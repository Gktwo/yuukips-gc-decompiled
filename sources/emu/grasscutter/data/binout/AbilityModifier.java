...
/* loaded from: grasscutter.jar:emu/grasscutter/data/binout/AbilityModifier.class */
public class AbilityModifier implements Serializable {
    ...
    /* loaded from: grasscutter.jar:emu/grasscutter/data/binout/AbilityModifier$AbilityModifierAction.class */
    public static class AbilityModifierAction {
        ...
        /* loaded from: grasscutter.jar:emu/grasscutter/data/binout/AbilityModifier$AbilityModifierAction$Type.class */
        public enum Type {
            ActCameraRadialBlur,
            ActCameraShake,
            AddAvatarSkillInfo,
