...
public class PacketDungeonChallengeBeginNotify extends BasePacket {
    public PacketDungeonChallengeBeginNotify(WorldChallenge challenge) {
        ...
        setData(DungeonChallengeBeginNotifyOuterClass.DungeonChallengeBeginNotify.newBuilder().setChallengeId(challenge.getChallengeId()).setChallengeIndex(challenge.getChallengeIndex()).setGroupId(challenge.getGroup().f922id).addAllParamList(challenge.getParamList()).build());
    }
}
