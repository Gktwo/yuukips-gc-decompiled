...
/* loaded from: grasscutter.jar:emu/grasscutter/server/packet/send/PacketSetUpLunchBoxWidgetRsp.class */
public class PacketSetUpLunchBoxWidgetRsp extends BasePacket {
    public PacketSetUpLunchBoxWidgetRsp(LunchBoxDataOuterClass.LunchBoxData lunchBoxData) {
        ...
        SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp.Builder rsp = SetUpLunchBoxWidgetRspOuterClass.SetUpLunchBoxWidgetRsp.newBuilder();
