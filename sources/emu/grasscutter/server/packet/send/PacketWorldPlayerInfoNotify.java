...
/* loaded from: grasscutter.jar:emu/grasscutter/server/packet/send/PacketWorldPlayerInfoNotify.class */
public class PacketWorldPlayerInfoNotify extends BasePacket {
    public PacketWorldPlayerInfoNotify(World world) {
        ...
        WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify.Builder proto = WorldPlayerInfoNotifyOuterClass.WorldPlayerInfoNotify.newBuilder();
