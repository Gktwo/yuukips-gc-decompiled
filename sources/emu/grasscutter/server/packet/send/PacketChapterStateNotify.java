...
/* loaded from: grasscutter.jar:emu/grasscutter/server/packet/send/PacketChapterStateNotify.class */
public class PacketChapterStateNotify extends BasePacket {
    public PacketChapterStateNotify(int id, ChapterStateOuterClass.ChapterState state) {
        ...
        ChapterStateNotifyOuterClass.ChapterStateNotify.Builder proto = ChapterStateNotifyOuterClass.ChapterStateNotify.newBuilder();
