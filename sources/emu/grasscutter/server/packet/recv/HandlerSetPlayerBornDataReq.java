...
public class HandlerSetPlayerBornDataReq extends PacketHandler {
    ...
    /*  JADX ERROR: Dependency scan failed at insn: 0x00FD: INVOKE_CUSTOM r-27
        java.lang.IndexOutOfBoundsException: Index 4 out of bounds for length 4
        	...
        	at jadx.core.dex.nodes.RootNode.runPreDecompileStage(RootNode.java:267)
        */
    /*  JADX ERROR: Failed to decode insn: 0x008C: INVOKE_CUSTOM r1, method: emu.grasscutter.server.packet.recv.HandlerSetPlayerBornDataReq.handle(emu.grasscutter.server.game.GameSession, byte[], byte[]):void
        jadx.core.utils.exceptions.JadxRuntimeException: 'invoke-custom' instruction processing error: Failed to process invoke-custom instruction: CallSite{[{ENCODED_METHOD_HANDLE: INVOKE_STATIC: Ljava/lang/invoke/StringConcatFactory;->makeConcatWithConstants(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/invoke/CallSite;}, makeConcatWithConstants, {ENCODED_METHOD_TYPE: (I)Ljava/lang/String;}, Error2 select avatar: ]}
