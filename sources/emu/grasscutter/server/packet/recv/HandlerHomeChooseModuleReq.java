...
/* loaded from: grasscutter.jar:emu/grasscutter/server/packet/recv/HandlerHomeChooseModuleReq.class */
public class HandlerHomeChooseModuleReq extends PacketHandler {
    @Override // emu.grasscutter.net.packet.PacketHandler
    public void handle(GameSession session, byte[] header, byte[] payload) throws Exception {
        HomeChooseModuleReqOuterClass.HomeChooseModuleReq req = HomeChooseModuleReqOuterClass.HomeChooseModuleReq.parseFrom(payload);
