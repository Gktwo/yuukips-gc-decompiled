...
/* loaded from: grasscutter.jar:emu/grasscutter/server/packet/recv/HandlerMusicGameStartReq.class */
public class HandlerMusicGameStartReq extends PacketHandler {
    @Override // emu.grasscutter.net.packet.PacketHandler
    public void handle(GameSession session, byte[] header, byte[] payload) throws Exception {
        MusicGameStartReqOuterClass.MusicGameStartReq req = MusicGameStartReqOuterClass.MusicGameStartReq.parseFrom(payload);
