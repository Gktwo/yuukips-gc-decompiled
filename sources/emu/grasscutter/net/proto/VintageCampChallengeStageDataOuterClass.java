...
public final class VintageCampChallengeStageDataOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_VintageCampChallengeStageData_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_VintageCampChallengeStageData_descriptor, new String[]{"CampLevelMap", "IsOpen", "MaxFinishedLevel", "IsFinish", "StageId", "OpenTime"});

    /* renamed from: internal_static_VintageCampChallengeStageData_CampLevelMapEntry_descriptor */
    private static final Descriptors.Descriptor f892x1e216a17 = internal_static_VintageCampChallengeStageData_descriptor.getNestedTypes().get(0);

    /* renamed from: internal_static_VintageCampChallengeStageData_CampLevelMapEntry_fieldAccessorTable */
    private static final GeneratedMessageV3.FieldAccessorTable f893x38ac8995 = new GeneratedMessageV3.FieldAccessorTable(f892x1e216a17, new String[]{"Key", "Value"});
    ...
    public static final class VintageCampChallengeStageData extends GeneratedMessageV3 implements VintageCampChallengeStageDataOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            GeneratedMessageV3.serializeIntegerMapTo(output, internalGetCampLevelMap(), CampLevelMapDefaultEntryHolder.defaultEntry, 1);
            if (this.isFinish_) {
                output.writeBool(4, this.isFinish_);
            }
            if (this.maxFinishedLevel_ != 0) {
                output.writeUInt32(7, this.maxFinishedLevel_);
            }
            if (this.stageId_ != 0) {
        ...
        public int getSerializedSize() {
            ...
            for (Map.Entry<Integer, VintageCampChallengeLevelDataOuterClass.VintageCampChallengeLevelData> entry : internalGetCampLevelMap().getMap().entrySet()) {
                size2 += CodedOutputStream.computeMessageSize(1, CampLevelMapDefaultEntryHolder.defaultEntry.newBuilderForType().setKey(entry.getKey()).setValue(entry.getValue()).build());
            }
            if (this.isFinish_) {
                size2 += CodedOutputStream.computeBoolSize(4, this.isFinish_);
            }
            if (this.maxFinishedLevel_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(7, this.maxFinishedLevel_);
            }
            if (this.stageId_ != 0) {
        ...
        public boolean equals(Object obj) {
            ...
            return internalGetCampLevelMap().equals(other.internalGetCampLevelMap()) && getIsOpen() == other.getIsOpen() && getMaxFinishedLevel() == other.getMaxFinishedLevel() && getIsFinish() == other.getIsFinish() && getStageId() == other.getStageId() && getOpenTime() == other.getOpenTime() && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            if (!internalGetCampLevelMap().getMap().isEmpty()) {
                hash = (53 * ((37 * hash) + 1)) + internalGetCampLevelMap().hashCode();
            }
            int hash2 = (29 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * hash) + 13)) + Internal.hashBoolean(getIsOpen()))) + 7)) + getMaxFinishedLevel())) + 4)) + Internal.hashBoolean(getIsFinish()))) + 9)) + getStageId())) + 10)) + getOpenTime())) + this.unknownFields.hashCode();
