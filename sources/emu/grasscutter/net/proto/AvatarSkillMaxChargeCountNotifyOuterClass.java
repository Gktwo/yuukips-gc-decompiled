...
public final class AvatarSkillMaxChargeCountNotifyOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable f649xc4b57a3 = new GeneratedMessageV3.FieldAccessorTable(internal_static_AvatarSkillMaxChargeCountNotify_descriptor, new String[]{"SkillId", "AvatarGuid", "MaxChargeCount"});
    ...
    public static final class AvatarSkillMaxChargeCountNotify extends GeneratedMessageV3 implements AvatarSkillMaxChargeCountNotifyOrBuilder {
        ...
        protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return AvatarSkillMaxChargeCountNotifyOuterClass.f649xc4b57a3.ensureFieldAccessorsInitialized(AvatarSkillMaxChargeCountNotify.class, Builder.class);
        }
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            if (this.maxChargeCount_ != 0) {
                output.writeUInt32(1, this.maxChargeCount_);
            }
            if (this.skillId_ != 0) {
                output.writeUInt32(3, this.skillId_);
            }
        ...
        public int getSerializedSize() {
            ...
            int size2 = 0;
            if (this.maxChargeCount_ != 0) {
                size2 = 0 + CodedOutputStream.computeUInt32Size(1, this.maxChargeCount_);
            }
            if (this.skillId_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(3, this.skillId_);
            }
            if (this.avatarGuid_ != 0) {
        ...
        public boolean equals(Object obj) {
            ...
            return getSkillId() == other.getSkillId() && getAvatarGuid() == other.getAvatarGuid() && getMaxChargeCount() == other.getMaxChargeCount() && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            int hash = (29 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * ((19 * 41) + getDescriptor().hashCode())) + 3)) + getSkillId())) + 7)) + Internal.hashLong(getAvatarGuid()))) + 1)) + getMaxChargeCount())) + this.unknownFields.hashCode();
