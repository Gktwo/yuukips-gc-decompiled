...
public final class QuestUpdateQuestTimeVarNotifyOuterClass {
    private static Descriptors.FileDescriptor descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(new String[]{"\n#QuestUpdateQuestTimeVarNotify.proto\"±\u0001\n\u001dQuestUpdateQuestTimeVarNotify\u0012D\n\ftime_var_map\u0018\u0001 \u0003(\u000b2..QuestUpdateQuestTimeVarNotify.TimeVarMapEntry\u0012\u0017\n\u000fparent_quest_id\u0018\u000e \u0001(\r\u001a1\n\u000fTimeVarMapEntry\u0012\u000b\n\u0003key\u0018\u0001 \u0001(\r\u0012\r\n\u0005value\u0018\u0002 \u0001(\r:\u00028\u0001B\u001b\n\u0019emu.grasscutter.net.protob\u0006proto3"}, new Descriptors.FileDescriptor[0]);
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_QuestUpdateQuestTimeVarNotify_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_QuestUpdateQuestTimeVarNotify_descriptor, new String[]{"TimeVarMap", "ParentQuestId"});

    /* renamed from: internal_static_QuestUpdateQuestTimeVarNotify_TimeVarMapEntry_descriptor */
    private static final Descriptors.Descriptor f838xdc53cc00 = internal_static_QuestUpdateQuestTimeVarNotify_descriptor.getNestedTypes().get(0);

    /* renamed from: internal_static_QuestUpdateQuestTimeVarNotify_TimeVarMapEntry_fieldAccessorTable */
    private static final GeneratedMessageV3.FieldAccessorTable f839x8536f27e = new GeneratedMessageV3.FieldAccessorTable(f838xdc53cc00, new String[]{"Key", "Value"});
    ...
    public static final class QuestUpdateQuestTimeVarNotify extends GeneratedMessageV3 implements QuestUpdateQuestTimeVarNotifyOrBuilder {
        ...
        public static final class TimeVarMapDefaultEntryHolder {
            static final MapEntry<Integer, Integer> defaultEntry = MapEntry.newDefaultInstance(QuestUpdateQuestTimeVarNotifyOuterClass.f838xdc53cc00, WireFormat.FieldType.UINT32, 0, WireFormat.FieldType.UINT32, 0);
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            GeneratedMessageV3.serializeIntegerMapTo(output, internalGetTimeVarMap(), TimeVarMapDefaultEntryHolder.defaultEntry, 1);
        ...
        public int getSerializedSize() {
            ...
            for (Map.Entry<Integer, Integer> entry : internalGetTimeVarMap().getMap().entrySet()) {
                size2 += CodedOutputStream.computeMessageSize(1, TimeVarMapDefaultEntryHolder.defaultEntry.newBuilderForType().setKey(entry.getKey()).setValue(entry.getValue()).build());
            }
            if (this.parentQuestId_ != 0) {
        ...
        public boolean equals(Object obj) {
            ...
            return internalGetTimeVarMap().equals(other.internalGetTimeVarMap()) && getParentQuestId() == other.getParentQuestId() && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            if (!internalGetTimeVarMap().getMap().isEmpty()) {
                hash = (53 * ((37 * hash) + 1)) + internalGetTimeVarMap().hashCode();
            }
            int hash2 = (29 * ((53 * ((37 * hash) + 14)) + getParentQuestId())) + this.unknownFields.hashCode();
