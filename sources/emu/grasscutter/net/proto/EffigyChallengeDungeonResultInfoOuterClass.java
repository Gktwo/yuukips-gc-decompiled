...
public final class EffigyChallengeDungeonResultInfoOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable f695x39bf6585 = new GeneratedMessageV3.FieldAccessorTable(internal_static_EffigyChallengeDungeonResultInfo_descriptor, new String[]{"ChallengeScore", "ChallengeMaxScore", "IsSuccess", "IsInTimeLimit", "ChallengeId"});
    ...
    public static final class EffigyChallengeDungeonResultInfo extends GeneratedMessageV3 implements EffigyChallengeDungeonResultInfoOrBuilder {
        ...
        protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return EffigyChallengeDungeonResultInfoOuterClass.f695x39bf6585.ensureFieldAccessorsInitialized(EffigyChallengeDungeonResultInfo.class, Builder.class);
        }
        ...
        public int getSerializedSize() {
            ...
            if (this.challengeMaxScore_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(8, this.challengeMaxScore_);
            }
            if (this.challengeScore_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(12, this.challengeScore_);
            }
            if (this.challengeId_ != 0) {
        ...
        public boolean equals(Object obj) {
            ...
            return getChallengeScore() == other.getChallengeScore() && getChallengeMaxScore() == other.getChallengeMaxScore() && getIsSuccess() == other.getIsSuccess() && getIsInTimeLimit() == other.getIsInTimeLimit() && getChallengeId() == other.getChallengeId() && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            int hash = (29 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * ((19 * 41) + getDescriptor().hashCode())) + 12)) + getChallengeScore())) + 8)) + getChallengeMaxScore())) + 2)) + Internal.hashBoolean(getIsSuccess()))) + 1)) + Internal.hashBoolean(getIsInTimeLimit()))) + 15)) + getChallengeId())) + this.unknownFields.hashCode();
