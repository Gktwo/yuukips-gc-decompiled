...
public final class GetInvestigationMonsterRspOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_GetInvestigationMonsterRsp_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_GetInvestigationMonsterRsp_descriptor, new String[]{"Retcode", "IsForMark", "MonsterList"});
    ...
    public static final class GetInvestigationMonsterRsp extends GeneratedMessageV3 implements GetInvestigationMonsterRspOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            for (int i = 0; i < this.monsterList_.size(); i++) {
                output.writeMessage(14, this.monsterList_.get(i));
            }
        ...
        public int getSerializedSize() {
            ...
            int size2 = 0;
            if (this.isForMark_) {
                size2 = 0 + CodedOutputStream.computeBoolSize(11, this.isForMark_);
            }
            if (this.retcode_ != 0) {
                size2 += CodedOutputStream.computeInt32Size(13, this.retcode_);
            }
            for (int i = 0; i < this.monsterList_.size(); i++) {
                size2 += CodedOutputStream.computeMessageSize(14, this.monsterList_.get(i));
            }
        ...
        public boolean equals(Object obj) {
            ...
            return getRetcode() == other.getRetcode() && getIsForMark() == other.getIsForMark() && getMonsterListList().equals(other.getMonsterListList()) && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            int hash = (53 * ((37 * ((53 * ((37 * ((19 * 41) + getDescriptor().hashCode())) + 13)) + getRetcode())) + 11)) + Internal.hashBoolean(getIsForMark());
            if (getMonsterListCount() > 0) {
                hash = (53 * ((37 * hash) + 14)) + getMonsterListList().hashCode();
            }
