...
public final class ScenePointUnlockNotifyOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_ScenePointUnlockNotify_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_ScenePointUnlockNotify_descriptor, new String[]{"HidePointList", "LockedPointList", "SceneId", "PointList", "UnhidePointList"});
    ...
    public static final class ScenePointUnlockNotify extends GeneratedMessageV3 implements ScenePointUnlockNotifyOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            for (int i2 = 0; i2 < this.lockedPointList_.size(); i2++) {
                output.writeUInt32NoTag(this.lockedPointList_.getInt(i2));
            }
        ...
        public int getSerializedSize() {
            ...
            int dataSize2 = 0;
            for (int i2 = 0; i2 < this.lockedPointList_.size(); i2++) {
                dataSize2 += CodedOutputStream.computeUInt32SizeNoTag(this.lockedPointList_.getInt(i2));
            }
            ...
            this.lockedPointListMemoizedSerializedSize = dataSize2;
            int dataSize3 = 0;
            for (int i3 = 0; i3 < this.pointList_.size(); i3++) {
            ...
            if (this.sceneId_ != 0) {
                size5 += CodedOutputStream.computeUInt32Size(11, this.sceneId_);
            }
        ...
        public boolean equals(Object obj) {
            ...
            return getHidePointListList().equals(other.getHidePointListList()) && getLockedPointListList().equals(other.getLockedPointListList()) && getSceneId() == other.getSceneId() && getPointListList().equals(other.getPointListList()) && getUnhidePointListList().equals(other.getUnhidePointListList()) && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            if (getHidePointListCount() > 0) {
                hash = (53 * ((37 * hash) + 10)) + getHidePointListList().hashCode();
            }
            if (getLockedPointListCount() > 0) {
                hash = (53 * ((37 * hash) + 5)) + getLockedPointListList().hashCode();
            }
            int hash2 = (53 * ((37 * hash) + 11)) + getSceneId();
            if (getPointListCount() > 0) {
                hash2 = (53 * ((37 * hash2) + 6)) + getPointListList().hashCode();
            }
            if (getUnhidePointListCount() > 0) {
                hash2 = (53 * ((37 * hash2) + 1)) + getUnhidePointListList().hashCode();
            }
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements ScenePointUnlockNotifyOrBuilder {
            ...
            @Override // emu.grasscutter.net.proto.ScenePointUnlockNotifyOuterClass.ScenePointUnlockNotifyOrBuilder
            public List<Integer> getHidePointListList() {
                return (this.bitField0_ & 1) != 0 ? Collections.unmodifiableList(this.hidePointList_) : this.hidePointList_;
            }
            ...
            @Override // emu.grasscutter.net.proto.ScenePointUnlockNotifyOuterClass.ScenePointUnlockNotifyOrBuilder
            public List<Integer> getPointListList() {
                return (this.bitField0_ & 4) != 0 ? Collections.unmodifiableList(this.pointList_) : this.pointList_;
            }
