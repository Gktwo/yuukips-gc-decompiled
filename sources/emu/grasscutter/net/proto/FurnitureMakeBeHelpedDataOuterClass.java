...
public final class FurnitureMakeBeHelpedDataOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_FurnitureMakeBeHelpedData_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_FurnitureMakeBeHelpedData_descriptor, new String[]{"PlayerName", "Icon", "ProfilePicture", "Time", "Uid"});
    ...
    public static final class FurnitureMakeBeHelpedData extends GeneratedMessageV3 implements FurnitureMakeBeHelpedDataOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            if (this.icon_ != 0) {
                output.writeUInt32(7, this.icon_);
            }
            if (this.uid_ != 0) {
                output.writeUInt32(8, this.uid_);
            }
            if (!GeneratedMessageV3.isStringEmpty(this.playerName_)) {
                GeneratedMessageV3.writeString(output, 11, this.playerName_);
            }
            if (this.time_ != 0) {
        ...
        public int getSerializedSize() {
            ...
            if (this.icon_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(7, this.icon_);
            }
            if (this.uid_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(8, this.uid_);
            }
            if (!GeneratedMessageV3.isStringEmpty(this.playerName_)) {
                size2 += GeneratedMessageV3.computeStringSize(11, this.playerName_);
            }
            if (this.time_ != 0) {
                size2 += CodedOutputStream.computeFixed32Size(12, this.time_);
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (getPlayerName().equals(other.getPlayerName()) && getIcon() == other.getIcon() && hasProfilePicture() == other.hasProfilePicture()) {
                return (!hasProfilePicture() || getProfilePicture().equals(other.getProfilePicture())) && getTime() == other.getTime() && getUid() == other.getUid() && this.unknownFields.equals(other.unknownFields);
            }
            return false;
        }
        ...
        public int hashCode() {
            ...
            int hash = (53 * ((37 * ((53 * ((37 * ((19 * 41) + getDescriptor().hashCode())) + 11)) + getPlayerName().hashCode())) + 7)) + getIcon();
            if (hasProfilePicture()) {
                hash = (53 * ((37 * hash) + 2)) + getProfilePicture().hashCode();
            }
            int hash2 = (29 * ((53 * ((37 * ((53 * ((37 * hash) + 12)) + getTime())) + 8)) + getUid())) + this.unknownFields.hashCode();
