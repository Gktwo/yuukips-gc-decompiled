...
public final class PostEnterSceneRspOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_PostEnterSceneRsp_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_PostEnterSceneRsp_descriptor, new String[]{"Retcode", "EnterSceneToken"});
    ...
    public static final class PostEnterSceneRsp extends GeneratedMessageV3 implements PostEnterSceneRspOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            if (this.enterSceneToken_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(12, this.enterSceneToken_);
            }
        ...
        public int hashCode() {
            ...
            int hash = (29 * ((53 * ((37 * ((53 * ((37 * ((19 * 41) + getDescriptor().hashCode())) + 9)) + getRetcode())) + 12)) + getEnterSceneToken())) + this.unknownFields.hashCode();
