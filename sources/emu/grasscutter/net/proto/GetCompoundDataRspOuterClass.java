...
public final class GetCompoundDataRspOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_GetCompoundDataRsp_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_GetCompoundDataRsp_descriptor, new String[]{"Retcode", "CompoundQueueDataList", "UnlockCompoundList"});
    ...
    public static final class GetCompoundDataRsp extends GeneratedMessageV3 implements GetCompoundDataRspOrBuilder {
        ...
        public boolean equals(Object obj) {
            ...
            return getRetcode() == other.getRetcode() && getCompoundQueueDataListList().equals(other.getCompoundQueueDataListList()) && getUnlockCompoundListList().equals(other.getUnlockCompoundListList()) && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            if (getUnlockCompoundListCount() > 0) {
                hash = (53 * ((37 * hash) + 14)) + getUnlockCompoundListList().hashCode();
            }
