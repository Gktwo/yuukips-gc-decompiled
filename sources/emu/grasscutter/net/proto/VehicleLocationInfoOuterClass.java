...
public final class VehicleLocationInfoOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_VehicleLocationInfo_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_VehicleLocationInfo_descriptor, new String[]{"UidList", "GadgetId", "Pos", "EntityId", "Rot", "CurHp", "OwnerUid", "MaxHp"});
    ...
    public static final class VehicleLocationInfo extends GeneratedMessageV3 implements VehicleLocationInfoOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            if (this.curHp_ != 0.0f) {
                output.writeFloat(5, this.curHp_);
            }
            if (this.maxHp_ != 0.0f) {
            ...
            if (this.ownerUid_ != 0) {
                output.writeUInt32(9, this.ownerUid_);
            }
        ...
        public int getSerializedSize() {
            ...
            if (this.curHp_ != 0.0f) {
                size2 += CodedOutputStream.computeFloatSize(5, this.curHp_);
            }
            if (this.maxHp_ != 0.0f) {
                size2 += CodedOutputStream.computeFloatSize(6, this.maxHp_);
            }
            if (this.gadgetId_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(7, this.gadgetId_);
            }
            if (this.ownerUid_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(9, this.ownerUid_);
            }
            int dataSize = 0;
            for (int i = 0; i < this.uidList_.size(); i++) {
            ...
            if (this.pos_ != null) {
                size3 += CodedOutputStream.computeMessageSize(12, getPos());
            }
            if (this.rot_ != null) {
                size3 += CodedOutputStream.computeMessageSize(14, getRot());
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (!getUidListList().equals(other.getUidListList()) || getGadgetId() != other.getGadgetId() || hasPos() != other.hasPos()) {
                return false;
            }
            if ((!hasPos() || getPos().equals(other.getPos())) && getEntityId() == other.getEntityId() && hasRot() == other.hasRot()) {
                return (!hasRot() || getRot().equals(other.getRot())) && Float.floatToIntBits(getCurHp()) == Float.floatToIntBits(other.getCurHp()) && getOwnerUid() == other.getOwnerUid() && Float.floatToIntBits(getMaxHp()) == Float.floatToIntBits(other.getMaxHp()) && this.unknownFields.equals(other.unknownFields);
            }
            return false;
        }
        ...
        public int hashCode() {
            ...
            if (getUidListCount() > 0) {
                hash = (53 * ((37 * hash) + 11)) + getUidListList().hashCode();
            }
            int hash2 = (53 * ((37 * hash) + 7)) + getGadgetId();
            if (hasPos()) {
                hash2 = (53 * ((37 * hash2) + 12)) + getPos().hashCode();
            }
            int hash3 = (53 * ((37 * hash2) + 2)) + getEntityId();
            if (hasRot()) {
                hash3 = (53 * ((37 * hash3) + 14)) + getRot().hashCode();
            }
            int hash4 = (29 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * hash3) + 5)) + Float.floatToIntBits(getCurHp()))) + 9)) + getOwnerUid())) + 6)) + Float.floatToIntBits(getMaxHp()))) + this.unknownFields.hashCode();
