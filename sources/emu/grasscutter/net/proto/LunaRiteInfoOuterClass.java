...
/* loaded from: grasscutter.jar:emu/grasscutter/net/proto/LunaRiteInfoOuterClass.class */
public final class LunaRiteInfoOuterClass {
    private static Descriptors.FileDescriptor descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(new String[]{"\n\u0012LunaRiteInfo.proto\u001a\u0017LunaRiteHintPoint.proto\u001a\u0016LunaRiteAreaInfo.proto\"^\n\fLunaRiteInfo\u0012%\n\thintPoint\u0018\b \u0003(\u000b2\u0012.LunaRiteHintPoint\u0012'\n\fareaInfoList\u0018\t \u0003(\u000b2\u0011.LunaRiteAreaInfoB\u001b\n\u0019emu.grasscutter.net.protob\u0006proto3"}, new Descriptors.FileDescriptor[]{LunaRiteHintPointOuterClass.getDescriptor(), LunaRiteAreaInfoOuterClass.getDescriptor()});
    private static final Descriptors.Descriptor internal_static_LunaRiteInfo_descriptor = getDescriptor().getMessageTypes().get(0);
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_LunaRiteInfo_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_LunaRiteInfo_descriptor, new String[]{"HintPoint", "AreaInfoList"});

    /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/LunaRiteInfoOuterClass$LunaRiteInfoOrBuilder.class */
    public interface LunaRiteInfoOrBuilder extends MessageOrBuilder {
    ...
    /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/LunaRiteInfoOuterClass$LunaRiteInfo.class */
    public static final class LunaRiteInfo extends GeneratedMessageV3 implements LunaRiteInfoOrBuilder {
        ...
        private static final LunaRiteInfo DEFAULT_INSTANCE = new LunaRiteInfo();
        private static final Parser<LunaRiteInfo> PARSER = new AbstractParser<LunaRiteInfo>() { // from class: emu.grasscutter.net.proto.LunaRiteInfoOuterClass.LunaRiteInfo.1
            @Override // com.google.protobuf.Parser
            public LunaRiteInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new LunaRiteInfo(input, extensionRegistry);
            }
        };

        private LunaRiteInfo(GeneratedMessageV3.Builder<?> builder) {
            super(builder);
        ...
        private LunaRiteInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this();
        ...
        protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return LunaRiteInfoOuterClass.internal_static_LunaRiteInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(LunaRiteInfo.class, Builder.class);
        }

        @Override // emu.grasscutter.net.proto.LunaRiteInfoOuterClass.LunaRiteInfoOrBuilder
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            for (int i = 0; i < this.hintPoint_.size(); i++) {
                output.writeMessage(8, this.hintPoint_.get(i));
            }
            for (int i2 = 0; i2 < this.areaInfoList_.size(); i2++) {
                output.writeMessage(9, this.areaInfoList_.get(i2));
            }
        ...
        public int getSerializedSize() {
            ...
            int size2 = 0;
            for (int i = 0; i < this.hintPoint_.size(); i++) {
                size2 += CodedOutputStream.computeMessageSize(8, this.hintPoint_.get(i));
            }
            for (int i2 = 0; i2 < this.areaInfoList_.size(); i2++) {
                size2 += CodedOutputStream.computeMessageSize(9, this.areaInfoList_.get(i2));
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof LunaRiteInfo)) {
                return equals(obj);
            }
            LunaRiteInfo other = (LunaRiteInfo) obj;
        ...
        public int hashCode() {
            ...
            if (getHintPointCount() > 0) {
                hash = (53 * ((37 * hash) + 8)) + getHintPointList().hashCode();
            }
            if (getAreaInfoListCount() > 0) {
                hash = (53 * ((37 * hash) + 9)) + getAreaInfoListList().hashCode();
            }
        ...
        public static LunaRiteInfo parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static LunaRiteInfo parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static LunaRiteInfo parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static LunaRiteInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static LunaRiteInfo parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static LunaRiteInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static LunaRiteInfo parseFrom(InputStream input) throws IOException {
            return (LunaRiteInfo) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static LunaRiteInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (LunaRiteInfo) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }

        public static LunaRiteInfo parseDelimitedFrom(InputStream input) throws IOException {
            return (LunaRiteInfo) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input);
        }

        public static LunaRiteInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (LunaRiteInfo) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
        }

        public static LunaRiteInfo parseFrom(CodedInputStream input) throws IOException {
            return (LunaRiteInfo) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static LunaRiteInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (LunaRiteInfo) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(LunaRiteInfo prototype) {
        ...
        /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/LunaRiteInfoOuterClass$LunaRiteInfo$Builder.class */
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements LunaRiteInfoOrBuilder {
            ...
            private void maybeForceBuilderInitialization() {
                if (LunaRiteInfo.alwaysUseFieldBuilders) {
            ...
            public LunaRiteInfo getDefaultInstanceForType() {
                return LunaRiteInfo.getDefaultInstance();
            }

            @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
            public LunaRiteInfo build() {
                LunaRiteInfo result = buildPartial();
            ...
            @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
            public LunaRiteInfo buildPartial() {
                LunaRiteInfo result = new LunaRiteInfo(this);
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof LunaRiteInfo) {
                    return mergeFrom((LunaRiteInfo) other);
                }
                mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(LunaRiteInfo other) {
                if (other == LunaRiteInfo.getDefaultInstance()) {
                    return this;
                }
                if (this.hintPointBuilder_ == null) {
                    ...
                    if (this.hintPointBuilder_.isEmpty()) {
                        ...
                        this.hintPoint_ = other.hintPoint_;
                        this.bitField0_ &= -2;
                        this.hintPointBuilder_ = LunaRiteInfo.alwaysUseFieldBuilders ? getHintPointFieldBuilder() : null;
                    } else {
                ...
                if (this.areaInfoListBuilder_ == null) {
                    ...
                    if (this.areaInfoListBuilder_.isEmpty()) {
                        ...
                        this.areaInfoList_ = other.areaInfoList_;
                        this.bitField0_ &= -3;
                        this.areaInfoListBuilder_ = LunaRiteInfo.alwaysUseFieldBuilders ? getAreaInfoListFieldBuilder() : null;
                    } else {
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                LunaRiteInfo parsedMessage = null;
                try {
                    try {
                        parsedMessage = LunaRiteInfo.PARSER.parsePartialFrom(input, extensionRegistry);
                        if (parsedMessage != null) {
                            mergeFrom(parsedMessage);
                        }
                        return this;
                    } catch (InvalidProtocolBufferException e) {
                        parsedMessage = (LunaRiteInfo) e.getUnfinishedMessage();
        ...
        public static LunaRiteInfo getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }

        public static Parser<LunaRiteInfo> parser() {
            return PARSER;
        }

        @Override // com.google.protobuf.GeneratedMessageV3, com.google.protobuf.MessageLite, com.google.protobuf.Message
        public Parser<LunaRiteInfo> getParserForType() {
            return PARSER;
        }
