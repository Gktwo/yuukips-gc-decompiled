...
public final class ReliquaryDecomposeRspOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_ReliquaryDecomposeRsp_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_ReliquaryDecomposeRsp_descriptor, new String[]{"Retcode", "GuidList"});
    ...
    public static final class ReliquaryDecomposeRsp extends GeneratedMessageV3 implements ReliquaryDecomposeRspOrBuilder {
        ...
        public boolean equals(Object obj) {
            ...
            return getRetcode() == other.getRetcode() && getGuidListList().equals(other.getGuidListList()) && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            if (getGuidListCount() > 0) {
                hash = (53 * ((37 * hash) + 12)) + getGuidListList().hashCode();
            }
