...
public final class PlayerApplyEnterMpRspOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_PlayerApplyEnterMpRsp_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_PlayerApplyEnterMpRsp_descriptor, new String[]{"TargetUid", "Retcode", "Param"});
    ...
    public static final class PlayerApplyEnterMpRsp extends GeneratedMessageV3 implements PlayerApplyEnterMpRspOrBuilder {
        ...
        public boolean equals(Object obj) {
            ...
            return getTargetUid() == other.getTargetUid() && getRetcode() == other.getRetcode() && getParam() == other.getParam() && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            int hash = (29 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * ((19 * 41) + getDescriptor().hashCode())) + 5)) + getTargetUid())) + 9)) + getRetcode())) + 14)) + getParam())) + this.unknownFields.hashCode();
