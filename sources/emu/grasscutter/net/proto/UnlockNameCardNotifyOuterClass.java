    ...
    public static final class UnlockNameCardNotify extends GeneratedMessageV3 implements UnlockNameCardNotifyOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            if (this.nameCardId_ != 0) {
                output.writeUInt32(5, this.nameCardId_);
            }
        ...
        public int getSerializedSize() {
            ...
            int size2 = 0;
            if (this.nameCardId_ != 0) {
                size2 = 0 + CodedOutputStream.computeUInt32Size(5, this.nameCardId_);
            }
        ...
        public int hashCode() {
            ...
            int hash = (29 * ((53 * ((37 * ((19 * 41) + getDescriptor().hashCode())) + 5)) + getNameCardId())) + this.unknownFields.hashCode();
