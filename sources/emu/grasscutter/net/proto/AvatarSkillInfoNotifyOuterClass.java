...
public final class AvatarSkillInfoNotifyOuterClass {
    ...
    public static final class AvatarSkillInfoNotify extends GeneratedMessageV3 implements AvatarSkillInfoNotifyOrBuilder {
        ...
        private static final AvatarSkillInfoNotify DEFAULT_INSTANCE = new AvatarSkillInfoNotify();
        private static final Parser<AvatarSkillInfoNotify> PARSER = new AbstractParser<AvatarSkillInfoNotify>() { // from class: emu.grasscutter.net.proto.AvatarSkillInfoNotifyOuterClass.AvatarSkillInfoNotify.1
            @Override // com.google.protobuf.Parser
            public AvatarSkillInfoNotify parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
        ...
        /*  JADX ERROR: Dependency scan failed at insn: 0x001E: INVOKE_CUSTOM r0
            ...
            */
        /*  JADX ERROR: Failed to decode insn: 0x001E: INVOKE_CUSTOM r2, method: emu.grasscutter.net.proto.AvatarSkillInfoNotifyOuterClass.AvatarSkillInfoNotify.internalGetMapField(int):com.google.protobuf.MapField
        ...
        protected com.google.protobuf.MapField internalGetMapField(int r5) {
            /*
                ...
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: emu.grasscutter.net.proto.AvatarSkillInfoNotifyOuterClass.AvatarSkillInfoNotify.internalGetMapField(int):com.google.protobuf.MapField");
        }

        private AvatarSkillInfoNotify(GeneratedMessageV3.Builder<?> builder) {
            super(builder);
        ...
        private AvatarSkillInfoNotify(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this();
        ...
        /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/AvatarSkillInfoNotifyOuterClass$AvatarSkillInfoNotify$SkillMapDefaultEntryHolder.class */
        public static final class SkillMapDefaultEntryHolder {
            static final MapEntry<Integer, AvatarSkillInfoOuterClass.AvatarSkillInfo> defaultEntry = MapEntry.newDefaultInstance(AvatarSkillInfoNotifyOuterClass.internal_static_AvatarSkillInfoNotify_SkillMapEntry_descriptor, WireFormat.FieldType.UINT32, 0, WireFormat.FieldType.MESSAGE, AvatarSkillInfoOuterClass.AvatarSkillInfo.getDefaultInstance());
        ...
        @Override // emu.grasscutter.net.proto.AvatarSkillInfoNotifyOuterClass.AvatarSkillInfoNotifyOrBuilder
        ...
        public boolean equals(Object obj) {
            ...
            AvatarSkillInfoNotify other = (AvatarSkillInfoNotify) obj;
            return internalGetSkillMap().equals(other.internalGetSkillMap()) && getGuid() == other.getGuid() && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public static AvatarSkillInfoNotify parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static AvatarSkillInfoNotify parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static AvatarSkillInfoNotify parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static AvatarSkillInfoNotify parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static AvatarSkillInfoNotify parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static AvatarSkillInfoNotify parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static AvatarSkillInfoNotify parseFrom(InputStream input) throws IOException {
            return (AvatarSkillInfoNotify) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static AvatarSkillInfoNotify parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (AvatarSkillInfoNotify) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }

        public static AvatarSkillInfoNotify parseDelimitedFrom(InputStream input) throws IOException {
            return (AvatarSkillInfoNotify) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input);
        }

        public static AvatarSkillInfoNotify parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (AvatarSkillInfoNotify) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
        }

        public static AvatarSkillInfoNotify parseFrom(CodedInputStream input) throws IOException {
            return (AvatarSkillInfoNotify) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static AvatarSkillInfoNotify parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (AvatarSkillInfoNotify) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(AvatarSkillInfoNotify prototype) {
        ...
        /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/AvatarSkillInfoNotifyOuterClass$AvatarSkillInfoNotify$Builder.class */
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements AvatarSkillInfoNotifyOrBuilder {
            ...
            /*  JADX ERROR: Dependency scan failed at insn: 0x001E: INVOKE_CUSTOM r0
                java.lang.IndexOutOfBoundsException: Index 4 out of bounds for length 4
                	...
                	at jadx.core.dex.nodes.RootNode.runPreDecompileStage(RootNode.java:267)
                */
            /*  JADX ERROR: Failed to decode insn: 0x001E: INVOKE_CUSTOM r2, method: emu.grasscutter.net.proto.AvatarSkillInfoNotifyOuterClass.AvatarSkillInfoNotify.Builder.internalGetMapField(int):com.google.protobuf.MapField
                jadx.core.utils.exceptions.JadxRuntimeException: 'invoke-custom' instruction processing error: Failed to process invoke-custom instruction: CallSite{[{ENCODED_METHOD_HANDLE: INVOKE_STATIC: Ljava/lang/invoke/StringConcatFactory;->makeConcatWithConstants(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/invoke/CallSite;}, makeConcatWithConstants, {ENCODED_METHOD_TYPE: (I)Ljava/lang/String;}, Invalid map field number: ]}
                	at jadx.core.dex.instructions.InvokeCustomBuilder.build(InvokeCustomBuilder.java:55)
                	at jadx.core.dex.instructions.InsnDecoder.invoke(InsnDecoder.java:568)
                	at jadx.core.dex.instructions.InsnDecoder.decode(InsnDecoder.java:438)
            ...
            protected com.google.protobuf.MapField internalGetMapField(int r5) {
                /*
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: emu.grasscutter.net.proto.AvatarSkillInfoNotifyOuterClass.AvatarSkillInfoNotify.Builder.internalGetMapField(int):com.google.protobuf.MapField");
            }
            ...
            /*  JADX ERROR: Dependency scan failed at insn: 0x001E: INVOKE_CUSTOM r0
                java.lang.IndexOutOfBoundsException: Index 4 out of bounds for length 4
                	...
                	at jadx.core.dex.nodes.RootNode.runPreDecompileStage(RootNode.java:267)
                */
            /*  JADX ERROR: Failed to decode insn: 0x001E: INVOKE_CUSTOM r2, method: emu.grasscutter.net.proto.AvatarSkillInfoNotifyOuterClass.AvatarSkillInfoNotify.Builder.internalGetMutableMapField(int):com.google.protobuf.MapField
                jadx.core.utils.exceptions.JadxRuntimeException: 'invoke-custom' instruction processing error: Failed to process invoke-custom instruction: CallSite{[{ENCODED_METHOD_HANDLE: INVOKE_STATIC: Ljava/lang/invoke/StringConcatFactory;->makeConcatWithConstants(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/invoke/CallSite;}, makeConcatWithConstants, {ENCODED_METHOD_TYPE: (I)Ljava/lang/String;}, Invalid map field number: ]}
                	at jadx.core.dex.instructions.InvokeCustomBuilder.build(InvokeCustomBuilder.java:55)
                	at jadx.core.dex.instructions.InsnDecoder.invoke(InsnDecoder.java:568)
                	at jadx.core.dex.instructions.InsnDecoder.decode(InsnDecoder.java:438)
            ...
            protected com.google.protobuf.MapField internalGetMutableMapField(int r5) {
                /*
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: emu.grasscutter.net.proto.AvatarSkillInfoNotifyOuterClass.AvatarSkillInfoNotify.Builder.internalGetMutableMapField(int):com.google.protobuf.MapField");
            }
            ...
            public AvatarSkillInfoNotify build() {
                AvatarSkillInfoNotify result = buildPartial();
            ...
            public AvatarSkillInfoNotify buildPartial() {
                AvatarSkillInfoNotify result = new AvatarSkillInfoNotify(this);
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof AvatarSkillInfoNotify) {
                    return mergeFrom((AvatarSkillInfoNotify) other);
                }
                mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(AvatarSkillInfoNotify other) {
