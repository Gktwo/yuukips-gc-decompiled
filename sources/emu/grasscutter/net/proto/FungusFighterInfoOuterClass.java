...
/* loaded from: grasscutter.jar:emu/grasscutter/net/proto/FungusFighterInfoOuterClass.class */
public final class FungusFighterInfoOuterClass {
    private static Descriptors.FileDescriptor descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(new String[]{"\n\u0017FungusFighterInfo.proto\u001a\u0012FungusDetail.proto\u001a\"FungusTrainingProgressDetail.proto\u001a\u001bFungusPlotStageDetail.proto\u001a!FungusTrainingDungeonDetail.proto\"Ó\u0002\n\u0011FungusFighterInfo\u0012'\n\u0010fungusDetailList\u0018\u0003 \u0003(\u000b2\r.FungusDetail\u0012\u001b\n\u0013Unk3300_GIHAKKAJHDH\u0018\t \u0003(\r\u0012H\n!trainingDungeonProgressDetailList\u0018\u0004 \u0003(\u000b2\u001d.FungusTrainingProgressDetail\u0012\u001b\n\u0013Unk3300_HPDOJOBPFMJ\u0018\u0002 \u0003(\r\u0012\u001b\n\u0013Unk3300_KGKFJJHFHAB\u0018\r \u0003(\r\u00123\n\u0013plotStageDetailList\u0018\u0006 \u0003(\u000b2\u0016.FungusPlotStageDetail\u0012?\n\u0019trainingDungeonDetailList\u0018\f \u0003(\u000b2\u001c.FungusTrainingDungeonDetailB\u001b\n\u0019emu.grasscutter.net.protob\u0006proto3"}, new Descriptors.FileDescriptor[]{FungusDetailOuterClass.getDescriptor(), FungusTrainingProgressDetailOuterClass.getDescriptor(), FungusPlotStageDetailOuterClass.getDescriptor(), FungusTrainingDungeonDetailOuterClass.getDescriptor()});
    private static final Descriptors.Descriptor internal_static_FungusFighterInfo_descriptor = getDescriptor().getMessageTypes().get(0);
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_FungusFighterInfo_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_FungusFighterInfo_descriptor, new String[]{"FungusDetailList", "Unk3300GIHAKKAJHDH", "TrainingDungeonProgressDetailList", "Unk3300HPDOJOBPFMJ", "Unk3300KGKFJJHFHAB", "PlotStageDetailList", "TrainingDungeonDetailList"});

    /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/FungusFighterInfoOuterClass$FungusFighterInfoOrBuilder.class */
    public interface FungusFighterInfoOrBuilder extends MessageOrBuilder {
    ...
    /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/FungusFighterInfoOuterClass$FungusFighterInfo.class */
    public static final class FungusFighterInfo extends GeneratedMessageV3 implements FungusFighterInfoOrBuilder {
        ...
        private static final FungusFighterInfo DEFAULT_INSTANCE = new FungusFighterInfo();
        private static final Parser<FungusFighterInfo> PARSER = new AbstractParser<FungusFighterInfo>() { // from class: emu.grasscutter.net.proto.FungusFighterInfoOuterClass.FungusFighterInfo.1
            @Override // com.google.protobuf.Parser
            public FungusFighterInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new FungusFighterInfo(input, extensionRegistry);
            }
        };

        private FungusFighterInfo(GeneratedMessageV3.Builder<?> builder) {
            super(builder);
        ...
        /* JADX DEBUG: Failed to insert an additional move for type inference into block B:143:0x0293 */
        private FungusFighterInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this();
        ...
        protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return FungusFighterInfoOuterClass.internal_static_FungusFighterInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(FungusFighterInfo.class, Builder.class);
        }

        @Override // emu.grasscutter.net.proto.FungusFighterInfoOuterClass.FungusFighterInfoOrBuilder
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            for (int i = 0; i < this.unk3300HPDOJOBPFMJ_.size(); i++) {
                output.writeUInt32NoTag(this.unk3300HPDOJOBPFMJ_.getInt(i));
            }
            for (int i2 = 0; i2 < this.fungusDetailList_.size(); i2++) {
                output.writeMessage(3, this.fungusDetailList_.get(i2));
            }
            for (int i3 = 0; i3 < this.trainingDungeonProgressDetailList_.size(); i3++) {
                output.writeMessage(4, this.trainingDungeonProgressDetailList_.get(i3));
            }
            for (int i4 = 0; i4 < this.plotStageDetailList_.size(); i4++) {
                output.writeMessage(6, this.plotStageDetailList_.get(i4));
            }
            if (getUnk3300GIHAKKAJHDHList().size() > 0) {
                output.writeUInt32NoTag(74);
                output.writeUInt32NoTag(this.unk3300GIHAKKAJHDHMemoizedSerializedSize);
            }
            for (int i5 = 0; i5 < this.unk3300GIHAKKAJHDH_.size(); i5++) {
                output.writeUInt32NoTag(this.unk3300GIHAKKAJHDH_.getInt(i5));
            }
            for (int i6 = 0; i6 < this.trainingDungeonDetailList_.size(); i6++) {
                output.writeMessage(12, this.trainingDungeonDetailList_.get(i6));
            }
            if (getUnk3300KGKFJJHFHABList().size() > 0) {
                output.writeUInt32NoTag(106);
                output.writeUInt32NoTag(this.unk3300KGKFJJHFHABMemoizedSerializedSize);
            }
            for (int i7 = 0; i7 < this.unk3300KGKFJJHFHAB_.size(); i7++) {
                output.writeUInt32NoTag(this.unk3300KGKFJJHFHAB_.getInt(i7));
            }
        ...
        public int getSerializedSize() {
            ...
            int dataSize = 0;
            for (int i = 0; i < this.unk3300HPDOJOBPFMJ_.size(); i++) {
                dataSize += CodedOutputStream.computeUInt32SizeNoTag(this.unk3300HPDOJOBPFMJ_.getInt(i));
            }
            int size2 = 0 + dataSize;
            if (!getUnk3300HPDOJOBPFMJList().isEmpty()) {
                size2 = size2 + 1 + CodedOutputStream.computeInt32SizeNoTag(dataSize);
            }
            this.unk3300HPDOJOBPFMJMemoizedSerializedSize = dataSize;
            for (int i2 = 0; i2 < this.fungusDetailList_.size(); i2++) {
                size2 += CodedOutputStream.computeMessageSize(3, this.fungusDetailList_.get(i2));
            }
            for (int i3 = 0; i3 < this.trainingDungeonProgressDetailList_.size(); i3++) {
                size2 += CodedOutputStream.computeMessageSize(4, this.trainingDungeonProgressDetailList_.get(i3));
            }
            for (int i4 = 0; i4 < this.plotStageDetailList_.size(); i4++) {
                size2 += CodedOutputStream.computeMessageSize(6, this.plotStageDetailList_.get(i4));
            }
            int dataSize2 = 0;
            for (int i5 = 0; i5 < this.unk3300GIHAKKAJHDH_.size(); i5++) {
                dataSize2 += CodedOutputStream.computeUInt32SizeNoTag(this.unk3300GIHAKKAJHDH_.getInt(i5));
            }
            ...
            this.unk3300GIHAKKAJHDHMemoizedSerializedSize = dataSize2;
            for (int i6 = 0; i6 < this.trainingDungeonDetailList_.size(); i6++) {
                size3 += CodedOutputStream.computeMessageSize(12, this.trainingDungeonDetailList_.get(i6));
            }
            int dataSize3 = 0;
            for (int i7 = 0; i7 < this.unk3300KGKFJJHFHAB_.size(); i7++) {
                dataSize3 += CodedOutputStream.computeUInt32SizeNoTag(this.unk3300KGKFJJHFHAB_.getInt(i7));
            }
            ...
            this.unk3300KGKFJJHFHABMemoizedSerializedSize = dataSize3;
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof FungusFighterInfo)) {
                return equals(obj);
            }
            FungusFighterInfo other = (FungusFighterInfo) obj;
            return getFungusDetailListList().equals(other.getFungusDetailListList()) && getUnk3300GIHAKKAJHDHList().equals(other.getUnk3300GIHAKKAJHDHList()) && getTrainingDungeonProgressDetailListList().equals(other.getTrainingDungeonProgressDetailListList()) && getUnk3300HPDOJOBPFMJList().equals(other.getUnk3300HPDOJOBPFMJList()) && getUnk3300KGKFJJHFHABList().equals(other.getUnk3300KGKFJJHFHABList()) && getPlotStageDetailListList().equals(other.getPlotStageDetailListList()) && getTrainingDungeonDetailListList().equals(other.getTrainingDungeonDetailListList()) && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            if (getFungusDetailListCount() > 0) {
                hash = (53 * ((37 * hash) + 3)) + getFungusDetailListList().hashCode();
            }
            if (getUnk3300GIHAKKAJHDHCount() > 0) {
                hash = (53 * ((37 * hash) + 9)) + getUnk3300GIHAKKAJHDHList().hashCode();
            }
            if (getTrainingDungeonProgressDetailListCount() > 0) {
                hash = (53 * ((37 * hash) + 4)) + getTrainingDungeonProgressDetailListList().hashCode();
            }
            if (getUnk3300HPDOJOBPFMJCount() > 0) {
                hash = (53 * ((37 * hash) + 2)) + getUnk3300HPDOJOBPFMJList().hashCode();
            }
            if (getUnk3300KGKFJJHFHABCount() > 0) {
                hash = (53 * ((37 * hash) + 13)) + getUnk3300KGKFJJHFHABList().hashCode();
            }
            if (getPlotStageDetailListCount() > 0) {
                hash = (53 * ((37 * hash) + 6)) + getPlotStageDetailListList().hashCode();
            }
            if (getTrainingDungeonDetailListCount() > 0) {
                hash = (53 * ((37 * hash) + 12)) + getTrainingDungeonDetailListList().hashCode();
            }
        ...
        public static FungusFighterInfo parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static FungusFighterInfo parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static FungusFighterInfo parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static FungusFighterInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static FungusFighterInfo parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static FungusFighterInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static FungusFighterInfo parseFrom(InputStream input) throws IOException {
            return (FungusFighterInfo) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static FungusFighterInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (FungusFighterInfo) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }

        public static FungusFighterInfo parseDelimitedFrom(InputStream input) throws IOException {
            return (FungusFighterInfo) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input);
        }

        public static FungusFighterInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (FungusFighterInfo) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
        }

        public static FungusFighterInfo parseFrom(CodedInputStream input) throws IOException {
            return (FungusFighterInfo) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static FungusFighterInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (FungusFighterInfo) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(FungusFighterInfo prototype) {
        ...
        /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/FungusFighterInfoOuterClass$FungusFighterInfo$Builder.class */
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements FungusFighterInfoOrBuilder {
            ...
            private Internal.IntList unk3300GIHAKKAJHDH_ = FungusFighterInfo.emptyIntList();
            ...
            private Internal.IntList unk3300HPDOJOBPFMJ_ = FungusFighterInfo.emptyIntList();
            private Internal.IntList unk3300KGKFJJHFHAB_ = FungusFighterInfo.emptyIntList();
            ...
            private void maybeForceBuilderInitialization() {
                if (FungusFighterInfo.alwaysUseFieldBuilders) {
            ...
            public Builder clear() {
                ...
                this.unk3300GIHAKKAJHDH_ = FungusFighterInfo.emptyIntList();
                this.bitField0_ &= -3;
                ...
                this.unk3300HPDOJOBPFMJ_ = FungusFighterInfo.emptyIntList();
                this.bitField0_ &= -9;
                this.unk3300KGKFJJHFHAB_ = FungusFighterInfo.emptyIntList();
                this.bitField0_ &= -17;
            ...
            public FungusFighterInfo getDefaultInstanceForType() {
                return FungusFighterInfo.getDefaultInstance();
            }

            @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
            public FungusFighterInfo build() {
                FungusFighterInfo result = buildPartial();
            ...
            @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
            public FungusFighterInfo buildPartial() {
                FungusFighterInfo result = new FungusFighterInfo(this);
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof FungusFighterInfo) {
                    return mergeFrom((FungusFighterInfo) other);
                }
                mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(FungusFighterInfo other) {
                if (other == FungusFighterInfo.getDefaultInstance()) {
                    return this;
                }
                if (this.fungusDetailListBuilder_ == null) {
                    ...
                    if (this.fungusDetailListBuilder_.isEmpty()) {
                        ...
                        this.fungusDetailList_ = other.fungusDetailList_;
                        this.bitField0_ &= -2;
                        this.fungusDetailListBuilder_ = FungusFighterInfo.alwaysUseFieldBuilders ? getFungusDetailListFieldBuilder() : null;
                    } else {
                ...
                if (this.trainingDungeonProgressDetailListBuilder_ == null) {
                    ...
                    if (this.trainingDungeonProgressDetailListBuilder_.isEmpty()) {
                        ...
                        this.trainingDungeonProgressDetailList_ = other.trainingDungeonProgressDetailList_;
                        this.bitField0_ &= -5;
                        this.trainingDungeonProgressDetailListBuilder_ = FungusFighterInfo.alwaysUseFieldBuilders ? getTrainingDungeonProgressDetailListFieldBuilder() : null;
                    } else {
                ...
                if (this.plotStageDetailListBuilder_ == null) {
                    ...
                    if (this.plotStageDetailListBuilder_.isEmpty()) {
                        ...
                        this.plotStageDetailList_ = other.plotStageDetailList_;
                        this.bitField0_ &= -33;
                        this.plotStageDetailListBuilder_ = FungusFighterInfo.alwaysUseFieldBuilders ? getPlotStageDetailListFieldBuilder() : null;
                    } else {
                ...
                if (this.trainingDungeonDetailListBuilder_ == null) {
                    ...
                    if (this.trainingDungeonDetailListBuilder_.isEmpty()) {
                        ...
                        this.trainingDungeonDetailList_ = other.trainingDungeonDetailList_;
                        this.bitField0_ &= -65;
                        this.trainingDungeonDetailListBuilder_ = FungusFighterInfo.alwaysUseFieldBuilders ? getTrainingDungeonDetailListFieldBuilder() : null;
                    } else {
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                FungusFighterInfo parsedMessage = null;
                try {
                    try {
                        parsedMessage = FungusFighterInfo.PARSER.parsePartialFrom(input, extensionRegistry);
                        if (parsedMessage != null) {
                            mergeFrom(parsedMessage);
                        }
                        return this;
                    } catch (InvalidProtocolBufferException e) {
                        parsedMessage = (FungusFighterInfo) e.getUnfinishedMessage();
            ...
            private void ensureUnk3300GIHAKKAJHDHIsMutable() {
                if ((this.bitField0_ & 2) == 0) {
                    this.unk3300GIHAKKAJHDH_ = FungusFighterInfo.mutableCopy(this.unk3300GIHAKKAJHDH_);
                    this.bitField0_ |= 2;
                }
            }
            ...
            private RepeatedFieldBuilderV3<FungusTrainingProgressDetailOuterClass.FungusTrainingProgressDetail, FungusTrainingProgressDetailOuterClass.FungusTrainingProgressDetail.Builder, FungusTrainingProgressDetailOuterClass.FungusTrainingProgressDetailOrBuilder> getTrainingDungeonProgressDetailListFieldBuilder() {
                if (this.trainingDungeonProgressDetailListBuilder_ == null) {
                    this.trainingDungeonProgressDetailListBuilder_ = new RepeatedFieldBuilderV3<>(this.trainingDungeonProgressDetailList_, (this.bitField0_ & 4) != 0, getParentForChildren(), isClean());
            ...
            private void ensureUnk3300HPDOJOBPFMJIsMutable() {
                if ((this.bitField0_ & 8) == 0) {
                    this.unk3300HPDOJOBPFMJ_ = FungusFighterInfo.mutableCopy(this.unk3300HPDOJOBPFMJ_);
                    this.bitField0_ |= 8;
                }
            }
            ...
            @Override // emu.grasscutter.net.proto.FungusFighterInfoOuterClass.FungusFighterInfoOrBuilder
            public List<Integer> getUnk3300HPDOJOBPFMJList() {
                return (this.bitField0_ & 8) != 0 ? Collections.unmodifiableList(this.unk3300HPDOJOBPFMJ_) : this.unk3300HPDOJOBPFMJ_;
            }
            ...
            private void ensureUnk3300KGKFJJHFHABIsMutable() {
                if ((this.bitField0_ & 16) == 0) {
                    this.unk3300KGKFJJHFHAB_ = FungusFighterInfo.mutableCopy(this.unk3300KGKFJJHFHAB_);
                    this.bitField0_ |= 16;
                }
            }
            ...
            @Override // emu.grasscutter.net.proto.FungusFighterInfoOuterClass.FungusFighterInfoOrBuilder
            public List<Integer> getUnk3300KGKFJJHFHABList() {
                return (this.bitField0_ & 16) != 0 ? Collections.unmodifiableList(this.unk3300KGKFJJHFHAB_) : this.unk3300KGKFJJHFHAB_;
            }
        ...
        public static FungusFighterInfo getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }

        public static Parser<FungusFighterInfo> parser() {
            return PARSER;
        }

        @Override // com.google.protobuf.GeneratedMessageV3, com.google.protobuf.MessageLite, com.google.protobuf.Message
        public Parser<FungusFighterInfo> getParserForType() {
            return PARSER;
        }
