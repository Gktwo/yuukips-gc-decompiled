...
public final class TowerCurLevelRecordOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_TowerCurLevelRecord_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_TowerCurLevelRecord_descriptor, new String[]{"TowerTeamList", "CurLevelIndex", "BuffIdList", "IsUpperPart", "IsEmpty", "CurFloorId"});
    ...
    public static final class TowerCurLevelRecord extends GeneratedMessageV3 implements TowerCurLevelRecordOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            if (this.isUpperPart_) {
                output.writeBool(1, this.isUpperPart_);
            }
            if (this.isEmpty_) {
                output.writeBool(7, this.isEmpty_);
            }
            ...
            for (int i2 = 0; i2 < this.towerTeamList_.size(); i2++) {
                output.writeMessage(13, this.towerTeamList_.get(i2));
            }
            if (this.curLevelIndex_ != 0) {
                output.writeUInt32(14, this.curLevelIndex_);
            }
        ...
        public int getSerializedSize() {
            ...
            int size2 = 0;
            if (this.isUpperPart_) {
                size2 = 0 + CodedOutputStream.computeBoolSize(1, this.isUpperPart_);
            }
            if (this.isEmpty_) {
                size2 += CodedOutputStream.computeBoolSize(7, this.isEmpty_);
            }
            if (this.curFloorId_ != 0) {
            ...
            for (int i2 = 0; i2 < this.towerTeamList_.size(); i2++) {
                size3 += CodedOutputStream.computeMessageSize(13, this.towerTeamList_.get(i2));
            }
            if (this.curLevelIndex_ != 0) {
                size3 += CodedOutputStream.computeUInt32Size(14, this.curLevelIndex_);
            }
        ...
        public boolean equals(Object obj) {
            ...
            return getTowerTeamListList().equals(other.getTowerTeamListList()) && getCurLevelIndex() == other.getCurLevelIndex() && getBuffIdListList().equals(other.getBuffIdListList()) && getIsUpperPart() == other.getIsUpperPart() && getIsEmpty() == other.getIsEmpty() && getCurFloorId() == other.getCurFloorId() && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            if (getTowerTeamListCount() > 0) {
                hash = (53 * ((37 * hash) + 13)) + getTowerTeamListList().hashCode();
            }
            int hash2 = (53 * ((37 * hash) + 14)) + getCurLevelIndex();
            if (getBuffIdListCount() > 0) {
                hash2 = (53 * ((37 * hash2) + 12)) + getBuffIdListList().hashCode();
            }
            int hash3 = (29 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * hash2) + 1)) + Internal.hashBoolean(getIsUpperPart()))) + 7)) + Internal.hashBoolean(getIsEmpty()))) + 9)) + getCurFloorId())) + this.unknownFields.hashCode();
