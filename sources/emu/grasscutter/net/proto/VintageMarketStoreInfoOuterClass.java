...
public final class VintageMarketStoreInfoOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_VintageMarketStoreInfo_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_VintageMarketStoreInfo_descriptor, new String[]{"StrategyList", "StoreId", "SlotCount", "Unk3300HNBGHCCENIA", "Unk3300ODLLANKOEND"});
    ...
    public static final class VintageMarketStoreInfo extends GeneratedMessageV3 implements VintageMarketStoreInfoOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            for (int i = 0; i < this.strategyList_.size(); i++) {
                output.writeUInt32NoTag(this.strategyList_.getInt(i));
            }
            if (this.slotCount_ != 0) {
                output.writeUInt32(7, this.slotCount_);
            }
            if (this.storeId_ != 0) {
                output.writeUInt32(8, this.storeId_);
            }
            if (getUnk3300HNBGHCCENIAList().size() > 0) {
                output.writeUInt32NoTag(82);
                output.writeUInt32NoTag(this.unk3300HNBGHCCENIAMemoizedSerializedSize);
            }
            for (int i2 = 0; i2 < this.unk3300HNBGHCCENIA_.size(); i2++) {
                output.writeUInt32NoTag(this.unk3300HNBGHCCENIA_.getInt(i2));
            }
            if (getUnk3300ODLLANKOENDList().size() > 0) {
                output.writeUInt32NoTag(98);
                output.writeUInt32NoTag(this.unk3300ODLLANKOENDMemoizedSerializedSize);
            }
            for (int i3 = 0; i3 < this.unk3300ODLLANKOEND_.size(); i3++) {
                output.writeUInt32NoTag(this.unk3300ODLLANKOEND_.getInt(i3));
            }
        ...
        public int getSerializedSize() {
            ...
            int dataSize = 0;
            for (int i = 0; i < this.strategyList_.size(); i++) {
                dataSize += CodedOutputStream.computeUInt32SizeNoTag(this.strategyList_.getInt(i));
            }
            int size2 = 0 + dataSize;
            if (!getStrategyListList().isEmpty()) {
                size2 = size2 + 1 + CodedOutputStream.computeInt32SizeNoTag(dataSize);
            }
            this.strategyListMemoizedSerializedSize = dataSize;
            if (this.slotCount_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(7, this.slotCount_);
            }
            if (this.storeId_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(8, this.storeId_);
            }
            int dataSize2 = 0;
            for (int i2 = 0; i2 < this.unk3300HNBGHCCENIA_.size(); i2++) {
                dataSize2 += CodedOutputStream.computeUInt32SizeNoTag(this.unk3300HNBGHCCENIA_.getInt(i2));
            }
            ...
            this.unk3300HNBGHCCENIAMemoizedSerializedSize = dataSize2;
            int dataSize3 = 0;
            for (int i3 = 0; i3 < this.unk3300ODLLANKOEND_.size(); i3++) {
                dataSize3 += CodedOutputStream.computeUInt32SizeNoTag(this.unk3300ODLLANKOEND_.getInt(i3));
            }
            ...
            this.unk3300ODLLANKOENDMemoizedSerializedSize = dataSize3;
        ...
        public boolean equals(Object obj) {
            ...
            return getStrategyListList().equals(other.getStrategyListList()) && getStoreId() == other.getStoreId() && getSlotCount() == other.getSlotCount() && getUnk3300HNBGHCCENIAList().equals(other.getUnk3300HNBGHCCENIAList()) && getUnk3300ODLLANKOENDList().equals(other.getUnk3300ODLLANKOENDList()) && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            if (getStrategyListCount() > 0) {
                hash = (53 * ((37 * hash) + 2)) + getStrategyListList().hashCode();
            }
            int hash2 = (53 * ((37 * ((53 * ((37 * hash) + 8)) + getStoreId())) + 7)) + getSlotCount();
            if (getUnk3300HNBGHCCENIACount() > 0) {
                hash2 = (53 * ((37 * hash2) + 10)) + getUnk3300HNBGHCCENIAList().hashCode();
            }
            if (getUnk3300ODLLANKOENDCount() > 0) {
                hash2 = (53 * ((37 * hash2) + 12)) + getUnk3300ODLLANKOENDList().hashCode();
            }
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements VintageMarketStoreInfoOrBuilder {
            ...
            @Override // emu.grasscutter.net.proto.VintageMarketStoreInfoOuterClass.VintageMarketStoreInfoOrBuilder
            public List<Integer> getStrategyListList() {
                return (this.bitField0_ & 1) != 0 ? Collections.unmodifiableList(this.strategyList_) : this.strategyList_;
            }
            ...
            @Override // emu.grasscutter.net.proto.VintageMarketStoreInfoOuterClass.VintageMarketStoreInfoOrBuilder
            public List<Integer> getUnk3300HNBGHCCENIAList() {
                return (this.bitField0_ & 2) != 0 ? Collections.unmodifiableList(this.unk3300HNBGHCCENIA_) : this.unk3300HNBGHCCENIA_;
            }
