...
public final class ChallengeBriefOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_ChallengeBrief_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_ChallengeBrief_descriptor, new String[]{"CurProgress", "IsSuccess", "ChallengeIndex", "ChallengeId"});
    ...
    public static final class ChallengeBrief extends GeneratedMessageV3 implements ChallengeBriefOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            if (this.challengeId_ != 0) {
                output.writeUInt32(2, this.challengeId_);
            }
            if (this.isSuccess_) {
            ...
            if (this.challengeIndex_ != 0) {
                output.writeUInt32(15, this.challengeIndex_);
            }
        ...
        public int getSerializedSize() {
            ...
            int size2 = 0;
            if (this.challengeId_ != 0) {
                size2 = 0 + CodedOutputStream.computeUInt32Size(2, this.challengeId_);
            }
            if (this.isSuccess_) {
                size2 += CodedOutputStream.computeBoolSize(5, this.isSuccess_);
            }
            if (this.curProgress_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(9, this.curProgress_);
            }
            if (this.challengeIndex_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(15, this.challengeIndex_);
            }
        ...
        public boolean equals(Object obj) {
            ...
            return getCurProgress() == other.getCurProgress() && getIsSuccess() == other.getIsSuccess() && getChallengeIndex() == other.getChallengeIndex() && getChallengeId() == other.getChallengeId() && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            int hash = (29 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * ((19 * 41) + getDescriptor().hashCode())) + 9)) + getCurProgress())) + 5)) + Internal.hashBoolean(getIsSuccess()))) + 15)) + getChallengeIndex())) + 2)) + getChallengeId())) + this.unknownFields.hashCode();
