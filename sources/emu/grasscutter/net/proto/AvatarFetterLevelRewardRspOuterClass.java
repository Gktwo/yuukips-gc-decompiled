...
public final class AvatarFetterLevelRewardRspOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_AvatarFetterLevelRewardRsp_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_AvatarFetterLevelRewardRsp_descriptor, new String[]{"Retcode", "RewardId", "FetterLevel", "AvatarGuid"});
    ...
    public static final class AvatarFetterLevelRewardRsp extends GeneratedMessageV3 implements AvatarFetterLevelRewardRspOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            if (this.fetterLevel_ != 0) {
                output.writeUInt32(1, this.fetterLevel_);
            }
            if (this.retcode_ != 0) {
        ...
        public int getSerializedSize() {
            ...
            int size2 = 0;
            if (this.fetterLevel_ != 0) {
                size2 = 0 + CodedOutputStream.computeUInt32Size(1, this.fetterLevel_);
            }
            if (this.retcode_ != 0) {
        ...
        public boolean equals(Object obj) {
            ...
            return getRetcode() == other.getRetcode() && getRewardId() == other.getRewardId() && getFetterLevel() == other.getFetterLevel() && getAvatarGuid() == other.getAvatarGuid() && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            int hash = (29 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * ((19 * 41) + getDescriptor().hashCode())) + 2)) + getRetcode())) + 15)) + getRewardId())) + 1)) + getFetterLevel())) + 6)) + Internal.hashLong(getAvatarGuid()))) + this.unknownFields.hashCode();
