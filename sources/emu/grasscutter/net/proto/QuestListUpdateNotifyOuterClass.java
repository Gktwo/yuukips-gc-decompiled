...
public final class QuestListUpdateNotifyOuterClass {
    ...
    /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/QuestListUpdateNotifyOuterClass$QuestListUpdateNotifyOrBuilder.class */
    ...
    public static final class QuestListUpdateNotify extends GeneratedMessageV3 implements QuestListUpdateNotifyOrBuilder {
        ...
        private static final Parser<QuestListUpdateNotify> PARSER = new AbstractParser<QuestListUpdateNotify>() { // from class: emu.grasscutter.net.proto.QuestListUpdateNotifyOuterClass.QuestListUpdateNotify.1
            @Override // com.google.protobuf.Parser
            public QuestListUpdateNotify parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new QuestListUpdateNotify(input, extensionRegistry);
            }
        };

        private QuestListUpdateNotify(GeneratedMessageV3.Builder<?> builder) {
            super(builder);
        ...
        private QuestListUpdateNotify(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this();
        ...
        @Override // emu.grasscutter.net.proto.QuestListUpdateNotifyOuterClass.QuestListUpdateNotifyOrBuilder
        ...
        public boolean equals(Object obj) {
            ...
            QuestListUpdateNotify other = (QuestListUpdateNotify) obj;
        ...
        public static QuestListUpdateNotify parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static QuestListUpdateNotify parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static QuestListUpdateNotify parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static QuestListUpdateNotify parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static QuestListUpdateNotify parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static QuestListUpdateNotify parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static QuestListUpdateNotify parseFrom(InputStream input) throws IOException {
            return (QuestListUpdateNotify) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static QuestListUpdateNotify parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (QuestListUpdateNotify) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }

        public static QuestListUpdateNotify parseDelimitedFrom(InputStream input) throws IOException {
            return (QuestListUpdateNotify) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input);
        }

        public static QuestListUpdateNotify parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (QuestListUpdateNotify) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
        }

        public static QuestListUpdateNotify parseFrom(CodedInputStream input) throws IOException {
            return (QuestListUpdateNotify) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static QuestListUpdateNotify parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (QuestListUpdateNotify) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(QuestListUpdateNotify prototype) {
        ...
        /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/QuestListUpdateNotifyOuterClass$QuestListUpdateNotify$Builder.class */
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements QuestListUpdateNotifyOrBuilder {
            ...
            public QuestListUpdateNotify build() {
                QuestListUpdateNotify result = buildPartial();
            ...
            public QuestListUpdateNotify buildPartial() {
                QuestListUpdateNotify result = new QuestListUpdateNotify(this);
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof QuestListUpdateNotify) {
                    return mergeFrom((QuestListUpdateNotify) other);
                }
                mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(QuestListUpdateNotify other) {
                ...
                if (this.questListBuilder_ == null) {
                    ...
                    if (this.questListBuilder_.isEmpty()) {
                        ...
                        this.questList_ = other.questList_;
                        this.bitField0_ &= -2;
                        this.questListBuilder_ = QuestListUpdateNotify.alwaysUseFieldBuilders ? getQuestListFieldBuilder() : null;
                    } else {
