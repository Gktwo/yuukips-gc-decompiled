...
public final class GetOnlinePlayerInfoRspOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_GetOnlinePlayerInfoRsp_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_GetOnlinePlayerInfoRsp_descriptor, new String[]{"TargetUid", "Param", "TargetPlayerInfo", "Retcode"});
    ...
    public static final class GetOnlinePlayerInfoRsp extends GeneratedMessageV3 implements GetOnlinePlayerInfoRspOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            if (this.param_ != 0) {
                output.writeUInt32(3, this.param_);
            }
        ...
        public int getSerializedSize() {
            ...
            int size2 = 0;
            if (this.param_ != 0) {
                size2 = 0 + CodedOutputStream.computeUInt32Size(3, this.param_);
            }
            if (this.targetPlayerInfo_ != null) {
                size2 += CodedOutputStream.computeMessageSize(6, getTargetPlayerInfo());
            }
            if (this.retcode_ != 0) {
                size2 += CodedOutputStream.computeInt32Size(7, this.retcode_);
            }
            if (this.targetUid_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(9, this.targetUid_);
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (getTargetUid() == other.getTargetUid() && getParam() == other.getParam() && hasTargetPlayerInfo() == other.hasTargetPlayerInfo()) {
                return (!hasTargetPlayerInfo() || getTargetPlayerInfo().equals(other.getTargetPlayerInfo())) && getRetcode() == other.getRetcode() && this.unknownFields.equals(other.unknownFields);
            }
            return false;
        }
        ...
        public int hashCode() {
            ...
            int hash = (53 * ((37 * ((53 * ((37 * ((19 * 41) + getDescriptor().hashCode())) + 9)) + getTargetUid())) + 3)) + getParam();
            if (hasTargetPlayerInfo()) {
                hash = (53 * ((37 * hash) + 6)) + getTargetPlayerInfo().hashCode();
            }
