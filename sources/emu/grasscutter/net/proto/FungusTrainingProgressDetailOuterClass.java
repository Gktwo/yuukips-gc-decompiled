...
public final class FungusTrainingProgressDetailOuterClass {
    private static Descriptors.FileDescriptor descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(new String[]{"\n\"FungusTrainingProgressDetail.proto\u001a FungusFighterMonsterDetail.proto\u001a%FungusTrainingPoolPreviewDetail.proto\"\u0002\n\u001cFungusTrainingProgressDetail\u0012\u001b\n\u0013Unk3300_EEOIMDJOHCM\u0018\n \u0003(\r\u0012\u0017\n\u000ftotal_used_time\u0018\u0003 \u0001(\r\u00128\n\u0013monster_detail_list\u0018\u000e \u0003(\u000b2\u001b.FungusFighterMonsterDetail\u0012\u0012\n\ndungeon_id\u0018\u0001 \u0001(\r\u0012C\n\u0019monster_pool_preview_list\u0018\u0005 \u0003(\u000b2 .FungusTrainingPoolPreviewDetail\u0012\u0011\n\tcur_round\u0018\t \u0001(\r\u0012\u001b\n\u0013Unk3300_NLHEFGBEOAC\u0018\u0004 \u0003(\rB\u001b\n\u0019emu.grasscutter.net.protob\u0006proto3"}, new Descriptors.FileDescriptor[]{FungusFighterMonsterDetailOuterClass.getDescriptor(), FungusTrainingPoolPreviewDetailOuterClass.getDescriptor()});
    ...
    public static final class FungusTrainingProgressDetail extends GeneratedMessageV3 implements FungusTrainingProgressDetailOrBuilder {
        ...
        /* JADX DEBUG: Failed to insert an additional move for type inference into block B:106:0x01e3 */
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            if (this.totalUsedTime_ != 0) {
                output.writeUInt32(3, this.totalUsedTime_);
            }
            if (getUnk3300NLHEFGBEOACList().size() > 0) {
                output.writeUInt32NoTag(34);
                output.writeUInt32NoTag(this.unk3300NLHEFGBEOACMemoizedSerializedSize);
            }
            for (int i = 0; i < this.unk3300NLHEFGBEOAC_.size(); i++) {
                output.writeUInt32NoTag(this.unk3300NLHEFGBEOAC_.getInt(i));
            }
            for (int i2 = 0; i2 < this.monsterPoolPreviewList_.size(); i2++) {
                output.writeMessage(5, this.monsterPoolPreviewList_.get(i2));
            }
            if (this.curRound_ != 0) {
                output.writeUInt32(9, this.curRound_);
            }
            if (getUnk3300EEOIMDJOHCMList().size() > 0) {
                output.writeUInt32NoTag(82);
                output.writeUInt32NoTag(this.unk3300EEOIMDJOHCMMemoizedSerializedSize);
            }
            for (int i3 = 0; i3 < this.unk3300EEOIMDJOHCM_.size(); i3++) {
                output.writeUInt32NoTag(this.unk3300EEOIMDJOHCM_.getInt(i3));
            }
            for (int i4 = 0; i4 < this.monsterDetailList_.size(); i4++) {
                output.writeMessage(14, this.monsterDetailList_.get(i4));
            }
        ...
        public int getSerializedSize() {
            ...
            if (this.totalUsedTime_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(3, this.totalUsedTime_);
            }
            int dataSize = 0;
            for (int i = 0; i < this.unk3300NLHEFGBEOAC_.size(); i++) {
                dataSize += CodedOutputStream.computeUInt32SizeNoTag(this.unk3300NLHEFGBEOAC_.getInt(i));
            }
            ...
            for (int i2 = 0; i2 < this.monsterPoolPreviewList_.size(); i2++) {
                size3 += CodedOutputStream.computeMessageSize(5, this.monsterPoolPreviewList_.get(i2));
            }
            if (this.curRound_ != 0) {
                size3 += CodedOutputStream.computeUInt32Size(9, this.curRound_);
            }
            int dataSize2 = 0;
            for (int i3 = 0; i3 < this.unk3300EEOIMDJOHCM_.size(); i3++) {
                dataSize2 += CodedOutputStream.computeUInt32SizeNoTag(this.unk3300EEOIMDJOHCM_.getInt(i3));
            }
            ...
            for (int i4 = 0; i4 < this.monsterDetailList_.size(); i4++) {
                size4 += CodedOutputStream.computeMessageSize(14, this.monsterDetailList_.get(i4));
            }
        ...
        public boolean equals(Object obj) {
            ...
            return getUnk3300EEOIMDJOHCMList().equals(other.getUnk3300EEOIMDJOHCMList()) && getTotalUsedTime() == other.getTotalUsedTime() && getMonsterDetailListList().equals(other.getMonsterDetailListList()) && getDungeonId() == other.getDungeonId() && getMonsterPoolPreviewListList().equals(other.getMonsterPoolPreviewListList()) && getCurRound() == other.getCurRound() && getUnk3300NLHEFGBEOACList().equals(other.getUnk3300NLHEFGBEOACList()) && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            if (getUnk3300EEOIMDJOHCMCount() > 0) {
                hash = (53 * ((37 * hash) + 10)) + getUnk3300EEOIMDJOHCMList().hashCode();
            }
            int hash2 = (53 * ((37 * hash) + 3)) + getTotalUsedTime();
            if (getMonsterDetailListCount() > 0) {
                hash2 = (53 * ((37 * hash2) + 14)) + getMonsterDetailListList().hashCode();
            }
            int hash3 = (53 * ((37 * hash2) + 1)) + getDungeonId();
            if (getMonsterPoolPreviewListCount() > 0) {
                hash3 = (53 * ((37 * hash3) + 5)) + getMonsterPoolPreviewListList().hashCode();
            }
            int hash4 = (53 * ((37 * hash3) + 9)) + getCurRound();
            if (getUnk3300NLHEFGBEOACCount() > 0) {
                hash4 = (53 * ((37 * hash4) + 4)) + getUnk3300NLHEFGBEOACList().hashCode();
            }
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements FungusTrainingProgressDetailOrBuilder {
            ...
            private RepeatedFieldBuilderV3<FungusFighterMonsterDetailOuterClass.FungusFighterMonsterDetail, FungusFighterMonsterDetailOuterClass.FungusFighterMonsterDetail.Builder, FungusFighterMonsterDetailOuterClass.FungusFighterMonsterDetailOrBuilder> getMonsterDetailListFieldBuilder() {
                if (this.monsterDetailListBuilder_ == null) {
                    this.monsterDetailListBuilder_ = new RepeatedFieldBuilderV3<>(this.monsterDetailList_, (this.bitField0_ & 2) != 0, getParentForChildren(), isClean());
            ...
            @Override // emu.grasscutter.net.proto.FungusTrainingProgressDetailOuterClass.FungusTrainingProgressDetailOrBuilder
            public List<Integer> getUnk3300NLHEFGBEOACList() {
                return (this.bitField0_ & 8) != 0 ? Collections.unmodifiableList(this.unk3300NLHEFGBEOAC_) : this.unk3300NLHEFGBEOAC_;
            }
