...
/* loaded from: grasscutter.jar:emu/grasscutter/net/proto/TrifleItemOuterClass.class */
public final class TrifleItemOuterClass {
    private static Descriptors.FileDescriptor descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(new String[]{"\n\u0010TrifleItem.proto\u001a\u000eMaterial.proto\u001a\u000bEquip.proto\u001a\u000fFurniture.proto\"\u0001\n\nTrifleItem\u0012\u000e\n\u0006itemId\u0018\u0001 \u0001(\r\u0012\f\n\u0004guid\u0018\u0002 \u0001(\u0004\u0012\u001d\n\bmaterial\u0018\u0005 \u0001(\u000b2\t.MaterialH��\u0012\u0017\n\u0005equip\u0018\u0006 \u0001(\u000b2\u0006.EquipH��\u0012\u001f\n\tfurniture\u0018\u0007 \u0001(\u000b2\n.FurnitureH��B\b\n\u0006detailB\u001b\n\u0019emu.grasscutter.net.protob\u0006proto3"}, new Descriptors.FileDescriptor[]{MaterialOuterClass.getDescriptor(), EquipOuterClass.getDescriptor(), FurnitureOuterClass.getDescriptor()});
    private static final Descriptors.Descriptor internal_static_TrifleItem_descriptor = getDescriptor().getMessageTypes().get(0);
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_TrifleItem_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_TrifleItem_descriptor, new String[]{"ItemId", "Guid", "Material", "Equip", "Furniture", "Detail"});

    /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/TrifleItemOuterClass$TrifleItemOrBuilder.class */
    public interface TrifleItemOrBuilder extends MessageOrBuilder {
        int getItemId();
        ...
        TrifleItem.DetailCase getDetailCase();
    }
    ...
    /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/TrifleItemOuterClass$TrifleItem.class */
    public static final class TrifleItem extends GeneratedMessageV3 implements TrifleItemOrBuilder {
        ...
        private static final TrifleItem DEFAULT_INSTANCE = new TrifleItem();
        private static final Parser<TrifleItem> PARSER = new AbstractParser<TrifleItem>() { // from class: emu.grasscutter.net.proto.TrifleItemOuterClass.TrifleItem.1
            @Override // com.google.protobuf.Parser
            public TrifleItem parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new TrifleItem(input, extensionRegistry);
            }
        };

        private TrifleItem(GeneratedMessageV3.Builder<?> builder) {
            super(builder);
            this.detailCase_ = 0;
        ...
        private TrifleItem(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this();
        ...
        protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return TrifleItemOuterClass.internal_static_TrifleItem_fieldAccessorTable.ensureFieldAccessorsInitialized(TrifleItem.class, Builder.class);
        }

        /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/TrifleItemOuterClass$TrifleItem$DetailCase.class */
        ...
        @Override // emu.grasscutter.net.proto.TrifleItemOuterClass.TrifleItemOrBuilder
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof TrifleItem)) {
                return equals(obj);
            }
            TrifleItem other = (TrifleItem) obj;
        ...
        public static TrifleItem parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static TrifleItem parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static TrifleItem parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static TrifleItem parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static TrifleItem parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static TrifleItem parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static TrifleItem parseFrom(InputStream input) throws IOException {
            return (TrifleItem) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static TrifleItem parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (TrifleItem) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }

        public static TrifleItem parseDelimitedFrom(InputStream input) throws IOException {
            return (TrifleItem) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input);
        }

        public static TrifleItem parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (TrifleItem) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
        }

        public static TrifleItem parseFrom(CodedInputStream input) throws IOException {
            return (TrifleItem) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static TrifleItem parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (TrifleItem) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(TrifleItem prototype) {
        ...
        /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/TrifleItemOuterClass$TrifleItem$Builder.class */
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements TrifleItemOrBuilder {
            ...
            private void maybeForceBuilderInitialization() {
                if (TrifleItem.alwaysUseFieldBuilders) {
                }
            }
            ...
            public TrifleItem getDefaultInstanceForType() {
                return TrifleItem.getDefaultInstance();
            }

            @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
            public TrifleItem build() {
                TrifleItem result = buildPartial();
            ...
            @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
            public TrifleItem buildPartial() {
                TrifleItem result = new TrifleItem(this);
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof TrifleItem) {
                    return mergeFrom((TrifleItem) other);
                }
                mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(TrifleItem other) {
                if (other == TrifleItem.getDefaultInstance()) {
                    return this;
                }
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                TrifleItem parsedMessage = null;
                try {
                    try {
                        parsedMessage = TrifleItem.PARSER.parsePartialFrom(input, extensionRegistry);
                        if (parsedMessage != null) {
                            mergeFrom(parsedMessage);
                        }
                        return this;
                    } catch (InvalidProtocolBufferException e) {
                        parsedMessage = (TrifleItem) e.getUnfinishedMessage();
        ...
        public static TrifleItem getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }

        public static Parser<TrifleItem> parser() {
            return PARSER;
        }

        @Override // com.google.protobuf.GeneratedMessageV3, com.google.protobuf.MessageLite, com.google.protobuf.Message
        public Parser<TrifleItem> getParserForType() {
            return PARSER;
        }
