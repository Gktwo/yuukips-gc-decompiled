...
public final class SkyCrystalDetectorDataOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_SkyCrystalDetectorData_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_SkyCrystalDetectorData_descriptor, new String[]{"HintCenterPos", "GroupId", "ConfigId", "IsHintValid"});
    ...
    public static final class SkyCrystalDetectorData extends GeneratedMessageV3 implements SkyCrystalDetectorDataOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            if (this.configId_ != 0) {
                output.writeUInt32(8, this.configId_);
            }
            if (this.groupId_ != 0) {
        ...
        public int getSerializedSize() {
            ...
            int size2 = 0;
            if (this.isHintValid_) {
                size2 = 0 + CodedOutputStream.computeBoolSize(3, this.isHintValid_);
            }
            if (this.hintCenterPos_ != null) {
                size2 += CodedOutputStream.computeMessageSize(6, getHintCenterPos());
            }
            if (this.configId_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(8, this.configId_);
            }
            if (this.groupId_ != 0) {
        ...
        public boolean equals(Object obj) {
            ...
            if (hasHintCenterPos() != other.hasHintCenterPos()) {
                return false;
            }
            return (!hasHintCenterPos() || getHintCenterPos().equals(other.getHintCenterPos())) && getGroupId() == other.getGroupId() && getConfigId() == other.getConfigId() && getIsHintValid() == other.getIsHintValid() && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            if (hasHintCenterPos()) {
                hash = (53 * ((37 * hash) + 6)) + getHintCenterPos().hashCode();
            }
            int hash2 = (29 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * hash) + 14)) + getGroupId())) + 8)) + getConfigId())) + 3)) + Internal.hashBoolean(getIsHintValid()))) + this.unknownFields.hashCode();
