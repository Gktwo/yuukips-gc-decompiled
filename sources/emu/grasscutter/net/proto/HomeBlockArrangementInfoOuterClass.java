...
public final class HomeBlockArrangementInfoOuterClass {
    private static Descriptors.FileDescriptor descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(new String[]{"\n\u001eHomeBlockArrangementInfo.proto\u001a\u001cHomeFurnitureSuiteData.proto\u001a\u0018HomeBlockFieldData.proto\u001a\u0016WeekendDjinnInfo.proto\u001a\u0017HomeFurnitureData.proto\u001a\u0019HomeBlockDotPattern.proto\u001a\u001cHomeFurnitureGroupData.proto\u001a\u0011HomeNpcData.proto\u001a\"HomeFurnitureCustomSuiteData.proto\u001a\u0014HomeAnimalData.proto\"¼\u0004\n\u0018HomeBlockArrangementInfo\u00123\n\u0012furnitureSuiteList\u0018\f \u0003(\u000b2\u0017.HomeFurnitureSuiteData\u0012&\n\tfieldList\u0018\r \u0003(\u000b2\u0013.HomeBlockFieldData\u0012/\n\u0014weekendDjinnInfoList\u0018\b \u0003(\u000b2\u0011.WeekendDjinnInfo\u00123\n\u0017persistentFurnitureList\u0018\u0006 \u0003(\u000b2\u0012.HomeFurnitureData\u0012,\n\u000edotPatternList\u0018\u0007 \u0003(\u000b2\u0014.HomeBlockDotPattern\u0012\u0014\n\fcomfortValue\u0018\t \u0001(\r\u00123\n\u0012furnitureGroupList\u0018\u0003 \u0003(\u000b2\u0017.HomeFurnitureGroupData\u0012.\n\u0012deployFurniureList\u0018\u000f \u0003(\u000b2\u0012.HomeFurnitureData\u0012#\n\rdeployNpcList\u0018\u0005 \u0003(\u000b2\f.HomeNpcData\u0012?\n\u0018furnitureCustomSuiteList\u0018\u0004 \u0003(\u000b2\u001d.HomeFurnitureCustomSuiteData\u0012\u0012\n\nisUnlocked\u0018\u0001 \u0001(\b\u0012\u000f\n\u0007blockId\u0018\u0002 \u0001(\r\u0012)\n\u0010deployAnimalList\u0018\u000e \u0003(\u000b2\u000f.HomeAnimalDataB\u001b\n\u0019emu.grasscutter.net.protob\u0006proto3"}, new Descriptors.FileDescriptor[]{HomeFurnitureSuiteDataOuterClass.getDescriptor(), HomeBlockFieldDataOuterClass.getDescriptor(), WeekendDjinnInfoOuterClass.getDescriptor(), HomeFurnitureDataOuterClass.getDescriptor(), HomeBlockDotPatternOuterClass.getDescriptor(), HomeFurnitureGroupDataOuterClass.getDescriptor(), HomeNpcDataOuterClass.getDescriptor(), HomeFurnitureCustomSuiteDataOuterClass.getDescriptor(), HomeAnimalDataOuterClass.getDescriptor()});
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_HomeBlockArrangementInfo_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_HomeBlockArrangementInfo_descriptor, new String[]{"FurnitureSuiteList", "FieldList", "WeekendDjinnInfoList", "PersistentFurnitureList", "DotPatternList", "ComfortValue", "FurnitureGroupList", "DeployFurniureList", "DeployNpcList", "FurnitureCustomSuiteList", "IsUnlocked", "BlockId", "DeployAnimalList"});
    ...
    public static final class HomeBlockArrangementInfo extends GeneratedMessageV3 implements HomeBlockArrangementInfoOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            if (this.blockId_ != 0) {
                output.writeUInt32(2, this.blockId_);
            }
            for (int i = 0; i < this.furnitureGroupList_.size(); i++) {
                output.writeMessage(3, this.furnitureGroupList_.get(i));
            }
            for (int i2 = 0; i2 < this.furnitureCustomSuiteList_.size(); i2++) {
                output.writeMessage(4, this.furnitureCustomSuiteList_.get(i2));
            }
            for (int i3 = 0; i3 < this.deployNpcList_.size(); i3++) {
                output.writeMessage(5, this.deployNpcList_.get(i3));
            }
            for (int i4 = 0; i4 < this.persistentFurnitureList_.size(); i4++) {
                output.writeMessage(6, this.persistentFurnitureList_.get(i4));
            }
            for (int i5 = 0; i5 < this.dotPatternList_.size(); i5++) {
                output.writeMessage(7, this.dotPatternList_.get(i5));
            }
            for (int i6 = 0; i6 < this.weekendDjinnInfoList_.size(); i6++) {
                output.writeMessage(8, this.weekendDjinnInfoList_.get(i6));
            }
            if (this.comfortValue_ != 0) {
                output.writeUInt32(9, this.comfortValue_);
            }
            for (int i7 = 0; i7 < this.furnitureSuiteList_.size(); i7++) {
                output.writeMessage(12, this.furnitureSuiteList_.get(i7));
            }
            for (int i8 = 0; i8 < this.fieldList_.size(); i8++) {
                output.writeMessage(13, this.fieldList_.get(i8));
            }
            for (int i9 = 0; i9 < this.deployAnimalList_.size(); i9++) {
                output.writeMessage(14, this.deployAnimalList_.get(i9));
            }
            for (int i10 = 0; i10 < this.deployFurniureList_.size(); i10++) {
                output.writeMessage(15, this.deployFurniureList_.get(i10));
            }
        ...
        public int getSerializedSize() {
            ...
            int size2 = 0;
            if (this.isUnlocked_) {
                size2 = 0 + CodedOutputStream.computeBoolSize(1, this.isUnlocked_);
            }
            if (this.blockId_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(2, this.blockId_);
            }
            for (int i = 0; i < this.furnitureGroupList_.size(); i++) {
                size2 += CodedOutputStream.computeMessageSize(3, this.furnitureGroupList_.get(i));
            }
            for (int i2 = 0; i2 < this.furnitureCustomSuiteList_.size(); i2++) {
                size2 += CodedOutputStream.computeMessageSize(4, this.furnitureCustomSuiteList_.get(i2));
            }
            for (int i3 = 0; i3 < this.deployNpcList_.size(); i3++) {
                size2 += CodedOutputStream.computeMessageSize(5, this.deployNpcList_.get(i3));
            }
            for (int i4 = 0; i4 < this.persistentFurnitureList_.size(); i4++) {
                size2 += CodedOutputStream.computeMessageSize(6, this.persistentFurnitureList_.get(i4));
            }
            for (int i5 = 0; i5 < this.dotPatternList_.size(); i5++) {
                size2 += CodedOutputStream.computeMessageSize(7, this.dotPatternList_.get(i5));
            }
            for (int i6 = 0; i6 < this.weekendDjinnInfoList_.size(); i6++) {
                size2 += CodedOutputStream.computeMessageSize(8, this.weekendDjinnInfoList_.get(i6));
            }
            if (this.comfortValue_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(9, this.comfortValue_);
            }
            for (int i7 = 0; i7 < this.furnitureSuiteList_.size(); i7++) {
                size2 += CodedOutputStream.computeMessageSize(12, this.furnitureSuiteList_.get(i7));
            }
            for (int i8 = 0; i8 < this.fieldList_.size(); i8++) {
                size2 += CodedOutputStream.computeMessageSize(13, this.fieldList_.get(i8));
            }
            for (int i9 = 0; i9 < this.deployAnimalList_.size(); i9++) {
                size2 += CodedOutputStream.computeMessageSize(14, this.deployAnimalList_.get(i9));
            }
            for (int i10 = 0; i10 < this.deployFurniureList_.size(); i10++) {
                size2 += CodedOutputStream.computeMessageSize(15, this.deployFurniureList_.get(i10));
            }
        ...
        public boolean equals(Object obj) {
            ...
            return getFurnitureSuiteListList().equals(other.getFurnitureSuiteListList()) && getFieldListList().equals(other.getFieldListList()) && getWeekendDjinnInfoListList().equals(other.getWeekendDjinnInfoListList()) && getPersistentFurnitureListList().equals(other.getPersistentFurnitureListList()) && getDotPatternListList().equals(other.getDotPatternListList()) && getComfortValue() == other.getComfortValue() && getFurnitureGroupListList().equals(other.getFurnitureGroupListList()) && getDeployFurniureListList().equals(other.getDeployFurniureListList()) && getDeployNpcListList().equals(other.getDeployNpcListList()) && getFurnitureCustomSuiteListList().equals(other.getFurnitureCustomSuiteListList()) && getIsUnlocked() == other.getIsUnlocked() && getBlockId() == other.getBlockId() && getDeployAnimalListList().equals(other.getDeployAnimalListList()) && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            if (getFurnitureSuiteListCount() > 0) {
                hash = (53 * ((37 * hash) + 12)) + getFurnitureSuiteListList().hashCode();
            }
            if (getFieldListCount() > 0) {
                hash = (53 * ((37 * hash) + 13)) + getFieldListList().hashCode();
            }
            if (getWeekendDjinnInfoListCount() > 0) {
                hash = (53 * ((37 * hash) + 8)) + getWeekendDjinnInfoListList().hashCode();
            }
            if (getPersistentFurnitureListCount() > 0) {
                hash = (53 * ((37 * hash) + 6)) + getPersistentFurnitureListList().hashCode();
            }
            if (getDotPatternListCount() > 0) {
                hash = (53 * ((37 * hash) + 7)) + getDotPatternListList().hashCode();
            }
            int hash2 = (53 * ((37 * hash) + 9)) + getComfortValue();
            if (getFurnitureGroupListCount() > 0) {
                hash2 = (53 * ((37 * hash2) + 3)) + getFurnitureGroupListList().hashCode();
            }
            if (getDeployFurniureListCount() > 0) {
                hash2 = (53 * ((37 * hash2) + 15)) + getDeployFurniureListList().hashCode();
            }
            if (getDeployNpcListCount() > 0) {
                hash2 = (53 * ((37 * hash2) + 5)) + getDeployNpcListList().hashCode();
            }
            if (getFurnitureCustomSuiteListCount() > 0) {
                hash2 = (53 * ((37 * hash2) + 4)) + getFurnitureCustomSuiteListList().hashCode();
            }
            int hash3 = (53 * ((37 * ((53 * ((37 * hash2) + 1)) + Internal.hashBoolean(getIsUnlocked()))) + 2)) + getBlockId();
            if (getDeployAnimalListCount() > 0) {
                hash3 = (53 * ((37 * hash3) + 14)) + getDeployAnimalListList().hashCode();
            }
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements HomeBlockArrangementInfoOrBuilder {
            ...
            private RepeatedFieldBuilderV3<HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData, HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData.Builder, HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteDataOrBuilder> getFurnitureSuiteListFieldBuilder() {
                if (this.furnitureSuiteListBuilder_ == null) {
                    this.furnitureSuiteListBuilder_ = new RepeatedFieldBuilderV3<>(this.furnitureSuiteList_, (this.bitField0_ & 1) != 0, getParentForChildren(), isClean());
            ...
            private RepeatedFieldBuilderV3<WeekendDjinnInfoOuterClass.WeekendDjinnInfo, WeekendDjinnInfoOuterClass.WeekendDjinnInfo.Builder, WeekendDjinnInfoOuterClass.WeekendDjinnInfoOrBuilder> getWeekendDjinnInfoListFieldBuilder() {
                if (this.weekendDjinnInfoListBuilder_ == null) {
                    this.weekendDjinnInfoListBuilder_ = new RepeatedFieldBuilderV3<>(this.weekendDjinnInfoList_, (this.bitField0_ & 4) != 0, getParentForChildren(), isClean());
            ...
            private RepeatedFieldBuilderV3<HomeFurnitureDataOuterClass.HomeFurnitureData, HomeFurnitureDataOuterClass.HomeFurnitureData.Builder, HomeFurnitureDataOuterClass.HomeFurnitureDataOrBuilder> getPersistentFurnitureListFieldBuilder() {
                if (this.persistentFurnitureListBuilder_ == null) {
                    this.persistentFurnitureListBuilder_ = new RepeatedFieldBuilderV3<>(this.persistentFurnitureList_, (this.bitField0_ & 8) != 0, getParentForChildren(), isClean());
            ...
            private RepeatedFieldBuilderV3<HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData, HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupData.Builder, HomeFurnitureGroupDataOuterClass.HomeFurnitureGroupDataOrBuilder> getFurnitureGroupListFieldBuilder() {
                if (this.furnitureGroupListBuilder_ == null) {
                    this.furnitureGroupListBuilder_ = new RepeatedFieldBuilderV3<>(this.furnitureGroupList_, (this.bitField0_ & 32) != 0, getParentForChildren(), isClean());
            ...
            private RepeatedFieldBuilderV3<HomeFurnitureDataOuterClass.HomeFurnitureData, HomeFurnitureDataOuterClass.HomeFurnitureData.Builder, HomeFurnitureDataOuterClass.HomeFurnitureDataOrBuilder> getDeployFurniureListFieldBuilder() {
                if (this.deployFurniureListBuilder_ == null) {
                    this.deployFurniureListBuilder_ = new RepeatedFieldBuilderV3<>(this.deployFurniureList_, (this.bitField0_ & 64) != 0, getParentForChildren(), isClean());
            ...
            private RepeatedFieldBuilderV3<HomeNpcDataOuterClass.HomeNpcData, HomeNpcDataOuterClass.HomeNpcData.Builder, HomeNpcDataOuterClass.HomeNpcDataOrBuilder> getDeployNpcListFieldBuilder() {
                if (this.deployNpcListBuilder_ == null) {
                    this.deployNpcListBuilder_ = new RepeatedFieldBuilderV3<>(this.deployNpcList_, (this.bitField0_ & 128) != 0, getParentForChildren(), isClean());
            ...
            private RepeatedFieldBuilderV3<HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData, HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData.Builder, HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteDataOrBuilder> getFurnitureCustomSuiteListFieldBuilder() {
                if (this.furnitureCustomSuiteListBuilder_ == null) {
                    this.furnitureCustomSuiteListBuilder_ = new RepeatedFieldBuilderV3<>(this.furnitureCustomSuiteList_, (this.bitField0_ & 256) != 0, getParentForChildren(), isClean());
            ...
            private RepeatedFieldBuilderV3<HomeAnimalDataOuterClass.HomeAnimalData, HomeAnimalDataOuterClass.HomeAnimalData.Builder, HomeAnimalDataOuterClass.HomeAnimalDataOrBuilder> getDeployAnimalListFieldBuilder() {
                if (this.deployAnimalListBuilder_ == null) {
                    this.deployAnimalListBuilder_ = new RepeatedFieldBuilderV3<>(this.deployAnimalList_, (this.bitField0_ & 512) != 0, getParentForChildren(), isClean());
