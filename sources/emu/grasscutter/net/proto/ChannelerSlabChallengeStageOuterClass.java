...
public final class ChannelerSlabChallengeStageOuterClass {
    private static Descriptors.FileDescriptor descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(new String[]{"\n!ChannelerSlabChallengeStage.proto\u001a ChannelerSlabOneoffDungeon.proto\u001a\u001cChannelerSlabChallenge.proto\"²\u0001\n\u001bChannelerSlabChallengeStage\u0012\u0010\n\bopenTime\u0018\n \u0001(\r\u0012.\n\rchallengeList\u0018\f \u0003(\u000b2\u0017.ChannelerSlabChallenge\u00120\n\u000bdungeonInfo\u0018\u0005 \u0001(\u000b2\u001b.ChannelerSlabOneoffDungeon\u0012\u000f\n\u0007stageId\u0018\r \u0001(\r\u0012\u000e\n\u0006isOpen\u0018\u0001 \u0001(\bB\u001b\n\u0019emu.grasscutter.net.protob\u0006proto3"}, new Descriptors.FileDescriptor[]{ChannelerSlabOneoffDungeonOuterClass.getDescriptor(), ChannelerSlabChallengeOuterClass.getDescriptor()});
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_ChannelerSlabChallengeStage_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_ChannelerSlabChallengeStage_descriptor, new String[]{"OpenTime", "ChallengeList", "DungeonInfo", "StageId", "IsOpen"});
    ...
    public static final class ChannelerSlabChallengeStage extends GeneratedMessageV3 implements ChannelerSlabChallengeStageOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            for (int i = 0; i < this.challengeList_.size(); i++) {
                output.writeMessage(12, this.challengeList_.get(i));
            }
            if (this.stageId_ != 0) {
        ...
        public int getSerializedSize() {
            ...
            if (this.dungeonInfo_ != null) {
                size2 += CodedOutputStream.computeMessageSize(5, getDungeonInfo());
            }
            if (this.openTime_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(10, this.openTime_);
            }
            for (int i = 0; i < this.challengeList_.size(); i++) {
                size2 += CodedOutputStream.computeMessageSize(12, this.challengeList_.get(i));
            }
            if (this.stageId_ != 0) {
        ...
        public boolean equals(Object obj) {
            ...
            if (getOpenTime() == other.getOpenTime() && getChallengeListList().equals(other.getChallengeListList()) && hasDungeonInfo() == other.hasDungeonInfo()) {
                return (!hasDungeonInfo() || getDungeonInfo().equals(other.getDungeonInfo())) && getStageId() == other.getStageId() && getIsOpen() == other.getIsOpen() && this.unknownFields.equals(other.unknownFields);
            }
            return false;
        }
        ...
        public int hashCode() {
            ...
            if (getChallengeListCount() > 0) {
                hash = (53 * ((37 * hash) + 12)) + getChallengeListList().hashCode();
            }
            if (hasDungeonInfo()) {
                hash = (53 * ((37 * hash) + 5)) + getDungeonInfo().hashCode();
            }
            int hash2 = (29 * ((53 * ((37 * ((53 * ((37 * hash) + 13)) + getStageId())) + 1)) + Internal.hashBoolean(getIsOpen()))) + this.unknownFields.hashCode();
