...
public final class SummerTimeV2DungeonStageInfoOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_SummerTimeV2DungeonStageInfo_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_SummerTimeV2DungeonStageInfo_descriptor, new String[]{"IsPrevDungeonSucceed", "IsOpen", "OpenTime", "StageId"});
    ...
    public static final class SummerTimeV2DungeonStageInfo extends GeneratedMessageV3 implements SummerTimeV2DungeonStageInfoOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            if (this.isPrevDungeonSucceed_) {
                output.writeBool(4, this.isPrevDungeonSucceed_);
            }
            if (this.stageId_ != 0) {
        ...
        public int getSerializedSize() {
            ...
            int size2 = 0;
            if (this.isPrevDungeonSucceed_) {
                size2 = 0 + CodedOutputStream.computeBoolSize(4, this.isPrevDungeonSucceed_);
            }
            if (this.stageId_ != 0) {
        ...
        public boolean equals(Object obj) {
            ...
            return getIsPrevDungeonSucceed() == other.getIsPrevDungeonSucceed() && getIsOpen() == other.getIsOpen() && getOpenTime() == other.getOpenTime() && getStageId() == other.getStageId() && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            int hash = (29 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * ((19 * 41) + getDescriptor().hashCode())) + 4)) + Internal.hashBoolean(getIsPrevDungeonSucceed()))) + 14)) + Internal.hashBoolean(getIsOpen()))) + 13)) + getOpenTime())) + 6)) + getStageId())) + this.unknownFields.hashCode();
