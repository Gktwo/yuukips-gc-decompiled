...
public final class QuestGlobalVarOuterClass {
    ...
    public static final class QuestGlobalVar extends GeneratedMessageV3 implements QuestGlobalVarOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            if (this.value_ != 0) {
                output.writeInt32(4, this.value_);
            }
            if (this.key_ != 0) {
        ...
        public int getSerializedSize() {
            ...
            int size2 = 0;
            if (this.value_ != 0) {
                size2 = 0 + CodedOutputStream.computeInt32Size(4, this.value_);
            }
            if (this.key_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(9, this.key_);
            }
        ...
        public int hashCode() {
            ...
            int hash = (29 * ((53 * ((37 * ((53 * ((37 * ((19 * 41) + getDescriptor().hashCode())) + 4)) + getValue())) + 9)) + getKey())) + this.unknownFields.hashCode();
