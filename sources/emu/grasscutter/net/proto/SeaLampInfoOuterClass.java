...
/* loaded from: grasscutter.jar:emu/grasscutter/net/proto/SeaLampInfoOuterClass.class */
public final class SeaLampInfoOuterClass {
    private static Descriptors.FileDescriptor descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(new String[]{"\n\u0011SeaLampInfo.proto\u001a\u0018SeaLampSectionInfo.proto\"÷\u0001\n\u000bSeaLampInfo\u0012\u0014\n\fleftMonsters\u0018\u0001 \u0001(\b\u0012\u001b\n\u0013Unk3300_BAJIGNGJALG\u0018\u0003 \u0001(\b\u0012,\n\u000fsectionInfoList\u0018\u0002 \u0003(\u000b2\u0013.SeaLampSectionInfo\u0012\u0019\n\u0011firstDayStartTime\u0018\n \u0001(\r\u0012\u0012\n\npopularity\u0018\u0005 \u0001(\r\u0012\u001b\n\u0013Unk3300_JMPCJGJHPIH\u0018\u000e \u0001(\b\u0012\u0010\n\bdayIndex\u0018\u0004 \u0001(\r\u0012\u0014\n\fmechanicusId\u0018\f \u0001(\r\u0012\u0013\n\u000bseaLampCoin\u0018\u0006 \u0001(\rB\u001b\n\u0019emu.grasscutter.net.protob\u0006proto3"}, new Descriptors.FileDescriptor[]{SeaLampSectionInfoOuterClass.getDescriptor()});
    private static final Descriptors.Descriptor internal_static_SeaLampInfo_descriptor = getDescriptor().getMessageTypes().get(0);
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_SeaLampInfo_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_SeaLampInfo_descriptor, new String[]{"LeftMonsters", "Unk3300BAJIGNGJALG", "SectionInfoList", "FirstDayStartTime", "Popularity", "Unk3300JMPCJGJHPIH", "DayIndex", "MechanicusId", "SeaLampCoin"});

    /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/SeaLampInfoOuterClass$SeaLampInfoOrBuilder.class */
    public interface SeaLampInfoOrBuilder extends MessageOrBuilder {
    ...
    /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/SeaLampInfoOuterClass$SeaLampInfo.class */
    public static final class SeaLampInfo extends GeneratedMessageV3 implements SeaLampInfoOrBuilder {
        ...
        private static final SeaLampInfo DEFAULT_INSTANCE = new SeaLampInfo();
        private static final Parser<SeaLampInfo> PARSER = new AbstractParser<SeaLampInfo>() { // from class: emu.grasscutter.net.proto.SeaLampInfoOuterClass.SeaLampInfo.1
            @Override // com.google.protobuf.Parser
            public SeaLampInfo parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new SeaLampInfo(input, extensionRegistry);
            }
        };

        private SeaLampInfo(GeneratedMessageV3.Builder<?> builder) {
            super(builder);
        ...
        private SeaLampInfo(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this();
        ...
        protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return SeaLampInfoOuterClass.internal_static_SeaLampInfo_fieldAccessorTable.ensureFieldAccessorsInitialized(SeaLampInfo.class, Builder.class);
        }

        @Override // emu.grasscutter.net.proto.SeaLampInfoOuterClass.SeaLampInfoOrBuilder
        ...
        public boolean equals(Object obj) {
            ...
            if (!(obj instanceof SeaLampInfo)) {
                return equals(obj);
            }
            SeaLampInfo other = (SeaLampInfo) obj;
        ...
        public static SeaLampInfo parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static SeaLampInfo parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static SeaLampInfo parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static SeaLampInfo parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static SeaLampInfo parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static SeaLampInfo parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static SeaLampInfo parseFrom(InputStream input) throws IOException {
            return (SeaLampInfo) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static SeaLampInfo parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (SeaLampInfo) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }

        public static SeaLampInfo parseDelimitedFrom(InputStream input) throws IOException {
            return (SeaLampInfo) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input);
        }

        public static SeaLampInfo parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (SeaLampInfo) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
        }

        public static SeaLampInfo parseFrom(CodedInputStream input) throws IOException {
            return (SeaLampInfo) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static SeaLampInfo parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (SeaLampInfo) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(SeaLampInfo prototype) {
        ...
        /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/SeaLampInfoOuterClass$SeaLampInfo$Builder.class */
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements SeaLampInfoOrBuilder {
            ...
            private void maybeForceBuilderInitialization() {
                if (SeaLampInfo.alwaysUseFieldBuilders) {
            ...
            public SeaLampInfo getDefaultInstanceForType() {
                return SeaLampInfo.getDefaultInstance();
            }

            @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
            public SeaLampInfo build() {
                SeaLampInfo result = buildPartial();
            ...
            @Override // com.google.protobuf.MessageLite.Builder, com.google.protobuf.Message.Builder
            public SeaLampInfo buildPartial() {
                SeaLampInfo result = new SeaLampInfo(this);
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof SeaLampInfo) {
                    return mergeFrom((SeaLampInfo) other);
                }
                mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(SeaLampInfo other) {
                if (other == SeaLampInfo.getDefaultInstance()) {
                    return this;
                }
                ...
                if (this.sectionInfoListBuilder_ == null) {
                    ...
                    if (this.sectionInfoListBuilder_.isEmpty()) {
                        ...
                        this.sectionInfoList_ = other.sectionInfoList_;
                        this.bitField0_ &= -2;
                        this.sectionInfoListBuilder_ = SeaLampInfo.alwaysUseFieldBuilders ? getSectionInfoListFieldBuilder() : null;
                    } else {
            ...
            public Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
                SeaLampInfo parsedMessage = null;
                try {
                    try {
                        parsedMessage = SeaLampInfo.PARSER.parsePartialFrom(input, extensionRegistry);
                        if (parsedMessage != null) {
                            mergeFrom(parsedMessage);
                        }
                        return this;
                    } catch (InvalidProtocolBufferException e) {
                        parsedMessage = (SeaLampInfo) e.getUnfinishedMessage();
        ...
        public static SeaLampInfo getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }

        public static Parser<SeaLampInfo> parser() {
            return PARSER;
        }

        @Override // com.google.protobuf.GeneratedMessageV3, com.google.protobuf.MessageLite, com.google.protobuf.Message
        public Parser<SeaLampInfo> getParserForType() {
            return PARSER;
        }
