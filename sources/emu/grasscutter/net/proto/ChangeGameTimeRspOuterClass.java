...
public final class ChangeGameTimeRspOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_ChangeGameTimeRsp_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_ChangeGameTimeRsp_descriptor, new String[]{"CurGameTime", "ExtraDays", "Retcode"});
    ...
    public static final class ChangeGameTimeRsp extends GeneratedMessageV3 implements ChangeGameTimeRspOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            if (this.extraDays_ != 0) {
                output.writeUInt32(5, this.extraDays_);
            }
            if (this.retcode_ != 0) {
                output.writeInt32(7, this.retcode_);
            }
            if (this.curGameTime_ != 0) {
                output.writeUInt32(15, this.curGameTime_);
            }
        ...
        public int getSerializedSize() {
            ...
            int size2 = 0;
            if (this.extraDays_ != 0) {
                size2 = 0 + CodedOutputStream.computeUInt32Size(5, this.extraDays_);
            }
            if (this.retcode_ != 0) {
                size2 += CodedOutputStream.computeInt32Size(7, this.retcode_);
            }
            if (this.curGameTime_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(15, this.curGameTime_);
            }
        ...
        public boolean equals(Object obj) {
            ...
            return getCurGameTime() == other.getCurGameTime() && getExtraDays() == other.getExtraDays() && getRetcode() == other.getRetcode() && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            int hash = (29 * ((53 * ((37 * ((53 * ((37 * ((53 * ((37 * ((19 * 41) + getDescriptor().hashCode())) + 15)) + getCurGameTime())) + 5)) + getExtraDays())) + 7)) + getRetcode())) + this.unknownFields.hashCode();
