...
/* loaded from: grasscutter.jar:emu/grasscutter/net/proto/PlatformStopRouteNotifyOuterClass.class */
public final class PlatformStopRouteNotifyOuterClass {
    ...
    private static final Descriptors.Descriptor internal_static_PlatformStopRouteNotify_descriptor = getDescriptor().getMessageTypes().get(0);
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_PlatformStopRouteNotify_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_PlatformStopRouteNotify_descriptor, new String[]{"Platform", "SceneTime", "EntityId"});

    /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/PlatformStopRouteNotifyOuterClass$PlatformStopRouteNotifyOrBuilder.class */
    ...
    /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/PlatformStopRouteNotifyOuterClass$PlatformStopRouteNotify.class */
    public static final class PlatformStopRouteNotify extends GeneratedMessageV3 implements PlatformStopRouteNotifyOrBuilder {
        ...
        private static final PlatformStopRouteNotify DEFAULT_INSTANCE = new PlatformStopRouteNotify();
        private static final Parser<PlatformStopRouteNotify> PARSER = new AbstractParser<PlatformStopRouteNotify>() { // from class: emu.grasscutter.net.proto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify.1
            @Override // com.google.protobuf.Parser
            public PlatformStopRouteNotify parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
                return new PlatformStopRouteNotify(input, extensionRegistry);
            }
        };

        private PlatformStopRouteNotify(GeneratedMessageV3.Builder<?> builder) {
            super(builder);
        ...
        private PlatformStopRouteNotify(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            this();
        ...
        @Override // emu.grasscutter.net.proto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotifyOrBuilder
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            if (this.sceneTime_ != 0) {
                output.writeUInt32(10, this.sceneTime_);
            }
        ...
        public int getSerializedSize() {
            ...
            if (this.sceneTime_ != 0) {
                size2 += CodedOutputStream.computeUInt32Size(10, this.sceneTime_);
            }
        ...
        public boolean equals(Object obj) {
            ...
            PlatformStopRouteNotify other = (PlatformStopRouteNotify) obj;
            if (hasPlatform() != other.hasPlatform()) {
                return false;
            }
            return (!hasPlatform() || getPlatform().equals(other.getPlatform())) && getSceneTime() == other.getSceneTime() && getEntityId() == other.getEntityId() && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            int hash2 = (29 * ((53 * ((37 * ((53 * ((37 * hash) + 10)) + getSceneTime())) + 6)) + getEntityId())) + this.unknownFields.hashCode();
            this.memoizedHashCode = hash2;
            return hash2;
        }

        public static PlatformStopRouteNotify parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static PlatformStopRouteNotify parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static PlatformStopRouteNotify parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static PlatformStopRouteNotify parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static PlatformStopRouteNotify parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data);
        }

        public static PlatformStopRouteNotify parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return PARSER.parseFrom(data, extensionRegistry);
        }

        public static PlatformStopRouteNotify parseFrom(InputStream input) throws IOException {
            return (PlatformStopRouteNotify) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static PlatformStopRouteNotify parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (PlatformStopRouteNotify) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }

        public static PlatformStopRouteNotify parseDelimitedFrom(InputStream input) throws IOException {
            return (PlatformStopRouteNotify) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input);
        }

        public static PlatformStopRouteNotify parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (PlatformStopRouteNotify) GeneratedMessageV3.parseDelimitedWithIOException(PARSER, input, extensionRegistry);
        }

        public static PlatformStopRouteNotify parseFrom(CodedInputStream input) throws IOException {
            return (PlatformStopRouteNotify) GeneratedMessageV3.parseWithIOException(PARSER, input);
        }

        public static PlatformStopRouteNotify parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return (PlatformStopRouteNotify) GeneratedMessageV3.parseWithIOException(PARSER, input, extensionRegistry);
        }
        ...
        public static Builder newBuilder(PlatformStopRouteNotify prototype) {
        ...
        /* loaded from: grasscutter.jar:emu/grasscutter/net/proto/PlatformStopRouteNotifyOuterClass$PlatformStopRouteNotify$Builder.class */
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements PlatformStopRouteNotifyOrBuilder {
            ...
            public PlatformStopRouteNotify build() {
                PlatformStopRouteNotify result = buildPartial();
            ...
            public PlatformStopRouteNotify buildPartial() {
                PlatformStopRouteNotify result = new PlatformStopRouteNotify(this);
                if (this.platformBuilder_ == null) {
            ...
            public Builder mergeFrom(Message other) {
                if (other instanceof PlatformStopRouteNotify) {
                    return mergeFrom((PlatformStopRouteNotify) other);
                }
                mergeFrom(other);
                return this;
            }

            public Builder mergeFrom(PlatformStopRouteNotify other) {
