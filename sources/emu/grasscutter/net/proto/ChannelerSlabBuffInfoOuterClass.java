...
public final class ChannelerSlabBuffInfoOuterClass {
    private static Descriptors.FileDescriptor descriptor = Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(new String[]{"\n\u001bChannelerSlabBuffInfo.proto\u001a\u001dChannelerSlabAssistInfo.proto\u001a!ChannelerSlabBuffSchemeInfo.proto\"×\u0001\n\u0015ChannelerSlabBuffInfo\u00122\n\u0010assist_info_list\u0018\u000b \u0003(\u000b2\u0018.ChannelerSlabAssistInfo\u00129\n\u0013Unk3300_CDFLIONGKCH\u0018\b \u0001(\u000b2\u001c.ChannelerSlabBuffSchemeInfo\u00129\n\u0013Unk3300_ANENHMAADLN\u0018\u000e \u0001(\u000b2\u001c.ChannelerSlabBuffSchemeInfo\u0012\u0014\n\fbuff_id_list\u0018\u0006 \u0003(\rB\u001b\n\u0019emu.grasscutter.net.protob\u0006proto3"}, new Descriptors.FileDescriptor[]{ChannelerSlabAssistInfoOuterClass.getDescriptor(), ChannelerSlabBuffSchemeInfoOuterClass.getDescriptor()});
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_ChannelerSlabBuffInfo_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_ChannelerSlabBuffInfo_descriptor, new String[]{"AssistInfoList", "Unk3300CDFLIONGKCH", "Unk3300ANENHMAADLN", "BuffIdList"});
    ...
    public static final class ChannelerSlabBuffInfo extends GeneratedMessageV3 implements ChannelerSlabBuffInfoOrBuilder {
                        ...
                        try {
                            ...
                            switch (tag) {
                                ...
                                case 50:
                                    ...
                                    break;
                                case 66:
                                    ChannelerSlabBuffSchemeInfoOuterClass.ChannelerSlabBuffSchemeInfo.Builder subBuilder = this.unk3300CDFLIONGKCH_ != null ? this.unk3300CDFLIONGKCH_.toBuilder() : null;
                                    ...
                                    if (subBuilder == null) {
                                        ...
                                        subBuilder.mergeFrom(this.unk3300CDFLIONGKCH_);
                                        this.unk3300CDFLIONGKCH_ = subBuilder.buildPartial();
                                        break;
                                    }
                                case 90:
                                    ...
                                    break;
                                case 114:
                                    ChannelerSlabBuffSchemeInfoOuterClass.ChannelerSlabBuffSchemeInfo.Builder subBuilder2 = this.unk3300ANENHMAADLN_ != null ? this.unk3300ANENHMAADLN_.toBuilder() : null;
                                    ...
                                    if (subBuilder2 == null) {
                                        ...
                                        subBuilder2.mergeFrom(this.unk3300ANENHMAADLN_);
                                        this.unk3300ANENHMAADLN_ = subBuilder2.buildPartial();
                                        break;
                                    }
                                default:
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            ...
            for (int i2 = 0; i2 < this.assistInfoList_.size(); i2++) {
                output.writeMessage(11, this.assistInfoList_.get(i2));
            }
        ...
        public int getSerializedSize() {
            ...
            if (this.unk3300CDFLIONGKCH_ != null) {
                size2 += CodedOutputStream.computeMessageSize(8, getUnk3300CDFLIONGKCH());
            }
            for (int i2 = 0; i2 < this.assistInfoList_.size(); i2++) {
                size2 += CodedOutputStream.computeMessageSize(11, this.assistInfoList_.get(i2));
            }
            if (this.unk3300ANENHMAADLN_ != null) {
                size2 += CodedOutputStream.computeMessageSize(14, getUnk3300ANENHMAADLN());
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (!getAssistInfoListList().equals(other.getAssistInfoListList()) || hasUnk3300CDFLIONGKCH() != other.hasUnk3300CDFLIONGKCH()) {
                return false;
            }
            if ((!hasUnk3300CDFLIONGKCH() || getUnk3300CDFLIONGKCH().equals(other.getUnk3300CDFLIONGKCH())) && hasUnk3300ANENHMAADLN() == other.hasUnk3300ANENHMAADLN()) {
                return (!hasUnk3300ANENHMAADLN() || getUnk3300ANENHMAADLN().equals(other.getUnk3300ANENHMAADLN())) && getBuffIdListList().equals(other.getBuffIdListList()) && this.unknownFields.equals(other.unknownFields);
            }
            return false;
        }
        ...
        public int hashCode() {
            ...
            if (getAssistInfoListCount() > 0) {
                hash = (53 * ((37 * hash) + 11)) + getAssistInfoListList().hashCode();
            }
            if (hasUnk3300CDFLIONGKCH()) {
                hash = (53 * ((37 * hash) + 8)) + getUnk3300CDFLIONGKCH().hashCode();
            }
            if (hasUnk3300ANENHMAADLN()) {
                hash = (53 * ((37 * hash) + 14)) + getUnk3300ANENHMAADLN().hashCode();
            }
            if (getBuffIdListCount() > 0) {
                hash = (53 * ((37 * hash) + 6)) + getBuffIdListList().hashCode();
            }
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements ChannelerSlabBuffInfoOrBuilder {
            ...
            private RepeatedFieldBuilderV3<ChannelerSlabAssistInfoOuterClass.ChannelerSlabAssistInfo, ChannelerSlabAssistInfoOuterClass.ChannelerSlabAssistInfo.Builder, ChannelerSlabAssistInfoOuterClass.ChannelerSlabAssistInfoOrBuilder> getAssistInfoListFieldBuilder() {
                if (this.assistInfoListBuilder_ == null) {
                    this.assistInfoListBuilder_ = new RepeatedFieldBuilderV3<>(this.assistInfoList_, (this.bitField0_ & 1) != 0, getParentForChildren(), isClean());
