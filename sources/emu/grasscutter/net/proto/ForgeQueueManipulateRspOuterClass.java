...
public final class ForgeQueueManipulateRspOuterClass {
    ...
    private static final GeneratedMessageV3.FieldAccessorTable internal_static_ForgeQueueManipulateRsp_fieldAccessorTable = new GeneratedMessageV3.FieldAccessorTable(internal_static_ForgeQueueManipulateRsp_descriptor, new String[]{"ReturnItemList", "ManipulateType", "ExtraOutputItemList", "OutputItemList", "Retcode"});
    ...
    public static final class ForgeQueueManipulateRsp extends GeneratedMessageV3 implements ForgeQueueManipulateRspOrBuilder {
        ...
        public void writeTo(CodedOutputStream output) throws IOException {
            for (int i = 0; i < this.returnItemList_.size(); i++) {
                output.writeMessage(3, this.returnItemList_.get(i));
            }
            if (this.retcode_ != 0) {
            ...
            if (this.manipulateType_ != ForgeQueueManipulateTypeOuterClass.ForgeQueueManipulateType.FORGE_QUEUE_MANIPULATE_TYPE_RECEIVE_OUTPUT.getNumber()) {
                output.writeEnum(7, this.manipulateType_);
            }
            for (int i2 = 0; i2 < this.outputItemList_.size(); i2++) {
                output.writeMessage(12, this.outputItemList_.get(i2));
            }
            for (int i3 = 0; i3 < this.extraOutputItemList_.size(); i3++) {
                output.writeMessage(13, this.extraOutputItemList_.get(i3));
            }
        ...
        public int getSerializedSize() {
            ...
            int size2 = 0;
            for (int i = 0; i < this.returnItemList_.size(); i++) {
                size2 += CodedOutputStream.computeMessageSize(3, this.returnItemList_.get(i));
            }
            if (this.retcode_ != 0) {
                size2 += CodedOutputStream.computeInt32Size(5, this.retcode_);
            }
            if (this.manipulateType_ != ForgeQueueManipulateTypeOuterClass.ForgeQueueManipulateType.FORGE_QUEUE_MANIPULATE_TYPE_RECEIVE_OUTPUT.getNumber()) {
                size2 += CodedOutputStream.computeEnumSize(7, this.manipulateType_);
            }
            for (int i2 = 0; i2 < this.outputItemList_.size(); i2++) {
                size2 += CodedOutputStream.computeMessageSize(12, this.outputItemList_.get(i2));
            }
            for (int i3 = 0; i3 < this.extraOutputItemList_.size(); i3++) {
                size2 += CodedOutputStream.computeMessageSize(13, this.extraOutputItemList_.get(i3));
            }
        ...
        public boolean equals(Object obj) {
            ...
            return getReturnItemListList().equals(other.getReturnItemListList()) && this.manipulateType_ == other.manipulateType_ && getExtraOutputItemListList().equals(other.getExtraOutputItemListList()) && getOutputItemListList().equals(other.getOutputItemListList()) && getRetcode() == other.getRetcode() && this.unknownFields.equals(other.unknownFields);
        }
        ...
        public int hashCode() {
            ...
            if (getReturnItemListCount() > 0) {
                hash = (53 * ((37 * hash) + 3)) + getReturnItemListList().hashCode();
            }
            int hash2 = (53 * ((37 * hash) + 7)) + this.manipulateType_;
            if (getExtraOutputItemListCount() > 0) {
                hash2 = (53 * ((37 * hash2) + 13)) + getExtraOutputItemListList().hashCode();
            }
            if (getOutputItemListCount() > 0) {
                hash2 = (53 * ((37 * hash2) + 12)) + getOutputItemListList().hashCode();
            }
            int hash3 = (29 * ((53 * ((37 * hash2) + 5)) + getRetcode())) + this.unknownFields.hashCode();
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements ForgeQueueManipulateRspOrBuilder {
            ...
            private RepeatedFieldBuilderV3<ItemParamOuterClass.ItemParam, ItemParamOuterClass.ItemParam.Builder, ItemParamOuterClass.ItemParamOrBuilder> getExtraOutputItemListFieldBuilder() {
                if (this.extraOutputItemListBuilder_ == null) {
                    this.extraOutputItemListBuilder_ = new RepeatedFieldBuilderV3<>(this.extraOutputItemList_, (this.bitField0_ & 2) != 0, getParentForChildren(), isClean());
