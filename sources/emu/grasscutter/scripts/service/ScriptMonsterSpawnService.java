...
/* loaded from: grasscutter.jar:emu/grasscutter/scripts/service/ScriptMonsterSpawnService.class */
public class ScriptMonsterSpawnService {
    ...
    public void onMonsterDead(EntityMonster entityMonster) {
        this.onMonsterDeadListener.forEach(l -> {
            l.onNotify(entityMonster);
        });
    }
}
