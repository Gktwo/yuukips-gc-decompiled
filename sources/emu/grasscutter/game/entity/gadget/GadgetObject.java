...
/* loaded from: grasscutter.jar:emu/grasscutter/game/entity/gadget/GadgetObject.class */
public class GadgetObject extends GadgetContent {
    /*  JADX ERROR: Dependency scan failed at insn: 0x000B: INVOKE_CUSTOM r-1, r0
        ...
        */
    /*  JADX ERROR: Failed to decode insn: 0x000B: INVOKE_CUSTOM r1, r2, method: emu.grasscutter.game.entity.gadget.GadgetObject.onInteract(emu.grasscutter.game.player.Player, emu.grasscutter.net.proto.GadgetInteractReqOuterClass$GadgetInteractReq):boolean
    ...
    public boolean onInteract(emu.grasscutter.game.player.Player r5, emu.grasscutter.net.proto.GadgetInteractReqOuterClass.GadgetInteractReq r6) {
        /*
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: emu.grasscutter.game.entity.gadget.GadgetObject.onInteract(emu.grasscutter.game.player.Player, emu.grasscutter.net.proto.GadgetInteractReqOuterClass$GadgetInteractReq):boolean");
    }
