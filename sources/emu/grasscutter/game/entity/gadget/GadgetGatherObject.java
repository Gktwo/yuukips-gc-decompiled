...
/* loaded from: grasscutter.jar:emu/grasscutter/game/entity/gadget/GadgetGatherObject.class */
public class GadgetGatherObject extends GadgetContent {
    ...
    /*  JADX ERROR: Dependency scan failed at insn: 0x000B: INVOKE_CUSTOM r-1, r0
        ...
        */
    /*  JADX ERROR: Failed to decode insn: 0x000B: INVOKE_CUSTOM r1, r2, method: emu.grasscutter.game.entity.gadget.GadgetGatherObject.onInteract(emu.grasscutter.game.player.Player, emu.grasscutter.net.proto.GadgetInteractReqOuterClass$GadgetInteractReq):boolean
        jadx.core.utils.exceptions.JadxRuntimeException: 'invoke-custom' instruction processing error: Failed to process invoke-custom instruction: CallSite{[{ENCODED_METHOD_HANDLE: INVOKE_STATIC: Ljava/lang/invoke/StringConcatFactory;->makeConcatWithConstants(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/invoke/CallSite;}, makeConcatWithConstants, {ENCODED_METHOD_TYPE: (I, I)Ljava/lang/String;}, GadgetGatherObject1: player  interact gadget with ]}
    ...
    public boolean onInteract(emu.grasscutter.game.player.Player r7, emu.grasscutter.net.proto.GadgetInteractReqOuterClass.GadgetInteractReq r8) {
        /*
            ...
            r0 = r6
            emu.grasscutter.game.entity.EntityGadget r0 = r0.getGadget()
            ...
            emu.grasscutter.net.proto.InteractTypeOuterClass$InteractType r4 = emu.grasscutter.net.proto.InteractTypeOuterClass.InteractType.INTERACT_TYPE_GATHER
            r2.<init>(r3, r4)
            r0.broadcastPacket(r1)
            r0 = 1
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: emu.grasscutter.game.entity.gadget.GadgetGatherObject.onInteract(emu.grasscutter.game.player.Player, emu.grasscutter.net.proto.GadgetInteractReqOuterClass$GadgetInteractReq):boolean");
    }
    ...
    public void dropItems(Player player) {
        ...
        for (int i = 0; i < times; i++) {
            scene.addEntity(new EntityItem(scene, player, GameData.getItemDataMap().get(this.itemId), getGadget().getPosition().nearby2d(1.0f).addY(2.0f), 1, true));
        }
