...
/* loaded from: grasscutter.jar:emu/grasscutter/game/quest/conditions/ConditionStateEqual.class */
public class ConditionStateEqual extends QuestBaseHandler {
    ...
    public boolean execute(GameQuest quest, QuestData.QuestCondition condition, String paramStr, int... params) {
        ...
        return checkQuest != null && checkQuest.getState().getValue() == condition.getParam()[1];
    }
}
