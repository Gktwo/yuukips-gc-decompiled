...
/* loaded from: grasscutter.jar:emu/grasscutter/game/quest/content/ContentQuestStateEqual.class */
public class ContentQuestStateEqual extends QuestBaseHandler {
    ...
    public boolean execute(GameQuest quest, QuestData.QuestCondition condition, String paramStr, int... params) {
        ...
        return checkQuest != null && checkQuest.getState().getValue() == params[1];
    }
}
