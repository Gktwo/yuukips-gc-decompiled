...
/* loaded from: grasscutter.jar:emu/grasscutter/game/quest/enums/QuestTrigger.class */
public enum QuestTrigger {
    ...
    static {
        Stream.of((Object[]) values()).filter(e -> {
            return e.name().startsWith("QUEST_CONTENT_");
        }).forEach(e -> {
            contentMap.put(e.getValue(), (int) e);
    ...
    public static QuestTrigger getContentTriggerByValue(int value) {
        return contentMap.getOrDefault(value, (int) QUEST_CONTENT_NONE);
    }
