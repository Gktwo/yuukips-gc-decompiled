...
/* loaded from: grasscutter.jar:emu/grasscutter/game/dungeons/challenge/factory/KillGadgetChallengeFactoryHandler.class */
public class KillGadgetChallengeFactoryHandler implements ChallengeFactoryHandler {
    /*  JADX ERROR: Dependency scan failed at insn: 0x0004: INVOKE_CUSTOM r0
        ...
        */
    /*  JADX ERROR: Failed to decode insn: 0x0004: INVOKE_CUSTOM r1, method: emu.grasscutter.game.dungeons.challenge.factory.KillGadgetChallengeFactoryHandler.build(int, int, int, int, int, int, emu.grasscutter.game.world.Scene, emu.grasscutter.scripts.data.SceneGroup):emu.grasscutter.game.dungeons.challenge.WorldChallenge
        jadx.core.utils.exceptions.JadxRuntimeException: 'invoke-custom' instruction processing error: Failed to process invoke-custom instruction: CallSite{[{ENCODED_METHOD_HANDLE: INVOKE_STATIC: Ljava/lang/invoke/StringConcatFactory;->makeConcatWithConstants(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/invoke/CallSite;}, makeConcatWithConstants, {ENCODED_METHOD_TYPE: (I)Ljava/lang/String;}, Start KillGadgetChallengeFactoryHandler: ]}
    ...
    public emu.grasscutter.game.dungeons.challenge.WorldChallenge build(int r14, int r15, int r16, int r17, int r18, int r19, emu.grasscutter.game.world.Scene r20, emu.grasscutter.scripts.data.SceneGroup r21) {
        /*
            ...
            r10 = r9
            r10.<init>()
            emu.grasscutter.game.dungeons.challenge.trigger.KillGadgetTrigger r10 = new emu.grasscutter.game.dungeons.challenge.trigger.KillGadgetTrigger
            r11 = r10
            r11.<init>()
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: emu.grasscutter.game.dungeons.challenge.factory.KillGadgetChallengeFactoryHandler.build(int, int, int, int, int, int, emu.grasscutter.game.world.Scene, emu.grasscutter.scripts.data.SceneGroup):emu.grasscutter.game.dungeons.challenge.WorldChallenge");
    }
