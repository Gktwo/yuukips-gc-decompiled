...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceArrayMap.class */
public class Double2ReferenceArrayMap<V> extends AbstractDouble2ReferenceMap<V> implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Double2ReferenceArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Double2ReferenceArrayMap(Double2ReferenceMap<V> m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Double2ReferenceMap.Entry<V>> it = m.double2ReferenceEntrySet().iterator();
        while (it.hasNext()) {
            Double2ReferenceMap.Entry<V> e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Double2ReferenceMap.Entry<V>> implements Double2ReferenceMap.FastEntrySet<V> {
        ...
        public ObjectIterator<Double2ReferenceMap.Entry<V>> iterator() {
            return new ObjectIterator<Double2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.doubles.Double2ReferenceArrayMap.EntrySet.1
                ...
                public Double2ReferenceMap.Entry<V> next() {
                    ...
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractDouble2ReferenceMap.BasicEntry(d, objArr[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Double2ReferenceArrayMap.access$010(Double2ReferenceArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Double2ReferenceMap.Entry<V>> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractDouble2ReferenceMap.BasicEntry(d, objArr[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Double2ReferenceMap.Entry<V>> fastIterator() {
            return new ObjectIterator<Double2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.doubles.Double2ReferenceArrayMap.EntrySet.2
                ...
                public Double2ReferenceMap.Entry<V> next() {
                    ...
                    AbstractDouble2ReferenceMap.BasicEntry<V> basicEntry = this.entry;
                    double[] dArr = Double2ReferenceArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = dArr[i];
                    AbstractDouble2ReferenceMap.BasicEntry<V> basicEntry2 = this.entry;
                    Object[] objArr = Double2ReferenceArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Double2ReferenceMap.Entry<V>> implements ObjectSpliterator<Double2ReferenceMap.Entry<V>> {
            ...
            public final Double2ReferenceMap.Entry<V> get(int location) {
                return new AbstractDouble2ReferenceMap.BasicEntry(Double2ReferenceArrayMap.this.key[location], Double2ReferenceArrayMap.this.value[location]);
            }

            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Double2ReferenceArrayMap<V>.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
        ...
        public void forEach(Consumer<? super Double2ReferenceMap.Entry<V>> action) {
            int max = Double2ReferenceArrayMap.this.size;
            for (int i = 0; i < max; i++) {
                action.accept(new AbstractDouble2ReferenceMap.BasicEntry(Double2ReferenceArrayMap.this.key[i], Double2ReferenceArrayMap.this.value[i]));
            }
        }
        ...
        public boolean remove(Object o) {
            ...
            if (oldPos == -1 || value != Double2ReferenceArrayMap.this.value[oldPos]) {
                return false;
            }
            ...
            Double2ReferenceArrayMap.access$010(Double2ReferenceArrayMap.this);
            Double2ReferenceArrayMap.this.value[Double2ReferenceArrayMap.this.size] = null;
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceArrayMap$KeySet.class */
    public final class KeySet extends AbstractDoubleSet {
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceArrayMap$KeySet$KeySetSpliterator.class */
        public final class KeySetSpliterator extends DoubleSpliterators.EarlyBindingSizeIndexBasedSpliterator implements DoubleSpliterator {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.doubles.DoubleSpliterators.AbstractIndexBasedSpliterator
            public final Double2ReferenceArrayMap<V>.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractReferenceCollection<V> {
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceArrayMap$ValuesCollection$ValuesSpliterator.class */
        public final class ValuesSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<V> implements ObjectSpliterator<V> {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Double2ReferenceArrayMap<V>.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
    ...
    public Double2ReferenceArrayMap<V> clone() {
        try {
            Double2ReferenceArrayMap<V> c = (Double2ReferenceArrayMap) clone();
