...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2CharFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2CharFunctions.class */
public final class Double2CharFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2CharFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2CharFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractDouble2CharFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDouble2CharFunction, p014it.unimi.dsi.fastutil.doubles.Double2CharFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2CharFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2CharFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2CharFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2CharFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Double2CharFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Double2CharFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Double2CharFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2CharFunction, java.util.function.DoubleToIntFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2CharFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2CharFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractDouble2CharFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Double2CharFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Double2CharFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2CharFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2CharFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Double2CharFunction {
        ...
        public char get(double key) {
            Character v = (Character) this.function.apply(Double.valueOf(key));
        ...
        public Character get(Object key) {
            ...
            return (Character) this.function.apply((Double) key);
        }
        ...
        public Character getOrDefault(Object key, Character defaultValue) {
            Character v;
            if (!(key == null || (v = (Character) this.function.apply((Double) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
    ...
    public static Double2CharFunction primitive(java.util.function.Function<? super Double, ? extends Character> f) {
        ...
        return f instanceof Double2CharFunction ? (Double2CharFunction) f : f instanceof DoubleToIntFunction ? key -> {
            return SafeMath.safeIntToChar(((DoubleToIntFunction) f).applyAsInt(key));
