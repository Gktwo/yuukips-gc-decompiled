...
public class Double2LongOpenHashMap extends AbstractDouble2LongMap implements Serializable, Cloneable, Hash {
    ...
    public Double2LongOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new long[this.f1622n + 1];
        }
    }
    ...
    public long removeNullEntry() {
        ...
        long oldValue = this.value[this.f1622n];
        this.size--;
        if (this.f1622n > this.minN && this.size < this.maxFill / 4 && this.f1622n > 16) {
            rehash(this.f1622n / 2);
        }
    ...
    public boolean containsValue(long v) {
        ...
        double[] key = this.key;
        if (this.containsNullKey && value[this.f1622n] == v) {
            return true;
        }
        int i = this.f1622n;
        while (true) {
    ...
    public boolean remove(double k, long v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1622n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Double2LongOpenHashMap.this.f1622n;
            this.last = -1;
            this.f1624c = Double2LongOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Double2LongOpenHashMap.this.f1622n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Double2LongOpenHashMap.this.f1622n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Double2LongOpenHashMap.this.f1622n;
            this.f1625c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1625c++;
                acceptOnIndex(action, Double2LongOpenHashMap.this.f1622n);
                return true;
            }
            double[] key = Double2LongOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Double2LongOpenHashMap.this.size - this.f1625c);
            }
            return Math.min((long) (Double2LongOpenHashMap.this.size - this.f1625c), ((long) ((((double) Double2LongOpenHashMap.this.realSize()) / ((double) Double2LongOpenHashMap.this.f1622n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Double2LongMap.Entry> implements Double2LongMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Double.doubleToLongBits(k) == 0) {
                return Double2LongOpenHashMap.this.containsNullKey && Double2LongOpenHashMap.this.value[Double2LongOpenHashMap.this.f1622n] == v;
            }
            double[] key = Double2LongOpenHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Double2LongOpenHashMap.this.containsNullKey || Double2LongOpenHashMap.this.value[Double2LongOpenHashMap.this.f1622n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Double2LongMap.Entry> consumer) {
            if (Double2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractDouble2LongMap.BasicEntry(Double2LongOpenHashMap.this.key[Double2LongOpenHashMap.this.f1622n], Double2LongOpenHashMap.this.value[Double2LongOpenHashMap.this.f1622n]));
            }
            int pos = Double2LongOpenHashMap.this.f1622n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Double2LongMap.Entry> consumer) {
            ...
            if (Double2LongOpenHashMap.this.containsNullKey) {
                entry.key = Double2LongOpenHashMap.this.key[Double2LongOpenHashMap.this.f1622n];
                entry.value = Double2LongOpenHashMap.this.value[Double2LongOpenHashMap.this.f1622n];
    ...
    public final class KeySet extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Double2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(Double2LongOpenHashMap.this.key[Double2LongOpenHashMap.this.f1622n]);
            }
            int pos = Double2LongOpenHashMap.this.f1622n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap.1
                ...
                public void forEach(LongConsumer consumer) {
                    if (Double2LongOpenHashMap.this.containsNullKey) {
                        consumer.accept(Double2LongOpenHashMap.this.value[Double2LongOpenHashMap.this.f1622n]);
                    }
                    int pos = Double2LongOpenHashMap.this.f1622n;
                    while (true) {
                        pos--;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.long2int(this.value[this.f1622n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        long[] value = new long[this.f1622n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
