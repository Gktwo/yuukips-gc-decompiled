...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap.class */
public class Double2LongOpenHashMap extends AbstractDouble2LongMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f1658n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f1659f;
    protected transient Double2LongMap.FastEntrySet entries;
    protected transient DoubleSet keys;
    protected transient LongCollection values;

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap.computeIfPresent(double, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Long, ? extends java.lang.Long>):long, file: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap.class
    ...
    public long computeIfPresent(double r1, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Long, ? extends java.lang.Long> r3) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap.computeIfPresent(double, java.util.function.BiFunction):long");
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap.compute(double, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Long, ? extends java.lang.Long>):long, file: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap.class
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:204)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:309)
        	at jadx.core.ProcessClass.process(ProcessClass.java:53)
        	at jadx.core.ProcessClass.generateCode(ProcessClass.java:87)
    ...
    public long compute(double r1, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Long, ? extends java.lang.Long> r3) {
        ...
        // Can't load method instructions: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap.compute(double, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Long, ? extends java.lang.Long>):long, file: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap.class
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap.compute(double, java.util.function.BiFunction):long");
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap.merge(double, long, java.util.function.BiFunction<? super java.lang.Long, ? super java.lang.Long, ? extends java.lang.Long>):long, file: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap.class
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:204)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:309)
        	at jadx.core.ProcessClass.process(ProcessClass.java:53)
        	at jadx.core.ProcessClass.generateCode(ProcessClass.java:87)
    ...
    public long merge(double r1, long r3, java.util.function.BiFunction<? super java.lang.Long, ? super java.lang.Long, ? extends java.lang.Long> r5) {
        ...
        // Can't load method instructions: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap.merge(double, long, java.util.function.BiFunction<? super java.lang.Long, ? super java.lang.Long, ? extends java.lang.Long>):long, file: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap.class
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap.merge(double, long, java.util.function.BiFunction):long");
    }
    ...
    public Double2LongOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f1658n = arraySize;
            this.minN = arraySize;
            this.mask = this.f1658n - 1;
            this.maxFill = HashCommon.maxFill(this.f1658n, f);
            this.key = new double[this.f1658n + 1];
            this.value = new long[this.f1658n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f1659f);
        if (needed > this.f1658n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f1659f)))));
        if (needed > this.f1658n) {
            rehash(needed);
        }
    }
    ...
    public long removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f1658n > this.minN && this.size < this.maxFill / 4 && this.f1658n > 16) {
            rehash(this.f1658n / 2);
        }
        return oldValue;
    }
    ...
    public long removeNullEntry() {
        ...
        long oldValue = this.value[this.f1658n];
        this.size--;
        if (this.f1658n > this.minN && this.size < this.maxFill / 4 && this.f1658n > 16) {
            rehash(this.f1658n / 2);
        }
    ...
    private int find(double k) {
        ...
        if (Double.doubleToLongBits(k) == 0) {
            return this.containsNullKey ? this.f1658n : -(this.f1658n + 1);
        }
        double[] key = this.key;
    ...
    private void insert(int pos, double k, long v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f1659f));
        }
    }
    ...
    public long addTo(double k, long incr) {
        ...
        if (Double.doubleToLongBits(k) != 0) {
            ...
            return addToValue(this.f1658n, incr);
        } else {
            pos = this.f1658n;
            this.containsNullKey = true;
        }
    ...
    public long get(double k) {
        double curr;
        if (Double.doubleToLongBits(k) == 0) {
            return this.containsNullKey ? this.value[this.f1658n] : this.defRetValue;
        }
        double[] key = this.key;
        int mix = ((int) HashCommon.mix(Double.doubleToRawLongBits(k))) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(long v) {
        ...
        double[] key = this.key;
        if (this.containsNullKey && value[this.f1658n] == v) {
            return true;
        }
        int i = this.f1658n;
        while (true) {
    ...
    public long getOrDefault(double k, long defaultValue) {
        double curr;
        if (Double.doubleToLongBits(k) == 0) {
            return this.containsNullKey ? this.value[this.f1658n] : defaultValue;
        }
        double[] key = this.key;
        int mix = ((int) HashCommon.mix(Double.doubleToRawLongBits(k))) & this.mask;
        int pos = mix;
    ...
    public boolean remove(double k, long v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1658n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap$MapEntry.class */
    public final class MapEntry implements Double2LongMap.Entry, Map.Entry<Double, Long>, DoubleLongPair {
        ...
        public boolean equals(Object o) {
            ...
            return Double.doubleToLongBits(Double2LongOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(e.getKey().doubleValue()) && Double2LongOpenHashMap.this.value[this.index] == e.getValue().longValue();
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Double2LongOpenHashMap.this.f1658n;
            this.last = -1;
            this.f1660c = Double2LongOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Double2LongOpenHashMap.this.f1658n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int i3 = Double2LongOpenHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        ...
                        mix = p + 1;
                        i3 = Double2LongOpenHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Double2LongOpenHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (Double.doubleToLongBits(curr) == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Double2LongOpenHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Double2LongOpenHashMap.this.value[pos] = Double2LongOpenHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Double2LongOpenHashMap.this.f1658n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Double2LongMap.Entry>> implements ObjectIterator<Double2LongMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Double2LongOpenHashMap.this.f1658n;
            this.f1661c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1661c++;
                acceptOnIndex(action, Double2LongOpenHashMap.this.f1658n);
                return true;
            }
            double[] key = Double2LongOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Double2LongOpenHashMap.this.size - this.f1661c);
            }
            return Math.min((long) (Double2LongOpenHashMap.this.size - this.f1661c), ((long) ((((double) Double2LongOpenHashMap.this.realSize()) / ((double) Double2LongOpenHashMap.this.f1658n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap r0 = p014it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap.this
                double[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x007a:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Double2LongMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Double2LongMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Double2LongMap.Entry> implements Double2LongMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Double.doubleToLongBits(k) == 0) {
                return Double2LongOpenHashMap.this.containsNullKey && Double2LongOpenHashMap.this.value[Double2LongOpenHashMap.this.f1658n] == v;
            }
            double[] key = Double2LongOpenHashMap.this.key;
            int mix = ((int) HashCommon.mix(Double.doubleToRawLongBits(k))) & Double2LongOpenHashMap.this.mask;
            int pos = mix;
            double curr2 = key[mix];
            if (Double.doubleToLongBits(curr2) == 0) {
                return false;
            ...
            do {
                int i = (pos + 1) & Double2LongOpenHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (Double.doubleToLongBits(curr) == 0) {
                    return false;
            ...
            if (Double.doubleToLongBits(k) != 0) {
                ...
                if (Double.doubleToLongBits(curr) != Double.doubleToLongBits(k)) {
                    while (true) {
                        ...
                        if (Double.doubleToLongBits(curr2) == Double.doubleToLongBits(k) && Double2LongOpenHashMap.this.value[pos] == v) {
                            Double2LongOpenHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Double2LongOpenHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Double2LongOpenHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Double2LongOpenHashMap.this.containsNullKey || Double2LongOpenHashMap.this.value[Double2LongOpenHashMap.this.f1658n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Double2LongMap.Entry> consumer) {
            if (Double2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractDouble2LongMap.BasicEntry(Double2LongOpenHashMap.this.key[Double2LongOpenHashMap.this.f1658n], Double2LongOpenHashMap.this.value[Double2LongOpenHashMap.this.f1658n]));
            }
            int pos = Double2LongOpenHashMap.this.f1658n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
                }
                if (Double.doubleToLongBits(Double2LongOpenHashMap.this.key[pos]) != 0) {
        ...
        public void fastForEach(Consumer<? super Double2LongMap.Entry> consumer) {
            ...
            if (Double2LongOpenHashMap.this.containsNullKey) {
                entry.key = Double2LongOpenHashMap.this.key[Double2LongOpenHashMap.this.f1658n];
                entry.value = Double2LongOpenHashMap.this.value[Double2LongOpenHashMap.this.f1658n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap$KeySet.class */
    public final class KeySet extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Double2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(Double2LongOpenHashMap.this.key[Double2LongOpenHashMap.this.f1658n]);
            }
            int pos = Double2LongOpenHashMap.this.f1658n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongOpenHashMap$ValueSpliterator.class */
    ...
    public Collection<Long> values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2LongOpenHashMap.1
                ...
                public void forEach(LongConsumer consumer) {
                    if (Double2LongOpenHashMap.this.containsNullKey) {
                        consumer.accept(Double2LongOpenHashMap.this.value[Double2LongOpenHashMap.this.f1658n]);
                    }
                    int pos = Double2LongOpenHashMap.this.f1658n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f1659f)));
        if (l >= this.f1658n || this.size > HashCommon.maxFill(l, this.f1659f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f1658n];
                this.f1658n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f1658n, this.f1659f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Double2LongOpenHashMap clone() {
        try {
            Double2LongOpenHashMap c = (Double2LongOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.long2int(this.value[this.f1658n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f1658n = HashCommon.arraySize(this.size, this.f1659f);
        this.maxFill = HashCommon.maxFill(this.f1658n, this.f1659f);
        this.mask = this.f1658n - 1;
        double[] key = new double[this.f1658n + 1];
        this.key = key;
        long[] value = new long[this.f1658n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
