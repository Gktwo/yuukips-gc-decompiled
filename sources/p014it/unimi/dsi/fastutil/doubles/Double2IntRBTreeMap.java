...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntRBTreeMap.class */
public class Double2IntRBTreeMap extends AbstractDouble2IntSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap.Entry add(double r10) {
        /*
        // Method dump skipped, instructions count: 947
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap.add(double):it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap$Entry");
    }
    ...
    public int remove(double r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap.remove(double):int");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(double k) {
            Entry locateKey = Double2IntRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2IntMap.Entry>() { // from class: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap.1
                final Comparator<? super Double2IntMap.Entry> comparator;

                {
                    this.comparator = Double2IntRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Double) && e.getValue() != null && (e.getValue() instanceof Integer)) {
                        return e.equals(Double2IntRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Double) || e.getValue() == null || !(e.getValue() instanceof Integer) || (f = Double2IntRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue())) == null || f.getIntValue() != ((Integer) e.getValue()).intValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntRBTreeMap$ValueIterator.class */
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntRBTreeMap$Submap.class */
    public final class Submap extends AbstractDouble2IntSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m933in(double k) {
            return (this.bottom || Double2IntRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2IntRBTreeMap.this.compare(k, this.f1614to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.doubles.Double2IntMap, p014it.unimi.dsi.fastutil.doubles.Double2IntSortedMap
        public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2IntMap.Entry>() { // from class: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Double) && e.getValue() != null && (e.getValue() instanceof Integer) && (f = Double2IntRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue())) != null && Submap.this.m933in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Double2IntRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue());
                        if (f != null && Submap.this.m933in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractDouble2IntSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public IntCollection values() {
            if (this.values == null) {
                this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.ints.AbstractIntCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.ints.IntCollection, p014it.unimi.dsi.fastutil.ints.IntIterable
                    public IntIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDouble2IntMap, p014it.unimi.dsi.fastutil.doubles.Double2IntFunction, p014it.unimi.dsi.fastutil.doubles.Double2IntMap
        public boolean containsKey(double k) {
            return m933in(k) && Double2IntRBTreeMap.this.containsKey(k);
        }
        ...
        public int get(double k) {
            Entry e;
            return (!m933in(k) || (e = Double2IntRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public int put(double k, int v) {
            ...
            if (!m933in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1614to)) + ")");
            }
            return Double2IntRBTreeMap.this.modified ? this.defRetValue : Double2IntRBTreeMap.this.put(k, v);
        }
        ...
        public int remove(double k) {
            ...
            return Double2IntRBTreeMap.this.modified ? Double2IntRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2IntSortedMap
        public Double2IntSortedMap headMap(double to) {
            if (!this.top && Double2IntRBTreeMap.this.compare(to, this.f1614to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2IntSortedMap
        public Double2IntSortedMap tailMap(double from) {
            if (!this.bottom && Double2IntRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1614to, this.top);
        }
        ...
        public Double2IntSortedMap subMap(double d, double d2) {
            ...
            double to = d2;
            if (!this.top) {
                to = Double2IntRBTreeMap.this.compare(d2, this.f1614to) < 0 ? d2 : this.f1614to;
            }
            double from = d;
            if (!this.bottom) {
                from = Double2IntRBTreeMap.this.compare(d, this.from) > 0 ? d : this.from;
            }
            if (!this.top && !this.bottom) {
                if ((from == Double.MIN_VALUE ? 1.0d : 0.0d) == this.from) {
                    if ((to == Double.MIN_VALUE ? 1.0d : 0.0d) == this.f1614to) {
                        return this;
                    }
                }
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Double2IntRBTreeMap.this.compare(e.key, this.f1614to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Double2IntRBTreeMap.this.locateKey(this.f1614to);
                if (Double2IntRBTreeMap.this.compare(e.key, this.f1614to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Double2IntRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, double k) {
                ...
                if (submap.bottom || Double2IntRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Double2IntRBTreeMap double2IntRBTreeMap = Double2IntRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (double2IntRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Double2IntRBTreeMap.this.compare(this.next.key, Submap.this.f1614to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Double2IntRBTreeMap clone() {
        try {
            Double2IntRBTreeMap c = (Double2IntRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
