...
/* renamed from: it.unimi.dsi.fastutil.doubles.DoubleArrayIndirectPriorityQueue */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/DoubleArrayIndirectPriorityQueue.class */
    ...
    private int findFirst() {
        ...
        if (this.f1664c != null) {
            ...
            while (true) {
                ...
                if (i == 0) {
                    break;
                } else if (Double.compare(this.refArray[this.array[i]], first) < 0) {
                    firstIndex = i;
                    first = this.refArray[this.array[i]];
                }
            }
    ...
    private int findLast() {
        ...
        if (this.f1664c != null) {
            ...
            while (true) {
                ...
                if (i == 0) {
                    break;
                } else if (Double.compare(last, this.refArray[this.array[i]]) < 0) {
                    lastIndex = i;
                    last = this.refArray[this.array[i]];
                }
            }
