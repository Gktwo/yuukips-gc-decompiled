...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap.class */
public class Double2DoubleOpenHashMap extends AbstractDouble2DoubleMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f1586n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f1587f;
    protected transient Double2DoubleMap.FastEntrySet entries;
    protected transient DoubleSet keys;
    protected transient DoubleCollection values;

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap.computeIfPresent(double, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Double, ? extends java.lang.Double>):double, file: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap.class
    ...
    public double computeIfPresent(double r1, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Double, ? extends java.lang.Double> r3) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap.computeIfPresent(double, java.util.function.BiFunction):double");
    }
    ...
    public double compute(double r1, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Double, ? extends java.lang.Double> r3) {
        ...
        // Can't load method instructions: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap.compute(double, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Double, ? extends java.lang.Double>):double, file: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap.class
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap.compute(double, java.util.function.BiFunction):double");
    }
    ...
    public double merge(double r1, double r3, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Double, ? extends java.lang.Double> r5) {
        ...
        // Can't load method instructions: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap.merge(double, double, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Double, ? extends java.lang.Double>):double, file: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap.class
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap.merge(double, double, java.util.function.BiFunction):double");
    }
    ...
    public Double2DoubleOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f1586n = arraySize;
            this.minN = arraySize;
            this.mask = this.f1586n - 1;
            this.maxFill = HashCommon.maxFill(this.f1586n, f);
            this.key = new double[this.f1586n + 1];
            this.value = new double[this.f1586n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f1587f);
        if (needed > this.f1586n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f1587f)))));
        if (needed > this.f1586n) {
            rehash(needed);
        }
    }
    ...
    public double removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f1586n > this.minN && this.size < this.maxFill / 4 && this.f1586n > 16) {
            rehash(this.f1586n / 2);
        }
        return oldValue;
    }
    ...
    public double removeNullEntry() {
        ...
        double oldValue = this.value[this.f1586n];
        this.size--;
        if (this.f1586n > this.minN && this.size < this.maxFill / 4 && this.f1586n > 16) {
            rehash(this.f1586n / 2);
        }
    ...
    private int find(double k) {
        ...
        if (Double.doubleToLongBits(k) == 0) {
            return this.containsNullKey ? this.f1586n : -(this.f1586n + 1);
        }
        double[] key = this.key;
    ...
    private void insert(int pos, double k, double v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f1587f));
        }
    }
    ...
    public double addTo(double k, double incr) {
        ...
        if (Double.doubleToLongBits(k) != 0) {
            ...
            return addToValue(this.f1586n, incr);
        } else {
            pos = this.f1586n;
            this.containsNullKey = true;
        }
    ...
    public double get(double k) {
        double curr;
        if (Double.doubleToLongBits(k) == 0) {
            return this.containsNullKey ? this.value[this.f1586n] : this.defRetValue;
        }
        double[] key = this.key;
        int mix = ((int) HashCommon.mix(Double.doubleToRawLongBits(k))) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(double v) {
        ...
        double[] key = this.key;
        if (this.containsNullKey && Double.doubleToLongBits(value[this.f1586n]) == Double.doubleToLongBits(v)) {
            return true;
        }
        int i = this.f1586n;
        while (true) {
    ...
    public double getOrDefault(double k, double defaultValue) {
        double curr;
        if (Double.doubleToLongBits(k) == 0) {
            return this.containsNullKey ? this.value[this.f1586n] : defaultValue;
        }
        double[] key = this.key;
        int mix = ((int) HashCommon.mix(Double.doubleToRawLongBits(k))) & this.mask;
        int pos = mix;
    ...
    public boolean remove(double k, double v) {
        ...
        } else if (!this.containsNullKey || Double.doubleToLongBits(v) != Double.doubleToLongBits(this.value[this.f1586n])) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap$MapEntry.class */
    public final class MapEntry implements Double2DoubleMap.Entry, Map.Entry<Double, Double>, DoubleDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            return Double.doubleToLongBits(Double2DoubleOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(e.getKey().doubleValue()) && Double.doubleToLongBits(Double2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits(e.getValue().doubleValue());
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Double2DoubleOpenHashMap.this.f1586n;
            this.last = -1;
            this.f1588c = Double2DoubleOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Double2DoubleOpenHashMap.this.f1586n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int i3 = Double2DoubleOpenHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        ...
                        mix = p + 1;
                        i3 = Double2DoubleOpenHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Double2DoubleOpenHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (Double.doubleToLongBits(curr) == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Double2DoubleOpenHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Double2DoubleOpenHashMap.this.value[pos] = Double2DoubleOpenHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Double2DoubleOpenHashMap.this.f1586n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Double2DoubleMap.Entry>> implements ObjectIterator<Double2DoubleMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Double2DoubleOpenHashMap.this.f1586n;
            this.f1589c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1589c++;
                acceptOnIndex(action, Double2DoubleOpenHashMap.this.f1586n);
                return true;
            }
            double[] key = Double2DoubleOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Double2DoubleOpenHashMap.this.size - this.f1589c);
            }
            return Math.min((long) (Double2DoubleOpenHashMap.this.size - this.f1589c), ((long) ((((double) Double2DoubleOpenHashMap.this.realSize()) / ((double) Double2DoubleOpenHashMap.this.f1586n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap r0 = p014it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap.this
                double[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x007a:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Double2DoubleMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Double2DoubleMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Double2DoubleMap.Entry> implements Double2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Double.doubleToLongBits(k) == 0) {
                return Double2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Double2DoubleOpenHashMap.this.value[Double2DoubleOpenHashMap.this.f1586n]) == Double.doubleToLongBits(v);
            }
            double[] key = Double2DoubleOpenHashMap.this.key;
            int mix = ((int) HashCommon.mix(Double.doubleToRawLongBits(k))) & Double2DoubleOpenHashMap.this.mask;
            int pos = mix;
            double curr2 = key[mix];
            if (Double.doubleToLongBits(curr2) == 0) {
                return false;
            ...
            do {
                int i = (pos + 1) & Double2DoubleOpenHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (Double.doubleToLongBits(curr) == 0) {
                    return false;
            ...
            if (Double.doubleToLongBits(k) != 0) {
                ...
                if (Double.doubleToLongBits(curr) != Double.doubleToLongBits(k)) {
                    while (true) {
                        ...
                        if (Double.doubleToLongBits(curr2) == Double.doubleToLongBits(k) && Double.doubleToLongBits(Double2DoubleOpenHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
                            Double2DoubleOpenHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Double.doubleToLongBits(Double2DoubleOpenHashMap.this.value[pos]) != Double.doubleToLongBits(v)) {
                    return false;
                } else {
                    Double2DoubleOpenHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Double2DoubleOpenHashMap.this.containsNullKey || Double.doubleToLongBits(Double2DoubleOpenHashMap.this.value[Double2DoubleOpenHashMap.this.f1586n]) != Double.doubleToLongBits(v)) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Double2DoubleMap.Entry> consumer) {
            if (Double2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractDouble2DoubleMap.BasicEntry(Double2DoubleOpenHashMap.this.key[Double2DoubleOpenHashMap.this.f1586n], Double2DoubleOpenHashMap.this.value[Double2DoubleOpenHashMap.this.f1586n]));
            }
            int pos = Double2DoubleOpenHashMap.this.f1586n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
                }
                if (Double.doubleToLongBits(Double2DoubleOpenHashMap.this.key[pos]) != 0) {
        ...
        public void fastForEach(Consumer<? super Double2DoubleMap.Entry> consumer) {
            ...
            if (Double2DoubleOpenHashMap.this.containsNullKey) {
                entry.key = Double2DoubleOpenHashMap.this.key[Double2DoubleOpenHashMap.this.f1586n];
                entry.value = Double2DoubleOpenHashMap.this.value[Double2DoubleOpenHashMap.this.f1586n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap$KeySet.class */
    public final class KeySet extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Double2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(Double2DoubleOpenHashMap.this.key[Double2DoubleOpenHashMap.this.f1586n]);
            }
            int pos = Double2DoubleOpenHashMap.this.f1586n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleOpenHashMap$ValueSpliterator.class */
    ...
    public Collection<Double> values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2DoubleOpenHashMap.1
                ...
                public void forEach(DoubleConsumer consumer) {
                    if (Double2DoubleOpenHashMap.this.containsNullKey) {
                        consumer.accept(Double2DoubleOpenHashMap.this.value[Double2DoubleOpenHashMap.this.f1586n]);
                    }
                    int pos = Double2DoubleOpenHashMap.this.f1586n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f1587f)));
        if (l >= this.f1586n || this.size > HashCommon.maxFill(l, this.f1587f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f1586n];
                this.f1586n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f1586n, this.f1587f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Double2DoubleOpenHashMap clone() {
        try {
            Double2DoubleOpenHashMap c = (Double2DoubleOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.double2int(this.value[this.f1586n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f1586n = HashCommon.arraySize(this.size, this.f1587f);
        this.maxFill = HashCommon.maxFill(this.f1586n, this.f1587f);
        this.mask = this.f1586n - 1;
        double[] key = new double[this.f1586n + 1];
        this.key = key;
        double[] value = new double[this.f1586n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
