...
/* renamed from: it.unimi.dsi.fastutil.doubles.DoubleSemiIndirectHeaps */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/DoubleSemiIndirectHeaps.class */
public final class DoubleSemiIndirectHeaps {
    static final /* synthetic */ boolean $assertionsDisabled;

    static {
        $assertionsDisabled = !DoubleSemiIndirectHeaps.class.desiredAssertionStatus();
    }
        ...
        if ($assertionsDisabled || i < size) {
            ...
            if (c != null) {
                ...
                while (true) {
                    ...
                    int t2 = heap[child2];
                    int right2 = child2 + 1;
                    if (right2 < size && Double.compare(refArray[heap[right2]], refArray[t2]) < 0) {
                        child2 = right2;
                        t2 = heap[right2];
                    }
                    if (Double.compare(E, refArray[t2]) <= 0) {
                        break;
                    }
                    heap[i] = t2;
                    i = child2;
