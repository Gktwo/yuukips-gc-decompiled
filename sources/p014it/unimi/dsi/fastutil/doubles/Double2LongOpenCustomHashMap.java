...
public class Double2LongOpenCustomHashMap extends AbstractDouble2LongMap implements Serializable, Cloneable, Hash {
    ...
    public Double2LongOpenCustomHashMap(int expected, float f, DoubleHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new long[this.f1654n + 1];
        }
    }
    ...
    public long removeNullEntry() {
        ...
        long oldValue = this.value[this.f1654n];
        this.size--;
        if (this.f1654n > this.minN && this.size < this.maxFill / 4 && this.f1654n > 16) {
            rehash(this.f1654n / 2);
        }
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Double2LongOpenCustomHashMap.this.f1654n;
            this.last = -1;
            this.f1656c = Double2LongOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Double2LongOpenCustomHashMap.this.f1654n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Double2LongOpenCustomHashMap.this.f1654n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Double2LongOpenCustomHashMap.this.f1654n;
            this.f1657c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1657c++;
                acceptOnIndex(action, Double2LongOpenCustomHashMap.this.f1654n);
                return true;
            }
            double[] key = Double2LongOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Double2LongOpenCustomHashMap.this.size - this.f1657c);
            }
            return Math.min((long) (Double2LongOpenCustomHashMap.this.size - this.f1657c), ((long) ((((double) Double2LongOpenCustomHashMap.this.realSize()) / ((double) Double2LongOpenCustomHashMap.this.f1654n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Double2LongMap.Entry> implements Double2LongMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Double2LongOpenCustomHashMap.this.strategy.equals(k, 0.0d)) {
                return Double2LongOpenCustomHashMap.this.containsNullKey && Double2LongOpenCustomHashMap.this.value[Double2LongOpenCustomHashMap.this.f1654n] == v;
            }
            double[] key = Double2LongOpenCustomHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Double2LongOpenCustomHashMap.this.containsNullKey || Double2LongOpenCustomHashMap.this.value[Double2LongOpenCustomHashMap.this.f1654n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Double2LongMap.Entry> consumer) {
            if (Double2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractDouble2LongMap.BasicEntry(Double2LongOpenCustomHashMap.this.key[Double2LongOpenCustomHashMap.this.f1654n], Double2LongOpenCustomHashMap.this.value[Double2LongOpenCustomHashMap.this.f1654n]));
            }
            int pos = Double2LongOpenCustomHashMap.this.f1654n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Double2LongMap.Entry> consumer) {
            ...
            if (Double2LongOpenCustomHashMap.this.containsNullKey) {
                entry.key = Double2LongOpenCustomHashMap.this.key[Double2LongOpenCustomHashMap.this.f1654n];
                entry.value = Double2LongOpenCustomHashMap.this.value[Double2LongOpenCustomHashMap.this.f1654n];
    ...
    public final class KeySet extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Double2LongOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Double2LongOpenCustomHashMap.this.key[Double2LongOpenCustomHashMap.this.f1654n]);
            }
            int pos = Double2LongOpenCustomHashMap.this.f1654n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2LongOpenCustomHashMap.1
                ...
                public void forEach(LongConsumer consumer) {
                    if (Double2LongOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Double2LongOpenCustomHashMap.this.value[Double2LongOpenCustomHashMap.this.f1654n]);
                    }
                    int pos = Double2LongOpenCustomHashMap.this.f1654n;
                    while (true) {
                        pos--;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.long2int(this.value[this.f1654n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        long[] value = new long[this.f1654n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
