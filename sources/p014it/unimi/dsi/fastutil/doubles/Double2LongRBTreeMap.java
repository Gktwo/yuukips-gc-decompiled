...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongRBTreeMap.class */
public class Double2LongRBTreeMap extends AbstractDouble2LongSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap.Entry add(double r11) {
        /*
        // Method dump skipped, instructions count: 947
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap.add(double):it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap$Entry");
    }
    ...
    public long remove(double r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap.remove(double):long");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(double k) {
            Entry locateKey = Double2LongRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2LongMap.Entry>() { // from class: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap.1
                final Comparator<? super Double2LongMap.Entry> comparator;

                {
                    this.comparator = Double2LongRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Double) && e.getValue() != null && (e.getValue() instanceof Long)) {
                        return e.equals(Double2LongRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Double) || e.getValue() == null || !(e.getValue() instanceof Long) || (f = Double2LongRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue())) == null || f.getLongValue() != ((Long) e.getValue()).longValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongRBTreeMap$ValueIterator.class */
    ...
    public LongCollection values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongRBTreeMap$Submap.class */
    public final class Submap extends AbstractDouble2LongSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m931in(double k) {
            return (this.bottom || Double2LongRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2LongRBTreeMap.this.compare(k, this.f1626to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.doubles.Double2LongMap, p014it.unimi.dsi.fastutil.doubles.Double2LongSortedMap
        public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2LongMap.Entry>() { // from class: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Double2LongMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Double) && e.getValue() != null && (e.getValue() instanceof Long) && (f = Double2LongRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue())) != null && Submap.this.m931in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Double2LongRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue());
                        if (f != null && Submap.this.m931in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractDouble2LongSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public LongCollection values() {
            if (this.values == null) {
                this.values = new AbstractLongCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.longs.AbstractLongCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.longs.LongCollection, p014it.unimi.dsi.fastutil.longs.LongIterable
                    public LongIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDouble2LongMap, p014it.unimi.dsi.fastutil.doubles.Double2LongFunction, p014it.unimi.dsi.fastutil.doubles.Double2LongMap
        public boolean containsKey(double k) {
            return m931in(k) && Double2LongRBTreeMap.this.containsKey(k);
        }
        ...
        public long get(double k) {
            Entry e;
            return (!m931in(k) || (e = Double2LongRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public long put(double k, long v) {
            ...
            return Double2LongRBTreeMap.this.modified ? this.defRetValue : Double2LongRBTreeMap.this.put(k, v);
        }
        ...
        public long remove(double k) {
            ...
            return Double2LongRBTreeMap.this.modified ? Double2LongRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2LongSortedMap
        public Double2LongSortedMap headMap(double to) {
            if (!this.top && Double2LongRBTreeMap.this.compare(to, this.f1626to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2LongSortedMap
        public Double2LongSortedMap tailMap(double from) {
            if (!this.bottom && Double2LongRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
        ...
        public Double2LongSortedMap subMap(double d, double d2) {
            ...
            double to = d2;
            if (!this.top) {
                to = Double2LongRBTreeMap.this.compare(d2, this.f1626to) < 0 ? d2 : this.f1626to;
            }
            double from = d;
            if (!this.bottom) {
                from = Double2LongRBTreeMap.this.compare(d, this.from) > 0 ? d : this.from;
            }
            if (!this.top && !this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Double2LongRBTreeMap.this.compare(e.key, this.f1626to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Double2LongRBTreeMap.this.locateKey(this.f1626to);
                if (Double2LongRBTreeMap.this.compare(e.key, this.f1626to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Double2LongRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, double k) {
                ...
                if (submap.bottom || Double2LongRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Double2LongRBTreeMap double2LongRBTreeMap = Double2LongRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (double2LongRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Double2LongRBTreeMap.this.compare(this.next.key, Submap.this.f1626to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Double2LongRBTreeMap clone() {
        try {
            Double2LongRBTreeMap c = (Double2LongRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
