...
import p014it.unimi.dsi.fastutil.doubles.Double2LongFunctions;
...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongMaps */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongMaps.class */
public final class Double2LongMaps {
    ...
    public static ObjectIterable<Double2LongMap.Entry> fastIterable(Double2LongMap map) {
        ...
        return entries instanceof Double2LongMap.FastEntrySet ? new ObjectIterable<Double2LongMap.Entry>() { // from class: it.unimi.dsi.fastutil.doubles.Double2LongMaps.1
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectIterable, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection
            public ObjectIterator<Double2LongMap.Entry> iterator() {
                return ((Double2LongMap.FastEntrySet) ObjectSet.this).fastIterator();
            }
            ...
            public void forEach(Consumer<? super Double2LongMap.Entry> consumer) {
                ((Double2LongMap.FastEntrySet) ObjectSet.this).fastForEach(consumer);
            }
        } : entries;
    }

    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongMaps$EmptyMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongMaps$EmptyMap.class */
    public static class EmptyMap extends Double2LongFunctions.EmptyFunction implements Double2LongMap, Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2LongFunctions.EmptyFunction, p014it.unimi.dsi.fastutil.doubles.Double2LongFunction
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2LongFunctions.EmptyFunction, java.lang.Object
        public Object clone() {
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongMaps$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongMaps$Singleton.class */
    public static class Singleton extends Double2LongFunctions.Singleton implements Double2LongMap, Serializable, Cloneable {
        ...
        public Singleton(double key, long value) {
            super(key, value);
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongMaps$SynchronizedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongMaps$SynchronizedMap.class */
    public static class SynchronizedMap extends Double2LongFunctions.SynchronizedFunction implements Double2LongMap, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedMap(Double2LongMap m, Object sync) {
            super(m, sync);
            this.map = m;
        }

        /* access modifiers changed from: protected */
        public SynchronizedMap(Double2LongMap m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2LongMap, p014it.unimi.dsi.fastutil.doubles.Double2LongSortedMap
        public ObjectSet<Double2LongMap.Entry> double2LongEntrySet() {
            ObjectSet<Double2LongMap.Entry> objectSet;
            synchronized (this.sync) {
                if (this.entries == null) {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2LongFunctions.SynchronizedFunction, java.lang.Object
        public int hashCode() {
            int hashCode;
            synchronized (this.sync) {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2LongFunctions.SynchronizedFunction, p014it.unimi.dsi.fastutil.doubles.Double2LongFunction
        public long getOrDefault(double key, long defaultValue) {
            long orDefault;
            synchronized (this.sync) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongMaps$UnmodifiableMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongMaps$UnmodifiableMap.class */
    public static class UnmodifiableMap extends Double2LongFunctions.UnmodifiableFunction implements Double2LongMap, Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableMap(Double2LongMap m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2LongFunctions.UnmodifiableFunction, java.lang.Object
        public int hashCode() {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2LongFunctions.UnmodifiableFunction, p014it.unimi.dsi.fastutil.doubles.Double2LongFunction
        public long getOrDefault(double key, long defaultValue) {
