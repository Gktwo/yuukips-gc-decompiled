...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ShortOpenHashMap.class */
public class Double2ShortOpenHashMap extends AbstractDouble2ShortMap implements Serializable, Cloneable, Hash {
    ...
    public Double2ShortOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new short[this.f1658n + 1];
        }
    }
    ...
    public short removeNullEntry() {
        ...
        short oldValue = this.value[this.f1658n];
        this.size--;
        if (this.f1658n > this.minN && this.size < this.maxFill / 4 && this.f1658n > 16) {
            rehash(this.f1658n / 2);
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ShortOpenHashMap$MapEntry.class */
    public final class MapEntry implements Double2ShortMap.Entry, Map.Entry<Double, Short>, DoubleShortPair {
        ...
        public boolean equals(Object o) {
            ...
            return Double.doubleToLongBits(Double2ShortOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(e.getKey().doubleValue()) && Double2ShortOpenHashMap.this.value[this.index] == e.getValue().shortValue();
        }
        ...
        public String toString() {
            return Double2ShortOpenHashMap.this.key[this.index] + "=>" + ((int) Double2ShortOpenHashMap.this.value[this.index]);
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ShortOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Double2ShortOpenHashMap.this.f1658n;
            this.last = -1;
            this.f1660c = Double2ShortOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Double2ShortOpenHashMap.this.f1658n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int i3 = Double2ShortOpenHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        ...
                        mix = p + 1;
                        i3 = Double2ShortOpenHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Double2ShortOpenHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (Double.doubleToLongBits(curr) == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Double2ShortOpenHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Double2ShortOpenHashMap.this.value[pos] = Double2ShortOpenHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Double2ShortOpenHashMap.this.f1658n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ShortOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Double2ShortMap.Entry>> implements ObjectIterator<Double2ShortMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ShortOpenHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ShortOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Double2ShortOpenHashMap.this.f1658n;
            this.f1661c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1661c++;
                acceptOnIndex(action, Double2ShortOpenHashMap.this.f1658n);
                return true;
            }
            double[] key = Double2ShortOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Double2ShortOpenHashMap.this.size - this.f1661c);
            }
            return Math.min((long) (Double2ShortOpenHashMap.this.size - this.f1661c), ((long) ((((double) Double2ShortOpenHashMap.this.realSize()) / ((double) Double2ShortOpenHashMap.this.f1658n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap r0 = p014it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap.this
                double[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x007a:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ShortOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Double2ShortMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Double2ShortMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ShortOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Double2ShortMap.Entry> implements Double2ShortMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Double.doubleToLongBits(k) == 0) {
                return Double2ShortOpenHashMap.this.containsNullKey && Double2ShortOpenHashMap.this.value[Double2ShortOpenHashMap.this.f1658n] == v;
            }
            double[] key = Double2ShortOpenHashMap.this.key;
            int mix = ((int) HashCommon.mix(Double.doubleToRawLongBits(k))) & Double2ShortOpenHashMap.this.mask;
            int pos = mix;
            double curr2 = key[mix];
            if (Double.doubleToLongBits(curr2) == 0) {
                return false;
            ...
            do {
                int i = (pos + 1) & Double2ShortOpenHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (Double.doubleToLongBits(curr) == 0) {
                    return false;
            ...
            if (Double.doubleToLongBits(k) != 0) {
                ...
                if (Double.doubleToLongBits(curr) != Double.doubleToLongBits(k)) {
                    while (true) {
                        ...
                        if (Double.doubleToLongBits(curr2) == Double.doubleToLongBits(k) && Double2ShortOpenHashMap.this.value[pos] == v) {
                            Double2ShortOpenHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Double2ShortOpenHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Double2ShortOpenHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Double2ShortOpenHashMap.this.containsNullKey || Double2ShortOpenHashMap.this.value[Double2ShortOpenHashMap.this.f1658n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Double2ShortMap.Entry> consumer) {
            if (Double2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractDouble2ShortMap.BasicEntry(Double2ShortOpenHashMap.this.key[Double2ShortOpenHashMap.this.f1658n], Double2ShortOpenHashMap.this.value[Double2ShortOpenHashMap.this.f1658n]));
            }
            int pos = Double2ShortOpenHashMap.this.f1658n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
                }
                if (Double.doubleToLongBits(Double2ShortOpenHashMap.this.key[pos]) != 0) {
        ...
        public void fastForEach(Consumer<? super Double2ShortMap.Entry> consumer) {
            ...
            if (Double2ShortOpenHashMap.this.containsNullKey) {
                entry.key = Double2ShortOpenHashMap.this.key[Double2ShortOpenHashMap.this.f1658n];
                entry.value = Double2ShortOpenHashMap.this.value[Double2ShortOpenHashMap.this.f1658n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ShortOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ShortOpenHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ShortOpenHashMap$KeySet.class */
    public final class KeySet extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Double2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(Double2ShortOpenHashMap.this.key[Double2ShortOpenHashMap.this.f1658n]);
            }
            int pos = Double2ShortOpenHashMap.this.f1658n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ShortOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ShortOpenHashMap$ValueSpliterator.class */
    ...
    public Collection<Short> values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2ShortOpenHashMap.1
                ...
                public void forEach(ShortConsumer consumer) {
                    if (Double2ShortOpenHashMap.this.containsNullKey) {
                        consumer.accept(Double2ShortOpenHashMap.this.value[Double2ShortOpenHashMap.this.f1658n]);
                    }
                    int pos = Double2ShortOpenHashMap.this.f1658n;
                    while (true) {
                        pos--;
    ...
    public Double2ShortOpenHashMap clone() {
        try {
            Double2ShortOpenHashMap c = (Double2ShortOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        short[] value = new short[this.f1658n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
