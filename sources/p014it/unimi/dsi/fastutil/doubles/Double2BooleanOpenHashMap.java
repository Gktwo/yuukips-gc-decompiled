...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanOpenHashMap.class */
public class Double2BooleanOpenHashMap extends AbstractDouble2BooleanMap implements Serializable, Cloneable, Hash {
    ...
    public Double2BooleanOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new boolean[this.f1586n + 1];
        }
    }
    ...
    public boolean removeNullEntry() {
        ...
        boolean oldValue = this.value[this.f1586n];
        this.size--;
        if (this.f1586n > this.minN && this.size < this.maxFill / 4 && this.f1586n > 16) {
            rehash(this.f1586n / 2);
        }
    ...
    public boolean containsValue(boolean v) {
        ...
        double[] key = this.key;
        if (this.containsNullKey && value[this.f1586n] == v) {
            return true;
        }
        int i = this.f1586n;
        while (true) {
    ...
    public boolean remove(double k, boolean v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1586n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanOpenHashMap$MapEntry.class */
    public final class MapEntry implements Double2BooleanMap.Entry, Map.Entry<Double, Boolean>, DoubleBooleanPair {
        ...
        public boolean equals(Object o) {
            ...
            return Double.doubleToLongBits(Double2BooleanOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(e.getKey().doubleValue()) && Double2BooleanOpenHashMap.this.value[this.index] == e.getValue().booleanValue();
        }

        @Override // java.util.Map.Entry, java.lang.Object
        public int hashCode() {
            return HashCommon.double2int(Double2BooleanOpenHashMap.this.key[this.index]) ^ (Double2BooleanOpenHashMap.this.value[this.index] ? RetcodeOuterClass.Retcode.RET_MP_OTHER_DATA_VERSION_NOT_LATEST_VALUE : RetcodeOuterClass.Retcode.RET_MP_MATCH_FULL_VALUE);
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Double2BooleanOpenHashMap.this.f1586n;
            this.last = -1;
            this.f1588c = Double2BooleanOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Double2BooleanOpenHashMap.this.f1586n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int i3 = Double2BooleanOpenHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        ...
                        mix = p + 1;
                        i3 = Double2BooleanOpenHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Double2BooleanOpenHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (Double.doubleToLongBits(curr) == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Double2BooleanOpenHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Double2BooleanOpenHashMap.this.value[pos] = Double2BooleanOpenHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Double2BooleanOpenHashMap.this.f1586n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Double2BooleanMap.Entry>> implements ObjectIterator<Double2BooleanMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanOpenHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Double2BooleanOpenHashMap.this.f1586n;
            this.f1589c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1589c++;
                acceptOnIndex(action, Double2BooleanOpenHashMap.this.f1586n);
                return true;
            }
            double[] key = Double2BooleanOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Double2BooleanOpenHashMap.this.size - this.f1589c);
            }
            return Math.min((long) (Double2BooleanOpenHashMap.this.size - this.f1589c), ((long) ((((double) Double2BooleanOpenHashMap.this.realSize()) / ((double) Double2BooleanOpenHashMap.this.f1586n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap r0 = p014it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap.this
                double[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x007a:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Double2BooleanMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Double2BooleanMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Double2BooleanMap.Entry> implements Double2BooleanMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Double.doubleToLongBits(k) == 0) {
                return Double2BooleanOpenHashMap.this.containsNullKey && Double2BooleanOpenHashMap.this.value[Double2BooleanOpenHashMap.this.f1586n] == v;
            }
            double[] key = Double2BooleanOpenHashMap.this.key;
            int mix = ((int) HashCommon.mix(Double.doubleToRawLongBits(k))) & Double2BooleanOpenHashMap.this.mask;
            int pos = mix;
            double curr2 = key[mix];
            if (Double.doubleToLongBits(curr2) == 0) {
                return false;
            ...
            do {
                int i = (pos + 1) & Double2BooleanOpenHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (Double.doubleToLongBits(curr) == 0) {
                    return false;
            ...
            if (Double.doubleToLongBits(k) != 0) {
                ...
                if (Double.doubleToLongBits(curr) != Double.doubleToLongBits(k)) {
                    while (true) {
                        ...
                        if (Double.doubleToLongBits(curr2) == Double.doubleToLongBits(k) && Double2BooleanOpenHashMap.this.value[pos] == v) {
                            Double2BooleanOpenHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Double2BooleanOpenHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Double2BooleanOpenHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Double2BooleanOpenHashMap.this.containsNullKey || Double2BooleanOpenHashMap.this.value[Double2BooleanOpenHashMap.this.f1586n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Double2BooleanMap.Entry> consumer) {
            if (Double2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractDouble2BooleanMap.BasicEntry(Double2BooleanOpenHashMap.this.key[Double2BooleanOpenHashMap.this.f1586n], Double2BooleanOpenHashMap.this.value[Double2BooleanOpenHashMap.this.f1586n]));
            }
            int pos = Double2BooleanOpenHashMap.this.f1586n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
                }
                if (Double.doubleToLongBits(Double2BooleanOpenHashMap.this.key[pos]) != 0) {
        ...
        public void fastForEach(Consumer<? super Double2BooleanMap.Entry> consumer) {
            ...
            if (Double2BooleanOpenHashMap.this.containsNullKey) {
                entry.key = Double2BooleanOpenHashMap.this.key[Double2BooleanOpenHashMap.this.f1586n];
                entry.value = Double2BooleanOpenHashMap.this.value[Double2BooleanOpenHashMap.this.f1586n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanOpenHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanOpenHashMap$KeySet.class */
    public final class KeySet extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Double2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(Double2BooleanOpenHashMap.this.key[Double2BooleanOpenHashMap.this.f1586n]);
            }
            int pos = Double2BooleanOpenHashMap.this.f1586n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanOpenHashMap$ValueSpliterator.class */
    ...
    public Collection<Boolean> values() {
        if (this.values == null) {
            this.values = new AbstractBooleanCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2BooleanOpenHashMap.1
                ...
                public void forEach(BooleanConsumer consumer) {
                    if (Double2BooleanOpenHashMap.this.containsNullKey) {
                        consumer.accept(Double2BooleanOpenHashMap.this.value[Double2BooleanOpenHashMap.this.f1586n]);
                    }
                    int pos = Double2BooleanOpenHashMap.this.f1586n;
                    while (true) {
                        pos--;
    ...
    public Double2BooleanOpenHashMap clone() {
        try {
            Double2BooleanOpenHashMap c = (Double2BooleanOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += this.value[this.f1586n] ? RetcodeOuterClass.Retcode.RET_MP_OTHER_DATA_VERSION_NOT_LATEST_VALUE : RetcodeOuterClass.Retcode.RET_MP_MATCH_FULL_VALUE;
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        boolean[] value = new boolean[this.f1586n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
