...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongArrayMap.class */
public class Double2LongArrayMap extends AbstractDouble2LongMap implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Double2LongArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Double2LongArrayMap(Double2LongMap m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Double2LongMap.Entry> it = m.double2LongEntrySet().iterator();
        while (it.hasNext()) {
            Double2LongMap.Entry e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Double2LongMap.Entry> implements Double2LongMap.FastEntrySet {
        ...
        public ObjectIterator<Double2LongMap.Entry> iterator() {
            return new ObjectIterator<Double2LongMap.Entry>() { // from class: it.unimi.dsi.fastutil.doubles.Double2LongArrayMap.EntrySet.1
                ...
                public Double2LongMap.Entry next() {
                    ...
                    double[] dArr = Double2LongArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    double d = dArr[i];
                    long[] jArr = Double2LongArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractDouble2LongMap.BasicEntry(d, jArr[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Double2LongArrayMap.access$010(Double2LongArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Double2LongMap.Entry> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractDouble2LongMap.BasicEntry(d, jArr[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Double2LongMap.Entry> fastIterator() {
            return new ObjectIterator<Double2LongMap.Entry>() { // from class: it.unimi.dsi.fastutil.doubles.Double2LongArrayMap.EntrySet.2
                ...
                public Double2LongMap.Entry next() {
                    ...
                    AbstractDouble2LongMap.BasicEntry basicEntry = this.entry;
                    double[] dArr = Double2LongArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = dArr[i];
                    AbstractDouble2LongMap.BasicEntry basicEntry2 = this.entry;
                    long[] jArr = Double2LongArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Double2LongMap.Entry> implements ObjectSpliterator<Double2LongMap.Entry> {
            ...
            public final Double2LongMap.Entry get(int location) {
        ...
        public boolean remove(Object o) {
            ...
            Double2LongArrayMap.access$010(Double2LongArrayMap.this);
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongArrayMap$KeySet.class */
    public final class KeySet extends AbstractDoubleSet {
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongArrayMap$KeySet$KeySetSpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractLongCollection {
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongArrayMap$ValuesCollection$ValuesSpliterator.class */
    ...
    public Double2LongArrayMap clone() {
        try {
            Double2LongArrayMap c = (Double2LongArrayMap) clone();
