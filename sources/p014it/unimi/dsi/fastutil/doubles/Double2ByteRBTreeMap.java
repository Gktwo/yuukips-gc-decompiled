...
import p014it.unimi.dsi.fastutil.doubles.AbstractDouble2ByteSortedMap;
...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ByteRBTreeMap.class */
public class Double2ByteRBTreeMap extends AbstractDouble2ByteSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap.Entry add(double r10) {
        /*
        // Method dump skipped, instructions count: 947
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap.add(double):it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.doubles.Double2ByteFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public byte remove(double r7) {
        /*
        // Method dump skipped, instructions count: 1897
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap.remove(double):byte");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ByteRBTreeMap$Entry.class */
    public static final class Entry extends AbstractDouble2ByteMap.BasicEntry implements Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDouble2ByteMap.BasicEntry, p014it.unimi.dsi.fastutil.doubles.Double2ByteMap.Entry
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDouble2ByteMap.BasicEntry, java.util.Map.Entry, java.lang.Object
        public boolean equals(Object o) {
            if (!(o instanceof Map.Entry)) {
                return false;
            }
            Map.Entry<Double, Byte> e = (Map.Entry) o;
            return Double.doubleToLongBits(this.key) == Double.doubleToLongBits(e.getKey().doubleValue()) && this.value == e.getValue().byteValue();
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDouble2ByteMap.BasicEntry, java.lang.Object
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ByteRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(double k) {
            Entry locateKey = Double2ByteRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ByteRBTreeMap$EntryIterator.class */
    public class EntryIterator extends TreeIterator implements ObjectListIterator<Double2ByteMap.Entry> {
        EntryIterator() {
            super();
        }
    ...
    public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap.1
                final Comparator<? super Double2ByteMap.Entry> comparator;

                {
                    this.comparator = Double2ByteRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Double) && e.getValue() != null && (e.getValue() instanceof Byte)) {
                        return e.equals(Double2ByteRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Double) || e.getValue() == null || !(e.getValue() instanceof Byte) || (f = Double2ByteRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue())) == null || f.getByteValue() != ((Byte) e.getValue()).byteValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ByteRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ByteRBTreeMap$KeySet.class */
    public class KeySet extends AbstractDouble2ByteSortedMap.KeySet {
        private KeySet() {
            super();
        }

        @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDouble2ByteSortedMap.KeySet, p014it.unimi.dsi.fastutil.doubles.AbstractDoubleSortedSet, p014it.unimi.dsi.fastutil.doubles.AbstractDoubleSet, p014it.unimi.dsi.fastutil.doubles.AbstractDoubleCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.doubles.DoubleCollection, p014it.unimi.dsi.fastutil.doubles.DoubleIterable
        public DoubleBidirectionalIterator iterator() {
            return new KeyIterator();
        }

        @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDouble2ByteSortedMap.KeySet, p014it.unimi.dsi.fastutil.doubles.DoubleSortedSet
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ByteRBTreeMap$ValueIterator.class */
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ByteRBTreeMap$Submap.class */
    public final class Submap extends AbstractDouble2ByteSortedMap implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        double from;
        ...
        /* renamed from: in */
        final boolean m941in(double k) {
            return (this.bottom || Double2ByteRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2ByteRBTreeMap.this.compare(k, this.f1566to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.doubles.Double2ByteMap, p014it.unimi.dsi.fastutil.doubles.Double2ByteSortedMap
        public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Double) && e.getValue() != null && (e.getValue() instanceof Byte) && (f = Double2ByteRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue())) != null && Submap.this.m941in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Double2ByteRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue());
                        if (f != null && Submap.this.m941in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ByteRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractDouble2ByteSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ByteCollection values() {
            if (this.values == null) {
                this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByteCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.bytes.ByteCollection, p014it.unimi.dsi.fastutil.bytes.ByteIterable, p014it.unimi.dsi.fastutil.bytes.ByteSet, java.util.Set
                    public ByteIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDouble2ByteMap, p014it.unimi.dsi.fastutil.doubles.Double2ByteFunction, p014it.unimi.dsi.fastutil.doubles.Double2ByteMap
        public boolean containsKey(double k) {
            return m941in(k) && Double2ByteRBTreeMap.this.containsKey(k);
        }
        ...
        public byte get(double k) {
            Entry e;
            return (!m941in(k) || (e = Double2ByteRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public byte put(double k, byte v) {
            ...
            if (!m941in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1566to)) + ")");
            }
            return Double2ByteRBTreeMap.this.modified ? this.defRetValue : Double2ByteRBTreeMap.this.put(k, v);
        }
        ...
        public byte remove(double k) {
            ...
            return Double2ByteRBTreeMap.this.modified ? Double2ByteRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2ByteSortedMap
        public Double2ByteSortedMap headMap(double to) {
            if (!this.top && Double2ByteRBTreeMap.this.compare(to, this.f1566to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2ByteSortedMap
        public Double2ByteSortedMap tailMap(double from) {
            if (!this.bottom && Double2ByteRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1566to, this.top);
        }
        ...
        public Double2ByteSortedMap subMap(double d, double d2) {
            ...
            double to = d2;
            if (!this.top) {
                to = Double2ByteRBTreeMap.this.compare(d2, this.f1566to) < 0 ? d2 : this.f1566to;
            }
            double from = d;
            if (!this.bottom) {
                from = Double2ByteRBTreeMap.this.compare(d, this.from) > 0 ? d : this.from;
            }
            if (!this.top && !this.bottom) {
                if ((from == Double.MIN_VALUE ? 1.0d : 0.0d) == this.from) {
                    if ((to == Double.MIN_VALUE ? 1.0d : 0.0d) == this.f1566to) {
                        return this;
                    }
                }
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Double2ByteRBTreeMap.this.compare(e.key, this.f1566to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Double2ByteRBTreeMap.this.locateKey(this.f1566to);
                if (Double2ByteRBTreeMap.this.compare(e.key, this.f1566to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Double2ByteRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ByteRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, double k) {
                ...
                if (submap.bottom || Double2ByteRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Double2ByteRBTreeMap double2ByteRBTreeMap = Double2ByteRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (double2ByteRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Double2ByteRBTreeMap.this.compare(this.next.key, Submap.this.f1566to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ByteRBTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Double2ByteMap.Entry> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ByteRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ByteRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ByteRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Double2ByteRBTreeMap clone() {
        try {
            Double2ByteRBTreeMap c = (Double2ByteRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n == 1) {
            ...
            Entry top2 = new Entry(s.readDouble(), s.readByte());
            top2.black(true);
            top2.right(new Entry(s.readDouble(), s.readByte()));
