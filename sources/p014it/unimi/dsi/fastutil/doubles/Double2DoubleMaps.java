...
import p014it.unimi.dsi.fastutil.doubles.Double2DoubleFunctions;
...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleMaps */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleMaps.class */
public final class Double2DoubleMaps {
    ...
    public static ObjectIterable<Double2DoubleMap.Entry> fastIterable(Double2DoubleMap map) {
        ...
        return entries instanceof Double2DoubleMap.FastEntrySet ? new ObjectIterable<Double2DoubleMap.Entry>() { // from class: it.unimi.dsi.fastutil.doubles.Double2DoubleMaps.1
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleMaps$EmptyMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleMaps$EmptyMap.class */
    public static class EmptyMap extends Double2DoubleFunctions.EmptyFunction implements Double2DoubleMap, Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2DoubleFunctions.EmptyFunction, p014it.unimi.dsi.fastutil.doubles.Double2DoubleFunction
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2DoubleFunctions.EmptyFunction, java.lang.Object
        public Object clone() {
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleMaps$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleMaps$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleMaps$SynchronizedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleMaps$SynchronizedMap.class */
    public static class SynchronizedMap extends Double2DoubleFunctions.SynchronizedFunction implements Double2DoubleMap, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedMap(Double2DoubleMap m, Object sync) {
            super(m, sync);
            this.map = m;
        }

        /* access modifiers changed from: protected */
        public SynchronizedMap(Double2DoubleMap m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2DoubleMap, p014it.unimi.dsi.fastutil.doubles.Double2DoubleSortedMap
        public ObjectSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
            ObjectSet<Double2DoubleMap.Entry> objectSet;
            synchronized (this.sync) {
                if (this.entries == null) {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2DoubleFunctions.SynchronizedFunction, java.lang.Object
        public int hashCode() {
            int hashCode;
            synchronized (this.sync) {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2DoubleFunctions.SynchronizedFunction, p014it.unimi.dsi.fastutil.doubles.Double2DoubleFunction
        public double getOrDefault(double key, double defaultValue) {
            double orDefault;
            synchronized (this.sync) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2DoubleMaps$UnmodifiableMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2DoubleMaps$UnmodifiableMap.class */
    public static class UnmodifiableMap extends Double2DoubleFunctions.UnmodifiableFunction implements Double2DoubleMap, Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableMap(Double2DoubleMap m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2DoubleFunctions.UnmodifiableFunction, java.lang.Object
        public int hashCode() {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2DoubleFunctions.UnmodifiableFunction, p014it.unimi.dsi.fastutil.doubles.Double2DoubleFunction
        public double getOrDefault(double key, double defaultValue) {
