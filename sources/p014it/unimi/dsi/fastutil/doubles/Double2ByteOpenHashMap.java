...
public class Double2ByteOpenHashMap extends AbstractDouble2ByteMap implements Serializable, Cloneable, Hash {
    ...
    public Double2ByteOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new byte[this.f1598n + 1];
        }
    }
    ...
    public byte removeNullEntry() {
        ...
        byte oldValue = this.value[this.f1598n];
        this.size--;
        if (this.f1598n > this.minN && this.size < this.maxFill / 4 && this.f1598n > 16) {
            rehash(this.f1598n / 2);
        }
    ...
    public boolean containsValue(byte v) {
        ...
        double[] key = this.key;
        if (this.containsNullKey && value[this.f1598n] == v) {
            return true;
        }
        int i = this.f1598n;
        while (true) {
    ...
    public boolean remove(double k, byte v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1598n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Double2ByteOpenHashMap.this.f1598n;
            this.last = -1;
            this.f1600c = Double2ByteOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Double2ByteOpenHashMap.this.f1598n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Double2ByteOpenHashMap.this.f1598n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Double2ByteOpenHashMap.this.f1598n;
            this.f1601c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1601c++;
                acceptOnIndex(action, Double2ByteOpenHashMap.this.f1598n);
                return true;
            }
            double[] key = Double2ByteOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Double2ByteOpenHashMap.this.size - this.f1601c);
            }
            return Math.min((long) (Double2ByteOpenHashMap.this.size - this.f1601c), ((long) ((((double) Double2ByteOpenHashMap.this.realSize()) / ((double) Double2ByteOpenHashMap.this.f1598n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Double2ByteMap.Entry> implements Double2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Double.doubleToLongBits(k) == 0) {
                return Double2ByteOpenHashMap.this.containsNullKey && Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.f1598n] == v;
            }
            double[] key = Double2ByteOpenHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Double2ByteOpenHashMap.this.containsNullKey || Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.f1598n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Double2ByteMap.Entry> consumer) {
            if (Double2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractDouble2ByteMap.BasicEntry(Double2ByteOpenHashMap.this.key[Double2ByteOpenHashMap.this.f1598n], Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.f1598n]));
            }
            int pos = Double2ByteOpenHashMap.this.f1598n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Double2ByteMap.Entry> consumer) {
            ...
            if (Double2ByteOpenHashMap.this.containsNullKey) {
                entry.key = Double2ByteOpenHashMap.this.key[Double2ByteOpenHashMap.this.f1598n];
                entry.value = Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.f1598n];
    ...
    public final class KeySet extends AbstractDoubleSet {
        ...
        public void forEach(DoubleConsumer consumer) {
            if (Double2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(Double2ByteOpenHashMap.this.key[Double2ByteOpenHashMap.this.f1598n]);
            }
            int pos = Double2ByteOpenHashMap.this.f1598n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2ByteOpenHashMap.1
                ...
                public void forEach(ByteConsumer consumer) {
                    if (Double2ByteOpenHashMap.this.containsNullKey) {
                        consumer.accept(Double2ByteOpenHashMap.this.value[Double2ByteOpenHashMap.this.f1598n]);
                    }
                    int pos = Double2ByteOpenHashMap.this.f1598n;
                    while (true) {
                        pos--;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        byte[] value = new byte[this.f1598n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
