...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanRBTreeMap.class */
public class Double2BooleanRBTreeMap extends AbstractDouble2BooleanSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap.Entry add(double r10) {
        /*
        // Method dump skipped, instructions count: 947
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap.add(double):it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap$Entry");
    }
    ...
    public boolean remove(double r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap.remove(double):boolean");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(double k) {
            Entry locateKey = Double2BooleanRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Double2BooleanMap.Entry>() { // from class: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap.1
                final Comparator<? super Double2BooleanMap.Entry> comparator;

                {
                    this.comparator = Double2BooleanRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Double) && e.getValue() != null && (e.getValue() instanceof Boolean)) {
                        return e.equals(Double2BooleanRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Double) || e.getValue() == null || !(e.getValue() instanceof Boolean) || (f = Double2BooleanRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue())) == null || f.getBooleanValue() != ((Boolean) e.getValue()).booleanValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanRBTreeMap$ValueIterator.class */
    ...
    public BooleanCollection values() {
        if (this.values == null) {
            this.values = new AbstractBooleanCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanRBTreeMap$Submap.class */
    public final class Submap extends AbstractDouble2BooleanSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m943in(double k) {
            return (this.bottom || Double2BooleanRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Double2BooleanRBTreeMap.this.compare(k, this.f1590to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.doubles.Double2BooleanMap, p014it.unimi.dsi.fastutil.doubles.Double2BooleanSortedMap
        public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Double2BooleanMap.Entry>() { // from class: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Double2BooleanMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Double) && e.getValue() != null && (e.getValue() instanceof Boolean) && (f = Double2BooleanRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue())) != null && Submap.this.m943in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Double2BooleanRBTreeMap.this.findKey(((Double) e.getKey()).doubleValue());
                        if (f != null && Submap.this.m943in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractDouble2BooleanSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public BooleanCollection values() {
            if (this.values == null) {
                this.values = new AbstractBooleanCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.booleans.AbstractBooleanCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.booleans.BooleanCollection, p014it.unimi.dsi.fastutil.booleans.BooleanIterable, p014it.unimi.dsi.fastutil.booleans.BooleanBigList
                    public BooleanIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDouble2BooleanMap, p014it.unimi.dsi.fastutil.doubles.Double2BooleanFunction, p014it.unimi.dsi.fastutil.doubles.Double2BooleanMap
        public boolean containsKey(double k) {
            return m943in(k) && Double2BooleanRBTreeMap.this.containsKey(k);
        }
        ...
        public boolean get(double k) {
            Entry e;
            return (!m943in(k) || (e = Double2BooleanRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public boolean put(double k, boolean v) {
            ...
            if (!m943in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1590to)) + ")");
            }
            return Double2BooleanRBTreeMap.this.modified ? this.defRetValue : Double2BooleanRBTreeMap.this.put(k, v);
        }
        ...
        public boolean remove(double k) {
            ...
            return Double2BooleanRBTreeMap.this.modified ? Double2BooleanRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2BooleanSortedMap
        public Double2BooleanSortedMap headMap(double to) {
            if (!this.top && Double2BooleanRBTreeMap.this.compare(to, this.f1590to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2BooleanSortedMap
        public Double2BooleanSortedMap tailMap(double from) {
            if (!this.bottom && Double2BooleanRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1590to, this.top);
        }
        ...
        public Double2BooleanSortedMap subMap(double d, double d2) {
            ...
            double to = d2;
            if (!this.top) {
                to = Double2BooleanRBTreeMap.this.compare(d2, this.f1590to) < 0 ? d2 : this.f1590to;
            }
            double from = d;
            if (!this.bottom) {
                from = Double2BooleanRBTreeMap.this.compare(d, this.from) > 0 ? d : this.from;
            }
            if (!this.top && !this.bottom) {
                if ((from == Double.MIN_VALUE ? 1.0d : 0.0d) == this.from) {
                    if ((to == Double.MIN_VALUE ? 1.0d : 0.0d) == this.f1590to) {
                        return this;
                    }
                }
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Double2BooleanRBTreeMap.this.compare(e.key, this.f1590to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Double2BooleanRBTreeMap.this.locateKey(this.f1590to);
                if (Double2BooleanRBTreeMap.this.compare(e.key, this.f1590to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Double2BooleanRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, double k) {
                ...
                if (submap.bottom || Double2BooleanRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Double2BooleanRBTreeMap double2BooleanRBTreeMap = Double2BooleanRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (double2BooleanRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Double2BooleanRBTreeMap.this.compare(this.next.key, Submap.this.f1590to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Double2BooleanRBTreeMap clone() {
        try {
            Double2BooleanRBTreeMap c = (Double2BooleanRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
