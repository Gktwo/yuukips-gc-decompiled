...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceMap.class */
public interface Double2ReferenceMap<V> extends Double2ReferenceFunction<V>, Map<Double, V> {
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceMap$FastEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceMap$FastEntrySet.class */
    ...
    default void forEach(BiConsumer<? super Double, ? super V> consumer) {
        ObjectSet<Entry<V>> entrySet = double2ReferenceEntrySet();
    ...
    default V computeIfAbsentPartial(double key, Double2ReferenceFunction<? extends V> mappingFunction) {
        return computeIfAbsent(key, (Double2ReferenceFunction) mappingFunction);
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceMap$Entry.class */
