...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntOpenHashMap.class */
public class Double2IntOpenHashMap extends AbstractDouble2IntMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntOpenHashMap$MapEntry.class */
    public final class MapEntry implements Double2IntMap.Entry, Map.Entry<Double, Integer>, DoubleIntPair {
        ...
        public boolean equals(Object o) {
            ...
            return Double.doubleToLongBits(Double2IntOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(e.getKey().doubleValue()) && Double2IntOpenHashMap.this.value[this.index] == e.getValue().intValue();
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int i3 = Double2IntOpenHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Double2IntOpenHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (Double.doubleToLongBits(curr) == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Double2IntOpenHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Double2IntOpenHashMap.this.value[pos] = Double2IntOpenHashMap.this.value[pos];
            }
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Double2IntMap.Entry>> implements ObjectIterator<Double2IntMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntOpenHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap r0 = p014it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap.this
                double[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x007a:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Double2IntMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Double2IntMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Double2IntMap.Entry> implements Double2IntMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                int i = (pos + 1) & Double2IntOpenHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (Double.doubleToLongBits(curr) == 0) {
                    return false;
            ...
            if (Double.doubleToLongBits(k) != 0) {
                ...
                if (Double.doubleToLongBits(curr) != Double.doubleToLongBits(k)) {
                    while (true) {
                        ...
                        if (Double.doubleToLongBits(curr2) == Double.doubleToLongBits(k) && Double2IntOpenHashMap.this.value[pos] == v) {
                            Double2IntOpenHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Double2IntOpenHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Double2IntOpenHashMap.this.removeEntry(pos);
                    return true;
        ...
        public void forEach(Consumer<? super Double2IntMap.Entry> consumer) {
            ...
            while (true) {
                ...
                if (Double.doubleToLongBits(Double2IntOpenHashMap.this.key[pos]) != 0) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntOpenHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntOpenHashMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2IntOpenHashMap$ValueSpliterator.class */
    ...
    public Collection<Integer> values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.doubles.Double2IntOpenHashMap.1
    ...
    public Double2IntOpenHashMap clone() {
        try {
            Double2IntOpenHashMap c = (Double2IntOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
