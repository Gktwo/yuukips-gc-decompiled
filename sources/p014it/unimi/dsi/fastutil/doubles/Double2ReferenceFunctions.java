...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceFunctions.class */
public final class Double2ReferenceFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceFunctions$EmptyFunction.class */
    public static class EmptyFunction<V> extends AbstractDouble2ReferenceFunction<V> implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDouble2ReferenceFunction, p014it.unimi.dsi.fastutil.doubles.Double2ReferenceFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction<V> implements Double2ReferenceFunction<V>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Double2ReferenceFunction<V> f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Double2ReferenceFunction<V> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2ReferenceFunction, java.util.function.DoubleFunction
        ...
        public V apply(Double key) {
            V apply;
            synchronized (this.sync) {
                apply = this.function.apply((Double2ReferenceFunction<V>) key);
            }
            return apply;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction<V> extends AbstractDouble2ReferenceFunction<V> implements Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Double2ReferenceFunction<? extends V> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2ReferenceFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2ReferenceFunctions$PrimitiveFunction.class */
