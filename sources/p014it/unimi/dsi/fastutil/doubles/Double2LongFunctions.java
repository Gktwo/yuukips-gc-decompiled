...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongFunctions.class */
public final class Double2LongFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractDouble2LongFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDouble2LongFunction, p014it.unimi.dsi.fastutil.doubles.Double2LongFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Double2LongFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Double2LongFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Double2LongFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2LongFunction, java.util.function.DoubleToLongFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractDouble2LongFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Double2LongFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Double2LongFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2LongFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2LongFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Double2LongFunction {
        ...
        public long get(double key) {
            Long v = (Long) this.function.apply(Double.valueOf(key));
        ...
        public Long get(Object key) {
            ...
            return (Long) this.function.apply((Double) key);
        }
        ...
        public Long getOrDefault(Object key, Long defaultValue) {
            Long v;
            if (!(key == null || (v = (Long) this.function.apply((Double) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
