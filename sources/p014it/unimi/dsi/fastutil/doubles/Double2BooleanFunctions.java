...
/* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanFunctions.class */
public final class Double2BooleanFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractDouble2BooleanFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDouble2BooleanFunction, p014it.unimi.dsi.fastutil.doubles.Double2BooleanFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Double2BooleanFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Double2BooleanFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Double2BooleanFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.doubles.Double2BooleanFunction, java.util.function.DoublePredicate
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractDouble2BooleanFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Double2BooleanFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Double2BooleanFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.doubles.Double2BooleanFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/doubles/Double2BooleanFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Double2BooleanFunction {
        ...
        public boolean get(double key) {
            Boolean v = (Boolean) this.function.apply(Double.valueOf(key));
        ...
        public Boolean get(Object key) {
            ...
            return (Boolean) this.function.apply((Double) key);
        }
        ...
        public Boolean getOrDefault(Object key, Boolean defaultValue) {
            Boolean v;
            if (!(key == null || (v = (Boolean) this.function.apply((Double) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
