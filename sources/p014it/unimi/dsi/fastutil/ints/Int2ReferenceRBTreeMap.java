...
public class Int2ReferenceRBTreeMap<V> extends AbstractInt2ReferenceSortedMap<V> implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractInt2ReferenceSortedMap<V> implements Serializable {
        ...
        final boolean m759in(int k) {
            return (this.bottom || Int2ReferenceRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2ReferenceRBTreeMap.this.compare(k, this.f2092to) < 0);
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ReferenceSortedMap
        public Int2ReferenceSortedMap<V> headMap(int to) {
            if (!this.top && Int2ReferenceRBTreeMap.this.compare(to, this.f2092to) >= 0) {
                return this;
            }
        ...
        public Int2ReferenceSortedMap<V> subMap(int from, int to) {
            ...
            if (!this.top) {
                to = Int2ReferenceRBTreeMap.this.compare(to, this.f2092to) < 0 ? to : this.f2092to;
            }
            if (!this.bottom) {
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.top || Int2ReferenceRBTreeMap.this.compare(e.key, this.f2092to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                ...
                e = Int2ReferenceRBTreeMap.this.locateKey(this.f2092to);
                if (Int2ReferenceRBTreeMap.this.compare(e.key, this.f2092to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends Int2ReferenceRBTreeMap<V>.TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Int2ReferenceRBTreeMap.this.compare(this.next.key, Submap.this.f2092to) >= 0) {
                    this.next = null;
                }
            }
        }
