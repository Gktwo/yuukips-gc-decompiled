...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap.class */
public class Int2ReferenceRBTreeMap<V> extends AbstractInt2ReferenceSortedMap<V> implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap.Entry<V> add(int r9) {
        /*
        // Method dump skipped, instructions count: 935
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap.add(int):it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap$Entry");
    }
    ...
    public V remove(int r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap.remove(int):java.lang.Object");
    }

    @Override // p014it.unimi.dsi.fastutil.ints.AbstractInt2ReferenceMap, java.util.Map
    public boolean containsValue(Object v) {
        Int2ReferenceRBTreeMap<V>.ValueIterator i = new ValueIterator();
        int j = this.count;
        do {
            j--;
            if (j == 0) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(int k) {
            Entry<V> locateKey = Int2ReferenceRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap$EntryIterator.class */
    public class EntryIterator extends Int2ReferenceRBTreeMap<V>.TreeIterator implements ObjectListIterator<Int2ReferenceMap.Entry<V>> {
        EntryIterator() {
            super();
        }
    ...
    public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap.1
                final Comparator<? super Int2ReferenceMap.Entry<V>> comparator;

                {
                    this.comparator = Int2ReferenceRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Integer)) {
                        return e.equals(Int2ReferenceRBTreeMap.this.findKey(((Integer) e.getKey()).intValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Integer) || (f = Int2ReferenceRBTreeMap.this.findKey(((Integer) e.getKey()).intValue())) == null || f.getValue() != e.getValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap$KeyIterator.class */
    public final class KeyIterator extends Int2ReferenceRBTreeMap<V>.TreeIterator implements IntListIterator {
        public KeyIterator() {
            super();
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap$ValueIterator.class */
    public final class ValueIterator extends Int2ReferenceRBTreeMap<V>.TreeIterator implements ObjectListIterator<V> {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap$Submap.class */
    public final class Submap extends AbstractInt2ReferenceSortedMap<V> implements Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.Function, p014it.unimi.dsi.fastutil.bytes.Byte2BooleanMap, java.util.Map
        public void clear() {
            Int2ReferenceRBTreeMap<V>.Submap.SubmapIterator i = new SubmapIterator();
            while (i.hasNext()) {
                i.nextEntry();
                i.remove();
            }
        ...
        /* renamed from: in */
        final boolean m759in(int k) {
            return (this.bottom || Int2ReferenceRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2ReferenceRBTreeMap.this.compare(k, this.f2128to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.ints.Int2ReferenceMap, p014it.unimi.dsi.fastutil.ints.Int2ReferenceSortedMap
        public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.ObjectSortedSet
                    public /* bridge */ /* synthetic */ ObjectBidirectionalIterator iterator(Object obj) {
                        return iterator((Int2ReferenceMap.Entry) ((Int2ReferenceMap.Entry) obj));
                    }
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Integer) && (f = Int2ReferenceRBTreeMap.this.findKey(((Integer) e.getKey()).intValue())) != null && Submap.this.m759in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry<V> f = Int2ReferenceRBTreeMap.this.findKey(((Integer) e.getKey()).intValue());
                        if (f != null && Submap.this.m759in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractInt2ReferenceSortedMap<V>.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ReferenceCollection<V> values() {
            if (this.values == null) {
                this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractReferenceCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ReferenceCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection
                    public ObjectIterator<V> iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.AbstractInt2ReferenceMap, p014it.unimi.dsi.fastutil.ints.Int2ReferenceFunction, p014it.unimi.dsi.fastutil.ints.Int2ReferenceMap
        public boolean containsKey(int k) {
            return m759in(k) && Int2ReferenceRBTreeMap.this.containsKey(k);
        }
        ...
        public V get(int k) {
            Entry<V> e;
            return (!m759in(k) || (e = Int2ReferenceRBTreeMap.this.findKey(k)) == null) ? (V) this.defRetValue : (V) e.value;
        }
        ...
        public V put(int k, V v) {
            ...
            if (!m759in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f2128to)) + ")");
            }
            return Int2ReferenceRBTreeMap.this.modified ? (V) this.defRetValue : (V) Int2ReferenceRBTreeMap.this.put(k, (int) v);
        }
        ...
        public V remove(int k) {
            ...
            return Int2ReferenceRBTreeMap.this.modified ? (V) Int2ReferenceRBTreeMap.this.remove(k) : (V) this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ReferenceSortedMap
        public Int2ReferenceSortedMap<V> headMap(int to) {
            if (!this.top && Int2ReferenceRBTreeMap.this.compare(to, this.f2128to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ReferenceSortedMap
        public Int2ReferenceSortedMap<V> tailMap(int from) {
            if (!this.bottom && Int2ReferenceRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f2128to, this.top);
        }
        ...
        public Int2ReferenceSortedMap<V> subMap(int from, int to) {
            ...
            if (!this.top) {
                to = Int2ReferenceRBTreeMap.this.compare(to, this.f2128to) < 0 ? to : this.f2128to;
            }
            if (!this.bottom) {
                from = Int2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f2128to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.top || Int2ReferenceRBTreeMap.this.compare(e.key, this.f2128to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                ...
                e = Int2ReferenceRBTreeMap.this.locateKey(this.f2128to);
                if (Int2ReferenceRBTreeMap.this.compare(e.key, this.f2128to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Int2ReferenceRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends Int2ReferenceRBTreeMap<V>.TreeIterator {
            SubmapIterator() {
                super();
            ...
            SubmapIterator(Submap submap, int k) {
                ...
                if (submap.bottom || Int2ReferenceRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Int2ReferenceRBTreeMap int2ReferenceRBTreeMap = Int2ReferenceRBTreeMap.this;
                        Entry<V> lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (int2ReferenceRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Int2ReferenceRBTreeMap.this.compare(this.next.key, Submap.this.f2128to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends Int2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Int2ReferenceMap.Entry<V>> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap$Submap$SubmapKeyIterator.class */
        public final class SubmapKeyIterator extends Int2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements IntListIterator {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceRBTreeMap$Submap$SubmapValueIterator.class */
        public final class SubmapValueIterator extends Int2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<V> {
    ...
    public Int2ReferenceRBTreeMap<V> clone() {
        try {
            Int2ReferenceRBTreeMap<V> c = (Int2ReferenceRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        int n = this.count;
        Int2ReferenceRBTreeMap<V>.EntryIterator i = new EntryIterator();
