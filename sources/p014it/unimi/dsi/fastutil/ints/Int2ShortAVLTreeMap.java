...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ShortAVLTreeMap.class */
public class Int2ShortAVLTreeMap extends AbstractInt2ShortSortedMap implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Int2ShortAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap.Entry add(int r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap.add(int):it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.ints.Int2ShortFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public short remove(int r5) {
        /*
        // Method dump skipped, instructions count: 1494
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap.remove(int):short");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ShortAVLTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ShortAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(int k) {
            Entry locateKey = Int2ShortAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ShortAVLTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap.1
                final Comparator<? super Int2ShortMap.Entry> comparator;

                {
                    this.comparator = Int2ShortAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Integer) && e.getValue() != null && (e.getValue() instanceof Short)) {
                        return e.equals(Int2ShortAVLTreeMap.this.findKey(((Integer) e.getKey()).intValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Integer) || !(e.getValue() instanceof Short) || (f = Int2ShortAVLTreeMap.this.findKey(((Integer) e.getKey()).intValue())) == null || f.getShortValue() != ((Short) e.getValue()).shortValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ShortAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ShortAVLTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ShortAVLTreeMap$ValueIterator.class */
    ...
    public ShortCollection values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ShortAVLTreeMap$Submap.class */
    public final class Submap extends AbstractInt2ShortSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m758in(int k) {
            return (this.bottom || Int2ShortAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2ShortAVLTreeMap.this.compare(k, this.f2129to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.ints.Int2ShortMap, p014it.unimi.dsi.fastutil.ints.Int2ShortSortedMap
        public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Integer) && e.getValue() != null && (e.getValue() instanceof Short) && (f = Int2ShortAVLTreeMap.this.findKey(((Integer) e.getKey()).intValue())) != null && Submap.this.m758in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Int2ShortAVLTreeMap.this.findKey(((Integer) e.getKey()).intValue());
                        if (f != null && Submap.this.m758in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ShortAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractInt2ShortSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ShortCollection values() {
            if (this.values == null) {
                this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShortCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.shorts.ShortCollection, p014it.unimi.dsi.fastutil.shorts.ShortIterable
                    public ShortIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.AbstractInt2ShortMap, p014it.unimi.dsi.fastutil.ints.Int2ShortFunction, p014it.unimi.dsi.fastutil.ints.Int2ShortMap
        public boolean containsKey(int k) {
            return m758in(k) && Int2ShortAVLTreeMap.this.containsKey(k);
        }
        ...
        public short get(int k) {
            Entry e;
            return (!m758in(k) || (e = Int2ShortAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public short put(int k, short v) {
            ...
            if (!m758in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f2129to)) + ")");
            }
            return Int2ShortAVLTreeMap.this.modified ? this.defRetValue : Int2ShortAVLTreeMap.this.put(k, v);
        }
        ...
        public short remove(int k) {
            ...
            return Int2ShortAVLTreeMap.this.modified ? Int2ShortAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ShortSortedMap
        public Int2ShortSortedMap headMap(int to) {
            if (!this.top && Int2ShortAVLTreeMap.this.compare(to, this.f2129to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ShortSortedMap
        public Int2ShortSortedMap tailMap(int from) {
            if (!this.bottom && Int2ShortAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f2129to, this.top);
        }
        ...
        public Int2ShortSortedMap subMap(int from, int to) {
            ...
            if (!this.top) {
                to = Int2ShortAVLTreeMap.this.compare(to, this.f2129to) < 0 ? to : this.f2129to;
            }
            if (!this.bottom) {
                from = Int2ShortAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f2129to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Int2ShortAVLTreeMap.this.compare(e.key, this.f2129to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Int2ShortAVLTreeMap.this.locateKey(this.f2129to);
                if (Int2ShortAVLTreeMap.this.compare(e.key, this.f2129to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Int2ShortAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ShortAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, int k) {
                ...
                if (submap.bottom || Int2ShortAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Int2ShortAVLTreeMap int2ShortAVLTreeMap = Int2ShortAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (int2ShortAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Int2ShortAVLTreeMap.this.compare(this.next.key, Submap.this.f2129to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ShortAVLTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ShortAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2ShortAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ShortAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Int2ShortAVLTreeMap clone() {
        try {
            Int2ShortAVLTreeMap c = (Int2ShortAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
