...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenHashMap.class */
public class Int2ObjectOpenHashMap<V> extends AbstractInt2ObjectMap<V> implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f2076n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f2077f;
    ...
    public Int2ObjectOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f2076n = arraySize;
            this.minN = arraySize;
            this.mask = this.f2076n - 1;
            this.maxFill = HashCommon.maxFill(this.f2076n, f);
            this.key = new int[this.f2076n + 1];
            this.value = (V[]) new Object[this.f2076n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f2077f);
        if (needed > this.f2076n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f2077f)))));
        if (needed > this.f2076n) {
            rehash(needed);
        }
    }
    ...
    public V removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f2076n > this.minN && this.size < this.maxFill / 4 && this.f2076n > 16) {
            rehash(this.f2076n / 2);
        }
        return oldValue;
    }
    ...
    public V removeNullEntry() {
        ...
        V oldValue = this.value[this.f2076n];
        this.value[this.f2076n] = null;
        this.size--;
        if (this.f2076n > this.minN && this.size < this.maxFill / 4 && this.f2076n > 16) {
            rehash(this.f2076n / 2);
        }
    ...
    private int find(int k) {
        int curr;
        if (k == 0) {
            return this.containsNullKey ? this.f2076n : -(this.f2076n + 1);
        }
        int[] key = this.key;
    ...
    private void insert(int pos, int k, V v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f2077f));
        }
    }
    ...
    public V get(int k) {
        int curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f2076n] : (V) this.defRetValue;
        }
        int[] key = this.key;
        int mix = HashCommon.mix(k) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(Object v) {
        V[] value = this.value;
        int[] key = this.key;
        if (this.containsNullKey && Objects.equals(value[this.f2076n], v)) {
            return true;
        }
        int i = this.f2076n;
        while (true) {
    ...
    public V getOrDefault(int k, V defaultValue) {
        int curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f2076n] : defaultValue;
        }
        int[] key = this.key;
        int mix = HashCommon.mix(k) & this.mask;
        int pos = mix;
    ...
    public boolean remove(int k, Object v) {
        ...
        } else if (!this.containsNullKey || !Objects.equals(v, this.value[this.f2076n])) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenHashMap$MapEntry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Int2ObjectOpenHashMap.this.f2076n;
            this.last = -1;
            this.f2078c = Int2ObjectOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Int2ObjectOpenHashMap.this.f2076n;
                this.last = i;
                return i;
            }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (curr == 0) {
                        key[pos] = 0;
                        Int2ObjectOpenHashMap.this.value[pos] = null;
                        return;
                    }
                ...
                key[pos] = curr;
                Int2ObjectOpenHashMap.this.value[pos] = Int2ObjectOpenHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Int2ObjectOpenHashMap.this.f2076n) {
                Int2ObjectOpenHashMap.this.containsNullKey = false;
                Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.f2076n] = null;
            } else if (this.pos >= 0) {
                shiftKeys(this.last);
            } else {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends Int2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<Int2ObjectMap.Entry<V>> {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap.MapIterator
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenHashMap$FastEntryIterator.class */
    private final class FastEntryIterator extends Int2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<Int2ObjectMap.Entry<V>> {
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends Int2ObjectOpenHashMap<V>.MapSpliterator> {
        int pos;
        int max;
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Int2ObjectOpenHashMap.this.f2076n;
            this.f2079c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2079c++;
                acceptOnIndex(action, Int2ObjectOpenHashMap.this.f2076n);
                return true;
            }
            int[] key = Int2ObjectOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Int2ObjectOpenHashMap.this.size - this.f2079c);
            }
            return Math.min((long) (Int2ObjectOpenHashMap.this.size - this.f2079c), ((long) ((((double) Int2ObjectOpenHashMap.this.realSize()) / ((double) Int2ObjectOpenHashMap.this.f2076n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap r0 = p014it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap.this
                int[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends Int2ObjectOpenHashMap<V>.MapSpliterator implements ObjectSpliterator<Int2ObjectMap.Entry<V>> {
        private static final int POST_SPLIT_CHARACTERISTICS = 1;

        @Override // p014it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap.MapSpliterator
        /* bridge */ /* synthetic */ void acceptOnIndex(Object obj, int i) {
            acceptOnIndex((Consumer) ((Consumer) obj), i);
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Int2ObjectMap.Entry<V>> implements Int2ObjectMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Int2ObjectOpenHashMap.this.containsNullKey && Objects.equals(Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.f2076n], value);
            }
            int[] key = Int2ObjectOpenHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            if (k != 0) {
                ...
                } else if (!Objects.equals(Int2ObjectOpenHashMap.this.value[pos], value)) {
                    return false;
                } else {
                    Int2ObjectOpenHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Int2ObjectOpenHashMap.this.containsNullKey || !Objects.equals(Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.f2076n], value)) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Int2ObjectMap.Entry<V>> consumer) {
            if (Int2ObjectOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2ObjectMap.BasicEntry(Int2ObjectOpenHashMap.this.key[Int2ObjectOpenHashMap.this.f2076n], Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.f2076n]));
            }
            int pos = Int2ObjectOpenHashMap.this.f2076n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Int2ObjectMap.Entry<V>> consumer) {
            ...
            if (Int2ObjectOpenHashMap.this.containsNullKey) {
                entry.key = Int2ObjectOpenHashMap.this.key[Int2ObjectOpenHashMap.this.f2076n];
                entry.value = Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.f2076n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenHashMap$KeySpliterator.class */
    public final class KeySpliterator extends Int2ObjectOpenHashMap<V>.MapSpliterator implements IntSpliterator {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenHashMap$KeySet.class */
    public final class KeySet extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Int2ObjectOpenHashMap.this.containsNullKey) {
                consumer.accept(Int2ObjectOpenHashMap.this.key[Int2ObjectOpenHashMap.this.f2076n]);
            }
            int pos = Int2ObjectOpenHashMap.this.f2076n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenHashMap$ValueSpliterator.class */
    public final class ValueSpliterator extends Int2ObjectOpenHashMap<V>.MapSpliterator implements ObjectSpliterator<V> {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>() { // from class: it.unimi.dsi.fastutil.ints.Int2ObjectOpenHashMap.1
                ...
                public void forEach(Consumer<? super V> consumer) {
                    if (Int2ObjectOpenHashMap.this.containsNullKey) {
                        consumer.accept((Object) Int2ObjectOpenHashMap.this.value[Int2ObjectOpenHashMap.this.f2076n]);
                    }
                    int pos = Int2ObjectOpenHashMap.this.f2076n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f2077f)));
        if (l >= this.f2076n || this.size > HashCommon.maxFill(l, this.f2077f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2076n];
                this.f2076n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f2076n, this.f2077f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Int2ObjectOpenHashMap<V> clone() {
        try {
            Int2ObjectOpenHashMap<V> c = (Int2ObjectOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += this.value[this.f2076n] == null ? 0 : this.value[this.f2076n].hashCode();
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f2076n = HashCommon.arraySize(this.size, this.f2077f);
        this.maxFill = HashCommon.maxFill(this.f2076n, this.f2077f);
        this.mask = this.f2076n - 1;
        int[] key = new int[this.f2076n + 1];
        this.key = key;
        V[] value = (V[]) new Object[this.f2076n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
