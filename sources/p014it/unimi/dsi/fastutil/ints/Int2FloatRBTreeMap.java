...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatRBTreeMap.class */
public class Int2FloatRBTreeMap extends AbstractInt2FloatSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap.Entry add(int r9) {
        /*
        // Method dump skipped, instructions count: 935
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap.add(int):it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.ints.Int2FloatFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public float remove(int r7) {
        /*
        // Method dump skipped, instructions count: 1895
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap.remove(int):float");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(int k) {
            Entry locateKey = Int2FloatRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2FloatMap.Entry>() { // from class: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap.1
                final Comparator<? super Int2FloatMap.Entry> comparator;

                {
                    this.comparator = Int2FloatRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Integer) && e.getValue() != null && (e.getValue() instanceof Float)) {
                        return e.equals(Int2FloatRBTreeMap.this.findKey(((Integer) e.getKey()).intValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Integer) || e.getValue() == null || !(e.getValue() instanceof Float) || (f = Int2FloatRBTreeMap.this.findKey(((Integer) e.getKey()).intValue())) == null || Float.floatToIntBits(f.getFloatValue()) != Float.floatToIntBits(((Float) e.getValue()).floatValue())) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatRBTreeMap$ValueIterator.class */
    ...
    public FloatCollection values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection() { // from class: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatRBTreeMap$Submap.class */
    public final class Submap extends AbstractInt2FloatSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m767in(int k) {
            return (this.bottom || Int2FloatRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2FloatRBTreeMap.this.compare(k, this.f2044to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.ints.Int2FloatMap, p014it.unimi.dsi.fastutil.ints.Int2FloatSortedMap
        public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2FloatMap.Entry>() { // from class: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Integer) && e.getValue() != null && (e.getValue() instanceof Float) && (f = Int2FloatRBTreeMap.this.findKey(((Integer) e.getKey()).intValue())) != null && Submap.this.m767in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Int2FloatRBTreeMap.this.findKey(((Integer) e.getKey()).intValue());
                        if (f != null && Submap.this.m767in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractInt2FloatSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public FloatCollection values() {
            if (this.values == null) {
                this.values = new AbstractFloatCollection() { // from class: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloatCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.floats.FloatCollection, p014it.unimi.dsi.fastutil.floats.FloatIterable
                    public FloatIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.AbstractInt2FloatMap, p014it.unimi.dsi.fastutil.ints.Int2FloatFunction, p014it.unimi.dsi.fastutil.ints.Int2FloatMap
        public boolean containsKey(int k) {
            return m767in(k) && Int2FloatRBTreeMap.this.containsKey(k);
        }
        ...
        public float get(int k) {
            Entry e;
            return (!m767in(k) || (e = Int2FloatRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public float put(int k, float v) {
            ...
            return Int2FloatRBTreeMap.this.modified ? this.defRetValue : Int2FloatRBTreeMap.this.put(k, v);
        }
        ...
        public float remove(int k) {
            ...
            return Int2FloatRBTreeMap.this.modified ? Int2FloatRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2FloatSortedMap
        public Int2FloatSortedMap headMap(int to) {
            if (!this.top && Int2FloatRBTreeMap.this.compare(to, this.f2044to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2FloatSortedMap
        public Int2FloatSortedMap tailMap(int from) {
            if (!this.bottom && Int2FloatRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
        ...
        public Int2FloatSortedMap subMap(int from, int to) {
            ...
            if (!this.top) {
                to = Int2FloatRBTreeMap.this.compare(to, this.f2044to) < 0 ? to : this.f2044to;
            }
            if (!this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Int2FloatRBTreeMap.this.compare(e.key, this.f2044to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Int2FloatRBTreeMap.this.locateKey(this.f2044to);
                if (Int2FloatRBTreeMap.this.compare(e.key, this.f2044to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Int2FloatRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, int k) {
                ...
                if (submap.bottom || Int2FloatRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Int2FloatRBTreeMap int2FloatRBTreeMap = Int2FloatRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (int2FloatRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Int2FloatRBTreeMap.this.compare(this.next.key, Submap.this.f2044to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Int2FloatRBTreeMap clone() {
        try {
            Int2FloatRBTreeMap c = (Int2FloatRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
