...
public class Int2ShortRBTreeMap extends AbstractInt2ShortSortedMap implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractInt2ShortSortedMap implements Serializable {
        ...
        final boolean m757in(int k) {
            return (this.bottom || Int2ShortRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2ShortRBTreeMap.this.compare(k, this.f2104to) < 0);
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ShortSortedMap
        public Int2ShortSortedMap headMap(int to) {
            if (!this.top && Int2ShortRBTreeMap.this.compare(to, this.f2104to) >= 0) {
                return this;
            }
        ...
        public Int2ShortSortedMap subMap(int from, int to) {
            ...
            if (!this.top) {
                to = Int2ShortRBTreeMap.this.compare(to, this.f2104to) < 0 ? to : this.f2104to;
            }
            if (!this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Int2ShortRBTreeMap.this.compare(e.key, this.f2104to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Int2ShortRBTreeMap.this.locateKey(this.f2104to);
                if (Int2ShortRBTreeMap.this.compare(e.key, this.f2104to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Int2ShortRBTreeMap.this.compare(this.next.key, Submap.this.f2104to) >= 0) {
                    this.next = null;
                }
            }
        }
