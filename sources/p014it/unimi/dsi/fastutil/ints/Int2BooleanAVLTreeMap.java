...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanAVLTreeMap.class */
public class Int2BooleanAVLTreeMap extends AbstractInt2BooleanSortedMap implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Int2BooleanAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap.Entry add(int r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap.add(int):it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap$Entry");
    }
    ...
    public boolean remove(int r5) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap.remove(int):boolean");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanAVLTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(int k) {
            Entry locateKey = Int2BooleanAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanAVLTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>() { // from class: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap.1
                final Comparator<? super Int2BooleanMap.Entry> comparator;

                {
                    this.comparator = Int2BooleanAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Integer) && e.getValue() != null && (e.getValue() instanceof Boolean)) {
                        return e.equals(Int2BooleanAVLTreeMap.this.findKey(((Integer) e.getKey()).intValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Integer) || !(e.getValue() instanceof Boolean) || (f = Int2BooleanAVLTreeMap.this.findKey(((Integer) e.getKey()).intValue())) == null || f.getBooleanValue() != ((Boolean) e.getValue()).booleanValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanAVLTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanAVLTreeMap$ValueIterator.class */
    ...
    public BooleanCollection values() {
        if (this.values == null) {
            this.values = new AbstractBooleanCollection() { // from class: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanAVLTreeMap$Submap.class */
    public final class Submap extends AbstractInt2BooleanSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m776in(int k) {
            return (this.bottom || Int2BooleanAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2BooleanAVLTreeMap.this.compare(k, this.f1985to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.ints.Int2BooleanMap, p014it.unimi.dsi.fastutil.ints.Int2BooleanSortedMap
        public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2BooleanMap.Entry>() { // from class: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Integer) && e.getValue() != null && (e.getValue() instanceof Boolean) && (f = Int2BooleanAVLTreeMap.this.findKey(((Integer) e.getKey()).intValue())) != null && Submap.this.m776in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Int2BooleanAVLTreeMap.this.findKey(((Integer) e.getKey()).intValue());
                        if (f != null && Submap.this.m776in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractInt2BooleanSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public BooleanCollection values() {
            if (this.values == null) {
                this.values = new AbstractBooleanCollection() { // from class: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.booleans.AbstractBooleanCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.booleans.BooleanCollection, p014it.unimi.dsi.fastutil.booleans.BooleanIterable, p014it.unimi.dsi.fastutil.booleans.BooleanBigList
                    public BooleanIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.AbstractInt2BooleanMap, p014it.unimi.dsi.fastutil.ints.Int2BooleanFunction, p014it.unimi.dsi.fastutil.ints.Int2BooleanMap
        public boolean containsKey(int k) {
            return m776in(k) && Int2BooleanAVLTreeMap.this.containsKey(k);
        }
        ...
        public boolean get(int k) {
            Entry e;
            return (!m776in(k) || (e = Int2BooleanAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public boolean put(int k, boolean v) {
            ...
            if (!m776in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1985to)) + ")");
            }
            return Int2BooleanAVLTreeMap.this.modified ? this.defRetValue : Int2BooleanAVLTreeMap.this.put(k, v);
        }
        ...
        public boolean remove(int k) {
            ...
            return Int2BooleanAVLTreeMap.this.modified ? Int2BooleanAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2BooleanSortedMap
        public Int2BooleanSortedMap headMap(int to) {
            if (!this.top && Int2BooleanAVLTreeMap.this.compare(to, this.f1985to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2BooleanSortedMap
        public Int2BooleanSortedMap tailMap(int from) {
            if (!this.bottom && Int2BooleanAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1985to, this.top);
        }
        ...
        public Int2BooleanSortedMap subMap(int from, int to) {
            ...
            if (!this.top) {
                to = Int2BooleanAVLTreeMap.this.compare(to, this.f1985to) < 0 ? to : this.f1985to;
            }
            if (!this.bottom) {
                from = Int2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1985to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Int2BooleanAVLTreeMap.this.compare(e.key, this.f1985to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Int2BooleanAVLTreeMap.this.locateKey(this.f1985to);
                if (Int2BooleanAVLTreeMap.this.compare(e.key, this.f1985to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Int2BooleanAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, int k) {
                ...
                if (submap.bottom || Int2BooleanAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Int2BooleanAVLTreeMap int2BooleanAVLTreeMap = Int2BooleanAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (int2BooleanAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Int2BooleanAVLTreeMap.this.compare(this.next.key, Submap.this.f1985to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanAVLTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Int2BooleanAVLTreeMap clone() {
        try {
            Int2BooleanAVLTreeMap c = (Int2BooleanAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
