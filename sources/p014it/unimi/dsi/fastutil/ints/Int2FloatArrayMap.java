...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatArrayMap.class */
public class Int2FloatArrayMap extends AbstractInt2FloatMap implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Int2FloatArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Int2FloatArrayMap(Int2FloatMap m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Int2FloatMap.Entry> it = m.int2FloatEntrySet().iterator();
        while (it.hasNext()) {
            Int2FloatMap.Entry e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Int2FloatMap.Entry> implements Int2FloatMap.FastEntrySet {
        private EntrySet() {
        }

        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
        public ObjectIterator<Int2FloatMap.Entry> iterator() {
            return new ObjectIterator<Int2FloatMap.Entry>() { // from class: it.unimi.dsi.fastutil.ints.Int2FloatArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Int2FloatMap.Entry next() {
                    ...
                    int[] iArr = Int2FloatArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    int i2 = iArr[i];
                    float[] fArr = Int2FloatArrayMap.this.value;
                    int i3 = this.next;
                    this.next = i3 + 1;
                    return new AbstractInt2FloatMap.BasicEntry(i2, fArr[i3]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Int2FloatArrayMap.access$010(Int2FloatArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Int2FloatMap.Entry> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i3 = this.next;
                        this.next = i3 + 1;
                        action.accept(new AbstractInt2FloatMap.BasicEntry(i2, fArr[i3]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Int2FloatMap.Entry> fastIterator() {
            return new ObjectIterator<Int2FloatMap.Entry>() { // from class: it.unimi.dsi.fastutil.ints.Int2FloatArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Int2FloatMap.Entry next() {
                    ...
                    AbstractInt2FloatMap.BasicEntry basicEntry = this.entry;
                    int[] iArr = Int2FloatArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = iArr[i];
                    AbstractInt2FloatMap.BasicEntry basicEntry2 = this.entry;
                    float[] fArr = Int2FloatArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Int2FloatMap.Entry> implements ObjectSpliterator<Int2FloatMap.Entry> {
            ...
            public final Int2FloatMap.Entry get(int location) {
        ...
        public boolean remove(Object o) {
            ...
            Int2FloatArrayMap.access$010(Int2FloatArrayMap.this);
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatArrayMap$KeySet.class */
    public final class KeySet extends AbstractIntSet {
        ...
        public IntIterator iterator() {
            return new IntIterator() { // from class: it.unimi.dsi.fastutil.ints.Int2FloatArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatArrayMap$KeySet$KeySetSpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractFloatCollection {
        ...
        public FloatIterator iterator() {
            return new FloatIterator() { // from class: it.unimi.dsi.fastutil.ints.Int2FloatArrayMap.ValuesCollection.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatArrayMap$ValuesCollection$ValuesSpliterator.class */
    ...
    public Int2FloatArrayMap clone() {
        try {
            Int2FloatArrayMap c = (Int2FloatArrayMap) clone();
