...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatOpenCustomHashMap.class */
public class Int2FloatOpenCustomHashMap extends AbstractInt2FloatMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f2036n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f2037f;
    ...
    public Int2FloatOpenCustomHashMap(int expected, float f, IntHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f2036n = arraySize;
            this.minN = arraySize;
            this.mask = this.f2036n - 1;
            this.maxFill = HashCommon.maxFill(this.f2036n, f);
            this.key = new int[this.f2036n + 1];
            this.value = new float[this.f2036n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f2037f);
        if (needed > this.f2036n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f2037f)))));
        if (needed > this.f2036n) {
            rehash(needed);
        }
    }
    ...
    public float removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f2036n > this.minN && this.size < this.maxFill / 4 && this.f2036n > 16) {
            rehash(this.f2036n / 2);
        }
        return oldValue;
    }
    ...
    public float removeNullEntry() {
        ...
        float oldValue = this.value[this.f2036n];
        this.size--;
        if (this.f2036n > this.minN && this.size < this.maxFill / 4 && this.f2036n > 16) {
            rehash(this.f2036n / 2);
        }
    ...
    private int find(int k) {
        ...
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.f2036n : -(this.f2036n + 1);
        }
        int[] key = this.key;
    ...
    private void insert(int pos, int k, float v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f2037f));
        }
    }
    ...
    public float addTo(int k, float incr) {
        ...
        if (!this.strategy.equals(k, 0)) {
            ...
            return addToValue(this.f2036n, incr);
        } else {
            pos = this.f2036n;
            this.containsNullKey = true;
        }
    ...
    public float get(int k) {
        int curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2036n] : this.defRetValue;
        }
        int[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(float v) {
        ...
        int[] key = this.key;
        if (this.containsNullKey && Float.floatToIntBits(value[this.f2036n]) == Float.floatToIntBits(v)) {
            return true;
        }
        int i = this.f2036n;
        while (true) {
    ...
    public float getOrDefault(int k, float defaultValue) {
        int curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2036n] : defaultValue;
        }
        int[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(int k, float v) {
        ...
        } else if (!this.containsNullKey || Float.floatToIntBits(v) != Float.floatToIntBits(this.value[this.f2036n])) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Int2FloatMap.Entry, Map.Entry<Integer, Float>, IntFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            return Int2FloatOpenCustomHashMap.this.strategy.equals(Int2FloatOpenCustomHashMap.this.key[this.index], e.getKey().intValue()) && Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue().floatValue());
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Int2FloatOpenCustomHashMap.this.f2036n;
            this.last = -1;
            this.f2038c = Int2FloatOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Int2FloatOpenCustomHashMap.this.f2036n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Int2FloatOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Int2FloatOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Int2FloatOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Int2FloatOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Int2FloatOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Int2FloatOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Int2FloatOpenCustomHashMap.this.value[pos] = Int2FloatOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Int2FloatOpenCustomHashMap.this.f2036n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Int2FloatMap.Entry>> implements ObjectIterator<Int2FloatMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Int2FloatOpenCustomHashMap.this.f2036n;
            this.f2039c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2039c++;
                acceptOnIndex(action, Int2FloatOpenCustomHashMap.this.f2036n);
                return true;
            }
            int[] key = Int2FloatOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Int2FloatOpenCustomHashMap.this.size - this.f2039c);
            }
            return Math.min((long) (Int2FloatOpenCustomHashMap.this.size - this.f2039c), ((long) ((((double) Int2FloatOpenCustomHashMap.this.realSize()) / ((double) Int2FloatOpenCustomHashMap.this.f2036n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap.this
                int[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Int2FloatMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Int2FloatMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Int2FloatMap.Entry> implements Int2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Int2FloatOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Int2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.f2036n]) == Float.floatToIntBits(v);
            }
            int[] key = Int2FloatOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Int2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Int2FloatOpenCustomHashMap.this.mask;
            int pos = mix;
            int curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            }
            if (Int2FloatOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v);
            }
            do {
                int i = (pos + 1) & Int2FloatOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (!Int2FloatOpenCustomHashMap.this.strategy.equals(k, 0)) {
                ...
                if (!Int2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Int2FloatOpenCustomHashMap.this.strategy.equals(curr2, k) && Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
                            Int2FloatOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[pos]) != Float.floatToIntBits(v)) {
                    return false;
                } else {
                    Int2FloatOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Int2FloatOpenCustomHashMap.this.containsNullKey || Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.f2036n]) != Float.floatToIntBits(v)) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Int2FloatMap.Entry> consumer) {
            if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2FloatMap.BasicEntry(Int2FloatOpenCustomHashMap.this.key[Int2FloatOpenCustomHashMap.this.f2036n], Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.f2036n]));
            }
            int pos = Int2FloatOpenCustomHashMap.this.f2036n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Int2FloatMap.Entry> consumer) {
            ...
            if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
                entry.key = Int2FloatOpenCustomHashMap.this.key[Int2FloatOpenCustomHashMap.this.f2036n];
                entry.value = Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.f2036n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Int2FloatOpenCustomHashMap.this.key[Int2FloatOpenCustomHashMap.this.f2036n]);
            }
            int pos = Int2FloatOpenCustomHashMap.this.f2036n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2FloatOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Float> values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection() { // from class: it.unimi.dsi.fastutil.ints.Int2FloatOpenCustomHashMap.1
                ...
                public void forEach(FloatConsumer consumer) {
                    if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.f2036n]);
                    }
                    int pos = Int2FloatOpenCustomHashMap.this.f2036n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f2037f)));
        if (l >= this.f2036n || this.size > HashCommon.maxFill(l, this.f2037f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2036n];
                this.f2036n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f2036n, this.f2037f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Int2FloatOpenCustomHashMap clone() {
        try {
            Int2FloatOpenCustomHashMap c = (Int2FloatOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.float2int(this.value[this.f2036n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f2036n = HashCommon.arraySize(this.size, this.f2037f);
        this.maxFill = HashCommon.maxFill(this.f2036n, this.f2037f);
        this.mask = this.f2036n - 1;
        int[] key = new int[this.f2036n + 1];
        this.key = key;
        float[] value = new float[this.f2036n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
