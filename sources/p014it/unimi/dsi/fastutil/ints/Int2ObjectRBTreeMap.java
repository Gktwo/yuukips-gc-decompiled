...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectRBTreeMap.class */
public class Int2ObjectRBTreeMap<V> extends AbstractInt2ObjectSortedMap<V> implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap.Entry<V> add(int r9) {
        /*
        // Method dump skipped, instructions count: 935
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap.add(int):it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap$Entry");
    }
    ...
    public V remove(int r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap.remove(int):java.lang.Object");
    }

    @Override // p014it.unimi.dsi.fastutil.ints.AbstractInt2ObjectMap, java.util.Map
    public boolean containsValue(Object v) {
        Int2ObjectRBTreeMap<V>.ValueIterator i = new ValueIterator();
        int j = this.count;
        do {
            j--;
            if (j == 0) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectRBTreeMap$TreeIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2ObjectMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap.1
                final Comparator<? super Int2ObjectMap.Entry<V>> comparator;

                {
                    this.comparator = Int2ObjectRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Integer)) {
                        return e.equals(Int2ObjectRBTreeMap.this.findKey(((Integer) e.getKey()).intValue()));
                    }
                    return false;
                }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectRBTreeMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectRBTreeMap$Submap.class */
    public final class Submap extends AbstractInt2ObjectSortedMap<V> implements Serializable {
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2ObjectMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap.Submap.1
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Integer) && (f = Int2ObjectRBTreeMap.this.findKey(((Integer) e.getKey()).intValue())) != null && Submap.this.m761in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        if (f != null && Submap.this.m761in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractInt2ObjectSortedMap<V>.KeySet {
            private KeySet() {
                super();
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.AbstractInt2ObjectMap, p014it.unimi.dsi.fastutil.ints.Int2ObjectFunction, p014it.unimi.dsi.fastutil.ints.Int2ObjectMap
        public boolean containsKey(int k) {
            return m761in(k) && Int2ObjectRBTreeMap.this.containsKey(k);
        }
        ...
        public V get(int k) {
            Entry<V> e;
            return (!m761in(k) || (e = Int2ObjectRBTreeMap.this.findKey(k)) == null) ? (V) this.defRetValue : (V) e.value;
        }
        ...
        public V remove(int k) {
            ...
            return Int2ObjectRBTreeMap.this.modified ? (V) Int2ObjectRBTreeMap.this.remove(k) : (V) this.defRetValue;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.bottom || Int2ObjectRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectRBTreeMap$Submap$SubmapIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Int2ObjectRBTreeMap<V> clone() {
        try {
            Int2ObjectRBTreeMap<V> c = (Int2ObjectRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
