...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanArrayMap.class */
public class Int2BooleanArrayMap extends AbstractInt2BooleanMap implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Int2BooleanArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Int2BooleanArrayMap(Int2BooleanMap m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Int2BooleanMap.Entry> it = m.int2BooleanEntrySet().iterator();
        while (it.hasNext()) {
            Int2BooleanMap.Entry e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Int2BooleanMap.Entry> implements Int2BooleanMap.FastEntrySet {
        ...
        public ObjectIterator<Int2BooleanMap.Entry> iterator() {
            return new ObjectIterator<Int2BooleanMap.Entry>() { // from class: it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Int2BooleanMap.Entry next() {
                    ...
                    int i3 = this.next;
                    this.next = i3 + 1;
                    return new AbstractInt2BooleanMap.BasicEntry(i2, zArr[i3]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Int2BooleanArrayMap.access$010(Int2BooleanArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Int2BooleanMap.Entry> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i3 = this.next;
                        this.next = i3 + 1;
                        action.accept(new AbstractInt2BooleanMap.BasicEntry(i2, zArr[i3]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Int2BooleanMap.Entry> fastIterator() {
            return new ObjectIterator<Int2BooleanMap.Entry>() { // from class: it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Int2BooleanMap.Entry next() {
                    ...
                    AbstractInt2BooleanMap.BasicEntry basicEntry = this.entry;
                    int[] iArr = Int2BooleanArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = iArr[i];
                    AbstractInt2BooleanMap.BasicEntry basicEntry2 = this.entry;
                    boolean[] zArr = Int2BooleanArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Int2BooleanMap.Entry> implements ObjectSpliterator<Int2BooleanMap.Entry> {
            ...
            public final Int2BooleanMap.Entry get(int location) {
        ...
        public boolean remove(Object o) {
            ...
            Int2BooleanArrayMap.access$010(Int2BooleanArrayMap.this);
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanArrayMap$KeySet.class */
    public final class KeySet extends AbstractIntSet {
        ...
        public IntIterator iterator() {
            return new IntIterator() { // from class: it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanArrayMap$KeySet$KeySetSpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractBooleanCollection {
        ...
        public BooleanIterator iterator() {
            return new BooleanIterator() { // from class: it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap.ValuesCollection.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanArrayMap$ValuesCollection$ValuesSpliterator.class */
    ...
    public Int2BooleanArrayMap clone() {
        try {
            Int2BooleanArrayMap c = (Int2BooleanArrayMap) clone();
