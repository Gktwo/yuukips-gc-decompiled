...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntOpenHashMap.class */
public class Int2IntOpenHashMap extends AbstractInt2IntMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f2052n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f2053f;
    ...
    public Int2IntOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f2052n = arraySize;
            this.minN = arraySize;
            this.mask = this.f2052n - 1;
            this.maxFill = HashCommon.maxFill(this.f2052n, f);
            this.key = new int[this.f2052n + 1];
            this.value = new int[this.f2052n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f2053f);
        if (needed > this.f2052n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f2053f)))));
        if (needed > this.f2052n) {
            rehash(needed);
        }
    }
    ...
    public int removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f2052n > this.minN && this.size < this.maxFill / 4 && this.f2052n > 16) {
            rehash(this.f2052n / 2);
        }
        return oldValue;
    }
    ...
    public int removeNullEntry() {
        ...
        int oldValue = this.value[this.f2052n];
        this.size--;
        if (this.f2052n > this.minN && this.size < this.maxFill / 4 && this.f2052n > 16) {
            rehash(this.f2052n / 2);
        }
    ...
    private int find(int k) {
        int curr;
        if (k == 0) {
            return this.containsNullKey ? this.f2052n : -(this.f2052n + 1);
        }
        int[] key = this.key;
    ...
    private void insert(int pos, int k, int v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f2053f));
        }
    }
    ...
    public int addTo(int k, int incr) {
        ...
        if (k != 0) {
            ...
            return addToValue(this.f2052n, incr);
        } else {
            pos = this.f2052n;
            this.containsNullKey = true;
        }
    ...
    public int get(int k) {
        int curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f2052n] : this.defRetValue;
        }
        int[] key = this.key;
        int mix = HashCommon.mix(k) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(int v) {
        ...
        int[] key = this.key;
        if (this.containsNullKey && value[this.f2052n] == v) {
            return true;
        }
        int i = this.f2052n;
        while (true) {
    ...
    public int getOrDefault(int k, int defaultValue) {
        int curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f2052n] : defaultValue;
        }
        int[] key = this.key;
        int mix = HashCommon.mix(k) & this.mask;
        int pos = mix;
    ...
    public boolean remove(int k, int v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f2052n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntOpenHashMap$MapEntry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Int2IntOpenHashMap.this.f2052n;
            this.last = -1;
            this.f2054c = Int2IntOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Int2IntOpenHashMap.this.f2052n;
                this.last = i;
                return i;
            }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                ...
                key[pos] = curr;
                Int2IntOpenHashMap.this.value[pos] = Int2IntOpenHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Int2IntOpenHashMap.this.f2052n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Int2IntMap.Entry>> implements ObjectIterator<Int2IntMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntOpenHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Int2IntOpenHashMap.this.f2052n;
            this.f2055c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2055c++;
                acceptOnIndex(action, Int2IntOpenHashMap.this.f2052n);
                return true;
            }
            int[] key = Int2IntOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Int2IntOpenHashMap.this.size - this.f2055c);
            }
            return Math.min((long) (Int2IntOpenHashMap.this.size - this.f2055c), ((long) ((((double) Int2IntOpenHashMap.this.realSize()) / ((double) Int2IntOpenHashMap.this.f2052n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap r0 = p014it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap.this
                int[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Int2IntMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Int2IntMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Int2IntMap.Entry> implements Int2IntMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Int2IntOpenHashMap.this.containsNullKey && Int2IntOpenHashMap.this.value[Int2IntOpenHashMap.this.f2052n] == v;
            }
            int[] key = Int2IntOpenHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            if (k != 0) {
                ...
                } else if (Int2IntOpenHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Int2IntOpenHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Int2IntOpenHashMap.this.containsNullKey || Int2IntOpenHashMap.this.value[Int2IntOpenHashMap.this.f2052n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Int2IntMap.Entry> consumer) {
            if (Int2IntOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2IntMap.BasicEntry(Int2IntOpenHashMap.this.key[Int2IntOpenHashMap.this.f2052n], Int2IntOpenHashMap.this.value[Int2IntOpenHashMap.this.f2052n]));
            }
            int pos = Int2IntOpenHashMap.this.f2052n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Int2IntMap.Entry> consumer) {
            ...
            if (Int2IntOpenHashMap.this.containsNullKey) {
                entry.key = Int2IntOpenHashMap.this.key[Int2IntOpenHashMap.this.f2052n];
                entry.value = Int2IntOpenHashMap.this.value[Int2IntOpenHashMap.this.f2052n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntOpenHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntOpenHashMap$KeySet.class */
    public final class KeySet extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Int2IntOpenHashMap.this.containsNullKey) {
                consumer.accept(Int2IntOpenHashMap.this.key[Int2IntOpenHashMap.this.f2052n]);
            }
            int pos = Int2IntOpenHashMap.this.f2052n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntOpenHashMap$ValueSpliterator.class */
    ...
    public Collection<Integer> values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.ints.Int2IntOpenHashMap.1
                ...
                public void forEach(IntConsumer consumer) {
                    if (Int2IntOpenHashMap.this.containsNullKey) {
                        consumer.accept(Int2IntOpenHashMap.this.value[Int2IntOpenHashMap.this.f2052n]);
                    }
                    int pos = Int2IntOpenHashMap.this.f2052n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f2053f)));
        if (l >= this.f2052n || this.size > HashCommon.maxFill(l, this.f2053f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2052n];
                this.f2052n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f2052n, this.f2053f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Int2IntOpenHashMap clone() {
        try {
            Int2IntOpenHashMap c = (Int2IntOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f2052n = HashCommon.arraySize(this.size, this.f2053f);
        this.maxFill = HashCommon.maxFill(this.f2052n, this.f2053f);
        this.mask = this.f2052n - 1;
        int[] key = new int[this.f2052n + 1];
        this.key = key;
        int[] value = new int[this.f2052n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
