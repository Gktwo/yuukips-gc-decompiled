...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanOpenHashMap.class */
public class Int2BooleanOpenHashMap extends AbstractInt2BooleanMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f2028n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f2029f;
    ...
    public Int2BooleanOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f2028n = arraySize;
            this.minN = arraySize;
            this.mask = this.f2028n - 1;
            this.maxFill = HashCommon.maxFill(this.f2028n, f);
            this.key = new int[this.f2028n + 1];
            this.value = new boolean[this.f2028n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f2029f);
        if (needed > this.f2028n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f2029f)))));
        if (needed > this.f2028n) {
            rehash(needed);
        }
    }
    ...
    public boolean removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f2028n > this.minN && this.size < this.maxFill / 4 && this.f2028n > 16) {
            rehash(this.f2028n / 2);
        }
        return oldValue;
    }
    ...
    public boolean removeNullEntry() {
        ...
        boolean oldValue = this.value[this.f2028n];
        this.size--;
        if (this.f2028n > this.minN && this.size < this.maxFill / 4 && this.f2028n > 16) {
            rehash(this.f2028n / 2);
        }
    ...
    private int find(int k) {
        int curr;
        if (k == 0) {
            return this.containsNullKey ? this.f2028n : -(this.f2028n + 1);
        }
        int[] key = this.key;
    ...
    private void insert(int pos, int k, boolean v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f2029f));
        }
    }
    ...
    public boolean get(int k) {
        int curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f2028n] : this.defRetValue;
        }
        int[] key = this.key;
        int mix = HashCommon.mix(k) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(boolean v) {
        ...
        int[] key = this.key;
        if (this.containsNullKey && value[this.f2028n] == v) {
            return true;
        }
        int i = this.f2028n;
        while (true) {
    ...
    public boolean getOrDefault(int k, boolean defaultValue) {
        int curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f2028n] : defaultValue;
        }
        int[] key = this.key;
        int mix = HashCommon.mix(k) & this.mask;
        int pos = mix;
    ...
    public boolean remove(int k, boolean v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f2028n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanOpenHashMap$MapEntry.class */
    public final class MapEntry implements Int2BooleanMap.Entry, Map.Entry<Integer, Boolean>, IntBooleanPair {
        ...
        public boolean equals(Object o) {
            ...
            return Int2BooleanOpenHashMap.this.key[this.index] == e.getKey().intValue() && Int2BooleanOpenHashMap.this.value[this.index] == e.getValue().booleanValue();
        }

        @Override // java.util.Map.Entry, java.lang.Object
        public int hashCode() {
            return Int2BooleanOpenHashMap.this.key[this.index] ^ (Int2BooleanOpenHashMap.this.value[this.index] ? RetcodeOuterClass.Retcode.RET_MP_OTHER_DATA_VERSION_NOT_LATEST_VALUE : RetcodeOuterClass.Retcode.RET_MP_MATCH_FULL_VALUE);
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Int2BooleanOpenHashMap.this.f2028n;
            this.last = -1;
            this.f2030c = Int2BooleanOpenHashMap.this.size;
            this.mustReturnNullKey = Int2BooleanOpenHashMap.this.containsNullKey;
        }

        public boolean hasNext() {
            return this.f2030c != 0;
        }
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Int2BooleanOpenHashMap.this.f2028n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int i3 = Int2BooleanOpenHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (k == key[p]) {
                            return p;
                        ...
                        mix = p + 1;
                        i3 = Int2BooleanOpenHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Int2BooleanOpenHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Int2BooleanOpenHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Int2BooleanOpenHashMap.this.value[pos] = Int2BooleanOpenHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Int2BooleanOpenHashMap.this.f2028n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Int2BooleanMap.Entry>> implements ObjectIterator<Int2BooleanMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanOpenHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Int2BooleanOpenHashMap.this.f2028n;
            this.f2031c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2031c++;
                acceptOnIndex(action, Int2BooleanOpenHashMap.this.f2028n);
                return true;
            }
            int[] key = Int2BooleanOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Int2BooleanOpenHashMap.this.size - this.f2031c);
            }
            return Math.min((long) (Int2BooleanOpenHashMap.this.size - this.f2031c), ((long) ((((double) Int2BooleanOpenHashMap.this.realSize()) / ((double) Int2BooleanOpenHashMap.this.f2028n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap r0 = p014it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap.this
                int[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Int2BooleanMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Int2BooleanMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Int2BooleanMap.Entry> implements Int2BooleanMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Int2BooleanOpenHashMap.this.containsNullKey && Int2BooleanOpenHashMap.this.value[Int2BooleanOpenHashMap.this.f2028n] == v;
            }
            int[] key = Int2BooleanOpenHashMap.this.key;
            int mix = HashCommon.mix(k) & Int2BooleanOpenHashMap.this.mask;
            int pos = mix;
            int curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            ...
            do {
                int i = (pos + 1) & Int2BooleanOpenHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (k != 0) {
                ...
                if (curr != k) {
                    while (true) {
                        ...
                        if (curr2 == k && Int2BooleanOpenHashMap.this.value[pos] == v) {
                            Int2BooleanOpenHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Int2BooleanOpenHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Int2BooleanOpenHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Int2BooleanOpenHashMap.this.containsNullKey || Int2BooleanOpenHashMap.this.value[Int2BooleanOpenHashMap.this.f2028n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Int2BooleanMap.Entry> consumer) {
            if (Int2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2BooleanMap.BasicEntry(Int2BooleanOpenHashMap.this.key[Int2BooleanOpenHashMap.this.f2028n], Int2BooleanOpenHashMap.this.value[Int2BooleanOpenHashMap.this.f2028n]));
            }
            int pos = Int2BooleanOpenHashMap.this.f2028n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Int2BooleanMap.Entry> consumer) {
            ...
            if (Int2BooleanOpenHashMap.this.containsNullKey) {
                entry.key = Int2BooleanOpenHashMap.this.key[Int2BooleanOpenHashMap.this.f2028n];
                entry.value = Int2BooleanOpenHashMap.this.value[Int2BooleanOpenHashMap.this.f2028n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanOpenHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanOpenHashMap$KeySet.class */
    public final class KeySet extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Int2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(Int2BooleanOpenHashMap.this.key[Int2BooleanOpenHashMap.this.f2028n]);
            }
            int pos = Int2BooleanOpenHashMap.this.f2028n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2BooleanOpenHashMap$ValueSpliterator.class */
    ...
    public Collection<Boolean> values() {
        if (this.values == null) {
            this.values = new AbstractBooleanCollection() { // from class: it.unimi.dsi.fastutil.ints.Int2BooleanOpenHashMap.1
                ...
                public void forEach(BooleanConsumer consumer) {
                    if (Int2BooleanOpenHashMap.this.containsNullKey) {
                        consumer.accept(Int2BooleanOpenHashMap.this.value[Int2BooleanOpenHashMap.this.f2028n]);
                    }
                    int pos = Int2BooleanOpenHashMap.this.f2028n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f2029f)));
        if (l >= this.f2028n || this.size > HashCommon.maxFill(l, this.f2029f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2028n];
                this.f2028n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f2028n, this.f2029f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Int2BooleanOpenHashMap clone() {
        try {
            Int2BooleanOpenHashMap c = (Int2BooleanOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        while (true) {
            ...
            h += this.key[i] ^ (this.value[i] ? RetcodeOuterClass.Retcode.RET_MP_OTHER_DATA_VERSION_NOT_LATEST_VALUE : RetcodeOuterClass.Retcode.RET_MP_MATCH_FULL_VALUE);
            i++;
        }
        if (this.containsNullKey) {
            h += this.value[this.f2028n] ? RetcodeOuterClass.Retcode.RET_MP_OTHER_DATA_VERSION_NOT_LATEST_VALUE : RetcodeOuterClass.Retcode.RET_MP_MATCH_FULL_VALUE;
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f2028n = HashCommon.arraySize(this.size, this.f2029f);
        this.maxFill = HashCommon.maxFill(this.f2028n, this.f2029f);
        this.mask = this.f2028n - 1;
        int[] key = new int[this.f2028n + 1];
        this.key = key;
        boolean[] value = new boolean[this.f2028n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
