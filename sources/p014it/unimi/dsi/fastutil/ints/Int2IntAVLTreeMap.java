...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntAVLTreeMap.class */
public class Int2IntAVLTreeMap extends AbstractInt2IntSortedMap implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Int2IntAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap.Entry add(int r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap.add(int):it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap$Entry");
    }
    ...
    public int remove(int r5) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap.remove(int):int");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntAVLTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(int k) {
            Entry locateKey = Int2IntAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntAVLTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2IntMap.Entry>() { // from class: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap.1
                final Comparator<? super Int2IntMap.Entry> comparator;

                {
                    this.comparator = Int2IntAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Integer) && e.getValue() != null && (e.getValue() instanceof Integer)) {
                        return e.equals(Int2IntAVLTreeMap.this.findKey(((Integer) e.getKey()).intValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Integer) || !(e.getValue() instanceof Integer) || (f = Int2IntAVLTreeMap.this.findKey(((Integer) e.getKey()).intValue())) == null || f.getIntValue() != ((Integer) e.getValue()).intValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntAVLTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntAVLTreeMap$ValueIterator.class */
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntAVLTreeMap$Submap.class */
    public final class Submap extends AbstractInt2IntSortedMap implements Serializable {
        ...
        public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2IntMap.Entry>() { // from class: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Int2IntMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Integer) && e.getValue() != null && (e.getValue() instanceof Integer) && (f = Int2IntAVLTreeMap.this.findKey(((Integer) e.getKey()).intValue())) != null && Submap.this.m766in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Int2IntAVLTreeMap.this.findKey(((Integer) e.getKey()).intValue());
                        if (f != null && Submap.this.m766in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractInt2IntSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public IntCollection values() {
            if (this.values == null) {
                this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.ints.AbstractIntCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.ints.IntCollection, p014it.unimi.dsi.fastutil.ints.IntIterable
                    public IntIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.AbstractInt2IntMap, p014it.unimi.dsi.fastutil.ints.Int2IntFunction, p014it.unimi.dsi.fastutil.ints.Int2IntMap
        public boolean containsKey(int k) {
            return m766in(k) && Int2IntAVLTreeMap.this.containsKey(k);
        }
        ...
        public int get(int k) {
            Entry e;
            return (!m766in(k) || (e = Int2IntAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public int remove(int k) {
            ...
            return Int2IntAVLTreeMap.this.modified ? Int2IntAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.bottom || Int2IntAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, int k) {
                ...
                if (submap.bottom || Int2IntAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Int2IntAVLTreeMap int2IntAVLTreeMap = Int2IntAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (int2IntAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntAVLTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2IntAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2IntAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Int2IntAVLTreeMap clone() {
        try {
            Int2IntAVLTreeMap c = (Int2IntAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
