...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceOpenHashMap.class */
public class Int2ReferenceOpenHashMap<V> extends AbstractInt2ReferenceMap<V> implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceOpenHashMap$MapEntry.class */
    public final class MapEntry implements Int2ReferenceMap.Entry<V>, Map.Entry<Integer, V>, IntReferencePair<V> {
        ...
        public boolean equals(Object o) {
            ...
            return Int2ReferenceOpenHashMap.this.key[this.index] == e.getKey().intValue() && Int2ReferenceOpenHashMap.this.value[this.index] == e.getValue();
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int i3 = Int2ReferenceOpenHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (k == key[p]) {
                            return p;
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Int2ReferenceOpenHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                        key[pos] = 0;
                        Int2ReferenceOpenHashMap.this.value[pos] = null;
                        return;
                    }
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Int2ReferenceOpenHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Int2ReferenceOpenHashMap.this.value[pos] = Int2ReferenceOpenHashMap.this.value[pos];
            }
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends Int2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Int2ReferenceMap.Entry<V>> {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap.MapIterator
        ...
        public Int2ReferenceOpenHashMap<V>.MapEntry next() {
            Int2ReferenceOpenHashMap<V>.MapEntry mapEntry = new MapEntry(nextEntry());
            this.entry = mapEntry;
            return mapEntry;
        }

        final void acceptOnIndex(Consumer<? super Int2ReferenceMap.Entry<V>> action, int index) {
            Int2ReferenceOpenHashMap<V>.MapEntry mapEntry = new MapEntry(index);
            this.entry = mapEntry;
            action.accept(mapEntry);
        }

        @Override // p014it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceOpenHashMap$FastEntryIterator.class */
    private final class FastEntryIterator extends Int2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Int2ReferenceMap.Entry<V>> {
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends Int2ReferenceOpenHashMap<V>.MapSpliterator> {
        int pos;
        int max;
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap r0 = p014it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap.this
                int[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends Int2ReferenceOpenHashMap<V>.MapSpliterator implements ObjectSpliterator<Int2ReferenceMap.Entry<V>> {
        private static final int POST_SPLIT_CHARACTERISTICS = 1;

        @Override // p014it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap.MapSpliterator
        /* bridge */ /* synthetic */ void acceptOnIndex(Object obj, int i) {
            acceptOnIndex((Consumer) ((Consumer) obj), i);
        }
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap.MapSpliterator
        public final Int2ReferenceOpenHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
            return new EntrySpliterator(pos, max, mustReturnNull, true);
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Int2ReferenceMap.Entry<V>> implements Int2ReferenceMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            if (k == curr2) {
                return Int2ReferenceOpenHashMap.this.value[pos] == value;
            }
            do {
                int i = (pos + 1) & Int2ReferenceOpenHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (k != 0) {
                ...
                if (curr != k) {
                    while (true) {
                        ...
                        if (curr2 == k && Int2ReferenceOpenHashMap.this.value[pos] == value) {
                            Int2ReferenceOpenHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Int2ReferenceOpenHashMap.this.value[pos] != value) {
                    return false;
                } else {
                    Int2ReferenceOpenHashMap.this.removeEntry(pos);
                    return true;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceOpenHashMap$KeyIterator.class */
    public final class KeyIterator extends Int2ReferenceOpenHashMap<V>.MapIterator implements IntIterator {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceOpenHashMap$KeySpliterator.class */
    public final class KeySpliterator extends Int2ReferenceOpenHashMap<V>.MapSpliterator implements IntSpliterator {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap.MapSpliterator
        public final Int2ReferenceOpenHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
            return new KeySpliterator(pos, max, mustReturnNull, true);
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceOpenHashMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceOpenHashMap$ValueIterator.class */
    public final class ValueIterator extends Int2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<V> {
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap.MapIterator
        /* bridge */ /* synthetic */ void acceptOnIndex(Object obj, int i) {
            acceptOnIndex((Consumer) ((Consumer) obj), i);
        }
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept((Object) Int2ReferenceOpenHashMap.this.value[index]);
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ReferenceOpenHashMap$ValueSpliterator.class */
    public final class ValueSpliterator extends Int2ReferenceOpenHashMap<V>.MapSpliterator implements ObjectSpliterator<V> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap.MapSpliterator
        public final Int2ReferenceOpenHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap.1
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (true) {
                        ...
                        if (Int2ReferenceOpenHashMap.this.key[pos] != 0) {
                            consumer.accept((Object) Int2ReferenceOpenHashMap.this.value[pos]);
                        }
                    }
                }
    ...
    public Int2ReferenceOpenHashMap<V> clone() {
        try {
            Int2ReferenceOpenHashMap<V> c = (Int2ReferenceOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        int[] key = this.key;
        V[] value = this.value;
        Int2ReferenceOpenHashMap<V>.EntryIterator i = new EntryIterator();
