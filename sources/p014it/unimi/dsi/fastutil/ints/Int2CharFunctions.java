...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2CharFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharFunctions.class */
public final class Int2CharFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractInt2CharFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.AbstractInt2CharFunction, p014it.unimi.dsi.fastutil.ints.Int2CharFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Int2CharFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Int2CharFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Int2CharFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2CharFunction, java.util.function.IntUnaryOperator
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractInt2CharFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Int2CharFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Int2CharFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Int2CharFunction {
        ...
        public char get(int key) {
            Character v = (Character) this.function.apply(Integer.valueOf(key));
        ...
        public Character get(Object key) {
            ...
            return (Character) this.function.apply((Integer) key);
        }
        ...
        public Character getOrDefault(Object key, Character defaultValue) {
            Character v;
            if (!(key == null || (v = (Character) this.function.apply((Integer) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
    ...
    public static Int2CharFunction primitive(java.util.function.Function<? super Integer, ? extends Character> f) {
        ...
        return f instanceof Int2CharFunction ? (Int2CharFunction) f : f instanceof IntUnaryOperator ? key -> {
