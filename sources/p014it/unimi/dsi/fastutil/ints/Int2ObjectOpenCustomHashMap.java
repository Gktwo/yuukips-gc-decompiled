...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenCustomHashMap.class */
public class Int2ObjectOpenCustomHashMap<V> extends AbstractInt2ObjectMap<V> implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f2072n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f2073f;
    ...
    public Int2ObjectOpenCustomHashMap(int expected, float f, IntHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f2072n = arraySize;
            this.minN = arraySize;
            this.mask = this.f2072n - 1;
            this.maxFill = HashCommon.maxFill(this.f2072n, f);
            this.key = new int[this.f2072n + 1];
            this.value = (V[]) new Object[this.f2072n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f2073f);
        if (needed > this.f2072n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f2073f)))));
        if (needed > this.f2072n) {
            rehash(needed);
        }
    }
    ...
    public V removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f2072n > this.minN && this.size < this.maxFill / 4 && this.f2072n > 16) {
            rehash(this.f2072n / 2);
        }
        return oldValue;
    }
    ...
    public V removeNullEntry() {
        ...
        V oldValue = this.value[this.f2072n];
        this.value[this.f2072n] = null;
        this.size--;
        if (this.f2072n > this.minN && this.size < this.maxFill / 4 && this.f2072n > 16) {
            rehash(this.f2072n / 2);
        }
    ...
    private int find(int k) {
        ...
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.f2072n : -(this.f2072n + 1);
        }
        int[] key = this.key;
    ...
    private void insert(int pos, int k, V v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f2073f));
        }
    }
    ...
    public V get(int k) {
        int curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2072n] : (V) this.defRetValue;
        }
        int[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(Object v) {
        V[] value = this.value;
        int[] key = this.key;
        if (this.containsNullKey && Objects.equals(value[this.f2072n], v)) {
            return true;
        }
        int i = this.f2072n;
        while (true) {
    ...
    public V getOrDefault(int k, V defaultValue) {
        int curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2072n] : defaultValue;
        }
        int[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(int k, Object v) {
        ...
        } else if (!this.containsNullKey || !Objects.equals(v, this.value[this.f2072n])) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenCustomHashMap$MapEntry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Int2ObjectOpenCustomHashMap.this.f2072n;
            this.last = -1;
            this.f2074c = Int2ObjectOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Int2ObjectOpenCustomHashMap.this.f2072n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Int2ObjectOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Int2ObjectOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Int2ObjectOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Int2ObjectOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Int2ObjectOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                        key[pos] = 0;
                        Int2ObjectOpenCustomHashMap.this.value[pos] = null;
                        return;
                    }
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Int2ObjectOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Int2ObjectOpenCustomHashMap.this.value[pos] = Int2ObjectOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Int2ObjectOpenCustomHashMap.this.f2072n) {
                Int2ObjectOpenCustomHashMap.this.containsNullKey = false;
                Int2ObjectOpenCustomHashMap.this.value[Int2ObjectOpenCustomHashMap.this.f2072n] = null;
            } else if (this.pos >= 0) {
                shiftKeys(this.last);
            } else {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends Int2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Int2ObjectMap.Entry<V>> {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap.MapIterator
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenCustomHashMap$FastEntryIterator.class */
    private final class FastEntryIterator extends Int2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Int2ObjectMap.Entry<V>> {
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends Int2ObjectOpenCustomHashMap<V>.MapSpliterator> {
        int pos;
        int max;
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Int2ObjectOpenCustomHashMap.this.f2072n;
            this.f2075c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2075c++;
                acceptOnIndex(action, Int2ObjectOpenCustomHashMap.this.f2072n);
                return true;
            }
            int[] key = Int2ObjectOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Int2ObjectOpenCustomHashMap.this.size - this.f2075c);
            }
            return Math.min((long) (Int2ObjectOpenCustomHashMap.this.size - this.f2075c), ((long) ((((double) Int2ObjectOpenCustomHashMap.this.realSize()) / ((double) Int2ObjectOpenCustomHashMap.this.f2072n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap.this
                int[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends Int2ObjectOpenCustomHashMap<V>.MapSpliterator implements ObjectSpliterator<Int2ObjectMap.Entry<V>> {
        private static final int POST_SPLIT_CHARACTERISTICS = 1;

        @Override // p014it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap.MapSpliterator
        /* bridge */ /* synthetic */ void acceptOnIndex(Object obj, int i) {
            acceptOnIndex((Consumer) ((Consumer) obj), i);
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Int2ObjectMap.Entry<V>> implements Int2ObjectMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            if (Int2ObjectOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Int2ObjectOpenCustomHashMap.this.containsNullKey && Objects.equals(Int2ObjectOpenCustomHashMap.this.value[Int2ObjectOpenCustomHashMap.this.f2072n], value);
            }
            int[] key = Int2ObjectOpenCustomHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            if (!Int2ObjectOpenCustomHashMap.this.strategy.equals(k, 0)) {
                ...
                } else if (!Objects.equals(Int2ObjectOpenCustomHashMap.this.value[pos], value)) {
                    return false;
                } else {
                    Int2ObjectOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Int2ObjectOpenCustomHashMap.this.containsNullKey || !Objects.equals(Int2ObjectOpenCustomHashMap.this.value[Int2ObjectOpenCustomHashMap.this.f2072n], value)) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Int2ObjectMap.Entry<V>> consumer) {
            if (Int2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2ObjectMap.BasicEntry(Int2ObjectOpenCustomHashMap.this.key[Int2ObjectOpenCustomHashMap.this.f2072n], Int2ObjectOpenCustomHashMap.this.value[Int2ObjectOpenCustomHashMap.this.f2072n]));
            }
            int pos = Int2ObjectOpenCustomHashMap.this.f2072n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Int2ObjectMap.Entry<V>> consumer) {
            ...
            if (Int2ObjectOpenCustomHashMap.this.containsNullKey) {
                entry.key = Int2ObjectOpenCustomHashMap.this.key[Int2ObjectOpenCustomHashMap.this.f2072n];
                entry.value = Int2ObjectOpenCustomHashMap.this.value[Int2ObjectOpenCustomHashMap.this.f2072n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenCustomHashMap$KeyIterator.class */
    public final class KeyIterator extends Int2ObjectOpenCustomHashMap<V>.MapIterator implements IntIterator {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenCustomHashMap$KeySpliterator.class */
    public final class KeySpliterator extends Int2ObjectOpenCustomHashMap<V>.MapSpliterator implements IntSpliterator {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Int2ObjectOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Int2ObjectOpenCustomHashMap.this.key[Int2ObjectOpenCustomHashMap.this.f2072n]);
            }
            int pos = Int2ObjectOpenCustomHashMap.this.f2072n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenCustomHashMap$ValueIterator.class */
    public final class ValueIterator extends Int2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<V> {
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap.MapIterator
        /* bridge */ /* synthetic */ void acceptOnIndex(Object obj, int i) {
            acceptOnIndex((Consumer) ((Consumer) obj), i);
        }
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept((Object) Int2ObjectOpenCustomHashMap.this.value[index]);
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ObjectOpenCustomHashMap$ValueSpliterator.class */
    public final class ValueSpliterator extends Int2ObjectOpenCustomHashMap<V>.MapSpliterator implements ObjectSpliterator<V> {
        ...
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>() { // from class: it.unimi.dsi.fastutil.ints.Int2ObjectOpenCustomHashMap.1
                ...
                public void forEach(Consumer<? super V> consumer) {
                    if (Int2ObjectOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((Object) Int2ObjectOpenCustomHashMap.this.value[Int2ObjectOpenCustomHashMap.this.f2072n]);
                    }
                    int pos = Int2ObjectOpenCustomHashMap.this.f2072n;
                    while (true) {
                        pos--;
                        ...
                        if (Int2ObjectOpenCustomHashMap.this.key[pos] != 0) {
                            consumer.accept((Object) Int2ObjectOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f2073f)));
        if (l >= this.f2072n || this.size > HashCommon.maxFill(l, this.f2073f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2072n];
                this.f2072n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f2072n, this.f2073f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Int2ObjectOpenCustomHashMap<V> clone() {
        try {
            Int2ObjectOpenCustomHashMap<V> c = (Int2ObjectOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += this.value[this.f2072n] == null ? 0 : this.value[this.f2072n].hashCode();
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f2072n = HashCommon.arraySize(this.size, this.f2073f);
        this.maxFill = HashCommon.maxFill(this.f2072n, this.f2073f);
        this.mask = this.f2072n - 1;
        int[] key = new int[this.f2072n + 1];
        this.key = key;
        V[] value = (V[]) new Object[this.f2072n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
