...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharOpenCustomHashMap.class */
public class Int2CharOpenCustomHashMap extends AbstractInt2CharMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f2012n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f2013f;
    ...
    public Int2CharOpenCustomHashMap(int expected, float f, IntHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f2012n = arraySize;
            this.minN = arraySize;
            this.mask = this.f2012n - 1;
            this.maxFill = HashCommon.maxFill(this.f2012n, f);
            this.key = new int[this.f2012n + 1];
            this.value = new char[this.f2012n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f2013f);
        if (needed > this.f2012n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f2013f)))));
        if (needed > this.f2012n) {
            rehash(needed);
        }
    }
    ...
    public char removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f2012n > this.minN && this.size < this.maxFill / 4 && this.f2012n > 16) {
            rehash(this.f2012n / 2);
        }
        return oldValue;
    }
    ...
    public char removeNullEntry() {
        ...
        char oldValue = this.value[this.f2012n];
        this.size--;
        if (this.f2012n > this.minN && this.size < this.maxFill / 4 && this.f2012n > 16) {
            rehash(this.f2012n / 2);
        }
    ...
    private int find(int k) {
        ...
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.f2012n : -(this.f2012n + 1);
        }
        int[] key = this.key;
    ...
    private void insert(int pos, int k, char v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f2013f));
        }
    }
    ...
    public char addTo(int k, char incr) {
        ...
        if (!this.strategy.equals(k, 0)) {
            ...
            return addToValue(this.f2012n, incr);
        } else {
            pos = this.f2012n;
            this.containsNullKey = true;
        }
    ...
    public char get(int k) {
        int curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2012n] : this.defRetValue;
        }
        int[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(char v) {
        ...
        int[] key = this.key;
        if (this.containsNullKey && value[this.f2012n] == v) {
            return true;
        }
        int i = this.f2012n;
        while (true) {
    ...
    public char getOrDefault(int k, char defaultValue) {
        int curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2012n] : defaultValue;
        }
        int[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(int k, char v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f2012n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Int2CharMap.Entry, Map.Entry<Integer, Character>, IntCharPair {
        ...
        public boolean equals(Object o) {
            ...
            return Int2CharOpenCustomHashMap.this.strategy.equals(Int2CharOpenCustomHashMap.this.key[this.index], e.getKey().intValue()) && Int2CharOpenCustomHashMap.this.value[this.index] == e.getValue().charValue();
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Int2CharOpenCustomHashMap.this.f2012n;
            this.last = -1;
            this.f2014c = Int2CharOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Int2CharOpenCustomHashMap.this.f2012n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Int2CharOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Int2CharOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Int2CharOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Int2CharOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Int2CharOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Int2CharOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Int2CharOpenCustomHashMap.this.value[pos] = Int2CharOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Int2CharOpenCustomHashMap.this.f2012n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Int2CharMap.Entry>> implements ObjectIterator<Int2CharMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Int2CharOpenCustomHashMap.this.f2012n;
            this.f2015c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2015c++;
                acceptOnIndex(action, Int2CharOpenCustomHashMap.this.f2012n);
                return true;
            }
            int[] key = Int2CharOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Int2CharOpenCustomHashMap.this.size - this.f2015c);
            }
            return Math.min((long) (Int2CharOpenCustomHashMap.this.size - this.f2015c), ((long) ((((double) Int2CharOpenCustomHashMap.this.realSize()) / ((double) Int2CharOpenCustomHashMap.this.f2012n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap.this
                int[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Int2CharMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Int2CharMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Int2CharMap.Entry> implements Int2CharMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Int2CharOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Int2CharOpenCustomHashMap.this.containsNullKey && Int2CharOpenCustomHashMap.this.value[Int2CharOpenCustomHashMap.this.f2012n] == v;
            }
            int[] key = Int2CharOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Int2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Int2CharOpenCustomHashMap.this.mask;
            int pos = mix;
            int curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            }
            if (Int2CharOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Int2CharOpenCustomHashMap.this.value[pos] == v;
            }
            do {
                int i = (pos + 1) & Int2CharOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (!Int2CharOpenCustomHashMap.this.strategy.equals(k, 0)) {
                ...
                if (!Int2CharOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Int2CharOpenCustomHashMap.this.strategy.equals(curr2, k) && Int2CharOpenCustomHashMap.this.value[pos] == v) {
                            Int2CharOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Int2CharOpenCustomHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Int2CharOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Int2CharOpenCustomHashMap.this.containsNullKey || Int2CharOpenCustomHashMap.this.value[Int2CharOpenCustomHashMap.this.f2012n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Int2CharMap.Entry> consumer) {
            if (Int2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractInt2CharMap.BasicEntry(Int2CharOpenCustomHashMap.this.key[Int2CharOpenCustomHashMap.this.f2012n], Int2CharOpenCustomHashMap.this.value[Int2CharOpenCustomHashMap.this.f2012n]));
            }
            int pos = Int2CharOpenCustomHashMap.this.f2012n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Int2CharMap.Entry> consumer) {
            ...
            if (Int2CharOpenCustomHashMap.this.containsNullKey) {
                entry.key = Int2CharOpenCustomHashMap.this.key[Int2CharOpenCustomHashMap.this.f2012n];
                entry.value = Int2CharOpenCustomHashMap.this.value[Int2CharOpenCustomHashMap.this.f2012n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractIntSet {
        ...
        public void forEach(IntConsumer consumer) {
            if (Int2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Int2CharOpenCustomHashMap.this.key[Int2CharOpenCustomHashMap.this.f2012n]);
            }
            int pos = Int2CharOpenCustomHashMap.this.f2012n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Character> values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection() { // from class: it.unimi.dsi.fastutil.ints.Int2CharOpenCustomHashMap.1
                ...
                public void forEach(CharConsumer consumer) {
                    if (Int2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Int2CharOpenCustomHashMap.this.value[Int2CharOpenCustomHashMap.this.f2012n]);
                    }
                    int pos = Int2CharOpenCustomHashMap.this.f2012n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f2013f)));
        if (l >= this.f2012n || this.size > HashCommon.maxFill(l, this.f2013f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2012n];
                this.f2012n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f2012n, this.f2013f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Int2CharOpenCustomHashMap clone() {
        try {
            Int2CharOpenCustomHashMap c = (Int2CharOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f2012n = HashCommon.arraySize(this.size, this.f2013f);
        this.maxFill = HashCommon.maxFill(this.f2012n, this.f2013f);
        this.mask = this.f2012n - 1;
        int[] key = new int[this.f2012n + 1];
        this.key = key;
        char[] value = new char[this.f2012n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
