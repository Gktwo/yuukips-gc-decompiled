...
import p014it.unimi.dsi.fastutil.ints.Int2ByteMaps;
...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2ByteSortedMaps */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ByteSortedMaps.class */
public final class Int2ByteSortedMaps {
    ...
    public static ObjectBidirectionalIterable<Int2ByteMap.Entry> fastIterable(Int2ByteSortedMap map) {
        ...
        Int2ByteSortedMap.FastSortedEntrySet fastSortedEntrySet = (Int2ByteSortedMap.FastSortedEntrySet) entries;
        Objects.requireNonNull(fastSortedEntrySet);
        return this::fastIterator;
    }

    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ByteSortedMaps$EmptySortedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ByteSortedMaps$EmptySortedMap.class */
    public static class EmptySortedMap extends Int2ByteMaps.EmptyMap implements Int2ByteSortedMap, Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ByteMaps.EmptyMap, p014it.unimi.dsi.fastutil.ints.Int2ByteMap, p014it.unimi.dsi.fastutil.ints.Int2ByteSortedMap
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ByteMaps.EmptyMap, p014it.unimi.dsi.fastutil.ints.Int2ByteMap, java.util.Map
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ByteSortedMaps$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ByteSortedMaps$Singleton.class */
    public static class Singleton extends Int2ByteMaps.Singleton implements Int2ByteSortedMap, Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ByteMaps.Singleton, p014it.unimi.dsi.fastutil.ints.Int2ByteMap, p014it.unimi.dsi.fastutil.ints.Int2ByteSortedMap
        public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ByteMaps.Singleton, p014it.unimi.dsi.fastutil.ints.Int2ByteMap, java.util.Map
        @Deprecated
        public ObjectSortedSet<Map.Entry<Integer, Byte>> entrySet() {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ByteSortedMap
        public Int2ByteSortedMap subMap(int from, int to) {
            return (compare(from, this.key) > 0 || compare(this.key, to) >= 0) ? Int2ByteSortedMaps.EMPTY_MAP : this;
        }

        @Override // p014it.unimi.dsi.fastutil.ints.Int2ByteSortedMap
        public Int2ByteSortedMap headMap(int to) {
            return compare(this.key, to) < 0 ? this : Int2ByteSortedMaps.EMPTY_MAP;
        }

        @Override // p014it.unimi.dsi.fastutil.ints.Int2ByteSortedMap
        public Int2ByteSortedMap tailMap(int from) {
            return compare(from, this.key) <= 0 ? this : Int2ByteSortedMaps.EMPTY_MAP;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ByteSortedMaps$SynchronizedSortedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ByteSortedMaps$SynchronizedSortedMap.class */
    public static class SynchronizedSortedMap extends Int2ByteMaps.SynchronizedMap implements Int2ByteSortedMap, Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ByteMaps.SynchronizedMap, p014it.unimi.dsi.fastutil.ints.Int2ByteMap, p014it.unimi.dsi.fastutil.ints.Int2ByteSortedMap
        public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
            if (this.entries == null) {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ByteMaps.SynchronizedMap, p014it.unimi.dsi.fastutil.ints.Int2ByteMap, java.util.Map
        @Deprecated
        public ObjectSortedSet<Map.Entry<Integer, Byte>> entrySet() {
            return int2ByteEntrySet();
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ByteSortedMaps$UnmodifiableSortedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ByteSortedMaps$UnmodifiableSortedMap.class */
    public static class UnmodifiableSortedMap extends Int2ByteMaps.UnmodifiableMap implements Int2ByteSortedMap, Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ByteMaps.UnmodifiableMap, p014it.unimi.dsi.fastutil.ints.Int2ByteMap, p014it.unimi.dsi.fastutil.ints.Int2ByteSortedMap
        public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
            if (this.entries == null) {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ByteMaps.UnmodifiableMap, p014it.unimi.dsi.fastutil.ints.Int2ByteMap, java.util.Map
        @Deprecated
        public ObjectSortedSet<Map.Entry<Integer, Byte>> entrySet() {
            return int2ByteEntrySet();
        }
