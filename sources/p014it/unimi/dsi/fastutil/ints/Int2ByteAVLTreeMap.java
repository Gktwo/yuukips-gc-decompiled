...
public class Int2ByteAVLTreeMap extends AbstractInt2ByteSortedMap implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractInt2ByteSortedMap implements Serializable {
        ...
        final boolean m774in(int k) {
            return (this.bottom || Int2ByteAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2ByteAVLTreeMap.this.compare(k, this.f2033to) < 0);
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ByteSortedMap
        public Int2ByteSortedMap headMap(int to) {
            if (!this.top && Int2ByteAVLTreeMap.this.compare(to, this.f2033to) >= 0) {
                return this;
            }
        ...
        public Int2ByteSortedMap subMap(int from, int to) {
            ...
            if (!this.top) {
                to = Int2ByteAVLTreeMap.this.compare(to, this.f2033to) < 0 ? to : this.f2033to;
            }
            if (!this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Int2ByteAVLTreeMap.this.compare(e.key, this.f2033to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Int2ByteAVLTreeMap.this.locateKey(this.f2033to);
                if (Int2ByteAVLTreeMap.this.compare(e.key, this.f2033to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Int2ByteAVLTreeMap.this.compare(this.next.key, Submap.this.f2033to) >= 0) {
                    this.next = null;
                }
            }
        }
