...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharRBTreeMap.class */
public class Int2CharRBTreeMap extends AbstractInt2CharSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap.Entry add(int r9) {
        /*
        // Method dump skipped, instructions count: 935
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap.add(int):it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.ints.Int2CharFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public char remove(int r7) {
        /*
        // Method dump skipped, instructions count: 1895
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap.remove(int):char");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(int k) {
            Entry locateKey = Int2CharRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Int2CharMap.Entry>() { // from class: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap.1
                final Comparator<? super Int2CharMap.Entry> comparator;

                {
                    this.comparator = Int2CharRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Integer) && e.getValue() != null && (e.getValue() instanceof Character)) {
                        return e.equals(Int2CharRBTreeMap.this.findKey(((Integer) e.getKey()).intValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Integer) || e.getValue() == null || !(e.getValue() instanceof Character) || (f = Int2CharRBTreeMap.this.findKey(((Integer) e.getKey()).intValue())) == null || f.getCharValue() != ((Character) e.getValue()).charValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharRBTreeMap$ValueIterator.class */
    ...
    public CharCollection values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection() { // from class: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharRBTreeMap$Submap.class */
    public final class Submap extends AbstractInt2CharSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m771in(int k) {
            return (this.bottom || Int2CharRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Int2CharRBTreeMap.this.compare(k, this.f2020to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.ints.Int2CharMap, p014it.unimi.dsi.fastutil.ints.Int2CharSortedMap
        public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Int2CharMap.Entry>() { // from class: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Int2CharMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Integer) && e.getValue() != null && (e.getValue() instanceof Character) && (f = Int2CharRBTreeMap.this.findKey(((Integer) e.getKey()).intValue())) != null && Submap.this.m771in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Int2CharRBTreeMap.this.findKey(((Integer) e.getKey()).intValue());
                        if (f != null && Submap.this.m771in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractInt2CharSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public CharCollection values() {
            if (this.values == null) {
                this.values = new AbstractCharCollection() { // from class: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.chars.AbstractCharCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.chars.CharCollection, p014it.unimi.dsi.fastutil.chars.CharIterable
                    public CharIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.AbstractInt2CharMap, p014it.unimi.dsi.fastutil.ints.Int2CharFunction, p014it.unimi.dsi.fastutil.ints.Int2CharMap
        public boolean containsKey(int k) {
            return m771in(k) && Int2CharRBTreeMap.this.containsKey(k);
        }
        ...
        public char get(int k) {
            Entry e;
            return (!m771in(k) || (e = Int2CharRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public char put(int k, char v) {
            ...
            if (!m771in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f2020to)) + ")");
            }
            return Int2CharRBTreeMap.this.modified ? this.defRetValue : Int2CharRBTreeMap.this.put(k, v);
        }
        ...
        public char remove(int k) {
            ...
            return Int2CharRBTreeMap.this.modified ? Int2CharRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2CharSortedMap
        public Int2CharSortedMap headMap(int to) {
            if (!this.top && Int2CharRBTreeMap.this.compare(to, this.f2020to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2CharSortedMap
        public Int2CharSortedMap tailMap(int from) {
            if (!this.bottom && Int2CharRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f2020to, this.top);
        }
        ...
        public Int2CharSortedMap subMap(int from, int to) {
            ...
            if (!this.top) {
                to = Int2CharRBTreeMap.this.compare(to, this.f2020to) < 0 ? to : this.f2020to;
            }
            if (!this.bottom) {
                from = Int2CharRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f2020to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Int2CharRBTreeMap.this.compare(e.key, this.f2020to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Int2CharRBTreeMap.this.locateKey(this.f2020to);
                if (Int2CharRBTreeMap.this.compare(e.key, this.f2020to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Int2CharRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, int k) {
                ...
                if (submap.bottom || Int2CharRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Int2CharRBTreeMap int2CharRBTreeMap = Int2CharRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (int2CharRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Int2CharRBTreeMap.this.compare(this.next.key, Submap.this.f2020to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.Int2CharRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2CharRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Int2CharRBTreeMap clone() {
        try {
            Int2CharRBTreeMap c = (Int2CharRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
