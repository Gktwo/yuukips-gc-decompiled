...
/* renamed from: it.unimi.dsi.fastutil.ints.Int2ByteFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ByteFunctions.class */
public final class Int2ByteFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ByteFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ByteFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractInt2ByteFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.AbstractInt2ByteFunction, p014it.unimi.dsi.fastutil.ints.Int2ByteFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ByteFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ByteFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ByteFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ByteFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Int2ByteFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Int2ByteFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Int2ByteFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.Int2ByteFunction, java.util.function.IntUnaryOperator
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ByteFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ByteFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractInt2ByteFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Int2ByteFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Int2ByteFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.Int2ByteFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/Int2ByteFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Int2ByteFunction {
        ...
        public byte get(int key) {
            Byte v = (Byte) this.function.apply(Integer.valueOf(key));
        ...
        public Byte getOrDefault(Object key, Byte defaultValue) {
            Byte v;
            if (!(key == null || (v = (Byte) this.function.apply((Integer) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
    ...
    public static Int2ByteFunction primitive(java.util.function.Function<? super Integer, ? extends Byte> f) {
        ...
        return f instanceof Int2ByteFunction ? (Int2ByteFunction) f : f instanceof IntUnaryOperator ? key -> {
