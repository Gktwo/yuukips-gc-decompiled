...
/* renamed from: it.unimi.dsi.fastutil.ints.IntAVLTreeSet */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/IntAVLTreeSet.class */
public class IntAVLTreeSet extends AbstractIntSortedSet implements Serializable, Cloneable, IntSortedSet {
    ...
    static {
        $assertionsDisabled = !IntAVLTreeSet.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:54:0x01a6, code lost:
        if (p014it.unimi.dsi.fastutil.ints.IntAVLTreeSet.$assertionsDisabled != false) goto L_0x01ba;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:82:0x02a9, code lost:
        if (p014it.unimi.dsi.fastutil.ints.IntAVLTreeSet.$assertionsDisabled != false) goto L_0x02bd;
     */
    ...
    public boolean add(int r8) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.ints.IntAVLTreeSet.add(int):boolean");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.IntAVLTreeSet$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/IntAVLTreeSet$Entry.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.ints.IntAVLTreeSet$SetIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/IntAVLTreeSet$SetIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.ints.IntAVLTreeSet$Subset */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/IntAVLTreeSet$Subset.class */
    private final class Subset extends AbstractIntSortedSet implements Serializable, IntSortedSet {
        ...
        @Override // p014it.unimi.dsi.fastutil.ints.AbstractIntCollection, p014it.unimi.dsi.fastutil.ints.IntCollection
        public boolean contains(int k) {
            return m756in(k) && IntAVLTreeSet.this.contains(k);
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.bottom || IntAVLTreeSet.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.ints.IntAVLTreeSet$Subset$SubsetIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/ints/IntAVLTreeSet$Subset$SubsetIterator.class */
    ...
    public Object clone() {
        try {
            IntAVLTreeSet c = (IntAVLTreeSet) clone();
            c.allocatePaths();
            if (this.count == 0) {
                return c;
            }
