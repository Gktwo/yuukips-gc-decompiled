...
/* renamed from: it.unimi.dsi.fastutil.objects.Reference2ReferenceFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ReferenceFunctions.class */
public final class Reference2ReferenceFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ReferenceFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ReferenceFunctions$EmptyFunction.class */
    public static class EmptyFunction<K, V> extends AbstractReference2ReferenceFunction<K, V> implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.AbstractReference2ReferenceFunction, p014it.unimi.dsi.fastutil.objects.Reference2ReferenceFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ReferenceFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ReferenceFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ReferenceFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ReferenceFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction<K, V> implements Reference2ReferenceFunction<K, V>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Reference2ReferenceFunction<K, V> f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Reference2ReferenceFunction<K, V> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ReferenceFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ReferenceFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction<K, V> extends AbstractReference2ReferenceFunction<K, V> implements Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Reference2ReferenceFunction<? extends K, ? extends V> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
