...
/* renamed from: it.unimi.dsi.fastutil.objects.Reference2IntArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2IntArrayMap.class */
public class Reference2IntArrayMap<K> extends AbstractReference2IntMap<K> implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Reference2IntArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Reference2IntArrayMap(Reference2IntMap<K> m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Reference2IntMap.Entry<K>> it = m.reference2IntEntrySet().iterator();
        while (it.hasNext()) {
            Reference2IntMap.Entry<K> e = it.next();
            this.key[i] = e.getKey();
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2IntArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2IntArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Reference2IntMap.Entry<K>> implements Reference2IntMap.FastEntrySet<K> {
        private EntrySet() {
        }

        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
        public ObjectIterator<Reference2IntMap.Entry<K>> iterator() {
            return new ObjectIterator<Reference2IntMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Reference2IntArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Reference2IntMap.Entry<K> next() {
                    ...
                    Object[] objArr = Reference2IntArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    Object obj = objArr[i];
                    int[] iArr = Reference2IntArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractReference2IntMap.BasicEntry(obj, iArr[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Reference2IntArrayMap.access$010(Reference2IntArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Reference2IntMap.Entry<K>> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractReference2IntMap.BasicEntry(obj, iArr[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Reference2IntMap.Entry<K>> fastIterator() {
            return new ObjectIterator<Reference2IntMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Reference2IntArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Reference2IntMap.Entry<K> next() {
                    ...
                    AbstractReference2IntMap.BasicEntry<K> basicEntry = this.entry;
                    Object[] objArr = Reference2IntArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = (K) objArr[i];
                    AbstractReference2IntMap.BasicEntry<K> basicEntry2 = this.entry;
                    int[] iArr = Reference2IntArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.objects.Reference2IntArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2IntArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Reference2IntMap.Entry<K>> implements ObjectSpliterator<Reference2IntMap.Entry<K>> {
            ...
            public final Reference2IntMap.Entry<K> get(int location) {
                return new AbstractReference2IntMap.BasicEntry(Reference2IntArrayMap.this.key[location], Reference2IntArrayMap.this.value[location]);
            }

            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Reference2IntArrayMap<K>.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
        ...
        public void forEach(Consumer<? super Reference2IntMap.Entry<K>> action) {
            int max = Reference2IntArrayMap.this.size;
            for (int i = 0; i < max; i++) {
                action.accept(new AbstractReference2IntMap.BasicEntry(Reference2IntArrayMap.this.key[i], Reference2IntArrayMap.this.value[i]));
            }
        }
        ...
        public boolean contains(Object o) {
            ...
            Object key = e.getKey();
            return Reference2IntArrayMap.this.containsKey(key) && Reference2IntArrayMap.this.getInt(key) == ((Integer) e.getValue()).intValue();
        }
        ...
        public boolean remove(Object o) {
            ...
            int oldPos = Reference2IntArrayMap.this.findKey(key);
            ...
            Reference2IntArrayMap.access$010(Reference2IntArrayMap.this);
            Reference2IntArrayMap.this.key[Reference2IntArrayMap.this.size] = null;
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2IntArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2IntArrayMap$KeySet.class */
    public final class KeySet extends AbstractReferenceSet<K> {
        ...
        public ObjectIterator<K> iterator() {
            return new ObjectIterator<K>() { // from class: it.unimi.dsi.fastutil.objects.Reference2IntArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Reference2IntArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2IntArrayMap$KeySet$KeySetSpliterator.class */
        public final class KeySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<K> implements ObjectSpliterator<K> {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Reference2IntArrayMap<K>.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2IntArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2IntArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractIntCollection {
        ...
        public IntIterator iterator() {
            return new IntIterator() { // from class: it.unimi.dsi.fastutil.objects.Reference2IntArrayMap.ValuesCollection.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Reference2IntArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2IntArrayMap$ValuesCollection$ValuesSpliterator.class */
        public final class ValuesSpliterator extends IntSpliterators.EarlyBindingSizeIndexBasedSpliterator implements IntSpliterator {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.ints.IntSpliterators.AbstractIndexBasedSpliterator
            public final Reference2IntArrayMap<K>.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
    ...
    public Reference2IntArrayMap<K> clone() {
        try {
            Reference2IntArrayMap<K> c = (Reference2IntArrayMap) clone();
