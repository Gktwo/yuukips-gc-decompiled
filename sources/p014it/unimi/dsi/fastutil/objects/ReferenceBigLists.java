...
/* renamed from: it.unimi.dsi.fastutil.objects.ReferenceBigLists */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/ReferenceBigLists.class */
public final class ReferenceBigLists {
    ...
    /* JADX WARN: Type inference failed for: r7v0, types: [it.unimi.dsi.fastutil.objects.ReferenceBigList, it.unimi.dsi.fastutil.objects.ReferenceBigList<K>] */
    ...
    public static <K> p014it.unimi.dsi.fastutil.objects.ReferenceBigList<K> shuffle(p014it.unimi.dsi.fastutil.objects.ReferenceBigList<K> r7, java.util.Random r8) {
        /*
            r0 = r7
            long r0 = r0.size64()
            r9 = r0
        ...
        L_0x0046:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.objects.ReferenceBigLists.shuffle(it.unimi.dsi.fastutil.objects.ReferenceBigList, java.util.Random):it.unimi.dsi.fastutil.objects.ReferenceBigList");
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.ReferenceBigLists$EmptyBigList */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/ReferenceBigLists$EmptyBigList.class */
    public static class EmptyBigList<K> extends ReferenceCollections.EmptyCollection<K> implements ReferenceBigList<K>, Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.ReferenceCollections.EmptyCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ReferenceCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectSet, java.util.Set
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.ReferenceBigLists$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/ReferenceBigLists$Singleton.class */
    public static class Singleton<K> extends AbstractReferenceBigList<K> implements Serializable, Cloneable {
        ...
        public ReferenceBigList<K> subList(long from, long to) {
            ...
            ensureIndex(to);
            if (from <= to) {
                return (from == 0 && to == 1) ? this : ReferenceBigLists.EMPTY_BIG_LIST;
            }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.ReferenceBigLists$SynchronizedBigList */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/ReferenceBigLists$SynchronizedBigList.class */
    public static class SynchronizedBigList<K> extends ReferenceCollections.SynchronizedCollection<K> implements ReferenceBigList<K>, Serializable {
        ...
        public ReferenceBigList<K> subList(long from, long to) {
            ...
            synchronized (this.sync) {
                synchronize = ReferenceBigLists.synchronize(this.list.subList(from, to), this.sync);
            }
            return synchronize;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.ReferenceBigLists$UnmodifiableBigList */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/ReferenceBigLists$UnmodifiableBigList.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.ReferenceBigLists$ListBigList */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/ReferenceBigLists$ListBigList.class */
    public static class ListBigList<K> extends AbstractReferenceBigList<K> implements Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.AbstractReferenceBigList, p014it.unimi.dsi.fastutil.objects.AbstractReferenceCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ReferenceCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection
        public ObjectBigListIterator<K> iterator() {
