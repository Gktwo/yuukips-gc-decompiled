...
/* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenCustomHashMap.class */
public class Object2IntOpenCustomHashMap<K> extends AbstractObject2IntMap<K> implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f2615n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f2616f;
    ...
    public Object2IntOpenCustomHashMap(int expected, float f, Hash.Strategy<? super K> strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f2615n = arraySize;
            this.minN = arraySize;
            this.mask = this.f2615n - 1;
            this.maxFill = HashCommon.maxFill(this.f2615n, f);
            this.key = (K[]) new Object[this.f2615n + 1];
            this.value = new int[this.f2615n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f2616f);
        if (needed > this.f2615n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f2616f)))));
        if (needed > this.f2615n) {
            rehash(needed);
        }
    }
    ...
    public int removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f2615n > this.minN && this.size < this.maxFill / 4 && this.f2615n > 16) {
            rehash(this.f2615n / 2);
        }
        return oldValue;
    }
    ...
    public int removeNullEntry() {
        ...
        this.key[this.f2615n] = null;
        int oldValue = this.value[this.f2615n];
        this.size--;
        if (this.f2615n > this.minN && this.size < this.maxFill / 4 && this.f2615n > 16) {
            rehash(this.f2615n / 2);
        }
    ...
    private int find(K k) {
        ...
        if (this.strategy.equals(k, null)) {
            return this.containsNullKey ? this.f2615n : -(this.f2615n + 1);
        }
        K[] key = this.key;
    ...
    private void insert(int pos, K k, int v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f2616f));
        }
    }
    ...
    public int addTo(K k, int incr) {
        ...
        if (!this.strategy.equals(k, null)) {
            ...
            return addToValue(this.f2615n, incr);
        } else {
            pos = this.f2615n;
            this.containsNullKey = true;
        }
    ...
    public int getInt(Object k) {
        K curr;
        if (this.strategy.equals(k, null)) {
            return this.containsNullKey ? this.value[this.f2615n] : this.defRetValue;
        }
        K[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(int v) {
        ...
        K[] key = this.key;
        if (this.containsNullKey && value[this.f2615n] == v) {
            return true;
        }
        int i = this.f2615n;
        while (true) {
    ...
    public int getOrDefault(Object k, int defaultValue) {
        K curr;
        if (this.strategy.equals(k, null)) {
            return this.containsNullKey ? this.value[this.f2615n] : defaultValue;
        }
        K[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(Object k, int v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f2615n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Object2IntMap.Entry<K>, Map.Entry<K, Integer>, ObjectIntPair<K> {
        ...
        public boolean equals(Object o) {
            ...
            return Object2IntOpenCustomHashMap.this.strategy.equals((Object) Object2IntOpenCustomHashMap.this.key[this.index], (Object) e.getKey()) && Object2IntOpenCustomHashMap.this.value[this.index] == e.getValue().intValue();
        }

        @Override // java.util.Map.Entry, java.lang.Object
        public int hashCode() {
            return Object2IntOpenCustomHashMap.this.strategy.hashCode((Object) Object2IntOpenCustomHashMap.this.key[this.index]) ^ Object2IntOpenCustomHashMap.this.value[this.index];
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Object2IntOpenCustomHashMap.this.f2615n;
            this.last = -1;
            this.f2617c = Object2IntOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Object2IntOpenCustomHashMap.this.f2615n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Object2IntOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Object2IntOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Object2IntOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Object2IntOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Object2IntOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == null) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Object2IntOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Object2IntOpenCustomHashMap.this.value[pos] = Object2IntOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Object2IntOpenCustomHashMap.this.f2615n) {
                Object2IntOpenCustomHashMap.this.containsNullKey = false;
                Object2IntOpenCustomHashMap.this.key[Object2IntOpenCustomHashMap.this.f2615n] = null;
            } else if (this.pos >= 0) {
                shiftKeys(this.last);
            } else {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends Object2IntOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2IntMap.Entry<K>> {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap.MapIterator
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenCustomHashMap$FastEntryIterator.class */
    private final class FastEntryIterator extends Object2IntOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2IntMap.Entry<K>> {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends Object2IntOpenCustomHashMap<K>.MapSpliterator> {
        int pos;
        int max;
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Object2IntOpenCustomHashMap.this.f2615n;
            this.f2618c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2618c++;
                acceptOnIndex(action, Object2IntOpenCustomHashMap.this.f2615n);
                return true;
            }
            K[] key = Object2IntOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Object2IntOpenCustomHashMap.this.size - this.f2618c);
            }
            return Math.min((long) (Object2IntOpenCustomHashMap.this.size - this.f2618c), ((long) ((((double) Object2IntOpenCustomHashMap.this.realSize()) / ((double) Object2IntOpenCustomHashMap.this.f2615n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap.this
                K[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends Object2IntOpenCustomHashMap<K>.MapSpliterator implements ObjectSpliterator<Object2IntMap.Entry<K>> {
        private static final int POST_SPLIT_CHARACTERISTICS = 1;

        @Override // p014it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap.MapSpliterator
        /* bridge */ /* synthetic */ void acceptOnIndex(Object obj, int i) {
            acceptOnIndex((Consumer) ((Consumer) obj), i);
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Object2IntMap.Entry<K>> implements Object2IntMap.FastEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            if (Object2IntOpenCustomHashMap.this.strategy.equals(key, null)) {
                return Object2IntOpenCustomHashMap.this.containsNullKey && Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.f2615n] == v;
            }
        ...
        public boolean remove(Object o) {
            ...
            if (!Object2IntOpenCustomHashMap.this.strategy.equals(key, null)) {
                ...
                } else if (Object2IntOpenCustomHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Object2IntOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Object2IntOpenCustomHashMap.this.containsNullKey || Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.f2615n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Object2IntMap.Entry<K>> consumer) {
            if (Object2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2IntMap.BasicEntry(Object2IntOpenCustomHashMap.this.key[Object2IntOpenCustomHashMap.this.f2615n], Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.f2615n]));
            }
            int pos = Object2IntOpenCustomHashMap.this.f2615n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Object2IntMap.Entry<K>> consumer) {
            ...
            if (Object2IntOpenCustomHashMap.this.containsNullKey) {
                entry.key = Object2IntOpenCustomHashMap.this.key[Object2IntOpenCustomHashMap.this.f2615n];
                entry.value = Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.f2615n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenCustomHashMap$KeyIterator.class */
    public final class KeyIterator extends Object2IntOpenCustomHashMap<K>.MapIterator implements ObjectIterator<K> {
        @Override // p014it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap.MapIterator
        /* bridge */ /* synthetic */ void acceptOnIndex(Object obj, int i) {
            acceptOnIndex((Consumer) ((Consumer) obj), i);
        }
        ...
        final void acceptOnIndex(Consumer<? super K> action, int index) {
            action.accept((Object) Object2IntOpenCustomHashMap.this.key[index]);
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenCustomHashMap$KeySpliterator.class */
    public final class KeySpliterator extends Object2IntOpenCustomHashMap<K>.MapSpliterator implements ObjectSpliterator<K> {
        private static final int POST_SPLIT_CHARACTERISTICS = 1;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            if (Object2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((Object) Object2IntOpenCustomHashMap.this.key[Object2IntOpenCustomHashMap.this.f2615n]);
            }
            int pos = Object2IntOpenCustomHashMap.this.f2615n;
            while (true) {
                pos--;
                if (pos != 0) {
                    Object obj = (Object) Object2IntOpenCustomHashMap.this.key[pos];
                    if (obj != 0) {
                        consumer.accept(obj);
                    }
                } else {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenCustomHashMap$ValueIterator.class */
    public final class ValueIterator extends Object2IntOpenCustomHashMap<K>.MapIterator implements IntIterator {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenCustomHashMap$ValueSpliterator.class */
    public final class ValueSpliterator extends Object2IntOpenCustomHashMap<K>.MapSpliterator implements IntSpliterator {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.objects.Object2IntOpenCustomHashMap.1
                ...
                public void forEach(IntConsumer consumer) {
                    if (Object2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Object2IntOpenCustomHashMap.this.value[Object2IntOpenCustomHashMap.this.f2615n]);
                    }
                    int pos = Object2IntOpenCustomHashMap.this.f2615n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f2616f)));
        if (l >= this.f2615n || this.size > HashCommon.maxFill(l, this.f2616f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2615n];
                this.f2615n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f2615n, this.f2616f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Object2IntOpenCustomHashMap<K> clone() {
        try {
            Object2IntOpenCustomHashMap<K> c = (Object2IntOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f2615n = HashCommon.arraySize(this.size, this.f2616f);
        this.maxFill = HashCommon.maxFill(this.f2615n, this.f2616f);
        this.mask = this.f2615n - 1;
        K[] key = (K[]) new Object[this.f2615n + 1];
        this.key = key;
        int[] value = new int[this.f2615n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
