...
/* renamed from: it.unimi.dsi.fastutil.objects.Object2ShortMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ShortMap.class */
public interface Object2ShortMap<K> extends Object2ShortFunction<K>, Map<K, Short> {
    ...
    @Override // p014it.unimi.dsi.fastutil.objects.Object2ShortSortedMap
    ...
    /* bridge */ /* synthetic */ default Short merge(Object obj, Short sh, BiFunction<? super Short, ? super Short, ? extends Short> biFunction) {
        return merge((Object2ShortMap<K>) obj, sh, biFunction);
    }
    ...
    /* bridge */ /* synthetic */ default Short replace(Object obj, Short sh) {
        return replace((Object2ShortMap<K>) obj, sh);
    }
    ...
    /* bridge */ /* synthetic */ default boolean replace(Object obj, Short sh, Short sh2) {
        return replace((Object2ShortMap<K>) obj, sh, sh2);
    }
    ...
    /* bridge */ /* synthetic */ default Short putIfAbsent(Object obj, Short sh) {
        return putIfAbsent((Object2ShortMap<K>) obj, sh);
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Object2ShortMap$FastEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ShortMap$FastEntrySet.class */
    ...
    default Short put(K key, Short value) {
        return put((Object2ShortMap<K>) key, value);
    }
    ...
    default void forEach(BiConsumer<? super K, ? super Short> consumer) {
        ObjectSet<Entry<K>> entrySet = object2ShortEntrySet();
    ...
    default short putIfAbsent(K key, short value) {
        ...
        put((Object2ShortMap<K>) key, value);
        return drv;
    }
    ...
    default boolean replace(K key, short oldValue, short newValue) {
        ...
        put((Object2ShortMap<K>) key, newValue);
        return true;
    }

    default short replace(K key, short value) {
        return containsKey(key) ? put((Object2ShortMap<K>) key, value) : defaultReturnValue();
    }
    ...
    default short computeShortIfAbsent(K key, ToIntFunction<? super K> mappingFunction) {
        return computeIfAbsent((Object2ShortMap<K>) key, (ToIntFunction<? super Object2ShortMap<K>>) mappingFunction);
    }
    ...
    default short computeShortIfAbsentPartial(K key, Object2ShortFunction<? super K> mappingFunction) {
        return computeIfAbsent((Object2ShortMap<K>) key, (Object2ShortFunction<? super Object2ShortMap<K>>) mappingFunction);
    }
    ...
    default short computeShortIfPresent(K key, BiFunction<? super K, ? super Short, ? extends Short> remappingFunction) {
        ...
        put((Object2ShortMap<K>) key, newVal);
        return newVal;
    }
    ...
    default short mergeShort(K key, short value, IntBinaryOperator remappingFunction) {
        return mergeShort((Object2ShortMap<K>) key, value, remappingFunction instanceof ShortBinaryOperator ? (ShortBinaryOperator) remappingFunction : x, y -> {
    ...
    default short mergeShort(K key, short value, BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
        return merge((Object2ShortMap<K>) key, value, remappingFunction);
    }

    @Deprecated
    default Short putIfAbsent(K key, Short value) {
        return putIfAbsent((Object2ShortMap<K>) key, (K) value);
    }
    ...
    @Deprecated
    default boolean replace(K key, Short oldValue, Short newValue) {
        return replace((Object2ShortMap<K>) key, oldValue, newValue);
    }

    @Deprecated
    default Short replace(K key, Short value) {
        return replace((Object2ShortMap<K>) key, (K) value);
    }
    ...
    @Deprecated
    default Short merge(K key, Short value, BiFunction<? super Short, ? super Short, ? extends Short> remappingFunction) {
        return merge((Object2ShortMap<K>) key, (K) value, (BiFunction<? super K, ? super K, ? extends K>) remappingFunction);
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Object2ShortMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ShortMap$Entry.class */
