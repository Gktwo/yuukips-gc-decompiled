...
/* renamed from: it.unimi.dsi.fastutil.objects.Object2LongMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2LongMap.class */
public interface Object2LongMap<K> extends Object2LongFunction<K>, Map<K, Long> {
    ...
    @Override // p014it.unimi.dsi.fastutil.objects.Object2LongSortedMap
    ...
    @Override // p014it.unimi.dsi.fastutil.objects.Object2LongFunction, p014it.unimi.dsi.fastutil.Function
    @Deprecated
    ...
    /* bridge */ /* synthetic */ default Long merge(Object obj, Long l, BiFunction<? super Long, ? super Long, ? extends Long> biFunction) {
        return merge((Object2LongMap<K>) obj, l, biFunction);
    }
    ...
    /* bridge */ /* synthetic */ default Long replace(Object obj, Long l) {
        return replace((Object2LongMap<K>) obj, l);
    }
    ...
    /* bridge */ /* synthetic */ default boolean replace(Object obj, Long l, Long l2) {
        return replace((Object2LongMap<K>) obj, l, l2);
    }
    ...
    /* bridge */ /* synthetic */ default Long putIfAbsent(Object obj, Long l) {
        return putIfAbsent((Object2LongMap<K>) obj, l);
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Object2LongMap$FastEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2LongMap$FastEntrySet.class */
    ...
    default Long put(K key, Long value) {
        return put((Object2LongMap<K>) key, value);
    }
    ...
    default void forEach(BiConsumer<? super K, ? super Long> consumer) {
        ObjectSet<Entry<K>> entrySet = object2LongEntrySet();
    ...
    default long putIfAbsent(K key, long value) {
        ...
        put((Object2LongMap<K>) key, value);
        return drv;
    }
    ...
    default boolean replace(K key, long oldValue, long newValue) {
        ...
        put((Object2LongMap<K>) key, newValue);
        return true;
    }

    default long replace(K key, long value) {
        return containsKey(key) ? put((Object2LongMap<K>) key, value) : defaultReturnValue();
    }
    ...
    default long computeLongIfAbsent(K key, ToLongFunction<? super K> mappingFunction) {
        return computeIfAbsent((Object2LongMap<K>) key, (ToLongFunction<? super Object2LongMap<K>>) mappingFunction);
    }
    ...
    default long computeLongIfAbsentPartial(K key, Object2LongFunction<? super K> mappingFunction) {
        return computeIfAbsent((Object2LongMap<K>) key, (Object2LongFunction<? super Object2LongMap<K>>) mappingFunction);
    }
    ...
    default long computeLongIfPresent(K key, BiFunction<? super K, ? super Long, ? extends Long> remappingFunction) {
        ...
        put((Object2LongMap<K>) key, newVal);
        return newVal;
    }
    ...
    default long mergeLong(K r7, long r8, java.util.function.LongBinaryOperator r10) {
        ...
        L_0x0037:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.objects.Object2LongMap.mergeLong(java.lang.Object, long, java.util.function.LongBinaryOperator):long");
    }

    default long mergeLong(K key, long value, LongBinaryOperator remappingFunction) {
        return mergeLong((Object2LongMap<K>) key, value, (java.util.function.LongBinaryOperator) remappingFunction);
    }

    @Deprecated
    default long mergeLong(K key, long value, BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
        return merge((Object2LongMap<K>) key, value, remappingFunction);
    }

    @Deprecated
    default Long putIfAbsent(K key, Long value) {
        return putIfAbsent((Object2LongMap<K>) key, (K) value);
    }
    ...
    @Deprecated
    default boolean replace(K key, Long oldValue, Long newValue) {
        return replace((Object2LongMap<K>) key, oldValue, newValue);
    }

    @Deprecated
    default Long replace(K key, Long value) {
        return replace((Object2LongMap<K>) key, (K) value);
    }
    ...
    @Deprecated
    default Long merge(K key, Long value, BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
        return merge((Object2LongMap<K>) key, (K) value, (BiFunction<? super K, ? super K, ? extends K>) remappingFunction);
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Object2LongMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2LongMap$Entry.class */
