...
public class Reference2BooleanOpenHashMap<K> extends AbstractReference2BooleanMap<K> implements Serializable, Cloneable, Hash {
    ...
    public Reference2BooleanOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new boolean[this.f2737n + 1];
        }
    }
    ...
    public boolean removeNullEntry() {
        ...
        boolean oldValue = this.value[this.f2737n];
        this.size--;
        if (this.f2737n > this.minN && this.size < this.maxFill / 4 && this.f2737n > 16) {
            rehash(this.f2737n / 2);
        }
    ...
    public boolean containsValue(boolean v) {
        ...
        K[] key = this.key;
        if (this.containsNullKey && value[this.f2737n] == v) {
            return true;
        }
        int i = this.f2737n;
        while (true) {
    ...
    public boolean remove(Object k, boolean v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f2737n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Reference2BooleanOpenHashMap.this.f2737n;
            this.last = -1;
            this.f2739c = Reference2BooleanOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Reference2BooleanOpenHashMap.this.f2737n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Reference2BooleanOpenHashMap.this.f2737n) {
                Reference2BooleanOpenHashMap.this.containsNullKey = false;
                Reference2BooleanOpenHashMap.this.key[Reference2BooleanOpenHashMap.this.f2737n] = null;
            } else if (this.pos >= 0) {
                shiftKeys(this.last);
            } else {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2BooleanOpenHashMap<K>.MapSpliterator> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Reference2BooleanOpenHashMap.this.f2737n;
            this.f2740c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2740c++;
                acceptOnIndex(action, Reference2BooleanOpenHashMap.this.f2737n);
                return true;
            }
            K[] key = Reference2BooleanOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Reference2BooleanOpenHashMap.this.size - this.f2740c);
            }
            return Math.min((long) (Reference2BooleanOpenHashMap.this.size - this.f2740c), ((long) ((((double) Reference2BooleanOpenHashMap.this.realSize()) / ((double) Reference2BooleanOpenHashMap.this.f2737n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Reference2BooleanMap.Entry<K>> implements Reference2BooleanMap.FastEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            if (key == null) {
                return Reference2BooleanOpenHashMap.this.containsNullKey && Reference2BooleanOpenHashMap.this.value[Reference2BooleanOpenHashMap.this.f2737n] == v;
            }
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Reference2BooleanOpenHashMap.this.containsNullKey || Reference2BooleanOpenHashMap.this.value[Reference2BooleanOpenHashMap.this.f2737n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
            if (Reference2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractReference2BooleanMap.BasicEntry(Reference2BooleanOpenHashMap.this.key[Reference2BooleanOpenHashMap.this.f2737n], Reference2BooleanOpenHashMap.this.value[Reference2BooleanOpenHashMap.this.f2737n]));
            }
            int pos = Reference2BooleanOpenHashMap.this.f2737n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
            ...
            if (Reference2BooleanOpenHashMap.this.containsNullKey) {
                entry.key = Reference2BooleanOpenHashMap.this.key[Reference2BooleanOpenHashMap.this.f2737n];
                entry.value = Reference2BooleanOpenHashMap.this.value[Reference2BooleanOpenHashMap.this.f2737n];
    ...
    public final class KeySet extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            if (Reference2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept((Object) Reference2BooleanOpenHashMap.this.key[Reference2BooleanOpenHashMap.this.f2737n]);
            }
            int pos = Reference2BooleanOpenHashMap.this.f2737n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection() { // from class: it.unimi.dsi.fastutil.objects.Reference2BooleanOpenHashMap.1
                ...
                public void forEach(BooleanConsumer consumer) {
                    if (Reference2BooleanOpenHashMap.this.containsNullKey) {
                        consumer.accept(Reference2BooleanOpenHashMap.this.value[Reference2BooleanOpenHashMap.this.f2737n]);
                    }
                    int pos = Reference2BooleanOpenHashMap.this.f2737n;
                    while (true) {
                        pos--;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += this.value[this.f2737n] ? RetcodeOuterClass.Retcode.RET_MP_OTHER_DATA_VERSION_NOT_LATEST_VALUE : RetcodeOuterClass.Retcode.RET_MP_MATCH_FULL_VALUE;
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        boolean[] value = new boolean[this.f2737n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
