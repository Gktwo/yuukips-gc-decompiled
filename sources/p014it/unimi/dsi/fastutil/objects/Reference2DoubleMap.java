...
/* renamed from: it.unimi.dsi.fastutil.objects.Reference2DoubleMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2DoubleMap.class */
public interface Reference2DoubleMap<K> extends Reference2DoubleFunction<K>, Map<K, Double> {
    ...
    /* bridge */ /* synthetic */ default Double merge(Object obj, Double d, BiFunction<? super Double, ? super Double, ? extends Double> biFunction) {
        return merge((Reference2DoubleMap<K>) obj, d, biFunction);
    }
    ...
    /* bridge */ /* synthetic */ default Double replace(Object obj, Double d) {
        return replace((Reference2DoubleMap<K>) obj, d);
    }
    ...
    /* bridge */ /* synthetic */ default boolean replace(Object obj, Double d, Double d2) {
        return replace((Reference2DoubleMap<K>) obj, d, d2);
    }
    ...
    /* bridge */ /* synthetic */ default Double putIfAbsent(Object obj, Double d) {
        return putIfAbsent((Reference2DoubleMap<K>) obj, d);
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2DoubleMap$FastEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2DoubleMap$FastEntrySet.class */
    ...
    default Double put(K key, Double value) {
        return put((Reference2DoubleMap<K>) key, value);
    }
    ...
    default void forEach(BiConsumer<? super K, ? super Double> consumer) {
        ObjectSet<Entry<K>> entrySet = reference2DoubleEntrySet();
    ...
    default double putIfAbsent(K key, double value) {
        ...
        put((Reference2DoubleMap<K>) key, value);
        return drv;
    }
    ...
    default boolean replace(K key, double oldValue, double newValue) {
        ...
        put((Reference2DoubleMap<K>) key, newValue);
        return true;
    }

    default double replace(K key, double value) {
        return containsKey(key) ? put((Reference2DoubleMap<K>) key, value) : defaultReturnValue();
    }
    ...
    default double computeDoubleIfAbsent(K key, ToDoubleFunction<? super K> mappingFunction) {
        return computeIfAbsent((Reference2DoubleMap<K>) key, (ToDoubleFunction<? super Reference2DoubleMap<K>>) mappingFunction);
    }
    ...
    default double computeDoubleIfAbsentPartial(K key, Reference2DoubleFunction<? super K> mappingFunction) {
        return computeIfAbsent((Reference2DoubleMap<K>) key, (Reference2DoubleFunction<? super Reference2DoubleMap<K>>) mappingFunction);
    }
    ...
    default double computeDoubleIfPresent(K key, BiFunction<? super K, ? super Double, ? extends Double> remappingFunction) {
        ...
        put((Reference2DoubleMap<K>) key, newVal);
        return newVal;
    }
    ...
    default double merge(K key, double value, BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
        ...
        put((Reference2DoubleMap<K>) key, c);
        return c;
    }
    ...
    default double mergeDouble(K r7, double r8, java.util.function.DoubleBinaryOperator r10) {
        ...
        L_0x0037:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.objects.Reference2DoubleMap.mergeDouble(java.lang.Object, double, java.util.function.DoubleBinaryOperator):double");
    }

    default double mergeDouble(K key, double value, DoubleBinaryOperator remappingFunction) {
        return mergeDouble((Reference2DoubleMap<K>) key, value, (java.util.function.DoubleBinaryOperator) remappingFunction);
    }

    @Deprecated
    default double mergeDouble(K key, double value, BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
        return merge((Reference2DoubleMap<K>) key, value, remappingFunction);
    }

    @Deprecated
    default Double putIfAbsent(K key, Double value) {
        return putIfAbsent((Reference2DoubleMap<K>) key, (K) value);
    }
    ...
    @Deprecated
    default boolean replace(K key, Double oldValue, Double newValue) {
        return replace((Reference2DoubleMap<K>) key, oldValue, newValue);
    }

    @Deprecated
    default Double replace(K key, Double value) {
        return replace((Reference2DoubleMap<K>) key, (K) value);
    }
    ...
    @Deprecated
    default Double merge(K key, Double value, BiFunction<? super Double, ? super Double, ? extends Double> remappingFunction) {
        return merge((Reference2DoubleMap<K>) key, (K) value, (BiFunction<? super K, ? super K, ? extends K>) remappingFunction);
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2DoubleMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2DoubleMap$Entry.class */
