...
import p014it.unimi.dsi.fastutil.objects.Reference2LongFunctions;
import p014it.unimi.dsi.fastutil.objects.Reference2LongMap;

/* renamed from: it.unimi.dsi.fastutil.objects.Reference2LongMaps */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2LongMaps.class */
public final class Reference2LongMaps {
    ...
    public static <K> ObjectIterable<Reference2LongMap.Entry<K>> fastIterable(Reference2LongMap<K> map) {
        ...
        return entries instanceof Reference2LongMap.FastEntrySet ? new ObjectIterable<Reference2LongMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Reference2LongMaps.1
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2LongMaps$EmptyMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2LongMaps$EmptyMap.class */
    public static class EmptyMap<K> extends Reference2LongFunctions.EmptyFunction<K> implements Reference2LongMap<K>, Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2LongFunctions.EmptyFunction, p014it.unimi.dsi.fastutil.objects.Reference2LongFunction
        public long getOrDefault(Object key, long defaultValue) {
            return defaultValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2LongFunctions.EmptyFunction, java.lang.Object
        public Object clone() {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2LongMaps$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2LongMaps$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2LongMaps$SynchronizedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2LongMaps$SynchronizedMap.class */
    public static class SynchronizedMap<K> extends Reference2LongFunctions.SynchronizedFunction<K> implements Reference2LongMap<K>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedMap(Reference2LongMap<K> m, Object sync) {
            super(m, sync);
            this.map = m;
        }

        /* access modifiers changed from: protected */
        public SynchronizedMap(Reference2LongMap<K> m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2LongFunctions.SynchronizedFunction, java.lang.Object
        public int hashCode() {
            int hashCode;
            synchronized (this.sync) {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2LongFunctions.SynchronizedFunction, p014it.unimi.dsi.fastutil.objects.Reference2LongFunction
        public long getOrDefault(Object key, long defaultValue) {
            long orDefault;
            synchronized (this.sync) {
        ...
        public long putIfAbsent(K key, long value) {
            long putIfAbsent;
            synchronized (this.sync) {
                putIfAbsent = this.map.putIfAbsent((Reference2LongMap<K>) key, value);
            }
            return putIfAbsent;
        }
        ...
        public long replace(K key, long value) {
            long replace;
            synchronized (this.sync) {
                replace = this.map.replace((Reference2LongMap<K>) key, value);
            }
            return replace;
        }
        ...
        public boolean replace(K key, long oldValue, long newValue) {
            boolean replace;
            synchronized (this.sync) {
                replace = this.map.replace((Reference2LongMap<K>) key, oldValue, newValue);
            }
            return replace;
        }
        ...
        public long computeIfAbsent(K key, ToLongFunction<? super K> mappingFunction) {
            ...
            synchronized (this.sync) {
                computeIfAbsent = this.map.computeIfAbsent((Reference2LongMap<K>) key, (ToLongFunction<? super Reference2LongMap<K>>) mappingFunction);
            }
        ...
        public long computeIfAbsent(K key, Reference2LongFunction<? super K> mappingFunction) {
            long computeIfAbsent;
            synchronized (this.sync) {
                computeIfAbsent = this.map.computeIfAbsent((Reference2LongMap<K>) key, (Reference2LongFunction<? super Reference2LongMap<K>>) mappingFunction);
            }
            return computeIfAbsent;
        }
        ...
        public long merge(K key, long value, BiFunction<? super Long, ? super Long, ? extends Long> remappingFunction) {
            long merge;
            synchronized (this.sync) {
                merge = this.map.merge((Reference2LongMap<K>) key, value, remappingFunction);
            }
            return merge;
        }
        ...
        public Long computeIfAbsent(K key, Function<? super K, ? extends Long> mappingFunction) {
            Long computeIfAbsent;
            synchronized (this.sync) {
                computeIfAbsent = this.map.computeIfAbsent((Reference2LongMap<K>) key, (Function<? super Reference2LongMap<K>, ? extends Long>) mappingFunction);
            }
            return computeIfAbsent;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2LongMaps$UnmodifiableMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2LongMaps$UnmodifiableMap.class */
    public static class UnmodifiableMap<K> extends Reference2LongFunctions.UnmodifiableFunction<K> implements Reference2LongMap<K>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableMap(Reference2LongMap<? extends K> m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2LongFunctions.UnmodifiableFunction, java.lang.Object
        public int hashCode() {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2LongFunctions.UnmodifiableFunction, p014it.unimi.dsi.fastutil.objects.Reference2LongFunction
        public long getOrDefault(Object key, long defaultValue) {
