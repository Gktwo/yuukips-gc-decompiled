...
/* renamed from: it.unimi.dsi.fastutil.objects.Object2ReferenceMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ReferenceMap.class */
public interface Object2ReferenceMap<K, V> extends Object2ReferenceFunction<K, V>, Map<K, V> {

    /* renamed from: it.unimi.dsi.fastutil.objects.Object2ReferenceMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ReferenceMap$Entry.class */
    ...
    @Override // p014it.unimi.dsi.fastutil.objects.Object2ReferenceSortedMap
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2ReferenceMap$FastEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ReferenceMap$FastEntrySet.class */
    ...
    default void forEach(BiConsumer<? super K, ? super V> consumer) {
        ObjectSet<Entry<K, V>> entrySet = object2ReferenceEntrySet();
    ...
    default V computeReferenceIfAbsentPartial(K key, Object2ReferenceFunction<? super K, ? extends V> mappingFunction) {
        return computeIfAbsent((Object2ReferenceMap<K, V>) key, (Object2ReferenceFunction<? super Object2ReferenceMap<K, V>, ? extends V>) mappingFunction);
    }
