...
/* renamed from: it.unimi.dsi.fastutil.objects.Object2CharFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2CharFunctions.class */
public final class Object2CharFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2CharFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2CharFunctions$EmptyFunction.class */
    public static class EmptyFunction<K> extends AbstractObject2CharFunction<K> implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObject2CharFunction, p014it.unimi.dsi.fastutil.objects.Object2CharFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2CharFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2CharFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2CharFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2CharFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction<K> implements Object2CharFunction<K>, Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Object2CharFunction, p014it.unimi.dsi.fastutil.Function
        @Deprecated
        public /* bridge */ /* synthetic */ Character put(Object obj, Character ch) {
            return put((SynchronizedFunction<K>) obj, ch);
        }

        /* access modifiers changed from: protected */
        public SynchronizedFunction(Object2CharFunction<K> f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Object2CharFunction<K> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Object2CharFunction, java.util.function.ToIntFunction
        ...
        public char put(K k, char v) {
            char put;
            synchronized (this.sync) {
                put = this.function.put((Object2CharFunction<K>) k, v);
            }
            return put;
        }
        ...
        public char removeChar(Object k) {
            char removeChar;
            synchronized (this.sync) {
                removeChar = this.function.removeChar(k);
            }
            return removeChar;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2CharFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2CharFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction<K> extends AbstractObject2CharFunction<K> implements Serializable {
        ...
        @Deprecated
        public /* bridge */ /* synthetic */ Character put(Object obj, Character ch) {
            return put((UnmodifiableFunction<K>) obj, ch);
        }

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Object2CharFunction<? extends K> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2CharFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2CharFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction<K> implements Object2CharFunction<K> {
        ...
        @Deprecated
        public /* bridge */ /* synthetic */ Character put(Object obj, Character ch) {
            return put((PrimitiveFunction<K>) obj, ch);
        }
    ...
    public static <K> Object2CharFunction<K> primitive(java.util.function.Function<? super K, ? extends Character> f) {
        ...
        return f instanceof Object2CharFunction ? (Object2CharFunction) f : f instanceof ToIntFunction ? key -> {
            return SafeMath.safeIntToChar(((ToIntFunction) f).applyAsInt(key));
