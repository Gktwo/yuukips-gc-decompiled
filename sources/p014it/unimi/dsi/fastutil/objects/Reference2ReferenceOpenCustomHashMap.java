...
public class Reference2ReferenceOpenCustomHashMap<K, V> extends AbstractReference2ReferenceMap<K, V> implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f2813n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f2814f;
    ...
    public Reference2ReferenceOpenCustomHashMap(int expected, float f, Hash.Strategy<? super K> strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f2813n = arraySize;
            this.minN = arraySize;
            this.mask = this.f2813n - 1;
            this.maxFill = HashCommon.maxFill(this.f2813n, f);
            this.key = (K[]) new Object[this.f2813n + 1];
            this.value = (V[]) new Object[this.f2813n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f2814f);
        if (needed > this.f2813n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f2814f)))));
        if (needed > this.f2813n) {
            rehash(needed);
        }
    }
    ...
    public V removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f2813n > this.minN && this.size < this.maxFill / 4 && this.f2813n > 16) {
            rehash(this.f2813n / 2);
        }
        return oldValue;
    }
    ...
    public V removeNullEntry() {
        ...
        this.key[this.f2813n] = null;
        V oldValue = this.value[this.f2813n];
        this.value[this.f2813n] = null;
        this.size--;
        if (this.f2813n > this.minN && this.size < this.maxFill / 4 && this.f2813n > 16) {
            rehash(this.f2813n / 2);
        }
    ...
    private int find(K k) {
        ...
        if (this.strategy.equals(k, null)) {
            return this.containsNullKey ? this.f2813n : -(this.f2813n + 1);
        }
        K[] key = this.key;
    ...
    private void insert(int pos, K k, V v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f2814f));
        }
    }
    ...
    public V get(Object k) {
        K curr;
        if (this.strategy.equals(k, null)) {
            return this.containsNullKey ? this.value[this.f2813n] : (V) this.defRetValue;
        }
        K[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(Object v) {
        V[] value = this.value;
        K[] key = this.key;
        if (this.containsNullKey && value[this.f2813n] == v) {
            return true;
        }
        int i = this.f2813n;
        while (true) {
    ...
    public V getOrDefault(Object k, V defaultValue) {
        K curr;
        if (this.strategy.equals(k, null)) {
            return this.containsNullKey ? this.value[this.f2813n] : defaultValue;
        }
        K[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(Object k, Object v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f2813n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Reference2ReferenceOpenCustomHashMap.this.f2813n;
            this.last = -1;
            this.f2815c = Reference2ReferenceOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Reference2ReferenceOpenCustomHashMap.this.f2813n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Reference2ReferenceOpenCustomHashMap.this.f2813n) {
                Reference2ReferenceOpenCustomHashMap.this.containsNullKey = false;
                Reference2ReferenceOpenCustomHashMap.this.key[Reference2ReferenceOpenCustomHashMap.this.f2813n] = null;
                Reference2ReferenceOpenCustomHashMap.this.value[Reference2ReferenceOpenCustomHashMap.this.f2813n] = null;
            } else if (this.pos >= 0) {
                shiftKeys(this.last);
            } else {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2ReferenceOpenCustomHashMap<K, V>.MapSpliterator> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Reference2ReferenceOpenCustomHashMap.this.f2813n;
            this.f2816c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2816c++;
                acceptOnIndex(action, Reference2ReferenceOpenCustomHashMap.this.f2813n);
                return true;
            }
            K[] key = Reference2ReferenceOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Reference2ReferenceOpenCustomHashMap.this.size - this.f2816c);
            }
            return Math.min((long) (Reference2ReferenceOpenCustomHashMap.this.size - this.f2816c), ((long) ((((double) Reference2ReferenceOpenCustomHashMap.this.realSize()) / ((double) Reference2ReferenceOpenCustomHashMap.this.f2813n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Reference2ReferenceMap.Entry<K, V>> implements Reference2ReferenceMap.FastEntrySet<K, V> {
        ...
        public boolean contains(Object o) {
            ...
            if (Reference2ReferenceOpenCustomHashMap.this.strategy.equals(key, null)) {
                return Reference2ReferenceOpenCustomHashMap.this.containsNullKey && Reference2ReferenceOpenCustomHashMap.this.value[Reference2ReferenceOpenCustomHashMap.this.f2813n] == value;
            }
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Reference2ReferenceOpenCustomHashMap.this.containsNullKey || Reference2ReferenceOpenCustomHashMap.this.value[Reference2ReferenceOpenCustomHashMap.this.f2813n] != value) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Reference2ReferenceMap.Entry<K, V>> consumer) {
            if (Reference2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractReference2ReferenceMap.BasicEntry(Reference2ReferenceOpenCustomHashMap.this.key[Reference2ReferenceOpenCustomHashMap.this.f2813n], Reference2ReferenceOpenCustomHashMap.this.value[Reference2ReferenceOpenCustomHashMap.this.f2813n]));
            }
            int pos = Reference2ReferenceOpenCustomHashMap.this.f2813n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Reference2ReferenceMap.Entry<K, V>> consumer) {
            ...
            if (Reference2ReferenceOpenCustomHashMap.this.containsNullKey) {
                entry.key = Reference2ReferenceOpenCustomHashMap.this.key[Reference2ReferenceOpenCustomHashMap.this.f2813n];
                entry.value = Reference2ReferenceOpenCustomHashMap.this.value[Reference2ReferenceOpenCustomHashMap.this.f2813n];
    ...
    public final class KeySet extends AbstractReferenceSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            if (Reference2ReferenceOpenCustomHashMap.this.containsNullKey) {
                consumer.accept((Object) Reference2ReferenceOpenCustomHashMap.this.key[Reference2ReferenceOpenCustomHashMap.this.f2813n]);
            }
            int pos = Reference2ReferenceOpenCustomHashMap.this.f2813n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.objects.Reference2ReferenceOpenCustomHashMap.1
                ...
                public void forEach(Consumer<? super V> consumer) {
                    if (Reference2ReferenceOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept((Object) Reference2ReferenceOpenCustomHashMap.this.value[Reference2ReferenceOpenCustomHashMap.this.f2813n]);
                    }
                    int pos = Reference2ReferenceOpenCustomHashMap.this.f2813n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f2814f)));
        if (l >= this.f2813n || this.size > HashCommon.maxFill(l, this.f2814f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2813n];
                this.f2813n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f2813n, this.f2814f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += this.value[this.f2813n] == null ? 0 : System.identityHashCode(this.value[this.f2813n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f2813n = HashCommon.arraySize(this.size, this.f2814f);
        this.maxFill = HashCommon.maxFill(this.f2813n, this.f2814f);
        this.mask = this.f2813n - 1;
        K[] key = (K[]) new Object[this.f2813n + 1];
        this.key = key;
        V[] value = (V[]) new Object[this.f2813n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
