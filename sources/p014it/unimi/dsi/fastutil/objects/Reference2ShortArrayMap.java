...
/* renamed from: it.unimi.dsi.fastutil.objects.Reference2ShortArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ShortArrayMap.class */
public class Reference2ShortArrayMap<K> extends AbstractReference2ShortMap<K> implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Reference2ShortArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Reference2ShortArrayMap(Reference2ShortMap<K> m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Reference2ShortMap.Entry<K>> it = m.reference2ShortEntrySet().iterator();
        while (it.hasNext()) {
            Reference2ShortMap.Entry<K> e = it.next();
            this.key[i] = e.getKey();
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ShortArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ShortArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Reference2ShortMap.Entry<K>> implements Reference2ShortMap.FastEntrySet<K> {
        private EntrySet() {
        }

        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
        public ObjectIterator<Reference2ShortMap.Entry<K>> iterator() {
            return new ObjectIterator<Reference2ShortMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Reference2ShortArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Reference2ShortMap.Entry<K> next() {
                    ...
                    Object[] objArr = Reference2ShortArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    Object obj = objArr[i];
                    short[] sArr = Reference2ShortArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractReference2ShortMap.BasicEntry(obj, sArr[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Reference2ShortArrayMap.access$010(Reference2ShortArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Reference2ShortMap.Entry<K>> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractReference2ShortMap.BasicEntry(obj, sArr[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Reference2ShortMap.Entry<K>> fastIterator() {
            return new ObjectIterator<Reference2ShortMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Reference2ShortArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Reference2ShortMap.Entry<K> next() {
                    ...
                    AbstractReference2ShortMap.BasicEntry<K> basicEntry = this.entry;
                    Object[] objArr = Reference2ShortArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = (K) objArr[i];
                    AbstractReference2ShortMap.BasicEntry<K> basicEntry2 = this.entry;
                    short[] sArr = Reference2ShortArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ShortArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ShortArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Reference2ShortMap.Entry<K>> implements ObjectSpliterator<Reference2ShortMap.Entry<K>> {
            ...
            public final Reference2ShortMap.Entry<K> get(int location) {
                return new AbstractReference2ShortMap.BasicEntry(Reference2ShortArrayMap.this.key[location], Reference2ShortArrayMap.this.value[location]);
            }

            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Reference2ShortArrayMap<K>.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
        ...
        public void forEach(Consumer<? super Reference2ShortMap.Entry<K>> action) {
            int max = Reference2ShortArrayMap.this.size;
            for (int i = 0; i < max; i++) {
                action.accept(new AbstractReference2ShortMap.BasicEntry(Reference2ShortArrayMap.this.key[i], Reference2ShortArrayMap.this.value[i]));
            }
        }
        ...
        public boolean contains(Object o) {
            ...
            Object key = e.getKey();
            return Reference2ShortArrayMap.this.containsKey(key) && Reference2ShortArrayMap.this.getShort(key) == ((Short) e.getValue()).shortValue();
        }
        ...
        public boolean remove(Object o) {
            ...
            int oldPos = Reference2ShortArrayMap.this.findKey(key);
            ...
            Reference2ShortArrayMap.access$010(Reference2ShortArrayMap.this);
            Reference2ShortArrayMap.this.key[Reference2ShortArrayMap.this.size] = null;
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ShortArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ShortArrayMap$KeySet.class */
    public final class KeySet extends AbstractReferenceSet<K> {
        ...
        public ObjectIterator<K> iterator() {
            return new ObjectIterator<K>() { // from class: it.unimi.dsi.fastutil.objects.Reference2ShortArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ShortArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ShortArrayMap$KeySet$KeySetSpliterator.class */
        public final class KeySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<K> implements ObjectSpliterator<K> {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Reference2ShortArrayMap<K>.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ShortArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ShortArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractShortCollection {
        ...
        public ShortIterator iterator() {
            return new ShortIterator() { // from class: it.unimi.dsi.fastutil.objects.Reference2ShortArrayMap.ValuesCollection.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ShortArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ShortArrayMap$ValuesCollection$ValuesSpliterator.class */
        public final class ValuesSpliterator extends ShortSpliterators.EarlyBindingSizeIndexBasedSpliterator implements ShortSpliterator {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.shorts.ShortSpliterators.AbstractIndexBasedSpliterator
            public final Reference2ShortArrayMap<K>.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
    ...
    public Reference2ShortArrayMap<K> clone() {
        try {
            Reference2ShortArrayMap<K> c = (Reference2ShortArrayMap) clone();
