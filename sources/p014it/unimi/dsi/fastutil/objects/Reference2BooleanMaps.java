...
import p014it.unimi.dsi.fastutil.objects.Reference2BooleanFunctions;
import p014it.unimi.dsi.fastutil.objects.Reference2BooleanMap;

/* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanMaps */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanMaps.class */
public final class Reference2BooleanMaps {
    ...
    public static <K> ObjectIterable<Reference2BooleanMap.Entry<K>> fastIterable(Reference2BooleanMap<K> map) {
        ...
        return entries instanceof Reference2BooleanMap.FastEntrySet ? new ObjectIterable<Reference2BooleanMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Reference2BooleanMaps.1
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanMaps$EmptyMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanMaps$EmptyMap.class */
    public static class EmptyMap<K> extends Reference2BooleanFunctions.EmptyFunction<K> implements Reference2BooleanMap<K>, Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanFunctions.EmptyFunction, p014it.unimi.dsi.fastutil.objects.Reference2BooleanFunction
        public boolean getOrDefault(Object key, boolean defaultValue) {
            return defaultValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanFunctions.EmptyFunction, java.lang.Object
        public Object clone() {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanMaps$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanMaps$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanMaps$SynchronizedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanMaps$SynchronizedMap.class */
    public static class SynchronizedMap<K> extends Reference2BooleanFunctions.SynchronizedFunction<K> implements Reference2BooleanMap<K>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedMap(Reference2BooleanMap<K> m, Object sync) {
            super(m, sync);
            this.map = m;
        }

        /* access modifiers changed from: protected */
        public SynchronizedMap(Reference2BooleanMap<K> m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanFunctions.SynchronizedFunction, java.lang.Object
        public int hashCode() {
            int hashCode;
            synchronized (this.sync) {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanFunctions.SynchronizedFunction, p014it.unimi.dsi.fastutil.objects.Reference2BooleanFunction
        public boolean getOrDefault(Object key, boolean defaultValue) {
            boolean orDefault;
            synchronized (this.sync) {
        ...
        public boolean putIfAbsent(K key, boolean value) {
            boolean putIfAbsent;
            synchronized (this.sync) {
                putIfAbsent = this.map.putIfAbsent((Reference2BooleanMap<K>) key, value);
            }
            return putIfAbsent;
        }
        ...
        public boolean replace(K key, boolean value) {
            boolean replace;
            synchronized (this.sync) {
                replace = this.map.replace((Reference2BooleanMap<K>) key, value);
            }
            return replace;
        }
        ...
        public boolean replace(K key, boolean oldValue, boolean newValue) {
            boolean replace;
            synchronized (this.sync) {
                replace = this.map.replace((Reference2BooleanMap<K>) key, oldValue, newValue);
            }
            return replace;
        }
        ...
        public boolean computeIfAbsent(K key, Predicate<? super K> mappingFunction) {
            ...
            synchronized (this.sync) {
                computeIfAbsent = this.map.computeIfAbsent((Reference2BooleanMap<K>) key, (Predicate<? super Reference2BooleanMap<K>>) mappingFunction);
            }
        ...
        public boolean computeIfAbsent(K key, Reference2BooleanFunction<? super K> mappingFunction) {
            boolean computeIfAbsent;
            synchronized (this.sync) {
                computeIfAbsent = this.map.computeIfAbsent((Reference2BooleanMap<K>) key, (Reference2BooleanFunction<? super Reference2BooleanMap<K>>) mappingFunction);
            }
            return computeIfAbsent;
        }
        ...
        public boolean merge(K key, boolean value, BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
            boolean merge;
            synchronized (this.sync) {
                merge = this.map.merge((Reference2BooleanMap<K>) key, value, remappingFunction);
            }
            return merge;
        }
        ...
        public Boolean replace(K key, Boolean value) {
            Boolean replace;
            synchronized (this.sync) {
                replace = this.map.replace((Reference2BooleanMap<K>) key, (K) value);
            }
            return replace;
        }
        ...
        public Boolean putIfAbsent(K key, Boolean value) {
            Boolean putIfAbsent;
            synchronized (this.sync) {
                putIfAbsent = this.map.putIfAbsent((Reference2BooleanMap<K>) key, (K) value);
            }
            return putIfAbsent;
        }
        ...
        public Boolean computeIfAbsent(K key, Function<? super K, ? extends Boolean> mappingFunction) {
            Boolean computeIfAbsent;
            synchronized (this.sync) {
                computeIfAbsent = this.map.computeIfAbsent((Reference2BooleanMap<K>) key, (Function<? super Reference2BooleanMap<K>, ? extends Boolean>) mappingFunction);
            }
            return computeIfAbsent;
        }
        ...
        public Boolean merge(K key, Boolean value, BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
            Boolean merge;
            synchronized (this.sync) {
                merge = this.map.merge((Reference2BooleanMap<K>) key, (K) value, (BiFunction<? super K, ? super K, ? extends K>) remappingFunction);
            }
            return merge;
        }
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanMaps$UnmodifiableMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanMaps$UnmodifiableMap.class */
    public static class UnmodifiableMap<K> extends Reference2BooleanFunctions.UnmodifiableFunction<K> implements Reference2BooleanMap<K>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableMap(Reference2BooleanMap<? extends K> m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanFunctions.UnmodifiableFunction, java.lang.Object
        public int hashCode() {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanFunctions.UnmodifiableFunction, p014it.unimi.dsi.fastutil.objects.Reference2BooleanFunction
        public boolean getOrDefault(Object key, boolean defaultValue) {
