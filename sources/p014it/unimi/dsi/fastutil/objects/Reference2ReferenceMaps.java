...
import p014it.unimi.dsi.fastutil.objects.Reference2ReferenceFunctions;
import p014it.unimi.dsi.fastutil.objects.Reference2ReferenceMap;

/* renamed from: it.unimi.dsi.fastutil.objects.Reference2ReferenceMaps */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ReferenceMaps.class */
public final class Reference2ReferenceMaps {
    ...
    public static <K, V> ObjectIterable<Reference2ReferenceMap.Entry<K, V>> fastIterable(Reference2ReferenceMap<K, V> map) {
        ...
        return entries instanceof Reference2ReferenceMap.FastEntrySet ? new ObjectIterable<Reference2ReferenceMap.Entry<K, V>>() { // from class: it.unimi.dsi.fastutil.objects.Reference2ReferenceMaps.1
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectIterable, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection
            public ObjectIterator<Reference2ReferenceMap.Entry<K, V>> iterator() {
                return ((Reference2ReferenceMap.FastEntrySet) ObjectSet.this).fastIterator();
            }
            ...
            public void forEach(Consumer<? super Reference2ReferenceMap.Entry<K, V>> consumer) {
                ((Reference2ReferenceMap.FastEntrySet) ObjectSet.this).fastForEach(consumer);
            }
        } : entries;
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ReferenceMaps$EmptyMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ReferenceMaps$EmptyMap.class */
    public static class EmptyMap<K, V> extends Reference2ReferenceFunctions.EmptyFunction<K, V> implements Reference2ReferenceMap<K, V>, Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2ReferenceFunctions.EmptyFunction, p014it.unimi.dsi.fastutil.objects.Reference2ReferenceFunction, p014it.unimi.dsi.fastutil.Function
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2ReferenceFunctions.EmptyFunction, java.lang.Object
        public Object clone() {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ReferenceMaps$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ReferenceMaps$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ReferenceMaps$SynchronizedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ReferenceMaps$SynchronizedMap.class */
    public static class SynchronizedMap<K, V> extends Reference2ReferenceFunctions.SynchronizedFunction<K, V> implements Reference2ReferenceMap<K, V>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedMap(Reference2ReferenceMap<K, V> m, Object sync) {
            super(m, sync);
            this.map = m;
        }

        /* access modifiers changed from: protected */
        public SynchronizedMap(Reference2ReferenceMap<K, V> m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2ReferenceMap
        public ObjectSet<Reference2ReferenceMap.Entry<K, V>> reference2ReferenceEntrySet() {
            ObjectSet<Reference2ReferenceMap.Entry<K, V>> objectSet;
            synchronized (this.sync) {
                if (this.entries == null) {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2ReferenceFunctions.SynchronizedFunction, java.lang.Object
        public int hashCode() {
            int hashCode;
            synchronized (this.sync) {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2ReferenceFunctions.SynchronizedFunction, p014it.unimi.dsi.fastutil.objects.Reference2ReferenceFunction, p014it.unimi.dsi.fastutil.Function
        public V getOrDefault(Object key, V defaultValue) {
            V orDefault;
            synchronized (this.sync) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ReferenceMaps$UnmodifiableMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ReferenceMaps$UnmodifiableMap.class */
    public static class UnmodifiableMap<K, V> extends Reference2ReferenceFunctions.UnmodifiableFunction<K, V> implements Reference2ReferenceMap<K, V>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableMap(Reference2ReferenceMap<? extends K, ? extends V> m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2ReferenceFunctions.UnmodifiableFunction, java.lang.Object
        public int hashCode() {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2ReferenceFunctions.UnmodifiableFunction, p014it.unimi.dsi.fastutil.objects.Reference2ReferenceFunction, p014it.unimi.dsi.fastutil.Function
        public V getOrDefault(Object key, V defaultValue) {
