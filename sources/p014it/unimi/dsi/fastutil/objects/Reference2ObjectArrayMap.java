...
/* renamed from: it.unimi.dsi.fastutil.objects.Reference2ObjectArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ObjectArrayMap.class */
public class Reference2ObjectArrayMap<K, V> extends AbstractReference2ObjectMap<K, V> implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Reference2ObjectArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Reference2ObjectArrayMap(Reference2ObjectMap<K, V> m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Reference2ObjectMap.Entry<K, V>> it = m.reference2ObjectEntrySet().iterator();
        while (it.hasNext()) {
            Reference2ObjectMap.Entry<K, V> e = it.next();
            this.key[i] = e.getKey();
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ObjectArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ObjectArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Reference2ObjectMap.Entry<K, V>> implements Reference2ObjectMap.FastEntrySet<K, V> {
        private EntrySet() {
        }

        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
        public ObjectIterator<Reference2ObjectMap.Entry<K, V>> iterator() {
            return new ObjectIterator<Reference2ObjectMap.Entry<K, V>>() { // from class: it.unimi.dsi.fastutil.objects.Reference2ObjectArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Reference2ObjectMap.Entry<K, V> next() {
                    ...
                    Object[] objArr = Reference2ObjectArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    Object obj = objArr[i];
                    Object[] objArr2 = Reference2ObjectArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractReference2ObjectMap.BasicEntry(obj, objArr2[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Reference2ObjectArrayMap.access$010(Reference2ObjectArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Reference2ObjectMap.Entry<K, V>> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractReference2ObjectMap.BasicEntry(obj, objArr2[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Reference2ObjectMap.Entry<K, V>> fastIterator() {
            return new ObjectIterator<Reference2ObjectMap.Entry<K, V>>() { // from class: it.unimi.dsi.fastutil.objects.Reference2ObjectArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Reference2ObjectMap.Entry<K, V> next() {
                    ...
                    AbstractReference2ObjectMap.BasicEntry<K, V> basicEntry = this.entry;
                    Object[] objArr = Reference2ObjectArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = (K) objArr[i];
                    AbstractReference2ObjectMap.BasicEntry<K, V> basicEntry2 = this.entry;
                    Object[] objArr2 = Reference2ObjectArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ObjectArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ObjectArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Reference2ObjectMap.Entry<K, V>> implements ObjectSpliterator<Reference2ObjectMap.Entry<K, V>> {
            ...
            public final Reference2ObjectMap.Entry<K, V> get(int location) {
                return new AbstractReference2ObjectMap.BasicEntry(Reference2ObjectArrayMap.this.key[location], Reference2ObjectArrayMap.this.value[location]);
            }

            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Reference2ObjectArrayMap<K, V>.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
        ...
        public void forEach(Consumer<? super Reference2ObjectMap.Entry<K, V>> action) {
            int max = Reference2ObjectArrayMap.this.size;
            for (int i = 0; i < max; i++) {
                action.accept(new AbstractReference2ObjectMap.BasicEntry(Reference2ObjectArrayMap.this.key[i], Reference2ObjectArrayMap.this.value[i]));
            }
        }
        ...
        public boolean contains(Object o) {
            ...
            Object key = e.getKey();
            return Reference2ObjectArrayMap.this.containsKey(key) && Objects.equals(Reference2ObjectArrayMap.this.get(key), e.getValue());
        }
        ...
        public boolean remove(Object o) {
            ...
            int oldPos = Reference2ObjectArrayMap.this.findKey(key);
            if (oldPos == -1 || !Objects.equals(value, Reference2ObjectArrayMap.this.value[oldPos])) {
                return false;
            }
            ...
            Reference2ObjectArrayMap.access$010(Reference2ObjectArrayMap.this);
            Reference2ObjectArrayMap.this.key[Reference2ObjectArrayMap.this.size] = null;
            Reference2ObjectArrayMap.this.value[Reference2ObjectArrayMap.this.size] = null;
            return true;
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ObjectArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ObjectArrayMap$KeySet.class */
    public final class KeySet extends AbstractReferenceSet<K> {
        ...
        public ObjectIterator<K> iterator() {
            return new ObjectIterator<K>() { // from class: it.unimi.dsi.fastutil.objects.Reference2ObjectArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ObjectArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ObjectArrayMap$KeySet$KeySetSpliterator.class */
        public final class KeySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<K> implements ObjectSpliterator<K> {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Reference2ObjectArrayMap<K, V>.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ObjectArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ObjectArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractObjectCollection<V> {
        ...
        public ObjectIterator<V> iterator() {
            return new ObjectIterator<V>() { // from class: it.unimi.dsi.fastutil.objects.Reference2ObjectArrayMap.ValuesCollection.1
                int pos = 0;
                ...
                public V next() {
                    ...
                    Object[] objArr = Reference2ObjectArrayMap.this.value;
                    int i = this.pos;
                    this.pos = i + 1;
                    return (V) objArr[i];
                }
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ObjectArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ObjectArrayMap$ValuesCollection$ValuesSpliterator.class */
        public final class ValuesSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<V> implements ObjectSpliterator<V> {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Reference2ObjectArrayMap<K, V>.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
    ...
    public Reference2ObjectArrayMap<K, V> clone() {
        try {
            Reference2ObjectArrayMap<K, V> c = (Reference2ObjectArrayMap) clone();
