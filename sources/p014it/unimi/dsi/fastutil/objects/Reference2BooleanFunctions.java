...
/* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanFunctions.class */
public final class Reference2BooleanFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanFunctions$EmptyFunction.class */
    public static class EmptyFunction<K> extends AbstractReference2BooleanFunction<K> implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.AbstractReference2BooleanFunction, p014it.unimi.dsi.fastutil.objects.Reference2BooleanFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction<K> implements Reference2BooleanFunction<K>, Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanFunction, p014it.unimi.dsi.fastutil.Function
        @Deprecated
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Reference2BooleanFunction<K> f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Reference2BooleanFunction<K> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanFunction, java.util.function.Predicate
        ...
        public boolean put(K k, boolean v) {
            boolean put;
            synchronized (this.sync) {
                put = this.function.put((Reference2BooleanFunction<K>) k, v);
            }
            return put;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction<K> extends AbstractReference2BooleanFunction<K> implements Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Reference2BooleanFunction<? extends K> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanFunctions$PrimitiveFunction.class */
    ...
    public static <K> Reference2BooleanFunction<K> primitive(java.util.function.Function<? super K, ? extends Boolean> f) {
        ...
        return f instanceof Reference2BooleanFunction ? (Reference2BooleanFunction) f : f instanceof Predicate ? key -> {
