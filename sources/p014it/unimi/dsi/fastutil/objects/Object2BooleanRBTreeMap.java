...
/* renamed from: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2BooleanRBTreeMap.class */
public class Object2BooleanRBTreeMap<K> extends AbstractObject2BooleanSortedMap<K> implements Serializable, Cloneable {
    ...
    public Object2BooleanRBTreeMap(K[] k, boolean[] v, Comparator<? super K> c) {
        ...
        for (int i = 0; i < k.length; i++) {
            put((Object2BooleanRBTreeMap<K>) k[i], v[i]);
        }
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap<K> */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r8v0, resolved type: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap<K> */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    private p014it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap.Entry<K> add(K r9) {
        /*
        // Method dump skipped, instructions count: 940
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap.add(java.lang.Object):it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap$Entry");
    }

    /* JADX DEBUG: Multi-variable search result rejected for r6v0, resolved type: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap<K> */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    public boolean removeBoolean(java.lang.Object r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap.removeBoolean(java.lang.Object):boolean");
    }
    ...
    public boolean containsValue(boolean v) {
        Object2BooleanRBTreeMap<K>.ValueIterator i = new ValueIterator();
        int j = this.count;
        do {
            j--;
            if (j == 0) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2BooleanRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2BooleanRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap */
        /* JADX WARN: Multi-variable type inference failed */
        TreeIterator(K k) {
            Entry<K> locateKey = Object2BooleanRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2BooleanRBTreeMap$EntryIterator.class */
    public class EntryIterator extends Object2BooleanRBTreeMap<K>.TreeIterator implements ObjectListIterator<Object2BooleanMap.Entry<K>> {
        EntryIterator() {
            super();
        }
    ...
    public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap.1
                final Comparator<? super Object2BooleanMap.Entry<K>> comparator;

                {
                    this.comparator = Object2BooleanRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                /* JADX DEBUG: Multi-variable search result rejected for r0v17, resolved type: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap */
                /* JADX WARN: Multi-variable type inference failed */
                ...
                public boolean contains(Object o) {
                    ...
                    return e.equals(Object2BooleanRBTreeMap.this.findKey(e.getKey()));
                }

                /* JADX DEBUG: Multi-variable search result rejected for r0v14, resolved type: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap */
                /* JADX WARN: Multi-variable type inference failed */
                @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getValue() == null || !(e.getValue() instanceof Boolean) || (f = Object2BooleanRBTreeMap.this.findKey(e.getKey())) == null || f.getBooleanValue() != ((Boolean) e.getValue()).booleanValue()) {
                        return false;
                    }
                ...
                public ObjectSortedSet<Object2BooleanMap.Entry<K>> subSet(Object2BooleanMap.Entry<K> from, Object2BooleanMap.Entry<K> to) {
                    return Object2BooleanRBTreeMap.this.subMap((Object) from.getKey(), (Object) to.getKey()).object2BooleanEntrySet();
                }

                public ObjectSortedSet<Object2BooleanMap.Entry<K>> headSet(Object2BooleanMap.Entry<K> to) {
                    return Object2BooleanRBTreeMap.this.headMap((Object2BooleanRBTreeMap) to.getKey()).object2BooleanEntrySet();
                }

                public ObjectSortedSet<Object2BooleanMap.Entry<K>> tailSet(Object2BooleanMap.Entry<K> from) {
                    return Object2BooleanRBTreeMap.this.tailMap((Object2BooleanRBTreeMap) from.getKey()).object2BooleanEntrySet();
                }
            };
        }
        return this.entries;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2BooleanRBTreeMap$KeyIterator.class */
    public final class KeyIterator extends Object2BooleanRBTreeMap<K>.TreeIterator implements ObjectListIterator<K> {
        public KeyIterator() {
            super();
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2BooleanRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2BooleanRBTreeMap$ValueIterator.class */
    public final class ValueIterator extends Object2BooleanRBTreeMap<K>.TreeIterator implements BooleanListIterator {
    ...
    public BooleanCollection values() {
        if (this.values == null) {
            this.values = new AbstractBooleanCollection() { // from class: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2BooleanRBTreeMap$Submap.class */
    public final class Submap extends AbstractObject2BooleanSortedMap<K> implements Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.Function, p014it.unimi.dsi.fastutil.bytes.Byte2BooleanMap, java.util.Map
        public void clear() {
            Object2BooleanRBTreeMap<K>.Submap.SubmapIterator i = new SubmapIterator();
            while (i.hasNext()) {
                i.nextEntry();
                i.remove();
            }
        ...
        public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.ObjectSortedSet
                    public /* bridge */ /* synthetic */ ObjectBidirectionalIterator iterator(Object obj) {
                        return iterator((Object2BooleanMap.Entry) ((Object2BooleanMap.Entry) obj));
                    }
                    ...
                    /* JADX DEBUG: Multi-variable search result rejected for r0v13, resolved type: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap */
                    /* JADX DEBUG: Multi-variable search result rejected for r0v18, resolved type: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap$Submap */
                    /* JADX WARN: Multi-variable type inference failed */
                    @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
                    public boolean contains(Object o) {
                        Entry<K> f;
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getValue() != null && (e.getValue() instanceof Boolean) && (f = Object2BooleanRBTreeMap.this.findKey(e.getKey())) != null && Submap.this.m605in(f.key) && e.equals(f);
                    }

                    /* JADX DEBUG: Multi-variable search result rejected for r0v13, resolved type: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap */
                    /* JADX DEBUG: Multi-variable search result rejected for r0v20, resolved type: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap$Submap */
                    /* JADX WARN: Multi-variable type inference failed */
                    @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
                    public boolean remove(Object o) {
                        if (!(o instanceof Map.Entry)) {
                        ...
                        Entry<K> f = Object2BooleanRBTreeMap.this.findKey(e.getKey());
                        if (f != null && Submap.this.m605in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2BooleanRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractObject2BooleanSortedMap<K>.KeySet {
            private KeySet() {
                super();
            }
        ...
        public BooleanCollection values() {
            if (this.values == null) {
                this.values = new AbstractBooleanCollection() { // from class: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.booleans.AbstractBooleanCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.booleans.BooleanCollection, p014it.unimi.dsi.fastutil.booleans.BooleanIterable, p014it.unimi.dsi.fastutil.booleans.BooleanBigList
                    public BooleanIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObject2BooleanMap, p014it.unimi.dsi.fastutil.Function
        public boolean containsKey(Object k) {
            return k != null && m605in(k) && Object2BooleanRBTreeMap.this.containsKey(k);
        }
        ...
        public boolean getBoolean(Object k) {
            Entry<K> e;
            return (!m605in(k) || (e = Object2BooleanRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public boolean removeBoolean(Object k) {
            ...
            return Object2BooleanRBTreeMap.this.modified ? Object2BooleanRBTreeMap.this.removeBoolean(k) : this.defRetValue;
        }
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r0v18, resolved type: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap */
        /* JADX WARN: Multi-variable type inference failed */
        ...
        public Entry<K> lastEntry() {
            ...
            if (this.bottom || Object2BooleanRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2BooleanRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends Object2BooleanRBTreeMap<K>.TreeIterator {
            SubmapIterator() {
                super();
                this.next = Submap.this.firstEntry();
            }

            /* JADX DEBUG: Multi-variable search result rejected for r0v9, resolved type: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap */
            /* JADX DEBUG: Multi-variable search result rejected for r0v15, resolved type: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap */
            /* JADX DEBUG: Multi-variable search result rejected for r0v19, resolved type: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap */
            /* JADX WARN: Multi-variable type inference failed */
            SubmapIterator(Submap submap, K k) {
                ...
                if (submap.bottom || Object2BooleanRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Object2BooleanRBTreeMap object2BooleanRBTreeMap = Object2BooleanRBTreeMap.this;
                        Entry<K> lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (object2BooleanRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            /* JADX DEBUG: Multi-variable search result rejected for r0v8, resolved type: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap */
            /* JADX WARN: Multi-variable type inference failed */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2BooleanRBTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends Object2BooleanRBTreeMap<K>.Submap.SubmapIterator implements ObjectListIterator<Object2BooleanMap.Entry<K>> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2BooleanRBTreeMap$Submap$SubmapKeyIterator.class */
        public final class SubmapKeyIterator extends Object2BooleanRBTreeMap<K>.Submap.SubmapIterator implements ObjectListIterator<K> {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Object2BooleanRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2BooleanRBTreeMap$Submap$SubmapValueIterator.class */
        public final class SubmapValueIterator extends Object2BooleanRBTreeMap<K>.Submap.SubmapIterator implements BooleanListIterator {
    ...
    public Object2BooleanRBTreeMap<K> clone() {
        try {
            Object2BooleanRBTreeMap<K> c = (Object2BooleanRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        int n = this.count;
        Object2BooleanRBTreeMap<K>.EntryIterator i = new EntryIterator();
