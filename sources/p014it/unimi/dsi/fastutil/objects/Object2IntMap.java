...
/* renamed from: it.unimi.dsi.fastutil.objects.Object2IntMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntMap.class */
public interface Object2IntMap<K> extends Object2IntFunction<K>, Map<K, Integer> {
    ...
    @Override // p014it.unimi.dsi.fastutil.objects.Object2IntSortedMap
    ...
    /* bridge */ /* synthetic */ default Integer merge(Object obj, Integer num, BiFunction<? super Integer, ? super Integer, ? extends Integer> biFunction) {
        return merge((Object2IntMap<K>) obj, num, biFunction);
    }
    ...
    /* bridge */ /* synthetic */ default Integer replace(Object obj, Integer num) {
        return replace((Object2IntMap<K>) obj, num);
    }
    ...
    /* bridge */ /* synthetic */ default boolean replace(Object obj, Integer num, Integer num2) {
        return replace((Object2IntMap<K>) obj, num, num2);
    }
    ...
    /* bridge */ /* synthetic */ default Integer putIfAbsent(Object obj, Integer num) {
        return putIfAbsent((Object2IntMap<K>) obj, num);
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntMap$FastEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntMap$FastEntrySet.class */
    ...
    default Integer put(K key, Integer value) {
        return put((Object2IntMap<K>) key, value);
    }
    ...
    default Integer putIfAbsent(K key, Integer value) {
        return putIfAbsent((Object2IntMap<K>) key, (K) value);
    }
    ...
    default boolean replace(K key, Integer oldValue, Integer newValue) {
        return replace((Object2IntMap<K>) key, oldValue, newValue);
    }

    @Deprecated
    default Integer replace(K key, Integer value) {
        return replace((Object2IntMap<K>) key, (K) value);
    }
    ...
    default Integer merge(K key, Integer value, BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
        return merge((Object2IntMap<K>) key, (K) value, (BiFunction<? super K, ? super K, ? extends K>) remappingFunction);
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntMap$Entry.class */
