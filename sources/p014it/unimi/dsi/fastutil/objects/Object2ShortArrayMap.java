...
/* renamed from: it.unimi.dsi.fastutil.objects.Object2ShortArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ShortArrayMap.class */
public class Object2ShortArrayMap<K> extends AbstractObject2ShortMap<K> implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Object2ShortArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Object2ShortArrayMap(Object2ShortMap<K> m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Object2ShortMap.Entry<K>> it = m.object2ShortEntrySet().iterator();
        while (it.hasNext()) {
            Object2ShortMap.Entry<K> e = it.next();
            this.key[i] = e.getKey();
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2ShortArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ShortArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Object2ShortMap.Entry<K>> implements Object2ShortMap.FastEntrySet<K> {
        ...
        public ObjectIterator<Object2ShortMap.Entry<K>> iterator() {
            return new ObjectIterator<Object2ShortMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Object2ShortArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Object2ShortMap.Entry<K> next() {
                    ...
                    Object[] objArr = Object2ShortArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    Object obj = objArr[i];
                    ...
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractObject2ShortMap.BasicEntry(obj, sArr[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Object2ShortArrayMap.access$010(Object2ShortArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Object2ShortMap.Entry<K>> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractObject2ShortMap.BasicEntry(obj, sArr[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Object2ShortMap.Entry<K>> fastIterator() {
            return new ObjectIterator<Object2ShortMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Object2ShortArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Object2ShortMap.Entry<K> next() {
                    ...
                    AbstractObject2ShortMap.BasicEntry<K> basicEntry2 = this.entry;
                    short[] sArr = Object2ShortArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.objects.Object2ShortArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ShortArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Object2ShortMap.Entry<K>> implements ObjectSpliterator<Object2ShortMap.Entry<K>> {
            ...
            public final Object2ShortMap.Entry<K> get(int location) {
                return new AbstractObject2ShortMap.BasicEntry(Object2ShortArrayMap.this.key[location], Object2ShortArrayMap.this.value[location]);
            }

            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Object2ShortArrayMap<K>.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
        ...
        public void forEach(Consumer<? super Object2ShortMap.Entry<K>> action) {
            int max = Object2ShortArrayMap.this.size;
            for (int i = 0; i < max; i++) {
                action.accept(new AbstractObject2ShortMap.BasicEntry(Object2ShortArrayMap.this.key[i], Object2ShortArrayMap.this.value[i]));
            }
        }
        ...
        public boolean contains(Object o) {
            ...
            Object key = e.getKey();
            return Object2ShortArrayMap.this.containsKey(key) && Object2ShortArrayMap.this.getShort(key) == ((Short) e.getValue()).shortValue();
        }
        ...
        public boolean remove(Object o) {
            ...
            int oldPos = Object2ShortArrayMap.this.findKey(key);
            ...
            Object2ShortArrayMap.access$010(Object2ShortArrayMap.this);
            Object2ShortArrayMap.this.key[Object2ShortArrayMap.this.size] = null;
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2ShortArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ShortArrayMap$KeySet.class */
    public final class KeySet extends AbstractObjectSet<K> {
        ...
        public ObjectIterator<K> iterator() {
            return new ObjectIterator<K>() { // from class: it.unimi.dsi.fastutil.objects.Object2ShortArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Object2ShortArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ShortArrayMap$KeySet$KeySetSpliterator.class */
        public final class KeySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<K> implements ObjectSpliterator<K> {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Object2ShortArrayMap<K>.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2ShortArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ShortArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractShortCollection {
        ...
        public ShortIterator iterator() {
            return new ShortIterator() { // from class: it.unimi.dsi.fastutil.objects.Object2ShortArrayMap.ValuesCollection.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Object2ShortArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ShortArrayMap$ValuesCollection$ValuesSpliterator.class */
        public final class ValuesSpliterator extends ShortSpliterators.EarlyBindingSizeIndexBasedSpliterator implements ShortSpliterator {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.shorts.ShortSpliterators.AbstractIndexBasedSpliterator
            public final Object2ShortArrayMap<K>.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
    ...
    public Object2ShortArrayMap<K> clone() {
        try {
            Object2ShortArrayMap<K> c = (Object2ShortArrayMap) clone();
