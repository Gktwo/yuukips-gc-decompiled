...
/* renamed from: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2DoubleAVLTreeMap.class */
public class Object2DoubleAVLTreeMap<K> extends AbstractObject2DoubleSortedMap<K> implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Object2DoubleAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    public Object2DoubleAVLTreeMap(K[] k, double[] v, Comparator<? super K> c) {
        ...
        for (int i = 0; i < k.length; i++) {
            put((Object2DoubleAVLTreeMap<K>) k[i], v[i]);
        }
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap<K> */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r9v0, resolved type: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap<K> */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    public double removeDouble(java.lang.Object r5) {
        /*
        // Method dump skipped, instructions count: 1494
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap.removeDouble(java.lang.Object):double");
    }
    ...
    public boolean containsValue(double v) {
        Object2DoubleAVLTreeMap<K>.ValueIterator i = new ValueIterator();
        int j = this.count;
        do {
            j--;
            if (j == 0) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2DoubleAVLTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2DoubleAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap */
        /* JADX WARN: Multi-variable type inference failed */
        TreeIterator(K k) {
            Entry<K> locateKey = Object2DoubleAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2DoubleAVLTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap.1
                final Comparator<? super Object2DoubleMap.Entry<K>> comparator;

                {
                    this.comparator = Object2DoubleAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                /* JADX DEBUG: Multi-variable search result rejected for r0v17, resolved type: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap */
                /* JADX WARN: Multi-variable type inference failed */
                ...
                public boolean contains(Object o) {
                    ...
                    return e.equals(Object2DoubleAVLTreeMap.this.findKey(e.getKey()));
                }

                /* JADX DEBUG: Multi-variable search result rejected for r0v10, resolved type: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap */
                /* JADX WARN: Multi-variable type inference failed */
                @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getValue() instanceof Double) || (f = Object2DoubleAVLTreeMap.this.findKey(e.getKey())) == null || Double.doubleToLongBits(f.getDoubleValue()) != Double.doubleToLongBits(((Double) e.getValue()).doubleValue())) {
                        return false;
                    }
                ...
                public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from, Object2DoubleMap.Entry<K> to) {
                    return Object2DoubleAVLTreeMap.this.subMap((Object) from.getKey(), (Object) to.getKey()).object2DoubleEntrySet();
                }

                public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> to) {
                    return Object2DoubleAVLTreeMap.this.headMap((Object2DoubleAVLTreeMap) to.getKey()).object2DoubleEntrySet();
                }

                public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> from) {
                    return Object2DoubleAVLTreeMap.this.tailMap((Object2DoubleAVLTreeMap) from.getKey()).object2DoubleEntrySet();
                }
            };
        }
        return this.entries;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2DoubleAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2DoubleAVLTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2DoubleAVLTreeMap$ValueIterator.class */
    ...
    public DoubleCollection values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection() { // from class: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2DoubleAVLTreeMap$Submap.class */
    public final class Submap extends AbstractObject2DoubleSortedMap<K> implements Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.Function, p014it.unimi.dsi.fastutil.bytes.Byte2BooleanMap, java.util.Map
        public void clear() {
            Object2DoubleAVLTreeMap<K>.Submap.SubmapIterator i = new SubmapIterator();
            while (i.hasNext()) {
                i.nextEntry();
                i.remove();
            }
        ...
        public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.ObjectSortedSet
                    public /* bridge */ /* synthetic */ ObjectBidirectionalIterator iterator(Object obj) {
                        return iterator((Object2DoubleMap.Entry) ((Object2DoubleMap.Entry) obj));
                    }
                    ...
                    /* JADX DEBUG: Multi-variable search result rejected for r0v13, resolved type: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap */
                    /* JADX DEBUG: Multi-variable search result rejected for r0v18, resolved type: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$Submap */
                    /* JADX WARN: Multi-variable type inference failed */
                    @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
                    public boolean contains(Object o) {
                        Entry<K> f;
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getValue() != null && (e.getValue() instanceof Double) && (f = Object2DoubleAVLTreeMap.this.findKey(e.getKey())) != null && Submap.this.m600in(f.key) && e.equals(f);
                    }

                    /* JADX DEBUG: Multi-variable search result rejected for r0v13, resolved type: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap */
                    /* JADX DEBUG: Multi-variable search result rejected for r0v20, resolved type: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$Submap */
                    /* JADX WARN: Multi-variable type inference failed */
                    @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
                    public boolean remove(Object o) {
                        if (!(o instanceof Map.Entry)) {
                        ...
                        Entry<K> f = Object2DoubleAVLTreeMap.this.findKey(e.getKey());
                        if (f != null && Submap.this.m600in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2DoubleAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractObject2DoubleSortedMap<K>.KeySet {
            private KeySet() {
                super();
            }
        ...
        public DoubleCollection values() {
            if (this.values == null) {
                this.values = new AbstractDoubleCollection() { // from class: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDoubleCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.doubles.DoubleCollection, p014it.unimi.dsi.fastutil.doubles.DoubleIterable
                    public DoubleIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObject2DoubleMap, p014it.unimi.dsi.fastutil.Function
        public boolean containsKey(Object k) {
            return k != null && m600in(k) && Object2DoubleAVLTreeMap.this.containsKey(k);
        }
        ...
        public double getDouble(Object k) {
            Entry<K> e;
            return (!m600in(k) || (e = Object2DoubleAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public double removeDouble(Object k) {
            ...
            return Object2DoubleAVLTreeMap.this.modified ? Object2DoubleAVLTreeMap.this.removeDouble(k) : this.defRetValue;
        }
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r0v18, resolved type: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap */
        /* JADX WARN: Multi-variable type inference failed */
        ...
        public Entry<K> lastEntry() {
            ...
            if (this.bottom || Object2DoubleAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2DoubleAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends Object2DoubleAVLTreeMap<K>.TreeIterator {
            ...
            /* JADX DEBUG: Multi-variable search result rejected for r0v9, resolved type: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap */
            /* JADX DEBUG: Multi-variable search result rejected for r0v15, resolved type: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap */
            /* JADX DEBUG: Multi-variable search result rejected for r0v19, resolved type: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap */
            /* JADX WARN: Multi-variable type inference failed */
            SubmapIterator(Submap submap, K k) {
                ...
                if (submap.bottom || Object2DoubleAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Object2DoubleAVLTreeMap object2DoubleAVLTreeMap = Object2DoubleAVLTreeMap.this;
                        Entry<K> lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (object2DoubleAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            /* JADX DEBUG: Multi-variable search result rejected for r0v8, resolved type: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap */
            /* JADX WARN: Multi-variable type inference failed */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2DoubleAVLTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2DoubleAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Object2DoubleAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2DoubleAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Object2DoubleAVLTreeMap<K> clone() {
        try {
            Object2DoubleAVLTreeMap<K> c = (Object2DoubleAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        int n = this.count;
        Object2DoubleAVLTreeMap<K>.EntryIterator i = new EntryIterator();
