...
/* renamed from: it.unimi.dsi.fastutil.objects.Reference2FloatFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2FloatFunctions.class */
public final class Reference2FloatFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2FloatFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2FloatFunctions$EmptyFunction.class */
    public static class EmptyFunction<K> extends AbstractReference2FloatFunction<K> implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.AbstractReference2FloatFunction, p014it.unimi.dsi.fastutil.objects.Reference2FloatFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2FloatFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2FloatFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2FloatFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2FloatFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction<K> implements Reference2FloatFunction<K>, Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2FloatFunction, p014it.unimi.dsi.fastutil.Function
        @Deprecated
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Reference2FloatFunction<K> f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Reference2FloatFunction<K> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2FloatFunction, java.util.function.ToDoubleFunction
        ...
        public float put(K k, float v) {
            float put;
            synchronized (this.sync) {
                put = this.function.put((Reference2FloatFunction<K>) k, v);
            }
            return put;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2FloatFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2FloatFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction<K> extends AbstractReference2FloatFunction<K> implements Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Reference2FloatFunction<? extends K> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2FloatFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2FloatFunctions$PrimitiveFunction.class */
    ...
    public static <K> Reference2FloatFunction<K> primitive(java.util.function.Function<? super K, ? extends Float> f) {
        ...
        return f instanceof Reference2FloatFunction ? (Reference2FloatFunction) f : f instanceof ToDoubleFunction ? key -> {
