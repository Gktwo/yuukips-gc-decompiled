...
/* renamed from: it.unimi.dsi.fastutil.objects.ObjectReferenceImmutablePair */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/ObjectReferenceImmutablePair.class */
public class ObjectReferenceImmutablePair<K, V> implements ObjectReferencePair<K, V>, Serializable {
    ...
    /* renamed from: of */
    public static <K, V> ObjectReferenceImmutablePair<K, V> m536of(K left, V right) {
