...
/* renamed from: it.unimi.dsi.fastutil.objects.Object2ObjectFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ObjectFunctions.class */
public final class Object2ObjectFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2ObjectFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ObjectFunctions$EmptyFunction.class */
    public static class EmptyFunction<K, V> extends AbstractObject2ObjectFunction<K, V> implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObject2ObjectFunction, p014it.unimi.dsi.fastutil.objects.Object2ObjectFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2ObjectFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ObjectFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2ObjectFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ObjectFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction<K, V> implements Object2ObjectFunction<K, V>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Object2ObjectFunction<K, V> f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Object2ObjectFunction<K, V> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2ObjectFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ObjectFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction<K, V> extends AbstractObject2ObjectFunction<K, V> implements Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Object2ObjectFunction<? extends K, ? extends V> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
