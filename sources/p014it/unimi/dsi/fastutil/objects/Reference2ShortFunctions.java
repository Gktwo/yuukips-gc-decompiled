...
/* renamed from: it.unimi.dsi.fastutil.objects.Reference2ShortFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ShortFunctions.class */
public final class Reference2ShortFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ShortFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ShortFunctions$EmptyFunction.class */
    public static class EmptyFunction<K> extends AbstractReference2ShortFunction<K> implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.AbstractReference2ShortFunction, p014it.unimi.dsi.fastutil.objects.Reference2ShortFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ShortFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ShortFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ShortFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ShortFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction<K> implements Reference2ShortFunction<K>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Reference2ShortFunction<K> f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Reference2ShortFunction<K> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2ShortFunction, java.util.function.ToIntFunction
        ...
        public short put(K k, short v) {
            short put;
            synchronized (this.sync) {
                put = this.function.put((Reference2ShortFunction<K>) k, v);
            }
            return put;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ShortFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ShortFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction<K> extends AbstractReference2ShortFunction<K> implements Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Reference2ShortFunction<? extends K> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2ShortFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2ShortFunctions$PrimitiveFunction.class */
    ...
    public static <K> Reference2ShortFunction<K> primitive(java.util.function.Function<? super K, ? extends Short> f) {
        ...
        return f instanceof Reference2ShortFunction ? (Reference2ShortFunction) f : f instanceof ToIntFunction ? key -> {
