...
/* renamed from: it.unimi.dsi.fastutil.objects.Object2ByteMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ByteMap.class */
public interface Object2ByteMap<K> extends Object2ByteFunction<K>, Map<K, Byte> {
    ...
    @Override // p014it.unimi.dsi.fastutil.objects.Object2ByteSortedMap
    ...
    /* bridge */ /* synthetic */ default Byte merge(Object obj, Byte b, BiFunction<? super Byte, ? super Byte, ? extends Byte> biFunction) {
        return merge((Object2ByteMap<K>) obj, b, biFunction);
    }
    ...
    /* bridge */ /* synthetic */ default Byte replace(Object obj, Byte b) {
        return replace((Object2ByteMap<K>) obj, b);
    }
    ...
    /* bridge */ /* synthetic */ default boolean replace(Object obj, Byte b, Byte b2) {
        return replace((Object2ByteMap<K>) obj, b, b2);
    }
    ...
    /* bridge */ /* synthetic */ default Byte putIfAbsent(Object obj, Byte b) {
        return putIfAbsent((Object2ByteMap<K>) obj, b);
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Object2ByteMap$FastEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ByteMap$FastEntrySet.class */
    ...
    default Byte put(K key, Byte value) {
        return put((Object2ByteMap<K>) key, value);
    }
    ...
    default void forEach(BiConsumer<? super K, ? super Byte> consumer) {
        ObjectSet<Entry<K>> entrySet = object2ByteEntrySet();
    ...
    default byte putIfAbsent(K key, byte value) {
        ...
        put((Object2ByteMap<K>) key, value);
        return drv;
    }
    ...
    default boolean replace(K key, byte oldValue, byte newValue) {
        ...
        put((Object2ByteMap<K>) key, newValue);
        return true;
    }

    default byte replace(K key, byte value) {
        return containsKey(key) ? put((Object2ByteMap<K>) key, value) : defaultReturnValue();
    }
    ...
    default byte computeByteIfAbsent(K key, ToIntFunction<? super K> mappingFunction) {
        return computeIfAbsent((Object2ByteMap<K>) key, (ToIntFunction<? super Object2ByteMap<K>>) mappingFunction);
    }
    ...
    default byte computeByteIfAbsentPartial(K key, Object2ByteFunction<? super K> mappingFunction) {
        return computeIfAbsent((Object2ByteMap<K>) key, (Object2ByteFunction<? super Object2ByteMap<K>>) mappingFunction);
    }
    ...
    default byte computeByteIfPresent(K key, BiFunction<? super K, ? super Byte, ? extends Byte> remappingFunction) {
        ...
        put((Object2ByteMap<K>) key, newVal);
        return newVal;
    }
    ...
    default byte mergeByte(K key, byte value, IntBinaryOperator remappingFunction) {
        return mergeByte((Object2ByteMap<K>) key, value, remappingFunction instanceof ByteBinaryOperator ? (ByteBinaryOperator) remappingFunction : x, y -> {
    ...
    default byte mergeByte(K key, byte value, BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
        return merge((Object2ByteMap<K>) key, value, remappingFunction);
    }

    @Deprecated
    default Byte putIfAbsent(K key, Byte value) {
        return putIfAbsent((Object2ByteMap<K>) key, (K) value);
    }
    ...
    @Deprecated
    default boolean replace(K key, Byte oldValue, Byte newValue) {
        return replace((Object2ByteMap<K>) key, oldValue, newValue);
    }

    @Deprecated
    default Byte replace(K key, Byte value) {
        return replace((Object2ByteMap<K>) key, (K) value);
    }
    ...
    @Deprecated
    default Byte merge(K key, Byte value, BiFunction<? super Byte, ? super Byte, ? extends Byte> remappingFunction) {
        return merge((Object2ByteMap<K>) key, (K) value, (BiFunction<? super K, ? super K, ? extends K>) remappingFunction);
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Object2ByteMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2ByteMap$Entry.class */
