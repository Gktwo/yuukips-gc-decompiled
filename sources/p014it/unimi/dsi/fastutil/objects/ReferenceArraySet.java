...
public class ReferenceArraySet<K> extends AbstractReferenceSet<K> implements Serializable, Cloneable {
    ...
    /* renamed from: a */
    private transient Object[] f2832a;
    private int size;
    ...
    public ReferenceArraySet() {
        this.f2832a = ObjectArrays.EMPTY_ARRAY;
    }

    public ReferenceArraySet(int capacity) {
        this.f2832a = new Object[capacity];
    }
    ...
    public ObjectIterator<K> iterator() {
        return new ObjectIterator<K>() { // from class: it.unimi.dsi.fastutil.objects.ReferenceArraySet.1
            ...
            public K next() {
                ...
                Object[] objArr = ReferenceArraySet.this.f2832a;
                int i = this.next;
                this.next = i + 1;
                return (K) objArr[i];
            }
            ...
            public void remove() {
                ...
                int i = this.next;
                this.next = i - 1;
                System.arraycopy(ReferenceArraySet.this.f2832a, this.next + 1, ReferenceArraySet.this.f2832a, this.next, access$010 - i);
                ReferenceArraySet.this.f2832a[ReferenceArraySet.this.size] = null;
            }
    ...
    public final class Spliterator implements ObjectSpliterator<K> {
        ...
        public void forEachRemaining(Consumer<? super K> action) {
            ...
            while (this.pos < max) {
                action.accept(ReferenceArraySet.this.f2832a[this.pos]);
                this.pos++;
            }
        }
    ...
    public boolean remove(Object k) {
        ...
        for (int i = 0; i < tail; i++) {
            this.f2832a[pos + i] = this.f2832a[pos + i + 1];
        }
        this.size--;
        this.f2832a[this.size] = null;
        return true;
    }
    ...
    public boolean add(K k) {
        ...
        if (this.size == this.f2832a.length) {
    ...
    @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
    public void clear() {
        Arrays.fill(this.f2832a, 0, this.size, (Object) null);
        this.size = 0;
    }
    ...
    public Object[] toArray() {
        return Arrays.copyOf(this.f2832a, this.size, Object[].class);
    }
    ...
    public <K> K[] toArray(K[] a) {
        ...
        System.arraycopy(this.f2832a, 0, a, 0, this.size);
    ...
    public ReferenceArraySet<K> clone() {
        try {
            ...
            c.f2832a = (Object[]) this.f2832a.clone();
            return c;
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        for (int i = 0; i < this.size; i++) {
            s.writeObject(this.f2832a[i]);
        }
    }

    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        s.defaultReadObject();
        this.f2832a = new Object[this.size];
        for (int i = 0; i < this.size; i++) {
            this.f2832a[i] = s.readObject();
        }
    }
}
