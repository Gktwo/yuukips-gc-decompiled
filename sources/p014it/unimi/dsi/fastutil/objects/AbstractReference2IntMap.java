...
/* renamed from: it.unimi.dsi.fastutil.objects.AbstractReference2IntMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/AbstractReference2IntMap.class */
public abstract class AbstractReference2IntMap<K> extends AbstractReference2IntFunction<K> implements Reference2IntMap<K>, Serializable {
    ...
    public final int mergeInt(K key, int value, IntBinaryOperator remappingFunction) {
        return mergeInt((AbstractReference2IntMap<K>) key, value, (java.util.function.IntBinaryOperator) remappingFunction);
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.AbstractReference2IntMap$BasicEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/AbstractReference2IntMap$BasicEntry.class */
    public static class BasicEntry<K> implements Reference2IntMap.Entry<K> {
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof Reference2IntMap.Entry) {
                Reference2IntMap.Entry<K> e = (Reference2IntMap.Entry) o;
                return this.key == e.getKey() && this.value == e.getIntValue();
            }
            Map.Entry<?, ?> e2 = (Map.Entry) o;
            Object key = e2.getKey();
            Object value = e2.getValue();
            return value != null && (value instanceof Integer) && this.key == key && this.value == ((Integer) value).intValue();
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.AbstractReference2IntMap$BasicEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/AbstractReference2IntMap$BasicEntrySet.class */
    public static abstract class BasicEntrySet<K> extends AbstractObjectSet<Reference2IntMap.Entry<K>> {
    ...
    public ReferenceSet<K> keySet() {
        return new AbstractReferenceSet<K>() { // from class: it.unimi.dsi.fastutil.objects.AbstractReference2IntMap.1
            @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
            ...
            public ObjectSpliterator<K> spliterator() {
                return ObjectSpliterators.asSpliterator(iterator(), Size64.sizeOf(AbstractReference2IntMap.this), 65);
            }
        };
    }
    ...
    public Collection<Integer> values() {
        return new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.objects.AbstractReference2IntMap.2
            ...
            public IntSpliterator spliterator() {
                return IntSpliterators.asSpliterator(iterator(), Size64.sizeOf(AbstractReference2IntMap.this), 320);
            }
        };
    }

    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: it.unimi.dsi.fastutil.objects.AbstractReference2IntMap<K> */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // java.util.Map
    public void putAll(Map<? extends K, ? extends Integer> m) {
        if (m instanceof Reference2IntMap) {
            ObjectIterator<Reference2IntMap.Entry<K>> i = Reference2IntMaps.fastIterator((Reference2IntMap) m);
            while (i.hasNext()) {
                Reference2IntMap.Entry<? extends K> e = (Reference2IntMap.Entry) i.next();
                put((AbstractReference2IntMap<K>) e.getKey(), e.getIntValue());
            }
            return;
        }
        int n = m.size();
        ...
        while (true) {
            ...
            if (n != 0) {
                ...
                put((AbstractReference2IntMap<K>) e2.getKey(), (Integer) e2.getValue());
            } else {
                return;
            }
        }
