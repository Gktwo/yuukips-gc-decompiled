...
/* renamed from: it.unimi.dsi.fastutil.objects.Object2CharMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2CharMap.class */
public interface Object2CharMap<K> extends Object2CharFunction<K>, Map<K, Character> {
    ...
    @Override // p014it.unimi.dsi.fastutil.objects.Object2CharSortedMap
    ...
    /* bridge */ /* synthetic */ default Character put(Object obj, Character ch) {
        return put((Object2CharMap<K>) obj, ch);
    }
    ...
    /* bridge */ /* synthetic */ default Character merge(Object obj, Character ch, BiFunction<? super Character, ? super Character, ? extends Character> biFunction) {
        return merge((Object2CharMap<K>) obj, ch, biFunction);
    }
    ...
    /* bridge */ /* synthetic */ default Character replace(Object obj, Character ch) {
        return replace((Object2CharMap<K>) obj, ch);
    }
    ...
    /* bridge */ /* synthetic */ default boolean replace(Object obj, Character ch, Character ch2) {
        return replace((Object2CharMap<K>) obj, ch, ch2);
    }
    ...
    /* bridge */ /* synthetic */ default Character putIfAbsent(Object obj, Character ch) {
        return putIfAbsent((Object2CharMap<K>) obj, ch);
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Object2CharMap$FastEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2CharMap$FastEntrySet.class */
    ...
    default Character put(K key, Character value) {
        return put((Object2CharMap<K>) key, value);
    }
    ...
    default void forEach(BiConsumer<? super K, ? super Character> consumer) {
        ObjectSet<Entry<K>> entrySet = object2CharEntrySet();
    ...
    default char putIfAbsent(K key, char value) {
        ...
        put((Object2CharMap<K>) key, value);
        return drv;
    }
    ...
    default boolean replace(K key, char oldValue, char newValue) {
        ...
        put((Object2CharMap<K>) key, newValue);
        return true;
    }

    default char replace(K key, char value) {
        return containsKey(key) ? put((Object2CharMap<K>) key, value) : defaultReturnValue();
    }
    ...
    default char computeCharIfAbsent(K key, ToIntFunction<? super K> mappingFunction) {
        return computeIfAbsent((Object2CharMap<K>) key, (ToIntFunction<? super Object2CharMap<K>>) mappingFunction);
    }
    ...
    default char computeCharIfAbsentPartial(K key, Object2CharFunction<? super K> mappingFunction) {
        return computeIfAbsent((Object2CharMap<K>) key, (Object2CharFunction<? super Object2CharMap<K>>) mappingFunction);
    }
    ...
    default char computeCharIfPresent(K key, BiFunction<? super K, ? super Character, ? extends Character> remappingFunction) {
        ...
        put((Object2CharMap<K>) key, newVal);
        return newVal;
    }
    ...
    default char mergeChar(K key, char value, IntBinaryOperator remappingFunction) {
        return mergeChar((Object2CharMap<K>) key, value, remappingFunction instanceof CharBinaryOperator ? (CharBinaryOperator) remappingFunction : x, y -> {
    ...
    default char mergeChar(K key, char value, BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
        return merge((Object2CharMap<K>) key, value, remappingFunction);
    }

    @Deprecated
    default Character putIfAbsent(K key, Character value) {
        return putIfAbsent((Object2CharMap<K>) key, (K) value);
    }
    ...
    default boolean replace(K key, Character oldValue, Character newValue) {
        return replace((Object2CharMap<K>) key, oldValue, newValue);
    }

    @Deprecated
    default Character replace(K key, Character value) {
        return replace((Object2CharMap<K>) key, (K) value);
    }
    ...
    default Character merge(K key, Character value, BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
        return merge((Object2CharMap<K>) key, (K) value, (BiFunction<? super K, ? super K, ? extends K>) remappingFunction);
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Object2CharMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2CharMap$Entry.class */
