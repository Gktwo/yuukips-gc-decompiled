...
/* renamed from: it.unimi.dsi.fastutil.objects.ReferenceBigList */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/ReferenceBigList.class */
public interface ReferenceBigList<K> extends BigList<K>, ReferenceCollection<K> {
    ...
    default void setElements(long r12, K[][] r14, long r15, long r17) {
        ...
        L_0x00da:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.objects.ReferenceBigList.setElements(long, java.lang.Object[][], long, long):void");
    }
    ...
    default boolean addAll(ReferenceBigList<? extends K> l) {
        return addAll(size64(), (ReferenceBigList) l);
    }
    ...
    default boolean addAll(ReferenceList<? extends K> l) {
        return addAll(size64(), (ReferenceList) l);
    }
}
