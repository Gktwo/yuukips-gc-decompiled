...
import p014it.unimi.dsi.fastutil.objects.Reference2CharFunctions;
import p014it.unimi.dsi.fastutil.objects.Reference2CharMap;

/* renamed from: it.unimi.dsi.fastutil.objects.Reference2CharMaps */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2CharMaps.class */
public final class Reference2CharMaps {
    ...
    public static <K> ObjectIterable<Reference2CharMap.Entry<K>> fastIterable(Reference2CharMap<K> map) {
        ...
        return entries instanceof Reference2CharMap.FastEntrySet ? new ObjectIterable<Reference2CharMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Reference2CharMaps.1
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectIterable, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection
            public ObjectIterator<Reference2CharMap.Entry<K>> iterator() {
                return ((Reference2CharMap.FastEntrySet) ObjectSet.this).fastIterator();
            }
            ...
            public void forEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
                ((Reference2CharMap.FastEntrySet) ObjectSet.this).fastForEach(consumer);
            }
        } : entries;
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2CharMaps$EmptyMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2CharMaps$EmptyMap.class */
    public static class EmptyMap<K> extends Reference2CharFunctions.EmptyFunction<K> implements Reference2CharMap<K>, Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2CharFunctions.EmptyFunction, p014it.unimi.dsi.fastutil.objects.Reference2CharFunction
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2CharFunctions.EmptyFunction, java.lang.Object
        public Object clone() {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2CharMaps$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2CharMaps$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2CharMaps$SynchronizedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2CharMaps$SynchronizedMap.class */
    public static class SynchronizedMap<K> extends Reference2CharFunctions.SynchronizedFunction<K> implements Reference2CharMap<K>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedMap(Reference2CharMap<K> m, Object sync) {
            super(m, sync);
            this.map = m;
        }

        /* access modifiers changed from: protected */
        public SynchronizedMap(Reference2CharMap<K> m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2CharMap
        public ObjectSet<Reference2CharMap.Entry<K>> reference2CharEntrySet() {
            ObjectSet<Reference2CharMap.Entry<K>> objectSet;
            synchronized (this.sync) {
                if (this.entries == null) {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2CharFunctions.SynchronizedFunction, java.lang.Object
        public int hashCode() {
            int hashCode;
            synchronized (this.sync) {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2CharFunctions.SynchronizedFunction, p014it.unimi.dsi.fastutil.objects.Reference2CharFunction
        public char getOrDefault(Object key, char defaultValue) {
            char orDefault;
            synchronized (this.sync) {
        ...
        public char putIfAbsent(K key, char value) {
            char putIfAbsent;
            synchronized (this.sync) {
                putIfAbsent = this.map.putIfAbsent((Reference2CharMap<K>) key, value);
            }
            return putIfAbsent;
        }
        ...
        public char replace(K key, char value) {
            char replace;
            synchronized (this.sync) {
                replace = this.map.replace((Reference2CharMap<K>) key, value);
            }
            return replace;
        }
        ...
        public boolean replace(K key, char oldValue, char newValue) {
            boolean replace;
            synchronized (this.sync) {
                replace = this.map.replace((Reference2CharMap<K>) key, oldValue, newValue);
            }
            return replace;
        }
        ...
        public char computeIfAbsent(K key, ToIntFunction<? super K> mappingFunction) {
            ...
            synchronized (this.sync) {
                computeIfAbsent = this.map.computeIfAbsent((Reference2CharMap<K>) key, (ToIntFunction<? super Reference2CharMap<K>>) mappingFunction);
            }
        ...
        public char computeIfAbsent(K key, Reference2CharFunction<? super K> mappingFunction) {
            char computeIfAbsent;
            synchronized (this.sync) {
                computeIfAbsent = this.map.computeIfAbsent((Reference2CharMap<K>) key, (Reference2CharFunction<? super Reference2CharMap<K>>) mappingFunction);
            }
            return computeIfAbsent;
        }
        ...
        public char merge(K key, char value, BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
            char merge;
            synchronized (this.sync) {
                merge = this.map.merge((Reference2CharMap<K>) key, value, remappingFunction);
            }
            return merge;
        }
        ...
        public Character computeIfAbsent(K key, Function<? super K, ? extends Character> mappingFunction) {
            ...
            synchronized (this.sync) {
                computeIfAbsent = this.map.computeIfAbsent((Reference2CharMap<K>) key, (Function<? super Reference2CharMap<K>, ? extends Character>) mappingFunction);
            }
            return computeIfAbsent;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2CharMaps$UnmodifiableMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2CharMaps$UnmodifiableMap.class */
    public static class UnmodifiableMap<K> extends Reference2CharFunctions.UnmodifiableFunction<K> implements Reference2CharMap<K>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableMap(Reference2CharMap<? extends K> m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2CharFunctions.UnmodifiableFunction, java.lang.Object
        public int hashCode() {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2CharFunctions.UnmodifiableFunction, p014it.unimi.dsi.fastutil.objects.Reference2CharFunction
        public char getOrDefault(Object key, char defaultValue) {
