...
import p014it.unimi.dsi.fastutil.objects.Object2FloatFunctions;
import p014it.unimi.dsi.fastutil.objects.Object2FloatMap;

/* renamed from: it.unimi.dsi.fastutil.objects.Object2FloatMaps */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2FloatMaps.class */
public final class Object2FloatMaps {
    ...
    public static <K> ObjectIterable<Object2FloatMap.Entry<K>> fastIterable(Object2FloatMap<K> map) {
        ...
        return entries instanceof Object2FloatMap.FastEntrySet ? new ObjectIterable<Object2FloatMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Object2FloatMaps.1
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2FloatMaps$EmptyMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2FloatMaps$EmptyMap.class */
    public static class EmptyMap<K> extends Object2FloatFunctions.EmptyFunction<K> implements Object2FloatMap<K>, Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Object2FloatFunctions.EmptyFunction, p014it.unimi.dsi.fastutil.objects.Object2FloatFunction
        public float getOrDefault(Object key, float defaultValue) {
            return defaultValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Object2FloatFunctions.EmptyFunction, java.lang.Object
        public Object clone() {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2FloatMaps$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2FloatMaps$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2FloatMaps$SynchronizedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2FloatMaps$SynchronizedMap.class */
    public static class SynchronizedMap<K> extends Object2FloatFunctions.SynchronizedFunction<K> implements Object2FloatMap<K>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedMap(Object2FloatMap<K> m, Object sync) {
            super(m, sync);
            this.map = m;
        }

        /* access modifiers changed from: protected */
        public SynchronizedMap(Object2FloatMap<K> m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Object2FloatFunctions.SynchronizedFunction, java.lang.Object
        public int hashCode() {
            int hashCode;
            synchronized (this.sync) {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Object2FloatFunctions.SynchronizedFunction, p014it.unimi.dsi.fastutil.objects.Object2FloatFunction
        public float getOrDefault(Object key, float defaultValue) {
            float orDefault;
            synchronized (this.sync) {
        ...
        public float putIfAbsent(K key, float value) {
            float putIfAbsent;
            synchronized (this.sync) {
                putIfAbsent = this.map.putIfAbsent((Object2FloatMap<K>) key, value);
            }
            return putIfAbsent;
        }
        ...
        public float replace(K key, float value) {
            float replace;
            synchronized (this.sync) {
                replace = this.map.replace((Object2FloatMap<K>) key, value);
            }
            return replace;
        }
        ...
        public boolean replace(K key, float oldValue, float newValue) {
            boolean replace;
            synchronized (this.sync) {
                replace = this.map.replace((Object2FloatMap<K>) key, oldValue, newValue);
            }
            return replace;
        }
        ...
        public float computeIfAbsent(K key, ToDoubleFunction<? super K> mappingFunction) {
            ...
            synchronized (this.sync) {
                computeIfAbsent = this.map.computeIfAbsent((Object2FloatMap<K>) key, (ToDoubleFunction<? super Object2FloatMap<K>>) mappingFunction);
            }
        ...
        public float computeIfAbsent(K key, Object2FloatFunction<? super K> mappingFunction) {
            float computeIfAbsent;
            synchronized (this.sync) {
                computeIfAbsent = this.map.computeIfAbsent((Object2FloatMap<K>) key, (Object2FloatFunction<? super Object2FloatMap<K>>) mappingFunction);
            }
            return computeIfAbsent;
        }
        ...
        public float merge(K key, float value, BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
            float merge;
            synchronized (this.sync) {
                merge = this.map.merge((Object2FloatMap<K>) key, value, remappingFunction);
            }
            return merge;
        }
        ...
        public Float computeIfAbsent(K key, Function<? super K, ? extends Float> mappingFunction) {
            Float computeIfAbsent;
            synchronized (this.sync) {
                computeIfAbsent = this.map.computeIfAbsent((Object2FloatMap<K>) key, (Function<? super Object2FloatMap<K>, ? extends Float>) mappingFunction);
            }
            return computeIfAbsent;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2FloatMaps$UnmodifiableMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2FloatMaps$UnmodifiableMap.class */
    public static class UnmodifiableMap<K> extends Object2FloatFunctions.UnmodifiableFunction<K> implements Object2FloatMap<K>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableMap(Object2FloatMap<? extends K> m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Object2FloatFunctions.UnmodifiableFunction, java.lang.Object
        public int hashCode() {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Object2FloatFunctions.UnmodifiableFunction, p014it.unimi.dsi.fastutil.objects.Object2FloatFunction
        public float getOrDefault(Object key, float defaultValue) {
