...
/* renamed from: it.unimi.dsi.fastutil.objects.Reference2FloatMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2FloatMap.class */
public interface Reference2FloatMap<K> extends Reference2FloatFunction<K>, Map<K, Float> {
    ...
    /* bridge */ /* synthetic */ default Float merge(Object obj, Float f, BiFunction<? super Float, ? super Float, ? extends Float> biFunction) {
        return merge((Reference2FloatMap<K>) obj, f, biFunction);
    }
    ...
    /* bridge */ /* synthetic */ default Float replace(Object obj, Float f) {
        return replace((Reference2FloatMap<K>) obj, f);
    }
    ...
    /* bridge */ /* synthetic */ default boolean replace(Object obj, Float f, Float f2) {
        return replace((Reference2FloatMap<K>) obj, f, f2);
    }
    ...
    /* bridge */ /* synthetic */ default Float putIfAbsent(Object obj, Float f) {
        return putIfAbsent((Reference2FloatMap<K>) obj, f);
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2FloatMap$FastEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2FloatMap$FastEntrySet.class */
    ...
    default Float put(K key, Float value) {
        return put((Reference2FloatMap<K>) key, value);
    }
    ...
    default void forEach(BiConsumer<? super K, ? super Float> consumer) {
        ObjectSet<Entry<K>> entrySet = reference2FloatEntrySet();
    ...
    default float putIfAbsent(K key, float value) {
        ...
        put((Reference2FloatMap<K>) key, value);
        return drv;
    }
    ...
    default boolean replace(K key, float oldValue, float newValue) {
        ...
        put((Reference2FloatMap<K>) key, newValue);
        return true;
    }

    default float replace(K key, float value) {
        return containsKey(key) ? put((Reference2FloatMap<K>) key, value) : defaultReturnValue();
    }
    ...
    default float computeFloatIfAbsent(K key, ToDoubleFunction<? super K> mappingFunction) {
        return computeIfAbsent((Reference2FloatMap<K>) key, (ToDoubleFunction<? super Reference2FloatMap<K>>) mappingFunction);
    }
    ...
    default float computeFloatIfAbsentPartial(K key, Reference2FloatFunction<? super K> mappingFunction) {
        return computeIfAbsent((Reference2FloatMap<K>) key, (Reference2FloatFunction<? super Reference2FloatMap<K>>) mappingFunction);
    }
    ...
    default float computeFloatIfPresent(K key, BiFunction<? super K, ? super Float, ? extends Float> remappingFunction) {
        ...
        put((Reference2FloatMap<K>) key, newVal);
        return newVal;
    }
    ...
    default float mergeFloat(K key, float value, DoubleBinaryOperator remappingFunction) {
        return mergeFloat((Reference2FloatMap<K>) key, value, remappingFunction instanceof FloatBinaryOperator ? (FloatBinaryOperator) remappingFunction : x, y -> {
    ...
    default float mergeFloat(K key, float value, BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
        return merge((Reference2FloatMap<K>) key, value, remappingFunction);
    }

    @Deprecated
    default Float putIfAbsent(K key, Float value) {
        return putIfAbsent((Reference2FloatMap<K>) key, (K) value);
    }
    ...
    @Deprecated
    default boolean replace(K key, Float oldValue, Float newValue) {
        return replace((Reference2FloatMap<K>) key, oldValue, newValue);
    }

    @Deprecated
    default Float replace(K key, Float value) {
        return replace((Reference2FloatMap<K>) key, (K) value);
    }
    ...
    @Deprecated
    default Float merge(K key, Float value, BiFunction<? super Float, ? super Float, ? extends Float> remappingFunction) {
        return merge((Reference2FloatMap<K>) key, (K) value, (BiFunction<? super K, ? super K, ? extends K>) remappingFunction);
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2FloatMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2FloatMap$Entry.class */
