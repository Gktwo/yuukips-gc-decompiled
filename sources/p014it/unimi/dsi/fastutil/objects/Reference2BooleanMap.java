...
/* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanMap.class */
public interface Reference2BooleanMap<K> extends Reference2BooleanFunction<K>, Map<K, Boolean> {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanMap$FastEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanMap$FastEntrySet.class */
    ...
    default Boolean put(K key, Boolean value) {
        return put((Reference2BooleanMap<K>) key, value);
    }
    ...
    default void forEach(BiConsumer<? super K, ? super Boolean> consumer) {
        ObjectSet<Entry<K>> entrySet = reference2BooleanEntrySet();
    ...
    default boolean putIfAbsent(K key, boolean value) {
        ...
        put((Reference2BooleanMap<K>) key, value);
        return drv;
    }
    ...
    default boolean replace(K key, boolean oldValue, boolean newValue) {
        ...
        put((Reference2BooleanMap<K>) key, newValue);
        return true;
    }

    default boolean replace(K key, boolean value) {
        return containsKey(key) ? put((Reference2BooleanMap<K>) key, value) : defaultReturnValue();
    }
    ...
    default boolean computeBooleanIfAbsent(K key, Predicate<? super K> mappingFunction) {
        return computeIfAbsent((Reference2BooleanMap<K>) key, (Predicate<? super Reference2BooleanMap<K>>) mappingFunction);
    }
    ...
    default boolean computeBooleanIfAbsentPartial(K key, Reference2BooleanFunction<? super K> mappingFunction) {
        return computeIfAbsent((Reference2BooleanMap<K>) key, (Reference2BooleanFunction<? super Reference2BooleanMap<K>>) mappingFunction);
    }
    ...
    default boolean computeBooleanIfPresent(K key, BiFunction<? super K, ? super Boolean, ? extends Boolean> remappingFunction) {
        ...
        put((Reference2BooleanMap<K>) key, newVal);
        return newVal;
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanMap$Entry.class */
