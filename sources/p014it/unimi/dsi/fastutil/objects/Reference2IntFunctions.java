...
/* renamed from: it.unimi.dsi.fastutil.objects.Reference2IntFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2IntFunctions.class */
public final class Reference2IntFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2IntFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2IntFunctions$EmptyFunction.class */
    public static class EmptyFunction<K> extends AbstractReference2IntFunction<K> implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.AbstractReference2IntFunction, p014it.unimi.dsi.fastutil.objects.Reference2IntFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2IntFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2IntFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2IntFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2IntFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction<K> implements Reference2IntFunction<K>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Reference2IntFunction<K> f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Reference2IntFunction<K> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2IntFunction, java.util.function.ToIntFunction
        ...
        public int put(K k, int v) {
            int put;
            synchronized (this.sync) {
                put = this.function.put((Reference2IntFunction<K>) k, v);
            }
            return put;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2IntFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2IntFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction<K> extends AbstractReference2IntFunction<K> implements Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Reference2IntFunction<? extends K> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2IntFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2IntFunctions$PrimitiveFunction.class */
    ...
    public static <K> Reference2IntFunction<K> primitive(java.util.function.Function<? super K, ? extends Integer> f) {
        ...
        return f instanceof Reference2IntFunction ? (Reference2IntFunction) f : f instanceof ToIntFunction ? key -> {
