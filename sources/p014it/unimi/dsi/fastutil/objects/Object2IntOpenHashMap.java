...
/* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenHashMap.class */
public class Object2IntOpenHashMap<K> extends AbstractObject2IntMap<K> implements Serializable, Cloneable, Hash {
    ...
    public Object2IntOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new int[this.f2619n + 1];
        }
    }
    ...
    public int removeNullEntry() {
        ...
        int oldValue = this.value[this.f2619n];
        this.size--;
        if (this.f2619n > this.minN && this.size < this.maxFill / 4 && this.f2619n > 16) {
            rehash(this.f2619n / 2);
        }
    ...
    public int addTo(K k, int incr) {
        ...
        if (k != null) {
            ...
            return addToValue(this.f2619n, incr);
        } else {
            pos = this.f2619n;
            this.containsNullKey = true;
        }
    ...
    public int getInt(Object k) {
        K curr;
        if (k == null) {
            return this.containsNullKey ? this.value[this.f2619n] : this.defRetValue;
        }
        K[] key = this.key;
        int mix = HashCommon.mix(k.hashCode()) & this.mask;
        int pos = mix;
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenHashMap$MapEntry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Object2IntOpenHashMap.this.f2619n;
            this.last = -1;
            this.f2621c = Object2IntOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Object2IntOpenHashMap.this.f2619n;
                this.last = i;
                return i;
            }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                ...
                key[pos] = curr;
                Object2IntOpenHashMap.this.value[pos] = Object2IntOpenHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Object2IntOpenHashMap.this.f2619n) {
                Object2IntOpenHashMap.this.containsNullKey = false;
                Object2IntOpenHashMap.this.key[Object2IntOpenHashMap.this.f2619n] = null;
            } else if (this.pos >= 0) {
                shiftKeys(this.last);
            } else {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends Object2IntOpenHashMap<K>.MapIterator implements ObjectIterator<Object2IntMap.Entry<K>> {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap.MapIterator
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenHashMap$FastEntryIterator.class */
    private final class FastEntryIterator extends Object2IntOpenHashMap<K>.MapIterator implements ObjectIterator<Object2IntMap.Entry<K>> {
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends Object2IntOpenHashMap<K>.MapSpliterator> {
        int pos;
        int max;
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Object2IntOpenHashMap.this.f2619n;
            this.f2622c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2622c++;
                acceptOnIndex(action, Object2IntOpenHashMap.this.f2619n);
                return true;
            }
            K[] key = Object2IntOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Object2IntOpenHashMap.this.size - this.f2622c);
            }
            return Math.min((long) (Object2IntOpenHashMap.this.size - this.f2622c), ((long) ((((double) Object2IntOpenHashMap.this.realSize()) / ((double) Object2IntOpenHashMap.this.f2619n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap r0 = p014it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap.this
                K[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends Object2IntOpenHashMap<K>.MapSpliterator implements ObjectSpliterator<Object2IntMap.Entry<K>> {
        private static final int POST_SPLIT_CHARACTERISTICS = 1;

        @Override // p014it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap.MapSpliterator
        /* bridge */ /* synthetic */ void acceptOnIndex(Object obj, int i) {
            acceptOnIndex((Consumer) ((Consumer) obj), i);
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Object2IntMap.Entry<K>> implements Object2IntMap.FastEntrySet<K> {
        ...
        public boolean contains(Object o) {
            ...
            if (key == null) {
                return Object2IntOpenHashMap.this.containsNullKey && Object2IntOpenHashMap.this.value[Object2IntOpenHashMap.this.f2619n] == v;
            }
        ...
        public boolean remove(Object o) {
            ...
            if (key != null) {
                ...
                } else if (Object2IntOpenHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Object2IntOpenHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Object2IntOpenHashMap.this.containsNullKey || Object2IntOpenHashMap.this.value[Object2IntOpenHashMap.this.f2619n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Object2IntMap.Entry<K>> consumer) {
            if (Object2IntOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractObject2IntMap.BasicEntry(Object2IntOpenHashMap.this.key[Object2IntOpenHashMap.this.f2619n], Object2IntOpenHashMap.this.value[Object2IntOpenHashMap.this.f2619n]));
            }
            int pos = Object2IntOpenHashMap.this.f2619n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Object2IntMap.Entry<K>> consumer) {
            ...
            if (Object2IntOpenHashMap.this.containsNullKey) {
                entry.key = Object2IntOpenHashMap.this.key[Object2IntOpenHashMap.this.f2619n];
                entry.value = Object2IntOpenHashMap.this.value[Object2IntOpenHashMap.this.f2619n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenHashMap$KeyIterator.class */
    public final class KeyIterator extends Object2IntOpenHashMap<K>.MapIterator implements ObjectIterator<K> {
        @Override // p014it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap.MapIterator
        /* bridge */ /* synthetic */ void acceptOnIndex(Object obj, int i) {
            acceptOnIndex((Consumer) ((Consumer) obj), i);
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenHashMap$KeySpliterator.class */
    public final class KeySpliterator extends Object2IntOpenHashMap<K>.MapSpliterator implements ObjectSpliterator<K> {
        private static final int POST_SPLIT_CHARACTERISTICS = 1;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenHashMap$KeySet.class */
    public final class KeySet extends AbstractObjectSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            if (Object2IntOpenHashMap.this.containsNullKey) {
                consumer.accept((Object) Object2IntOpenHashMap.this.key[Object2IntOpenHashMap.this.f2619n]);
            }
            int pos = Object2IntOpenHashMap.this.f2619n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenHashMap$ValueIterator.class */
    public final class ValueIterator extends Object2IntOpenHashMap<K>.MapIterator implements IntIterator {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Object2IntOpenHashMap$ValueSpliterator.class */
    public final class ValueSpliterator extends Object2IntOpenHashMap<K>.MapSpliterator implements IntSpliterator {
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap.1
                ...
                public void forEach(IntConsumer consumer) {
                    if (Object2IntOpenHashMap.this.containsNullKey) {
                        consumer.accept(Object2IntOpenHashMap.this.value[Object2IntOpenHashMap.this.f2619n]);
                    }
                    int pos = Object2IntOpenHashMap.this.f2619n;
                    while (true) {
                        pos--;
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2619n];
                this.f2619n = newN;
                this.mask = mask;
    ...
    public Object2IntOpenHashMap<K> clone() {
        try {
            Object2IntOpenHashMap<K> c = (Object2IntOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        int[] value = new int[this.f2619n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
