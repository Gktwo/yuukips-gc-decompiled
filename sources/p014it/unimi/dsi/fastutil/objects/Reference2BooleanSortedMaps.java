...
import p014it.unimi.dsi.fastutil.objects.Reference2BooleanMaps;
import p014it.unimi.dsi.fastutil.objects.Reference2BooleanSortedMap;

/* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanSortedMaps */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanSortedMaps.class */
public final class Reference2BooleanSortedMaps {
    ...
    public static <K> ObjectBidirectionalIterable<Reference2BooleanMap.Entry<K>> fastIterable(Reference2BooleanSortedMap<K> map) {
        ObjectSortedSet<Reference2BooleanMap.Entry<K>> entries = map.reference2BooleanEntrySet();
        if (!(entries instanceof Reference2BooleanSortedMap.FastSortedEntrySet)) {
            return entries;
        }
        Reference2BooleanSortedMap.FastSortedEntrySet fastSortedEntrySet = (Reference2BooleanSortedMap.FastSortedEntrySet) entries;
        Objects.requireNonNull(fastSortedEntrySet);
        return this::fastIterator;
    }

    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanSortedMaps$EmptySortedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanSortedMaps$EmptySortedMap.class */
    public static class EmptySortedMap<K> extends Reference2BooleanMaps.EmptyMap<K> implements Reference2BooleanSortedMap<K>, Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanMaps.EmptyMap, p014it.unimi.dsi.fastutil.objects.Reference2BooleanMap
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanMaps.EmptyMap, p014it.unimi.dsi.fastutil.objects.Reference2BooleanMap, java.util.Map
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanSortedMaps$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanSortedMaps$Singleton.class */
    public static class Singleton<K> extends Reference2BooleanMaps.Singleton<K> implements Reference2BooleanSortedMap<K>, Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanMaps.Singleton, p014it.unimi.dsi.fastutil.objects.Reference2BooleanMap
        public ObjectSortedSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanMaps.Singleton, p014it.unimi.dsi.fastutil.objects.Reference2BooleanMap, java.util.Map
        @Deprecated
        public ObjectSortedSet<Map.Entry<K, Boolean>> entrySet() {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: it.unimi.dsi.fastutil.objects.Reference2BooleanSortedMaps$Singleton<K> */
        /* JADX WARN: Multi-variable type inference failed */
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanSortedMap, java.util.SortedMap
        public Reference2BooleanSortedMap<K> subMap(K from, K to) {
            return (compare(from, this.key) > 0 || compare(this.key, to) >= 0) ? Reference2BooleanSortedMaps.EMPTY_MAP : this;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanSortedMap, java.util.SortedMap
        public Reference2BooleanSortedMap<K> headMap(K to) {
            return compare(this.key, to) < 0 ? this : Reference2BooleanSortedMaps.EMPTY_MAP;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanSortedMap, java.util.SortedMap
        public Reference2BooleanSortedMap<K> tailMap(K from) {
            return compare(from, this.key) <= 0 ? this : Reference2BooleanSortedMaps.EMPTY_MAP;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanSortedMaps$SynchronizedSortedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanSortedMaps$SynchronizedSortedMap.class */
    public static class SynchronizedSortedMap<K> extends Reference2BooleanMaps.SynchronizedMap<K> implements Reference2BooleanSortedMap<K>, Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanMaps.SynchronizedMap, p014it.unimi.dsi.fastutil.objects.Reference2BooleanMap
        public ObjectSortedSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() {
            if (this.entries == null) {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanMaps.SynchronizedMap, p014it.unimi.dsi.fastutil.objects.Reference2BooleanMap, java.util.Map
        @Deprecated
        public ObjectSortedSet<Map.Entry<K, Boolean>> entrySet() {
            return reference2BooleanEntrySet();
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanSortedMap, java.util.SortedMap
        public Reference2BooleanSortedMap<K> headMap(K to) {
            return new SynchronizedSortedMap(this.sortedMap.headMap((Reference2BooleanSortedMap<K>) to), this.sync);
        }

        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanSortedMap, java.util.SortedMap
        public Reference2BooleanSortedMap<K> tailMap(K from) {
            return new SynchronizedSortedMap(this.sortedMap.tailMap((Reference2BooleanSortedMap<K>) from), this.sync);
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2BooleanSortedMaps$UnmodifiableSortedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2BooleanSortedMaps$UnmodifiableSortedMap.class */
    public static class UnmodifiableSortedMap<K> extends Reference2BooleanMaps.UnmodifiableMap<K> implements Reference2BooleanSortedMap<K>, Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanMaps.UnmodifiableMap, p014it.unimi.dsi.fastutil.objects.Reference2BooleanMap
        public ObjectSortedSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() {
            if (this.entries == null) {
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanMaps.UnmodifiableMap, p014it.unimi.dsi.fastutil.objects.Reference2BooleanMap, java.util.Map
        @Deprecated
        public ObjectSortedSet<Map.Entry<K, Boolean>> entrySet() {
            return reference2BooleanEntrySet();
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanSortedMap, java.util.SortedMap
        public Reference2BooleanSortedMap<K> headMap(K to) {
            return new UnmodifiableSortedMap(this.sortedMap.headMap((Reference2BooleanSortedMap<K>) to));
        }

        @Override // p014it.unimi.dsi.fastutil.objects.Reference2BooleanSortedMap, java.util.SortedMap
        public Reference2BooleanSortedMap<K> tailMap(K from) {
            return new UnmodifiableSortedMap(this.sortedMap.tailMap((Reference2BooleanSortedMap<K>) from));
        }
