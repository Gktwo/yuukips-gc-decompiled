...
/* renamed from: it.unimi.dsi.fastutil.objects.Reference2DoubleArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2DoubleArrayMap.class */
public class Reference2DoubleArrayMap<K> extends AbstractReference2DoubleMap<K> implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Reference2DoubleArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Reference2DoubleArrayMap(Reference2DoubleMap<K> m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Reference2DoubleMap.Entry<K>> it = m.reference2DoubleEntrySet().iterator();
        while (it.hasNext()) {
            Reference2DoubleMap.Entry<K> e = it.next();
            this.key[i] = e.getKey();
    ...
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2DoubleArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2DoubleArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Reference2DoubleMap.Entry<K>> implements Reference2DoubleMap.FastEntrySet<K> {
        private EntrySet() {
        }

        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
        public ObjectIterator<Reference2DoubleMap.Entry<K>> iterator() {
            return new ObjectIterator<Reference2DoubleMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Reference2DoubleArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Reference2DoubleMap.Entry<K> next() {
                    ...
                    Object[] objArr = Reference2DoubleArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    Object obj = objArr[i];
                    double[] dArr = Reference2DoubleArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractReference2DoubleMap.BasicEntry(obj, dArr[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Reference2DoubleArrayMap.access$010(Reference2DoubleArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Reference2DoubleMap.Entry<K>> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractReference2DoubleMap.BasicEntry(obj, dArr[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Reference2DoubleMap.Entry<K>> fastIterator() {
            return new ObjectIterator<Reference2DoubleMap.Entry<K>>() { // from class: it.unimi.dsi.fastutil.objects.Reference2DoubleArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Reference2DoubleMap.Entry<K> next() {
                    ...
                    AbstractReference2DoubleMap.BasicEntry<K> basicEntry = this.entry;
                    Object[] objArr = Reference2DoubleArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = (K) objArr[i];
                    AbstractReference2DoubleMap.BasicEntry<K> basicEntry2 = this.entry;
                    double[] dArr = Reference2DoubleArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.objects.Reference2DoubleArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2DoubleArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Reference2DoubleMap.Entry<K>> implements ObjectSpliterator<Reference2DoubleMap.Entry<K>> {
            ...
            public final Reference2DoubleMap.Entry<K> get(int location) {
                return new AbstractReference2DoubleMap.BasicEntry(Reference2DoubleArrayMap.this.key[location], Reference2DoubleArrayMap.this.value[location]);
            }

            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Reference2DoubleArrayMap<K>.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
        ...
        public void forEach(Consumer<? super Reference2DoubleMap.Entry<K>> action) {
            int max = Reference2DoubleArrayMap.this.size;
            for (int i = 0; i < max; i++) {
                action.accept(new AbstractReference2DoubleMap.BasicEntry(Reference2DoubleArrayMap.this.key[i], Reference2DoubleArrayMap.this.value[i]));
            }
        }
        ...
        public boolean contains(Object o) {
            ...
            Object key = e.getKey();
            return Reference2DoubleArrayMap.this.containsKey(key) && Double.doubleToLongBits(Reference2DoubleArrayMap.this.getDouble(key)) == Double.doubleToLongBits(((Double) e.getValue()).doubleValue());
        }
        ...
        public boolean remove(Object o) {
            ...
            int oldPos = Reference2DoubleArrayMap.this.findKey(key);
            ...
            Reference2DoubleArrayMap.access$010(Reference2DoubleArrayMap.this);
            Reference2DoubleArrayMap.this.key[Reference2DoubleArrayMap.this.size] = null;
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2DoubleArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2DoubleArrayMap$KeySet.class */
    public final class KeySet extends AbstractReferenceSet<K> {
        ...
        public ObjectIterator<K> iterator() {
            return new ObjectIterator<K>() { // from class: it.unimi.dsi.fastutil.objects.Reference2DoubleArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Reference2DoubleArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2DoubleArrayMap$KeySet$KeySetSpliterator.class */
        public final class KeySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<K> implements ObjectSpliterator<K> {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Reference2DoubleArrayMap<K>.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.objects.Reference2DoubleArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2DoubleArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractDoubleCollection {
        ...
        public DoubleIterator iterator() {
            return new DoubleIterator() { // from class: it.unimi.dsi.fastutil.objects.Reference2DoubleArrayMap.ValuesCollection.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.objects.Reference2DoubleArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/objects/Reference2DoubleArrayMap$ValuesCollection$ValuesSpliterator.class */
        public final class ValuesSpliterator extends DoubleSpliterators.EarlyBindingSizeIndexBasedSpliterator implements DoubleSpliterator {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.doubles.DoubleSpliterators.AbstractIndexBasedSpliterator
            public final Reference2DoubleArrayMap<K>.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
    ...
    public Reference2DoubleArrayMap<K> clone() {
        try {
            Reference2DoubleArrayMap<K> c = (Reference2DoubleArrayMap) clone();
