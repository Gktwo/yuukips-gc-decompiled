...
public class Object2DoubleRBTreeMap<K> extends AbstractObject2DoubleSortedMap<K> implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractObject2DoubleSortedMap<K> implements Serializable {
        ...
        final boolean m599in(K k) {
            return (this.bottom || Object2DoubleRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Object2DoubleRBTreeMap.this.compare(k, this.f2595to) < 0);
        }
        ...
        public double put(K k, double v) {
            ...
            if (!m599in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f2595to)) + ")");
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.objects.Object2DoubleSortedMap, java.util.SortedMap
        public Object2DoubleSortedMap<K> headMap(K to) {
            if (!this.top && Object2DoubleRBTreeMap.this.compare(to, this.f2595to) >= 0) {
                return this;
            }
        ...
        public Object2DoubleSortedMap<K> tailMap(K from) {
            ...
            return new Submap(from, false, this.f2595to, this.top);
        }
        ...
        public Object2DoubleSortedMap<K> subMap(K from, K to) {
            ...
            if (!this.top) {
                to = Object2DoubleRBTreeMap.this.compare(to, this.f2595to) < 0 ? to : this.f2595to;
            }
            if (!this.bottom) {
                from = Object2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f2595to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry<K> firstEntry() {
            ...
            if (this.top || Object2DoubleRBTreeMap.this.compare(e.key, this.f2595to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry<K> lastEntry() {
            ...
            if (this.top) {
                ...
                e = Object2DoubleRBTreeMap.this.locateKey(this.f2595to);
                if (Object2DoubleRBTreeMap.this.compare(e.key, this.f2595to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends Object2DoubleRBTreeMap<K>.TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Object2DoubleRBTreeMap.this.compare(this.next.key, Submap.this.f2595to) >= 0) {
                    this.next = null;
                }
            }
        }
