...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatFunctions.class */
public final class Long2FloatFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractLong2FloatFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2FloatFunction, p014it.unimi.dsi.fastutil.longs.Long2FloatFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Long2FloatFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Long2FloatFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Long2FloatFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2FloatFunction, java.util.function.LongToDoubleFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractLong2FloatFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Long2FloatFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Long2FloatFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Long2FloatFunction {
        ...
        public float get(long key) {
            Float v = (Float) this.function.apply(Long.valueOf(key));
        ...
        public Float get(Object key) {
            ...
            return (Float) this.function.apply((Long) key);
        }
        ...
        public Float getOrDefault(Object key, Float defaultValue) {
            Float v;
            if (!(key == null || (v = (Float) this.function.apply((Long) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
    ...
    public static Long2FloatFunction primitive(java.util.function.Function<? super Long, ? extends Float> f) {
        ...
        return f instanceof Long2FloatFunction ? (Long2FloatFunction) f : f instanceof LongToDoubleFunction ? key -> {
            return SafeMath.safeDoubleToFloat(((LongToDoubleFunction) f).applyAsDouble(key));
