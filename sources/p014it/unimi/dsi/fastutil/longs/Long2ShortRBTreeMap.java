...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortRBTreeMap.class */
public class Long2ShortRBTreeMap extends AbstractLong2ShortSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap.Entry add(long r10) {
        /*
        // Method dump skipped, instructions count: 947
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap.add(long):it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap$Entry");
    }
    ...
    public short remove(long r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap.remove(long):short");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(long k) {
            Entry locateKey = Long2ShortRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap.1
                final Comparator<? super Long2ShortMap.Entry> comparator;

                {
                    this.comparator = Long2ShortRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Long) && e.getValue() != null && (e.getValue() instanceof Short)) {
                        return e.equals(Long2ShortRBTreeMap.this.findKey(((Long) e.getKey()).longValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Long) || e.getValue() == null || !(e.getValue() instanceof Short) || (f = Long2ShortRBTreeMap.this.findKey(((Long) e.getKey()).longValue())) == null || f.getShortValue() != ((Short) e.getValue()).shortValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortRBTreeMap$ValueIterator.class */
    ...
    public ShortCollection values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortRBTreeMap$Submap.class */
    public final class Submap extends AbstractLong2ShortSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m672in(long k) {
            return (this.bottom || Long2ShortRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2ShortRBTreeMap.this.compare(k, this.f2382to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.longs.Long2ShortMap, p014it.unimi.dsi.fastutil.longs.Long2ShortSortedMap
        public ObjectSortedSet<Long2ShortMap.Entry> long2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Long2ShortMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Long) && e.getValue() != null && (e.getValue() instanceof Short) && (f = Long2ShortRBTreeMap.this.findKey(((Long) e.getKey()).longValue())) != null && Submap.this.m672in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Long2ShortRBTreeMap.this.findKey(((Long) e.getKey()).longValue());
                        if (f != null && Submap.this.m672in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractLong2ShortSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ShortCollection values() {
            if (this.values == null) {
                this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShortCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.shorts.ShortCollection, p014it.unimi.dsi.fastutil.shorts.ShortIterable
                    public ShortIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2ShortMap, p014it.unimi.dsi.fastutil.longs.Long2ShortFunction, p014it.unimi.dsi.fastutil.longs.Long2ShortMap
        public boolean containsKey(long k) {
            return m672in(k) && Long2ShortRBTreeMap.this.containsKey(k);
        }
        ...
        public short get(long k) {
            Entry e;
            return (!m672in(k) || (e = Long2ShortRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public short put(long k, short v) {
            ...
            if (!m672in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f2382to)) + ")");
            }
            return Long2ShortRBTreeMap.this.modified ? this.defRetValue : Long2ShortRBTreeMap.this.put(k, v);
        }
        ...
        public short remove(long k) {
            ...
            return Long2ShortRBTreeMap.this.modified ? Long2ShortRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2ShortSortedMap
        public Long2ShortSortedMap headMap(long to) {
            if (!this.top && Long2ShortRBTreeMap.this.compare(to, this.f2382to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2ShortSortedMap
        public Long2ShortSortedMap tailMap(long from) {
            if (!this.bottom && Long2ShortRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f2382to, this.top);
        }
        ...
        public Long2ShortSortedMap subMap(long j, long j2) {
            ...
            long to = j2;
            if (!this.top) {
                to = Long2ShortRBTreeMap.this.compare(j2, this.f2382to) < 0 ? j2 : this.f2382to;
            }
            long from = j;
            if (!this.bottom) {
                from = Long2ShortRBTreeMap.this.compare(j, this.from) > 0 ? j : this.from;
            }
            if (!this.top && !this.bottom) {
                if ((from == 1 ? 1 : 0) == this.from) {
                    if ((to == 1 ? 1 : 0) == this.f2382to) {
                        return this;
                    }
                }
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Long2ShortRBTreeMap.this.compare(e.key, this.f2382to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Long2ShortRBTreeMap.this.locateKey(this.f2382to);
                if (Long2ShortRBTreeMap.this.compare(e.key, this.f2382to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Long2ShortRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, long k) {
                ...
                if (submap.bottom || Long2ShortRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Long2ShortRBTreeMap long2ShortRBTreeMap = Long2ShortRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (long2ShortRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Long2ShortRBTreeMap.this.compare(this.next.key, Submap.this.f2382to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Long2ShortRBTreeMap clone() {
        try {
            Long2ShortRBTreeMap c = (Long2ShortRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
