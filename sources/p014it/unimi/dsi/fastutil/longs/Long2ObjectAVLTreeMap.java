...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ObjectAVLTreeMap.class */
public class Long2ObjectAVLTreeMap<V> extends AbstractLong2ObjectSortedMap<V> implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Long2ObjectAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    public V remove(long r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap.remove(long):java.lang.Object");
    }

    @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2ObjectMap, java.util.Map
    public boolean containsValue(Object v) {
        Long2ObjectAVLTreeMap<V>.ValueIterator i = new ValueIterator();
        int j = this.count;
        do {
            j--;
            if (j == 0) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ObjectAVLTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ObjectAVLTreeMap$TreeIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ObjectAVLTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap.1
                final Comparator<? super Long2ObjectMap.Entry<V>> comparator;

                {
                    this.comparator = Long2ObjectAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Long)) {
                        return e.equals(Long2ObjectAVLTreeMap.this.findKey(((Long) e.getKey()).longValue()));
                    }
                    return false;
                }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ObjectAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ObjectAVLTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ObjectAVLTreeMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ObjectAVLTreeMap$Submap.class */
    public final class Submap extends AbstractLong2ObjectSortedMap<V> implements Serializable {
        ...
        /* renamed from: in */
        final boolean m677in(long k) {
            return (this.bottom || Long2ObjectAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2ObjectAVLTreeMap.this.compare(k, this.f2311to) < 0);
        }
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap.Submap.1
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Long) && (f = Long2ObjectAVLTreeMap.this.findKey(((Long) e.getKey()).longValue())) != null && Submap.this.m677in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        if (f != null && Submap.this.m677in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ObjectAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractLong2ObjectSortedMap<V>.KeySet {
            private KeySet() {
                super();
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2ObjectMap, p014it.unimi.dsi.fastutil.longs.Long2ObjectFunction, p014it.unimi.dsi.fastutil.longs.Long2ObjectMap
        public boolean containsKey(long k) {
            return m677in(k) && Long2ObjectAVLTreeMap.this.containsKey(k);
        }
        ...
        public V get(long k) {
            Entry<V> e;
            return (!m677in(k) || (e = Long2ObjectAVLTreeMap.this.findKey(k)) == null) ? (V) this.defRetValue : (V) e.value;
        }
        ...
        public V put(long k, V v) {
            ...
            if (!m677in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f2311to)) + ")");
            }
            return Long2ObjectAVLTreeMap.this.modified ? (V) this.defRetValue : (V) Long2ObjectAVLTreeMap.this.put(k, (long) v);
        }
        ...
        public V remove(long k) {
            ...
            return Long2ObjectAVLTreeMap.this.modified ? (V) Long2ObjectAVLTreeMap.this.remove(k) : (V) this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2ObjectSortedMap
        public Long2ObjectSortedMap<V> headMap(long to) {
            if (!this.top && Long2ObjectAVLTreeMap.this.compare(to, this.f2311to) >= 0) {
                return this;
            }
        ...
        public Long2ObjectSortedMap<V> tailMap(long from) {
            ...
            return new Submap(from, false, this.f2311to, this.top);
        }
        ...
        public Long2ObjectSortedMap<V> subMap(long j, long j2) {
            ...
            long to = j2;
            if (!this.top) {
                to = Long2ObjectAVLTreeMap.this.compare(j2, this.f2311to) < 0 ? j2 : this.f2311to;
            }
            long from = j;
            if (!this.bottom) {
                from = Long2ObjectAVLTreeMap.this.compare(j, this.from) > 0 ? j : this.from;
            }
            if (!this.top && !this.bottom) {
                if ((from == 1 ? 1 : 0) == this.from) {
                    if ((to == 1 ? 1 : 0) == this.f2311to) {
                        return this;
                    }
                }
            }
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.top || Long2ObjectAVLTreeMap.this.compare(e.key, this.f2311to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                ...
                e = Long2ObjectAVLTreeMap.this.locateKey(this.f2311to);
                if (Long2ObjectAVLTreeMap.this.compare(e.key, this.f2311to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Long2ObjectAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ObjectAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends Long2ObjectAVLTreeMap<V>.TreeIterator {
            ...
            @Override // p014it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Long2ObjectAVLTreeMap.this.compare(this.next.key, Submap.this.f2311to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ObjectAVLTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ObjectAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ObjectAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ObjectAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Long2ObjectAVLTreeMap<V> clone() {
        try {
            Long2ObjectAVLTreeMap<V> c = (Long2ObjectAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
