...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatOpenHashMap.class */
public class Long2FloatOpenHashMap extends AbstractLong2FloatMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f2282n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f2283f;
    ...
    public Long2FloatOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f2282n = arraySize;
            this.minN = arraySize;
            this.mask = this.f2282n - 1;
            this.maxFill = HashCommon.maxFill(this.f2282n, f);
            this.key = new long[this.f2282n + 1];
            this.value = new float[this.f2282n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f2283f);
        if (needed > this.f2282n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f2283f)))));
        if (needed > this.f2282n) {
            rehash(needed);
        }
    }
    ...
    public float removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f2282n > this.minN && this.size < this.maxFill / 4 && this.f2282n > 16) {
            rehash(this.f2282n / 2);
        }
        return oldValue;
    }
    ...
    public float removeNullEntry() {
        ...
        float oldValue = this.value[this.f2282n];
        this.size--;
        if (this.f2282n > this.minN && this.size < this.maxFill / 4 && this.f2282n > 16) {
            rehash(this.f2282n / 2);
        }
    ...
    private int find(long k) {
        long curr;
        if (k == 0) {
            return this.containsNullKey ? this.f2282n : -(this.f2282n + 1);
        }
        long[] key = this.key;
    ...
    private void insert(int pos, long k, float v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f2283f));
        }
    }
    ...
    public float addTo(long k, float incr) {
        ...
        if (k != 0) {
            ...
            return addToValue(this.f2282n, incr);
        } else {
            pos = this.f2282n;
            this.containsNullKey = true;
        }
    ...
    public float get(long k) {
        long curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f2282n] : this.defRetValue;
        }
        long[] key = this.key;
        int mix = ((int) HashCommon.mix(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(float v) {
        ...
        long[] key = this.key;
        if (this.containsNullKey && Float.floatToIntBits(value[this.f2282n]) == Float.floatToIntBits(v)) {
            return true;
        }
        int i = this.f2282n;
        while (true) {
    ...
    public float getOrDefault(long k, float defaultValue) {
        long curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f2282n] : defaultValue;
        }
        long[] key = this.key;
        int mix = ((int) HashCommon.mix(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(long k, float v) {
        ...
        } else if (!this.containsNullKey || Float.floatToIntBits(v) != Float.floatToIntBits(this.value[this.f2282n])) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatOpenHashMap$MapEntry.class */
    public final class MapEntry implements Long2FloatMap.Entry, Map.Entry<Long, Float>, LongFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            return Long2FloatOpenHashMap.this.key[this.index] == e.getKey().longValue() && Float.floatToIntBits(Long2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue().floatValue());
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Long2FloatOpenHashMap.this.f2282n;
            this.last = -1;
            this.f2284c = Long2FloatOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Long2FloatOpenHashMap.this.f2282n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int i3 = Long2FloatOpenHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (k == key[p]) {
                            return p;
                        ...
                        mix = p + 1;
                        i3 = Long2FloatOpenHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Long2FloatOpenHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Long2FloatOpenHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Long2FloatOpenHashMap.this.value[pos] = Long2FloatOpenHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Long2FloatOpenHashMap.this.f2282n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Long2FloatMap.Entry>> implements ObjectIterator<Long2FloatMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatOpenHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Long2FloatOpenHashMap.this.f2282n;
            this.f2285c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2285c++;
                acceptOnIndex(action, Long2FloatOpenHashMap.this.f2282n);
                return true;
            }
            long[] key = Long2FloatOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Long2FloatOpenHashMap.this.size - this.f2285c);
            }
            return Math.min((long) (Long2FloatOpenHashMap.this.size - this.f2285c), ((long) ((((double) Long2FloatOpenHashMap.this.realSize()) / ((double) Long2FloatOpenHashMap.this.f2282n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap r0 = p014it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap.this
                long[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0077:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Long2FloatMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Long2FloatMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Long2FloatMap.Entry> implements Long2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Long2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.f2282n]) == Float.floatToIntBits(v);
            }
            long[] key = Long2FloatOpenHashMap.this.key;
            int mix = ((int) HashCommon.mix(k)) & Long2FloatOpenHashMap.this.mask;
            int pos = mix;
            long curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            ...
            do {
                int i = (pos + 1) & Long2FloatOpenHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (k != 0) {
                ...
                if (curr != k) {
                    while (true) {
                        ...
                        if (curr2 == k && Float.floatToIntBits(Long2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
                            Long2FloatOpenHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Float.floatToIntBits(Long2FloatOpenHashMap.this.value[pos]) != Float.floatToIntBits(v)) {
                    return false;
                } else {
                    Long2FloatOpenHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Long2FloatOpenHashMap.this.containsNullKey || Float.floatToIntBits(Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.f2282n]) != Float.floatToIntBits(v)) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Long2FloatMap.Entry> consumer) {
            if (Long2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractLong2FloatMap.BasicEntry(Long2FloatOpenHashMap.this.key[Long2FloatOpenHashMap.this.f2282n], Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.f2282n]));
            }
            int pos = Long2FloatOpenHashMap.this.f2282n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
                }
                if (Long2FloatOpenHashMap.this.key[pos] != 0) {
        ...
        public void fastForEach(Consumer<? super Long2FloatMap.Entry> consumer) {
            ...
            if (Long2FloatOpenHashMap.this.containsNullKey) {
                entry.key = Long2FloatOpenHashMap.this.key[Long2FloatOpenHashMap.this.f2282n];
                entry.value = Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.f2282n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatOpenHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatOpenHashMap$KeySet.class */
    public final class KeySet extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            if (Long2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(Long2FloatOpenHashMap.this.key[Long2FloatOpenHashMap.this.f2282n]);
            }
            int pos = Long2FloatOpenHashMap.this.f2282n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2FloatOpenHashMap$ValueSpliterator.class */
    ...
    public Collection<Float> values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection() { // from class: it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap.1
                ...
                public void forEach(FloatConsumer consumer) {
                    if (Long2FloatOpenHashMap.this.containsNullKey) {
                        consumer.accept(Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.f2282n]);
                    }
                    int pos = Long2FloatOpenHashMap.this.f2282n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f2283f)));
        if (l >= this.f2282n || this.size > HashCommon.maxFill(l, this.f2283f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2282n];
                this.f2282n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f2282n, this.f2283f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Long2FloatOpenHashMap clone() {
        try {
            Long2FloatOpenHashMap c = (Long2FloatOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.float2int(this.value[this.f2282n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f2282n = HashCommon.arraySize(this.size, this.f2283f);
        this.maxFill = HashCommon.maxFill(this.f2282n, this.f2283f);
        this.mask = this.f2282n - 1;
        long[] key = new long[this.f2282n + 1];
        this.key = key;
        float[] value = new float[this.f2282n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
