...
public class Long2FloatOpenHashMap extends AbstractLong2FloatMap implements Serializable, Cloneable, Hash {
    ...
    public Long2FloatOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new float[this.f2318n + 1];
        }
    }
    ...
    public float removeNullEntry() {
        ...
        float oldValue = this.value[this.f2318n];
        this.size--;
        if (this.f2318n > this.minN && this.size < this.maxFill / 4 && this.f2318n > 16) {
            rehash(this.f2318n / 2);
        }
    ...
    public float addTo(long k, float incr) {
        ...
        if (k != 0) {
            ...
            return addToValue(this.f2318n, incr);
        } else {
            pos = this.f2318n;
            this.containsNullKey = true;
        }
    ...
    public float get(long k) {
        long curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f2318n] : this.defRetValue;
        }
        long[] key = this.key;
        int mix = ((int) HashCommon.mix(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(float v) {
        ...
        long[] key = this.key;
        if (this.containsNullKey && Float.floatToIntBits(value[this.f2318n]) == Float.floatToIntBits(v)) {
            return true;
        }
        int i = this.f2318n;
        while (true) {
    ...
    public boolean remove(long k, float v) {
        ...
        } else if (!this.containsNullKey || Float.floatToIntBits(v) != Float.floatToIntBits(this.value[this.f2318n])) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Long2FloatOpenHashMap.this.f2318n;
            this.last = -1;
            this.f2320c = Long2FloatOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Long2FloatOpenHashMap.this.f2318n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Long2FloatOpenHashMap.this.f2318n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Long2FloatOpenHashMap.this.f2318n;
            this.f2321c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2321c++;
                acceptOnIndex(action, Long2FloatOpenHashMap.this.f2318n);
                return true;
            }
            long[] key = Long2FloatOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Long2FloatOpenHashMap.this.size - this.f2321c);
            }
            return Math.min((long) (Long2FloatOpenHashMap.this.size - this.f2321c), ((long) ((((double) Long2FloatOpenHashMap.this.realSize()) / ((double) Long2FloatOpenHashMap.this.f2318n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Long2FloatMap.Entry> implements Long2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Long2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.f2318n]) == Float.floatToIntBits(v);
            }
            long[] key = Long2FloatOpenHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Long2FloatOpenHashMap.this.containsNullKey || Float.floatToIntBits(Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.f2318n]) != Float.floatToIntBits(v)) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Long2FloatMap.Entry> consumer) {
            if (Long2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractLong2FloatMap.BasicEntry(Long2FloatOpenHashMap.this.key[Long2FloatOpenHashMap.this.f2318n], Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.f2318n]));
            }
            int pos = Long2FloatOpenHashMap.this.f2318n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Long2FloatMap.Entry> consumer) {
            ...
            if (Long2FloatOpenHashMap.this.containsNullKey) {
                entry.key = Long2FloatOpenHashMap.this.key[Long2FloatOpenHashMap.this.f2318n];
                entry.value = Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.f2318n];
    ...
    public final class KeySet extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            if (Long2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(Long2FloatOpenHashMap.this.key[Long2FloatOpenHashMap.this.f2318n]);
            }
            int pos = Long2FloatOpenHashMap.this.f2318n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection() { // from class: it.unimi.dsi.fastutil.longs.Long2FloatOpenHashMap.1
                ...
                public void forEach(FloatConsumer consumer) {
                    if (Long2FloatOpenHashMap.this.containsNullKey) {
                        consumer.accept(Long2FloatOpenHashMap.this.value[Long2FloatOpenHashMap.this.f2318n]);
                    }
                    int pos = Long2FloatOpenHashMap.this.f2318n;
                    while (true) {
                        pos--;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.float2int(this.value[this.f2318n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        float[] value = new float[this.f2318n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
