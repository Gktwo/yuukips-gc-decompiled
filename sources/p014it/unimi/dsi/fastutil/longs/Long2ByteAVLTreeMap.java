...
import p014it.unimi.dsi.fastutil.longs.AbstractLong2ByteSortedMap;
...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteAVLTreeMap.class */
public class Long2ByteAVLTreeMap extends AbstractLong2ByteSortedMap implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Long2ByteAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    public byte remove(long r7) {
        /*
        // Method dump skipped, instructions count: 1527
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap.remove(long):byte");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteAVLTreeMap$Entry.class */
    public static final class Entry extends AbstractLong2ByteMap.BasicEntry implements Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2ByteMap.BasicEntry, p014it.unimi.dsi.fastutil.longs.Long2ByteMap.Entry
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2ByteMap.BasicEntry, java.util.Map.Entry, java.lang.Object
        public boolean equals(Object o) {
            if (!(o instanceof Map.Entry)) {
                return false;
            }
            Map.Entry<Long, Byte> e = (Map.Entry) o;
            return this.key == e.getKey().longValue() && this.value == e.getValue().byteValue();
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2ByteMap.BasicEntry, java.lang.Object
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(long k) {
            Entry locateKey = Long2ByteAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteAVLTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap.1
                final Comparator<? super Long2ByteMap.Entry> comparator;

                {
                    this.comparator = Long2ByteAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Long) && e.getValue() != null && (e.getValue() instanceof Byte)) {
                        return e.equals(Long2ByteAVLTreeMap.this.findKey(((Long) e.getKey()).longValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Long) || !(e.getValue() instanceof Byte) || (f = Long2ByteAVLTreeMap.this.findKey(((Long) e.getKey()).longValue())) == null || f.getByteValue() != ((Byte) e.getValue()).byteValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteAVLTreeMap$ValueIterator.class */
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteAVLTreeMap$Submap.class */
    public final class Submap extends AbstractLong2ByteSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m689in(long k) {
            return (this.bottom || Long2ByteAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2ByteAVLTreeMap.this.compare(k, this.f2239to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.longs.Long2ByteMap, p014it.unimi.dsi.fastutil.longs.Long2ByteSortedMap
        public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Long) && e.getValue() != null && (e.getValue() instanceof Byte) && (f = Long2ByteAVLTreeMap.this.findKey(((Long) e.getKey()).longValue())) != null && Submap.this.m689in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Long2ByteAVLTreeMap.this.findKey(((Long) e.getKey()).longValue());
                        if (f != null && Submap.this.m689in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractLong2ByteSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ByteCollection values() {
            if (this.values == null) {
                this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByteCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.bytes.ByteCollection, p014it.unimi.dsi.fastutil.bytes.ByteIterable, p014it.unimi.dsi.fastutil.bytes.ByteSet, java.util.Set
                    public ByteIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2ByteMap, p014it.unimi.dsi.fastutil.longs.Long2ByteFunction, p014it.unimi.dsi.fastutil.longs.Long2ByteMap
        public boolean containsKey(long k) {
            return m689in(k) && Long2ByteAVLTreeMap.this.containsKey(k);
        }
        ...
        public byte get(long k) {
            Entry e;
            return (!m689in(k) || (e = Long2ByteAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public byte put(long k, byte v) {
            ...
            if (!m689in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f2239to)) + ")");
            }
            return Long2ByteAVLTreeMap.this.modified ? this.defRetValue : Long2ByteAVLTreeMap.this.put(k, v);
        }
        ...
        public byte remove(long k) {
            ...
            return Long2ByteAVLTreeMap.this.modified ? Long2ByteAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2ByteSortedMap
        public Long2ByteSortedMap headMap(long to) {
            if (!this.top && Long2ByteAVLTreeMap.this.compare(to, this.f2239to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2ByteSortedMap
        public Long2ByteSortedMap tailMap(long from) {
            if (!this.bottom && Long2ByteAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f2239to, this.top);
        }
        ...
        public Long2ByteSortedMap subMap(long j, long j2) {
            ...
            long to = j2;
            if (!this.top) {
                to = Long2ByteAVLTreeMap.this.compare(j2, this.f2239to) < 0 ? j2 : this.f2239to;
            }
            long from = j;
            if (!this.bottom) {
                from = Long2ByteAVLTreeMap.this.compare(j, this.from) > 0 ? j : this.from;
            }
            if (!this.top && !this.bottom) {
                if ((from == 1 ? 1 : 0) == this.from) {
                    if ((to == 1 ? 1 : 0) == this.f2239to) {
                        return this;
                    }
                }
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Long2ByteAVLTreeMap.this.compare(e.key, this.f2239to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Long2ByteAVLTreeMap.this.locateKey(this.f2239to);
                if (Long2ByteAVLTreeMap.this.compare(e.key, this.f2239to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Long2ByteAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, long k) {
                ...
                if (submap.bottom || Long2ByteAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Long2ByteAVLTreeMap long2ByteAVLTreeMap = Long2ByteAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (long2ByteAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Long2ByteAVLTreeMap.this.compare(this.next.key, Submap.this.f2239to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteAVLTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Long2ByteAVLTreeMap clone() {
        try {
            Long2ByteAVLTreeMap c = (Long2ByteAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n == 1) {
            ...
            Entry top2 = new Entry(s.readLong(), s.readByte());
            top2.right(new Entry(s.readLong(), s.readByte()));
