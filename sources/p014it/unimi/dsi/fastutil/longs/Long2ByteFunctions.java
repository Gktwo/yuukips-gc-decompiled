...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteFunctions.class */
public final class Long2ByteFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractLong2ByteFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2ByteFunction, p014it.unimi.dsi.fastutil.longs.Long2ByteFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Long2ByteFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Long2ByteFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Long2ByteFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2ByteFunction, java.util.function.LongToIntFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractLong2ByteFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Long2ByteFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Long2ByteFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Long2ByteFunction {
        ...
        public byte get(long key) {
            Byte v = (Byte) this.function.apply(Long.valueOf(key));
        ...
        public Byte get(Object key) {
            ...
            return (Byte) this.function.apply((Long) key);
        }
        ...
        public Byte getOrDefault(Object key, Byte defaultValue) {
            Byte v;
            if (!(key == null || (v = (Byte) this.function.apply((Long) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
    ...
    public static Long2ByteFunction primitive(java.util.function.Function<? super Long, ? extends Byte> f) {
        ...
        return f instanceof Long2ByteFunction ? (Long2ByteFunction) f : f instanceof LongToIntFunction ? key -> {
            return SafeMath.safeIntToByte(((LongToIntFunction) f).applyAsInt(key));
