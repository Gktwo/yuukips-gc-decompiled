...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteRBTreeMap.class */
public class Long2ByteRBTreeMap extends AbstractLong2ByteSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap.Entry add(long r10) {
        /*
        // Method dump skipped, instructions count: 947
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap.add(long):it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap$Entry");
    }
    ...
    public byte remove(long r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap.remove(long):byte");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(long k) {
            Entry locateKey = Long2ByteRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap.1
                final Comparator<? super Long2ByteMap.Entry> comparator;

                {
                    this.comparator = Long2ByteRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Long) && e.getValue() != null && (e.getValue() instanceof Byte)) {
                        return e.equals(Long2ByteRBTreeMap.this.findKey(((Long) e.getKey()).longValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Long) || e.getValue() == null || !(e.getValue() instanceof Byte) || (f = Long2ByteRBTreeMap.this.findKey(((Long) e.getKey()).longValue())) == null || f.getByteValue() != ((Byte) e.getValue()).byteValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteRBTreeMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteRBTreeMap$Submap.class */
    public final class Submap extends AbstractLong2ByteSortedMap implements Serializable {
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap.Submap.1
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Long) && e.getValue() != null && (e.getValue() instanceof Byte) && (f = Long2ByteRBTreeMap.this.findKey(((Long) e.getKey()).longValue())) != null && Submap.this.m688in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Long2ByteRBTreeMap.this.findKey(((Long) e.getKey()).longValue());
                        if (f != null && Submap.this.m688in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractLong2ByteSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2ByteMap, p014it.unimi.dsi.fastutil.longs.Long2ByteFunction, p014it.unimi.dsi.fastutil.longs.Long2ByteMap
        public boolean containsKey(long k) {
            return m688in(k) && Long2ByteRBTreeMap.this.containsKey(k);
        }
        ...
        public byte get(long k) {
            Entry e;
            return (!m688in(k) || (e = Long2ByteRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public byte remove(long k) {
            ...
            return Long2ByteRBTreeMap.this.modified ? Long2ByteRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        public Long2ByteSortedMap subMap(long j, long j2) {
            ...
            long from = j;
            if (!this.bottom) {
                from = Long2ByteRBTreeMap.this.compare(j, this.from) > 0 ? j : this.from;
            }
            if (!this.top && !this.bottom) {
        ...
        public Entry lastEntry() {
            ...
            if (this.bottom || Long2ByteRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, long k) {
                ...
                if (submap.bottom || Long2ByteRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Long2ByteRBTreeMap long2ByteRBTreeMap = Long2ByteRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (long2ByteRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Long2ByteRBTreeMap clone() {
        try {
            Long2ByteRBTreeMap c = (Long2ByteRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
