...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ReferenceRBTreeMap.class */
public class Long2ReferenceRBTreeMap<V> extends AbstractLong2ReferenceSortedMap<V> implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap.Entry<V> add(long r10) {
        /*
        // Method dump skipped, instructions count: 947
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap.add(long):it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap$Entry");
    }
    ...
    public V remove(long r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap.remove(long):java.lang.Object");
    }

    @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2ReferenceMap, java.util.Map
    public boolean containsValue(Object v) {
        Long2ReferenceRBTreeMap<V>.ValueIterator i = new ValueIterator();
        int j = this.count;
        do {
            j--;
            if (j == 0) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ReferenceRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ReferenceRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(long k) {
            Entry<V> locateKey = Long2ReferenceRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ReferenceRBTreeMap$EntryIterator.class */
    public class EntryIterator extends Long2ReferenceRBTreeMap<V>.TreeIterator implements ObjectListIterator<Long2ReferenceMap.Entry<V>> {
        EntryIterator() {
            super();
        }
    ...
    public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap.1
                final Comparator<? super Long2ReferenceMap.Entry<V>> comparator;

                {
                    this.comparator = Long2ReferenceRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Long)) {
                        return e.equals(Long2ReferenceRBTreeMap.this.findKey(((Long) e.getKey()).longValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Long) || (f = Long2ReferenceRBTreeMap.this.findKey(((Long) e.getKey()).longValue())) == null || f.getValue() != e.getValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ReferenceRBTreeMap$KeyIterator.class */
    public final class KeyIterator extends Long2ReferenceRBTreeMap<V>.TreeIterator implements LongListIterator {
        public KeyIterator() {
            super();
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ReferenceRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ReferenceRBTreeMap$ValueIterator.class */
    public final class ValueIterator extends Long2ReferenceRBTreeMap<V>.TreeIterator implements ObjectListIterator<V> {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ReferenceRBTreeMap$Submap.class */
    public final class Submap extends AbstractLong2ReferenceSortedMap<V> implements Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.Function, p014it.unimi.dsi.fastutil.bytes.Byte2BooleanMap, java.util.Map
        public void clear() {
            Long2ReferenceRBTreeMap<V>.Submap.SubmapIterator i = new SubmapIterator();
            while (i.hasNext()) {
                i.nextEntry();
                i.remove();
            }
        ...
        /* renamed from: in */
        final boolean m674in(long k) {
            return (this.bottom || Long2ReferenceRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2ReferenceRBTreeMap.this.compare(k, this.f2370to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.longs.Long2ReferenceMap, p014it.unimi.dsi.fastutil.longs.Long2ReferenceSortedMap
        public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.ObjectSortedSet
                    public /* bridge */ /* synthetic */ ObjectBidirectionalIterator iterator(Object obj) {
                        return iterator((Long2ReferenceMap.Entry) ((Long2ReferenceMap.Entry) obj));
                    }
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Long) && (f = Long2ReferenceRBTreeMap.this.findKey(((Long) e.getKey()).longValue())) != null && Submap.this.m674in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry<V> f = Long2ReferenceRBTreeMap.this.findKey(((Long) e.getKey()).longValue());
                        if (f != null && Submap.this.m674in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ReferenceRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractLong2ReferenceSortedMap<V>.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ReferenceCollection<V> values() {
            if (this.values == null) {
                this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractReferenceCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ReferenceCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection
                    public ObjectIterator<V> iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2ReferenceMap, p014it.unimi.dsi.fastutil.longs.Long2ReferenceFunction, p014it.unimi.dsi.fastutil.longs.Long2ReferenceMap
        public boolean containsKey(long k) {
            return m674in(k) && Long2ReferenceRBTreeMap.this.containsKey(k);
        }
        ...
        public V get(long k) {
            Entry<V> e;
            return (!m674in(k) || (e = Long2ReferenceRBTreeMap.this.findKey(k)) == null) ? (V) this.defRetValue : (V) e.value;
        }
        ...
        public V put(long k, V v) {
            ...
            if (!m674in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f2370to)) + ")");
            }
            return Long2ReferenceRBTreeMap.this.modified ? (V) this.defRetValue : (V) Long2ReferenceRBTreeMap.this.put(k, (long) v);
        }
        ...
        public V remove(long k) {
            ...
            return Long2ReferenceRBTreeMap.this.modified ? (V) Long2ReferenceRBTreeMap.this.remove(k) : (V) this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2ReferenceSortedMap
        public Long2ReferenceSortedMap<V> headMap(long to) {
            if (!this.top && Long2ReferenceRBTreeMap.this.compare(to, this.f2370to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2ReferenceSortedMap
        public Long2ReferenceSortedMap<V> tailMap(long from) {
            if (!this.bottom && Long2ReferenceRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f2370to, this.top);
        }
        ...
        public Long2ReferenceSortedMap<V> subMap(long j, long j2) {
            ...
            long to = j2;
            if (!this.top) {
                to = Long2ReferenceRBTreeMap.this.compare(j2, this.f2370to) < 0 ? j2 : this.f2370to;
            }
            long from = j;
            if (!this.bottom) {
                from = Long2ReferenceRBTreeMap.this.compare(j, this.from) > 0 ? j : this.from;
            }
            if (!this.top && !this.bottom) {
                if ((from == 1 ? 1 : 0) == this.from) {
                    if ((to == 1 ? 1 : 0) == this.f2370to) {
                        return this;
                    }
                }
            }
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.top || Long2ReferenceRBTreeMap.this.compare(e.key, this.f2370to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                ...
                e = Long2ReferenceRBTreeMap.this.locateKey(this.f2370to);
                if (Long2ReferenceRBTreeMap.this.compare(e.key, this.f2370to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Long2ReferenceRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ReferenceRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends Long2ReferenceRBTreeMap<V>.TreeIterator {
            SubmapIterator() {
                super();
            ...
            SubmapIterator(Submap submap, long k) {
                ...
                if (submap.bottom || Long2ReferenceRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Long2ReferenceRBTreeMap long2ReferenceRBTreeMap = Long2ReferenceRBTreeMap.this;
                        Entry<V> lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (long2ReferenceRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Long2ReferenceRBTreeMap.this.compare(this.next.key, Submap.this.f2370to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ReferenceRBTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends Long2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Long2ReferenceMap.Entry<V>> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ReferenceRBTreeMap$Submap$SubmapKeyIterator.class */
        public final class SubmapKeyIterator extends Long2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements LongListIterator {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ReferenceRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ReferenceRBTreeMap$Submap$SubmapValueIterator.class */
        public final class SubmapValueIterator extends Long2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<V> {
    ...
    public Long2ReferenceRBTreeMap<V> clone() {
        try {
            Long2ReferenceRBTreeMap<V> c = (Long2ReferenceRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        int n = this.count;
        Long2ReferenceRBTreeMap<V>.EntryIterator i = new EntryIterator();
