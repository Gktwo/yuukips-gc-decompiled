...
public class Long2BooleanOpenCustomHashMap extends AbstractLong2BooleanMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f2230n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f2231f;
    ...
    public Long2BooleanOpenCustomHashMap(int expected, float f, LongHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f2230n = arraySize;
            this.minN = arraySize;
            this.mask = this.f2230n - 1;
            this.maxFill = HashCommon.maxFill(this.f2230n, f);
            this.key = new long[this.f2230n + 1];
            this.value = new boolean[this.f2230n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f2231f);
        if (needed > this.f2230n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f2231f)))));
        if (needed > this.f2230n) {
            rehash(needed);
        }
    }
    ...
    public boolean removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f2230n > this.minN && this.size < this.maxFill / 4 && this.f2230n > 16) {
            rehash(this.f2230n / 2);
        }
        return oldValue;
    }
    ...
    public boolean removeNullEntry() {
        ...
        boolean oldValue = this.value[this.f2230n];
        this.size--;
        if (this.f2230n > this.minN && this.size < this.maxFill / 4 && this.f2230n > 16) {
            rehash(this.f2230n / 2);
        }
    ...
    private int find(long k) {
        ...
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.f2230n : -(this.f2230n + 1);
        }
        long[] key = this.key;
    ...
    private void insert(int pos, long k, boolean v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f2231f));
        }
    }
    ...
    public boolean get(long k) {
        int i;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2230n] : this.defRetValue;
        }
        long[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(boolean v) {
        ...
        long[] key = this.key;
        if (this.containsNullKey && value[this.f2230n] == v) {
            return true;
        }
        int i = this.f2230n;
        while (true) {
    ...
    public boolean getOrDefault(long k, boolean defaultValue) {
        int i;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2230n] : defaultValue;
        }
        long[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(long k, boolean v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f2230n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Long2BooleanOpenCustomHashMap.this.f2230n;
            this.last = -1;
            this.f2232c = Long2BooleanOpenCustomHashMap.this.size;
            this.mustReturnNullKey = Long2BooleanOpenCustomHashMap.this.containsNullKey;
        }

        public boolean hasNext() {
            return this.f2232c != 0;
        }
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Long2BooleanOpenCustomHashMap.this.f2230n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Long2BooleanOpenCustomHashMap.this.f2230n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Long2BooleanOpenCustomHashMap.this.f2230n;
            this.f2233c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2233c++;
                acceptOnIndex(action, Long2BooleanOpenCustomHashMap.this.f2230n);
                return true;
            }
            long[] key = Long2BooleanOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Long2BooleanOpenCustomHashMap.this.size - this.f2233c);
            }
            return Math.min((long) (Long2BooleanOpenCustomHashMap.this.size - this.f2233c), ((long) ((((double) Long2BooleanOpenCustomHashMap.this.realSize()) / ((double) Long2BooleanOpenCustomHashMap.this.f2230n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Long2BooleanMap.Entry> implements Long2BooleanMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Long2BooleanOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Long2BooleanOpenCustomHashMap.this.containsNullKey && Long2BooleanOpenCustomHashMap.this.value[Long2BooleanOpenCustomHashMap.this.f2230n] == v;
            }
            long[] key = Long2BooleanOpenCustomHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Long2BooleanOpenCustomHashMap.this.containsNullKey || Long2BooleanOpenCustomHashMap.this.value[Long2BooleanOpenCustomHashMap.this.f2230n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Long2BooleanMap.Entry> consumer) {
            if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractLong2BooleanMap.BasicEntry(Long2BooleanOpenCustomHashMap.this.key[Long2BooleanOpenCustomHashMap.this.f2230n], Long2BooleanOpenCustomHashMap.this.value[Long2BooleanOpenCustomHashMap.this.f2230n]));
            }
            int pos = Long2BooleanOpenCustomHashMap.this.f2230n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Long2BooleanMap.Entry> consumer) {
            ...
            if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
                entry.key = Long2BooleanOpenCustomHashMap.this.key[Long2BooleanOpenCustomHashMap.this.f2230n];
                entry.value = Long2BooleanOpenCustomHashMap.this.value[Long2BooleanOpenCustomHashMap.this.f2230n];
    ...
    public final class KeySet extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Long2BooleanOpenCustomHashMap.this.key[Long2BooleanOpenCustomHashMap.this.f2230n]);
            }
            int pos = Long2BooleanOpenCustomHashMap.this.f2230n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection() { // from class: it.unimi.dsi.fastutil.longs.Long2BooleanOpenCustomHashMap.1
                ...
                public void forEach(BooleanConsumer consumer) {
                    if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Long2BooleanOpenCustomHashMap.this.value[Long2BooleanOpenCustomHashMap.this.f2230n]);
                    }
                    int pos = Long2BooleanOpenCustomHashMap.this.f2230n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f2231f)));
        if (l >= this.f2230n || this.size > HashCommon.maxFill(l, this.f2231f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2230n];
                this.f2230n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f2230n, this.f2231f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += this.value[this.f2230n] ? RetcodeOuterClass.Retcode.RET_MP_OTHER_DATA_VERSION_NOT_LATEST_VALUE : RetcodeOuterClass.Retcode.RET_MP_MATCH_FULL_VALUE;
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f2230n = HashCommon.arraySize(this.size, this.f2231f);
        this.maxFill = HashCommon.maxFill(this.f2230n, this.f2231f);
        this.mask = this.f2230n - 1;
        long[] key = new long[this.f2230n + 1];
        this.key = key;
        boolean[] value = new boolean[this.f2230n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
