...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortOpenCustomHashMap.class */
public class Long2ShortOpenCustomHashMap extends AbstractLong2ShortMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f2374n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f2375f;
    ...
    public Long2ShortOpenCustomHashMap(int expected, float f, LongHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f2374n = arraySize;
            this.minN = arraySize;
            this.mask = this.f2374n - 1;
            this.maxFill = HashCommon.maxFill(this.f2374n, f);
            this.key = new long[this.f2374n + 1];
            this.value = new short[this.f2374n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f2375f);
        if (needed > this.f2374n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f2375f)))));
        if (needed > this.f2374n) {
            rehash(needed);
        }
    }
    ...
    public short removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f2374n > this.minN && this.size < this.maxFill / 4 && this.f2374n > 16) {
            rehash(this.f2374n / 2);
        }
        return oldValue;
    }
    ...
    public short removeNullEntry() {
        ...
        short oldValue = this.value[this.f2374n];
        this.size--;
        if (this.f2374n > this.minN && this.size < this.maxFill / 4 && this.f2374n > 16) {
            rehash(this.f2374n / 2);
        }
    ...
    private int find(long k) {
        ...
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.f2374n : -(this.f2374n + 1);
        }
        long[] key = this.key;
    ...
    private void insert(int pos, long k, short v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f2375f));
        }
    }
    ...
    public short addTo(long k, short incr) {
        ...
        if (!this.strategy.equals(k, 0)) {
            ...
            return addToValue(this.f2374n, incr);
        } else {
            pos = this.f2374n;
            this.containsNullKey = true;
        }
    ...
    public short get(long k) {
        int i;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2374n] : this.defRetValue;
        }
        long[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(short v) {
        ...
        long[] key = this.key;
        if (this.containsNullKey && value[this.f2374n] == v) {
            return true;
        }
        int i = this.f2374n;
        while (true) {
    ...
    public short getOrDefault(long k, short defaultValue) {
        int i;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2374n] : defaultValue;
        }
        long[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(long k, short v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f2374n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Long2ShortMap.Entry, Map.Entry<Long, Short>, LongShortPair {
        ...
        public boolean equals(Object o) {
            ...
            return Long2ShortOpenCustomHashMap.this.strategy.equals(Long2ShortOpenCustomHashMap.this.key[this.index], e.getKey().longValue()) && Long2ShortOpenCustomHashMap.this.value[this.index] == e.getValue().shortValue();
        }
        ...
        public String toString() {
            return Long2ShortOpenCustomHashMap.this.key[this.index] + "=>" + ((int) Long2ShortOpenCustomHashMap.this.value[this.index]);
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Long2ShortOpenCustomHashMap.this.f2374n;
            this.last = -1;
            this.f2376c = Long2ShortOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Long2ShortOpenCustomHashMap.this.f2374n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Long2ShortOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Long2ShortOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Long2ShortOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Long2ShortOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Long2ShortOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Long2ShortOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Long2ShortOpenCustomHashMap.this.value[pos] = Long2ShortOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Long2ShortOpenCustomHashMap.this.f2374n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Long2ShortMap.Entry>> implements ObjectIterator<Long2ShortMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Long2ShortOpenCustomHashMap.this.f2374n;
            this.f2377c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2377c++;
                acceptOnIndex(action, Long2ShortOpenCustomHashMap.this.f2374n);
                return true;
            }
            long[] key = Long2ShortOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Long2ShortOpenCustomHashMap.this.size - this.f2377c);
            }
            return Math.min((long) (Long2ShortOpenCustomHashMap.this.size - this.f2377c), ((long) ((((double) Long2ShortOpenCustomHashMap.this.realSize()) / ((double) Long2ShortOpenCustomHashMap.this.f2374n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap.this
                long[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0077:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Long2ShortMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Long2ShortMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Long2ShortMap.Entry> implements Long2ShortMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Long2ShortOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Long2ShortOpenCustomHashMap.this.containsNullKey && Long2ShortOpenCustomHashMap.this.value[Long2ShortOpenCustomHashMap.this.f2374n] == v;
            }
            long[] key = Long2ShortOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Long2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Long2ShortOpenCustomHashMap.this.mask;
            int pos = mix;
            if (key[mix] == 0) {
                return false;
            }
            if (Long2ShortOpenCustomHashMap.this.strategy.equals(k, mix)) {
                return Long2ShortOpenCustomHashMap.this.value[pos] == v;
            }
            do {
                i = (pos + 1) & Long2ShortOpenCustomHashMap.this.mask;
                pos = i;
                if (key[i] == 0) {
                    return false;
                }
            } while (!Long2ShortOpenCustomHashMap.this.strategy.equals(k, i));
            return Long2ShortOpenCustomHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            if (!Long2ShortOpenCustomHashMap.this.strategy.equals(k, 0)) {
                ...
                if (!Long2ShortOpenCustomHashMap.this.strategy.equals(mix, k)) {
                    while (true) {
                        int i = (pos + 1) & Long2ShortOpenCustomHashMap.this.mask;
                        pos = i;
                        if (key[i] == 0) {
                            return false;
                        }
                        if (Long2ShortOpenCustomHashMap.this.strategy.equals(i, k) && Long2ShortOpenCustomHashMap.this.value[pos] == v) {
                            Long2ShortOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Long2ShortOpenCustomHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Long2ShortOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Long2ShortOpenCustomHashMap.this.containsNullKey || Long2ShortOpenCustomHashMap.this.value[Long2ShortOpenCustomHashMap.this.f2374n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Long2ShortMap.Entry> consumer) {
            if (Long2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractLong2ShortMap.BasicEntry(Long2ShortOpenCustomHashMap.this.key[Long2ShortOpenCustomHashMap.this.f2374n], Long2ShortOpenCustomHashMap.this.value[Long2ShortOpenCustomHashMap.this.f2374n]));
            }
            int pos = Long2ShortOpenCustomHashMap.this.f2374n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
                }
                if (Long2ShortOpenCustomHashMap.this.key[pos] != 0) {
        ...
        public void fastForEach(Consumer<? super Long2ShortMap.Entry> consumer) {
            ...
            if (Long2ShortOpenCustomHashMap.this.containsNullKey) {
                entry.key = Long2ShortOpenCustomHashMap.this.key[Long2ShortOpenCustomHashMap.this.f2374n];
                entry.value = Long2ShortOpenCustomHashMap.this.value[Long2ShortOpenCustomHashMap.this.f2374n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            if (Long2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Long2ShortOpenCustomHashMap.this.key[Long2ShortOpenCustomHashMap.this.f2374n]);
            }
            int pos = Long2ShortOpenCustomHashMap.this.f2374n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Short> values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.longs.Long2ShortOpenCustomHashMap.1
                ...
                public void forEach(ShortConsumer consumer) {
                    if (Long2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Long2ShortOpenCustomHashMap.this.value[Long2ShortOpenCustomHashMap.this.f2374n]);
                    }
                    int pos = Long2ShortOpenCustomHashMap.this.f2374n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f2375f)));
        if (l >= this.f2374n || this.size > HashCommon.maxFill(l, this.f2375f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2374n];
                this.f2374n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f2374n, this.f2375f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Long2ShortOpenCustomHashMap clone() {
        try {
            Long2ShortOpenCustomHashMap c = (Long2ShortOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f2374n = HashCommon.arraySize(this.size, this.f2375f);
        this.maxFill = HashCommon.maxFill(this.f2374n, this.f2375f);
        this.mask = this.f2374n - 1;
        long[] key = new long[this.f2374n + 1];
        this.key = key;
        short[] value = new short[this.f2374n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
