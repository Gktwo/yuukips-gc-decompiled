...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteOpenCustomHashMap.class */
public class Long2ByteOpenCustomHashMap extends AbstractLong2ByteMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f2242n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f2243f;
    ...
    public Long2ByteOpenCustomHashMap(int expected, float f, LongHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f2242n = arraySize;
            this.minN = arraySize;
            this.mask = this.f2242n - 1;
            this.maxFill = HashCommon.maxFill(this.f2242n, f);
            this.key = new long[this.f2242n + 1];
            this.value = new byte[this.f2242n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f2243f);
        if (needed > this.f2242n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f2243f)))));
        if (needed > this.f2242n) {
            rehash(needed);
        }
    }
    ...
    public byte removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f2242n > this.minN && this.size < this.maxFill / 4 && this.f2242n > 16) {
            rehash(this.f2242n / 2);
        }
        return oldValue;
    }
    ...
    public byte removeNullEntry() {
        ...
        byte oldValue = this.value[this.f2242n];
        this.size--;
        if (this.f2242n > this.minN && this.size < this.maxFill / 4 && this.f2242n > 16) {
            rehash(this.f2242n / 2);
        }
    ...
    private int find(long k) {
        ...
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.f2242n : -(this.f2242n + 1);
        }
        long[] key = this.key;
    ...
    private void insert(int pos, long k, byte v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f2243f));
        }
    }
    ...
    public byte addTo(long k, byte incr) {
        ...
        if (!this.strategy.equals(k, 0)) {
            ...
            return addToValue(this.f2242n, incr);
        } else {
            pos = this.f2242n;
            this.containsNullKey = true;
        }
    ...
    public byte get(long k) {
        int i;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2242n] : this.defRetValue;
        }
        long[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(byte v) {
        ...
        long[] key = this.key;
        if (this.containsNullKey && value[this.f2242n] == v) {
            return true;
        }
        int i = this.f2242n;
        while (true) {
    ...
    public byte getOrDefault(long k, byte defaultValue) {
        int i;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2242n] : defaultValue;
        }
        long[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(long k, byte v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f2242n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Long2ByteMap.Entry, Map.Entry<Long, Byte>, LongBytePair {
        ...
        public boolean equals(Object o) {
            ...
            return Long2ByteOpenCustomHashMap.this.strategy.equals(Long2ByteOpenCustomHashMap.this.key[this.index], e.getKey().longValue()) && Long2ByteOpenCustomHashMap.this.value[this.index] == e.getValue().byteValue();
        }
        ...
        public String toString() {
            return Long2ByteOpenCustomHashMap.this.key[this.index] + "=>" + ((int) Long2ByteOpenCustomHashMap.this.value[this.index]);
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Long2ByteOpenCustomHashMap.this.f2242n;
            this.last = -1;
            this.f2244c = Long2ByteOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Long2ByteOpenCustomHashMap.this.f2242n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Long2ByteOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Long2ByteOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Long2ByteOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Long2ByteOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Long2ByteOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Long2ByteOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Long2ByteOpenCustomHashMap.this.value[pos] = Long2ByteOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Long2ByteOpenCustomHashMap.this.f2242n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Long2ByteMap.Entry>> implements ObjectIterator<Long2ByteMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Long2ByteOpenCustomHashMap.this.f2242n;
            this.f2245c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2245c++;
                acceptOnIndex(action, Long2ByteOpenCustomHashMap.this.f2242n);
                return true;
            }
            long[] key = Long2ByteOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Long2ByteOpenCustomHashMap.this.size - this.f2245c);
            }
            return Math.min((long) (Long2ByteOpenCustomHashMap.this.size - this.f2245c), ((long) ((((double) Long2ByteOpenCustomHashMap.this.realSize()) / ((double) Long2ByteOpenCustomHashMap.this.f2242n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap.this
                long[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0077:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Long2ByteMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Long2ByteMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Long2ByteMap.Entry> implements Long2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Long2ByteOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Long2ByteOpenCustomHashMap.this.containsNullKey && Long2ByteOpenCustomHashMap.this.value[Long2ByteOpenCustomHashMap.this.f2242n] == v;
            }
            long[] key = Long2ByteOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Long2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Long2ByteOpenCustomHashMap.this.mask;
            int pos = mix;
            if (key[mix] == 0) {
                return false;
            }
            if (Long2ByteOpenCustomHashMap.this.strategy.equals(k, mix)) {
                return Long2ByteOpenCustomHashMap.this.value[pos] == v;
            }
            do {
                i = (pos + 1) & Long2ByteOpenCustomHashMap.this.mask;
                pos = i;
                if (key[i] == 0) {
                    return false;
                }
            } while (!Long2ByteOpenCustomHashMap.this.strategy.equals(k, i));
            return Long2ByteOpenCustomHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            if (!Long2ByteOpenCustomHashMap.this.strategy.equals(k, 0)) {
                ...
                if (!Long2ByteOpenCustomHashMap.this.strategy.equals(mix, k)) {
                    while (true) {
                        int i = (pos + 1) & Long2ByteOpenCustomHashMap.this.mask;
                        pos = i;
                        if (key[i] == 0) {
                            return false;
                        }
                        if (Long2ByteOpenCustomHashMap.this.strategy.equals(i, k) && Long2ByteOpenCustomHashMap.this.value[pos] == v) {
                            Long2ByteOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Long2ByteOpenCustomHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Long2ByteOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Long2ByteOpenCustomHashMap.this.containsNullKey || Long2ByteOpenCustomHashMap.this.value[Long2ByteOpenCustomHashMap.this.f2242n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Long2ByteMap.Entry> consumer) {
            if (Long2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractLong2ByteMap.BasicEntry(Long2ByteOpenCustomHashMap.this.key[Long2ByteOpenCustomHashMap.this.f2242n], Long2ByteOpenCustomHashMap.this.value[Long2ByteOpenCustomHashMap.this.f2242n]));
            }
            int pos = Long2ByteOpenCustomHashMap.this.f2242n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
                }
                if (Long2ByteOpenCustomHashMap.this.key[pos] != 0) {
        ...
        public void fastForEach(Consumer<? super Long2ByteMap.Entry> consumer) {
            ...
            if (Long2ByteOpenCustomHashMap.this.containsNullKey) {
                entry.key = Long2ByteOpenCustomHashMap.this.key[Long2ByteOpenCustomHashMap.this.f2242n];
                entry.value = Long2ByteOpenCustomHashMap.this.value[Long2ByteOpenCustomHashMap.this.f2242n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            if (Long2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Long2ByteOpenCustomHashMap.this.key[Long2ByteOpenCustomHashMap.this.f2242n]);
            }
            int pos = Long2ByteOpenCustomHashMap.this.f2242n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Byte> values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.longs.Long2ByteOpenCustomHashMap.1
                ...
                public void forEach(ByteConsumer consumer) {
                    if (Long2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Long2ByteOpenCustomHashMap.this.value[Long2ByteOpenCustomHashMap.this.f2242n]);
                    }
                    int pos = Long2ByteOpenCustomHashMap.this.f2242n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f2243f)));
        if (l >= this.f2242n || this.size > HashCommon.maxFill(l, this.f2243f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2242n];
                this.f2242n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f2242n, this.f2243f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Long2ByteOpenCustomHashMap clone() {
        try {
            Long2ByteOpenCustomHashMap c = (Long2ByteOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f2242n = HashCommon.arraySize(this.size, this.f2243f);
        this.maxFill = HashCommon.maxFill(this.f2242n, this.f2243f);
        this.mask = this.f2242n - 1;
        long[] key = new long[this.f2242n + 1];
        this.key = key;
        byte[] value = new byte[this.f2242n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
