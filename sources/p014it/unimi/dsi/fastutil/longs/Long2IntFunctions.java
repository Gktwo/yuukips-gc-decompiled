...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2IntFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntFunctions.class */
public final class Long2IntFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractLong2IntFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2IntFunction, p014it.unimi.dsi.fastutil.longs.Long2IntFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Long2IntFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Long2IntFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Long2IntFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2IntFunction, java.util.function.LongToIntFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractLong2IntFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Long2IntFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Long2IntFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Long2IntFunction {
        ...
        public int get(long key) {
            Integer v = (Integer) this.function.apply(Long.valueOf(key));
        ...
        public Integer get(Object key) {
            ...
            return (Integer) this.function.apply((Long) key);
        }
        ...
        public Integer getOrDefault(Object key, Integer defaultValue) {
            Integer v;
            if (!(key == null || (v = (Integer) this.function.apply((Long) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
    ...
    public static Long2IntFunction primitive(java.util.function.Function<? super Long, ? extends Integer> f) {
        ...
        LongToIntFunction longToIntFunction = (LongToIntFunction) f;
