...
public class Long2ReferenceAVLTreeMap<V> extends AbstractLong2ReferenceSortedMap<V> implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractLong2ReferenceSortedMap<V> implements Serializable {
        ...
        final boolean m675in(long k) {
            return (this.bottom || Long2ReferenceAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2ReferenceAVLTreeMap.this.compare(k, this.f2359to) < 0);
        }
        ...
        public V put(long k, V v) {
            ...
            if (!m675in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f2359to)) + ")");
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2ReferenceSortedMap
        public Long2ReferenceSortedMap<V> headMap(long to) {
            if (!this.top && Long2ReferenceAVLTreeMap.this.compare(to, this.f2359to) >= 0) {
                return this;
            }
        ...
        public Long2ReferenceSortedMap<V> tailMap(long from) {
            ...
            return new Submap(from, false, this.f2359to, this.top);
        }
        ...
        public Long2ReferenceSortedMap<V> subMap(long j, long j2) {
            ...
            long to = j2;
            if (!this.top) {
                to = Long2ReferenceAVLTreeMap.this.compare(j2, this.f2359to) < 0 ? j2 : this.f2359to;
            }
            long from = j;
            if (!this.bottom) {
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.top || Long2ReferenceAVLTreeMap.this.compare(e.key, this.f2359to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                ...
                e = Long2ReferenceAVLTreeMap.this.locateKey(this.f2359to);
                if (Long2ReferenceAVLTreeMap.this.compare(e.key, this.f2359to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends Long2ReferenceAVLTreeMap<V>.TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Long2ReferenceAVLTreeMap.this.compare(this.next.key, Submap.this.f2359to) >= 0) {
                    this.next = null;
                }
            }
        }
