...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntOpenCustomHashMap.class */
public class Long2IntOpenCustomHashMap extends AbstractLong2IntMap implements Serializable, Cloneable, Hash {
    ...
    public Long2IntOpenCustomHashMap(int expected, float f, LongHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new int[this.f2326n + 1];
        }
    }
    ...
    public int removeNullEntry() {
        ...
        int oldValue = this.value[this.f2326n];
        this.size--;
        if (this.f2326n > this.minN && this.size < this.maxFill / 4 && this.f2326n > 16) {
            rehash(this.f2326n / 2);
        }
    ...
    public int addTo(long k, int incr) {
        ...
        if (!this.strategy.equals(k, 0)) {
            ...
            return addToValue(this.f2326n, incr);
        } else {
            pos = this.f2326n;
            this.containsNullKey = true;
        }
    ...
    public int get(long k) {
        int i;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2326n] : this.defRetValue;
        }
        long[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Long2IntMap.Entry, Map.Entry<Long, Integer>, LongIntPair {
        ...
        public boolean equals(Object o) {
            ...
            return Long2IntOpenCustomHashMap.this.strategy.equals(Long2IntOpenCustomHashMap.this.key[this.index], e.getKey().longValue()) && Long2IntOpenCustomHashMap.this.value[this.index] == e.getValue().intValue();
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Long2IntOpenCustomHashMap.this.f2326n;
            this.last = -1;
            this.f2328c = Long2IntOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Long2IntOpenCustomHashMap.this.f2326n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Long2IntOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Long2IntOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Long2IntOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Long2IntOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Long2IntOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Long2IntOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Long2IntOpenCustomHashMap.this.value[pos] = Long2IntOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Long2IntOpenCustomHashMap.this.f2326n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Long2IntMap.Entry>> implements ObjectIterator<Long2IntMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Long2IntOpenCustomHashMap.this.f2326n;
            this.f2329c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2329c++;
                acceptOnIndex(action, Long2IntOpenCustomHashMap.this.f2326n);
                return true;
            }
            long[] key = Long2IntOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Long2IntOpenCustomHashMap.this.size - this.f2329c);
            }
            return Math.min((long) (Long2IntOpenCustomHashMap.this.size - this.f2329c), ((long) ((((double) Long2IntOpenCustomHashMap.this.realSize()) / ((double) Long2IntOpenCustomHashMap.this.f2326n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap.this
                long[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0077:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Long2IntMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Long2IntMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Long2IntMap.Entry> implements Long2IntMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Long2IntOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Long2IntOpenCustomHashMap.this.containsNullKey && Long2IntOpenCustomHashMap.this.value[Long2IntOpenCustomHashMap.this.f2326n] == v;
            }
            long[] key = Long2IntOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Long2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Long2IntOpenCustomHashMap.this.mask;
            int pos = mix;
            if (key[mix] == 0) {
                return false;
            }
            if (Long2IntOpenCustomHashMap.this.strategy.equals(k, mix)) {
                return Long2IntOpenCustomHashMap.this.value[pos] == v;
            }
            do {
                i = (pos + 1) & Long2IntOpenCustomHashMap.this.mask;
                pos = i;
                if (key[i] == 0) {
                    return false;
                }
            } while (!Long2IntOpenCustomHashMap.this.strategy.equals(k, i));
            return Long2IntOpenCustomHashMap.this.value[pos] == v;
        }
        ...
        public boolean remove(Object o) {
            ...
            if (!Long2IntOpenCustomHashMap.this.strategy.equals(k, 0)) {
                ...
                if (!Long2IntOpenCustomHashMap.this.strategy.equals(mix, k)) {
                    while (true) {
                        int i = (pos + 1) & Long2IntOpenCustomHashMap.this.mask;
                        pos = i;
                        if (key[i] == 0) {
                            return false;
                        }
                        if (Long2IntOpenCustomHashMap.this.strategy.equals(i, k) && Long2IntOpenCustomHashMap.this.value[pos] == v) {
                            Long2IntOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Long2IntOpenCustomHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Long2IntOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Long2IntOpenCustomHashMap.this.containsNullKey || Long2IntOpenCustomHashMap.this.value[Long2IntOpenCustomHashMap.this.f2326n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Long2IntMap.Entry> consumer) {
            if (Long2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractLong2IntMap.BasicEntry(Long2IntOpenCustomHashMap.this.key[Long2IntOpenCustomHashMap.this.f2326n], Long2IntOpenCustomHashMap.this.value[Long2IntOpenCustomHashMap.this.f2326n]));
            }
            int pos = Long2IntOpenCustomHashMap.this.f2326n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
                }
                if (Long2IntOpenCustomHashMap.this.key[pos] != 0) {
        ...
        public void fastForEach(Consumer<? super Long2IntMap.Entry> consumer) {
            ...
            if (Long2IntOpenCustomHashMap.this.containsNullKey) {
                entry.key = Long2IntOpenCustomHashMap.this.key[Long2IntOpenCustomHashMap.this.f2326n];
                entry.value = Long2IntOpenCustomHashMap.this.value[Long2IntOpenCustomHashMap.this.f2326n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractLongSet {
        ...
        public void forEach(LongConsumer consumer) {
            if (Long2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Long2IntOpenCustomHashMap.this.key[Long2IntOpenCustomHashMap.this.f2326n]);
            }
            int pos = Long2IntOpenCustomHashMap.this.f2326n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2IntOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Integer> values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.longs.Long2IntOpenCustomHashMap.1
                ...
                public void forEach(IntConsumer consumer) {
                    if (Long2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Long2IntOpenCustomHashMap.this.value[Long2IntOpenCustomHashMap.this.f2326n]);
                    }
                    int pos = Long2IntOpenCustomHashMap.this.f2326n;
                    while (true) {
                        pos--;
    ...
    public Long2IntOpenCustomHashMap clone() {
        try {
            Long2IntOpenCustomHashMap c = (Long2IntOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        int[] value = new int[this.f2326n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
