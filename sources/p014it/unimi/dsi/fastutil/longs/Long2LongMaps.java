...
import p014it.unimi.dsi.fastutil.longs.Long2LongFunctions;
...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2LongMaps */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2LongMaps.class */
public final class Long2LongMaps {
    ...
    public static ObjectIterable<Long2LongMap.Entry> fastIterable(Long2LongMap map) {
        ...
        return entries instanceof Long2LongMap.FastEntrySet ? new ObjectIterable<Long2LongMap.Entry>() { // from class: it.unimi.dsi.fastutil.longs.Long2LongMaps.1
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectIterable, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection
            public ObjectIterator<Long2LongMap.Entry> iterator() {
                return ((Long2LongMap.FastEntrySet) ObjectSet.this).fastIterator();
            }
            ...
            public void forEach(Consumer<? super Long2LongMap.Entry> consumer) {
                ((Long2LongMap.FastEntrySet) ObjectSet.this).fastForEach(consumer);
            }
        } : entries;
    }

    /* renamed from: it.unimi.dsi.fastutil.longs.Long2LongMaps$EmptyMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2LongMaps$EmptyMap.class */
    public static class EmptyMap extends Long2LongFunctions.EmptyFunction implements Long2LongMap, Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2LongFunctions.EmptyFunction, p014it.unimi.dsi.fastutil.longs.Long2LongFunction
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2LongFunctions.EmptyFunction, java.lang.Object
        public Object clone() {
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2LongMaps$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2LongMaps$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2LongMaps$SynchronizedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2LongMaps$SynchronizedMap.class */
    public static class SynchronizedMap extends Long2LongFunctions.SynchronizedFunction implements Long2LongMap, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedMap(Long2LongMap m, Object sync) {
            super(m, sync);
            this.map = m;
        }

        /* access modifiers changed from: protected */
        public SynchronizedMap(Long2LongMap m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2LongMap, p014it.unimi.dsi.fastutil.longs.Long2LongSortedMap
        public ObjectSet<Long2LongMap.Entry> long2LongEntrySet() {
            ObjectSet<Long2LongMap.Entry> objectSet;
            synchronized (this.sync) {
                if (this.entries == null) {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2LongFunctions.SynchronizedFunction, java.lang.Object
        public int hashCode() {
            int hashCode;
            synchronized (this.sync) {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2LongFunctions.SynchronizedFunction, p014it.unimi.dsi.fastutil.longs.Long2LongFunction
        public long getOrDefault(long key, long defaultValue) {
            long orDefault;
            synchronized (this.sync) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2LongMaps$UnmodifiableMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2LongMaps$UnmodifiableMap.class */
    public static class UnmodifiableMap extends Long2LongFunctions.UnmodifiableFunction implements Long2LongMap, Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableMap(Long2LongMap m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2LongFunctions.UnmodifiableFunction, java.lang.Object
        public int hashCode() {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2LongFunctions.UnmodifiableFunction, p014it.unimi.dsi.fastutil.longs.Long2LongFunction
        public long getOrDefault(long key, long defaultValue) {
