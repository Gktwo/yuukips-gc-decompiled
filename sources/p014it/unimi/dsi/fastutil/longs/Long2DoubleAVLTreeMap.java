...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2DoubleAVLTreeMap.class */
public class Long2DoubleAVLTreeMap extends AbstractLong2DoubleSortedMap implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Long2DoubleAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    public double remove(long r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap.remove(long):double");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2DoubleAVLTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2DoubleAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(long k) {
            Entry locateKey = Long2DoubleAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2DoubleAVLTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>() { // from class: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap.1
                final Comparator<? super Long2DoubleMap.Entry> comparator;

                {
                    this.comparator = Long2DoubleAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Long) && e.getValue() != null && (e.getValue() instanceof Double)) {
                        return e.equals(Long2DoubleAVLTreeMap.this.findKey(((Long) e.getKey()).longValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Long) || !(e.getValue() instanceof Double) || (f = Long2DoubleAVLTreeMap.this.findKey(((Long) e.getKey()).longValue())) == null || Double.doubleToLongBits(f.getDoubleValue()) != Double.doubleToLongBits(((Double) e.getValue()).doubleValue())) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2DoubleAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2DoubleAVLTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2DoubleAVLTreeMap$ValueIterator.class */
    ...
    public DoubleCollection values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection() { // from class: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2DoubleAVLTreeMap$Submap.class */
    public final class Submap extends AbstractLong2DoubleSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m685in(long k) {
            return (this.bottom || Long2DoubleAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2DoubleAVLTreeMap.this.compare(k, this.f2299to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.longs.Long2DoubleMap, p014it.unimi.dsi.fastutil.longs.Long2DoubleSortedMap
        public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>() { // from class: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Long) && e.getValue() != null && (e.getValue() instanceof Double) && (f = Long2DoubleAVLTreeMap.this.findKey(((Long) e.getKey()).longValue())) != null && Submap.this.m685in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Long2DoubleAVLTreeMap.this.findKey(((Long) e.getKey()).longValue());
                        if (f != null && Submap.this.m685in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2DoubleAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractLong2DoubleSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public DoubleCollection values() {
            if (this.values == null) {
                this.values = new AbstractDoubleCollection() { // from class: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDoubleCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.doubles.DoubleCollection, p014it.unimi.dsi.fastutil.doubles.DoubleIterable
                    public DoubleIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2DoubleMap, p014it.unimi.dsi.fastutil.longs.Long2DoubleFunction, p014it.unimi.dsi.fastutil.longs.Long2DoubleMap
        public boolean containsKey(long k) {
            return m685in(k) && Long2DoubleAVLTreeMap.this.containsKey(k);
        }
        ...
        public double get(long k) {
            Entry e;
            return (!m685in(k) || (e = Long2DoubleAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public double put(long k, double v) {
            ...
            if (!m685in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f2299to)) + ")");
            }
            return Long2DoubleAVLTreeMap.this.modified ? this.defRetValue : Long2DoubleAVLTreeMap.this.put(k, v);
        }
        ...
        public double remove(long k) {
            ...
            return Long2DoubleAVLTreeMap.this.modified ? Long2DoubleAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2DoubleSortedMap
        public Long2DoubleSortedMap headMap(long to) {
            if (!this.top && Long2DoubleAVLTreeMap.this.compare(to, this.f2299to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2DoubleSortedMap
        public Long2DoubleSortedMap tailMap(long from) {
            if (!this.bottom && Long2DoubleAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f2299to, this.top);
        }
        ...
        public Long2DoubleSortedMap subMap(long j, long j2) {
            ...
            long to = j2;
            if (!this.top) {
                to = Long2DoubleAVLTreeMap.this.compare(j2, this.f2299to) < 0 ? j2 : this.f2299to;
            }
            long from = j;
            if (!this.bottom) {
                from = Long2DoubleAVLTreeMap.this.compare(j, this.from) > 0 ? j : this.from;
            }
            if (!this.top && !this.bottom) {
                if ((from == 1 ? 1 : 0) == this.from) {
                    if ((to == 1 ? 1 : 0) == this.f2299to) {
                        return this;
                    }
                }
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Long2DoubleAVLTreeMap.this.compare(e.key, this.f2299to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Long2DoubleAVLTreeMap.this.locateKey(this.f2299to);
                if (Long2DoubleAVLTreeMap.this.compare(e.key, this.f2299to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Long2DoubleAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2DoubleAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, long k) {
                ...
                if (submap.bottom || Long2DoubleAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Long2DoubleAVLTreeMap long2DoubleAVLTreeMap = Long2DoubleAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (long2DoubleAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Long2DoubleAVLTreeMap.this.compare(this.next.key, Submap.this.f2299to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2DoubleAVLTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2DoubleAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2DoubleAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2DoubleAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Long2DoubleAVLTreeMap clone() {
        try {
            Long2DoubleAVLTreeMap c = (Long2DoubleAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
