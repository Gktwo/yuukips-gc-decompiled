...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortFunctions.class */
public final class Long2ShortFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractLong2ShortFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2ShortFunction, p014it.unimi.dsi.fastutil.longs.Long2ShortFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Long2ShortFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Long2ShortFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Long2ShortFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2ShortFunction, java.util.function.LongToIntFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractLong2ShortFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Long2ShortFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Long2ShortFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ShortFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ShortFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Long2ShortFunction {
        ...
        public short get(long key) {
            Short v = (Short) this.function.apply(Long.valueOf(key));
        ...
        public Short get(Object key) {
            ...
            return (Short) this.function.apply((Long) key);
        }
        ...
        public Short getOrDefault(Object key, Short defaultValue) {
            Short v;
            if (!(key == null || (v = (Short) this.function.apply((Long) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
    ...
    public static Long2ShortFunction primitive(java.util.function.Function<? super Long, ? extends Short> f) {
        ...
        return f instanceof Long2ShortFunction ? (Long2ShortFunction) f : f instanceof LongToIntFunction ? key -> {
            return SafeMath.safeIntToShort(((LongToIntFunction) f).applyAsInt(key));
