...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2BooleanRBTreeMap.class */
public class Long2BooleanRBTreeMap extends AbstractLong2BooleanSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap.Entry add(long r10) {
        /*
        // Method dump skipped, instructions count: 947
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap.add(long):it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap$Entry");
    }
    ...
    public boolean remove(long r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap.remove(long):boolean");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2BooleanRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2BooleanRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(long k) {
            Entry locateKey = Long2BooleanRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2BooleanRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry>() { // from class: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap.1
                final Comparator<? super Long2BooleanMap.Entry> comparator;

                {
                    this.comparator = Long2BooleanRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Long) && e.getValue() != null && (e.getValue() instanceof Boolean)) {
                        return e.equals(Long2BooleanRBTreeMap.this.findKey(((Long) e.getKey()).longValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Long) || e.getValue() == null || !(e.getValue() instanceof Boolean) || (f = Long2BooleanRBTreeMap.this.findKey(((Long) e.getKey()).longValue())) == null || f.getBooleanValue() != ((Boolean) e.getValue()).booleanValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2BooleanRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2BooleanRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2BooleanRBTreeMap$ValueIterator.class */
    ...
    public BooleanCollection values() {
        if (this.values == null) {
            this.values = new AbstractBooleanCollection() { // from class: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2BooleanRBTreeMap$Submap.class */
    public final class Submap extends AbstractLong2BooleanSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m690in(long k) {
            return (this.bottom || Long2BooleanRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Long2BooleanRBTreeMap.this.compare(k, this.f2238to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.longs.Long2BooleanMap, p014it.unimi.dsi.fastutil.longs.Long2BooleanSortedMap
        public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry>() { // from class: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Long2BooleanMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Long) && e.getValue() != null && (e.getValue() instanceof Boolean) && (f = Long2BooleanRBTreeMap.this.findKey(((Long) e.getKey()).longValue())) != null && Submap.this.m690in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Long2BooleanRBTreeMap.this.findKey(((Long) e.getKey()).longValue());
                        if (f != null && Submap.this.m690in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2BooleanRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractLong2BooleanSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public BooleanCollection values() {
            if (this.values == null) {
                this.values = new AbstractBooleanCollection() { // from class: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.booleans.AbstractBooleanCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.booleans.BooleanCollection, p014it.unimi.dsi.fastutil.booleans.BooleanIterable, p014it.unimi.dsi.fastutil.booleans.BooleanBigList
                    public BooleanIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.AbstractLong2BooleanMap, p014it.unimi.dsi.fastutil.longs.Long2BooleanFunction, p014it.unimi.dsi.fastutil.longs.Long2BooleanMap
        public boolean containsKey(long k) {
            return m690in(k) && Long2BooleanRBTreeMap.this.containsKey(k);
        }
        ...
        public boolean get(long k) {
            Entry e;
            return (!m690in(k) || (e = Long2BooleanRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public boolean put(long k, boolean v) {
            ...
            if (!m690in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f2238to)) + ")");
            }
            return Long2BooleanRBTreeMap.this.modified ? this.defRetValue : Long2BooleanRBTreeMap.this.put(k, v);
        }
        ...
        public boolean remove(long k) {
            ...
            return Long2BooleanRBTreeMap.this.modified ? Long2BooleanRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2BooleanSortedMap
        public Long2BooleanSortedMap headMap(long to) {
            if (!this.top && Long2BooleanRBTreeMap.this.compare(to, this.f2238to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.longs.Long2BooleanSortedMap
        public Long2BooleanSortedMap tailMap(long from) {
            if (!this.bottom && Long2BooleanRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f2238to, this.top);
        }
        ...
        public Long2BooleanSortedMap subMap(long j, long j2) {
            ...
            long to = j2;
            if (!this.top) {
                to = Long2BooleanRBTreeMap.this.compare(j2, this.f2238to) < 0 ? j2 : this.f2238to;
            }
            long from = j;
            if (!this.bottom) {
                from = Long2BooleanRBTreeMap.this.compare(j, this.from) > 0 ? j : this.from;
            }
            if (!this.top && !this.bottom) {
                if ((from == 1 ? 1 : 0) == this.from) {
                    if ((to == 1 ? 1 : 0) == this.f2238to) {
                        return this;
                    }
                }
            }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Long2BooleanRBTreeMap.this.compare(e.key, this.f2238to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Long2BooleanRBTreeMap.this.locateKey(this.f2238to);
                if (Long2BooleanRBTreeMap.this.compare(e.key, this.f2238to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Long2BooleanRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2BooleanRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, long k) {
                ...
                if (submap.bottom || Long2BooleanRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Long2BooleanRBTreeMap long2BooleanRBTreeMap = Long2BooleanRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (long2BooleanRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Long2BooleanRBTreeMap.this.compare(this.next.key, Submap.this.f2238to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2BooleanRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2BooleanRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2BooleanRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2BooleanRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Long2BooleanRBTreeMap clone() {
        try {
            Long2BooleanRBTreeMap c = (Long2BooleanRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
