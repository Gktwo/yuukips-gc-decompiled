...
/* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteArrayMap.class */
public class Long2ByteArrayMap extends AbstractLong2ByteMap implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Long2ByteArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Long2ByteArrayMap(Long2ByteMap m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Long2ByteMap.Entry> it = m.long2ByteEntrySet().iterator();
        while (it.hasNext()) {
            Long2ByteMap.Entry e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Long2ByteMap.Entry> implements Long2ByteMap.FastEntrySet {
        private EntrySet() {
        }

        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
        public ObjectIterator<Long2ByteMap.Entry> iterator() {
            return new ObjectIterator<Long2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.longs.Long2ByteArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Long2ByteMap.Entry next() {
                    ...
                    long[] jArr = Long2ByteArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    long j = jArr[i];
                    byte[] bArr = Long2ByteArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractLong2ByteMap.BasicEntry(j, bArr[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Long2ByteArrayMap.access$010(Long2ByteArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Long2ByteMap.Entry> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractLong2ByteMap.BasicEntry(j, bArr[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Long2ByteMap.Entry> fastIterator() {
            return new ObjectIterator<Long2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.longs.Long2ByteArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Long2ByteMap.Entry next() {
                    ...
                    AbstractLong2ByteMap.BasicEntry basicEntry = this.entry;
                    long[] jArr = Long2ByteArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = jArr[i];
                    AbstractLong2ByteMap.BasicEntry basicEntry2 = this.entry;
                    byte[] bArr = Long2ByteArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Long2ByteMap.Entry> implements ObjectSpliterator<Long2ByteMap.Entry> {
            ...
            public final Long2ByteMap.Entry get(int location) {
        ...
        public boolean remove(Object o) {
            ...
            Long2ByteArrayMap.access$010(Long2ByteArrayMap.this);
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteArrayMap$KeySet.class */
    public final class KeySet extends AbstractLongSet {
        ...
        public LongIterator iterator() {
            return new LongIterator() { // from class: it.unimi.dsi.fastutil.longs.Long2ByteArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteArrayMap$KeySet$KeySetSpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractByteCollection {
        ...
        public ByteIterator iterator() {
            return new ByteIterator() { // from class: it.unimi.dsi.fastutil.longs.Long2ByteArrayMap.ValuesCollection.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.longs.Long2ByteArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/longs/Long2ByteArrayMap$ValuesCollection$ValuesSpliterator.class */
    ...
    public Long2ByteArrayMap clone() {
        try {
            Long2ByteArrayMap c = (Long2ByteArrayMap) clone();
