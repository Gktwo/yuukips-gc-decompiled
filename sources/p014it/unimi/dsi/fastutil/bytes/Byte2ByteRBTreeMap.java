...
public class Byte2ByteRBTreeMap extends AbstractByte2ByteSortedMap implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractByte2ByteSortedMap implements Serializable {
        ...
        final boolean m1111in(byte k) {
            return (this.bottom || Byte2ByteRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ByteRBTreeMap.this.compare(k, this.f1148to) < 0);
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ByteSortedMap
        public Byte2ByteSortedMap headMap(byte to) {
            if (!this.top && Byte2ByteRBTreeMap.this.compare(to, this.f1148to) >= 0) {
                return this;
            }
        ...
        public Byte2ByteSortedMap subMap(byte from, byte to) {
            ...
            if (!this.top) {
                to = Byte2ByteRBTreeMap.this.compare(to, this.f1148to) < 0 ? to : this.f1148to;
            }
            if (!this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Byte2ByteRBTreeMap.this.compare(e.key, this.f1148to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Byte2ByteRBTreeMap.this.locateKey(this.f1148to);
                if (Byte2ByteRBTreeMap.this.compare(e.key, this.f1148to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Byte2ByteRBTreeMap.this.compare(this.next.key, Submap.this.f1148to) >= 0) {
                    this.next = null;
                }
            }
        }
