...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceMap.class */
public interface Byte2ReferenceMap<V> extends Byte2ReferenceFunction<V>, Map<Byte, V> {
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceMap$FastEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceMap$FastEntrySet.class */
    ...
    default void forEach(BiConsumer<? super Byte, ? super V> consumer) {
        ObjectSet<Entry<V>> entrySet = byte2ReferenceEntrySet();
    ...
    default V computeIfAbsentPartial(byte key, Byte2ReferenceFunction<? extends V> mappingFunction) {
        return computeIfAbsent(key, (Byte2ReferenceFunction) mappingFunction);
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceMap$Entry.class */
