...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap.class */
public class Byte2DoubleOpenCustomHashMap extends AbstractByte2DoubleMap implements Serializable, Cloneable, Hash {
    ...
    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap.computeIfPresent(byte, java.util.function.BiFunction<? super java.lang.Byte, ? super java.lang.Double, ? extends java.lang.Double>):double, file: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap.class
    ...
    public double computeIfPresent(byte r1, java.util.function.BiFunction<? super java.lang.Byte, ? super java.lang.Double, ? extends java.lang.Double> r2) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap.computeIfPresent(byte, java.util.function.BiFunction):double");
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap.compute(byte, java.util.function.BiFunction<? super java.lang.Byte, ? super java.lang.Double, ? extends java.lang.Double>):double, file: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap.class
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:204)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:309)
        	at jadx.core.ProcessClass.process(ProcessClass.java:53)
        	at jadx.core.ProcessClass.generateCode(ProcessClass.java:87)
    ...
    public double compute(byte r1, java.util.function.BiFunction<? super java.lang.Byte, ? super java.lang.Double, ? extends java.lang.Double> r2) {
        ...
        // Can't load method instructions: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap.compute(byte, java.util.function.BiFunction<? super java.lang.Byte, ? super java.lang.Double, ? extends java.lang.Double>):double, file: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap.class
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap.compute(byte, java.util.function.BiFunction):double");
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap.merge(byte, double, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Double, ? extends java.lang.Double>):double, file: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap.class
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:204)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:309)
        	at jadx.core.ProcessClass.process(ProcessClass.java:53)
        	at jadx.core.ProcessClass.generateCode(ProcessClass.java:87)
    ...
    public double merge(byte r1, double r2, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Double, ? extends java.lang.Double> r4) {
        ...
        // Can't load method instructions: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap.merge(byte, double, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Double, ? extends java.lang.Double>):double, file: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap.class
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap.merge(byte, double, java.util.function.BiFunction):double");
    }
    ...
    public Byte2DoubleOpenCustomHashMap(int expected, float f, ByteHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new double[this.f1128n + 1];
        }
    }
    ...
    public double removeNullEntry() {
        ...
        double oldValue = this.value[this.f1128n];
        this.size--;
        if (this.f1128n > this.minN && this.size < this.maxFill / 4 && this.f1128n > 16) {
            rehash(this.f1128n / 2);
        }
    ...
    public double addTo(byte k, double incr) {
        ...
        if (!this.strategy.equals(k, (byte) 0)) {
            ...
            return addToValue(this.f1128n, incr);
        } else {
            pos = this.f1128n;
            this.containsNullKey = true;
        }
    ...
    public boolean containsValue(double v) {
        ...
        byte[] key = this.key;
        if (this.containsNullKey && Double.doubleToLongBits(value[this.f1128n]) == Double.doubleToLongBits(v)) {
            return true;
        }
        int i = this.f1128n;
        while (true) {
    ...
    public boolean remove(byte k, double v) {
        ...
        } else if (!this.containsNullKey || Double.doubleToLongBits(v) != Double.doubleToLongBits(this.value[this.f1128n])) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Byte2DoubleMap.Entry, Map.Entry<Byte, Double>, ByteDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            return Byte2DoubleOpenCustomHashMap.this.strategy.equals(Byte2DoubleOpenCustomHashMap.this.key[this.index], e.getKey().byteValue()) && Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits(e.getValue().doubleValue());
        }
        ...
        public String toString() {
            return ((int) Byte2DoubleOpenCustomHashMap.this.key[this.index]) + "=>" + Byte2DoubleOpenCustomHashMap.this.value[this.index];
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Byte2DoubleOpenCustomHashMap.this.f1128n;
            this.last = -1;
            this.f1130c = Byte2DoubleOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Byte2DoubleOpenCustomHashMap.this.f1128n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Byte2DoubleOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Byte2DoubleOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Byte2DoubleOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Byte2DoubleOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Byte2DoubleOpenCustomHashMap.this.value[pos] = Byte2DoubleOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Byte2DoubleOpenCustomHashMap.this.f1128n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Byte2DoubleMap.Entry>> implements ObjectIterator<Byte2DoubleMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Byte2DoubleOpenCustomHashMap.this.f1128n;
            this.f1131c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1131c++;
                acceptOnIndex(action, Byte2DoubleOpenCustomHashMap.this.f1128n);
                return true;
            }
            byte[] key = Byte2DoubleOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Byte2DoubleOpenCustomHashMap.this.size - this.f1131c);
            }
            return Math.min((long) (Byte2DoubleOpenCustomHashMap.this.size - this.f1131c), ((long) ((((double) Byte2DoubleOpenCustomHashMap.this.realSize()) / ((double) Byte2DoubleOpenCustomHashMap.this.f1128n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap.this
                byte[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Byte2DoubleMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Byte2DoubleMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Byte2DoubleMap.Entry> implements Byte2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, (byte) 0)) {
                return Byte2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.f1128n]) == Double.doubleToLongBits(v);
            }
            byte[] key = Byte2DoubleOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2DoubleOpenCustomHashMap.this.mask;
            int pos = mix;
            byte curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            }
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v);
            }
            do {
                int i = (pos + 1) & Byte2DoubleOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (!Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, (byte) 0)) {
                ...
                if (!Byte2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(curr2, k) && Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
                            Byte2DoubleOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[pos]) != Double.doubleToLongBits(v)) {
                    return false;
                } else {
                    Byte2DoubleOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Byte2DoubleOpenCustomHashMap.this.containsNullKey || Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.f1128n]) != Double.doubleToLongBits(v)) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Byte2DoubleMap.Entry> consumer) {
            if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2DoubleMap.BasicEntry(Byte2DoubleOpenCustomHashMap.this.key[Byte2DoubleOpenCustomHashMap.this.f1128n], Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.f1128n]));
            }
            int pos = Byte2DoubleOpenCustomHashMap.this.f1128n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Byte2DoubleMap.Entry> consumer) {
            ...
            if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
                entry.key = Byte2DoubleOpenCustomHashMap.this.key[Byte2DoubleOpenCustomHashMap.this.f1128n];
                entry.value = Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.f1128n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Byte2DoubleOpenCustomHashMap.this.key[Byte2DoubleOpenCustomHashMap.this.f1128n]);
            }
            int pos = Byte2DoubleOpenCustomHashMap.this.f1128n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Double> values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap.1
                ...
                public void forEach(DoubleConsumer consumer) {
                    if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.f1128n]);
                    }
                    int pos = Byte2DoubleOpenCustomHashMap.this.f1128n;
                    while (true) {
                        pos--;
    ...
    public Byte2DoubleOpenCustomHashMap clone() {
        try {
            Byte2DoubleOpenCustomHashMap c = (Byte2DoubleOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.double2int(this.value[this.f1128n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        double[] value = new double[this.f1128n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
