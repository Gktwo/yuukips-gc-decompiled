...
public class Byte2DoubleOpenCustomHashMap extends AbstractByte2DoubleMap implements Serializable, Cloneable, Hash {
    ...
    public Byte2DoubleOpenCustomHashMap(int expected, float f, ByteHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new double[this.f1164n + 1];
        }
    }
    ...
    public double removeNullEntry() {
        ...
        double oldValue = this.value[this.f1164n];
        this.size--;
        if (this.f1164n > this.minN && this.size < this.maxFill / 4 && this.f1164n > 16) {
            rehash(this.f1164n / 2);
        }
    ...
    public boolean containsValue(double v) {
        ...
        byte[] key = this.key;
        if (this.containsNullKey && Double.doubleToLongBits(value[this.f1164n]) == Double.doubleToLongBits(v)) {
            return true;
        }
        int i = this.f1164n;
        while (true) {
    ...
    public boolean remove(byte k, double v) {
        ...
        } else if (!this.containsNullKey || Double.doubleToLongBits(v) != Double.doubleToLongBits(this.value[this.f1164n])) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Byte2DoubleOpenCustomHashMap.this.f1164n;
            this.last = -1;
            this.f1166c = Byte2DoubleOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Byte2DoubleOpenCustomHashMap.this.f1164n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Byte2DoubleOpenCustomHashMap.this.f1164n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Byte2DoubleOpenCustomHashMap.this.f1164n;
            this.f1167c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1167c++;
                acceptOnIndex(action, Byte2DoubleOpenCustomHashMap.this.f1164n);
                return true;
            }
            byte[] key = Byte2DoubleOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Byte2DoubleOpenCustomHashMap.this.size - this.f1167c);
            }
            return Math.min((long) (Byte2DoubleOpenCustomHashMap.this.size - this.f1167c), ((long) ((((double) Byte2DoubleOpenCustomHashMap.this.realSize()) / ((double) Byte2DoubleOpenCustomHashMap.this.f1164n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Byte2DoubleMap.Entry> implements Byte2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, (byte) 0)) {
                return Byte2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.f1164n]) == Double.doubleToLongBits(v);
            }
            byte[] key = Byte2DoubleOpenCustomHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Byte2DoubleOpenCustomHashMap.this.containsNullKey || Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.f1164n]) != Double.doubleToLongBits(v)) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Byte2DoubleMap.Entry> consumer) {
            if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2DoubleMap.BasicEntry(Byte2DoubleOpenCustomHashMap.this.key[Byte2DoubleOpenCustomHashMap.this.f1164n], Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.f1164n]));
            }
            int pos = Byte2DoubleOpenCustomHashMap.this.f1164n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Byte2DoubleMap.Entry> consumer) {
            ...
            if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
                entry.key = Byte2DoubleOpenCustomHashMap.this.key[Byte2DoubleOpenCustomHashMap.this.f1164n];
                entry.value = Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.f1164n];
    ...
    public final class KeySet extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Byte2DoubleOpenCustomHashMap.this.key[Byte2DoubleOpenCustomHashMap.this.f1164n]);
            }
            int pos = Byte2DoubleOpenCustomHashMap.this.f1164n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2DoubleOpenCustomHashMap.1
                ...
                public void forEach(DoubleConsumer consumer) {
                    if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.f1164n]);
                    }
                    int pos = Byte2DoubleOpenCustomHashMap.this.f1164n;
                    while (true) {
                        pos--;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.double2int(this.value[this.f1164n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        double[] value = new double[this.f1164n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
