...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntOpenCustomHashMap.class */
public class Byte2IntOpenCustomHashMap extends AbstractByte2IntMap implements Serializable, Cloneable, Hash {
    ...
    public Byte2IntOpenCustomHashMap(int expected, float f, ByteHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new int[this.f1188n + 1];
        }
    }
    ...
    public int removeNullEntry() {
        ...
        int oldValue = this.value[this.f1188n];
        this.size--;
        if (this.f1188n > this.minN && this.size < this.maxFill / 4 && this.f1188n > 16) {
            rehash(this.f1188n / 2);
        }
    ...
    public int addTo(byte k, int incr) {
        ...
        if (!this.strategy.equals(k, (byte) 0)) {
            ...
            return addToValue(this.f1188n, incr);
        } else {
            pos = this.f1188n;
            this.containsNullKey = true;
        }
    ...
    public int get(byte k) {
        byte curr;
        if (this.strategy.equals(k, (byte) 0)) {
            return this.containsNullKey ? this.value[this.f1188n] : this.defRetValue;
        }
        byte[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Byte2IntMap.Entry, Map.Entry<Byte, Integer>, ByteIntPair {
        ...
        public boolean equals(Object o) {
            ...
            return Byte2IntOpenCustomHashMap.this.strategy.equals(Byte2IntOpenCustomHashMap.this.key[this.index], e.getKey().byteValue()) && Byte2IntOpenCustomHashMap.this.value[this.index] == e.getValue().intValue();
        }
        ...
        public String toString() {
            return ((int) Byte2IntOpenCustomHashMap.this.key[this.index]) + "=>" + Byte2IntOpenCustomHashMap.this.value[this.index];
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Byte2IntOpenCustomHashMap.this.f1188n;
            this.last = -1;
            this.f1190c = Byte2IntOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Byte2IntOpenCustomHashMap.this.f1188n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Byte2IntOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Byte2IntOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Byte2IntOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Byte2IntOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Byte2IntOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Byte2IntOpenCustomHashMap.this.value[pos] = Byte2IntOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Byte2IntOpenCustomHashMap.this.f1188n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Byte2IntMap.Entry>> implements ObjectIterator<Byte2IntMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Byte2IntOpenCustomHashMap.this.f1188n;
            this.f1191c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1191c++;
                acceptOnIndex(action, Byte2IntOpenCustomHashMap.this.f1188n);
                return true;
            }
            byte[] key = Byte2IntOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Byte2IntOpenCustomHashMap.this.size - this.f1191c);
            }
            return Math.min((long) (Byte2IntOpenCustomHashMap.this.size - this.f1191c), ((long) ((((double) Byte2IntOpenCustomHashMap.this.realSize()) / ((double) Byte2IntOpenCustomHashMap.this.f1188n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap.this
                byte[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Byte2IntMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Byte2IntMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Byte2IntMap.Entry> implements Byte2IntMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Byte2IntOpenCustomHashMap.this.strategy.equals(k, (byte) 0)) {
                return Byte2IntOpenCustomHashMap.this.containsNullKey && Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.f1188n] == v;
            }
            byte[] key = Byte2IntOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Byte2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2IntOpenCustomHashMap.this.mask;
            int pos = mix;
            byte curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            }
            if (Byte2IntOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Byte2IntOpenCustomHashMap.this.value[pos] == v;
            }
            do {
                int i = (pos + 1) & Byte2IntOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (!Byte2IntOpenCustomHashMap.this.strategy.equals(k, (byte) 0)) {
                ...
                if (!Byte2IntOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Byte2IntOpenCustomHashMap.this.strategy.equals(curr2, k) && Byte2IntOpenCustomHashMap.this.value[pos] == v) {
                            Byte2IntOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Byte2IntOpenCustomHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Byte2IntOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Byte2IntOpenCustomHashMap.this.containsNullKey || Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.f1188n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Byte2IntMap.Entry> consumer) {
            if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2IntMap.BasicEntry(Byte2IntOpenCustomHashMap.this.key[Byte2IntOpenCustomHashMap.this.f1188n], Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.f1188n]));
            }
            int pos = Byte2IntOpenCustomHashMap.this.f1188n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Byte2IntMap.Entry> consumer) {
            ...
            if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
                entry.key = Byte2IntOpenCustomHashMap.this.key[Byte2IntOpenCustomHashMap.this.f1188n];
                entry.value = Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.f1188n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Byte2IntOpenCustomHashMap.this.key[Byte2IntOpenCustomHashMap.this.f1188n]);
            }
            int pos = Byte2IntOpenCustomHashMap.this.f1188n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntOpenCustomHashMap$ValueSpliterator.class */
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap.1
                ...
                public void forEach(IntConsumer consumer) {
                    if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.f1188n]);
                    }
                    int pos = Byte2IntOpenCustomHashMap.this.f1188n;
                    while (true) {
                        pos--;
    ...
    public Byte2IntOpenCustomHashMap clone() {
        try {
            Byte2IntOpenCustomHashMap c = (Byte2IntOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        int[] value = new int[this.f1188n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
