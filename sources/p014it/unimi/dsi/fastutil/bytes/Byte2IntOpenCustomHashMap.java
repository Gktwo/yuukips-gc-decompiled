...
public class Byte2IntOpenCustomHashMap extends AbstractByte2IntMap implements Serializable, Cloneable, Hash {
    ...
    public Byte2IntOpenCustomHashMap(int expected, float f, ByteHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new int[this.f1152n + 1];
        }
    }
    ...
    public int removeNullEntry() {
        ...
        int oldValue = this.value[this.f1152n];
        this.size--;
        if (this.f1152n > this.minN && this.size < this.maxFill / 4 && this.f1152n > 16) {
            rehash(this.f1152n / 2);
        }
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Byte2IntOpenCustomHashMap.this.f1152n;
            this.last = -1;
            this.f1154c = Byte2IntOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Byte2IntOpenCustomHashMap.this.f1152n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Byte2IntOpenCustomHashMap.this.f1152n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Byte2IntOpenCustomHashMap.this.f1152n;
            this.f1155c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1155c++;
                acceptOnIndex(action, Byte2IntOpenCustomHashMap.this.f1152n);
                return true;
            }
            byte[] key = Byte2IntOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Byte2IntOpenCustomHashMap.this.size - this.f1155c);
            }
            return Math.min((long) (Byte2IntOpenCustomHashMap.this.size - this.f1155c), ((long) ((((double) Byte2IntOpenCustomHashMap.this.realSize()) / ((double) Byte2IntOpenCustomHashMap.this.f1152n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Byte2IntMap.Entry> implements Byte2IntMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Byte2IntOpenCustomHashMap.this.strategy.equals(k, (byte) 0)) {
                return Byte2IntOpenCustomHashMap.this.containsNullKey && Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.f1152n] == v;
            }
            byte[] key = Byte2IntOpenCustomHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Byte2IntOpenCustomHashMap.this.containsNullKey || Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.f1152n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Byte2IntMap.Entry> consumer) {
            if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2IntMap.BasicEntry(Byte2IntOpenCustomHashMap.this.key[Byte2IntOpenCustomHashMap.this.f1152n], Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.f1152n]));
            }
            int pos = Byte2IntOpenCustomHashMap.this.f1152n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Byte2IntMap.Entry> consumer) {
            ...
            if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
                entry.key = Byte2IntOpenCustomHashMap.this.key[Byte2IntOpenCustomHashMap.this.f1152n];
                entry.value = Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.f1152n];
    ...
    public final class KeySet extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Byte2IntOpenCustomHashMap.this.key[Byte2IntOpenCustomHashMap.this.f1152n]);
            }
            int pos = Byte2IntOpenCustomHashMap.this.f1152n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2IntOpenCustomHashMap.1
                ...
                public void forEach(IntConsumer consumer) {
                    if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Byte2IntOpenCustomHashMap.this.value[Byte2IntOpenCustomHashMap.this.f1152n]);
                    }
                    int pos = Byte2IntOpenCustomHashMap.this.f1152n;
                    while (true) {
                        pos--;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        int[] value = new int[this.f1152n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
