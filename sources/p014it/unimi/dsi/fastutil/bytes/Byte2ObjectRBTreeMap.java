...
public class Byte2ObjectRBTreeMap<V> extends AbstractByte2ObjectSortedMap<V> implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractByte2ObjectSortedMap<V> implements Serializable {
        ...
        final boolean m1099in(byte k) {
            return (this.bottom || Byte2ObjectRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ObjectRBTreeMap.this.compare(k, this.f1220to) < 0);
        }
        ...
        public V put(byte k, V v) {
            ...
            if (!m1099in(k)) {
                throw new IllegalArgumentException("Key (" + ((int) k) + ") out of range [" + (this.bottom ? "-" : String.valueOf((int) this.from)) + ", " + (this.top ? "-" : String.valueOf((int) this.f1220to)) + ")");
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ObjectSortedMap
        public Byte2ObjectSortedMap<V> headMap(byte to) {
            if (!this.top && Byte2ObjectRBTreeMap.this.compare(to, this.f1220to) >= 0) {
                return this;
            }
        ...
        public Byte2ObjectSortedMap<V> tailMap(byte from) {
            ...
            return new Submap(from, false, this.f1220to, this.top);
        }
        ...
        public Byte2ObjectSortedMap<V> subMap(byte from, byte to) {
            ...
            if (!this.top) {
                to = Byte2ObjectRBTreeMap.this.compare(to, this.f1220to) < 0 ? to : this.f1220to;
            }
            if (!this.bottom) {
                from = Byte2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1220to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.top || Byte2ObjectRBTreeMap.this.compare(e.key, this.f1220to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                ...
                e = Byte2ObjectRBTreeMap.this.locateKey(this.f1220to);
                if (Byte2ObjectRBTreeMap.this.compare(e.key, this.f1220to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends Byte2ObjectRBTreeMap<V>.TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Byte2ObjectRBTreeMap.this.compare(this.next.key, Submap.this.f1220to) >= 0) {
                    this.next = null;
                }
            }
        }
