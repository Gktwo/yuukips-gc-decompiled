...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongRBTreeMap.class */
public class Byte2LongRBTreeMap extends AbstractByte2LongSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap.Entry add(byte r10) {
        /*
        // Method dump skipped, instructions count: 935
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap.add(byte):it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.bytes.Byte2LongFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public long remove(byte r7) {
        /*
        // Method dump skipped, instructions count: 1895
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap.remove(byte):long");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(byte k) {
            Entry locateKey = Byte2LongRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2LongMap.Entry>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap.1
                final Comparator<? super Byte2LongMap.Entry> comparator;

                {
                    this.comparator = Byte2LongRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Byte) && e.getValue() != null && (e.getValue() instanceof Long)) {
                        return e.equals(Byte2LongRBTreeMap.this.findKey(((Byte) e.getKey()).byteValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Byte) || e.getValue() == null || !(e.getValue() instanceof Long) || (f = Byte2LongRBTreeMap.this.findKey(((Byte) e.getKey()).byteValue())) == null || f.getLongValue() != ((Long) e.getValue()).longValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongRBTreeMap$ValueIterator.class */
    ...
    public LongCollection values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongRBTreeMap$Submap.class */
    public final class Submap extends AbstractByte2LongSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m1101in(byte k) {
            return (this.bottom || Byte2LongRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2LongRBTreeMap.this.compare(k, this.f1172to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2LongMap, p014it.unimi.dsi.fastutil.bytes.Byte2LongSortedMap
        public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2LongMap.Entry>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Byte) && e.getValue() != null && (e.getValue() instanceof Long) && (f = Byte2LongRBTreeMap.this.findKey(((Byte) e.getKey()).byteValue())) != null && Submap.this.m1101in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Byte2LongRBTreeMap.this.findKey(((Byte) e.getKey()).byteValue());
                        if (f != null && Submap.this.m1101in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractByte2LongSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public LongCollection values() {
            if (this.values == null) {
                this.values = new AbstractLongCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.longs.AbstractLongCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.longs.LongCollection, p014it.unimi.dsi.fastutil.longs.LongIterable
                    public LongIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2LongMap, p014it.unimi.dsi.fastutil.bytes.Byte2LongFunction, p014it.unimi.dsi.fastutil.bytes.Byte2LongMap
        public boolean containsKey(byte k) {
            return m1101in(k) && Byte2LongRBTreeMap.this.containsKey(k);
        }
        ...
        public long get(byte k) {
            Entry e;
            return (!m1101in(k) || (e = Byte2LongRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public long put(byte k, long v) {
            ...
            return Byte2LongRBTreeMap.this.modified ? this.defRetValue : Byte2LongRBTreeMap.this.put(k, v);
        }
        ...
        public long remove(byte k) {
            ...
            return Byte2LongRBTreeMap.this.modified ? Byte2LongRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2LongSortedMap
        public Byte2LongSortedMap headMap(byte to) {
            if (!this.top && Byte2LongRBTreeMap.this.compare(to, this.f1172to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2LongSortedMap
        public Byte2LongSortedMap tailMap(byte from) {
            if (!this.bottom && Byte2LongRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
        ...
        public Byte2LongSortedMap subMap(byte from, byte to) {
            ...
            if (!this.top) {
                to = Byte2LongRBTreeMap.this.compare(to, this.f1172to) < 0 ? to : this.f1172to;
            }
            if (!this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Byte2LongRBTreeMap.this.compare(e.key, this.f1172to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Byte2LongRBTreeMap.this.locateKey(this.f1172to);
                if (Byte2LongRBTreeMap.this.compare(e.key, this.f1172to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Byte2LongRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, byte k) {
                ...
                if (submap.bottom || Byte2LongRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Byte2LongRBTreeMap byte2LongRBTreeMap = Byte2LongRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (byte2LongRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Byte2LongRBTreeMap.this.compare(this.next.key, Submap.this.f1172to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Byte2LongRBTreeMap clone() {
        try {
            Byte2LongRBTreeMap c = (Byte2LongRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
