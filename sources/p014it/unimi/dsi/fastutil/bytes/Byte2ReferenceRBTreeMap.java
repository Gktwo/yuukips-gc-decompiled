...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceRBTreeMap.class */
public class Byte2ReferenceRBTreeMap<V> extends AbstractByte2ReferenceSortedMap<V> implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap.Entry<V> add(byte r9) {
        /*
        // Method dump skipped, instructions count: 935
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap.add(byte):it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap$Entry");
    }
    ...
    public V remove(byte r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap.remove(byte):java.lang.Object");
    }

    @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ReferenceMap, java.util.Map
    public boolean containsValue(Object v) {
        Byte2ReferenceRBTreeMap<V>.ValueIterator i = new ValueIterator();
        int j = this.count;
        do {
            j--;
            if (j == 0) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(byte k) {
            Entry<V> locateKey = Byte2ReferenceRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceRBTreeMap$EntryIterator.class */
    public class EntryIterator extends Byte2ReferenceRBTreeMap<V>.TreeIterator implements ObjectListIterator<Byte2ReferenceMap.Entry<V>> {
        EntryIterator() {
            super();
        }
    ...
    public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap.1
                final Comparator<? super Byte2ReferenceMap.Entry<V>> comparator;

                {
                    this.comparator = Byte2ReferenceRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Byte)) {
                        return e.equals(Byte2ReferenceRBTreeMap.this.findKey(((Byte) e.getKey()).byteValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Byte) || (f = Byte2ReferenceRBTreeMap.this.findKey(((Byte) e.getKey()).byteValue())) == null || f.getValue() != e.getValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceRBTreeMap$KeyIterator.class */
    public final class KeyIterator extends Byte2ReferenceRBTreeMap<V>.TreeIterator implements ByteListIterator {
        public KeyIterator() {
            super();
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceRBTreeMap$ValueIterator.class */
    public final class ValueIterator extends Byte2ReferenceRBTreeMap<V>.TreeIterator implements ObjectListIterator<V> {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceRBTreeMap$Submap.class */
    public final class Submap extends AbstractByte2ReferenceSortedMap<V> implements Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.Function, p014it.unimi.dsi.fastutil.bytes.Byte2BooleanMap, java.util.Map
        public void clear() {
            Byte2ReferenceRBTreeMap<V>.Submap.SubmapIterator i = new SubmapIterator();
            while (i.hasNext()) {
                i.nextEntry();
                i.remove();
            }
        ...
        /* renamed from: in */
        final boolean m1097in(byte k) {
            return (this.bottom || Byte2ReferenceRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ReferenceRBTreeMap.this.compare(k, this.f1232to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceMap, p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceSortedMap
        public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.ObjectSortedSet
                    public /* bridge */ /* synthetic */ ObjectBidirectionalIterator iterator(Object obj) {
                        return iterator((Byte2ReferenceMap.Entry) ((Byte2ReferenceMap.Entry) obj));
                    }
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Byte) && (f = Byte2ReferenceRBTreeMap.this.findKey(((Byte) e.getKey()).byteValue())) != null && Submap.this.m1097in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry<V> f = Byte2ReferenceRBTreeMap.this.findKey(((Byte) e.getKey()).byteValue());
                        if (f != null && Submap.this.m1097in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractByte2ReferenceSortedMap<V>.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ReferenceCollection<V> values() {
            if (this.values == null) {
                this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractReferenceCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ReferenceCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection
                    public ObjectIterator<V> iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ReferenceMap, p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceFunction, p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceMap
        public boolean containsKey(byte k) {
            return m1097in(k) && Byte2ReferenceRBTreeMap.this.containsKey(k);
        }
        ...
        public V get(byte k) {
            Entry<V> e;
            return (!m1097in(k) || (e = Byte2ReferenceRBTreeMap.this.findKey(k)) == null) ? (V) this.defRetValue : (V) e.value;
        }
        ...
        public V put(byte k, V v) {
            ...
            if (!m1097in(k)) {
                throw new IllegalArgumentException("Key (" + ((int) k) + ") out of range [" + (this.bottom ? "-" : String.valueOf((int) this.from)) + ", " + (this.top ? "-" : String.valueOf((int) this.f1232to)) + ")");
            }
            return Byte2ReferenceRBTreeMap.this.modified ? (V) this.defRetValue : (V) Byte2ReferenceRBTreeMap.this.put(k, (byte) v);
        }
        ...
        public V remove(byte k) {
            ...
            return Byte2ReferenceRBTreeMap.this.modified ? (V) Byte2ReferenceRBTreeMap.this.remove(k) : (V) this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceSortedMap
        public Byte2ReferenceSortedMap<V> headMap(byte to) {
            if (!this.top && Byte2ReferenceRBTreeMap.this.compare(to, this.f1232to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceSortedMap
        public Byte2ReferenceSortedMap<V> tailMap(byte from) {
            if (!this.bottom && Byte2ReferenceRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1232to, this.top);
        }
        ...
        public Byte2ReferenceSortedMap<V> subMap(byte from, byte to) {
            ...
            if (!this.top) {
                to = Byte2ReferenceRBTreeMap.this.compare(to, this.f1232to) < 0 ? to : this.f1232to;
            }
            if (!this.bottom) {
                from = Byte2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1232to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.top || Byte2ReferenceRBTreeMap.this.compare(e.key, this.f1232to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                ...
                e = Byte2ReferenceRBTreeMap.this.locateKey(this.f1232to);
                if (Byte2ReferenceRBTreeMap.this.compare(e.key, this.f1232to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Byte2ReferenceRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends Byte2ReferenceRBTreeMap<V>.TreeIterator {
            SubmapIterator() {
                super();
            ...
            SubmapIterator(Submap submap, byte k) {
                ...
                if (submap.bottom || Byte2ReferenceRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Byte2ReferenceRBTreeMap byte2ReferenceRBTreeMap = Byte2ReferenceRBTreeMap.this;
                        Entry<V> lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (byte2ReferenceRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Byte2ReferenceRBTreeMap.this.compare(this.next.key, Submap.this.f1232to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceRBTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends Byte2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Byte2ReferenceMap.Entry<V>> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceRBTreeMap$Submap$SubmapKeyIterator.class */
        public final class SubmapKeyIterator extends Byte2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ByteListIterator {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceRBTreeMap$Submap$SubmapValueIterator.class */
        public final class SubmapValueIterator extends Byte2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<V> {
    ...
    public Byte2ReferenceRBTreeMap<V> clone() {
        try {
            Byte2ReferenceRBTreeMap<V> c = (Byte2ReferenceRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        int n = this.count;
        Byte2ReferenceRBTreeMap<V>.EntryIterator i = new EntryIterator();
