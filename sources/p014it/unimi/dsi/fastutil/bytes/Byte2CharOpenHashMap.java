...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2CharOpenHashMap.class */
public class Byte2CharOpenHashMap extends AbstractByte2CharMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f1120n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f1121f;
    ...
    public Byte2CharOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f1120n = arraySize;
            this.minN = arraySize;
            this.mask = this.f1120n - 1;
            this.maxFill = HashCommon.maxFill(this.f1120n, f);
            this.key = new byte[this.f1120n + 1];
            this.value = new char[this.f1120n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f1121f);
        if (needed > this.f1120n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f1121f)))));
        if (needed > this.f1120n) {
            rehash(needed);
        }
    }
    ...
    public char removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f1120n > this.minN && this.size < this.maxFill / 4 && this.f1120n > 16) {
            rehash(this.f1120n / 2);
        }
        return oldValue;
    }
    ...
    public char removeNullEntry() {
        ...
        char oldValue = this.value[this.f1120n];
        this.size--;
        if (this.f1120n > this.minN && this.size < this.maxFill / 4 && this.f1120n > 16) {
            rehash(this.f1120n / 2);
        }
    ...
    private int find(byte k) {
        byte curr;
        if (k == 0) {
            return this.containsNullKey ? this.f1120n : -(this.f1120n + 1);
        }
        byte[] key = this.key;
    ...
    private void insert(int pos, byte k, char v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f1121f));
        }
    }
    ...
    public char addTo(byte k, char incr) {
        ...
        if (k != 0) {
            ...
            return addToValue(this.f1120n, incr);
        } else {
            pos = this.f1120n;
            this.containsNullKey = true;
        }
    ...
    public char get(byte k) {
        byte curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f1120n] : this.defRetValue;
        }
        byte[] key = this.key;
        int mix = HashCommon.mix((int) k) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(char v) {
        ...
        byte[] key = this.key;
        if (this.containsNullKey && value[this.f1120n] == v) {
            return true;
        }
        int i = this.f1120n;
        while (true) {
    ...
    public char getOrDefault(byte k, char defaultValue) {
        byte curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f1120n] : defaultValue;
        }
        byte[] key = this.key;
        int mix = HashCommon.mix((int) k) & this.mask;
        int pos = mix;
    ...
    public boolean remove(byte k, char v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1120n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2CharOpenHashMap$MapEntry.class */
    public final class MapEntry implements Byte2CharMap.Entry, Map.Entry<Byte, Character>, ByteCharPair {
        ...
        public boolean equals(Object o) {
            ...
            return Byte2CharOpenHashMap.this.key[this.index] == e.getKey().byteValue() && Byte2CharOpenHashMap.this.value[this.index] == e.getValue().charValue();
        }
        ...
        public String toString() {
            return ((int) Byte2CharOpenHashMap.this.key[this.index]) + "=>" + Byte2CharOpenHashMap.this.value[this.index];
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2CharOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Byte2CharOpenHashMap.this.f1120n;
            this.last = -1;
            this.f1122c = Byte2CharOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Byte2CharOpenHashMap.this.f1120n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int i3 = Byte2CharOpenHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (k == key[p]) {
                            return p;
                        ...
                        mix = p + 1;
                        i3 = Byte2CharOpenHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Byte2CharOpenHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Byte2CharOpenHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Byte2CharOpenHashMap.this.value[pos] = Byte2CharOpenHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Byte2CharOpenHashMap.this.f1120n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2CharOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Byte2CharMap.Entry>> implements ObjectIterator<Byte2CharMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2CharOpenHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2CharOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Byte2CharOpenHashMap.this.f1120n;
            this.f1123c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1123c++;
                acceptOnIndex(action, Byte2CharOpenHashMap.this.f1120n);
                return true;
            }
            byte[] key = Byte2CharOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Byte2CharOpenHashMap.this.size - this.f1123c);
            }
            return Math.min((long) (Byte2CharOpenHashMap.this.size - this.f1123c), ((long) ((((double) Byte2CharOpenHashMap.this.realSize()) / ((double) Byte2CharOpenHashMap.this.f1120n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap r0 = p014it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap.this
                byte[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2CharOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Byte2CharMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Byte2CharMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2CharOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Byte2CharMap.Entry> implements Byte2CharMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Byte2CharOpenHashMap.this.containsNullKey && Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.f1120n] == v;
            }
            byte[] key = Byte2CharOpenHashMap.this.key;
            int mix = HashCommon.mix((int) k) & Byte2CharOpenHashMap.this.mask;
            int pos = mix;
            byte curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            ...
            do {
                int i = (pos + 1) & Byte2CharOpenHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (k != 0) {
                ...
                if (curr != k) {
                    while (true) {
                        ...
                        if (curr2 == k && Byte2CharOpenHashMap.this.value[pos] == v) {
                            Byte2CharOpenHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Byte2CharOpenHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Byte2CharOpenHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Byte2CharOpenHashMap.this.containsNullKey || Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.f1120n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Byte2CharMap.Entry> consumer) {
            if (Byte2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2CharMap.BasicEntry(Byte2CharOpenHashMap.this.key[Byte2CharOpenHashMap.this.f1120n], Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.f1120n]));
            }
            int pos = Byte2CharOpenHashMap.this.f1120n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Byte2CharMap.Entry> consumer) {
            ...
            if (Byte2CharOpenHashMap.this.containsNullKey) {
                entry.key = Byte2CharOpenHashMap.this.key[Byte2CharOpenHashMap.this.f1120n];
                entry.value = Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.f1120n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2CharOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2CharOpenHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2CharOpenHashMap$KeySet.class */
    public final class KeySet extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            if (Byte2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(Byte2CharOpenHashMap.this.key[Byte2CharOpenHashMap.this.f1120n]);
            }
            int pos = Byte2CharOpenHashMap.this.f1120n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2CharOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2CharOpenHashMap$ValueSpliterator.class */
    ...
    public Collection<Character> values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2CharOpenHashMap.1
                ...
                public void forEach(CharConsumer consumer) {
                    if (Byte2CharOpenHashMap.this.containsNullKey) {
                        consumer.accept(Byte2CharOpenHashMap.this.value[Byte2CharOpenHashMap.this.f1120n]);
                    }
                    int pos = Byte2CharOpenHashMap.this.f1120n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f1121f)));
        if (l >= this.f1120n || this.size > HashCommon.maxFill(l, this.f1121f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f1120n];
                this.f1120n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f1120n, this.f1121f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Byte2CharOpenHashMap clone() {
        try {
            Byte2CharOpenHashMap c = (Byte2CharOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f1120n = HashCommon.arraySize(this.size, this.f1121f);
        this.maxFill = HashCommon.maxFill(this.f1120n, this.f1121f);
        this.mask = this.f1120n - 1;
        byte[] key = new byte[this.f1120n + 1];
        this.key = key;
        char[] value = new char[this.f1120n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
