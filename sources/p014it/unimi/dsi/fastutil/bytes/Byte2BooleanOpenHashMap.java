...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2BooleanOpenHashMap.class */
public class Byte2BooleanOpenHashMap extends AbstractByte2BooleanMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f1096n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f1097f;
    ...
    public Byte2BooleanOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f1096n = arraySize;
            this.minN = arraySize;
            this.mask = this.f1096n - 1;
            this.maxFill = HashCommon.maxFill(this.f1096n, f);
            this.key = new byte[this.f1096n + 1];
            this.value = new boolean[this.f1096n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f1097f);
        if (needed > this.f1096n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f1097f)))));
        if (needed > this.f1096n) {
            rehash(needed);
        }
    }
    ...
    public boolean removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f1096n > this.minN && this.size < this.maxFill / 4 && this.f1096n > 16) {
            rehash(this.f1096n / 2);
        }
        return oldValue;
    }
    ...
    public boolean removeNullEntry() {
        ...
        boolean oldValue = this.value[this.f1096n];
        this.size--;
        if (this.f1096n > this.minN && this.size < this.maxFill / 4 && this.f1096n > 16) {
            rehash(this.f1096n / 2);
        }
    ...
    private int find(byte k) {
        byte curr;
        if (k == 0) {
            return this.containsNullKey ? this.f1096n : -(this.f1096n + 1);
        }
        byte[] key = this.key;
    ...
    private void insert(int pos, byte k, boolean v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f1097f));
        }
    }
    ...
    public boolean get(byte k) {
        byte curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f1096n] : this.defRetValue;
        }
        byte[] key = this.key;
        int mix = HashCommon.mix((int) k) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(boolean v) {
        ...
        byte[] key = this.key;
        if (this.containsNullKey && value[this.f1096n] == v) {
            return true;
        }
        int i = this.f1096n;
        while (true) {
    ...
    public boolean getOrDefault(byte k, boolean defaultValue) {
        byte curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f1096n] : defaultValue;
        }
        byte[] key = this.key;
        int mix = HashCommon.mix((int) k) & this.mask;
        int pos = mix;
    ...
    public boolean remove(byte k, boolean v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1096n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2BooleanOpenHashMap$MapEntry.class */
    public final class MapEntry implements Byte2BooleanMap.Entry, Map.Entry<Byte, Boolean>, ByteBooleanPair {
        ...
        public boolean equals(Object o) {
            ...
            return Byte2BooleanOpenHashMap.this.key[this.index] == e.getKey().byteValue() && Byte2BooleanOpenHashMap.this.value[this.index] == e.getValue().booleanValue();
        }

        @Override // java.util.Map.Entry, java.lang.Object
        public int hashCode() {
            return Byte2BooleanOpenHashMap.this.key[this.index] ^ (Byte2BooleanOpenHashMap.this.value[this.index] ? (byte) 1231 : 1237);
        }

        @Override // java.lang.Object
        public String toString() {
            return ((int) Byte2BooleanOpenHashMap.this.key[this.index]) + "=>" + Byte2BooleanOpenHashMap.this.value[this.index];
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2BooleanOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Byte2BooleanOpenHashMap.this.f1096n;
            this.last = -1;
            this.f1098c = Byte2BooleanOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Byte2BooleanOpenHashMap.this.f1096n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int i3 = Byte2BooleanOpenHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (k == key[p]) {
                            return p;
                        ...
                        mix = p + 1;
                        i3 = Byte2BooleanOpenHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Byte2BooleanOpenHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Byte2BooleanOpenHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Byte2BooleanOpenHashMap.this.value[pos] = Byte2BooleanOpenHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Byte2BooleanOpenHashMap.this.f1096n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2BooleanOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Byte2BooleanMap.Entry>> implements ObjectIterator<Byte2BooleanMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2BooleanOpenHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2BooleanOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Byte2BooleanOpenHashMap.this.f1096n;
            this.f1099c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1099c++;
                acceptOnIndex(action, Byte2BooleanOpenHashMap.this.f1096n);
                return true;
            }
            byte[] key = Byte2BooleanOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Byte2BooleanOpenHashMap.this.size - this.f1099c);
            }
            return Math.min((long) (Byte2BooleanOpenHashMap.this.size - this.f1099c), ((long) ((((double) Byte2BooleanOpenHashMap.this.realSize()) / ((double) Byte2BooleanOpenHashMap.this.f1096n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap r0 = p014it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap.this
                byte[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2BooleanOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Byte2BooleanMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Byte2BooleanMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2BooleanOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Byte2BooleanMap.Entry> implements Byte2BooleanMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Byte2BooleanOpenHashMap.this.containsNullKey && Byte2BooleanOpenHashMap.this.value[Byte2BooleanOpenHashMap.this.f1096n] == v;
            }
            byte[] key = Byte2BooleanOpenHashMap.this.key;
            int mix = HashCommon.mix((int) k) & Byte2BooleanOpenHashMap.this.mask;
            int pos = mix;
            byte curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            ...
            do {
                int i = (pos + 1) & Byte2BooleanOpenHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (k != 0) {
                ...
                if (curr != k) {
                    while (true) {
                        ...
                        if (curr2 == k && Byte2BooleanOpenHashMap.this.value[pos] == v) {
                            Byte2BooleanOpenHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Byte2BooleanOpenHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Byte2BooleanOpenHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Byte2BooleanOpenHashMap.this.containsNullKey || Byte2BooleanOpenHashMap.this.value[Byte2BooleanOpenHashMap.this.f1096n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Byte2BooleanMap.Entry> consumer) {
            if (Byte2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2BooleanMap.BasicEntry(Byte2BooleanOpenHashMap.this.key[Byte2BooleanOpenHashMap.this.f1096n], Byte2BooleanOpenHashMap.this.value[Byte2BooleanOpenHashMap.this.f1096n]));
            }
            int pos = Byte2BooleanOpenHashMap.this.f1096n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Byte2BooleanMap.Entry> consumer) {
            ...
            if (Byte2BooleanOpenHashMap.this.containsNullKey) {
                entry.key = Byte2BooleanOpenHashMap.this.key[Byte2BooleanOpenHashMap.this.f1096n];
                entry.value = Byte2BooleanOpenHashMap.this.value[Byte2BooleanOpenHashMap.this.f1096n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2BooleanOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2BooleanOpenHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2BooleanOpenHashMap$KeySet.class */
    public final class KeySet extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            if (Byte2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(Byte2BooleanOpenHashMap.this.key[Byte2BooleanOpenHashMap.this.f1096n]);
            }
            int pos = Byte2BooleanOpenHashMap.this.f1096n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2BooleanOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2BooleanOpenHashMap$ValueSpliterator.class */
    ...
    public Collection<Boolean> values() {
        if (this.values == null) {
            this.values = new AbstractBooleanCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2BooleanOpenHashMap.1
                ...
                public void forEach(BooleanConsumer consumer) {
                    if (Byte2BooleanOpenHashMap.this.containsNullKey) {
                        consumer.accept(Byte2BooleanOpenHashMap.this.value[Byte2BooleanOpenHashMap.this.f1096n]);
                    }
                    int pos = Byte2BooleanOpenHashMap.this.f1096n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f1097f)));
        if (l >= this.f1096n || this.size > HashCommon.maxFill(l, this.f1097f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f1096n];
                this.f1096n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f1096n, this.f1097f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Byte2BooleanOpenHashMap clone() {
        try {
            Byte2BooleanOpenHashMap c = (Byte2BooleanOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += this.value[this.f1096n] ? RetcodeOuterClass.Retcode.RET_MP_OTHER_DATA_VERSION_NOT_LATEST_VALUE : RetcodeOuterClass.Retcode.RET_MP_MATCH_FULL_VALUE;
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f1096n = HashCommon.arraySize(this.size, this.f1097f);
        this.maxFill = HashCommon.maxFill(this.f1096n, this.f1097f);
        this.mask = this.f1096n - 1;
        byte[] key = new byte[this.f1096n + 1];
        this.key = key;
        boolean[] value = new boolean[this.f1096n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
