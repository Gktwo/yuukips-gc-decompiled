...
public class Byte2IntOpenHashMap extends AbstractByte2IntMap implements Serializable, Cloneable, Hash {
    ...
    public Byte2IntOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new int[this.f1156n + 1];
        }
    }
    ...
    public int removeNullEntry() {
        ...
        int oldValue = this.value[this.f1156n];
        this.size--;
        if (this.f1156n > this.minN && this.size < this.maxFill / 4 && this.f1156n > 16) {
            rehash(this.f1156n / 2);
        }
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Byte2IntOpenHashMap.this.f1156n;
            this.last = -1;
            this.f1158c = Byte2IntOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Byte2IntOpenHashMap.this.f1156n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Byte2IntOpenHashMap.this.f1156n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Byte2IntOpenHashMap.this.f1156n;
            this.f1159c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1159c++;
                acceptOnIndex(action, Byte2IntOpenHashMap.this.f1156n);
                return true;
            }
            byte[] key = Byte2IntOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Byte2IntOpenHashMap.this.size - this.f1159c);
            }
            return Math.min((long) (Byte2IntOpenHashMap.this.size - this.f1159c), ((long) ((((double) Byte2IntOpenHashMap.this.realSize()) / ((double) Byte2IntOpenHashMap.this.f1156n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Byte2IntMap.Entry> implements Byte2IntMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Byte2IntOpenHashMap.this.containsNullKey && Byte2IntOpenHashMap.this.value[Byte2IntOpenHashMap.this.f1156n] == v;
            }
            byte[] key = Byte2IntOpenHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Byte2IntOpenHashMap.this.containsNullKey || Byte2IntOpenHashMap.this.value[Byte2IntOpenHashMap.this.f1156n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Byte2IntMap.Entry> consumer) {
            if (Byte2IntOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2IntMap.BasicEntry(Byte2IntOpenHashMap.this.key[Byte2IntOpenHashMap.this.f1156n], Byte2IntOpenHashMap.this.value[Byte2IntOpenHashMap.this.f1156n]));
            }
            int pos = Byte2IntOpenHashMap.this.f1156n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Byte2IntMap.Entry> consumer) {
            ...
            if (Byte2IntOpenHashMap.this.containsNullKey) {
                entry.key = Byte2IntOpenHashMap.this.key[Byte2IntOpenHashMap.this.f1156n];
                entry.value = Byte2IntOpenHashMap.this.value[Byte2IntOpenHashMap.this.f1156n];
    ...
    public final class KeySet extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            if (Byte2IntOpenHashMap.this.containsNullKey) {
                consumer.accept(Byte2IntOpenHashMap.this.key[Byte2IntOpenHashMap.this.f1156n]);
            }
            int pos = Byte2IntOpenHashMap.this.f1156n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2IntOpenHashMap.1
                ...
                public void forEach(IntConsumer consumer) {
                    if (Byte2IntOpenHashMap.this.containsNullKey) {
                        consumer.accept(Byte2IntOpenHashMap.this.value[Byte2IntOpenHashMap.this.f1156n]);
                    }
                    int pos = Byte2IntOpenHashMap.this.f1156n;
                    while (true) {
                        pos--;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        int[] value = new int[this.f1156n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
