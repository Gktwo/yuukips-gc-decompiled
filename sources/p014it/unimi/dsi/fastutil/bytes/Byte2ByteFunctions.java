...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteFunctions.class */
public final class Byte2ByteFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractByte2ByteFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ByteFunction, p014it.unimi.dsi.fastutil.bytes.Byte2ByteFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Byte2ByteFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Byte2ByteFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Byte2ByteFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ByteFunction, java.util.function.IntUnaryOperator
        @Deprecated
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractByte2ByteFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Byte2ByteFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Byte2ByteFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Byte2ByteFunction {
        ...
        public byte get(byte key) {
            Byte v = (Byte) this.function.apply(Byte.valueOf(key));
        ...
        public Byte get(Object key) {
            ...
            return (Byte) this.function.apply((Byte) key);
        }
        ...
        public Byte getOrDefault(Object key, Byte defaultValue) {
            Byte v;
            if (!(key == null || (v = (Byte) this.function.apply((Byte) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
    ...
    public static Byte2ByteFunction primitive(java.util.function.Function<? super Byte, ? extends Byte> f) {
        ...
        return f instanceof Byte2ByteFunction ? (Byte2ByteFunction) f : f instanceof IntUnaryOperator ? key -> {
