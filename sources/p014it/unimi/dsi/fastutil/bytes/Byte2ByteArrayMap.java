...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteArrayMap.class */
public class Byte2ByteArrayMap extends AbstractByte2ByteMap implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Byte2ByteArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Byte2ByteArrayMap(Byte2ByteMap m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Byte2ByteMap.Entry> it = m.byte2ByteEntrySet().iterator();
        while (it.hasNext()) {
            Byte2ByteMap.Entry e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Byte2ByteMap.Entry> implements Byte2ByteMap.FastEntrySet {
        private EntrySet() {
        }

        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
        public ObjectIterator<Byte2ByteMap.Entry> iterator() {
            return new ObjectIterator<Byte2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ByteArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Byte2ByteMap.Entry next() {
                    ...
                    byte[] bArr = Byte2ByteArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    byte b = bArr[i];
                    byte[] bArr2 = Byte2ByteArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractByte2ByteMap.BasicEntry(b, bArr2[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Byte2ByteArrayMap.access$010(Byte2ByteArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Byte2ByteMap.Entry> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractByte2ByteMap.BasicEntry(b, bArr2[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Byte2ByteMap.Entry> fastIterator() {
            return new ObjectIterator<Byte2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ByteArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Byte2ByteMap.Entry next() {
                    ...
                    AbstractByte2ByteMap.BasicEntry basicEntry = this.entry;
                    byte[] bArr = Byte2ByteArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = bArr[i];
                    AbstractByte2ByteMap.BasicEntry basicEntry2 = this.entry;
                    byte[] bArr2 = Byte2ByteArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    basicEntry2.value = bArr2[i2];
                    return this.entry;
                }
        ...
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Byte2ByteMap.Entry> implements ObjectSpliterator<Byte2ByteMap.Entry> {
            ...
            public final Byte2ByteMap.Entry get(int location) {
        ...
        public boolean remove(Object o) {
            ...
            Byte2ByteArrayMap.access$010(Byte2ByteArrayMap.this);
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteArrayMap$KeySet.class */
    public final class KeySet extends AbstractByteSet {
        ...
        public Iterator<Byte> iterator() {
            return new ByteIterator() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ByteArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteArrayMap$KeySet$KeySetSpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractByteCollection {
        ...
        public ByteIterator iterator() {
            return new ByteIterator() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ByteArrayMap.ValuesCollection.1
                int pos = 0;
                ...
                public byte nextByte() {
                    ...
                    byte[] bArr = Byte2ByteArrayMap.this.value;
                    int i = this.pos;
                    this.pos = i + 1;
                    return bArr[i];
                }
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteArrayMap$ValuesCollection$ValuesSpliterator.class */
    ...
    public Byte2ByteArrayMap clone() {
        try {
            Byte2ByteArrayMap c = (Byte2ByteArrayMap) clone();
