...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceAVLTreeMap.class */
public class Byte2ReferenceAVLTreeMap<V> extends AbstractByte2ReferenceSortedMap<V> implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Byte2ReferenceAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap.Entry<V> add(byte r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap.add(byte):it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap$Entry");
    }
    ...
    public V remove(byte r5) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap.remove(byte):java.lang.Object");
    }

    @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ReferenceMap, java.util.Map
    public boolean containsValue(Object v) {
        Byte2ReferenceAVLTreeMap<V>.ValueIterator i = new ValueIterator();
        int j = this.count;
        do {
            j--;
            if (j == 0) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceAVLTreeMap$Entry.class */
    public static final class Entry<V> extends AbstractByte2ReferenceMap.BasicEntry<V> implements Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ReferenceMap.BasicEntry, java.util.Map.Entry
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ReferenceMap.BasicEntry, java.util.Map.Entry, java.lang.Object
        public boolean equals(Object o) {
            if (!(o instanceof Map.Entry)) {
                return false;
            }
            Map.Entry<Byte, V> e = (Map.Entry) o;
            return this.key == e.getKey().byteValue() && this.value == e.getValue();
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ReferenceMap.BasicEntry, java.lang.Object
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(byte k) {
            Entry<V> locateKey = Byte2ReferenceAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceAVLTreeMap$EntryIterator.class */
    public class EntryIterator extends Byte2ReferenceAVLTreeMap<V>.TreeIterator implements ObjectListIterator<Byte2ReferenceMap.Entry<V>> {
    ...
    public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap.1
                final Comparator<? super Byte2ReferenceMap.Entry<V>> comparator;

                {
                    this.comparator = Byte2ReferenceAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Byte)) {
                        return e.equals(Byte2ReferenceAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Byte) || (f = Byte2ReferenceAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue())) == null || f.getValue() != e.getValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceAVLTreeMap$KeyIterator.class */
    public final class KeyIterator extends Byte2ReferenceAVLTreeMap<V>.TreeIterator implements ByteListIterator {
        public KeyIterator() {
            super();
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceAVLTreeMap$KeySet.class */
    public class KeySet extends AbstractByte2ReferenceSortedMap<V>.KeySet {
        private KeySet() {
            super();
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ReferenceSortedMap.KeySet, p014it.unimi.dsi.fastutil.bytes.AbstractByteSortedSet, p014it.unimi.dsi.fastutil.bytes.AbstractByteSet, p014it.unimi.dsi.fastutil.bytes.AbstractByteCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.bytes.ByteCollection, p014it.unimi.dsi.fastutil.bytes.ByteIterable, p014it.unimi.dsi.fastutil.bytes.ByteSet, java.util.Set
        public ByteBidirectionalIterator iterator() {
            return new KeyIterator();
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ReferenceSortedMap.KeySet, p014it.unimi.dsi.fastutil.bytes.ByteSortedSet
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceAVLTreeMap$ValueIterator.class */
    public final class ValueIterator extends Byte2ReferenceAVLTreeMap<V>.TreeIterator implements ObjectListIterator<V> {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceAVLTreeMap$Submap.class */
    public final class Submap extends AbstractByte2ReferenceSortedMap<V> implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        byte from;
        ...
        @Override // p014it.unimi.dsi.fastutil.Function, p014it.unimi.dsi.fastutil.bytes.Byte2BooleanMap, java.util.Map
        public void clear() {
            Byte2ReferenceAVLTreeMap<V>.Submap.SubmapIterator i = new SubmapIterator();
            while (i.hasNext()) {
                i.nextEntry();
                i.remove();
            }
        ...
        /* renamed from: in */
        final boolean m1098in(byte k) {
            return (this.bottom || Byte2ReferenceAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ReferenceAVLTreeMap.this.compare(k, this.f1221to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceMap, p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceSortedMap
        public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.ObjectSortedSet
                    public /* bridge */ /* synthetic */ ObjectBidirectionalIterator iterator(Object obj) {
                        return iterator((Byte2ReferenceMap.Entry) ((Byte2ReferenceMap.Entry) obj));
                    }
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Byte) && (f = Byte2ReferenceAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue())) != null && Submap.this.m1098in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry<V> f = Byte2ReferenceAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue());
                        if (f != null && Submap.this.m1098in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractByte2ReferenceSortedMap<V>.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ReferenceCollection<V> values() {
            if (this.values == null) {
                this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractReferenceCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ReferenceCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection
                    public ObjectIterator<V> iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ReferenceMap, p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceFunction, p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceMap
        public boolean containsKey(byte k) {
            return m1098in(k) && Byte2ReferenceAVLTreeMap.this.containsKey(k);
        }
        ...
        public V get(byte k) {
            Entry<V> e;
            return (!m1098in(k) || (e = Byte2ReferenceAVLTreeMap.this.findKey(k)) == null) ? (V) this.defRetValue : (V) e.value;
        }
        ...
        public V put(byte k, V v) {
            ...
            if (!m1098in(k)) {
                throw new IllegalArgumentException("Key (" + ((int) k) + ") out of range [" + (this.bottom ? "-" : String.valueOf((int) this.from)) + ", " + (this.top ? "-" : String.valueOf((int) this.f1221to)) + ")");
            }
            return Byte2ReferenceAVLTreeMap.this.modified ? (V) this.defRetValue : (V) Byte2ReferenceAVLTreeMap.this.put(k, (byte) v);
        }
        ...
        public V remove(byte k) {
            ...
            return Byte2ReferenceAVLTreeMap.this.modified ? (V) Byte2ReferenceAVLTreeMap.this.remove(k) : (V) this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceSortedMap
        public Byte2ReferenceSortedMap<V> headMap(byte to) {
            if (!this.top && Byte2ReferenceAVLTreeMap.this.compare(to, this.f1221to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceSortedMap
        public Byte2ReferenceSortedMap<V> tailMap(byte from) {
            if (!this.bottom && Byte2ReferenceAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1221to, this.top);
        }
        ...
        public Byte2ReferenceSortedMap<V> subMap(byte from, byte to) {
            ...
            if (!this.top) {
                to = Byte2ReferenceAVLTreeMap.this.compare(to, this.f1221to) < 0 ? to : this.f1221to;
            }
            if (!this.bottom) {
                from = Byte2ReferenceAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1221to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.top || Byte2ReferenceAVLTreeMap.this.compare(e.key, this.f1221to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                ...
                e = Byte2ReferenceAVLTreeMap.this.locateKey(this.f1221to);
                if (Byte2ReferenceAVLTreeMap.this.compare(e.key, this.f1221to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Byte2ReferenceAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends Byte2ReferenceAVLTreeMap<V>.TreeIterator {
            SubmapIterator() {
                super();
            ...
            SubmapIterator(Submap submap, byte k) {
                ...
                if (submap.bottom || Byte2ReferenceAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Byte2ReferenceAVLTreeMap byte2ReferenceAVLTreeMap = Byte2ReferenceAVLTreeMap.this;
                        Entry<V> lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (byte2ReferenceAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Byte2ReferenceAVLTreeMap.this.compare(this.next.key, Submap.this.f1221to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceAVLTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends Byte2ReferenceAVLTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Byte2ReferenceMap.Entry<V>> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceAVLTreeMap$Submap$SubmapKeyIterator.class */
        public final class SubmapKeyIterator extends Byte2ReferenceAVLTreeMap<V>.Submap.SubmapIterator implements ByteListIterator {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceAVLTreeMap$Submap$SubmapValueIterator.class */
        public final class SubmapValueIterator extends Byte2ReferenceAVLTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<V> {
    ...
    public Byte2ReferenceAVLTreeMap<V> clone() {
        try {
            Byte2ReferenceAVLTreeMap<V> c = (Byte2ReferenceAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        int n = this.count;
        Byte2ReferenceAVLTreeMap<V>.EntryIterator i = new EntryIterator();
