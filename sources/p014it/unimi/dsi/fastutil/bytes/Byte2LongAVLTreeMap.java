...
import p014it.unimi.dsi.fastutil.bytes.AbstractByte2LongSortedMap;
...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongAVLTreeMap.class */
public class Byte2LongAVLTreeMap extends AbstractByte2LongSortedMap implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Byte2LongAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap.Entry add(byte r10) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap.add(byte):it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.bytes.Byte2LongFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public long remove(byte r5) {
        /*
        // Method dump skipped, instructions count: 1494
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap.remove(byte):long");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongAVLTreeMap$Entry.class */
    public static final class Entry extends AbstractByte2LongMap.BasicEntry implements Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2LongMap.BasicEntry, p014it.unimi.dsi.fastutil.bytes.Byte2LongMap.Entry
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2LongMap.BasicEntry, java.util.Map.Entry, java.lang.Object
        public boolean equals(Object o) {
            if (!(o instanceof Map.Entry)) {
                return false;
            }
            Map.Entry<Byte, Long> e = (Map.Entry) o;
            return this.key == e.getKey().byteValue() && this.value == e.getValue().longValue();
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2LongMap.BasicEntry, java.lang.Object
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(byte k) {
            Entry locateKey = Byte2LongAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongAVLTreeMap$EntryIterator.class */
    public class EntryIterator extends TreeIterator implements ObjectListIterator<Byte2LongMap.Entry> {
        EntryIterator() {
            super();
        }
    ...
    public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2LongMap.Entry>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap.1
                final Comparator<? super Byte2LongMap.Entry> comparator;

                {
                    this.comparator = Byte2LongAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Byte) && e.getValue() != null && (e.getValue() instanceof Long)) {
                        return e.equals(Byte2LongAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Byte) || !(e.getValue() instanceof Long) || (f = Byte2LongAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue())) == null || f.getLongValue() != ((Long) e.getValue()).longValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongAVLTreeMap$KeySet.class */
    public class KeySet extends AbstractByte2LongSortedMap.KeySet {
        private KeySet() {
            super();
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2LongSortedMap.KeySet, p014it.unimi.dsi.fastutil.bytes.AbstractByteSortedSet, p014it.unimi.dsi.fastutil.bytes.AbstractByteSet, p014it.unimi.dsi.fastutil.bytes.AbstractByteCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.bytes.ByteCollection, p014it.unimi.dsi.fastutil.bytes.ByteIterable, p014it.unimi.dsi.fastutil.bytes.ByteSet, java.util.Set
        public ByteBidirectionalIterator iterator() {
            return new KeyIterator();
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2LongSortedMap.KeySet, p014it.unimi.dsi.fastutil.bytes.ByteSortedSet
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongAVLTreeMap$ValueIterator.class */
    ...
    public LongCollection values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongAVLTreeMap$Submap.class */
    public final class Submap extends AbstractByte2LongSortedMap implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        byte from;
        ...
        /* renamed from: in */
        final boolean m1102in(byte k) {
            return (this.bottom || Byte2LongAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2LongAVLTreeMap.this.compare(k, this.f1161to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2LongMap, p014it.unimi.dsi.fastutil.bytes.Byte2LongSortedMap
        public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2LongMap.Entry>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Byte) && e.getValue() != null && (e.getValue() instanceof Long) && (f = Byte2LongAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue())) != null && Submap.this.m1102in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Byte2LongAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue());
                        if (f != null && Submap.this.m1102in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractByte2LongSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public LongCollection values() {
            if (this.values == null) {
                this.values = new AbstractLongCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.longs.AbstractLongCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.longs.LongCollection, p014it.unimi.dsi.fastutil.longs.LongIterable
                    public LongIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2LongMap, p014it.unimi.dsi.fastutil.bytes.Byte2LongFunction, p014it.unimi.dsi.fastutil.bytes.Byte2LongMap
        public boolean containsKey(byte k) {
            return m1102in(k) && Byte2LongAVLTreeMap.this.containsKey(k);
        }
        ...
        public long get(byte k) {
            Entry e;
            return (!m1102in(k) || (e = Byte2LongAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public long put(byte k, long v) {
            ...
            return Byte2LongAVLTreeMap.this.modified ? this.defRetValue : Byte2LongAVLTreeMap.this.put(k, v);
        }
        ...
        public long remove(byte k) {
            ...
            return Byte2LongAVLTreeMap.this.modified ? Byte2LongAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2LongSortedMap
        public Byte2LongSortedMap headMap(byte to) {
            if (!this.top && Byte2LongAVLTreeMap.this.compare(to, this.f1161to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2LongSortedMap
        public Byte2LongSortedMap tailMap(byte from) {
            if (!this.bottom && Byte2LongAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
        ...
        public Byte2LongSortedMap subMap(byte from, byte to) {
            ...
            if (!this.top) {
                to = Byte2LongAVLTreeMap.this.compare(to, this.f1161to) < 0 ? to : this.f1161to;
            }
            if (!this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Byte2LongAVLTreeMap.this.compare(e.key, this.f1161to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Byte2LongAVLTreeMap.this.locateKey(this.f1161to);
                if (Byte2LongAVLTreeMap.this.compare(e.key, this.f1161to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Byte2LongAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, byte k) {
                ...
                if (submap.bottom || Byte2LongAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Byte2LongAVLTreeMap byte2LongAVLTreeMap = Byte2LongAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (byte2LongAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Byte2LongAVLTreeMap.this.compare(this.next.key, Submap.this.f1161to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongAVLTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Byte2LongMap.Entry> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2LongAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2LongAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Byte2LongAVLTreeMap clone() {
        try {
            Byte2LongAVLTreeMap c = (Byte2LongAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n == 1) {
            ...
            Entry top2 = new Entry(s.readByte(), s.readLong());
            top2.right(new Entry(s.readByte(), s.readLong()));
