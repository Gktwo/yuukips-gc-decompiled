...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleRBTreeMap.class */
public class Byte2DoubleRBTreeMap extends AbstractByte2DoubleSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap.Entry add(byte r10) {
        /*
        // Method dump skipped, instructions count: 935
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap.add(byte):it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.bytes.Byte2DoubleFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public double remove(byte r7) {
        /*
        // Method dump skipped, instructions count: 1895
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap.remove(byte):double");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(byte k) {
            Entry locateKey = Byte2DoubleRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2DoubleMap.Entry>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap.1
                final Comparator<? super Byte2DoubleMap.Entry> comparator;

                {
                    this.comparator = Byte2DoubleRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Byte) && e.getValue() != null && (e.getValue() instanceof Double)) {
                        return e.equals(Byte2DoubleRBTreeMap.this.findKey(((Byte) e.getKey()).byteValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Byte) || e.getValue() == null || !(e.getValue() instanceof Double) || (f = Byte2DoubleRBTreeMap.this.findKey(((Byte) e.getKey()).byteValue())) == null || Double.doubleToLongBits(f.getDoubleValue()) != Double.doubleToLongBits(((Double) e.getValue()).doubleValue())) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleRBTreeMap$ValueIterator.class */
    ...
    public DoubleCollection values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleRBTreeMap$Submap.class */
    public final class Submap extends AbstractByte2DoubleSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m1107in(byte k) {
            return (this.bottom || Byte2DoubleRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2DoubleRBTreeMap.this.compare(k, this.f1172to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2DoubleMap, p014it.unimi.dsi.fastutil.bytes.Byte2DoubleSortedMap
        public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2DoubleMap.Entry>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Byte) && e.getValue() != null && (e.getValue() instanceof Double) && (f = Byte2DoubleRBTreeMap.this.findKey(((Byte) e.getKey()).byteValue())) != null && Submap.this.m1107in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Byte2DoubleRBTreeMap.this.findKey(((Byte) e.getKey()).byteValue());
                        if (f != null && Submap.this.m1107in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractByte2DoubleSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public DoubleCollection values() {
            if (this.values == null) {
                this.values = new AbstractDoubleCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDoubleCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.doubles.DoubleCollection, p014it.unimi.dsi.fastutil.doubles.DoubleIterable
                    public DoubleIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2DoubleMap, p014it.unimi.dsi.fastutil.bytes.Byte2DoubleFunction, p014it.unimi.dsi.fastutil.bytes.Byte2DoubleMap
        public boolean containsKey(byte k) {
            return m1107in(k) && Byte2DoubleRBTreeMap.this.containsKey(k);
        }
        ...
        public double get(byte k) {
            Entry e;
            return (!m1107in(k) || (e = Byte2DoubleRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public double put(byte k, double v) {
            ...
            if (!m1107in(k)) {
                throw new IllegalArgumentException("Key (" + ((int) k) + ") out of range [" + (this.bottom ? "-" : String.valueOf((int) this.from)) + ", " + (this.top ? "-" : String.valueOf((int) this.f1172to)) + ")");
            }
            return Byte2DoubleRBTreeMap.this.modified ? this.defRetValue : Byte2DoubleRBTreeMap.this.put(k, v);
        }
        ...
        public double remove(byte k) {
            ...
            return Byte2DoubleRBTreeMap.this.modified ? Byte2DoubleRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2DoubleSortedMap
        public Byte2DoubleSortedMap headMap(byte to) {
            if (!this.top && Byte2DoubleRBTreeMap.this.compare(to, this.f1172to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2DoubleSortedMap
        public Byte2DoubleSortedMap tailMap(byte from) {
            if (!this.bottom && Byte2DoubleRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1172to, this.top);
        }
        ...
        public Byte2DoubleSortedMap subMap(byte from, byte to) {
            ...
            if (!this.top) {
                to = Byte2DoubleRBTreeMap.this.compare(to, this.f1172to) < 0 ? to : this.f1172to;
            }
            if (!this.bottom) {
                from = Byte2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1172to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Byte2DoubleRBTreeMap.this.compare(e.key, this.f1172to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Byte2DoubleRBTreeMap.this.locateKey(this.f1172to);
                if (Byte2DoubleRBTreeMap.this.compare(e.key, this.f1172to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Byte2DoubleRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, byte k) {
                ...
                if (submap.bottom || Byte2DoubleRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Byte2DoubleRBTreeMap byte2DoubleRBTreeMap = Byte2DoubleRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (byte2DoubleRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Byte2DoubleRBTreeMap.this.compare(this.next.key, Submap.this.f1172to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Byte2DoubleRBTreeMap clone() {
        try {
            Byte2DoubleRBTreeMap c = (Byte2DoubleRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
