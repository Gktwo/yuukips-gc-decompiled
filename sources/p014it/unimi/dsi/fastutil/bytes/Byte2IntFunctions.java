...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntFunctions.class */
public final class Byte2IntFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractByte2IntFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2IntFunction, p014it.unimi.dsi.fastutil.bytes.Byte2IntFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Byte2IntFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Byte2IntFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Byte2IntFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2IntFunction, java.util.function.IntUnaryOperator
        @Deprecated
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractByte2IntFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Byte2IntFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Byte2IntFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2IntFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2IntFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Byte2IntFunction {
        ...
        public int get(byte key) {
            Integer v = (Integer) this.function.apply(Byte.valueOf(key));
        ...
        public Integer get(Object key) {
            ...
            return (Integer) this.function.apply((Byte) key);
        }
        ...
        public Integer getOrDefault(Object key, Integer defaultValue) {
            Integer v;
            if (!(key == null || (v = (Integer) this.function.apply((Byte) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
