...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteOpenHashMap.class */
public class Byte2ByteOpenHashMap extends AbstractByte2ByteMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f1108n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f1109f;
    ...
    public Byte2ByteOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f1108n = arraySize;
            this.minN = arraySize;
            this.mask = this.f1108n - 1;
            this.maxFill = HashCommon.maxFill(this.f1108n, f);
            this.key = new byte[this.f1108n + 1];
            this.value = new byte[this.f1108n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f1109f);
        if (needed > this.f1108n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f1109f)))));
        if (needed > this.f1108n) {
            rehash(needed);
        }
    }
    ...
    public byte removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f1108n > this.minN && this.size < this.maxFill / 4 && this.f1108n > 16) {
            rehash(this.f1108n / 2);
        }
        return oldValue;
    }
    ...
    public byte removeNullEntry() {
        ...
        byte oldValue = this.value[this.f1108n];
        this.size--;
        if (this.f1108n > this.minN && this.size < this.maxFill / 4 && this.f1108n > 16) {
            rehash(this.f1108n / 2);
        }
    ...
    private int find(byte k) {
        byte curr;
        if (k == 0) {
            return this.containsNullKey ? this.f1108n : -(this.f1108n + 1);
        }
        byte[] key = this.key;
    ...
    private void insert(int pos, byte k, byte v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f1109f));
        }
    }
    ...
    public byte addTo(byte k, byte incr) {
        ...
        if (k != 0) {
            ...
            return addToValue(this.f1108n, incr);
        } else {
            pos = this.f1108n;
            this.containsNullKey = true;
        }
    ...
    public byte get(byte k) {
        byte curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f1108n] : this.defRetValue;
        }
        byte[] key = this.key;
        int mix = HashCommon.mix((int) k) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(byte v) {
        ...
        byte[] key = this.key;
        if (this.containsNullKey && value[this.f1108n] == v) {
            return true;
        }
        int i = this.f1108n;
        while (true) {
    ...
    public byte getOrDefault(byte k, byte defaultValue) {
        byte curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f1108n] : defaultValue;
        }
        byte[] key = this.key;
        int mix = HashCommon.mix((int) k) & this.mask;
        int pos = mix;
    ...
    public boolean remove(byte k, byte v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1108n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteOpenHashMap$MapEntry.class */
    public final class MapEntry implements Byte2ByteMap.Entry, Map.Entry<Byte, Byte>, ByteBytePair {
        ...
        public boolean equals(Object o) {
            ...
            return Byte2ByteOpenHashMap.this.key[this.index] == e.getKey().byteValue() && Byte2ByteOpenHashMap.this.value[this.index] == e.getValue().byteValue();
        }
        ...
        public String toString() {
            return ((int) Byte2ByteOpenHashMap.this.key[this.index]) + "=>" + ((int) Byte2ByteOpenHashMap.this.value[this.index]);
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Byte2ByteOpenHashMap.this.f1108n;
            this.last = -1;
            this.f1110c = Byte2ByteOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Byte2ByteOpenHashMap.this.f1108n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int i3 = Byte2ByteOpenHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (k == key[p]) {
                            return p;
                        ...
                        mix = p + 1;
                        i3 = Byte2ByteOpenHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Byte2ByteOpenHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Byte2ByteOpenHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Byte2ByteOpenHashMap.this.value[pos] = Byte2ByteOpenHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Byte2ByteOpenHashMap.this.f1108n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Byte2ByteMap.Entry>> implements ObjectIterator<Byte2ByteMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteOpenHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Byte2ByteOpenHashMap.this.f1108n;
            this.f1111c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1111c++;
                acceptOnIndex(action, Byte2ByteOpenHashMap.this.f1108n);
                return true;
            }
            byte[] key = Byte2ByteOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Byte2ByteOpenHashMap.this.size - this.f1111c);
            }
            return Math.min((long) (Byte2ByteOpenHashMap.this.size - this.f1111c), ((long) ((((double) Byte2ByteOpenHashMap.this.realSize()) / ((double) Byte2ByteOpenHashMap.this.f1108n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap r0 = p014it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap.this
                byte[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Byte2ByteMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Byte2ByteMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Byte2ByteMap.Entry> implements Byte2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Byte2ByteOpenHashMap.this.containsNullKey && Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.f1108n] == v;
            }
            byte[] key = Byte2ByteOpenHashMap.this.key;
            int mix = HashCommon.mix((int) k) & Byte2ByteOpenHashMap.this.mask;
            int pos = mix;
            byte curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            ...
            do {
                int i = (pos + 1) & Byte2ByteOpenHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (k != 0) {
                ...
                if (curr != k) {
                    while (true) {
                        ...
                        if (curr2 == k && Byte2ByteOpenHashMap.this.value[pos] == v) {
                            Byte2ByteOpenHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Byte2ByteOpenHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Byte2ByteOpenHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Byte2ByteOpenHashMap.this.containsNullKey || Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.f1108n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Byte2ByteMap.Entry> consumer) {
            if (Byte2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2ByteMap.BasicEntry(Byte2ByteOpenHashMap.this.key[Byte2ByteOpenHashMap.this.f1108n], Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.f1108n]));
            }
            int pos = Byte2ByteOpenHashMap.this.f1108n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Byte2ByteMap.Entry> consumer) {
            ...
            if (Byte2ByteOpenHashMap.this.containsNullKey) {
                entry.key = Byte2ByteOpenHashMap.this.key[Byte2ByteOpenHashMap.this.f1108n];
                entry.value = Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.f1108n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteOpenHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteOpenHashMap$KeySet.class */
    public final class KeySet extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            if (Byte2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(Byte2ByteOpenHashMap.this.key[Byte2ByteOpenHashMap.this.f1108n]);
            }
            int pos = Byte2ByteOpenHashMap.this.f1108n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteOpenHashMap$ValueSpliterator.class */
    ...
    public Collection<Byte> values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ByteOpenHashMap.1
                ...
                public void forEach(ByteConsumer consumer) {
                    if (Byte2ByteOpenHashMap.this.containsNullKey) {
                        consumer.accept(Byte2ByteOpenHashMap.this.value[Byte2ByteOpenHashMap.this.f1108n]);
                    }
                    int pos = Byte2ByteOpenHashMap.this.f1108n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f1109f)));
        if (l >= this.f1108n || this.size > HashCommon.maxFill(l, this.f1109f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f1108n];
                this.f1108n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f1108n, this.f1109f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Byte2ByteOpenHashMap clone() {
        try {
            Byte2ByteOpenHashMap c = (Byte2ByteOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f1108n = HashCommon.arraySize(this.size, this.f1109f);
        this.maxFill = HashCommon.maxFill(this.f1108n, this.f1109f);
        this.mask = this.f1108n - 1;
        byte[] key = new byte[this.f1108n + 1];
        this.key = key;
        byte[] value = new byte[this.f1108n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
