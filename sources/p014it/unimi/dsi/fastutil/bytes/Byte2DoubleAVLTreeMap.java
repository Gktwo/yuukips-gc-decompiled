...
import p014it.unimi.dsi.fastutil.bytes.AbstractByte2DoubleSortedMap;
...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleAVLTreeMap.class */
public class Byte2DoubleAVLTreeMap extends AbstractByte2DoubleSortedMap implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Byte2DoubleAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap.Entry add(byte r10) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap.add(byte):it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.bytes.Byte2DoubleFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public double remove(byte r5) {
        /*
        // Method dump skipped, instructions count: 1494
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap.remove(byte):double");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleAVLTreeMap$Entry.class */
    public static final class Entry extends AbstractByte2DoubleMap.BasicEntry implements Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2DoubleMap.BasicEntry, p014it.unimi.dsi.fastutil.bytes.Byte2DoubleMap.Entry
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2DoubleMap.BasicEntry, java.util.Map.Entry, java.lang.Object
        public boolean equals(Object o) {
            if (!(o instanceof Map.Entry)) {
                return false;
            }
            Map.Entry<Byte, Double> e = (Map.Entry) o;
            return this.key == e.getKey().byteValue() && Double.doubleToLongBits(this.value) == Double.doubleToLongBits(e.getValue().doubleValue());
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2DoubleMap.BasicEntry, java.lang.Object
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(byte k) {
            Entry locateKey = Byte2DoubleAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleAVLTreeMap$EntryIterator.class */
    public class EntryIterator extends TreeIterator implements ObjectListIterator<Byte2DoubleMap.Entry> {
        EntryIterator() {
            super();
        }
    ...
    public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2DoubleMap.Entry>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap.1
                final Comparator<? super Byte2DoubleMap.Entry> comparator;

                {
                    this.comparator = Byte2DoubleAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Byte) && e.getValue() != null && (e.getValue() instanceof Double)) {
                        return e.equals(Byte2DoubleAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Byte) || !(e.getValue() instanceof Double) || (f = Byte2DoubleAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue())) == null || Double.doubleToLongBits(f.getDoubleValue()) != Double.doubleToLongBits(((Double) e.getValue()).doubleValue())) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleAVLTreeMap$KeySet.class */
    public class KeySet extends AbstractByte2DoubleSortedMap.KeySet {
        private KeySet() {
            super();
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2DoubleSortedMap.KeySet, p014it.unimi.dsi.fastutil.bytes.AbstractByteSortedSet, p014it.unimi.dsi.fastutil.bytes.AbstractByteSet, p014it.unimi.dsi.fastutil.bytes.AbstractByteCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.bytes.ByteCollection, p014it.unimi.dsi.fastutil.bytes.ByteIterable, p014it.unimi.dsi.fastutil.bytes.ByteSet, java.util.Set
        public ByteBidirectionalIterator iterator() {
            return new KeyIterator();
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2DoubleSortedMap.KeySet, p014it.unimi.dsi.fastutil.bytes.ByteSortedSet
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleAVLTreeMap$ValueIterator.class */
    ...
    public DoubleCollection values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleAVLTreeMap$Submap.class */
    public final class Submap extends AbstractByte2DoubleSortedMap implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        byte from;
        ...
        /* renamed from: in */
        final boolean m1108in(byte k) {
            return (this.bottom || Byte2DoubleAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2DoubleAVLTreeMap.this.compare(k, this.f1161to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2DoubleMap, p014it.unimi.dsi.fastutil.bytes.Byte2DoubleSortedMap
        public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2DoubleMap.Entry>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Byte) && e.getValue() != null && (e.getValue() instanceof Double) && (f = Byte2DoubleAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue())) != null && Submap.this.m1108in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Byte2DoubleAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue());
                        if (f != null && Submap.this.m1108in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractByte2DoubleSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public DoubleCollection values() {
            if (this.values == null) {
                this.values = new AbstractDoubleCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.doubles.AbstractDoubleCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.doubles.DoubleCollection, p014it.unimi.dsi.fastutil.doubles.DoubleIterable
                    public DoubleIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2DoubleMap, p014it.unimi.dsi.fastutil.bytes.Byte2DoubleFunction, p014it.unimi.dsi.fastutil.bytes.Byte2DoubleMap
        public boolean containsKey(byte k) {
            return m1108in(k) && Byte2DoubleAVLTreeMap.this.containsKey(k);
        }
        ...
        public double get(byte k) {
            Entry e;
            return (!m1108in(k) || (e = Byte2DoubleAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public double put(byte k, double v) {
            ...
            if (!m1108in(k)) {
                throw new IllegalArgumentException("Key (" + ((int) k) + ") out of range [" + (this.bottom ? "-" : String.valueOf((int) this.from)) + ", " + (this.top ? "-" : String.valueOf((int) this.f1161to)) + ")");
            }
            return Byte2DoubleAVLTreeMap.this.modified ? this.defRetValue : Byte2DoubleAVLTreeMap.this.put(k, v);
        }
        ...
        public double remove(byte k) {
            ...
            return Byte2DoubleAVLTreeMap.this.modified ? Byte2DoubleAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2DoubleSortedMap
        public Byte2DoubleSortedMap headMap(byte to) {
            if (!this.top && Byte2DoubleAVLTreeMap.this.compare(to, this.f1161to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2DoubleSortedMap
        public Byte2DoubleSortedMap tailMap(byte from) {
            if (!this.bottom && Byte2DoubleAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1161to, this.top);
        }
        ...
        public Byte2DoubleSortedMap subMap(byte from, byte to) {
            ...
            if (!this.top) {
                to = Byte2DoubleAVLTreeMap.this.compare(to, this.f1161to) < 0 ? to : this.f1161to;
            }
            if (!this.bottom) {
                from = Byte2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1161to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Byte2DoubleAVLTreeMap.this.compare(e.key, this.f1161to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Byte2DoubleAVLTreeMap.this.locateKey(this.f1161to);
                if (Byte2DoubleAVLTreeMap.this.compare(e.key, this.f1161to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Byte2DoubleAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, byte k) {
                ...
                if (submap.bottom || Byte2DoubleAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Byte2DoubleAVLTreeMap byte2DoubleAVLTreeMap = Byte2DoubleAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (byte2DoubleAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Byte2DoubleAVLTreeMap.this.compare(this.next.key, Submap.this.f1161to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleAVLTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Byte2DoubleMap.Entry> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2DoubleAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2DoubleAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Byte2DoubleAVLTreeMap clone() {
        try {
            Byte2DoubleAVLTreeMap c = (Byte2DoubleAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n == 1) {
            ...
            Entry top2 = new Entry(s.readByte(), s.readDouble());
            top2.right(new Entry(s.readByte(), s.readDouble()));
