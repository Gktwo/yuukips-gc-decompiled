...
public class Byte2FloatAVLTreeMap extends AbstractByte2FloatSortedMap implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractByte2FloatSortedMap implements Serializable {
        ...
        final boolean m1106in(byte k) {
            return (this.bottom || Byte2FloatAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2FloatAVLTreeMap.this.compare(k, this.f1137to) < 0);
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2FloatSortedMap
        public Byte2FloatSortedMap headMap(byte to) {
            if (!this.top && Byte2FloatAVLTreeMap.this.compare(to, this.f1137to) >= 0) {
                return this;
            }
        ...
        public Byte2FloatSortedMap subMap(byte from, byte to) {
            ...
            if (!this.top) {
                to = Byte2FloatAVLTreeMap.this.compare(to, this.f1137to) < 0 ? to : this.f1137to;
            }
            if (!this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Byte2FloatAVLTreeMap.this.compare(e.key, this.f1137to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Byte2FloatAVLTreeMap.this.locateKey(this.f1137to);
                if (Byte2FloatAVLTreeMap.this.compare(e.key, this.f1137to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Byte2FloatAVLTreeMap.this.compare(this.next.key, Submap.this.f1137to) >= 0) {
                    this.next = null;
                }
            }
        }
