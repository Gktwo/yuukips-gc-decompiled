...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceOpenCustomHashMap.class */
public class Byte2ReferenceOpenCustomHashMap<V> extends AbstractByte2ReferenceMap<V> implements Serializable, Cloneable, Hash {
    ...
    public Byte2ReferenceOpenCustomHashMap(Byte2ReferenceMap<V> m, ByteHash.Strategy strategy) {
        this((Byte2ReferenceMap) m, 0.75f, strategy);
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Byte2ReferenceMap.Entry<V>, Map.Entry<Byte, V>, ByteReferencePair<V> {
        ...
        public boolean equals(Object o) {
            ...
            return Byte2ReferenceOpenCustomHashMap.this.strategy.equals(Byte2ReferenceOpenCustomHashMap.this.key[this.index], e.getKey().byteValue()) && Byte2ReferenceOpenCustomHashMap.this.value[this.index] == e.getValue();
        }
        ...
        public String toString() {
            return ((int) Byte2ReferenceOpenCustomHashMap.this.key[this.index]) + "=>" + Byte2ReferenceOpenCustomHashMap.this.value[this.index];
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Byte2ReferenceOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Byte2ReferenceOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                        key[pos] = 0;
                        Byte2ReferenceOpenCustomHashMap.this.value[pos] = null;
                        return;
                    }
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Byte2ReferenceOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Byte2ReferenceOpenCustomHashMap.this.value[pos] = Byte2ReferenceOpenCustomHashMap.this.value[pos];
            }
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends Byte2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Byte2ReferenceMap.Entry<V>> {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap.MapIterator
        ...
        public Byte2ReferenceOpenCustomHashMap<V>.MapEntry next() {
            Byte2ReferenceOpenCustomHashMap<V>.MapEntry mapEntry = new MapEntry(nextEntry());
            this.entry = mapEntry;
            return mapEntry;
        }

        final void acceptOnIndex(Consumer<? super Byte2ReferenceMap.Entry<V>> action, int index) {
            Byte2ReferenceOpenCustomHashMap<V>.MapEntry mapEntry = new MapEntry(index);
            this.entry = mapEntry;
            action.accept(mapEntry);
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceOpenCustomHashMap$FastEntryIterator.class */
    private final class FastEntryIterator extends Byte2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Byte2ReferenceMap.Entry<V>> {
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends Byte2ReferenceOpenCustomHashMap<V>.MapSpliterator> {
        int pos;
        int max;
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap.this
                byte[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends Byte2ReferenceOpenCustomHashMap<V>.MapSpliterator implements ObjectSpliterator<Byte2ReferenceMap.Entry<V>> {
        private static final int POST_SPLIT_CHARACTERISTICS = 1;

        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap.MapSpliterator
        /* bridge */ /* synthetic */ void acceptOnIndex(Object obj, int i) {
            acceptOnIndex((Consumer) ((Consumer) obj), i);
        }
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap.MapSpliterator
        public final Byte2ReferenceOpenCustomHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
            return new EntrySpliterator(pos, max, mustReturnNull, true);
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Byte2ReferenceMap.Entry<V>> implements Byte2ReferenceMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Byte2ReferenceOpenCustomHashMap.this.value[pos] == value;
            }
            do {
                int i = (pos + 1) & Byte2ReferenceOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (!Byte2ReferenceOpenCustomHashMap.this.strategy.equals(k, (byte) 0)) {
                ...
                if (!Byte2ReferenceOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(curr2, k) && Byte2ReferenceOpenCustomHashMap.this.value[pos] == value) {
                            Byte2ReferenceOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Byte2ReferenceOpenCustomHashMap.this.value[pos] != value) {
                    return false;
                } else {
                    Byte2ReferenceOpenCustomHashMap.this.removeEntry(pos);
                    return true;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceOpenCustomHashMap$KeyIterator.class */
    public final class KeyIterator extends Byte2ReferenceOpenCustomHashMap<V>.MapIterator implements ByteIterator {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceOpenCustomHashMap$KeySpliterator.class */
    public final class KeySpliterator extends Byte2ReferenceOpenCustomHashMap<V>.MapSpliterator implements ByteSpliterator {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap.MapSpliterator
        public final Byte2ReferenceOpenCustomHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
            return new KeySpliterator(pos, max, mustReturnNull, true);
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceOpenCustomHashMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceOpenCustomHashMap$ValueIterator.class */
    public final class ValueIterator extends Byte2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<V> {
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap.MapIterator
        /* bridge */ /* synthetic */ void acceptOnIndex(Object obj, int i) {
            acceptOnIndex((Consumer) ((Consumer) obj), i);
        }
        ...
        final void acceptOnIndex(Consumer<? super V> action, int index) {
            action.accept((Object) Byte2ReferenceOpenCustomHashMap.this.value[index]);
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ReferenceOpenCustomHashMap$ValueSpliterator.class */
    public final class ValueSpliterator extends Byte2ReferenceOpenCustomHashMap<V>.MapSpliterator implements ObjectSpliterator<V> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap.MapSpliterator
        public final Byte2ReferenceOpenCustomHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ReferenceOpenCustomHashMap.1
                ...
                public void forEach(Consumer<? super V> consumer) {
                    ...
                    while (true) {
                        ...
                        if (Byte2ReferenceOpenCustomHashMap.this.key[pos] != 0) {
                            consumer.accept((Object) Byte2ReferenceOpenCustomHashMap.this.value[pos]);
                        }
                    }
                }
    ...
    public Byte2ReferenceOpenCustomHashMap<V> clone() {
        try {
            Byte2ReferenceOpenCustomHashMap<V> c = (Byte2ReferenceOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        byte[] key = this.key;
        V[] value = this.value;
        Byte2ReferenceOpenCustomHashMap<V>.EntryIterator i = new EntryIterator();
