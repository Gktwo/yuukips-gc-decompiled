...
import p014it.unimi.dsi.fastutil.bytes.AbstractByte2ByteSortedMap;
...
/* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteAVLTreeMap.class */
public class Byte2ByteAVLTreeMap extends AbstractByte2ByteSortedMap implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Byte2ByteAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap.Entry add(byte r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap.add(byte):it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ByteFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public byte remove(byte r5) {
        /*
        // Method dump skipped, instructions count: 1494
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap.remove(byte):byte");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteAVLTreeMap$Entry.class */
    public static final class Entry extends AbstractByte2ByteMap.BasicEntry implements Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ByteMap.BasicEntry, p014it.unimi.dsi.fastutil.bytes.Byte2ByteMap.Entry
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ByteMap.BasicEntry, java.util.Map.Entry, java.lang.Object
        public boolean equals(Object o) {
            if (!(o instanceof Map.Entry)) {
                return false;
            }
            Map.Entry<Byte, Byte> e = (Map.Entry) o;
            return this.key == e.getKey().byteValue() && this.value == e.getValue().byteValue();
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ByteMap.BasicEntry, java.lang.Object
    ...
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(byte k) {
            Entry locateKey = Byte2ByteAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteAVLTreeMap$EntryIterator.class */
    public class EntryIterator extends TreeIterator implements ObjectListIterator<Byte2ByteMap.Entry> {
        EntryIterator() {
            super();
        }
    ...
    public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Byte2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap.1
                final Comparator<? super Byte2ByteMap.Entry> comparator;

                {
                    this.comparator = Byte2ByteAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Byte) && e.getValue() != null && (e.getValue() instanceof Byte)) {
                        return e.equals(Byte2ByteAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Byte) || !(e.getValue() instanceof Byte) || (f = Byte2ByteAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue())) == null || f.getByteValue() != ((Byte) e.getValue()).byteValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteAVLTreeMap$KeySet.class */
    public class KeySet extends AbstractByte2ByteSortedMap.KeySet {
        private KeySet() {
            super();
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ByteSortedMap.KeySet, p014it.unimi.dsi.fastutil.bytes.AbstractByteSortedSet, p014it.unimi.dsi.fastutil.bytes.AbstractByteSet, p014it.unimi.dsi.fastutil.bytes.AbstractByteCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.bytes.ByteCollection, p014it.unimi.dsi.fastutil.bytes.ByteIterable, p014it.unimi.dsi.fastutil.bytes.ByteSet, java.util.Set
        public ByteBidirectionalIterator iterator() {
            return new KeyIterator();
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ByteSortedMap.KeySet, p014it.unimi.dsi.fastutil.bytes.ByteSortedSet
        public ByteBidirectionalIterator iterator(byte from) {
            return new KeyIterator(from);
        }
    }

    @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ByteSortedMap, p014it.unimi.dsi.fastutil.bytes.AbstractByte2ByteMap, p014it.unimi.dsi.fastutil.bytes.Byte2ByteMap, java.util.Map
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteAVLTreeMap$ValueIterator.class */
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteAVLTreeMap$Submap.class */
    public final class Submap extends AbstractByte2ByteSortedMap implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        byte from;
        ...
        /* renamed from: in */
        final boolean m1112in(byte k) {
            return (this.bottom || Byte2ByteAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Byte2ByteAVLTreeMap.this.compare(k, this.f1137to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ByteMap, p014it.unimi.dsi.fastutil.bytes.Byte2ByteSortedMap
        public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Byte2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Byte) && e.getValue() != null && (e.getValue() instanceof Byte) && (f = Byte2ByteAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue())) != null && Submap.this.m1112in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Byte2ByteAVLTreeMap.this.findKey(((Byte) e.getKey()).byteValue());
                        if (f != null && Submap.this.m1112in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractByte2ByteSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ByteCollection values() {
            if (this.values == null) {
                this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByteCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.bytes.ByteCollection, p014it.unimi.dsi.fastutil.bytes.ByteIterable, p014it.unimi.dsi.fastutil.bytes.ByteSet, java.util.Set
                    public ByteIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByte2ByteMap, p014it.unimi.dsi.fastutil.bytes.Byte2ByteFunction, p014it.unimi.dsi.fastutil.bytes.Byte2ByteMap
        public boolean containsKey(byte k) {
            return m1112in(k) && Byte2ByteAVLTreeMap.this.containsKey(k);
        }
        ...
        public byte get(byte k) {
            Entry e;
            return (!m1112in(k) || (e = Byte2ByteAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public byte put(byte k, byte v) {
            ...
            if (!m1112in(k)) {
                throw new IllegalArgumentException("Key (" + ((int) k) + ") out of range [" + (this.bottom ? "-" : String.valueOf((int) this.from)) + ", " + (this.top ? "-" : String.valueOf((int) this.f1137to)) + ")");
            }
            return Byte2ByteAVLTreeMap.this.modified ? this.defRetValue : Byte2ByteAVLTreeMap.this.put(k, v);
        }
        ...
        public byte remove(byte k) {
            ...
            return Byte2ByteAVLTreeMap.this.modified ? Byte2ByteAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ByteSortedMap
        public Byte2ByteSortedMap headMap(byte to) {
            if (!this.top && Byte2ByteAVLTreeMap.this.compare(to, this.f1137to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ByteSortedMap
        public Byte2ByteSortedMap tailMap(byte from) {
            if (!this.bottom && Byte2ByteAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1137to, this.top);
        }
        ...
        public Byte2ByteSortedMap subMap(byte from, byte to) {
            ...
            if (!this.top) {
                to = Byte2ByteAVLTreeMap.this.compare(to, this.f1137to) < 0 ? to : this.f1137to;
            }
            if (!this.bottom) {
                from = Byte2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1137to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Byte2ByteAVLTreeMap.this.compare(e.key, this.f1137to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Byte2ByteAVLTreeMap.this.locateKey(this.f1137to);
                if (Byte2ByteAVLTreeMap.this.compare(e.key, this.f1137to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Byte2ByteAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, byte k) {
                ...
                if (submap.bottom || Byte2ByteAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Byte2ByteAVLTreeMap byte2ByteAVLTreeMap = Byte2ByteAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (byte2ByteAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Byte2ByteAVLTreeMap.this.compare(this.next.key, Submap.this.f1137to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteAVLTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Byte2ByteMap.Entry> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.bytes.Byte2ByteAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/bytes/Byte2ByteAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Byte2ByteAVLTreeMap clone() {
        try {
            Byte2ByteAVLTreeMap c = (Byte2ByteAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n == 1) {
            ...
            Entry top2 = new Entry(s.readByte(), s.readByte());
            top2.right(new Entry(s.readByte(), s.readByte()));
