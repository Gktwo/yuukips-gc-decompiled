...
public class Byte2ByteOpenCustomHashMap extends AbstractByte2ByteMap implements Serializable, Cloneable, Hash {
    ...
    public Byte2ByteOpenCustomHashMap(int expected, float f, ByteHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new byte[this.f1140n + 1];
        }
    }
    ...
    public byte removeNullEntry() {
        ...
        byte oldValue = this.value[this.f1140n];
        this.size--;
        if (this.f1140n > this.minN && this.size < this.maxFill / 4 && this.f1140n > 16) {
            rehash(this.f1140n / 2);
        }
    ...
    public boolean containsValue(byte v) {
        ...
        byte[] key = this.key;
        if (this.containsNullKey && value[this.f1140n] == v) {
            return true;
        }
        int i = this.f1140n;
        while (true) {
    ...
    public boolean remove(byte k, byte v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1140n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Byte2ByteOpenCustomHashMap.this.f1140n;
            this.last = -1;
            this.f1142c = Byte2ByteOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Byte2ByteOpenCustomHashMap.this.f1140n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Byte2ByteOpenCustomHashMap.this.f1140n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Byte2ByteOpenCustomHashMap.this.f1140n;
            this.f1143c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1143c++;
                acceptOnIndex(action, Byte2ByteOpenCustomHashMap.this.f1140n);
                return true;
            }
            byte[] key = Byte2ByteOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Byte2ByteOpenCustomHashMap.this.size - this.f1143c);
            }
            return Math.min((long) (Byte2ByteOpenCustomHashMap.this.size - this.f1143c), ((long) ((((double) Byte2ByteOpenCustomHashMap.this.realSize()) / ((double) Byte2ByteOpenCustomHashMap.this.f1140n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Byte2ByteMap.Entry> implements Byte2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Byte2ByteOpenCustomHashMap.this.strategy.equals(k, (byte) 0)) {
                return Byte2ByteOpenCustomHashMap.this.containsNullKey && Byte2ByteOpenCustomHashMap.this.value[Byte2ByteOpenCustomHashMap.this.f1140n] == v;
            }
            byte[] key = Byte2ByteOpenCustomHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Byte2ByteOpenCustomHashMap.this.containsNullKey || Byte2ByteOpenCustomHashMap.this.value[Byte2ByteOpenCustomHashMap.this.f1140n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Byte2ByteMap.Entry> consumer) {
            if (Byte2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractByte2ByteMap.BasicEntry(Byte2ByteOpenCustomHashMap.this.key[Byte2ByteOpenCustomHashMap.this.f1140n], Byte2ByteOpenCustomHashMap.this.value[Byte2ByteOpenCustomHashMap.this.f1140n]));
            }
            int pos = Byte2ByteOpenCustomHashMap.this.f1140n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Byte2ByteMap.Entry> consumer) {
            ...
            if (Byte2ByteOpenCustomHashMap.this.containsNullKey) {
                entry.key = Byte2ByteOpenCustomHashMap.this.key[Byte2ByteOpenCustomHashMap.this.f1140n];
                entry.value = Byte2ByteOpenCustomHashMap.this.value[Byte2ByteOpenCustomHashMap.this.f1140n];
    ...
    public final class KeySet extends AbstractByteSet {
        ...
        public void forEach(ByteConsumer consumer) {
            if (Byte2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Byte2ByteOpenCustomHashMap.this.key[Byte2ByteOpenCustomHashMap.this.f1140n]);
            }
            int pos = Byte2ByteOpenCustomHashMap.this.f1140n;
            while (true) {
                pos--;
    ...
    public Collection<Byte> values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.bytes.Byte2ByteOpenCustomHashMap.1
                ...
                public void forEach(ByteConsumer consumer) {
                    if (Byte2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Byte2ByteOpenCustomHashMap.this.value[Byte2ByteOpenCustomHashMap.this.f1140n]);
                    }
                    int pos = Byte2ByteOpenCustomHashMap.this.f1140n;
                    while (true) {
                        pos--;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        byte[] value = new byte[this.f1140n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
