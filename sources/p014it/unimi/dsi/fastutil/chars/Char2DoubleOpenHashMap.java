...
public class Char2DoubleOpenHashMap extends AbstractChar2DoubleMap implements Serializable, Cloneable, Hash {
    ...
    public Char2DoubleOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new double[this.f1395n + 1];
        }
    }
    ...
    public double removeNullEntry() {
        ...
        double oldValue = this.value[this.f1395n];
        this.size--;
        if (this.f1395n > this.minN && this.size < this.maxFill / 4 && this.f1395n > 16) {
            rehash(this.f1395n / 2);
        }
    ...
    public boolean containsValue(double v) {
        ...
        char[] key = this.key;
        if (this.containsNullKey && Double.doubleToLongBits(value[this.f1395n]) == Double.doubleToLongBits(v)) {
            return true;
        }
        int i = this.f1395n;
        while (true) {
    ...
    public boolean remove(char k, double v) {
        ...
        } else if (!this.containsNullKey || Double.doubleToLongBits(v) != Double.doubleToLongBits(this.value[this.f1395n])) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Char2DoubleOpenHashMap.this.f1395n;
            this.last = -1;
            this.f1397c = Char2DoubleOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Char2DoubleOpenHashMap.this.f1395n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Char2DoubleOpenHashMap.this.f1395n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Char2DoubleOpenHashMap.this.f1395n;
            this.f1398c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1398c++;
                acceptOnIndex(action, Char2DoubleOpenHashMap.this.f1395n);
                return true;
            }
            char[] key = Char2DoubleOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Char2DoubleOpenHashMap.this.size - this.f1398c);
            }
            return Math.min((long) (Char2DoubleOpenHashMap.this.size - this.f1398c), ((long) ((((double) Char2DoubleOpenHashMap.this.realSize()) / ((double) Char2DoubleOpenHashMap.this.f1395n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Char2DoubleMap.Entry> implements Char2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Char2DoubleOpenHashMap.this.containsNullKey && Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.f1395n]) == Double.doubleToLongBits(v);
            }
            char[] key = Char2DoubleOpenHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Char2DoubleOpenHashMap.this.containsNullKey || Double.doubleToLongBits(Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.f1395n]) != Double.doubleToLongBits(v)) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Char2DoubleMap.Entry> consumer) {
            if (Char2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2DoubleMap.BasicEntry(Char2DoubleOpenHashMap.this.key[Char2DoubleOpenHashMap.this.f1395n], Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.f1395n]));
            }
            int pos = Char2DoubleOpenHashMap.this.f1395n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Char2DoubleMap.Entry> consumer) {
            ...
            if (Char2DoubleOpenHashMap.this.containsNullKey) {
                entry.key = Char2DoubleOpenHashMap.this.key[Char2DoubleOpenHashMap.this.f1395n];
                entry.value = Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.f1395n];
    ...
    public final class KeySet extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            if (Char2DoubleOpenHashMap.this.containsNullKey) {
                consumer.accept(Char2DoubleOpenHashMap.this.key[Char2DoubleOpenHashMap.this.f1395n]);
            }
            int pos = Char2DoubleOpenHashMap.this.f1395n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractDoubleCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2DoubleOpenHashMap.1
                ...
                public void forEach(DoubleConsumer consumer) {
                    if (Char2DoubleOpenHashMap.this.containsNullKey) {
                        consumer.accept(Char2DoubleOpenHashMap.this.value[Char2DoubleOpenHashMap.this.f1395n]);
                    }
                    int pos = Char2DoubleOpenHashMap.this.f1395n;
                    while (true) {
                        pos--;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.double2int(this.value[this.f1395n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        double[] value = new double[this.f1395n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
