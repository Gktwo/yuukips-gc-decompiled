...
public class CharArrayList extends AbstractCharList implements RandomAccess, Cloneable, Serializable {
    ...
    /* renamed from: a */
    protected transient char[] f1446a;
    protected int size;
    ...
    private static final char[] copyArrayFromSafe(CharArrayList l) {
        return copyArraySafe(l.f1446a, l.size);
    }
    ...
    private void initArrayFromCapacity(int capacity) {
        if (capacity < 0) {
            ...
            this.f1446a = CharArrays.EMPTY_ARRAY;
        } else {
            this.f1446a = new char[capacity];
        }
    }
    ...
    public CharArrayList() {
        this.f1446a = CharArrays.DEFAULT_EMPTY_ARRAY;
    }

    public CharArrayList(Collection<? extends Character> c) {
        if (c instanceof CharArrayList) {
            this.f1446a = copyArrayFromSafe((CharArrayList) c);
            this.size = this.f1446a.length;
            return;
        }
        ...
        this.size = CharIterators.unwrap(CharIterators.asCharIterator(c.iterator()), this.f1446a);
    }
    ...
    public CharArrayList(CharCollection c) {
        ...
        this.size = CharIterators.unwrap(c.iterator(), this.f1446a);
    }

    public CharArrayList(CharList l) {
        if (l instanceof CharArrayList) {
            this.f1446a = copyArrayFromSafe((CharArrayList) l);
            this.size = this.f1446a.length;
            return;
        }
    ...
    public CharArrayList(char[] a, int offset, int length) {
        this(length);
        System.arraycopy(a, offset, this.f1446a, 0, length);
        this.size = length;
    }
    ...
    public void ensureCapacity(int capacity) {
        if (capacity <= this.f1446a.length) {
            return;
        }
        if (this.f1446a != CharArrays.DEFAULT_EMPTY_ARRAY || capacity > 10) {
            this.f1446a = CharArrays.ensureCapacity(this.f1446a, capacity, this.size);
            if (!$assertionsDisabled && this.size > this.f1446a.length) {
    ...
    private void grow(int capacity) {
        if (capacity > this.f1446a.length) {
            if (this.f1446a != CharArrays.DEFAULT_EMPTY_ARRAY) {
                capacity = (int) Math.max(Math.min(((long) this.f1446a.length) + ((long) (this.f1446a.length >> 1)), 2147483639L), (long) capacity);
            } else if (capacity < 10) {
                capacity = 10;
            }
            this.f1446a = CharArrays.forceCapacity(this.f1446a, capacity, this.size);
            if (!$assertionsDisabled && this.size > this.f1446a.length) {
                throw new AssertionError();
            }
        }
    ...
    public void add(int index, char k) {
        ...
        grow(this.size + 1);
        if (index != this.size) {
            System.arraycopy(this.f1446a, index, this.f1446a, index + 1, this.size - index);
        }
        this.f1446a[index] = k;
        this.size++;
        if (!$assertionsDisabled && this.size > this.f1446a.length) {
    ...
    public char removeChar(int index) {
        ...
        char old = this.f1446a[index];
        this.size--;
        if (index != this.size) {
            System.arraycopy(this.f1446a, index + 1, this.f1446a, index, this.size - index);
        }
        if ($assertionsDisabled || this.size <= this.f1446a.length) {
            return old;
        }
    ...
    public void size(int size) {
        if (size > this.f1446a.length) {
            this.f1446a = CharArrays.forceCapacity(this.f1446a, size, this.size);
        }
        if (size > this.size) {
            Arrays.fill(this.f1446a, this.size, size, (char) 0);
        }
        this.size = size;
    }
    ...
    public void trim(int n) {
        if (n < this.f1446a.length && this.size != this.f1446a.length) {
            char[] t = new char[Math.max(n, this.size)];
            System.arraycopy(this.f1446a, 0, t, 0, this.size);
            this.f1446a = t;
            if (!$assertionsDisabled && this.size > this.f1446a.length) {
                throw new AssertionError();
            }
    ...
    public class SubList extends AbstractCharList.CharRandomAccessSubList {
        ...
        public final class SubListIterator extends CharIterators.AbstractIndexBasedListIterator {
            ...
            protected final char get(int i) {
                return CharArrayList.this.f1446a[SubList.this.from + i];
            }
            ...
            protected final int getMaxPos() {
                return SubList.this.f1314to - SubList.this.from;
            }
            ...
            public char nextChar() {
                ...
                char[] cArr = CharArrayList.this.f1446a;
            ...
            public void forEachRemaining(CharConsumer action) {
                int max = SubList.this.f1314to - SubList.this.from;
                while (this.pos < max) {
                    char[] cArr = CharArrayList.this.f1446a;
                    int i = SubList.this.from;
                    int i2 = this.pos;
        ...
        boolean contentsEquals(char[] otherA, int otherAFrom, int otherATo) {
            if (CharArrayList.this.f1446a == otherA && this.from == otherAFrom && this.f1314to == otherATo) {
                return true;
            }
            ...
            while (pos < this.f1314to) {
                pos++;
                otherPos++;
                if (CharArrayList.this.f1446a[pos] != otherA[otherPos]) {
                    return false;
                }
            }
            return true;
        ...
        public boolean equals(Object o) {
            ...
            if (o instanceof CharArrayList) {
                ...
                return contentsEquals(other.f1446a, 0, other.size());
            } else if (!(o instanceof SubList)) {
                return equals(o);
            } else {
                SubList other2 = (SubList) o;
                return contentsEquals(other2.getParentArray(), other2.from, other2.f1314to);
            }
        }
        ...
        int contentsCompareTo(char[] otherA, int otherAFrom, int otherATo) {
            ...
            int i = this.from;
            int j = otherAFrom;
            while (i < this.f1314to && i < otherATo) {
                int r = Character.compare(CharArrayList.this.f1446a[i], otherA[j]);
                if (r != 0) {
                    return r;
                }
                i++;
        ...
        public int compareTo(List<? extends Character> l) {
            if (l instanceof CharArrayList) {
                ...
                return contentsCompareTo(other.f1446a, 0, other.size());
            } else if (!(l instanceof SubList)) {
                return compareTo(l);
            } else {
                SubList other2 = (SubList) l;
                return contentsCompareTo(other2.getParentArray(), other2.from, other2.f1314to);
            }
        }
    }
    ...
    public void getElements(int from, char[] a, int offset, int length) {
        ...
        System.arraycopy(this.f1446a, from, a, offset, length);
    }

    @Override // p014it.unimi.dsi.fastutil.chars.AbstractCharList, p014it.unimi.dsi.fastutil.chars.CharList
    public void removeElements(int from, int to) {
        p014it.unimi.dsi.fastutil.Arrays.ensureFromTo(this.size, from, to);
        System.arraycopy(this.f1446a, to, this.f1446a, from, this.size - to);
        this.size -= to - from;
    }
    ...
    public void addElements(int index, char[] a, int offset, int length) {
        ...
        System.arraycopy(this.f1446a, index, this.f1446a, index + length, this.size - index);
        System.arraycopy(a, offset, this.f1446a, index, length);
        this.size += length;
    }
    ...
    public boolean addAll(int index, CharCollection c) {
        ...
        grow(this.size + n);
        System.arraycopy(this.f1446a, index, this.f1446a, index + n, this.size - index);
    ...
    public boolean addAll(int index, CharList l) {
        ...
        grow(this.size + n);
        System.arraycopy(this.f1446a, index, this.f1446a, index + n, this.size - index);
        l.getElements(0, this.f1446a, index, n);
        this.size += n;
        if ($assertionsDisabled || this.size <= this.f1446a.length) {
            return true;
        }
    ...
    public char[] toArray(char[] a) {
        ...
        System.arraycopy(this.f1446a, 0, a, 0, this.size);
        return a;
    }
    ...
    public final class Spliterator implements CharSpliterator {
        ...
        public void forEachRemaining(CharConsumer action) {
            ...
            while (this.pos < max) {
                action.accept(CharArrayList.this.f1446a[this.pos]);
                this.pos++;
            }
        }
    ...
    public void sort(CharComparator comp) {
        if (comp == null) {
            CharArrays.stableSort(this.f1446a, 0, this.size);
        } else {
            CharArrays.stableSort(this.f1446a, 0, this.size, comp);
        }
    }
    ...
    public void unstableSort(CharComparator comp) {
        if (comp == null) {
            CharArrays.unstableSort(this.f1446a, 0, this.size);
        } else {
            CharArrays.unstableSort(this.f1446a, 0, this.size, comp);
        }
    }
    ...
    public CharArrayList clone() {
        ...
        if (getClass() == CharArrayList.class) {
            cloned = new CharArrayList(copyArraySafe(this.f1446a, this.size), false);
            cloned.size = this.size;
        } else {
            try {
                cloned = (CharArrayList) clone();
                cloned.f1446a = copyArraySafe(this.f1446a, this.size);
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        ...
        for (int i = 0; i < this.size; i++) {
            s.writeChar(this.f1446a[i]);
        }
    }

    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        s.defaultReadObject();
        this.f1446a = new char[this.size];
        for (int i = 0; i < this.size; i++) {
            this.f1446a[i] = s.readChar();
        }
    }
}
