...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortFunctions.class */
public final class Char2ShortFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractChar2ShortFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ShortFunction, p014it.unimi.dsi.fastutil.chars.Char2ShortFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Char2ShortFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Char2ShortFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Char2ShortFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2ShortFunction, java.util.function.IntUnaryOperator
        @Deprecated
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractChar2ShortFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Char2ShortFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Char2ShortFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Char2ShortFunction {
        ...
        public short get(char key) {
            Short v = (Short) this.function.apply(Character.valueOf(key));
        ...
        public Short get(Object key) {
            ...
            return (Short) this.function.apply((Character) key);
        }
        ...
        public Short getOrDefault(Object key, Short defaultValue) {
            Short v;
            if (!(key == null || (v = (Short) this.function.apply((Character) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
    ...
    public static Char2ShortFunction primitive(java.util.function.Function<? super Character, ? extends Short> f) {
        ...
        return f instanceof Char2ShortFunction ? (Char2ShortFunction) f : f instanceof IntUnaryOperator ? key -> {
