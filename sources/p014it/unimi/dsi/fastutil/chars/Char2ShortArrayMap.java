...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortArrayMap.class */
public class Char2ShortArrayMap extends AbstractChar2ShortMap implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Char2ShortArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Char2ShortArrayMap(Char2ShortMap m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Char2ShortMap.Entry> it = m.char2ShortEntrySet().iterator();
        while (it.hasNext()) {
            Char2ShortMap.Entry e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Char2ShortMap.Entry> implements Char2ShortMap.FastEntrySet {
        private EntrySet() {
        }

        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
        public ObjectIterator<Char2ShortMap.Entry> iterator() {
            return new ObjectIterator<Char2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2ShortArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Char2ShortMap.Entry next() {
                    ...
                    char[] cArr = Char2ShortArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    char c = cArr[i];
                    short[] sArr = Char2ShortArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractChar2ShortMap.BasicEntry(c, sArr[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Char2ShortArrayMap.access$010(Char2ShortArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Char2ShortMap.Entry> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractChar2ShortMap.BasicEntry(c, sArr[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Char2ShortMap.Entry> fastIterator() {
            return new ObjectIterator<Char2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2ShortArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Char2ShortMap.Entry next() {
                    ...
                    AbstractChar2ShortMap.BasicEntry basicEntry = this.entry;
                    char[] cArr = Char2ShortArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = cArr[i];
                    AbstractChar2ShortMap.BasicEntry basicEntry2 = this.entry;
                    short[] sArr = Char2ShortArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Char2ShortMap.Entry> implements ObjectSpliterator<Char2ShortMap.Entry> {
            ...
            public final Char2ShortMap.Entry get(int location) {
        ...
        public boolean remove(Object o) {
            ...
            Char2ShortArrayMap.access$010(Char2ShortArrayMap.this);
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortArrayMap$KeySet.class */
    public final class KeySet extends AbstractCharSet {
        ...
        public CharIterator iterator() {
            return new CharIterator() { // from class: it.unimi.dsi.fastutil.chars.Char2ShortArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortArrayMap$KeySet$KeySetSpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractShortCollection {
        ...
        public ShortIterator iterator() {
            return new ShortIterator() { // from class: it.unimi.dsi.fastutil.chars.Char2ShortArrayMap.ValuesCollection.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortArrayMap$ValuesCollection$ValuesSpliterator.class */
    ...
    public Char2ShortArrayMap clone() {
        try {
            Char2ShortArrayMap c = (Char2ShortArrayMap) clone();
