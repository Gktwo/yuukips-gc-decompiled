...
/* renamed from: it.unimi.dsi.fastutil.chars.CharRBTreeSet */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/CharRBTreeSet.class */
public class CharRBTreeSet extends AbstractCharSortedSet implements Serializable, Cloneable, CharSortedSet {
    ...
    public boolean add(char r8) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.CharRBTreeSet.add(char):boolean");
    }
    ...
    public boolean remove(char r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.CharRBTreeSet.remove(char):boolean");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.CharRBTreeSet$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/CharRBTreeSet$Entry.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.CharRBTreeSet$SetIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/CharRBTreeSet$SetIterator.class */
    public class SetIterator implements CharListIterator {
        ...
        SetIterator(char k) {
            Entry locateKey = CharRBTreeSet.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.CharRBTreeSet$Subset */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/CharRBTreeSet$Subset.class */
    private final class Subset extends AbstractCharSortedSet implements Serializable, CharSortedSet {
        ...
        /* renamed from: in */
        final boolean m957in(char k) {
            return (this.bottom || CharRBTreeSet.this.compare(k, this.from) >= 0) && (this.top || CharRBTreeSet.this.compare(k, this.f1528to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.chars.AbstractCharCollection, p014it.unimi.dsi.fastutil.chars.CharCollection
        public boolean contains(char k) {
            return m957in(k) && CharRBTreeSet.this.contains(k);
        }
        ...
        public boolean add(char k) {
            ...
            throw new IllegalArgumentException("Element (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1528to)) + ")");
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.CharSortedSet
        public CharSortedSet headSet(char to) {
            if (!this.top && CharRBTreeSet.this.compare(to, this.f1528to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.CharSortedSet
        public CharSortedSet tailSet(char from) {
            if (!this.bottom && CharRBTreeSet.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Subset(from, false, this.f1528to, this.top);
        }
        ...
        public CharSortedSet subSet(char from, char to) {
            ...
            if (!this.top) {
                to = CharRBTreeSet.this.compare(to, this.f1528to) < 0 ? to : this.f1528to;
            }
            if (!this.bottom) {
                from = CharRBTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1528to) ? new Subset(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || CharRBTreeSet.this.compare(e.key, this.f1528to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = CharRBTreeSet.this.locateKey(this.f1528to);
                if (CharRBTreeSet.this.compare(e.key, this.f1528to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || CharRBTreeSet.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.CharRBTreeSet$Subset$SubsetIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/CharRBTreeSet$Subset$SubsetIterator.class */
        public final class SubsetIterator extends SetIterator {
            ...
            SubsetIterator(Subset subset, char k) {
                ...
                if (subset.bottom || CharRBTreeSet.this.compare(k, this.next.key) >= 0) {
                    if (!subset.top) {
                        CharRBTreeSet charRBTreeSet = CharRBTreeSet.this;
                        Entry lastEntry = subset.lastEntry();
                        this.prev = lastEntry;
                        if (charRBTreeSet.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.chars.CharRBTreeSet.SetIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Subset.this.top && this.next != null && CharRBTreeSet.this.compare(this.next.key, Subset.this.f1528to) >= 0) {
                    this.next = null;
                }
            }
        }
    ...
    public Object clone() {
        try {
            CharRBTreeSet c = (CharRBTreeSet) clone();
            c.allocatePaths();
            if (this.count == 0) {
                return c;
            }
