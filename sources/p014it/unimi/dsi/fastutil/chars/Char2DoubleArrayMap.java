...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2DoubleArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2DoubleArrayMap.class */
public class Char2DoubleArrayMap extends AbstractChar2DoubleMap implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Char2DoubleArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Char2DoubleArrayMap(Char2DoubleMap m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Char2DoubleMap.Entry> it = m.char2DoubleEntrySet().iterator();
        while (it.hasNext()) {
            Char2DoubleMap.Entry e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2DoubleArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2DoubleArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Char2DoubleMap.Entry> implements Char2DoubleMap.FastEntrySet {
        ...
        public ObjectIterator<Char2DoubleMap.Entry> iterator() {
            return new ObjectIterator<Char2DoubleMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2DoubleArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Char2DoubleMap.Entry next() {
                    ...
                    char[] cArr = Char2DoubleArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    char c = cArr[i];
                    ...
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractChar2DoubleMap.BasicEntry(c, dArr[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Char2DoubleArrayMap.access$010(Char2DoubleArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Char2DoubleMap.Entry> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractChar2DoubleMap.BasicEntry(c, dArr[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Char2DoubleMap.Entry> fastIterator() {
            return new ObjectIterator<Char2DoubleMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2DoubleArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Char2DoubleMap.Entry next() {
                    ...
                    AbstractChar2DoubleMap.BasicEntry basicEntry2 = this.entry;
                    double[] dArr = Char2DoubleArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2DoubleArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2DoubleArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Char2DoubleMap.Entry> implements ObjectSpliterator<Char2DoubleMap.Entry> {
            ...
            public final Char2DoubleMap.Entry get(int location) {
        ...
        public boolean remove(Object o) {
            ...
            Char2DoubleArrayMap.access$010(Char2DoubleArrayMap.this);
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2DoubleArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2DoubleArrayMap$KeySet.class */
    public final class KeySet extends AbstractCharSet {
        ...
        public CharIterator iterator() {
            return new CharIterator() { // from class: it.unimi.dsi.fastutil.chars.Char2DoubleArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2DoubleArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2DoubleArrayMap$KeySet$KeySetSpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2DoubleArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2DoubleArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractDoubleCollection {
        ...
        public DoubleIterator iterator() {
            return new DoubleIterator() { // from class: it.unimi.dsi.fastutil.chars.Char2DoubleArrayMap.ValuesCollection.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2DoubleArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2DoubleArrayMap$ValuesCollection$ValuesSpliterator.class */
    ...
    public Char2DoubleArrayMap clone() {
        try {
            Char2DoubleArrayMap c = (Char2DoubleArrayMap) clone();
