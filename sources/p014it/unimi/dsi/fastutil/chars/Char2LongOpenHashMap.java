...
public class Char2LongOpenHashMap extends AbstractChar2LongMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f1395n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f1396f;
    ...
    public Char2LongOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f1395n = arraySize;
            this.minN = arraySize;
            this.mask = this.f1395n - 1;
            this.maxFill = HashCommon.maxFill(this.f1395n, f);
            this.key = new char[this.f1395n + 1];
            this.value = new long[this.f1395n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f1396f);
        if (needed > this.f1395n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f1396f)))));
        if (needed > this.f1395n) {
            rehash(needed);
        }
    }
    ...
    public long removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f1395n > this.minN && this.size < this.maxFill / 4 && this.f1395n > 16) {
            rehash(this.f1395n / 2);
        }
        return oldValue;
    }
    ...
    public long removeNullEntry() {
        ...
        long oldValue = this.value[this.f1395n];
        this.size--;
        if (this.f1395n > this.minN && this.size < this.maxFill / 4 && this.f1395n > 16) {
            rehash(this.f1395n / 2);
        }
    ...
    private int find(char k) {
        char curr;
        if (k == 0) {
            return this.containsNullKey ? this.f1395n : -(this.f1395n + 1);
        }
        char[] key = this.key;
    ...
    private void insert(int pos, char k, long v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f1396f));
        }
    }
    ...
    public long addTo(char k, long incr) {
        ...
        if (k != 0) {
            ...
            return addToValue(this.f1395n, incr);
        } else {
            pos = this.f1395n;
            this.containsNullKey = true;
        }
    ...
    public long get(char k) {
        char curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f1395n] : this.defRetValue;
        }
        char[] key = this.key;
        int mix = HashCommon.mix((int) k) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(long v) {
        ...
        char[] key = this.key;
        if (this.containsNullKey && value[this.f1395n] == v) {
            return true;
        }
        int i = this.f1395n;
        while (true) {
    ...
    public long getOrDefault(char k, long defaultValue) {
        char curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f1395n] : defaultValue;
        }
        char[] key = this.key;
        int mix = HashCommon.mix((int) k) & this.mask;
        int pos = mix;
    ...
    public boolean remove(char k, long v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1395n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Char2LongOpenHashMap.this.f1395n;
            this.last = -1;
            this.f1397c = Char2LongOpenHashMap.this.size;
            this.mustReturnNullKey = Char2LongOpenHashMap.this.containsNullKey;
        }

        public boolean hasNext() {
            return this.f1397c != 0;
        }
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Char2LongOpenHashMap.this.f1395n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Char2LongOpenHashMap.this.f1395n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Char2LongOpenHashMap.this.f1395n;
            this.f1398c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1398c++;
                acceptOnIndex(action, Char2LongOpenHashMap.this.f1395n);
                return true;
            }
            char[] key = Char2LongOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Char2LongOpenHashMap.this.size - this.f1398c);
            }
            return Math.min((long) (Char2LongOpenHashMap.this.size - this.f1398c), ((long) ((((double) Char2LongOpenHashMap.this.realSize()) / ((double) Char2LongOpenHashMap.this.f1395n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Char2LongMap.Entry> implements Char2LongMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Char2LongOpenHashMap.this.containsNullKey && Char2LongOpenHashMap.this.value[Char2LongOpenHashMap.this.f1395n] == v;
            }
            char[] key = Char2LongOpenHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Char2LongOpenHashMap.this.containsNullKey || Char2LongOpenHashMap.this.value[Char2LongOpenHashMap.this.f1395n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Char2LongMap.Entry> consumer) {
            if (Char2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2LongMap.BasicEntry(Char2LongOpenHashMap.this.key[Char2LongOpenHashMap.this.f1395n], Char2LongOpenHashMap.this.value[Char2LongOpenHashMap.this.f1395n]));
            }
            int pos = Char2LongOpenHashMap.this.f1395n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Char2LongMap.Entry> consumer) {
            ...
            if (Char2LongOpenHashMap.this.containsNullKey) {
                entry.key = Char2LongOpenHashMap.this.key[Char2LongOpenHashMap.this.f1395n];
                entry.value = Char2LongOpenHashMap.this.value[Char2LongOpenHashMap.this.f1395n];
    ...
    public final class KeySet extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            if (Char2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(Char2LongOpenHashMap.this.key[Char2LongOpenHashMap.this.f1395n]);
            }
            int pos = Char2LongOpenHashMap.this.f1395n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractLongCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap.1
                ...
                public void forEach(LongConsumer consumer) {
                    if (Char2LongOpenHashMap.this.containsNullKey) {
                        consumer.accept(Char2LongOpenHashMap.this.value[Char2LongOpenHashMap.this.f1395n]);
                    }
                    int pos = Char2LongOpenHashMap.this.f1395n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f1396f)));
        if (l >= this.f1395n || this.size > HashCommon.maxFill(l, this.f1396f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f1395n];
                this.f1395n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f1395n, this.f1396f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.long2int(this.value[this.f1395n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f1395n = HashCommon.arraySize(this.size, this.f1396f);
        this.maxFill = HashCommon.maxFill(this.f1395n, this.f1396f);
        this.mask = this.f1395n - 1;
        char[] key = new char[this.f1395n + 1];
        this.key = key;
        long[] value = new long[this.f1395n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
