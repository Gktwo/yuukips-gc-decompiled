...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongOpenHashMap.class */
public class Char2LongOpenHashMap extends AbstractChar2LongMap implements Serializable, Cloneable, Hash {
    ...
    public long computeIfPresent(char r1, java.util.function.BiFunction<? super java.lang.Character, ? super java.lang.Long, ? extends java.lang.Long> r2) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap.computeIfPresent(char, java.util.function.BiFunction):long");
    }
    ...
    public long compute(char r1, java.util.function.BiFunction<? super java.lang.Character, ? super java.lang.Long, ? extends java.lang.Long> r2) {
        ...
        // Can't load method instructions: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap.compute(char, java.util.function.BiFunction<? super java.lang.Character, ? super java.lang.Long, ? extends java.lang.Long>):long, file: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongOpenHashMap.class
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap.compute(char, java.util.function.BiFunction):long");
    }
    ...
    public long merge(char r1, long r2, java.util.function.BiFunction<? super java.lang.Long, ? super java.lang.Long, ? extends java.lang.Long> r4) {
        ...
        // Can't load method instructions: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap.merge(char, long, java.util.function.BiFunction<? super java.lang.Long, ? super java.lang.Long, ? extends java.lang.Long>):long, file: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongOpenHashMap.class
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap.merge(char, long, java.util.function.BiFunction):long");
    }
    ...
    public Char2LongOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f1431n = arraySize;
            this.minN = arraySize;
            this.mask = this.f1431n - 1;
            this.maxFill = HashCommon.maxFill(this.f1431n, f);
            this.key = new char[this.f1431n + 1];
            this.value = new long[this.f1431n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f1432f);
        if (needed > this.f1431n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f1432f)))));
        if (needed > this.f1431n) {
            rehash(needed);
        }
    }
    ...
    public long removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f1431n > this.minN && this.size < this.maxFill / 4 && this.f1431n > 16) {
            rehash(this.f1431n / 2);
        }
        return oldValue;
    }
    ...
    public long removeNullEntry() {
        ...
        long oldValue = this.value[this.f1431n];
        this.size--;
        if (this.f1431n > this.minN && this.size < this.maxFill / 4 && this.f1431n > 16) {
            rehash(this.f1431n / 2);
        }
    ...
    private int find(char k) {
        char curr;
        if (k == 0) {
            return this.containsNullKey ? this.f1431n : -(this.f1431n + 1);
        }
        char[] key = this.key;
    ...
    private void insert(int pos, char k, long v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f1432f));
        }
    }
    ...
    public long addTo(char k, long incr) {
        ...
        if (k != 0) {
            ...
            return addToValue(this.f1431n, incr);
        } else {
            pos = this.f1431n;
            this.containsNullKey = true;
        }
    ...
    public long get(char k) {
        char curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f1431n] : this.defRetValue;
        }
        char[] key = this.key;
        int mix = HashCommon.mix((int) k) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(long v) {
        ...
        char[] key = this.key;
        if (this.containsNullKey && value[this.f1431n] == v) {
            return true;
        }
        int i = this.f1431n;
        while (true) {
    ...
    public long getOrDefault(char k, long defaultValue) {
        char curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f1431n] : defaultValue;
        }
        char[] key = this.key;
        int mix = HashCommon.mix((int) k) & this.mask;
        int pos = mix;
    ...
    public boolean remove(char k, long v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1431n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongOpenHashMap$MapEntry.class */
    public final class MapEntry implements Char2LongMap.Entry, Map.Entry<Character, Long>, CharLongPair {
        ...
        public boolean equals(Object o) {
            ...
            return Char2LongOpenHashMap.this.key[this.index] == e.getKey().charValue() && Char2LongOpenHashMap.this.value[this.index] == e.getValue().longValue();
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Char2LongOpenHashMap.this.f1431n;
            this.last = -1;
            this.f1433c = Char2LongOpenHashMap.this.size;
            this.mustReturnNullKey = Char2LongOpenHashMap.this.containsNullKey;
        }

        public boolean hasNext() {
            return this.f1433c != 0;
        }
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Char2LongOpenHashMap.this.f1431n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int i3 = Char2LongOpenHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (k == key[p]) {
                            return p;
                        ...
                        mix = p + 1;
                        i3 = Char2LongOpenHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Char2LongOpenHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Char2LongOpenHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Char2LongOpenHashMap.this.value[pos] = Char2LongOpenHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Char2LongOpenHashMap.this.f1431n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Char2LongMap.Entry>> implements ObjectIterator<Char2LongMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongOpenHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Char2LongOpenHashMap.this.f1431n;
            this.f1434c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1434c++;
                acceptOnIndex(action, Char2LongOpenHashMap.this.f1431n);
                return true;
            }
            char[] key = Char2LongOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Char2LongOpenHashMap.this.size - this.f1434c);
            }
            return Math.min((long) (Char2LongOpenHashMap.this.size - this.f1434c), ((long) ((((double) Char2LongOpenHashMap.this.realSize()) / ((double) Char2LongOpenHashMap.this.f1431n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap r0 = p014it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap.this
                char[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Char2LongMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Char2LongMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Char2LongMap.Entry> implements Char2LongMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Char2LongOpenHashMap.this.containsNullKey && Char2LongOpenHashMap.this.value[Char2LongOpenHashMap.this.f1431n] == v;
            }
            char[] key = Char2LongOpenHashMap.this.key;
            int mix = HashCommon.mix((int) k) & Char2LongOpenHashMap.this.mask;
            int pos = mix;
            char curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            ...
            do {
                int i = (pos + 1) & Char2LongOpenHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (k != 0) {
                ...
                if (curr != k) {
                    while (true) {
                        ...
                        if (curr2 == k && Char2LongOpenHashMap.this.value[pos] == v) {
                            Char2LongOpenHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Char2LongOpenHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Char2LongOpenHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Char2LongOpenHashMap.this.containsNullKey || Char2LongOpenHashMap.this.value[Char2LongOpenHashMap.this.f1431n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Char2LongMap.Entry> consumer) {
            if (Char2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2LongMap.BasicEntry(Char2LongOpenHashMap.this.key[Char2LongOpenHashMap.this.f1431n], Char2LongOpenHashMap.this.value[Char2LongOpenHashMap.this.f1431n]));
            }
            int pos = Char2LongOpenHashMap.this.f1431n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Char2LongMap.Entry> consumer) {
            ...
            if (Char2LongOpenHashMap.this.containsNullKey) {
                entry.key = Char2LongOpenHashMap.this.key[Char2LongOpenHashMap.this.f1431n];
                entry.value = Char2LongOpenHashMap.this.value[Char2LongOpenHashMap.this.f1431n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongOpenHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongOpenHashMap$KeySet.class */
    public final class KeySet extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            if (Char2LongOpenHashMap.this.containsNullKey) {
                consumer.accept(Char2LongOpenHashMap.this.key[Char2LongOpenHashMap.this.f1431n]);
            }
            int pos = Char2LongOpenHashMap.this.f1431n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongOpenHashMap$ValueSpliterator.class */
    ...
    public Collection<Long> values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2LongOpenHashMap.1
                ...
                public void forEach(LongConsumer consumer) {
                    if (Char2LongOpenHashMap.this.containsNullKey) {
                        consumer.accept(Char2LongOpenHashMap.this.value[Char2LongOpenHashMap.this.f1431n]);
                    }
                    int pos = Char2LongOpenHashMap.this.f1431n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f1432f)));
        if (l >= this.f1431n || this.size > HashCommon.maxFill(l, this.f1432f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f1431n];
                this.f1431n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f1431n, this.f1432f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Char2LongOpenHashMap clone() {
        try {
            Char2LongOpenHashMap c = (Char2LongOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.long2int(this.value[this.f1431n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f1431n = HashCommon.arraySize(this.size, this.f1432f);
        this.maxFill = HashCommon.maxFill(this.f1431n, this.f1432f);
        this.mask = this.f1431n - 1;
        char[] key = new char[this.f1431n + 1];
        this.key = key;
        long[] value = new long[this.f1431n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
