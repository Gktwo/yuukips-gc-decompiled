...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortRBTreeMap.class */
public class Char2ShortRBTreeMap extends AbstractChar2ShortSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap.Entry add(char r9) {
        /*
        // Method dump skipped, instructions count: 935
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap.add(char):it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.chars.Char2ShortFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public short remove(char r7) {
        /*
        // Method dump skipped, instructions count: 1895
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap.remove(char):short");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(char k) {
            Entry locateKey = Char2ShortRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap.1
                final Comparator<? super Char2ShortMap.Entry> comparator;

                {
                    this.comparator = Char2ShortRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Character) && e.getValue() != null && (e.getValue() instanceof Short)) {
                        return e.equals(Char2ShortRBTreeMap.this.findKey(((Character) e.getKey()).charValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Character) || e.getValue() == null || !(e.getValue() instanceof Short) || (f = Char2ShortRBTreeMap.this.findKey(((Character) e.getKey()).charValue())) == null || f.getShortValue() != ((Short) e.getValue()).shortValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortRBTreeMap$ValueIterator.class */
    ...
    public ShortCollection values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortRBTreeMap$Submap.class */
    public final class Submap extends AbstractChar2ShortSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m1010in(char k) {
            return (this.bottom || Char2ShortRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2ShortRBTreeMap.this.compare(k, this.f1471to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.chars.Char2ShortMap, p014it.unimi.dsi.fastutil.chars.Char2ShortSortedMap
        public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Character) && e.getValue() != null && (e.getValue() instanceof Short) && (f = Char2ShortRBTreeMap.this.findKey(((Character) e.getKey()).charValue())) != null && Submap.this.m1010in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        if (f != null && Submap.this.m1010in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractChar2ShortSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ShortCollection values() {
            if (this.values == null) {
                this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShortCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.shorts.ShortCollection, p014it.unimi.dsi.fastutil.shorts.ShortIterable
                    public ShortIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ShortMap, p014it.unimi.dsi.fastutil.chars.Char2ShortFunction, p014it.unimi.dsi.fastutil.chars.Char2ShortMap
        public boolean containsKey(char k) {
            return m1010in(k) && Char2ShortRBTreeMap.this.containsKey(k);
        }
        ...
        public short get(char k) {
            Entry e;
            return (!m1010in(k) || (e = Char2ShortRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public short put(char k, short v) {
            ...
            if (!m1010in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1471to)) + ")");
            }
            return Char2ShortRBTreeMap.this.modified ? this.defRetValue : Char2ShortRBTreeMap.this.put(k, v);
        }
        ...
        public short remove(char k) {
            ...
            return Char2ShortRBTreeMap.this.modified ? Char2ShortRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2ShortSortedMap
        public Char2ShortSortedMap headMap(char to) {
            if (!this.top && Char2ShortRBTreeMap.this.compare(to, this.f1471to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2ShortSortedMap
        public Char2ShortSortedMap tailMap(char from) {
            if (!this.bottom && Char2ShortRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1471to, this.top);
        }
        ...
        public Char2ShortSortedMap subMap(char from, char to) {
            ...
            if (!this.top) {
                to = Char2ShortRBTreeMap.this.compare(to, this.f1471to) < 0 ? to : this.f1471to;
            }
            if (!this.bottom) {
                from = Char2ShortRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1471to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Char2ShortRBTreeMap.this.compare(e.key, this.f1471to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Char2ShortRBTreeMap.this.locateKey(this.f1471to);
                if (Char2ShortRBTreeMap.this.compare(e.key, this.f1471to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Char2ShortRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, char k) {
                ...
                if (submap.bottom || Char2ShortRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Char2ShortRBTreeMap char2ShortRBTreeMap = Char2ShortRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (char2ShortRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Char2ShortRBTreeMap.this.compare(this.next.key, Submap.this.f1471to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Char2ShortRBTreeMap clone() {
        try {
            Char2ShortRBTreeMap c = (Char2ShortRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
