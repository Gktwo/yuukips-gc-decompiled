...
public class Char2IntOpenHashMap extends AbstractChar2IntMap implements Serializable, Cloneable, Hash {
    ...
    public Char2IntOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new int[this.f1383n + 1];
        }
    }
    ...
    public int removeNullEntry() {
        ...
        int oldValue = this.value[this.f1383n];
        this.size--;
        if (this.f1383n > this.minN && this.size < this.maxFill / 4 && this.f1383n > 16) {
            rehash(this.f1383n / 2);
        }
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Char2IntOpenHashMap.this.f1383n;
            this.last = -1;
            this.f1385c = Char2IntOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Char2IntOpenHashMap.this.f1383n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Char2IntOpenHashMap.this.f1383n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Char2IntOpenHashMap.this.f1383n;
            this.f1386c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1386c++;
                acceptOnIndex(action, Char2IntOpenHashMap.this.f1383n);
                return true;
            }
            char[] key = Char2IntOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Char2IntOpenHashMap.this.size - this.f1386c);
            }
            return Math.min((long) (Char2IntOpenHashMap.this.size - this.f1386c), ((long) ((((double) Char2IntOpenHashMap.this.realSize()) / ((double) Char2IntOpenHashMap.this.f1383n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Char2IntMap.Entry> implements Char2IntMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Char2IntOpenHashMap.this.containsNullKey && Char2IntOpenHashMap.this.value[Char2IntOpenHashMap.this.f1383n] == v;
            }
            char[] key = Char2IntOpenHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Char2IntOpenHashMap.this.containsNullKey || Char2IntOpenHashMap.this.value[Char2IntOpenHashMap.this.f1383n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Char2IntMap.Entry> consumer) {
            if (Char2IntOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2IntMap.BasicEntry(Char2IntOpenHashMap.this.key[Char2IntOpenHashMap.this.f1383n], Char2IntOpenHashMap.this.value[Char2IntOpenHashMap.this.f1383n]));
            }
            int pos = Char2IntOpenHashMap.this.f1383n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Char2IntMap.Entry> consumer) {
            ...
            if (Char2IntOpenHashMap.this.containsNullKey) {
                entry.key = Char2IntOpenHashMap.this.key[Char2IntOpenHashMap.this.f1383n];
                entry.value = Char2IntOpenHashMap.this.value[Char2IntOpenHashMap.this.f1383n];
    ...
    public final class KeySet extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            if (Char2IntOpenHashMap.this.containsNullKey) {
                consumer.accept(Char2IntOpenHashMap.this.key[Char2IntOpenHashMap.this.f1383n]);
            }
            int pos = Char2IntOpenHashMap.this.f1383n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2IntOpenHashMap.1
                ...
                public void forEach(IntConsumer consumer) {
                    if (Char2IntOpenHashMap.this.containsNullKey) {
                        consumer.accept(Char2IntOpenHashMap.this.value[Char2IntOpenHashMap.this.f1383n]);
                    }
                    int pos = Char2IntOpenHashMap.this.f1383n;
                    while (true) {
                        pos--;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        int[] value = new int[this.f1383n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
