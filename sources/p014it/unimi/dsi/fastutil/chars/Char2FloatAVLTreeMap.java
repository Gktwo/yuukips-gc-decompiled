...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatAVLTreeMap.class */
public class Char2FloatAVLTreeMap extends AbstractChar2FloatSortedMap implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Char2FloatAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap.Entry add(char r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap.add(char):it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.chars.Char2FloatFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public float remove(char r5) {
        /*
        // Method dump skipped, instructions count: 1494
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap.remove(char):float");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatAVLTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(char k) {
            Entry locateKey = Char2FloatAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatAVLTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2FloatMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap.1
                final Comparator<? super Char2FloatMap.Entry> comparator;

                {
                    this.comparator = Char2FloatAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Character) && e.getValue() != null && (e.getValue() instanceof Float)) {
                        return e.equals(Char2FloatAVLTreeMap.this.findKey(((Character) e.getKey()).charValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Character) || !(e.getValue() instanceof Float) || (f = Char2FloatAVLTreeMap.this.findKey(((Character) e.getKey()).charValue())) == null || Float.floatToIntBits(f.getFloatValue()) != Float.floatToIntBits(((Float) e.getValue()).floatValue())) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatAVLTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatAVLTreeMap$ValueIterator.class */
    ...
    public FloatCollection values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatAVLTreeMap$Submap.class */
    public final class Submap extends AbstractChar2FloatSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m1021in(char k) {
            return (this.bottom || Char2FloatAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2FloatAVLTreeMap.this.compare(k, this.f1364to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.chars.Char2FloatMap, p014it.unimi.dsi.fastutil.chars.Char2FloatSortedMap
        public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2FloatMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Character) && e.getValue() != null && (e.getValue() instanceof Float) && (f = Char2FloatAVLTreeMap.this.findKey(((Character) e.getKey()).charValue())) != null && Submap.this.m1021in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        if (f != null && Submap.this.m1021in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractChar2FloatSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public FloatCollection values() {
            if (this.values == null) {
                this.values = new AbstractFloatCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloatCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.floats.FloatCollection, p014it.unimi.dsi.fastutil.floats.FloatIterable
                    public FloatIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2FloatMap, p014it.unimi.dsi.fastutil.chars.Char2FloatFunction, p014it.unimi.dsi.fastutil.chars.Char2FloatMap
        public boolean containsKey(char k) {
            return m1021in(k) && Char2FloatAVLTreeMap.this.containsKey(k);
        }
        ...
        public float get(char k) {
            Entry e;
            return (!m1021in(k) || (e = Char2FloatAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public float put(char k, float v) {
            ...
            if (!m1021in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1364to)) + ")");
            }
            return Char2FloatAVLTreeMap.this.modified ? this.defRetValue : Char2FloatAVLTreeMap.this.put(k, v);
        }
        ...
        public float remove(char k) {
            ...
            return Char2FloatAVLTreeMap.this.modified ? Char2FloatAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2FloatSortedMap
        public Char2FloatSortedMap headMap(char to) {
            if (!this.top && Char2FloatAVLTreeMap.this.compare(to, this.f1364to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2FloatSortedMap
        public Char2FloatSortedMap tailMap(char from) {
            if (!this.bottom && Char2FloatAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1364to, this.top);
        }
        ...
        public Char2FloatSortedMap subMap(char from, char to) {
            ...
            if (!this.top) {
                to = Char2FloatAVLTreeMap.this.compare(to, this.f1364to) < 0 ? to : this.f1364to;
            }
            if (!this.bottom) {
                from = Char2FloatAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1364to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Char2FloatAVLTreeMap.this.compare(e.key, this.f1364to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Char2FloatAVLTreeMap.this.locateKey(this.f1364to);
                if (Char2FloatAVLTreeMap.this.compare(e.key, this.f1364to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Char2FloatAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, char k) {
                ...
                if (submap.bottom || Char2FloatAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Char2FloatAVLTreeMap char2FloatAVLTreeMap = Char2FloatAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (char2FloatAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Char2FloatAVLTreeMap.this.compare(this.next.key, Submap.this.f1364to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatAVLTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Char2FloatAVLTreeMap clone() {
        try {
            Char2FloatAVLTreeMap c = (Char2FloatAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
