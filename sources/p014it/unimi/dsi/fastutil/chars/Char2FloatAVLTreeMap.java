...
public class Char2FloatAVLTreeMap extends AbstractChar2FloatSortedMap implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractChar2FloatSortedMap implements Serializable {
        ...
        final boolean m1021in(char k) {
            return (this.bottom || Char2FloatAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2FloatAVLTreeMap.this.compare(k, this.f1400to) < 0);
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2FloatSortedMap
        public Char2FloatSortedMap headMap(char to) {
            if (!this.top && Char2FloatAVLTreeMap.this.compare(to, this.f1400to) >= 0) {
                return this;
            }
        ...
        public Char2FloatSortedMap subMap(char from, char to) {
            ...
            if (!this.top) {
                to = Char2FloatAVLTreeMap.this.compare(to, this.f1400to) < 0 ? to : this.f1400to;
            }
            if (!this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Char2FloatAVLTreeMap.this.compare(e.key, this.f1400to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Char2FloatAVLTreeMap.this.locateKey(this.f1400to);
                if (Char2FloatAVLTreeMap.this.compare(e.key, this.f1400to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Char2FloatAVLTreeMap.this.compare(this.next.key, Submap.this.f1400to) >= 0) {
                    this.next = null;
                }
            }
        }
