...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2CharArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharArrayMap.class */
public class Char2CharArrayMap extends AbstractChar2CharMap implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Char2CharArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Char2CharArrayMap(Char2CharMap m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Char2CharMap.Entry> it = m.char2CharEntrySet().iterator();
        while (it.hasNext()) {
            Char2CharMap.Entry e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Char2CharMap.Entry> implements Char2CharMap.FastEntrySet {
        private EntrySet() {
        }

        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
        public ObjectIterator<Char2CharMap.Entry> iterator() {
            return new ObjectIterator<Char2CharMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2CharArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Char2CharMap.Entry next() {
                    ...
                    char[] cArr = Char2CharArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    char c = cArr[i];
                    char[] cArr2 = Char2CharArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractChar2CharMap.BasicEntry(c, cArr2[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Char2CharArrayMap.access$010(Char2CharArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Char2CharMap.Entry> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractChar2CharMap.BasicEntry(c, cArr2[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Char2CharMap.Entry> fastIterator() {
            return new ObjectIterator<Char2CharMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2CharArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Char2CharMap.Entry next() {
                    ...
                    AbstractChar2CharMap.BasicEntry basicEntry = this.entry;
                    char[] cArr = Char2CharArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = cArr[i];
                    AbstractChar2CharMap.BasicEntry basicEntry2 = this.entry;
                    char[] cArr2 = Char2CharArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    basicEntry2.value = cArr2[i2];
                    return this.entry;
                }
        ...
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Char2CharMap.Entry> implements ObjectSpliterator<Char2CharMap.Entry> {
            ...
            public final Char2CharMap.Entry get(int location) {
        ...
        public boolean remove(Object o) {
            ...
            Char2CharArrayMap.access$010(Char2CharArrayMap.this);
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharArrayMap$KeySet.class */
    public final class KeySet extends AbstractCharSet {
        ...
        public CharIterator iterator() {
            return new CharIterator() { // from class: it.unimi.dsi.fastutil.chars.Char2CharArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharArrayMap$KeySet$KeySetSpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractCharCollection {
        ...
        public CharIterator iterator() {
            return new CharIterator() { // from class: it.unimi.dsi.fastutil.chars.Char2CharArrayMap.ValuesCollection.1
                int pos = 0;
                ...
                public char nextChar() {
                    ...
                    char[] cArr = Char2CharArrayMap.this.value;
                    int i = this.pos;
                    this.pos = i + 1;
                    return cArr[i];
                }
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharArrayMap$ValuesCollection$ValuesSpliterator.class */
    ...
    public Char2CharArrayMap clone() {
        try {
            Char2CharArrayMap c = (Char2CharArrayMap) clone();
