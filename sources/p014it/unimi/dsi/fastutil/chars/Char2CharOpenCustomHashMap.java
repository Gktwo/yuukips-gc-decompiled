...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharOpenCustomHashMap.class */
public class Char2CharOpenCustomHashMap extends AbstractChar2CharMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f1343n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f1344f;
    ...
    public Char2CharOpenCustomHashMap(int expected, float f, CharHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f1343n = arraySize;
            this.minN = arraySize;
            this.mask = this.f1343n - 1;
            this.maxFill = HashCommon.maxFill(this.f1343n, f);
            this.key = new char[this.f1343n + 1];
            this.value = new char[this.f1343n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f1344f);
        if (needed > this.f1343n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f1344f)))));
        if (needed > this.f1343n) {
            rehash(needed);
        }
    }
    ...
    public char removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f1343n > this.minN && this.size < this.maxFill / 4 && this.f1343n > 16) {
            rehash(this.f1343n / 2);
        }
        return oldValue;
    }
    ...
    public char removeNullEntry() {
        ...
        char oldValue = this.value[this.f1343n];
        this.size--;
        if (this.f1343n > this.minN && this.size < this.maxFill / 4 && this.f1343n > 16) {
            rehash(this.f1343n / 2);
        }
    ...
    private int find(char k) {
        ...
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.f1343n : -(this.f1343n + 1);
        }
        char[] key = this.key;
    ...
    private void insert(int pos, char k, char v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f1344f));
        }
    }
    ...
    public char addTo(char k, char incr) {
        ...
        if (!this.strategy.equals(k, 0)) {
            ...
            return addToValue(this.f1343n, incr);
        } else {
            pos = this.f1343n;
            this.containsNullKey = true;
        }
    ...
    public char get(char k) {
        char curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f1343n] : this.defRetValue;
        }
        char[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(char v) {
        ...
        char[] key = this.key;
        if (this.containsNullKey && value[this.f1343n] == v) {
            return true;
        }
        int i = this.f1343n;
        while (true) {
    ...
    public char getOrDefault(char k, char defaultValue) {
        char curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f1343n] : defaultValue;
        }
        char[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(char k, char v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1343n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Char2CharMap.Entry, Map.Entry<Character, Character>, CharCharPair {
        ...
        public boolean equals(Object o) {
            ...
            return Char2CharOpenCustomHashMap.this.strategy.equals(Char2CharOpenCustomHashMap.this.key[this.index], e.getKey().charValue()) && Char2CharOpenCustomHashMap.this.value[this.index] == e.getValue().charValue();
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Char2CharOpenCustomHashMap.this.f1343n;
            this.last = -1;
            this.f1345c = Char2CharOpenCustomHashMap.this.size;
            this.mustReturnNullKey = Char2CharOpenCustomHashMap.this.containsNullKey;
        }

        public boolean hasNext() {
            return this.f1345c != 0;
        }
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Char2CharOpenCustomHashMap.this.f1343n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Char2CharOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Char2CharOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Char2CharOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Char2CharOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Char2CharOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Char2CharOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Char2CharOpenCustomHashMap.this.value[pos] = Char2CharOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Char2CharOpenCustomHashMap.this.f1343n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Char2CharMap.Entry>> implements ObjectIterator<Char2CharMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Char2CharOpenCustomHashMap.this.f1343n;
            this.f1346c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1346c++;
                acceptOnIndex(action, Char2CharOpenCustomHashMap.this.f1343n);
                return true;
            }
            char[] key = Char2CharOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Char2CharOpenCustomHashMap.this.size - this.f1346c);
            }
            return Math.min((long) (Char2CharOpenCustomHashMap.this.size - this.f1346c), ((long) ((((double) Char2CharOpenCustomHashMap.this.realSize()) / ((double) Char2CharOpenCustomHashMap.this.f1343n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap.this
                char[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Char2CharMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Char2CharMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Char2CharMap.Entry> implements Char2CharMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Char2CharOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Char2CharOpenCustomHashMap.this.containsNullKey && Char2CharOpenCustomHashMap.this.value[Char2CharOpenCustomHashMap.this.f1343n] == v;
            }
            char[] key = Char2CharOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Char2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Char2CharOpenCustomHashMap.this.mask;
            int pos = mix;
            char curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            }
            if (Char2CharOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Char2CharOpenCustomHashMap.this.value[pos] == v;
            }
            do {
                int i = (pos + 1) & Char2CharOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (!Char2CharOpenCustomHashMap.this.strategy.equals(k, 0)) {
                ...
                if (!Char2CharOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Char2CharOpenCustomHashMap.this.strategy.equals(curr2, k) && Char2CharOpenCustomHashMap.this.value[pos] == v) {
                            Char2CharOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Char2CharOpenCustomHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Char2CharOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Char2CharOpenCustomHashMap.this.containsNullKey || Char2CharOpenCustomHashMap.this.value[Char2CharOpenCustomHashMap.this.f1343n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Char2CharMap.Entry> consumer) {
            if (Char2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2CharMap.BasicEntry(Char2CharOpenCustomHashMap.this.key[Char2CharOpenCustomHashMap.this.f1343n], Char2CharOpenCustomHashMap.this.value[Char2CharOpenCustomHashMap.this.f1343n]));
            }
            int pos = Char2CharOpenCustomHashMap.this.f1343n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Char2CharMap.Entry> consumer) {
            ...
            if (Char2CharOpenCustomHashMap.this.containsNullKey) {
                entry.key = Char2CharOpenCustomHashMap.this.key[Char2CharOpenCustomHashMap.this.f1343n];
                entry.value = Char2CharOpenCustomHashMap.this.value[Char2CharOpenCustomHashMap.this.f1343n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            if (Char2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Char2CharOpenCustomHashMap.this.key[Char2CharOpenCustomHashMap.this.f1343n]);
            }
            int pos = Char2CharOpenCustomHashMap.this.f1343n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Character> values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2CharOpenCustomHashMap.1
                ...
                public void forEach(CharConsumer consumer) {
                    if (Char2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Char2CharOpenCustomHashMap.this.value[Char2CharOpenCustomHashMap.this.f1343n]);
                    }
                    int pos = Char2CharOpenCustomHashMap.this.f1343n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f1344f)));
        if (l >= this.f1343n || this.size > HashCommon.maxFill(l, this.f1344f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f1343n];
                this.f1343n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f1343n, this.f1344f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Char2CharOpenCustomHashMap clone() {
        try {
            Char2CharOpenCustomHashMap c = (Char2CharOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f1343n = HashCommon.arraySize(this.size, this.f1344f);
        this.maxFill = HashCommon.maxFill(this.f1343n, this.f1344f);
        this.mask = this.f1343n - 1;
        char[] key = new char[this.f1343n + 1];
        this.key = key;
        char[] value = new char[this.f1343n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
