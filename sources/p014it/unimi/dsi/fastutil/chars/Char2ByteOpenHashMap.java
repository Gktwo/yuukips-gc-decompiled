...
public class Char2ByteOpenHashMap extends AbstractChar2ByteMap implements Serializable, Cloneable, Hash {
    ...
    public Char2ByteOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new byte[this.f1371n + 1];
        }
    }
    ...
    public byte removeNullEntry() {
        ...
        byte oldValue = this.value[this.f1371n];
        this.size--;
        if (this.f1371n > this.minN && this.size < this.maxFill / 4 && this.f1371n > 16) {
            rehash(this.f1371n / 2);
        }
    ...
    public boolean containsValue(byte v) {
        ...
        char[] key = this.key;
        if (this.containsNullKey && value[this.f1371n] == v) {
            return true;
        }
        int i = this.f1371n;
        while (true) {
    ...
    public boolean remove(char k, byte v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1371n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Char2ByteOpenHashMap.this.f1371n;
            this.last = -1;
            this.f1373c = Char2ByteOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Char2ByteOpenHashMap.this.f1371n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Char2ByteOpenHashMap.this.f1371n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Char2ByteOpenHashMap.this.f1371n;
            this.f1374c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1374c++;
                acceptOnIndex(action, Char2ByteOpenHashMap.this.f1371n);
                return true;
            }
            char[] key = Char2ByteOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Char2ByteOpenHashMap.this.size - this.f1374c);
            }
            return Math.min((long) (Char2ByteOpenHashMap.this.size - this.f1374c), ((long) ((((double) Char2ByteOpenHashMap.this.realSize()) / ((double) Char2ByteOpenHashMap.this.f1371n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Char2ByteMap.Entry> implements Char2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Char2ByteOpenHashMap.this.containsNullKey && Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.f1371n] == v;
            }
            char[] key = Char2ByteOpenHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Char2ByteOpenHashMap.this.containsNullKey || Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.f1371n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Char2ByteMap.Entry> consumer) {
            if (Char2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2ByteMap.BasicEntry(Char2ByteOpenHashMap.this.key[Char2ByteOpenHashMap.this.f1371n], Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.f1371n]));
            }
            int pos = Char2ByteOpenHashMap.this.f1371n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Char2ByteMap.Entry> consumer) {
            ...
            if (Char2ByteOpenHashMap.this.containsNullKey) {
                entry.key = Char2ByteOpenHashMap.this.key[Char2ByteOpenHashMap.this.f1371n];
                entry.value = Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.f1371n];
    ...
    public final class KeySet extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            if (Char2ByteOpenHashMap.this.containsNullKey) {
                consumer.accept(Char2ByteOpenHashMap.this.key[Char2ByteOpenHashMap.this.f1371n]);
            }
            int pos = Char2ByteOpenHashMap.this.f1371n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2ByteOpenHashMap.1
                ...
                public void forEach(ByteConsumer consumer) {
                    if (Char2ByteOpenHashMap.this.containsNullKey) {
                        consumer.accept(Char2ByteOpenHashMap.this.value[Char2ByteOpenHashMap.this.f1371n]);
                    }
                    int pos = Char2ByteOpenHashMap.this.f1371n;
                    while (true) {
                        pos--;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        byte[] value = new byte[this.f1371n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
