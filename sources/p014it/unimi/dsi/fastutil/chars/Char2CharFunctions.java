...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2CharFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharFunctions.class */
public final class Char2CharFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractChar2CharFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2CharFunction, p014it.unimi.dsi.fastutil.chars.Char2CharFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Char2CharFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Char2CharFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Char2CharFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2CharFunction, java.util.function.IntUnaryOperator
        @Deprecated
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractChar2CharFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Char2CharFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Char2CharFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2CharFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2CharFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Char2CharFunction {
        ...
        public char get(char key) {
            Character v = (Character) this.function.apply(Character.valueOf(key));
        ...
        public Character get(Object key) {
            ...
            return (Character) this.function.apply((Character) key);
        }
        ...
        public Character getOrDefault(Object key, Character defaultValue) {
            Character v;
            if (!(key == null || (v = (Character) this.function.apply((Character) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
    ...
    public static Char2CharFunction primitive(java.util.function.Function<? super Character, ? extends Character> f) {
        ...
        return f instanceof Char2CharFunction ? (Char2CharFunction) f : f instanceof IntUnaryOperator ? key -> {
