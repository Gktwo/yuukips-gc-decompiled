...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ObjectAVLTreeMap.class */
public class Char2ObjectAVLTreeMap<V> extends AbstractChar2ObjectSortedMap<V> implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Char2ObjectAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap.Entry<V> add(char r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap.add(char):it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap$Entry");
    }
    ...
    public V remove(char r5) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap.remove(char):java.lang.Object");
    }

    @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ObjectMap, java.util.Map
    public boolean containsValue(Object v) {
        Char2ObjectAVLTreeMap<V>.ValueIterator i = new ValueIterator();
        int j = this.count;
        do {
            j--;
            if (j == 0) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ObjectAVLTreeMap$Entry.class */
    public static final class Entry<V> extends AbstractChar2ObjectMap.BasicEntry<V> implements Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ObjectMap.BasicEntry, java.util.Map.Entry
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ObjectMap.BasicEntry, java.util.Map.Entry, java.lang.Object
        public boolean equals(Object o) {
            if (!(o instanceof Map.Entry)) {
                return false;
            }
            Map.Entry<Character, V> e = (Map.Entry) o;
            return this.key == e.getKey().charValue() && Objects.equals(this.value, e.getValue());
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ObjectMap.BasicEntry, java.lang.Object
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ObjectAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(char k) {
            Entry<V> locateKey = Char2ObjectAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ObjectAVLTreeMap$EntryIterator.class */
    public class EntryIterator extends Char2ObjectAVLTreeMap<V>.TreeIterator implements ObjectListIterator<Char2ObjectMap.Entry<V>> {
    ...
    public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ObjectMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap.1
                final Comparator<? super Char2ObjectMap.Entry<V>> comparator;

                {
                    this.comparator = Char2ObjectAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Character)) {
                        return e.equals(Char2ObjectAVLTreeMap.this.findKey(((Character) e.getKey()).charValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Character) || (f = Char2ObjectAVLTreeMap.this.findKey(((Character) e.getKey()).charValue())) == null || !Objects.equals(f.getValue(), e.getValue())) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ObjectAVLTreeMap$KeyIterator.class */
    public final class KeyIterator extends Char2ObjectAVLTreeMap<V>.TreeIterator implements CharListIterator {
        public KeyIterator() {
            super();
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ObjectAVLTreeMap$KeySet.class */
    public class KeySet extends AbstractChar2ObjectSortedMap<V>.KeySet {
        private KeySet() {
            super();
        }

        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ObjectSortedMap.KeySet, p014it.unimi.dsi.fastutil.chars.AbstractCharSortedSet, p014it.unimi.dsi.fastutil.chars.AbstractCharSet, p014it.unimi.dsi.fastutil.chars.AbstractCharCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.chars.CharCollection, p014it.unimi.dsi.fastutil.chars.CharIterable
        public CharBidirectionalIterator iterator() {
            return new KeyIterator();
        }

        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ObjectSortedMap.KeySet, p014it.unimi.dsi.fastutil.chars.CharSortedSet
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ObjectAVLTreeMap$ValueIterator.class */
    public final class ValueIterator extends Char2ObjectAVLTreeMap<V>.TreeIterator implements ObjectListIterator<V> {
    ...
    public ObjectCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>() { // from class: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ObjectAVLTreeMap$Submap.class */
    public final class Submap extends AbstractChar2ObjectSortedMap<V> implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        char from;
        ...
        @Override // p014it.unimi.dsi.fastutil.Function, p014it.unimi.dsi.fastutil.bytes.Byte2BooleanMap, java.util.Map
        public void clear() {
            Char2ObjectAVLTreeMap<V>.Submap.SubmapIterator i = new SubmapIterator();
            while (i.hasNext()) {
                i.nextEntry();
                i.remove();
            }
        ...
        /* renamed from: in */
        final boolean m1015in(char k) {
            return (this.bottom || Char2ObjectAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2ObjectAVLTreeMap.this.compare(k, this.f1436to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.chars.Char2ObjectMap, p014it.unimi.dsi.fastutil.chars.Char2ObjectSortedMap
        public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2ObjectMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.ObjectSortedSet
                    public /* bridge */ /* synthetic */ ObjectBidirectionalIterator iterator(Object obj) {
                        return iterator((Char2ObjectMap.Entry) ((Char2ObjectMap.Entry) obj));
                    }
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Character) && (f = Char2ObjectAVLTreeMap.this.findKey(((Character) e.getKey()).charValue())) != null && Submap.this.m1015in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry<V> f = Char2ObjectAVLTreeMap.this.findKey(((Character) e.getKey()).charValue());
                        if (f != null && Submap.this.m1015in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ObjectAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractChar2ObjectSortedMap<V>.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ObjectCollection<V> values() {
            if (this.values == null) {
                this.values = new AbstractObjectCollection<V>() { // from class: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectIterator<V> iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ObjectMap, p014it.unimi.dsi.fastutil.chars.Char2ObjectFunction, p014it.unimi.dsi.fastutil.chars.Char2ObjectMap
        public boolean containsKey(char k) {
            return m1015in(k) && Char2ObjectAVLTreeMap.this.containsKey(k);
        }
        ...
        public V get(char k) {
            Entry<V> e;
            return (!m1015in(k) || (e = Char2ObjectAVLTreeMap.this.findKey(k)) == null) ? (V) this.defRetValue : (V) e.value;
        }
        ...
        public V put(char k, V v) {
            ...
            if (!m1015in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1436to)) + ")");
            }
            return Char2ObjectAVLTreeMap.this.modified ? (V) this.defRetValue : (V) Char2ObjectAVLTreeMap.this.put(k, (char) v);
        }
        ...
        public V remove(char k) {
            ...
            return Char2ObjectAVLTreeMap.this.modified ? (V) Char2ObjectAVLTreeMap.this.remove(k) : (V) this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2ObjectSortedMap
        public Char2ObjectSortedMap<V> headMap(char to) {
            if (!this.top && Char2ObjectAVLTreeMap.this.compare(to, this.f1436to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2ObjectSortedMap
        public Char2ObjectSortedMap<V> tailMap(char from) {
            if (!this.bottom && Char2ObjectAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1436to, this.top);
        }
        ...
        public Char2ObjectSortedMap<V> subMap(char from, char to) {
            ...
            if (!this.top) {
                to = Char2ObjectAVLTreeMap.this.compare(to, this.f1436to) < 0 ? to : this.f1436to;
            }
            if (!this.bottom) {
                from = Char2ObjectAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1436to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.top || Char2ObjectAVLTreeMap.this.compare(e.key, this.f1436to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                ...
                e = Char2ObjectAVLTreeMap.this.locateKey(this.f1436to);
                if (Char2ObjectAVLTreeMap.this.compare(e.key, this.f1436to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Char2ObjectAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ObjectAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends Char2ObjectAVLTreeMap<V>.TreeIterator {
            SubmapIterator() {
                super();
            ...
            SubmapIterator(Submap submap, char k) {
                ...
                if (submap.bottom || Char2ObjectAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Char2ObjectAVLTreeMap char2ObjectAVLTreeMap = Char2ObjectAVLTreeMap.this;
                        Entry<V> lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (char2ObjectAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Char2ObjectAVLTreeMap.this.compare(this.next.key, Submap.this.f1436to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ObjectAVLTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends Char2ObjectAVLTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Char2ObjectMap.Entry<V>> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ObjectAVLTreeMap$Submap$SubmapKeyIterator.class */
        public final class SubmapKeyIterator extends Char2ObjectAVLTreeMap<V>.Submap.SubmapIterator implements CharListIterator {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ObjectAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ObjectAVLTreeMap$Submap$SubmapValueIterator.class */
        public final class SubmapValueIterator extends Char2ObjectAVLTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<V> {
    ...
    public Char2ObjectAVLTreeMap<V> clone() {
        try {
            Char2ObjectAVLTreeMap<V> c = (Char2ObjectAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        int n = this.count;
        Char2ObjectAVLTreeMap<V>.EntryIterator i = new EntryIterator();
