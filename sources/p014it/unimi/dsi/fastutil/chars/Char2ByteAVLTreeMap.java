...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteAVLTreeMap.class */
public class Char2ByteAVLTreeMap extends AbstractChar2ByteSortedMap implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Char2ByteAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap.Entry add(char r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap.add(char):it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.chars.Char2ByteFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public byte remove(char r5) {
        /*
        // Method dump skipped, instructions count: 1494
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap.remove(char):byte");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteAVLTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(char k) {
            Entry locateKey = Char2ByteAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteAVLTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap.1
                final Comparator<? super Char2ByteMap.Entry> comparator;

                {
                    this.comparator = Char2ByteAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Character) && e.getValue() != null && (e.getValue() instanceof Byte)) {
                        return e.equals(Char2ByteAVLTreeMap.this.findKey(((Character) e.getKey()).charValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Character) || !(e.getValue() instanceof Byte) || (f = Char2ByteAVLTreeMap.this.findKey(((Character) e.getKey()).charValue())) == null || f.getByteValue() != ((Byte) e.getValue()).byteValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteAVLTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteAVLTreeMap$ValueIterator.class */
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteAVLTreeMap$Submap.class */
    public final class Submap extends AbstractChar2ByteSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m1027in(char k) {
            return (this.bottom || Char2ByteAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2ByteAVLTreeMap.this.compare(k, this.f1328to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.chars.Char2ByteMap, p014it.unimi.dsi.fastutil.chars.Char2ByteSortedMap
        public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Character) && e.getValue() != null && (e.getValue() instanceof Byte) && (f = Char2ByteAVLTreeMap.this.findKey(((Character) e.getKey()).charValue())) != null && Submap.this.m1027in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        if (f != null && Submap.this.m1027in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractChar2ByteSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ByteCollection values() {
            if (this.values == null) {
                this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByteCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.bytes.ByteCollection, p014it.unimi.dsi.fastutil.bytes.ByteIterable, p014it.unimi.dsi.fastutil.bytes.ByteSet, java.util.Set
                    public ByteIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ByteMap, p014it.unimi.dsi.fastutil.chars.Char2ByteFunction, p014it.unimi.dsi.fastutil.chars.Char2ByteMap
        public boolean containsKey(char k) {
            return m1027in(k) && Char2ByteAVLTreeMap.this.containsKey(k);
        }
        ...
        public byte get(char k) {
            Entry e;
            return (!m1027in(k) || (e = Char2ByteAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public byte put(char k, byte v) {
            ...
            if (!m1027in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1328to)) + ")");
            }
            return Char2ByteAVLTreeMap.this.modified ? this.defRetValue : Char2ByteAVLTreeMap.this.put(k, v);
        }
        ...
        public byte remove(char k) {
            ...
            return Char2ByteAVLTreeMap.this.modified ? Char2ByteAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2ByteSortedMap
        public Char2ByteSortedMap headMap(char to) {
            if (!this.top && Char2ByteAVLTreeMap.this.compare(to, this.f1328to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2ByteSortedMap
        public Char2ByteSortedMap tailMap(char from) {
            if (!this.bottom && Char2ByteAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1328to, this.top);
        }
        ...
        public Char2ByteSortedMap subMap(char from, char to) {
            ...
            if (!this.top) {
                to = Char2ByteAVLTreeMap.this.compare(to, this.f1328to) < 0 ? to : this.f1328to;
            }
            if (!this.bottom) {
                from = Char2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1328to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Char2ByteAVLTreeMap.this.compare(e.key, this.f1328to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Char2ByteAVLTreeMap.this.locateKey(this.f1328to);
                if (Char2ByteAVLTreeMap.this.compare(e.key, this.f1328to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Char2ByteAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, char k) {
                ...
                if (submap.bottom || Char2ByteAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Char2ByteAVLTreeMap char2ByteAVLTreeMap = Char2ByteAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (char2ByteAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Char2ByteAVLTreeMap.this.compare(this.next.key, Submap.this.f1328to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteAVLTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Char2ByteAVLTreeMap clone() {
        try {
            Char2ByteAVLTreeMap c = (Char2ByteAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
