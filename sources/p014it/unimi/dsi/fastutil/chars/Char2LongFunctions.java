...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2LongFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongFunctions.class */
public final class Char2LongFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractChar2LongFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2LongFunction, p014it.unimi.dsi.fastutil.chars.Char2LongFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Char2LongFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Char2LongFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Char2LongFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2LongFunction, java.util.function.IntToLongFunction
        @Deprecated
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractChar2LongFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Char2LongFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Char2LongFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2LongFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2LongFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Char2LongFunction {
        ...
        public long get(char key) {
            Long v = (Long) this.function.apply(Character.valueOf(key));
        ...
        public Long get(Object key) {
            ...
            return (Long) this.function.apply((Character) key);
        }
        ...
        public Long getOrDefault(Object key, Long defaultValue) {
            Long v;
            if (!(key == null || (v = (Long) this.function.apply((Character) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
