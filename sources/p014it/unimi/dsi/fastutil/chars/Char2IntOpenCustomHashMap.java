...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2IntOpenCustomHashMap.class */
public class Char2IntOpenCustomHashMap extends AbstractChar2IntMap implements Serializable, Cloneable, Hash {
    ...
    public Char2IntOpenCustomHashMap(int expected, float f, CharHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new int[this.f1379n + 1];
        }
    }
    ...
    public int removeNullEntry() {
        ...
        int oldValue = this.value[this.f1379n];
        this.size--;
        if (this.f1379n > this.minN && this.size < this.maxFill / 4 && this.f1379n > 16) {
            rehash(this.f1379n / 2);
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2IntOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Char2IntMap.Entry, Map.Entry<Character, Integer>, CharIntPair {
        ...
        public boolean equals(Object o) {
            ...
            return Char2IntOpenCustomHashMap.this.strategy.equals(Char2IntOpenCustomHashMap.this.key[this.index], e.getKey().charValue()) && Char2IntOpenCustomHashMap.this.value[this.index] == e.getValue().intValue();
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2IntOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Char2IntOpenCustomHashMap.this.f1379n;
            this.last = -1;
            this.f1381c = Char2IntOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Char2IntOpenCustomHashMap.this.f1379n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Char2IntOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Char2IntOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Char2IntOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Char2IntOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Char2IntOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Char2IntOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Char2IntOpenCustomHashMap.this.value[pos] = Char2IntOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Char2IntOpenCustomHashMap.this.f1379n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2IntOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Char2IntMap.Entry>> implements ObjectIterator<Char2IntMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2IntOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2IntOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Char2IntOpenCustomHashMap.this.f1379n;
            this.f1382c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1382c++;
                acceptOnIndex(action, Char2IntOpenCustomHashMap.this.f1379n);
                return true;
            }
            char[] key = Char2IntOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Char2IntOpenCustomHashMap.this.size - this.f1382c);
            }
            return Math.min((long) (Char2IntOpenCustomHashMap.this.size - this.f1382c), ((long) ((((double) Char2IntOpenCustomHashMap.this.realSize()) / ((double) Char2IntOpenCustomHashMap.this.f1379n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap.this
                char[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2IntOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Char2IntMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Char2IntMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2IntOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Char2IntMap.Entry> implements Char2IntMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Char2IntOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Char2IntOpenCustomHashMap.this.containsNullKey && Char2IntOpenCustomHashMap.this.value[Char2IntOpenCustomHashMap.this.f1379n] == v;
            }
            char[] key = Char2IntOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Char2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Char2IntOpenCustomHashMap.this.mask;
            int pos = mix;
            char curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            }
            if (Char2IntOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Char2IntOpenCustomHashMap.this.value[pos] == v;
            }
            do {
                int i = (pos + 1) & Char2IntOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (!Char2IntOpenCustomHashMap.this.strategy.equals(k, 0)) {
                ...
                if (!Char2IntOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Char2IntOpenCustomHashMap.this.strategy.equals(curr2, k) && Char2IntOpenCustomHashMap.this.value[pos] == v) {
                            Char2IntOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Char2IntOpenCustomHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Char2IntOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Char2IntOpenCustomHashMap.this.containsNullKey || Char2IntOpenCustomHashMap.this.value[Char2IntOpenCustomHashMap.this.f1379n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Char2IntMap.Entry> consumer) {
            if (Char2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2IntMap.BasicEntry(Char2IntOpenCustomHashMap.this.key[Char2IntOpenCustomHashMap.this.f1379n], Char2IntOpenCustomHashMap.this.value[Char2IntOpenCustomHashMap.this.f1379n]));
            }
            int pos = Char2IntOpenCustomHashMap.this.f1379n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Char2IntMap.Entry> consumer) {
            ...
            if (Char2IntOpenCustomHashMap.this.containsNullKey) {
                entry.key = Char2IntOpenCustomHashMap.this.key[Char2IntOpenCustomHashMap.this.f1379n];
                entry.value = Char2IntOpenCustomHashMap.this.value[Char2IntOpenCustomHashMap.this.f1379n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2IntOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2IntOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2IntOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            if (Char2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Char2IntOpenCustomHashMap.this.key[Char2IntOpenCustomHashMap.this.f1379n]);
            }
            int pos = Char2IntOpenCustomHashMap.this.f1379n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2IntOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2IntOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Integer> values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2IntOpenCustomHashMap.1
                ...
                public void forEach(IntConsumer consumer) {
                    if (Char2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Char2IntOpenCustomHashMap.this.value[Char2IntOpenCustomHashMap.this.f1379n]);
                    }
                    int pos = Char2IntOpenCustomHashMap.this.f1379n;
                    while (true) {
                        pos--;
    ...
    public Char2IntOpenCustomHashMap clone() {
        try {
            Char2IntOpenCustomHashMap c = (Char2IntOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        int[] value = new int[this.f1379n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
