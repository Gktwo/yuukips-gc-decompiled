...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteArrayMap.class */
public class Char2ByteArrayMap extends AbstractChar2ByteMap implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Char2ByteArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Char2ByteArrayMap(Char2ByteMap m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Char2ByteMap.Entry> it = m.char2ByteEntrySet().iterator();
        while (it.hasNext()) {
            Char2ByteMap.Entry e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Char2ByteMap.Entry> implements Char2ByteMap.FastEntrySet {
        private EntrySet() {
        }

        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
        public ObjectIterator<Char2ByteMap.Entry> iterator() {
            return new ObjectIterator<Char2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2ByteArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Char2ByteMap.Entry next() {
                    ...
                    char[] cArr = Char2ByteArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    char c = cArr[i];
                    byte[] bArr = Char2ByteArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractChar2ByteMap.BasicEntry(c, bArr[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Char2ByteArrayMap.access$010(Char2ByteArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Char2ByteMap.Entry> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractChar2ByteMap.BasicEntry(c, bArr[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Char2ByteMap.Entry> fastIterator() {
            return new ObjectIterator<Char2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2ByteArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Char2ByteMap.Entry next() {
                    ...
                    AbstractChar2ByteMap.BasicEntry basicEntry = this.entry;
                    char[] cArr = Char2ByteArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = cArr[i];
                    AbstractChar2ByteMap.BasicEntry basicEntry2 = this.entry;
                    byte[] bArr = Char2ByteArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Char2ByteMap.Entry> implements ObjectSpliterator<Char2ByteMap.Entry> {
            ...
            public final Char2ByteMap.Entry get(int location) {
        ...
        public boolean remove(Object o) {
            ...
            Char2ByteArrayMap.access$010(Char2ByteArrayMap.this);
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteArrayMap$KeySet.class */
    public final class KeySet extends AbstractCharSet {
        ...
        public CharIterator iterator() {
            return new CharIterator() { // from class: it.unimi.dsi.fastutil.chars.Char2ByteArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteArrayMap$KeySet$KeySetSpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractByteCollection {
        ...
        public ByteIterator iterator() {
            return new ByteIterator() { // from class: it.unimi.dsi.fastutil.chars.Char2ByteArrayMap.ValuesCollection.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteArrayMap$ValuesCollection$ValuesSpliterator.class */
    ...
    public Char2ByteArrayMap clone() {
        try {
            Char2ByteArrayMap c = (Char2ByteArrayMap) clone();
