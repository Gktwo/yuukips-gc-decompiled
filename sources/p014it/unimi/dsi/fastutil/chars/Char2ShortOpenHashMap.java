...
public class Char2ShortOpenHashMap extends AbstractChar2ShortMap implements Serializable, Cloneable, Hash {
    ...
    public Char2ShortOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new short[this.f1431n + 1];
        }
    }
    ...
    public short removeNullEntry() {
        ...
        short oldValue = this.value[this.f1431n];
        this.size--;
        if (this.f1431n > this.minN && this.size < this.maxFill / 4 && this.f1431n > 16) {
            rehash(this.f1431n / 2);
        }
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Char2ShortOpenHashMap.this.f1431n;
            this.last = -1;
            this.f1433c = Char2ShortOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Char2ShortOpenHashMap.this.f1431n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Char2ShortOpenHashMap.this.f1431n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Char2ShortOpenHashMap.this.f1431n;
            this.f1434c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1434c++;
                acceptOnIndex(action, Char2ShortOpenHashMap.this.f1431n);
                return true;
            }
            char[] key = Char2ShortOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Char2ShortOpenHashMap.this.size - this.f1434c);
            }
            return Math.min((long) (Char2ShortOpenHashMap.this.size - this.f1434c), ((long) ((((double) Char2ShortOpenHashMap.this.realSize()) / ((double) Char2ShortOpenHashMap.this.f1431n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Char2ShortMap.Entry> implements Char2ShortMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Char2ShortOpenHashMap.this.containsNullKey && Char2ShortOpenHashMap.this.value[Char2ShortOpenHashMap.this.f1431n] == v;
            }
            char[] key = Char2ShortOpenHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Char2ShortOpenHashMap.this.containsNullKey || Char2ShortOpenHashMap.this.value[Char2ShortOpenHashMap.this.f1431n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Char2ShortMap.Entry> consumer) {
            if (Char2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2ShortMap.BasicEntry(Char2ShortOpenHashMap.this.key[Char2ShortOpenHashMap.this.f1431n], Char2ShortOpenHashMap.this.value[Char2ShortOpenHashMap.this.f1431n]));
            }
            int pos = Char2ShortOpenHashMap.this.f1431n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Char2ShortMap.Entry> consumer) {
            ...
            if (Char2ShortOpenHashMap.this.containsNullKey) {
                entry.key = Char2ShortOpenHashMap.this.key[Char2ShortOpenHashMap.this.f1431n];
                entry.value = Char2ShortOpenHashMap.this.value[Char2ShortOpenHashMap.this.f1431n];
    ...
    public final class KeySet extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            if (Char2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(Char2ShortOpenHashMap.this.key[Char2ShortOpenHashMap.this.f1431n]);
            }
            int pos = Char2ShortOpenHashMap.this.f1431n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2ShortOpenHashMap.1
                ...
                public void forEach(ShortConsumer consumer) {
                    if (Char2ShortOpenHashMap.this.containsNullKey) {
                        consumer.accept(Char2ShortOpenHashMap.this.value[Char2ShortOpenHashMap.this.f1431n]);
                    }
                    int pos = Char2ShortOpenHashMap.this.f1431n;
                    while (true) {
                        pos--;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        short[] value = new short[this.f1431n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
