...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteFunctions.class */
public final class Char2ByteFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractChar2ByteFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ByteFunction, p014it.unimi.dsi.fastutil.chars.Char2ByteFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Char2ByteFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Char2ByteFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Char2ByteFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2ByteFunction, java.util.function.IntUnaryOperator
        @Deprecated
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractChar2ByteFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Char2ByteFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Char2ByteFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Char2ByteFunction {
        ...
        public byte get(char key) {
            Byte v = (Byte) this.function.apply(Character.valueOf(key));
        ...
        public Byte get(Object key) {
            ...
            return (Byte) this.function.apply((Character) key);
        }
        ...
        public Byte getOrDefault(Object key, Byte defaultValue) {
            Byte v;
            if (!(key == null || (v = (Byte) this.function.apply((Character) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
    ...
    public static Char2ByteFunction primitive(java.util.function.Function<? super Character, ? extends Byte> f) {
        ...
        return f instanceof Char2ByteFunction ? (Char2ByteFunction) f : f instanceof IntUnaryOperator ? key -> {
