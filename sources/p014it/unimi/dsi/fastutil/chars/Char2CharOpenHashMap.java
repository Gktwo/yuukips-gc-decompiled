...
public class Char2CharOpenHashMap extends AbstractChar2CharMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f1347n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f1348f;
    ...
    public Char2CharOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f1347n = arraySize;
            this.minN = arraySize;
            this.mask = this.f1347n - 1;
            this.maxFill = HashCommon.maxFill(this.f1347n, f);
            this.key = new char[this.f1347n + 1];
            this.value = new char[this.f1347n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f1348f);
        if (needed > this.f1347n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f1348f)))));
        if (needed > this.f1347n) {
            rehash(needed);
        }
    }
    ...
    public char removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f1347n > this.minN && this.size < this.maxFill / 4 && this.f1347n > 16) {
            rehash(this.f1347n / 2);
        }
        return oldValue;
    }
    ...
    public char removeNullEntry() {
        ...
        char oldValue = this.value[this.f1347n];
        this.size--;
        if (this.f1347n > this.minN && this.size < this.maxFill / 4 && this.f1347n > 16) {
            rehash(this.f1347n / 2);
        }
    ...
    private int find(char k) {
        char curr;
        if (k == 0) {
            return this.containsNullKey ? this.f1347n : -(this.f1347n + 1);
        }
        char[] key = this.key;
    ...
    private void insert(int pos, char k, char v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f1348f));
        }
    }
    ...
    public char addTo(char k, char incr) {
        ...
        if (k != 0) {
            ...
            return addToValue(this.f1347n, incr);
        } else {
            pos = this.f1347n;
            this.containsNullKey = true;
        }
    ...
    public char get(char k) {
        char curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f1347n] : this.defRetValue;
        }
        char[] key = this.key;
        int mix = HashCommon.mix((int) k) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(char v) {
        ...
        char[] key = this.key;
        if (this.containsNullKey && value[this.f1347n] == v) {
            return true;
        }
        int i = this.f1347n;
        while (true) {
    ...
    public char getOrDefault(char k, char defaultValue) {
        char curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f1347n] : defaultValue;
        }
        char[] key = this.key;
        int mix = HashCommon.mix((int) k) & this.mask;
        int pos = mix;
    ...
    public boolean remove(char k, char v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1347n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Char2CharOpenHashMap.this.f1347n;
            this.last = -1;
            this.f1349c = Char2CharOpenHashMap.this.size;
            this.mustReturnNullKey = Char2CharOpenHashMap.this.containsNullKey;
        }

        public boolean hasNext() {
            return this.f1349c != 0;
        }
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Char2CharOpenHashMap.this.f1347n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Char2CharOpenHashMap.this.f1347n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Char2CharOpenHashMap.this.f1347n;
            this.f1350c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1350c++;
                acceptOnIndex(action, Char2CharOpenHashMap.this.f1347n);
                return true;
            }
            char[] key = Char2CharOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Char2CharOpenHashMap.this.size - this.f1350c);
            }
            return Math.min((long) (Char2CharOpenHashMap.this.size - this.f1350c), ((long) ((((double) Char2CharOpenHashMap.this.realSize()) / ((double) Char2CharOpenHashMap.this.f1347n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Char2CharMap.Entry> implements Char2CharMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Char2CharOpenHashMap.this.containsNullKey && Char2CharOpenHashMap.this.value[Char2CharOpenHashMap.this.f1347n] == v;
            }
            char[] key = Char2CharOpenHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Char2CharOpenHashMap.this.containsNullKey || Char2CharOpenHashMap.this.value[Char2CharOpenHashMap.this.f1347n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Char2CharMap.Entry> consumer) {
            if (Char2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2CharMap.BasicEntry(Char2CharOpenHashMap.this.key[Char2CharOpenHashMap.this.f1347n], Char2CharOpenHashMap.this.value[Char2CharOpenHashMap.this.f1347n]));
            }
            int pos = Char2CharOpenHashMap.this.f1347n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Char2CharMap.Entry> consumer) {
            ...
            if (Char2CharOpenHashMap.this.containsNullKey) {
                entry.key = Char2CharOpenHashMap.this.key[Char2CharOpenHashMap.this.f1347n];
                entry.value = Char2CharOpenHashMap.this.value[Char2CharOpenHashMap.this.f1347n];
    ...
    public final class KeySet extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            if (Char2CharOpenHashMap.this.containsNullKey) {
                consumer.accept(Char2CharOpenHashMap.this.key[Char2CharOpenHashMap.this.f1347n]);
            }
            int pos = Char2CharOpenHashMap.this.f1347n;
            while (true) {
                pos--;
    ...
    public Collection<Character> values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2CharOpenHashMap.1
                ...
                public void forEach(CharConsumer consumer) {
                    if (Char2CharOpenHashMap.this.containsNullKey) {
                        consumer.accept(Char2CharOpenHashMap.this.value[Char2CharOpenHashMap.this.f1347n]);
                    }
                    int pos = Char2CharOpenHashMap.this.f1347n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f1348f)));
        if (l >= this.f1347n || this.size > HashCommon.maxFill(l, this.f1348f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f1347n];
                this.f1347n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f1347n, this.f1348f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f1347n = HashCommon.arraySize(this.size, this.f1348f);
        this.maxFill = HashCommon.maxFill(this.f1347n, this.f1348f);
        this.mask = this.f1347n - 1;
        char[] key = new char[this.f1347n + 1];
        this.key = key;
        char[] value = new char[this.f1347n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
