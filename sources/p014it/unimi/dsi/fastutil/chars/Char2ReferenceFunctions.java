...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2ReferenceFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ReferenceFunctions.class */
public final class Char2ReferenceFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ReferenceFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ReferenceFunctions$EmptyFunction.class */
    public static class EmptyFunction<V> extends AbstractChar2ReferenceFunction<V> implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ReferenceFunction, p014it.unimi.dsi.fastutil.chars.Char2ReferenceFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ReferenceFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ReferenceFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ReferenceFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ReferenceFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction<V> implements Char2ReferenceFunction<V>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Char2ReferenceFunction<V> f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Char2ReferenceFunction<V> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2ReferenceFunction, java.util.function.IntFunction
        @Deprecated
        ...
        public V apply(Character key) {
            V apply;
            synchronized (this.sync) {
                apply = this.function.apply((Char2ReferenceFunction<V>) key);
            }
            return apply;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ReferenceFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ReferenceFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction<V> extends AbstractChar2ReferenceFunction<V> implements Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Char2ReferenceFunction<? extends V> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ReferenceFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ReferenceFunctions$PrimitiveFunction.class */
