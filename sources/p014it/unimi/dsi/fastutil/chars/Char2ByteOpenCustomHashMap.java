...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteOpenCustomHashMap.class */
public class Char2ByteOpenCustomHashMap extends AbstractChar2ByteMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f1331n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f1332f;
    ...
    public Char2ByteOpenCustomHashMap(int expected, float f, CharHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f1331n = arraySize;
            this.minN = arraySize;
            this.mask = this.f1331n - 1;
            this.maxFill = HashCommon.maxFill(this.f1331n, f);
            this.key = new char[this.f1331n + 1];
            this.value = new byte[this.f1331n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f1332f);
        if (needed > this.f1331n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f1332f)))));
        if (needed > this.f1331n) {
            rehash(needed);
        }
    }
    ...
    public byte removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f1331n > this.minN && this.size < this.maxFill / 4 && this.f1331n > 16) {
            rehash(this.f1331n / 2);
        }
        return oldValue;
    }
    ...
    public byte removeNullEntry() {
        ...
        byte oldValue = this.value[this.f1331n];
        this.size--;
        if (this.f1331n > this.minN && this.size < this.maxFill / 4 && this.f1331n > 16) {
            rehash(this.f1331n / 2);
        }
    ...
    private int find(char k) {
        ...
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.f1331n : -(this.f1331n + 1);
        }
        char[] key = this.key;
    ...
    private void insert(int pos, char k, byte v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f1332f));
        }
    }
    ...
    public byte addTo(char k, byte incr) {
        ...
        if (!this.strategy.equals(k, 0)) {
            ...
            return addToValue(this.f1331n, incr);
        } else {
            pos = this.f1331n;
            this.containsNullKey = true;
        }
    ...
    public byte get(char k) {
        char curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f1331n] : this.defRetValue;
        }
        char[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(byte v) {
        ...
        char[] key = this.key;
        if (this.containsNullKey && value[this.f1331n] == v) {
            return true;
        }
        int i = this.f1331n;
        while (true) {
    ...
    public byte getOrDefault(char k, byte defaultValue) {
        char curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f1331n] : defaultValue;
        }
        char[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(char k, byte v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1331n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Char2ByteMap.Entry, Map.Entry<Character, Byte>, CharBytePair {
        ...
        public boolean equals(Object o) {
            ...
            return Char2ByteOpenCustomHashMap.this.strategy.equals(Char2ByteOpenCustomHashMap.this.key[this.index], e.getKey().charValue()) && Char2ByteOpenCustomHashMap.this.value[this.index] == e.getValue().byteValue();
        }
        ...
        public String toString() {
            return Char2ByteOpenCustomHashMap.this.key[this.index] + "=>" + ((int) Char2ByteOpenCustomHashMap.this.value[this.index]);
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Char2ByteOpenCustomHashMap.this.f1331n;
            this.last = -1;
            this.f1333c = Char2ByteOpenCustomHashMap.this.size;
            this.mustReturnNullKey = Char2ByteOpenCustomHashMap.this.containsNullKey;
        }

        public boolean hasNext() {
            return this.f1333c != 0;
        }
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Char2ByteOpenCustomHashMap.this.f1331n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Char2ByteOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Char2ByteOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Char2ByteOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Char2ByteOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Char2ByteOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Char2ByteOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Char2ByteOpenCustomHashMap.this.value[pos] = Char2ByteOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Char2ByteOpenCustomHashMap.this.f1331n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Char2ByteMap.Entry>> implements ObjectIterator<Char2ByteMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Char2ByteOpenCustomHashMap.this.f1331n;
            this.f1334c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1334c++;
                acceptOnIndex(action, Char2ByteOpenCustomHashMap.this.f1331n);
                return true;
            }
            char[] key = Char2ByteOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Char2ByteOpenCustomHashMap.this.size - this.f1334c);
            }
            return Math.min((long) (Char2ByteOpenCustomHashMap.this.size - this.f1334c), ((long) ((((double) Char2ByteOpenCustomHashMap.this.realSize()) / ((double) Char2ByteOpenCustomHashMap.this.f1331n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap.this
                char[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Char2ByteMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Char2ByteMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Char2ByteMap.Entry> implements Char2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Char2ByteOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Char2ByteOpenCustomHashMap.this.containsNullKey && Char2ByteOpenCustomHashMap.this.value[Char2ByteOpenCustomHashMap.this.f1331n] == v;
            }
            char[] key = Char2ByteOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Char2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ByteOpenCustomHashMap.this.mask;
            int pos = mix;
            char curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            }
            if (Char2ByteOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Char2ByteOpenCustomHashMap.this.value[pos] == v;
            }
            do {
                int i = (pos + 1) & Char2ByteOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (!Char2ByteOpenCustomHashMap.this.strategy.equals(k, 0)) {
                ...
                if (!Char2ByteOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Char2ByteOpenCustomHashMap.this.strategy.equals(curr2, k) && Char2ByteOpenCustomHashMap.this.value[pos] == v) {
                            Char2ByteOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Char2ByteOpenCustomHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Char2ByteOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Char2ByteOpenCustomHashMap.this.containsNullKey || Char2ByteOpenCustomHashMap.this.value[Char2ByteOpenCustomHashMap.this.f1331n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Char2ByteMap.Entry> consumer) {
            if (Char2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2ByteMap.BasicEntry(Char2ByteOpenCustomHashMap.this.key[Char2ByteOpenCustomHashMap.this.f1331n], Char2ByteOpenCustomHashMap.this.value[Char2ByteOpenCustomHashMap.this.f1331n]));
            }
            int pos = Char2ByteOpenCustomHashMap.this.f1331n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Char2ByteMap.Entry> consumer) {
            ...
            if (Char2ByteOpenCustomHashMap.this.containsNullKey) {
                entry.key = Char2ByteOpenCustomHashMap.this.key[Char2ByteOpenCustomHashMap.this.f1331n];
                entry.value = Char2ByteOpenCustomHashMap.this.value[Char2ByteOpenCustomHashMap.this.f1331n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            if (Char2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Char2ByteOpenCustomHashMap.this.key[Char2ByteOpenCustomHashMap.this.f1331n]);
            }
            int pos = Char2ByteOpenCustomHashMap.this.f1331n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ByteOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Byte> values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2ByteOpenCustomHashMap.1
                ...
                public void forEach(ByteConsumer consumer) {
                    if (Char2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Char2ByteOpenCustomHashMap.this.value[Char2ByteOpenCustomHashMap.this.f1331n]);
                    }
                    int pos = Char2ByteOpenCustomHashMap.this.f1331n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f1332f)));
        if (l >= this.f1331n || this.size > HashCommon.maxFill(l, this.f1332f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f1331n];
                this.f1331n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f1331n, this.f1332f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Char2ByteOpenCustomHashMap clone() {
        try {
            Char2ByteOpenCustomHashMap c = (Char2ByteOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f1331n = HashCommon.arraySize(this.size, this.f1332f);
        this.maxFill = HashCommon.maxFill(this.f1331n, this.f1332f);
        this.mask = this.f1331n - 1;
        char[] key = new char[this.f1331n + 1];
        this.key = key;
        byte[] value = new byte[this.f1331n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
