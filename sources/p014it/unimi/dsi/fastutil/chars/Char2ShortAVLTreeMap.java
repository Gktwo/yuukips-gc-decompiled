...
import p014it.unimi.dsi.fastutil.chars.AbstractChar2ShortSortedMap;
...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortAVLTreeMap.class */
public class Char2ShortAVLTreeMap extends AbstractChar2ShortSortedMap implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Char2ShortAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap.Entry add(char r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap.add(char):it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.chars.Char2ShortFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public short remove(char r5) {
        /*
        // Method dump skipped, instructions count: 1494
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap.remove(char):short");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortAVLTreeMap$Entry.class */
    public static final class Entry extends AbstractChar2ShortMap.BasicEntry implements Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ShortMap.BasicEntry, p014it.unimi.dsi.fastutil.chars.Char2ShortMap.Entry
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ShortMap.BasicEntry, java.util.Map.Entry, java.lang.Object
        public boolean equals(Object o) {
            if (!(o instanceof Map.Entry)) {
                return false;
            }
            Map.Entry<Character, Short> e = (Map.Entry) o;
            return this.key == e.getKey().charValue() && this.value == e.getValue().shortValue();
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ShortMap.BasicEntry, java.lang.Object
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(char k) {
            Entry locateKey = Char2ShortAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortAVLTreeMap$EntryIterator.class */
    public class EntryIterator extends TreeIterator implements ObjectListIterator<Char2ShortMap.Entry> {
        EntryIterator() {
            super();
        }
    ...
    public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap.1
                final Comparator<? super Char2ShortMap.Entry> comparator;

                {
                    this.comparator = Char2ShortAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Character) && e.getValue() != null && (e.getValue() instanceof Short)) {
                        return e.equals(Char2ShortAVLTreeMap.this.findKey(((Character) e.getKey()).charValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Character) || !(e.getValue() instanceof Short) || (f = Char2ShortAVLTreeMap.this.findKey(((Character) e.getKey()).charValue())) == null || f.getShortValue() != ((Short) e.getValue()).shortValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortAVLTreeMap$KeySet.class */
    public class KeySet extends AbstractChar2ShortSortedMap.KeySet {
        private KeySet() {
            super();
        }

        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ShortSortedMap.KeySet, p014it.unimi.dsi.fastutil.chars.AbstractCharSortedSet, p014it.unimi.dsi.fastutil.chars.AbstractCharSet, p014it.unimi.dsi.fastutil.chars.AbstractCharCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.chars.CharCollection, p014it.unimi.dsi.fastutil.chars.CharIterable
        public CharBidirectionalIterator iterator() {
            return new KeyIterator();
        }

        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ShortSortedMap.KeySet, p014it.unimi.dsi.fastutil.chars.CharSortedSet
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortAVLTreeMap$ValueIterator.class */
    ...
    public ShortCollection values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortAVLTreeMap$Submap.class */
    public final class Submap extends AbstractChar2ShortSortedMap implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        char from;
        ...
        /* renamed from: in */
        final boolean m1011in(char k) {
            return (this.bottom || Char2ShortAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Char2ShortAVLTreeMap.this.compare(k, this.f1460to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.chars.Char2ShortMap, p014it.unimi.dsi.fastutil.chars.Char2ShortSortedMap
        public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Char2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Character) && e.getValue() != null && (e.getValue() instanceof Short) && (f = Char2ShortAVLTreeMap.this.findKey(((Character) e.getKey()).charValue())) != null && Submap.this.m1011in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        if (f != null && Submap.this.m1011in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractChar2ShortSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ShortCollection values() {
            if (this.values == null) {
                this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShortCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.shorts.ShortCollection, p014it.unimi.dsi.fastutil.shorts.ShortIterable
                    public ShortIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.AbstractChar2ShortMap, p014it.unimi.dsi.fastutil.chars.Char2ShortFunction, p014it.unimi.dsi.fastutil.chars.Char2ShortMap
        public boolean containsKey(char k) {
            return m1011in(k) && Char2ShortAVLTreeMap.this.containsKey(k);
        }
        ...
        public short get(char k) {
            Entry e;
            return (!m1011in(k) || (e = Char2ShortAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public short put(char k, short v) {
            ...
            if (!m1011in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1460to)) + ")");
            }
            return Char2ShortAVLTreeMap.this.modified ? this.defRetValue : Char2ShortAVLTreeMap.this.put(k, v);
        }
        ...
        public short remove(char k) {
            ...
            return Char2ShortAVLTreeMap.this.modified ? Char2ShortAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2ShortSortedMap
        public Char2ShortSortedMap headMap(char to) {
            if (!this.top && Char2ShortAVLTreeMap.this.compare(to, this.f1460to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2ShortSortedMap
        public Char2ShortSortedMap tailMap(char from) {
            if (!this.bottom && Char2ShortAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1460to, this.top);
        }
        ...
        public Char2ShortSortedMap subMap(char from, char to) {
            ...
            if (!this.top) {
                to = Char2ShortAVLTreeMap.this.compare(to, this.f1460to) < 0 ? to : this.f1460to;
            }
            if (!this.bottom) {
                from = Char2ShortAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1460to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Char2ShortAVLTreeMap.this.compare(e.key, this.f1460to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Char2ShortAVLTreeMap.this.locateKey(this.f1460to);
                if (Char2ShortAVLTreeMap.this.compare(e.key, this.f1460to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Char2ShortAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, char k) {
                ...
                if (submap.bottom || Char2ShortAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Char2ShortAVLTreeMap char2ShortAVLTreeMap = Char2ShortAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (char2ShortAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Char2ShortAVLTreeMap.this.compare(this.next.key, Submap.this.f1460to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortAVLTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Char2ShortMap.Entry> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.chars.Char2ShortAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2ShortAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Char2ShortAVLTreeMap clone() {
        try {
            Char2ShortAVLTreeMap c = (Char2ShortAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n == 1) {
            ...
            Entry top2 = new Entry(s.readChar(), s.readShort());
            top2.right(new Entry(s.readChar(), s.readShort()));
