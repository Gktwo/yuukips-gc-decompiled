...
/* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatOpenCustomHashMap.class */
public class Char2FloatOpenCustomHashMap extends AbstractChar2FloatMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f1367n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f1368f;
    ...
    public Char2FloatOpenCustomHashMap(int expected, float f, CharHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f1367n = arraySize;
            this.minN = arraySize;
            this.mask = this.f1367n - 1;
            this.maxFill = HashCommon.maxFill(this.f1367n, f);
            this.key = new char[this.f1367n + 1];
            this.value = new float[this.f1367n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f1368f);
        if (needed > this.f1367n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f1368f)))));
        if (needed > this.f1367n) {
            rehash(needed);
        }
    }
    ...
    public float removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f1367n > this.minN && this.size < this.maxFill / 4 && this.f1367n > 16) {
            rehash(this.f1367n / 2);
        }
        return oldValue;
    }
    ...
    public float removeNullEntry() {
        ...
        float oldValue = this.value[this.f1367n];
        this.size--;
        if (this.f1367n > this.minN && this.size < this.maxFill / 4 && this.f1367n > 16) {
            rehash(this.f1367n / 2);
        }
    ...
    private int find(char k) {
        ...
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.f1367n : -(this.f1367n + 1);
        }
        char[] key = this.key;
    ...
    private void insert(int pos, char k, float v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f1368f));
        }
    }
    ...
    public float addTo(char k, float incr) {
        ...
        if (!this.strategy.equals(k, 0)) {
            ...
            return addToValue(this.f1367n, incr);
        } else {
            pos = this.f1367n;
            this.containsNullKey = true;
        }
    ...
    public float get(char k) {
        char curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f1367n] : this.defRetValue;
        }
        char[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(float v) {
        ...
        char[] key = this.key;
        if (this.containsNullKey && Float.floatToIntBits(value[this.f1367n]) == Float.floatToIntBits(v)) {
            return true;
        }
        int i = this.f1367n;
        while (true) {
    ...
    public float getOrDefault(char k, float defaultValue) {
        char curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f1367n] : defaultValue;
        }
        char[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(char k, float v) {
        ...
        } else if (!this.containsNullKey || Float.floatToIntBits(v) != Float.floatToIntBits(this.value[this.f1367n])) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Char2FloatMap.Entry, Map.Entry<Character, Float>, CharFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            return Char2FloatOpenCustomHashMap.this.strategy.equals(Char2FloatOpenCustomHashMap.this.key[this.index], e.getKey().charValue()) && Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue().floatValue());
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Char2FloatOpenCustomHashMap.this.f1367n;
            this.last = -1;
            this.f1369c = Char2FloatOpenCustomHashMap.this.size;
            this.mustReturnNullKey = Char2FloatOpenCustomHashMap.this.containsNullKey;
        }

        public boolean hasNext() {
            return this.f1369c != 0;
        }
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Char2FloatOpenCustomHashMap.this.f1367n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Char2FloatOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Char2FloatOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Char2FloatOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Char2FloatOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Char2FloatOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Char2FloatOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Char2FloatOpenCustomHashMap.this.value[pos] = Char2FloatOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Char2FloatOpenCustomHashMap.this.f1367n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Char2FloatMap.Entry>> implements ObjectIterator<Char2FloatMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Char2FloatOpenCustomHashMap.this.f1367n;
            this.f1370c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1370c++;
                acceptOnIndex(action, Char2FloatOpenCustomHashMap.this.f1367n);
                return true;
            }
            char[] key = Char2FloatOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Char2FloatOpenCustomHashMap.this.size - this.f1370c);
            }
            return Math.min((long) (Char2FloatOpenCustomHashMap.this.size - this.f1370c), ((long) ((((double) Char2FloatOpenCustomHashMap.this.realSize()) / ((double) Char2FloatOpenCustomHashMap.this.f1367n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap.this
                char[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Char2FloatMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Char2FloatMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Char2FloatMap.Entry> implements Char2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Char2FloatOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Char2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[Char2FloatOpenCustomHashMap.this.f1367n]) == Float.floatToIntBits(v);
            }
            char[] key = Char2FloatOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Char2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Char2FloatOpenCustomHashMap.this.mask;
            int pos = mix;
            char curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            }
            if (Char2FloatOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v);
            }
            do {
                int i = (pos + 1) & Char2FloatOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (!Char2FloatOpenCustomHashMap.this.strategy.equals(k, 0)) {
                ...
                if (!Char2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Char2FloatOpenCustomHashMap.this.strategy.equals(curr2, k) && Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
                            Char2FloatOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[pos]) != Float.floatToIntBits(v)) {
                    return false;
                } else {
                    Char2FloatOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Char2FloatOpenCustomHashMap.this.containsNullKey || Float.floatToIntBits(Char2FloatOpenCustomHashMap.this.value[Char2FloatOpenCustomHashMap.this.f1367n]) != Float.floatToIntBits(v)) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Char2FloatMap.Entry> consumer) {
            if (Char2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2FloatMap.BasicEntry(Char2FloatOpenCustomHashMap.this.key[Char2FloatOpenCustomHashMap.this.f1367n], Char2FloatOpenCustomHashMap.this.value[Char2FloatOpenCustomHashMap.this.f1367n]));
            }
            int pos = Char2FloatOpenCustomHashMap.this.f1367n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Char2FloatMap.Entry> consumer) {
            ...
            if (Char2FloatOpenCustomHashMap.this.containsNullKey) {
                entry.key = Char2FloatOpenCustomHashMap.this.key[Char2FloatOpenCustomHashMap.this.f1367n];
                entry.value = Char2FloatOpenCustomHashMap.this.value[Char2FloatOpenCustomHashMap.this.f1367n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            if (Char2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Char2FloatOpenCustomHashMap.this.key[Char2FloatOpenCustomHashMap.this.f1367n]);
            }
            int pos = Char2FloatOpenCustomHashMap.this.f1367n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/chars/Char2FloatOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Float> values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection() { // from class: it.unimi.dsi.fastutil.chars.Char2FloatOpenCustomHashMap.1
                ...
                public void forEach(FloatConsumer consumer) {
                    if (Char2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Char2FloatOpenCustomHashMap.this.value[Char2FloatOpenCustomHashMap.this.f1367n]);
                    }
                    int pos = Char2FloatOpenCustomHashMap.this.f1367n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f1368f)));
        if (l >= this.f1367n || this.size > HashCommon.maxFill(l, this.f1368f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f1367n];
                this.f1367n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f1367n, this.f1368f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Char2FloatOpenCustomHashMap clone() {
        try {
            Char2FloatOpenCustomHashMap c = (Char2FloatOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.float2int(this.value[this.f1367n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f1367n = HashCommon.arraySize(this.size, this.f1368f);
        this.maxFill = HashCommon.maxFill(this.f1367n, this.f1368f);
        this.mask = this.f1367n - 1;
        char[] key = new char[this.f1367n + 1];
        this.key = key;
        float[] value = new float[this.f1367n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
