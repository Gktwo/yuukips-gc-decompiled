...
public class Char2ReferenceOpenHashMap<V> extends AbstractChar2ReferenceMap<V> implements Serializable, Cloneable, Hash {
    ...
    public Char2ReferenceOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = (V[]) new Object[this.f1419n + 1];
        }
    }
    ...
    public V removeNullEntry() {
        ...
        V oldValue = this.value[this.f1419n];
        this.value[this.f1419n] = null;
        this.size--;
        if (this.f1419n > this.minN && this.size < this.maxFill / 4 && this.f1419n > 16) {
            rehash(this.f1419n / 2);
        }
    ...
    public V get(char k) {
        char curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f1419n] : (V) this.defRetValue;
        }
        char[] key = this.key;
        int mix = HashCommon.mix((int) k) & this.mask;
        int pos = mix;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Char2ReferenceOpenHashMap.this.f1419n;
            this.last = -1;
            this.f1421c = Char2ReferenceOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Char2ReferenceOpenHashMap.this.f1419n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Char2ReferenceOpenHashMap.this.f1419n) {
                Char2ReferenceOpenHashMap.this.containsNullKey = false;
                Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.f1419n] = null;
            } else if (this.pos >= 0) {
                shiftKeys(this.last);
            } else {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends Char2ReferenceOpenHashMap<V>.MapSpliterator> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Char2ReferenceOpenHashMap.this.f1419n;
            this.f1422c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1422c++;
                acceptOnIndex(action, Char2ReferenceOpenHashMap.this.f1419n);
                return true;
            }
            char[] key = Char2ReferenceOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Char2ReferenceOpenHashMap.this.size - this.f1422c);
            }
            return Math.min((long) (Char2ReferenceOpenHashMap.this.size - this.f1422c), ((long) ((((double) Char2ReferenceOpenHashMap.this.realSize()) / ((double) Char2ReferenceOpenHashMap.this.f1419n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Char2ReferenceMap.Entry<V>> implements Char2ReferenceMap.FastEntrySet<V> {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Char2ReferenceOpenHashMap.this.containsNullKey && Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.f1419n] == value;
            }
            char[] key = Char2ReferenceOpenHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Char2ReferenceOpenHashMap.this.containsNullKey || Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.f1419n] != value) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
            if (Char2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractChar2ReferenceMap.BasicEntry(Char2ReferenceOpenHashMap.this.key[Char2ReferenceOpenHashMap.this.f1419n], Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.f1419n]));
            }
            int pos = Char2ReferenceOpenHashMap.this.f1419n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Char2ReferenceMap.Entry<V>> consumer) {
            ...
            if (Char2ReferenceOpenHashMap.this.containsNullKey) {
                entry.key = Char2ReferenceOpenHashMap.this.key[Char2ReferenceOpenHashMap.this.f1419n];
                entry.value = Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.f1419n];
    ...
    public final class KeySet extends AbstractCharSet {
        ...
        public void forEach(CharConsumer consumer) {
            if (Char2ReferenceOpenHashMap.this.containsNullKey) {
                consumer.accept(Char2ReferenceOpenHashMap.this.key[Char2ReferenceOpenHashMap.this.f1419n]);
            }
            int pos = Char2ReferenceOpenHashMap.this.f1419n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.chars.Char2ReferenceOpenHashMap.1
                ...
                public void forEach(Consumer<? super V> consumer) {
                    if (Char2ReferenceOpenHashMap.this.containsNullKey) {
                        consumer.accept((Object) Char2ReferenceOpenHashMap.this.value[Char2ReferenceOpenHashMap.this.f1419n]);
                    }
                    int pos = Char2ReferenceOpenHashMap.this.f1419n;
                    while (true) {
                        pos--;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += this.value[this.f1419n] == null ? 0 : System.identityHashCode(this.value[this.f1419n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        V[] value = (V[]) new Object[this.f1419n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
