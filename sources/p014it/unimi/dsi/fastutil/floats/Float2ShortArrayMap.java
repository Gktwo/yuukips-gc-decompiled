...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortArrayMap.class */
public class Float2ShortArrayMap extends AbstractFloat2ShortMap implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Float2ShortArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Float2ShortArrayMap(Float2ShortMap m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Float2ShortMap.Entry> it = m.float2ShortEntrySet().iterator();
        while (it.hasNext()) {
            Float2ShortMap.Entry e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Float2ShortMap.Entry> implements Float2ShortMap.FastEntrySet {
        private EntrySet() {
        }

        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
        public ObjectIterator<Float2ShortMap.Entry> iterator() {
            return new ObjectIterator<Float2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2ShortArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Float2ShortMap.Entry next() {
                    ...
                    float[] fArr = Float2ShortArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    float f = fArr[i];
                    short[] sArr = Float2ShortArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractFloat2ShortMap.BasicEntry(f, sArr[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Float2ShortArrayMap.access$010(Float2ShortArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Float2ShortMap.Entry> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractFloat2ShortMap.BasicEntry(f, sArr[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Float2ShortMap.Entry> fastIterator() {
            return new ObjectIterator<Float2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2ShortArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Float2ShortMap.Entry next() {
                    ...
                    AbstractFloat2ShortMap.BasicEntry basicEntry = this.entry;
                    float[] fArr = Float2ShortArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = fArr[i];
                    AbstractFloat2ShortMap.BasicEntry basicEntry2 = this.entry;
                    short[] sArr = Float2ShortArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Float2ShortMap.Entry> implements ObjectSpliterator<Float2ShortMap.Entry> {
            ...
            public final Float2ShortMap.Entry get(int location) {
        ...
        public boolean remove(Object o) {
            ...
            Float2ShortArrayMap.access$010(Float2ShortArrayMap.this);
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortArrayMap$KeySet.class */
    public final class KeySet extends AbstractFloatSet {
        ...
        public FloatIterator iterator() {
            return new FloatIterator() { // from class: it.unimi.dsi.fastutil.floats.Float2ShortArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortArrayMap$KeySet$KeySetSpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractShortCollection {
        ...
        public ShortIterator iterator() {
            return new ShortIterator() { // from class: it.unimi.dsi.fastutil.floats.Float2ShortArrayMap.ValuesCollection.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortArrayMap$ValuesCollection$ValuesSpliterator.class */
    ...
    public Float2ShortArrayMap clone() {
        try {
            Float2ShortArrayMap c = (Float2ShortArrayMap) clone();
