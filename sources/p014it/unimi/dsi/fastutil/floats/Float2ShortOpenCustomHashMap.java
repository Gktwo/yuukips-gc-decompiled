...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortOpenCustomHashMap.class */
public class Float2ShortOpenCustomHashMap extends AbstractFloat2ShortMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f1911n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f1912f;
    ...
    public Float2ShortOpenCustomHashMap(int expected, float f, FloatHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f1911n = arraySize;
            this.minN = arraySize;
            this.mask = this.f1911n - 1;
            this.maxFill = HashCommon.maxFill(this.f1911n, f);
            this.key = new float[this.f1911n + 1];
            this.value = new short[this.f1911n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f1912f);
        if (needed > this.f1911n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f1912f)))));
        if (needed > this.f1911n) {
            rehash(needed);
        }
    }
    ...
    public short removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f1911n > this.minN && this.size < this.maxFill / 4 && this.f1911n > 16) {
            rehash(this.f1911n / 2);
        }
        return oldValue;
    }
    ...
    public short removeNullEntry() {
        ...
        short oldValue = this.value[this.f1911n];
        this.size--;
        if (this.f1911n > this.minN && this.size < this.maxFill / 4 && this.f1911n > 16) {
            rehash(this.f1911n / 2);
        }
    ...
    private int find(float k) {
        ...
        if (this.strategy.equals(k, 0.0f)) {
            return this.containsNullKey ? this.f1911n : -(this.f1911n + 1);
        }
        float[] key = this.key;
    ...
    private void insert(int pos, float k, short v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f1912f));
        }
    }
    ...
    public short addTo(float k, short incr) {
        ...
        if (!this.strategy.equals(k, 0.0f)) {
            ...
            return addToValue(this.f1911n, incr);
        } else {
            pos = this.f1911n;
            this.containsNullKey = true;
        }
    ...
    public short get(float k) {
        float curr;
        if (this.strategy.equals(k, 0.0f)) {
            return this.containsNullKey ? this.value[this.f1911n] : this.defRetValue;
        }
        float[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(short v) {
        ...
        float[] key = this.key;
        if (this.containsNullKey && value[this.f1911n] == v) {
            return true;
        }
        int i = this.f1911n;
        while (true) {
    ...
    public short getOrDefault(float k, short defaultValue) {
        float curr;
        if (this.strategy.equals(k, 0.0f)) {
            return this.containsNullKey ? this.value[this.f1911n] : defaultValue;
        }
        float[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(float k, short v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1911n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Float2ShortMap.Entry, Map.Entry<Float, Short>, FloatShortPair {
        ...
        public boolean equals(Object o) {
            ...
            return Float2ShortOpenCustomHashMap.this.strategy.equals(Float2ShortOpenCustomHashMap.this.key[this.index], e.getKey().floatValue()) && Float2ShortOpenCustomHashMap.this.value[this.index] == e.getValue().shortValue();
        }
        ...
        public String toString() {
            return Float2ShortOpenCustomHashMap.this.key[this.index] + "=>" + ((int) Float2ShortOpenCustomHashMap.this.value[this.index]);
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Float2ShortOpenCustomHashMap.this.f1911n;
            this.last = -1;
            this.f1913c = Float2ShortOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Float2ShortOpenCustomHashMap.this.f1911n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Float2ShortOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Float2ShortOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Float2ShortOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Float2ShortOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Float2ShortOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (Float.floatToIntBits(curr) == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Float2ShortOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Float2ShortOpenCustomHashMap.this.value[pos] = Float2ShortOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Float2ShortOpenCustomHashMap.this.f1911n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Float2ShortMap.Entry>> implements ObjectIterator<Float2ShortMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Float2ShortOpenCustomHashMap.this.f1911n;
            this.f1914c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1914c++;
                acceptOnIndex(action, Float2ShortOpenCustomHashMap.this.f1911n);
                return true;
            }
            float[] key = Float2ShortOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Float2ShortOpenCustomHashMap.this.size - this.f1914c);
            }
            return Math.min((long) (Float2ShortOpenCustomHashMap.this.size - this.f1914c), ((long) ((((double) Float2ShortOpenCustomHashMap.this.realSize()) / ((double) Float2ShortOpenCustomHashMap.this.f1911n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap.this
                float[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0078:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Float2ShortMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Float2ShortMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Float2ShortMap.Entry> implements Float2ShortMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Float2ShortOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                return Float2ShortOpenCustomHashMap.this.containsNullKey && Float2ShortOpenCustomHashMap.this.value[Float2ShortOpenCustomHashMap.this.f1911n] == v;
            }
            float[] key = Float2ShortOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Float2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ShortOpenCustomHashMap.this.mask;
            int pos = mix;
            float curr2 = key[mix];
            if (Float.floatToIntBits(curr2) == 0) {
                return false;
            }
            if (Float2ShortOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Float2ShortOpenCustomHashMap.this.value[pos] == v;
            }
            do {
                int i = (pos + 1) & Float2ShortOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (Float.floatToIntBits(curr) == 0) {
                    return false;
            ...
            if (!Float2ShortOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                ...
                if (!Float2ShortOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Float2ShortOpenCustomHashMap.this.strategy.equals(curr2, k) && Float2ShortOpenCustomHashMap.this.value[pos] == v) {
                            Float2ShortOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Float2ShortOpenCustomHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Float2ShortOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Float2ShortOpenCustomHashMap.this.containsNullKey || Float2ShortOpenCustomHashMap.this.value[Float2ShortOpenCustomHashMap.this.f1911n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Float2ShortMap.Entry> consumer) {
            if (Float2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2ShortMap.BasicEntry(Float2ShortOpenCustomHashMap.this.key[Float2ShortOpenCustomHashMap.this.f1911n], Float2ShortOpenCustomHashMap.this.value[Float2ShortOpenCustomHashMap.this.f1911n]));
            }
            int pos = Float2ShortOpenCustomHashMap.this.f1911n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Float2ShortMap.Entry> consumer) {
            ...
            if (Float2ShortOpenCustomHashMap.this.containsNullKey) {
                entry.key = Float2ShortOpenCustomHashMap.this.key[Float2ShortOpenCustomHashMap.this.f1911n];
                entry.value = Float2ShortOpenCustomHashMap.this.value[Float2ShortOpenCustomHashMap.this.f1911n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            if (Float2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Float2ShortOpenCustomHashMap.this.key[Float2ShortOpenCustomHashMap.this.f1911n]);
            }
            int pos = Float2ShortOpenCustomHashMap.this.f1911n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Short> values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap.1
                ...
                public void forEach(ShortConsumer consumer) {
                    if (Float2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Float2ShortOpenCustomHashMap.this.value[Float2ShortOpenCustomHashMap.this.f1911n]);
                    }
                    int pos = Float2ShortOpenCustomHashMap.this.f1911n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f1912f)));
        if (l >= this.f1911n || this.size > HashCommon.maxFill(l, this.f1912f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f1911n];
                this.f1911n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f1911n, this.f1912f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Float2ShortOpenCustomHashMap clone() {
        try {
            Float2ShortOpenCustomHashMap c = (Float2ShortOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f1911n = HashCommon.arraySize(this.size, this.f1912f);
        this.maxFill = HashCommon.maxFill(this.f1911n, this.f1912f);
        this.mask = this.f1911n - 1;
        float[] key = new float[this.f1911n + 1];
        this.key = key;
        short[] value = new short[this.f1911n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
