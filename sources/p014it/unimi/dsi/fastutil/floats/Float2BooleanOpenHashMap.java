...
public class Float2BooleanOpenHashMap extends AbstractFloat2BooleanMap implements Serializable, Cloneable, Hash {
    ...
    public Float2BooleanOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new boolean[this.f1807n + 1];
        }
    }
    ...
    public boolean removeNullEntry() {
        ...
        boolean oldValue = this.value[this.f1807n];
        this.size--;
        if (this.f1807n > this.minN && this.size < this.maxFill / 4 && this.f1807n > 16) {
            rehash(this.f1807n / 2);
        }
    ...
    public boolean containsValue(boolean v) {
        ...
        float[] key = this.key;
        if (this.containsNullKey && value[this.f1807n] == v) {
            return true;
        }
        int i = this.f1807n;
        while (true) {
    ...
    public boolean remove(float k, boolean v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1807n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Float2BooleanOpenHashMap.this.f1807n;
            this.last = -1;
            this.f1809c = Float2BooleanOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Float2BooleanOpenHashMap.this.f1807n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Float2BooleanOpenHashMap.this.f1807n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Float2BooleanOpenHashMap.this.f1807n;
            this.f1810c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1810c++;
                acceptOnIndex(action, Float2BooleanOpenHashMap.this.f1807n);
                return true;
            }
            float[] key = Float2BooleanOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Float2BooleanOpenHashMap.this.size - this.f1810c);
            }
            return Math.min((long) (Float2BooleanOpenHashMap.this.size - this.f1810c), ((long) ((((double) Float2BooleanOpenHashMap.this.realSize()) / ((double) Float2BooleanOpenHashMap.this.f1807n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Float2BooleanMap.Entry> implements Float2BooleanMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Float.floatToIntBits(k) == 0) {
                return Float2BooleanOpenHashMap.this.containsNullKey && Float2BooleanOpenHashMap.this.value[Float2BooleanOpenHashMap.this.f1807n] == v;
            }
            float[] key = Float2BooleanOpenHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Float2BooleanOpenHashMap.this.containsNullKey || Float2BooleanOpenHashMap.this.value[Float2BooleanOpenHashMap.this.f1807n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Float2BooleanMap.Entry> consumer) {
            if (Float2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2BooleanMap.BasicEntry(Float2BooleanOpenHashMap.this.key[Float2BooleanOpenHashMap.this.f1807n], Float2BooleanOpenHashMap.this.value[Float2BooleanOpenHashMap.this.f1807n]));
            }
            int pos = Float2BooleanOpenHashMap.this.f1807n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Float2BooleanMap.Entry> consumer) {
            ...
            if (Float2BooleanOpenHashMap.this.containsNullKey) {
                entry.key = Float2BooleanOpenHashMap.this.key[Float2BooleanOpenHashMap.this.f1807n];
                entry.value = Float2BooleanOpenHashMap.this.value[Float2BooleanOpenHashMap.this.f1807n];
    ...
    public final class KeySet extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            if (Float2BooleanOpenHashMap.this.containsNullKey) {
                consumer.accept(Float2BooleanOpenHashMap.this.key[Float2BooleanOpenHashMap.this.f1807n]);
            }
            int pos = Float2BooleanOpenHashMap.this.f1807n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractBooleanCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2BooleanOpenHashMap.1
                ...
                public void forEach(BooleanConsumer consumer) {
                    if (Float2BooleanOpenHashMap.this.containsNullKey) {
                        consumer.accept(Float2BooleanOpenHashMap.this.value[Float2BooleanOpenHashMap.this.f1807n]);
                    }
                    int pos = Float2BooleanOpenHashMap.this.f1807n;
                    while (true) {
                        pos--;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += this.value[this.f1807n] ? RetcodeOuterClass.Retcode.RET_MP_OTHER_DATA_VERSION_NOT_LATEST_VALUE : RetcodeOuterClass.Retcode.RET_MP_MATCH_FULL_VALUE;
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        boolean[] value = new boolean[this.f1807n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
