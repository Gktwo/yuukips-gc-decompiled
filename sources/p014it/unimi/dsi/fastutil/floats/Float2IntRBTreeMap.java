...
public class Float2IntRBTreeMap extends AbstractFloat2IntSortedMap implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractFloat2IntSortedMap implements Serializable {
        ...
        final boolean m849in(float k) {
            return (this.bottom || Float2IntRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2IntRBTreeMap.this.compare(k, this.f1835to) < 0);
        }
        ...
        public int put(float k, int v) {
            ...
            if (!m849in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1835to)) + ")");
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2IntSortedMap
        public Float2IntSortedMap headMap(float to) {
            if (!this.top && Float2IntRBTreeMap.this.compare(to, this.f1835to) >= 0) {
                return this;
            }
        ...
        public Float2IntSortedMap tailMap(float from) {
            ...
            return new Submap(from, false, this.f1835to, this.top);
        }
        ...
        public Float2IntSortedMap subMap(float from, float to) {
            ...
            if (!this.top) {
                to = Float2IntRBTreeMap.this.compare(to, this.f1835to) < 0 ? to : this.f1835to;
            }
            if (!this.bottom) {
                from = Float2IntRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1835to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Float2IntRBTreeMap.this.compare(e.key, this.f1835to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Float2IntRBTreeMap.this.locateKey(this.f1835to);
                if (Float2IntRBTreeMap.this.compare(e.key, this.f1835to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Float2IntRBTreeMap.this.compare(this.next.key, Submap.this.f1835to) >= 0) {
                    this.next = null;
                }
            }
        }
