...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntRBTreeMap.class */
public class Float2IntRBTreeMap extends AbstractFloat2IntSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap.Entry add(float r9) {
        /*
        // Method dump skipped, instructions count: 935
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap.add(float):it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.floats.Float2IntFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public int remove(float r7) {
        /*
        // Method dump skipped, instructions count: 1895
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap.remove(float):int");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(float k) {
            Entry locateKey = Float2IntRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2IntMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap.1
                final Comparator<? super Float2IntMap.Entry> comparator;

                {
                    this.comparator = Float2IntRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Float) && e.getValue() != null && (e.getValue() instanceof Integer)) {
                        return e.equals(Float2IntRBTreeMap.this.findKey(((Float) e.getKey()).floatValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Float) || e.getValue() == null || !(e.getValue() instanceof Integer) || (f = Float2IntRBTreeMap.this.findKey(((Float) e.getKey()).floatValue())) == null || f.getIntValue() != ((Integer) e.getValue()).intValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntRBTreeMap$ValueIterator.class */
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntRBTreeMap$Submap.class */
    public final class Submap extends AbstractFloat2IntSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m849in(float k) {
            return (this.bottom || Float2IntRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2IntRBTreeMap.this.compare(k, this.f1871to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.floats.Float2IntMap, p014it.unimi.dsi.fastutil.floats.Float2IntSortedMap
        public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2IntMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Float2IntMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Float) && e.getValue() != null && (e.getValue() instanceof Integer) && (f = Float2IntRBTreeMap.this.findKey(((Float) e.getKey()).floatValue())) != null && Submap.this.m849in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        if (f != null && Submap.this.m849in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractFloat2IntSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public IntCollection values() {
            if (this.values == null) {
                this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.ints.AbstractIntCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.ints.IntCollection, p014it.unimi.dsi.fastutil.ints.IntIterable
                    public IntIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2IntMap, p014it.unimi.dsi.fastutil.floats.Float2IntFunction, p014it.unimi.dsi.fastutil.floats.Float2IntMap
        public boolean containsKey(float k) {
            return m849in(k) && Float2IntRBTreeMap.this.containsKey(k);
        }
        ...
        public int get(float k) {
            Entry e;
            return (!m849in(k) || (e = Float2IntRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public int put(float k, int v) {
            ...
            return Float2IntRBTreeMap.this.modified ? this.defRetValue : Float2IntRBTreeMap.this.put(k, v);
        }
        ...
        public int remove(float k) {
            ...
            return Float2IntRBTreeMap.this.modified ? Float2IntRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2IntSortedMap
        public Float2IntSortedMap headMap(float to) {
            if (!this.top && Float2IntRBTreeMap.this.compare(to, this.f1871to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2IntSortedMap
        public Float2IntSortedMap tailMap(float from) {
            if (!this.bottom && Float2IntRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
        ...
        public Float2IntSortedMap subMap(float from, float to) {
            ...
            if (!this.top) {
                to = Float2IntRBTreeMap.this.compare(to, this.f1871to) < 0 ? to : this.f1871to;
            }
            if (!this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Float2IntRBTreeMap.this.compare(e.key, this.f1871to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Float2IntRBTreeMap.this.locateKey(this.f1871to);
                if (Float2IntRBTreeMap.this.compare(e.key, this.f1871to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Float2IntRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, float k) {
                ...
                if (submap.bottom || Float2IntRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Float2IntRBTreeMap float2IntRBTreeMap = Float2IntRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (float2IntRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Float2IntRBTreeMap.this.compare(this.next.key, Submap.this.f1871to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Float2IntRBTreeMap clone() {
        try {
            Float2IntRBTreeMap c = (Float2IntRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
