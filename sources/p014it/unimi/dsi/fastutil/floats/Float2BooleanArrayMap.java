...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanArrayMap.class */
public class Float2BooleanArrayMap extends AbstractFloat2BooleanMap implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Float2BooleanArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Float2BooleanArrayMap(Float2BooleanMap m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Float2BooleanMap.Entry> it = m.float2BooleanEntrySet().iterator();
        while (it.hasNext()) {
            Float2BooleanMap.Entry e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Float2BooleanMap.Entry> implements Float2BooleanMap.FastEntrySet {
        ...
        public ObjectIterator<Float2BooleanMap.Entry> iterator() {
            return new ObjectIterator<Float2BooleanMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2BooleanArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public void forEachRemaining(Consumer<? super Float2BooleanMap.Entry> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractFloat2BooleanMap.BasicEntry(f, zArr[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Float2BooleanMap.Entry> fastIterator() {
            return new ObjectIterator<Float2BooleanMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2BooleanArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Float2BooleanMap.Entry> implements ObjectSpliterator<Float2BooleanMap.Entry> {
            ...
            public final Float2BooleanMap.Entry get(int location) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanArrayMap$KeySet.class */
    public final class KeySet extends AbstractFloatSet {
        ...
        public FloatIterator iterator() {
            return new FloatIterator() { // from class: it.unimi.dsi.fastutil.floats.Float2BooleanArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanArrayMap$KeySet$KeySetSpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractBooleanCollection {
        ...
        public BooleanIterator iterator() {
            return new BooleanIterator() { // from class: it.unimi.dsi.fastutil.floats.Float2BooleanArrayMap.ValuesCollection.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanArrayMap$ValuesCollection$ValuesSpliterator.class */
    ...
    public Float2BooleanArrayMap clone() {
        try {
            Float2BooleanArrayMap c = (Float2BooleanArrayMap) clone();
