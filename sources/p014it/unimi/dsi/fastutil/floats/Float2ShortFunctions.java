...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortFunctions.class */
public final class Float2ShortFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractFloat2ShortFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ShortFunction, p014it.unimi.dsi.fastutil.floats.Float2ShortFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Float2ShortFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Float2ShortFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Float2ShortFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ShortFunction, java.util.function.DoubleToIntFunction
        @Deprecated
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractFloat2ShortFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Float2ShortFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Float2ShortFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Float2ShortFunction {
        ...
        public short get(float key) {
            Short v = (Short) this.function.apply(Float.valueOf(key));
        ...
        public Short get(Object key) {
            ...
            return (Short) this.function.apply((Float) key);
        }
        ...
        public Short getOrDefault(Object key, Short defaultValue) {
            Short v;
            if (!(key == null || (v = (Short) this.function.apply((Float) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
    ...
    public static Float2ShortFunction primitive(java.util.function.Function<? super Float, ? extends Short> f) {
        ...
        return f instanceof Float2ShortFunction ? (Float2ShortFunction) f : f instanceof DoubleToIntFunction ? key -> {
            return SafeMath.safeIntToShort(((DoubleToIntFunction) f).applyAsInt((double) key));
