...
/* renamed from: it.unimi.dsi.fastutil.floats.FloatBigList */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/FloatBigList.class */
public interface FloatBigList extends BigList<Float>, FloatCollection, Comparable<BigList<? extends Float>> {
    ...
    @Override // p014it.unimi.dsi.fastutil.BigList
    BigList<Float> subList(long j, long j2);
    ...
    default void getElements(long from, float[] a, int offset, int length) {
        getElements(from, new float[][]{a}, (long) offset, (long) length);
    }
    ...
    default void setElements(long r12, float[][] r14, long r15, long r17) {
        /*
            r11 = this;
            r0 = r12
            r1 = 0
        ...
        L_0x00da:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.FloatBigList.setElements(long, float[][], long, long):void");
    }
