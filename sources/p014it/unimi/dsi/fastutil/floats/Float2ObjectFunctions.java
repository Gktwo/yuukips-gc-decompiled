...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2ObjectFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ObjectFunctions.class */
public final class Float2ObjectFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ObjectFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ObjectFunctions$EmptyFunction.class */
    public static class EmptyFunction<V> extends AbstractFloat2ObjectFunction<V> implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ObjectFunction, p014it.unimi.dsi.fastutil.floats.Float2ObjectFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ObjectFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ObjectFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ObjectFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ObjectFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction<V> implements Float2ObjectFunction<V>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Float2ObjectFunction<V> f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Float2ObjectFunction<V> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ObjectFunction, java.util.function.DoubleFunction
        @Deprecated
        ...
        public V apply(Float key) {
            V apply;
            synchronized (this.sync) {
                apply = this.function.apply((Float2ObjectFunction<V>) key);
            }
            return apply;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ObjectFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ObjectFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction<V> extends AbstractFloat2ObjectFunction<V> implements Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Float2ObjectFunction<? extends V> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ObjectFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ObjectFunctions$PrimitiveFunction.class */
