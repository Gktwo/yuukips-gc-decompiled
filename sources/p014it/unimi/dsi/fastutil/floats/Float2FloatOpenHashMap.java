...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenHashMap.class */
public class Float2FloatOpenHashMap extends AbstractFloat2FloatMap implements Serializable, Cloneable, Hash {
    ...
    public Float2FloatOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new float[this.f1855n + 1];
        }
    }
    ...
    public float removeNullEntry() {
        ...
        float oldValue = this.value[this.f1855n];
        this.size--;
        if (this.f1855n > this.minN && this.size < this.maxFill / 4 && this.f1855n > 16) {
            rehash(this.f1855n / 2);
        }
    ...
    public float addTo(float k, float incr) {
        ...
        if (Float.floatToIntBits(k) != 0) {
            ...
            return addToValue(this.f1855n, incr);
        } else {
            pos = this.f1855n;
            this.containsNullKey = true;
        }
    ...
    public float get(float k) {
        float curr;
        if (Float.floatToIntBits(k) == 0) {
            return this.containsNullKey ? this.value[this.f1855n] : this.defRetValue;
        }
        float[] key = this.key;
        int mix = HashCommon.mix(HashCommon.float2int(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(float v) {
        ...
        float[] key = this.key;
        if (this.containsNullKey && Float.floatToIntBits(value[this.f1855n]) == Float.floatToIntBits(v)) {
            return true;
        }
        int i = this.f1855n;
        while (true) {
    ...
    public boolean remove(float k, float v) {
        ...
        } else if (!this.containsNullKey || Float.floatToIntBits(v) != Float.floatToIntBits(this.value[this.f1855n])) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenHashMap$MapEntry.class */
    public final class MapEntry implements Float2FloatMap.Entry, Map.Entry<Float, Float>, FloatFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            return Float.floatToIntBits(Float2FloatOpenHashMap.this.key[this.index]) == Float.floatToIntBits(e.getKey().floatValue()) && Float.floatToIntBits(Float2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue().floatValue());
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Float2FloatOpenHashMap.this.f1855n;
            this.last = -1;
            this.f1857c = Float2FloatOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Float2FloatOpenHashMap.this.f1855n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int i3 = Float2FloatOpenHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        ...
                        mix = p + 1;
                        i3 = Float2FloatOpenHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Float2FloatOpenHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (Float.floatToIntBits(curr) == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Float2FloatOpenHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Float2FloatOpenHashMap.this.value[pos] = Float2FloatOpenHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Float2FloatOpenHashMap.this.f1855n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Float2FloatMap.Entry>> implements ObjectIterator<Float2FloatMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Float2FloatOpenHashMap.this.f1855n;
            this.f1858c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1858c++;
                acceptOnIndex(action, Float2FloatOpenHashMap.this.f1855n);
                return true;
            }
            float[] key = Float2FloatOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Float2FloatOpenHashMap.this.size - this.f1858c);
            }
            return Math.min((long) (Float2FloatOpenHashMap.this.size - this.f1858c), ((long) ((((double) Float2FloatOpenHashMap.this.realSize()) / ((double) Float2FloatOpenHashMap.this.f1855n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap r0 = p014it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap.this
                float[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0078:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Float2FloatMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Float2FloatMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Float2FloatMap.Entry> implements Float2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Float.floatToIntBits(k) == 0) {
                return Float2FloatOpenHashMap.this.containsNullKey && Float.floatToIntBits(Float2FloatOpenHashMap.this.value[Float2FloatOpenHashMap.this.f1855n]) == Float.floatToIntBits(v);
            }
            float[] key = Float2FloatOpenHashMap.this.key;
            int mix = HashCommon.mix(HashCommon.float2int(k)) & Float2FloatOpenHashMap.this.mask;
            int pos = mix;
            float curr2 = key[mix];
            if (Float.floatToIntBits(curr2) == 0) {
                return false;
            ...
            do {
                int i = (pos + 1) & Float2FloatOpenHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (Float.floatToIntBits(curr) == 0) {
                    return false;
            ...
            if (Float.floatToIntBits(k) != 0) {
                ...
                if (Float.floatToIntBits(curr) != Float.floatToIntBits(k)) {
                    while (true) {
                        ...
                        if (Float.floatToIntBits(curr2) == Float.floatToIntBits(k) && Float.floatToIntBits(Float2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
                            Float2FloatOpenHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Float.floatToIntBits(Float2FloatOpenHashMap.this.value[pos]) != Float.floatToIntBits(v)) {
                    return false;
                } else {
                    Float2FloatOpenHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Float2FloatOpenHashMap.this.containsNullKey || Float.floatToIntBits(Float2FloatOpenHashMap.this.value[Float2FloatOpenHashMap.this.f1855n]) != Float.floatToIntBits(v)) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Float2FloatMap.Entry> consumer) {
            if (Float2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2FloatMap.BasicEntry(Float2FloatOpenHashMap.this.key[Float2FloatOpenHashMap.this.f1855n], Float2FloatOpenHashMap.this.value[Float2FloatOpenHashMap.this.f1855n]));
            }
            int pos = Float2FloatOpenHashMap.this.f1855n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Float2FloatMap.Entry> consumer) {
            ...
            if (Float2FloatOpenHashMap.this.containsNullKey) {
                entry.key = Float2FloatOpenHashMap.this.key[Float2FloatOpenHashMap.this.f1855n];
                entry.value = Float2FloatOpenHashMap.this.value[Float2FloatOpenHashMap.this.f1855n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenHashMap$KeySet.class */
    public final class KeySet extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            if (Float2FloatOpenHashMap.this.containsNullKey) {
                consumer.accept(Float2FloatOpenHashMap.this.key[Float2FloatOpenHashMap.this.f1855n]);
            }
            int pos = Float2FloatOpenHashMap.this.f1855n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenHashMap$ValueSpliterator.class */
    ...
    public Collection<Float> values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2FloatOpenHashMap.1
                ...
                public void forEach(FloatConsumer consumer) {
                    if (Float2FloatOpenHashMap.this.containsNullKey) {
                        consumer.accept(Float2FloatOpenHashMap.this.value[Float2FloatOpenHashMap.this.f1855n]);
                    }
                    int pos = Float2FloatOpenHashMap.this.f1855n;
                    while (true) {
                        pos--;
    ...
    public Float2FloatOpenHashMap clone() {
        try {
            Float2FloatOpenHashMap c = (Float2FloatOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.float2int(this.value[this.f1855n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        float[] value = new float[this.f1855n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
