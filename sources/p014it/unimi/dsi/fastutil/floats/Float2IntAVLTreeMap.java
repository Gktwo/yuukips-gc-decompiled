...
import p014it.unimi.dsi.fastutil.floats.AbstractFloat2IntSortedMap;
...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntAVLTreeMap.class */
public class Float2IntAVLTreeMap extends AbstractFloat2IntSortedMap implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Float2IntAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap.Entry add(float r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap.add(float):it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.floats.Float2IntFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public int remove(float r5) {
        /*
        // Method dump skipped, instructions count: 1494
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap.remove(float):int");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntAVLTreeMap$Entry.class */
    public static final class Entry extends AbstractFloat2IntMap.BasicEntry implements Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2IntMap.BasicEntry, p014it.unimi.dsi.fastutil.floats.Float2IntMap.Entry
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2IntMap.BasicEntry, java.util.Map.Entry, java.lang.Object
        public boolean equals(Object o) {
            if (!(o instanceof Map.Entry)) {
                return false;
            }
            Map.Entry<Float, Integer> e = (Map.Entry) o;
            return Float.floatToIntBits(this.key) == Float.floatToIntBits(e.getKey().floatValue()) && this.value == e.getValue().intValue();
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2IntMap.BasicEntry, java.lang.Object
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(float k) {
            Entry locateKey = Float2IntAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntAVLTreeMap$EntryIterator.class */
    public class EntryIterator extends TreeIterator implements ObjectListIterator<Float2IntMap.Entry> {
        EntryIterator() {
            super();
        }
    ...
    public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2IntMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap.1
                final Comparator<? super Float2IntMap.Entry> comparator;

                {
                    this.comparator = Float2IntAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Float) && e.getValue() != null && (e.getValue() instanceof Integer)) {
                        return e.equals(Float2IntAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Float) || !(e.getValue() instanceof Integer) || (f = Float2IntAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue())) == null || f.getIntValue() != ((Integer) e.getValue()).intValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntAVLTreeMap$KeySet.class */
    public class KeySet extends AbstractFloat2IntSortedMap.KeySet {
        private KeySet() {
            super();
        }

        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2IntSortedMap.KeySet, p014it.unimi.dsi.fastutil.floats.AbstractFloatSortedSet, p014it.unimi.dsi.fastutil.floats.AbstractFloatSet, p014it.unimi.dsi.fastutil.floats.AbstractFloatCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.floats.FloatCollection, p014it.unimi.dsi.fastutil.floats.FloatIterable
        public FloatBidirectionalIterator iterator() {
            return new KeyIterator();
        }

        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2IntSortedMap.KeySet, p014it.unimi.dsi.fastutil.floats.FloatSortedSet
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntAVLTreeMap$ValueIterator.class */
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntAVLTreeMap$Submap.class */
    public final class Submap extends AbstractFloat2IntSortedMap implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        float from;
        ...
        /* renamed from: in */
        final boolean m850in(float k) {
            return (this.bottom || Float2IntAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2IntAVLTreeMap.this.compare(k, this.f1860to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.floats.Float2IntMap, p014it.unimi.dsi.fastutil.floats.Float2IntSortedMap
        public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2IntMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Float2IntMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Float) && e.getValue() != null && (e.getValue() instanceof Integer) && (f = Float2IntAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue())) != null && Submap.this.m850in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        if (f != null && Submap.this.m850in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractFloat2IntSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public IntCollection values() {
            if (this.values == null) {
                this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.ints.AbstractIntCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.ints.IntCollection, p014it.unimi.dsi.fastutil.ints.IntIterable
                    public IntIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2IntMap, p014it.unimi.dsi.fastutil.floats.Float2IntFunction, p014it.unimi.dsi.fastutil.floats.Float2IntMap
        public boolean containsKey(float k) {
            return m850in(k) && Float2IntAVLTreeMap.this.containsKey(k);
        }
        ...
        public int get(float k) {
            Entry e;
            return (!m850in(k) || (e = Float2IntAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public int put(float k, int v) {
            ...
            return Float2IntAVLTreeMap.this.modified ? this.defRetValue : Float2IntAVLTreeMap.this.put(k, v);
        }
        ...
        public int remove(float k) {
            ...
            return Float2IntAVLTreeMap.this.modified ? Float2IntAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2IntSortedMap
        public Float2IntSortedMap headMap(float to) {
            if (!this.top && Float2IntAVLTreeMap.this.compare(to, this.f1860to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2IntSortedMap
        public Float2IntSortedMap tailMap(float from) {
            if (!this.bottom && Float2IntAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
        ...
        public Float2IntSortedMap subMap(float from, float to) {
            ...
            if (!this.top) {
                to = Float2IntAVLTreeMap.this.compare(to, this.f1860to) < 0 ? to : this.f1860to;
            }
            if (!this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Float2IntAVLTreeMap.this.compare(e.key, this.f1860to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Float2IntAVLTreeMap.this.locateKey(this.f1860to);
                if (Float2IntAVLTreeMap.this.compare(e.key, this.f1860to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Float2IntAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, float k) {
                ...
                if (submap.bottom || Float2IntAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Float2IntAVLTreeMap float2IntAVLTreeMap = Float2IntAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (float2IntAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Float2IntAVLTreeMap.this.compare(this.next.key, Submap.this.f1860to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntAVLTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Float2IntMap.Entry> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2IntAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2IntAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Float2IntAVLTreeMap clone() {
        try {
            Float2IntAVLTreeMap c = (Float2IntAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n == 1) {
            ...
            Entry top2 = new Entry(s.readFloat(), s.readInt());
            top2.right(new Entry(s.readFloat(), s.readInt()));
