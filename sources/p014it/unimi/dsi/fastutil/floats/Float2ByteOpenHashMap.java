...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenHashMap.class */
public class Float2ByteOpenHashMap extends AbstractFloat2ByteMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenHashMap$MapEntry.class */
    public final class MapEntry implements Float2ByteMap.Entry, Map.Entry<Float, Byte>, FloatBytePair {
        ...
        public boolean equals(Object o) {
            ...
            return Float.floatToIntBits(Float2ByteOpenHashMap.this.key[this.index]) == Float.floatToIntBits(e.getKey().floatValue()) && Float2ByteOpenHashMap.this.value[this.index] == e.getValue().byteValue();
        }
        ...
        public String toString() {
            return Float2ByteOpenHashMap.this.key[this.index] + "=>" + ((int) Float2ByteOpenHashMap.this.value[this.index]);
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        public int nextEntry() {
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int i3 = Float2ByteOpenHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Float2ByteOpenHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (Float.floatToIntBits(curr) == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Float2ByteOpenHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Float2ByteOpenHashMap.this.value[pos] = Float2ByteOpenHashMap.this.value[pos];
            }
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Float2ByteMap.Entry>> implements ObjectIterator<Float2ByteMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap r0 = p014it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap.this
                float[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0078:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Float2ByteMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Float2ByteMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Float2ByteMap.Entry> implements Float2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            do {
                int i = (pos + 1) & Float2ByteOpenHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (Float.floatToIntBits(curr) == 0) {
                    return false;
            ...
            if (Float.floatToIntBits(k) != 0) {
                ...
                if (Float.floatToIntBits(curr) != Float.floatToIntBits(k)) {
                    while (true) {
                        ...
                        if (Float.floatToIntBits(curr2) == Float.floatToIntBits(k) && Float2ByteOpenHashMap.this.value[pos] == v) {
                            Float2ByteOpenHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Float2ByteOpenHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Float2ByteOpenHashMap.this.removeEntry(pos);
                    return true;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenHashMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenHashMap$ValueSpliterator.class */
    ...
    public Collection<Byte> values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2ByteOpenHashMap.1
    ...
    public Float2ByteOpenHashMap clone() {
        try {
            Float2ByteOpenHashMap c = (Float2ByteOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
