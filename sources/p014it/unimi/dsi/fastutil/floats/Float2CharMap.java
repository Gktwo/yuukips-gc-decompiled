...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2CharMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2CharMap.class */
public interface Float2CharMap extends Float2CharFunction, Map<Float, Character> {
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2CharMap$FastEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2CharMap$FastEntrySet.class */
    ...
    default void forEach(BiConsumer<? super Float, ? super Character> consumer) {
        ObjectSet<Entry> entrySet = float2CharEntrySet();
        Consumer<Entry> wrappingConsumer = entry -> {
            consumer.accept(Float.valueOf(entry.getFloatKey()), Character.valueOf(entry.getCharValue()));
        };
    ...
    default char computeIfPresent(float key, BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
        ...
        Character newValue = (Character) remappingFunction.apply(Float.valueOf(key), Character.valueOf(oldValue));
        if (newValue == null) {
            remove(key);
            return drv;
        }
    ...
    default char compute(float key, BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
        ...
        Character newValue = (Character) remappingFunction.apply(Float.valueOf(key), contained ? Character.valueOf(oldValue) : null);
        if (newValue == null) {
            if (contained) {
                remove(key);
            }
    ...
    default Character putIfAbsent(Float key, Character value) {
        return putIfAbsent((Float2CharMap) key, (Float) value);
    }
    ...
    default boolean replace(Float key, Character oldValue, Character newValue) {
        return replace((Float2CharMap) key, oldValue, newValue);
    }

    @Deprecated
    default Character replace(Float key, Character value) {
        return replace((Float2CharMap) key, (Float) value);
    }

    @Deprecated
    default Character computeIfAbsent(Float key, Function<? super Float, ? extends Character> mappingFunction) {
        return computeIfAbsent((Float2CharMap) key, (Function<? super Float2CharMap, ? extends Character>) mappingFunction);
    }

    @Deprecated
    default Character computeIfPresent(Float key, BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
        return computeIfPresent((Float2CharMap) key, (BiFunction<? super Float2CharMap, ? super Character, ? extends Character>) remappingFunction);
    }

    @Deprecated
    default Character compute(Float key, BiFunction<? super Float, ? super Character, ? extends Character> remappingFunction) {
        return compute((Float2CharMap) key, (BiFunction<? super Float2CharMap, ? super Character, ? extends Character>) remappingFunction);
    }
    ...
    default Character merge(Float key, Character value, BiFunction<? super Character, ? super Character, ? extends Character> remappingFunction) {
        return merge((Float2CharMap) key, (Float) value, (BiFunction<? super Float, ? super Float, ? extends Float>) remappingFunction);
    }

    /* renamed from: it.unimi.dsi.fastutil.floats.Float2CharMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2CharMap$Entry.class */
