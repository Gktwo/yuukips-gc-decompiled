...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenCustomHashMap.class */
public class Float2FloatOpenCustomHashMap extends AbstractFloat2FloatMap implements Serializable, Cloneable, Hash {
    ...
    public Float2FloatOpenCustomHashMap(int expected, float f, FloatHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new float[this.f1851n + 1];
        }
    }
    ...
    public float removeNullEntry() {
        ...
        float oldValue = this.value[this.f1851n];
        this.size--;
        if (this.f1851n > this.minN && this.size < this.maxFill / 4 && this.f1851n > 16) {
            rehash(this.f1851n / 2);
        }
    ...
    public float addTo(float k, float incr) {
        ...
        if (!this.strategy.equals(k, 0.0f)) {
            ...
            return addToValue(this.f1851n, incr);
        } else {
            pos = this.f1851n;
            this.containsNullKey = true;
        }
    ...
    public float get(float k) {
        float curr;
        if (this.strategy.equals(k, 0.0f)) {
            return this.containsNullKey ? this.value[this.f1851n] : this.defRetValue;
        }
        float[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(float v) {
        ...
        float[] key = this.key;
        if (this.containsNullKey && Float.floatToIntBits(value[this.f1851n]) == Float.floatToIntBits(v)) {
            return true;
        }
        int i = this.f1851n;
        while (true) {
    ...
    public boolean remove(float k, float v) {
        ...
        } else if (!this.containsNullKey || Float.floatToIntBits(v) != Float.floatToIntBits(this.value[this.f1851n])) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Float2FloatMap.Entry, Map.Entry<Float, Float>, FloatFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            return Float2FloatOpenCustomHashMap.this.strategy.equals(Float2FloatOpenCustomHashMap.this.key[this.index], e.getKey().floatValue()) && Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue().floatValue());
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Float2FloatOpenCustomHashMap.this.f1851n;
            this.last = -1;
            this.f1853c = Float2FloatOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Float2FloatOpenCustomHashMap.this.f1851n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Float2FloatOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Float2FloatOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Float2FloatOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Float2FloatOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Float2FloatOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (Float.floatToIntBits(curr) == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Float2FloatOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Float2FloatOpenCustomHashMap.this.value[pos] = Float2FloatOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Float2FloatOpenCustomHashMap.this.f1851n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Float2FloatMap.Entry>> implements ObjectIterator<Float2FloatMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Float2FloatOpenCustomHashMap.this.f1851n;
            this.f1854c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1854c++;
                acceptOnIndex(action, Float2FloatOpenCustomHashMap.this.f1851n);
                return true;
            }
            float[] key = Float2FloatOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Float2FloatOpenCustomHashMap.this.size - this.f1854c);
            }
            return Math.min((long) (Float2FloatOpenCustomHashMap.this.size - this.f1854c), ((long) ((((double) Float2FloatOpenCustomHashMap.this.realSize()) / ((double) Float2FloatOpenCustomHashMap.this.f1851n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap.this
                float[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0078:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Float2FloatMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Float2FloatMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Float2FloatMap.Entry> implements Float2FloatMap.FastEntrySet {
        private MapEntrySet() {
        }
        ...
        public boolean contains(Object o) {
            ...
            if (Float2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                return Float2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.f1851n]) == Float.floatToIntBits(v);
            }
            float[] key = Float2FloatOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Float2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Float2FloatOpenCustomHashMap.this.mask;
            int pos = mix;
            float curr2 = key[mix];
            if (Float.floatToIntBits(curr2) == 0) {
                return false;
            }
            if (Float2FloatOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v);
            }
            do {
                int i = (pos + 1) & Float2FloatOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (Float.floatToIntBits(curr) == 0) {
                    return false;
            ...
            if (!Float2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                ...
                if (!Float2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Float2FloatOpenCustomHashMap.this.strategy.equals(curr2, k) && Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
                            Float2FloatOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[pos]) != Float.floatToIntBits(v)) {
                    return false;
                } else {
                    Float2FloatOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Float2FloatOpenCustomHashMap.this.containsNullKey || Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.f1851n]) != Float.floatToIntBits(v)) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Float2FloatMap.Entry> consumer) {
            if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2FloatMap.BasicEntry(Float2FloatOpenCustomHashMap.this.key[Float2FloatOpenCustomHashMap.this.f1851n], Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.f1851n]));
            }
            int pos = Float2FloatOpenCustomHashMap.this.f1851n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Float2FloatMap.Entry> consumer) {
            ...
            if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
                entry.key = Float2FloatOpenCustomHashMap.this.key[Float2FloatOpenCustomHashMap.this.f1851n];
                entry.value = Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.f1851n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Float2FloatOpenCustomHashMap.this.key[Float2FloatOpenCustomHashMap.this.f1851n]);
            }
            int pos = Float2FloatOpenCustomHashMap.this.f1851n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Float> values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2FloatOpenCustomHashMap.1
                ...
                public void forEach(FloatConsumer consumer) {
                    if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.f1851n]);
                    }
                    int pos = Float2FloatOpenCustomHashMap.this.f1851n;
                    while (true) {
                        pos--;
    ...
    public Float2FloatOpenCustomHashMap clone() {
        try {
            Float2FloatOpenCustomHashMap c = (Float2FloatOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.float2int(this.value[this.f1851n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        float[] value = new float[this.f1851n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
