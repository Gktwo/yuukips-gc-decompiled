...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceMap.class */
public interface Float2ReferenceMap<V> extends Float2ReferenceFunction<V>, Map<Float, V> {
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceMap$FastEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceMap$FastEntrySet.class */
    ...
    default void forEach(BiConsumer<? super Float, ? super V> consumer) {
        ObjectSet<Entry<V>> entrySet = float2ReferenceEntrySet();
    ...
    default V computeIfAbsentPartial(float key, Float2ReferenceFunction<? extends V> mappingFunction) {
        return computeIfAbsent(key, (Float2ReferenceFunction) mappingFunction);
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceMap$Entry.class */
