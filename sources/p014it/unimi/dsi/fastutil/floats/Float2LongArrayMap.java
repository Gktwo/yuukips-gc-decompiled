...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2LongArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2LongArrayMap.class */
public class Float2LongArrayMap extends AbstractFloat2LongMap implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Float2LongArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Float2LongArrayMap(Float2LongMap m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Float2LongMap.Entry> it = m.float2LongEntrySet().iterator();
        while (it.hasNext()) {
            Float2LongMap.Entry e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2LongArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2LongArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Float2LongMap.Entry> implements Float2LongMap.FastEntrySet {
        private EntrySet() {
        }

        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
        public ObjectIterator<Float2LongMap.Entry> iterator() {
            return new ObjectIterator<Float2LongMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2LongArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Float2LongMap.Entry next() {
                    ...
                    float[] fArr = Float2LongArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    float f = fArr[i];
                    long[] jArr = Float2LongArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractFloat2LongMap.BasicEntry(f, jArr[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Float2LongArrayMap.access$010(Float2LongArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Float2LongMap.Entry> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractFloat2LongMap.BasicEntry(f, jArr[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Float2LongMap.Entry> fastIterator() {
            return new ObjectIterator<Float2LongMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2LongArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Float2LongMap.Entry next() {
                    ...
                    AbstractFloat2LongMap.BasicEntry basicEntry = this.entry;
                    float[] fArr = Float2LongArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = fArr[i];
                    AbstractFloat2LongMap.BasicEntry basicEntry2 = this.entry;
                    long[] jArr = Float2LongArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2LongArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2LongArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Float2LongMap.Entry> implements ObjectSpliterator<Float2LongMap.Entry> {
            ...
            public final Float2LongMap.Entry get(int location) {
        ...
        public boolean remove(Object o) {
            ...
            Float2LongArrayMap.access$010(Float2LongArrayMap.this);
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2LongArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2LongArrayMap$KeySet.class */
    public final class KeySet extends AbstractFloatSet {
        ...
        public FloatIterator iterator() {
            return new FloatIterator() { // from class: it.unimi.dsi.fastutil.floats.Float2LongArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2LongArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2LongArrayMap$KeySet$KeySetSpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2LongArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2LongArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractLongCollection {
        ...
        public LongIterator iterator() {
            return new LongIterator() { // from class: it.unimi.dsi.fastutil.floats.Float2LongArrayMap.ValuesCollection.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2LongArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2LongArrayMap$ValuesCollection$ValuesSpliterator.class */
    ...
    public Float2LongArrayMap clone() {
        try {
            Float2LongArrayMap c = (Float2LongArrayMap) clone();
