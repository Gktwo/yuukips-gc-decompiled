...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatFunctions.class */
public final class Float2FloatFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractFloat2FloatFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2FloatFunction, p014it.unimi.dsi.fastutil.floats.Float2FloatFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Float2FloatFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Float2FloatFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Float2FloatFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2FloatFunction, java.util.function.DoubleUnaryOperator
        @Deprecated
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractFloat2FloatFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Float2FloatFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Float2FloatFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Float2FloatFunction {
        ...
        public float get(float key) {
            Float v = (Float) this.function.apply(Float.valueOf(key));
        ...
        public Float get(Object key) {
            ...
            return (Float) this.function.apply((Float) key);
        }
        ...
        public Float getOrDefault(Object key, Float defaultValue) {
            Float v;
            if (!(key == null || (v = (Float) this.function.apply((Float) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
    ...
    public static Float2FloatFunction primitive(java.util.function.Function<? super Float, ? extends Float> f) {
        ...
        return f instanceof Float2FloatFunction ? (Float2FloatFunction) f : f instanceof DoubleUnaryOperator ? key -> {
            return SafeMath.safeDoubleToFloat(((DoubleUnaryOperator) f).applyAsDouble((double) key));
