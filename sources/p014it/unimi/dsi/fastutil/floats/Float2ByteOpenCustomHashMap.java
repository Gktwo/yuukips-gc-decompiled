...
public class Float2ByteOpenCustomHashMap extends AbstractFloat2ByteMap implements Serializable, Cloneable, Hash {
    ...
    public Float2ByteOpenCustomHashMap(int expected, float f, FloatHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new byte[this.f1815n + 1];
        }
    }
    ...
    public byte removeNullEntry() {
        ...
        byte oldValue = this.value[this.f1815n];
        this.size--;
        if (this.f1815n > this.minN && this.size < this.maxFill / 4 && this.f1815n > 16) {
            rehash(this.f1815n / 2);
        }
    ...
    public boolean containsValue(byte v) {
        ...
        float[] key = this.key;
        if (this.containsNullKey && value[this.f1815n] == v) {
            return true;
        }
        int i = this.f1815n;
        while (true) {
    ...
    public boolean remove(float k, byte v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1815n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Float2ByteOpenCustomHashMap.this.f1815n;
            this.last = -1;
            this.f1817c = Float2ByteOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Float2ByteOpenCustomHashMap.this.f1815n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Float2ByteOpenCustomHashMap.this.f1815n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Float2ByteOpenCustomHashMap.this.f1815n;
            this.f1818c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1818c++;
                acceptOnIndex(action, Float2ByteOpenCustomHashMap.this.f1815n);
                return true;
            }
            float[] key = Float2ByteOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Float2ByteOpenCustomHashMap.this.size - this.f1818c);
            }
            return Math.min((long) (Float2ByteOpenCustomHashMap.this.size - this.f1818c), ((long) ((((double) Float2ByteOpenCustomHashMap.this.realSize()) / ((double) Float2ByteOpenCustomHashMap.this.f1815n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Float2ByteMap.Entry> implements Float2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Float2ByteOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                return Float2ByteOpenCustomHashMap.this.containsNullKey && Float2ByteOpenCustomHashMap.this.value[Float2ByteOpenCustomHashMap.this.f1815n] == v;
            }
            float[] key = Float2ByteOpenCustomHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Float2ByteOpenCustomHashMap.this.containsNullKey || Float2ByteOpenCustomHashMap.this.value[Float2ByteOpenCustomHashMap.this.f1815n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Float2ByteMap.Entry> consumer) {
            if (Float2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2ByteMap.BasicEntry(Float2ByteOpenCustomHashMap.this.key[Float2ByteOpenCustomHashMap.this.f1815n], Float2ByteOpenCustomHashMap.this.value[Float2ByteOpenCustomHashMap.this.f1815n]));
            }
            int pos = Float2ByteOpenCustomHashMap.this.f1815n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Float2ByteMap.Entry> consumer) {
            ...
            if (Float2ByteOpenCustomHashMap.this.containsNullKey) {
                entry.key = Float2ByteOpenCustomHashMap.this.key[Float2ByteOpenCustomHashMap.this.f1815n];
                entry.value = Float2ByteOpenCustomHashMap.this.value[Float2ByteOpenCustomHashMap.this.f1815n];
    ...
    public final class KeySet extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            if (Float2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Float2ByteOpenCustomHashMap.this.key[Float2ByteOpenCustomHashMap.this.f1815n]);
            }
            int pos = Float2ByteOpenCustomHashMap.this.f1815n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap.1
                ...
                public void forEach(ByteConsumer consumer) {
                    if (Float2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Float2ByteOpenCustomHashMap.this.value[Float2ByteOpenCustomHashMap.this.f1815n]);
                    }
                    int pos = Float2ByteOpenCustomHashMap.this.f1815n;
                    while (true) {
                        pos--;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        byte[] value = new byte[this.f1815n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
