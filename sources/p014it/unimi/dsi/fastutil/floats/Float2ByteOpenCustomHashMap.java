...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenCustomHashMap.class */
public class Float2ByteOpenCustomHashMap extends AbstractFloat2ByteMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f1779n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f1780f;
    ...
    public Float2ByteOpenCustomHashMap(int expected, float f, FloatHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f1779n = arraySize;
            this.minN = arraySize;
            this.mask = this.f1779n - 1;
            this.maxFill = HashCommon.maxFill(this.f1779n, f);
            this.key = new float[this.f1779n + 1];
            this.value = new byte[this.f1779n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f1780f);
        if (needed > this.f1779n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f1780f)))));
        if (needed > this.f1779n) {
            rehash(needed);
        }
    }
    ...
    public byte removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f1779n > this.minN && this.size < this.maxFill / 4 && this.f1779n > 16) {
            rehash(this.f1779n / 2);
        }
        return oldValue;
    }
    ...
    public byte removeNullEntry() {
        ...
        byte oldValue = this.value[this.f1779n];
        this.size--;
        if (this.f1779n > this.minN && this.size < this.maxFill / 4 && this.f1779n > 16) {
            rehash(this.f1779n / 2);
        }
    ...
    private int find(float k) {
        ...
        if (this.strategy.equals(k, 0.0f)) {
            return this.containsNullKey ? this.f1779n : -(this.f1779n + 1);
        }
        float[] key = this.key;
    ...
    private void insert(int pos, float k, byte v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f1780f));
        }
    }
    ...
    public byte addTo(float k, byte incr) {
        ...
        if (!this.strategy.equals(k, 0.0f)) {
            ...
            return addToValue(this.f1779n, incr);
        } else {
            pos = this.f1779n;
            this.containsNullKey = true;
        }
    ...
    public byte get(float k) {
        float curr;
        if (this.strategy.equals(k, 0.0f)) {
            return this.containsNullKey ? this.value[this.f1779n] : this.defRetValue;
        }
        float[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(byte v) {
        ...
        float[] key = this.key;
        if (this.containsNullKey && value[this.f1779n] == v) {
            return true;
        }
        int i = this.f1779n;
        while (true) {
    ...
    public byte getOrDefault(float k, byte defaultValue) {
        float curr;
        if (this.strategy.equals(k, 0.0f)) {
            return this.containsNullKey ? this.value[this.f1779n] : defaultValue;
        }
        float[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(float k, byte v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f1779n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Float2ByteMap.Entry, Map.Entry<Float, Byte>, FloatBytePair {
        ...
        public boolean equals(Object o) {
            ...
            return Float2ByteOpenCustomHashMap.this.strategy.equals(Float2ByteOpenCustomHashMap.this.key[this.index], e.getKey().floatValue()) && Float2ByteOpenCustomHashMap.this.value[this.index] == e.getValue().byteValue();
        }
        ...
        public String toString() {
            return Float2ByteOpenCustomHashMap.this.key[this.index] + "=>" + ((int) Float2ByteOpenCustomHashMap.this.value[this.index]);
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Float2ByteOpenCustomHashMap.this.f1779n;
            this.last = -1;
            this.f1781c = Float2ByteOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Float2ByteOpenCustomHashMap.this.f1779n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Float2ByteOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Float2ByteOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Float2ByteOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Float2ByteOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Float2ByteOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (Float.floatToIntBits(curr) == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Float2ByteOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Float2ByteOpenCustomHashMap.this.value[pos] = Float2ByteOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Float2ByteOpenCustomHashMap.this.f1779n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Float2ByteMap.Entry>> implements ObjectIterator<Float2ByteMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Float2ByteOpenCustomHashMap.this.f1779n;
            this.f1782c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f1782c++;
                acceptOnIndex(action, Float2ByteOpenCustomHashMap.this.f1779n);
                return true;
            }
            float[] key = Float2ByteOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Float2ByteOpenCustomHashMap.this.size - this.f1782c);
            }
            return Math.min((long) (Float2ByteOpenCustomHashMap.this.size - this.f1782c), ((long) ((((double) Float2ByteOpenCustomHashMap.this.realSize()) / ((double) Float2ByteOpenCustomHashMap.this.f1779n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap.this
                float[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0078:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Float2ByteMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Float2ByteMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Float2ByteMap.Entry> implements Float2ByteMap.FastEntrySet {
        private MapEntrySet() {
        }
        ...
        public boolean contains(Object o) {
            ...
            if (Float2ByteOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                return Float2ByteOpenCustomHashMap.this.containsNullKey && Float2ByteOpenCustomHashMap.this.value[Float2ByteOpenCustomHashMap.this.f1779n] == v;
            }
            float[] key = Float2ByteOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Float2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ByteOpenCustomHashMap.this.mask;
            int pos = mix;
            float curr2 = key[mix];
            if (Float.floatToIntBits(curr2) == 0) {
                return false;
            }
            if (Float2ByteOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Float2ByteOpenCustomHashMap.this.value[pos] == v;
            }
            do {
                int i = (pos + 1) & Float2ByteOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (Float.floatToIntBits(curr) == 0) {
                    return false;
            ...
            if (!Float2ByteOpenCustomHashMap.this.strategy.equals(k, 0.0f)) {
                ...
                if (!Float2ByteOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Float2ByteOpenCustomHashMap.this.strategy.equals(curr2, k) && Float2ByteOpenCustomHashMap.this.value[pos] == v) {
                            Float2ByteOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Float2ByteOpenCustomHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Float2ByteOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Float2ByteOpenCustomHashMap.this.containsNullKey || Float2ByteOpenCustomHashMap.this.value[Float2ByteOpenCustomHashMap.this.f1779n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Float2ByteMap.Entry> consumer) {
            if (Float2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractFloat2ByteMap.BasicEntry(Float2ByteOpenCustomHashMap.this.key[Float2ByteOpenCustomHashMap.this.f1779n], Float2ByteOpenCustomHashMap.this.value[Float2ByteOpenCustomHashMap.this.f1779n]));
            }
            int pos = Float2ByteOpenCustomHashMap.this.f1779n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Float2ByteMap.Entry> consumer) {
            ...
            if (Float2ByteOpenCustomHashMap.this.containsNullKey) {
                entry.key = Float2ByteOpenCustomHashMap.this.key[Float2ByteOpenCustomHashMap.this.f1779n];
                entry.value = Float2ByteOpenCustomHashMap.this.value[Float2ByteOpenCustomHashMap.this.f1779n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractFloatSet {
        ...
        public void forEach(FloatConsumer consumer) {
            if (Float2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Float2ByteOpenCustomHashMap.this.key[Float2ByteOpenCustomHashMap.this.f1779n]);
            }
            int pos = Float2ByteOpenCustomHashMap.this.f1779n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Byte> values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2ByteOpenCustomHashMap.1
                ...
                public void forEach(ByteConsumer consumer) {
                    if (Float2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Float2ByteOpenCustomHashMap.this.value[Float2ByteOpenCustomHashMap.this.f1779n]);
                    }
                    int pos = Float2ByteOpenCustomHashMap.this.f1779n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f1780f)));
        if (l >= this.f1779n || this.size > HashCommon.maxFill(l, this.f1780f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f1779n];
                this.f1779n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f1779n, this.f1780f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Float2ByteOpenCustomHashMap clone() {
        try {
            Float2ByteOpenCustomHashMap c = (Float2ByteOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f1779n = HashCommon.arraySize(this.size, this.f1780f);
        this.maxFill = HashCommon.maxFill(this.f1779n, this.f1780f);
        this.mask = this.f1779n - 1;
        float[] key = new float[this.f1779n + 1];
        this.key = key;
        byte[] value = new byte[this.f1779n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
