...
import p014it.unimi.dsi.fastutil.floats.AbstractFloat2ShortSortedMap;
...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortAVLTreeMap.class */
public class Float2ShortAVLTreeMap extends AbstractFloat2ShortSortedMap implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Float2ShortAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap.Entry add(float r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap.add(float):it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.floats.Float2ShortFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public short remove(float r5) {
        /*
        // Method dump skipped, instructions count: 1494
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap.remove(float):short");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortAVLTreeMap$Entry.class */
    public static final class Entry extends AbstractFloat2ShortMap.BasicEntry implements Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ShortMap.BasicEntry, p014it.unimi.dsi.fastutil.floats.Float2ShortMap.Entry
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ShortMap.BasicEntry, java.util.Map.Entry, java.lang.Object
        public boolean equals(Object o) {
            if (!(o instanceof Map.Entry)) {
                return false;
            }
            Map.Entry<Float, Short> e = (Map.Entry) o;
            return Float.floatToIntBits(this.key) == Float.floatToIntBits(e.getKey().floatValue()) && this.value == e.getValue().shortValue();
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ShortMap.BasicEntry, java.lang.Object
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(float k) {
            Entry locateKey = Float2ShortAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortAVLTreeMap$EntryIterator.class */
    public class EntryIterator extends TreeIterator implements ObjectListIterator<Float2ShortMap.Entry> {
        EntryIterator() {
            super();
        }
    ...
    public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap.1
                final Comparator<? super Float2ShortMap.Entry> comparator;

                {
                    this.comparator = Float2ShortAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Float) && e.getValue() != null && (e.getValue() instanceof Short)) {
                        return e.equals(Float2ShortAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Float) || !(e.getValue() instanceof Short) || (f = Float2ShortAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue())) == null || f.getShortValue() != ((Short) e.getValue()).shortValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortAVLTreeMap$KeySet.class */
    public class KeySet extends AbstractFloat2ShortSortedMap.KeySet {
        private KeySet() {
            super();
        }

        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ShortSortedMap.KeySet, p014it.unimi.dsi.fastutil.floats.AbstractFloatSortedSet, p014it.unimi.dsi.fastutil.floats.AbstractFloatSet, p014it.unimi.dsi.fastutil.floats.AbstractFloatCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.floats.FloatCollection, p014it.unimi.dsi.fastutil.floats.FloatIterable
        public FloatBidirectionalIterator iterator() {
            return new KeyIterator();
        }

        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ShortSortedMap.KeySet, p014it.unimi.dsi.fastutil.floats.FloatSortedSet
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortAVLTreeMap$ValueIterator.class */
    ...
    public ShortCollection values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortAVLTreeMap$Submap.class */
    public final class Submap extends AbstractFloat2ShortSortedMap implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        float from;
        ...
        /* renamed from: in */
        final boolean m842in(float k) {
            return (this.bottom || Float2ShortAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2ShortAVLTreeMap.this.compare(k, this.f1908to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.floats.Float2ShortMap, p014it.unimi.dsi.fastutil.floats.Float2ShortSortedMap
        public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Float2ShortMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Float) && e.getValue() != null && (e.getValue() instanceof Short) && (f = Float2ShortAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue())) != null && Submap.this.m842in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        if (f != null && Submap.this.m842in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractFloat2ShortSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ShortCollection values() {
            if (this.values == null) {
                this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShortCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.shorts.ShortCollection, p014it.unimi.dsi.fastutil.shorts.ShortIterable
                    public ShortIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ShortMap, p014it.unimi.dsi.fastutil.floats.Float2ShortFunction, p014it.unimi.dsi.fastutil.floats.Float2ShortMap
        public boolean containsKey(float k) {
            return m842in(k) && Float2ShortAVLTreeMap.this.containsKey(k);
        }
        ...
        public short get(float k) {
            Entry e;
            return (!m842in(k) || (e = Float2ShortAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public short put(float k, short v) {
            ...
            if (!m842in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1908to)) + ")");
            }
            return Float2ShortAVLTreeMap.this.modified ? this.defRetValue : Float2ShortAVLTreeMap.this.put(k, v);
        }
        ...
        public short remove(float k) {
            ...
            return Float2ShortAVLTreeMap.this.modified ? Float2ShortAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ShortSortedMap
        public Float2ShortSortedMap headMap(float to) {
            if (!this.top && Float2ShortAVLTreeMap.this.compare(to, this.f1908to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ShortSortedMap
        public Float2ShortSortedMap tailMap(float from) {
            if (!this.bottom && Float2ShortAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1908to, this.top);
        }
        ...
        public Float2ShortSortedMap subMap(float from, float to) {
            ...
            if (!this.top) {
                to = Float2ShortAVLTreeMap.this.compare(to, this.f1908to) < 0 ? to : this.f1908to;
            }
            if (!this.bottom) {
                from = Float2ShortAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1908to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Float2ShortAVLTreeMap.this.compare(e.key, this.f1908to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Float2ShortAVLTreeMap.this.locateKey(this.f1908to);
                if (Float2ShortAVLTreeMap.this.compare(e.key, this.f1908to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Float2ShortAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, float k) {
                ...
                if (submap.bottom || Float2ShortAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Float2ShortAVLTreeMap float2ShortAVLTreeMap = Float2ShortAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (float2ShortAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Float2ShortAVLTreeMap.this.compare(this.next.key, Submap.this.f1908to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortAVLTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends SubmapIterator implements ObjectListIterator<Float2ShortMap.Entry> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Float2ShortAVLTreeMap clone() {
        try {
            Float2ShortAVLTreeMap c = (Float2ShortAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n == 1) {
            ...
            Entry top2 = new Entry(s.readFloat(), s.readShort());
            top2.right(new Entry(s.readFloat(), s.readShort()));
