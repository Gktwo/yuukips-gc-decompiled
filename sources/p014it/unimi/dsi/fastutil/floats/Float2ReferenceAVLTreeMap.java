...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceAVLTreeMap.class */
public class Float2ReferenceAVLTreeMap<V> extends AbstractFloat2ReferenceSortedMap<V> implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Float2ReferenceAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap.Entry<V> add(float r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap.add(float):it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap$Entry");
    }
    ...
    public V remove(float r5) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap.remove(float):java.lang.Object");
    }

    @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ReferenceMap, java.util.Map
    public boolean containsValue(Object v) {
        Float2ReferenceAVLTreeMap<V>.ValueIterator i = new ValueIterator();
        int j = this.count;
        do {
            j--;
            if (j == 0) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceAVLTreeMap$Entry.class */
    public static final class Entry<V> extends AbstractFloat2ReferenceMap.BasicEntry<V> implements Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ReferenceMap.BasicEntry, java.util.Map.Entry
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ReferenceMap.BasicEntry, java.util.Map.Entry, java.lang.Object
        public boolean equals(Object o) {
            if (!(o instanceof Map.Entry)) {
                return false;
            }
            Map.Entry<Float, V> e = (Map.Entry) o;
            return Float.floatToIntBits(this.key) == Float.floatToIntBits(e.getKey().floatValue()) && this.value == e.getValue();
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ReferenceMap.BasicEntry, java.lang.Object
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(float k) {
            Entry<V> locateKey = Float2ReferenceAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceAVLTreeMap$EntryIterator.class */
    public class EntryIterator extends Float2ReferenceAVLTreeMap<V>.TreeIterator implements ObjectListIterator<Float2ReferenceMap.Entry<V>> {
    ...
    public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap.1
                final Comparator<? super Float2ReferenceMap.Entry<V>> comparator;

                {
                    this.comparator = Float2ReferenceAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Float)) {
                        return e.equals(Float2ReferenceAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Float) || (f = Float2ReferenceAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue())) == null || f.getValue() != e.getValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceAVLTreeMap$KeyIterator.class */
    public final class KeyIterator extends Float2ReferenceAVLTreeMap<V>.TreeIterator implements FloatListIterator {
        public KeyIterator() {
            super();
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceAVLTreeMap$KeySet.class */
    public class KeySet extends AbstractFloat2ReferenceSortedMap<V>.KeySet {
        private KeySet() {
            super();
        }

        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ReferenceSortedMap.KeySet, p014it.unimi.dsi.fastutil.floats.AbstractFloatSortedSet, p014it.unimi.dsi.fastutil.floats.AbstractFloatSet, p014it.unimi.dsi.fastutil.floats.AbstractFloatCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.floats.FloatCollection, p014it.unimi.dsi.fastutil.floats.FloatIterable
        public FloatBidirectionalIterator iterator() {
            return new KeyIterator();
        }

        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ReferenceSortedMap.KeySet, p014it.unimi.dsi.fastutil.floats.FloatSortedSet
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceAVLTreeMap$ValueIterator.class */
    public final class ValueIterator extends Float2ReferenceAVLTreeMap<V>.TreeIterator implements ObjectListIterator<V> {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceAVLTreeMap$Submap.class */
    public final class Submap extends AbstractFloat2ReferenceSortedMap<V> implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        float from;
        ...
        @Override // p014it.unimi.dsi.fastutil.Function, p014it.unimi.dsi.fastutil.bytes.Byte2BooleanMap, java.util.Map
        public void clear() {
            Float2ReferenceAVLTreeMap<V>.Submap.SubmapIterator i = new SubmapIterator();
            while (i.hasNext()) {
                i.nextEntry();
                i.remove();
            }
        ...
        /* renamed from: in */
        final boolean m844in(float k) {
            return (this.bottom || Float2ReferenceAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2ReferenceAVLTreeMap.this.compare(k, this.f1896to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.floats.Float2ReferenceMap, p014it.unimi.dsi.fastutil.floats.Float2ReferenceSortedMap
        public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.ObjectSortedSet
                    public /* bridge */ /* synthetic */ ObjectBidirectionalIterator iterator(Object obj) {
                        return iterator((Float2ReferenceMap.Entry) ((Float2ReferenceMap.Entry) obj));
                    }
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Float) && (f = Float2ReferenceAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue())) != null && Submap.this.m844in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry<V> f = Float2ReferenceAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue());
                        if (f != null && Submap.this.m844in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractFloat2ReferenceSortedMap<V>.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ReferenceCollection<V> values() {
            if (this.values == null) {
                this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractReferenceCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ReferenceCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection
                    public ObjectIterator<V> iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ReferenceMap, p014it.unimi.dsi.fastutil.floats.Float2ReferenceFunction, p014it.unimi.dsi.fastutil.floats.Float2ReferenceMap
        public boolean containsKey(float k) {
            return m844in(k) && Float2ReferenceAVLTreeMap.this.containsKey(k);
        }
        ...
        public V get(float k) {
            Entry<V> e;
            return (!m844in(k) || (e = Float2ReferenceAVLTreeMap.this.findKey(k)) == null) ? (V) this.defRetValue : (V) e.value;
        }
        ...
        public V put(float k, V v) {
            ...
            if (!m844in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1896to)) + ")");
            }
            return Float2ReferenceAVLTreeMap.this.modified ? (V) this.defRetValue : (V) Float2ReferenceAVLTreeMap.this.put(k, (float) v);
        }
        ...
        public V remove(float k) {
            ...
            return Float2ReferenceAVLTreeMap.this.modified ? (V) Float2ReferenceAVLTreeMap.this.remove(k) : (V) this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ReferenceSortedMap
        public Float2ReferenceSortedMap<V> headMap(float to) {
            if (!this.top && Float2ReferenceAVLTreeMap.this.compare(to, this.f1896to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ReferenceSortedMap
        public Float2ReferenceSortedMap<V> tailMap(float from) {
            if (!this.bottom && Float2ReferenceAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1896to, this.top);
        }
        ...
        public Float2ReferenceSortedMap<V> subMap(float from, float to) {
            ...
            if (!this.top) {
                to = Float2ReferenceAVLTreeMap.this.compare(to, this.f1896to) < 0 ? to : this.f1896to;
            }
            if (!this.bottom) {
                from = Float2ReferenceAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1896to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.top || Float2ReferenceAVLTreeMap.this.compare(e.key, this.f1896to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                ...
                e = Float2ReferenceAVLTreeMap.this.locateKey(this.f1896to);
                if (Float2ReferenceAVLTreeMap.this.compare(e.key, this.f1896to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Float2ReferenceAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends Float2ReferenceAVLTreeMap<V>.TreeIterator {
            SubmapIterator() {
                super();
            ...
            SubmapIterator(Submap submap, float k) {
                ...
                if (submap.bottom || Float2ReferenceAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Float2ReferenceAVLTreeMap float2ReferenceAVLTreeMap = Float2ReferenceAVLTreeMap.this;
                        Entry<V> lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (float2ReferenceAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Float2ReferenceAVLTreeMap.this.compare(this.next.key, Submap.this.f1896to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceAVLTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends Float2ReferenceAVLTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Float2ReferenceMap.Entry<V>> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceAVLTreeMap$Submap$SubmapKeyIterator.class */
        public final class SubmapKeyIterator extends Float2ReferenceAVLTreeMap<V>.Submap.SubmapIterator implements FloatListIterator {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceAVLTreeMap$Submap$SubmapValueIterator.class */
        public final class SubmapValueIterator extends Float2ReferenceAVLTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<V> {
    ...
    public Float2ReferenceAVLTreeMap<V> clone() {
        try {
            Float2ReferenceAVLTreeMap<V> c = (Float2ReferenceAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        int n = this.count;
        Float2ReferenceAVLTreeMap<V>.EntryIterator i = new EntryIterator();
