...
public class Float2ReferenceRBTreeMap<V> extends AbstractFloat2ReferenceSortedMap<V> implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractFloat2ReferenceSortedMap<V> implements Serializable {
        ...
        final boolean m843in(float k) {
            return (this.bottom || Float2ReferenceRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2ReferenceRBTreeMap.this.compare(k, this.f1871to) < 0);
        }
        ...
        public V put(float k, V v) {
            ...
            if (!m843in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1871to)) + ")");
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ReferenceSortedMap
        public Float2ReferenceSortedMap<V> headMap(float to) {
            if (!this.top && Float2ReferenceRBTreeMap.this.compare(to, this.f1871to) >= 0) {
                return this;
            }
        ...
        public Float2ReferenceSortedMap<V> tailMap(float from) {
            ...
            return new Submap(from, false, this.f1871to, this.top);
        }
        ...
        public Float2ReferenceSortedMap<V> subMap(float from, float to) {
            ...
            if (!this.top) {
                to = Float2ReferenceRBTreeMap.this.compare(to, this.f1871to) < 0 ? to : this.f1871to;
            }
            if (!this.bottom) {
                from = Float2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1871to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.top || Float2ReferenceRBTreeMap.this.compare(e.key, this.f1871to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                ...
                e = Float2ReferenceRBTreeMap.this.locateKey(this.f1871to);
                if (Float2ReferenceRBTreeMap.this.compare(e.key, this.f1871to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends Float2ReferenceRBTreeMap<V>.TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Float2ReferenceRBTreeMap.this.compare(this.next.key, Submap.this.f1871to) >= 0) {
                    this.next = null;
                }
            }
        }
