...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceRBTreeMap.class */
public class Float2ReferenceRBTreeMap<V> extends AbstractFloat2ReferenceSortedMap<V> implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap.Entry<V> add(float r9) {
        /*
        // Method dump skipped, instructions count: 935
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap.add(float):it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap$Entry");
    }
    ...
    public V remove(float r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap.remove(float):java.lang.Object");
    }

    @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ReferenceMap, java.util.Map
    public boolean containsValue(Object v) {
        Float2ReferenceRBTreeMap<V>.ValueIterator i = new ValueIterator();
        int j = this.count;
        do {
            j--;
            if (j == 0) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(float k) {
            Entry<V> locateKey = Float2ReferenceRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceRBTreeMap$EntryIterator.class */
    public class EntryIterator extends Float2ReferenceRBTreeMap<V>.TreeIterator implements ObjectListIterator<Float2ReferenceMap.Entry<V>> {
        EntryIterator() {
            super();
        }
    ...
    public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap.1
                final Comparator<? super Float2ReferenceMap.Entry<V>> comparator;

                {
                    this.comparator = Float2ReferenceRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Float)) {
                        return e.equals(Float2ReferenceRBTreeMap.this.findKey(((Float) e.getKey()).floatValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Float) || (f = Float2ReferenceRBTreeMap.this.findKey(((Float) e.getKey()).floatValue())) == null || f.getValue() != e.getValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceRBTreeMap$KeyIterator.class */
    public final class KeyIterator extends Float2ReferenceRBTreeMap<V>.TreeIterator implements FloatListIterator {
        public KeyIterator() {
            super();
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceRBTreeMap$ValueIterator.class */
    public final class ValueIterator extends Float2ReferenceRBTreeMap<V>.TreeIterator implements ObjectListIterator<V> {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceRBTreeMap$Submap.class */
    public final class Submap extends AbstractFloat2ReferenceSortedMap<V> implements Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.Function, p014it.unimi.dsi.fastutil.bytes.Byte2BooleanMap, java.util.Map
        public void clear() {
            Float2ReferenceRBTreeMap<V>.Submap.SubmapIterator i = new SubmapIterator();
            while (i.hasNext()) {
                i.nextEntry();
                i.remove();
            }
        ...
        /* renamed from: in */
        final boolean m843in(float k) {
            return (this.bottom || Float2ReferenceRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2ReferenceRBTreeMap.this.compare(k, this.f1907to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.floats.Float2ReferenceMap, p014it.unimi.dsi.fastutil.floats.Float2ReferenceSortedMap
        public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.ObjectSortedSet
                    public /* bridge */ /* synthetic */ ObjectBidirectionalIterator iterator(Object obj) {
                        return iterator((Float2ReferenceMap.Entry) ((Float2ReferenceMap.Entry) obj));
                    }
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Float) && (f = Float2ReferenceRBTreeMap.this.findKey(((Float) e.getKey()).floatValue())) != null && Submap.this.m843in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry<V> f = Float2ReferenceRBTreeMap.this.findKey(((Float) e.getKey()).floatValue());
                        if (f != null && Submap.this.m843in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractFloat2ReferenceSortedMap<V>.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ReferenceCollection<V> values() {
            if (this.values == null) {
                this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractReferenceCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ReferenceCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection
                    public ObjectIterator<V> iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ReferenceMap, p014it.unimi.dsi.fastutil.floats.Float2ReferenceFunction, p014it.unimi.dsi.fastutil.floats.Float2ReferenceMap
        public boolean containsKey(float k) {
            return m843in(k) && Float2ReferenceRBTreeMap.this.containsKey(k);
        }
        ...
        public V get(float k) {
            Entry<V> e;
            return (!m843in(k) || (e = Float2ReferenceRBTreeMap.this.findKey(k)) == null) ? (V) this.defRetValue : (V) e.value;
        }
        ...
        public V put(float k, V v) {
            ...
            if (!m843in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1907to)) + ")");
            }
            return Float2ReferenceRBTreeMap.this.modified ? (V) this.defRetValue : (V) Float2ReferenceRBTreeMap.this.put(k, (float) v);
        }
        ...
        public V remove(float k) {
            ...
            return Float2ReferenceRBTreeMap.this.modified ? (V) Float2ReferenceRBTreeMap.this.remove(k) : (V) this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ReferenceSortedMap
        public Float2ReferenceSortedMap<V> headMap(float to) {
            if (!this.top && Float2ReferenceRBTreeMap.this.compare(to, this.f1907to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ReferenceSortedMap
        public Float2ReferenceSortedMap<V> tailMap(float from) {
            if (!this.bottom && Float2ReferenceRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1907to, this.top);
        }
        ...
        public Float2ReferenceSortedMap<V> subMap(float from, float to) {
            ...
            if (!this.top) {
                to = Float2ReferenceRBTreeMap.this.compare(to, this.f1907to) < 0 ? to : this.f1907to;
            }
            if (!this.bottom) {
                from = Float2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1907to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.top || Float2ReferenceRBTreeMap.this.compare(e.key, this.f1907to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                ...
                e = Float2ReferenceRBTreeMap.this.locateKey(this.f1907to);
                if (Float2ReferenceRBTreeMap.this.compare(e.key, this.f1907to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Float2ReferenceRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends Float2ReferenceRBTreeMap<V>.TreeIterator {
            SubmapIterator() {
                super();
            ...
            SubmapIterator(Submap submap, float k) {
                ...
                if (submap.bottom || Float2ReferenceRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Float2ReferenceRBTreeMap float2ReferenceRBTreeMap = Float2ReferenceRBTreeMap.this;
                        Entry<V> lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (float2ReferenceRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Float2ReferenceRBTreeMap.this.compare(this.next.key, Submap.this.f1907to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceRBTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends Float2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Float2ReferenceMap.Entry<V>> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceRBTreeMap$Submap$SubmapKeyIterator.class */
        public final class SubmapKeyIterator extends Float2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements FloatListIterator {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ReferenceRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ReferenceRBTreeMap$Submap$SubmapValueIterator.class */
        public final class SubmapValueIterator extends Float2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<V> {
    ...
    public Float2ReferenceRBTreeMap<V> clone() {
        try {
            Float2ReferenceRBTreeMap<V> c = (Float2ReferenceRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        int n = this.count;
        Float2ReferenceRBTreeMap<V>.EntryIterator i = new EntryIterator();
