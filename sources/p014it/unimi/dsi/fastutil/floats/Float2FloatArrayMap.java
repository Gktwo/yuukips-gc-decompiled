...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatArrayMap.class */
public class Float2FloatArrayMap extends AbstractFloat2FloatMap implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Float2FloatArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Float2FloatArrayMap(Float2FloatMap m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Float2FloatMap.Entry> it = m.float2FloatEntrySet().iterator();
        while (it.hasNext()) {
            Float2FloatMap.Entry e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Float2FloatMap.Entry> implements Float2FloatMap.FastEntrySet {
            ...
            return new ObjectIterator<Float2FloatMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2FloatArrayMap.EntrySet.1
                ...
                public void forEachRemaining(Consumer<? super Float2FloatMap.Entry> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractFloat2FloatMap.BasicEntry(f, fArr2[i2]));
                    }
                }
            };
        }
        ...
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Float2FloatMap.Entry> implements ObjectSpliterator<Float2FloatMap.Entry> {
            ...
            public final Float2FloatMap.Entry get(int location) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatArrayMap$KeySet.class */
    public final class KeySet extends AbstractFloatSet {
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatArrayMap$KeySet$KeySetSpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractFloatCollection {
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2FloatArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2FloatArrayMap$ValuesCollection$ValuesSpliterator.class */
    ...
    public Float2FloatArrayMap clone() {
        try {
            Float2FloatArrayMap c = (Float2FloatArrayMap) clone();
