...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteAVLTreeMap.class */
public class Float2ByteAVLTreeMap extends AbstractFloat2ByteSortedMap implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Float2ByteAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap.Entry add(float r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap.add(float):it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.floats.Float2ByteFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public byte remove(float r5) {
        /*
        // Method dump skipped, instructions count: 1494
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap.remove(float):byte");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteAVLTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(float k) {
            Entry locateKey = Float2ByteAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteAVLTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap.1
                final Comparator<? super Float2ByteMap.Entry> comparator;

                {
                    this.comparator = Float2ByteAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Float) && e.getValue() != null && (e.getValue() instanceof Byte)) {
                        return e.equals(Float2ByteAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Float) || !(e.getValue() instanceof Byte) || (f = Float2ByteAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue())) == null || f.getByteValue() != ((Byte) e.getValue()).byteValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteAVLTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteAVLTreeMap$ValueIterator.class */
    ...
    public ByteCollection values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteAVLTreeMap$Submap.class */
    public final class Submap extends AbstractFloat2ByteSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m858in(float k) {
            return (this.bottom || Float2ByteAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2ByteAVLTreeMap.this.compare(k, this.f1776to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.floats.Float2ByteMap, p014it.unimi.dsi.fastutil.floats.Float2ByteSortedMap
        public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2ByteMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Float) && e.getValue() != null && (e.getValue() instanceof Byte) && (f = Float2ByteAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue())) != null && Submap.this.m858in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        if (f != null && Submap.this.m858in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractFloat2ByteSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ByteCollection values() {
            if (this.values == null) {
                this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.bytes.AbstractByteCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.bytes.ByteCollection, p014it.unimi.dsi.fastutil.bytes.ByteIterable, p014it.unimi.dsi.fastutil.bytes.ByteSet, java.util.Set
                    public ByteIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ByteMap, p014it.unimi.dsi.fastutil.floats.Float2ByteFunction, p014it.unimi.dsi.fastutil.floats.Float2ByteMap
        public boolean containsKey(float k) {
            return m858in(k) && Float2ByteAVLTreeMap.this.containsKey(k);
        }
        ...
        public byte get(float k) {
            Entry e;
            return (!m858in(k) || (e = Float2ByteAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public byte put(float k, byte v) {
            ...
            if (!m858in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1776to)) + ")");
            }
            return Float2ByteAVLTreeMap.this.modified ? this.defRetValue : Float2ByteAVLTreeMap.this.put(k, v);
        }
        ...
        public byte remove(float k) {
            ...
            return Float2ByteAVLTreeMap.this.modified ? Float2ByteAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ByteSortedMap
        public Float2ByteSortedMap headMap(float to) {
            if (!this.top && Float2ByteAVLTreeMap.this.compare(to, this.f1776to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ByteSortedMap
        public Float2ByteSortedMap tailMap(float from) {
            if (!this.bottom && Float2ByteAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1776to, this.top);
        }
        ...
        public Float2ByteSortedMap subMap(float from, float to) {
            ...
            if (!this.top) {
                to = Float2ByteAVLTreeMap.this.compare(to, this.f1776to) < 0 ? to : this.f1776to;
            }
            if (!this.bottom) {
                from = Float2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1776to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Float2ByteAVLTreeMap.this.compare(e.key, this.f1776to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Float2ByteAVLTreeMap.this.locateKey(this.f1776to);
                if (Float2ByteAVLTreeMap.this.compare(e.key, this.f1776to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Float2ByteAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, float k) {
                ...
                if (submap.bottom || Float2ByteAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Float2ByteAVLTreeMap float2ByteAVLTreeMap = Float2ByteAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (float2ByteAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Float2ByteAVLTreeMap.this.compare(this.next.key, Submap.this.f1776to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteAVLTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ByteAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ByteAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Float2ByteAVLTreeMap clone() {
        try {
            Float2ByteAVLTreeMap c = (Float2ByteAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
