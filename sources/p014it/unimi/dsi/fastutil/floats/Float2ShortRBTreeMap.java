...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortRBTreeMap.class */
public class Float2ShortRBTreeMap extends AbstractFloat2ShortSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap.Entry add(float r9) {
        /*
        // Method dump skipped, instructions count: 935
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap.add(float):it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.floats.Float2ShortFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public short remove(float r7) {
        /*
        // Method dump skipped, instructions count: 1895
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap.remove(float):short");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(float k) {
            Entry locateKey = Float2ShortRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap.1
                final Comparator<? super Float2ShortMap.Entry> comparator;

                {
                    this.comparator = Float2ShortRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Float) && e.getValue() != null && (e.getValue() instanceof Short)) {
                        return e.equals(Float2ShortRBTreeMap.this.findKey(((Float) e.getKey()).floatValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Float) || e.getValue() == null || !(e.getValue() instanceof Short) || (f = Float2ShortRBTreeMap.this.findKey(((Float) e.getKey()).floatValue())) == null || f.getShortValue() != ((Short) e.getValue()).shortValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortRBTreeMap$ValueIterator.class */
    ...
    public ShortCollection values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortRBTreeMap$Submap.class */
    public final class Submap extends AbstractFloat2ShortSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m841in(float k) {
            return (this.bottom || Float2ShortRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2ShortRBTreeMap.this.compare(k, this.f1919to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.floats.Float2ShortMap, p014it.unimi.dsi.fastutil.floats.Float2ShortSortedMap
        public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Float2ShortMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Float) && e.getValue() != null && (e.getValue() instanceof Short) && (f = Float2ShortRBTreeMap.this.findKey(((Float) e.getKey()).floatValue())) != null && Submap.this.m841in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        if (f != null && Submap.this.m841in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractFloat2ShortSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ShortCollection values() {
            if (this.values == null) {
                this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShortCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.shorts.ShortCollection, p014it.unimi.dsi.fastutil.shorts.ShortIterable
                    public ShortIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2ShortMap, p014it.unimi.dsi.fastutil.floats.Float2ShortFunction, p014it.unimi.dsi.fastutil.floats.Float2ShortMap
        public boolean containsKey(float k) {
            return m841in(k) && Float2ShortRBTreeMap.this.containsKey(k);
        }
        ...
        public short get(float k) {
            Entry e;
            return (!m841in(k) || (e = Float2ShortRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public short put(float k, short v) {
            ...
            if (!m841in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1919to)) + ")");
            }
            return Float2ShortRBTreeMap.this.modified ? this.defRetValue : Float2ShortRBTreeMap.this.put(k, v);
        }
        ...
        public short remove(float k) {
            ...
            return Float2ShortRBTreeMap.this.modified ? Float2ShortRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ShortSortedMap
        public Float2ShortSortedMap headMap(float to) {
            if (!this.top && Float2ShortRBTreeMap.this.compare(to, this.f1919to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2ShortSortedMap
        public Float2ShortSortedMap tailMap(float from) {
            if (!this.bottom && Float2ShortRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1919to, this.top);
        }
        ...
        public Float2ShortSortedMap subMap(float from, float to) {
            ...
            if (!this.top) {
                to = Float2ShortRBTreeMap.this.compare(to, this.f1919to) < 0 ? to : this.f1919to;
            }
            if (!this.bottom) {
                from = Float2ShortRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1919to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Float2ShortRBTreeMap.this.compare(e.key, this.f1919to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Float2ShortRBTreeMap.this.locateKey(this.f1919to);
                if (Float2ShortRBTreeMap.this.compare(e.key, this.f1919to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Float2ShortRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, float k) {
                ...
                if (submap.bottom || Float2ShortRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Float2ShortRBTreeMap float2ShortRBTreeMap = Float2ShortRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (float2ShortRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Float2ShortRBTreeMap.this.compare(this.next.key, Submap.this.f1919to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ShortRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ShortRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Float2ShortRBTreeMap clone() {
        try {
            Float2ShortRBTreeMap c = (Float2ShortRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
