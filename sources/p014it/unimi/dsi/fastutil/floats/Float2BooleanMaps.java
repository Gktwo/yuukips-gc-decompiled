...
import p014it.unimi.dsi.fastutil.floats.Float2BooleanFunctions;
...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanMaps */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanMaps.class */
public final class Float2BooleanMaps {
    ...
    public static ObjectIterable<Float2BooleanMap.Entry> fastIterable(Float2BooleanMap map) {
        ...
        return entries instanceof Float2BooleanMap.FastEntrySet ? new ObjectIterable<Float2BooleanMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2BooleanMaps.1
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanMaps$EmptyMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanMaps$EmptyMap.class */
    public static class EmptyMap extends Float2BooleanFunctions.EmptyFunction implements Float2BooleanMap, Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2BooleanFunctions.EmptyFunction, p014it.unimi.dsi.fastutil.floats.Float2BooleanFunction
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2BooleanFunctions.EmptyFunction, java.lang.Object
        public Object clone() {
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanMaps$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanMaps$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanMaps$SynchronizedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanMaps$SynchronizedMap.class */
    public static class SynchronizedMap extends Float2BooleanFunctions.SynchronizedFunction implements Float2BooleanMap, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedMap(Float2BooleanMap m, Object sync) {
            super(m, sync);
            this.map = m;
        }

        /* access modifiers changed from: protected */
        public SynchronizedMap(Float2BooleanMap m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2BooleanMap, p014it.unimi.dsi.fastutil.floats.Float2BooleanSortedMap
        public ObjectSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
            ObjectSet<Float2BooleanMap.Entry> objectSet;
            synchronized (this.sync) {
                if (this.entries == null) {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2BooleanFunctions.SynchronizedFunction, java.lang.Object
        public int hashCode() {
            int hashCode;
            synchronized (this.sync) {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2BooleanFunctions.SynchronizedFunction, p014it.unimi.dsi.fastutil.floats.Float2BooleanFunction
        public boolean getOrDefault(float key, boolean defaultValue) {
            boolean orDefault;
            synchronized (this.sync) {
        ...
        public Boolean replace(Float key, Boolean value) {
            Boolean replace;
            synchronized (this.sync) {
                replace = this.map.replace((Float2BooleanMap) key, (Float) value);
            }
            return replace;
        }
        ...
        public boolean replace(Float key, Boolean oldValue, Boolean newValue) {
            boolean replace;
            synchronized (this.sync) {
                replace = this.map.replace((Float2BooleanMap) key, oldValue, newValue);
            }
            return replace;
        }
        ...
        public Boolean putIfAbsent(Float key, Boolean value) {
            Boolean putIfAbsent;
            synchronized (this.sync) {
                putIfAbsent = this.map.putIfAbsent((Float2BooleanMap) key, (Float) value);
            }
            return putIfAbsent;
        }
        ...
        public Boolean computeIfAbsent(Float key, Function<? super Float, ? extends Boolean> mappingFunction) {
            Boolean computeIfAbsent;
            synchronized (this.sync) {
                computeIfAbsent = this.map.computeIfAbsent((Float2BooleanMap) key, (Function<? super Float2BooleanMap, ? extends Boolean>) mappingFunction);
            }
            return computeIfAbsent;
        }
        ...
        public Boolean computeIfPresent(Float key, BiFunction<? super Float, ? super Boolean, ? extends Boolean> remappingFunction) {
            Boolean computeIfPresent;
            synchronized (this.sync) {
                computeIfPresent = this.map.computeIfPresent((Float2BooleanMap) key, (BiFunction<? super Float2BooleanMap, ? super Boolean, ? extends Boolean>) remappingFunction);
            }
            return computeIfPresent;
        }
        ...
        public Boolean compute(Float key, BiFunction<? super Float, ? super Boolean, ? extends Boolean> remappingFunction) {
            Boolean compute;
            synchronized (this.sync) {
                compute = this.map.compute((Float2BooleanMap) key, (BiFunction<? super Float2BooleanMap, ? super Boolean, ? extends Boolean>) remappingFunction);
            }
            return compute;
        }
        ...
        public Boolean merge(Float key, Boolean value, BiFunction<? super Boolean, ? super Boolean, ? extends Boolean> remappingFunction) {
            Boolean merge;
            synchronized (this.sync) {
                merge = this.map.merge((Float2BooleanMap) key, (Float) value, (BiFunction<? super Float, ? super Float, ? extends Float>) remappingFunction);
            }
            return merge;
        }
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanMaps$UnmodifiableMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanMaps$UnmodifiableMap.class */
    public static class UnmodifiableMap extends Float2BooleanFunctions.UnmodifiableFunction implements Float2BooleanMap, Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableMap(Float2BooleanMap m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2BooleanFunctions.UnmodifiableFunction, java.lang.Object
        public int hashCode() {
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2BooleanFunctions.UnmodifiableFunction, p014it.unimi.dsi.fastutil.floats.Float2BooleanFunction
        public boolean getOrDefault(float key, boolean defaultValue) {
