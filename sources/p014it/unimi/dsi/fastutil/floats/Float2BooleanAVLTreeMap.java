...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanAVLTreeMap.class */
public class Float2BooleanAVLTreeMap extends AbstractFloat2BooleanSortedMap implements Serializable, Cloneable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap.Entry add(float r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap.add(float):it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap$Entry");
    }
    ...
    public boolean remove(float r5) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap.remove(float):boolean");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanAVLTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(float k) {
            Entry locateKey = Float2BooleanAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanAVLTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Float2BooleanMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap.1
                ...
                {
                    this.comparator = Float2BooleanAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Float) && e.getValue() != null && (e.getValue() instanceof Boolean)) {
                        return e.equals(Float2BooleanAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Float) || !(e.getValue() instanceof Boolean) || (f = Float2BooleanAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue())) == null || f.getBooleanValue() != ((Boolean) e.getValue()).booleanValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanAVLTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanAVLTreeMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanAVLTreeMap$Submap.class */
    public final class Submap extends AbstractFloat2BooleanSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m860in(float k) {
            return (this.bottom || Float2BooleanAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2BooleanAVLTreeMap.this.compare(k, this.f1764to) < 0);
        }
            ...
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Float2BooleanMap.Entry>() { // from class: it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap.Submap.1
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Float) && e.getValue() != null && (e.getValue() instanceof Boolean) && (f = Float2BooleanAVLTreeMap.this.findKey(((Float) e.getKey()).floatValue())) != null && Submap.this.m860in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        if (f != null && Submap.this.m860in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractFloat2BooleanSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.AbstractFloat2BooleanMap, p014it.unimi.dsi.fastutil.floats.Float2BooleanFunction, p014it.unimi.dsi.fastutil.floats.Float2BooleanMap
        public boolean containsKey(float k) {
            return m860in(k) && Float2BooleanAVLTreeMap.this.containsKey(k);
        }
        ...
        public boolean get(float k) {
            Entry e;
            return (!m860in(k) || (e = Float2BooleanAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public boolean put(float k, boolean v) {
            ...
            if (!m860in(k)) {
                throw new IllegalArgumentException("Key (" + k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.f1764to)) + ")");
            }
            return Float2BooleanAVLTreeMap.this.modified ? this.defRetValue : Float2BooleanAVLTreeMap.this.put(k, v);
        }
        ...
        public boolean remove(float k) {
            ...
            return Float2BooleanAVLTreeMap.this.modified ? Float2BooleanAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2BooleanSortedMap
        public Float2BooleanSortedMap headMap(float to) {
            if (!this.top && Float2BooleanAVLTreeMap.this.compare(to, this.f1764to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2BooleanSortedMap
        public Float2BooleanSortedMap tailMap(float from) {
            if (!this.bottom && Float2BooleanAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f1764to, this.top);
        }
        ...
        public Float2BooleanSortedMap subMap(float from, float to) {
            ...
            if (!this.top) {
                to = Float2BooleanAVLTreeMap.this.compare(to, this.f1764to) < 0 ? to : this.f1764to;
            }
            if (!this.bottom) {
                from = Float2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f1764to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Float2BooleanAVLTreeMap.this.compare(e.key, this.f1764to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Float2BooleanAVLTreeMap.this.locateKey(this.f1764to);
                if (Float2BooleanAVLTreeMap.this.compare(e.key, this.f1764to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Float2BooleanAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, float k) {
                ...
                if (submap.bottom || Float2BooleanAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Float2BooleanAVLTreeMap float2BooleanAVLTreeMap = Float2BooleanAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (float2BooleanAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Float2BooleanAVLTreeMap.this.compare(this.next.key, Submap.this.f1764to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanAVLTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2BooleanAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2BooleanAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Float2BooleanAVLTreeMap clone() {
        try {
            Float2BooleanAVLTreeMap c = (Float2BooleanAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
