...
public class Float2BooleanAVLTreeMap extends AbstractFloat2BooleanSortedMap implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractFloat2BooleanSortedMap implements Serializable {
        ...
        final boolean m860in(float k) {
            return (this.bottom || Float2BooleanAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Float2BooleanAVLTreeMap.this.compare(k, this.f1800to) < 0);
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.floats.Float2BooleanSortedMap
        public Float2BooleanSortedMap headMap(float to) {
            if (!this.top && Float2BooleanAVLTreeMap.this.compare(to, this.f1800to) >= 0) {
                return this;
            }
        ...
        public Float2BooleanSortedMap subMap(float from, float to) {
            ...
            if (!this.top) {
                to = Float2BooleanAVLTreeMap.this.compare(to, this.f1800to) < 0 ? to : this.f1800to;
            }
            if (!this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Float2BooleanAVLTreeMap.this.compare(e.key, this.f1800to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Float2BooleanAVLTreeMap.this.locateKey(this.f1800to);
                if (Float2BooleanAVLTreeMap.this.compare(e.key, this.f1800to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Float2BooleanAVLTreeMap.this.compare(this.next.key, Submap.this.f1800to) >= 0) {
                    this.next = null;
                }
            }
        }
