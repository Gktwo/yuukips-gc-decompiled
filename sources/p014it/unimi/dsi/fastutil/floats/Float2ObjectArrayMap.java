...
/* renamed from: it.unimi.dsi.fastutil.floats.Float2ObjectArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ObjectArrayMap.class */
public class Float2ObjectArrayMap<V> extends AbstractFloat2ObjectMap<V> implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Float2ObjectArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Float2ObjectArrayMap(Float2ObjectMap<V> m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Float2ObjectMap.Entry<V>> it = m.float2ObjectEntrySet().iterator();
        while (it.hasNext()) {
            Float2ObjectMap.Entry<V> e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ObjectArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ObjectArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Float2ObjectMap.Entry<V>> implements Float2ObjectMap.FastEntrySet<V> {
        private EntrySet() {
        }

        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
        public ObjectIterator<Float2ObjectMap.Entry<V>> iterator() {
            return new ObjectIterator<Float2ObjectMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.floats.Float2ObjectArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Float2ObjectMap.Entry<V> next() {
                    ...
                    float[] fArr = Float2ObjectArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    float f = fArr[i];
                    Object[] objArr = Float2ObjectArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractFloat2ObjectMap.BasicEntry(f, objArr[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Float2ObjectArrayMap.access$010(Float2ObjectArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Float2ObjectMap.Entry<V>> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractFloat2ObjectMap.BasicEntry(f, objArr[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Float2ObjectMap.Entry<V>> fastIterator() {
            return new ObjectIterator<Float2ObjectMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.floats.Float2ObjectArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Float2ObjectMap.Entry<V> next() {
                    ...
                    AbstractFloat2ObjectMap.BasicEntry<V> basicEntry = this.entry;
                    float[] fArr = Float2ObjectArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = fArr[i];
                    AbstractFloat2ObjectMap.BasicEntry<V> basicEntry2 = this.entry;
                    Object[] objArr = Float2ObjectArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ObjectArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ObjectArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Float2ObjectMap.Entry<V>> implements ObjectSpliterator<Float2ObjectMap.Entry<V>> {
            ...
            public final Float2ObjectMap.Entry<V> get(int location) {
                return new AbstractFloat2ObjectMap.BasicEntry(Float2ObjectArrayMap.this.key[location], Float2ObjectArrayMap.this.value[location]);
            }

            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Float2ObjectArrayMap<V>.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
        ...
        public void forEach(Consumer<? super Float2ObjectMap.Entry<V>> action) {
            int max = Float2ObjectArrayMap.this.size;
            for (int i = 0; i < max; i++) {
                action.accept(new AbstractFloat2ObjectMap.BasicEntry(Float2ObjectArrayMap.this.key[i], Float2ObjectArrayMap.this.value[i]));
            }
        }
        ...
        public boolean remove(Object o) {
            ...
            if (oldPos == -1 || !Objects.equals(value, Float2ObjectArrayMap.this.value[oldPos])) {
                return false;
            }
            ...
            Float2ObjectArrayMap.access$010(Float2ObjectArrayMap.this);
            Float2ObjectArrayMap.this.value[Float2ObjectArrayMap.this.size] = null;
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ObjectArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ObjectArrayMap$KeySet.class */
    public final class KeySet extends AbstractFloatSet {
        ...
        public FloatIterator iterator() {
            return new FloatIterator() { // from class: it.unimi.dsi.fastutil.floats.Float2ObjectArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ObjectArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ObjectArrayMap$KeySet$KeySetSpliterator.class */
        public final class KeySetSpliterator extends FloatSpliterators.EarlyBindingSizeIndexBasedSpliterator implements FloatSpliterator {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.floats.FloatSpliterators.AbstractIndexBasedSpliterator
            public final Float2ObjectArrayMap<V>.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.floats.Float2ObjectArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ObjectArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractObjectCollection<V> {
        ...
        public ObjectIterator<V> iterator() {
            return new ObjectIterator<V>() { // from class: it.unimi.dsi.fastutil.floats.Float2ObjectArrayMap.ValuesCollection.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.floats.Float2ObjectArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/floats/Float2ObjectArrayMap$ValuesCollection$ValuesSpliterator.class */
        public final class ValuesSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<V> implements ObjectSpliterator<V> {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Float2ObjectArrayMap<V>.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
    ...
    public Float2ObjectArrayMap<V> clone() {
        try {
            Float2ObjectArrayMap<V> c = (Float2ObjectArrayMap) clone();
