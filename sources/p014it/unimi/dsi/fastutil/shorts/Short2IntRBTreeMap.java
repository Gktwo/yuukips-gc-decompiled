...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntRBTreeMap.class */
public class Short2IntRBTreeMap extends AbstractShort2IntSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap.Entry add(short r9) {
        /*
        // Method dump skipped, instructions count: 935
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap.add(short):it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap$Entry");
    }
    ...
    public int remove(short r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap.remove(short):int");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(short k) {
            Entry locateKey = Short2IntRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2IntMap.Entry>() { // from class: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap.1
                final Comparator<? super Short2IntMap.Entry> comparator;

                {
                    this.comparator = Short2IntRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Short) && e.getValue() != null && (e.getValue() instanceof Integer)) {
                        return e.equals(Short2IntRBTreeMap.this.findKey(((Short) e.getKey()).shortValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Short) || e.getValue() == null || !(e.getValue() instanceof Integer) || (f = Short2IntRBTreeMap.this.findKey(((Short) e.getKey()).shortValue())) == null || f.getIntValue() != ((Integer) e.getValue()).intValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntRBTreeMap$ValueIterator.class */
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntRBTreeMap$Submap.class */
    public final class Submap extends AbstractShort2IntSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m455in(short k) {
            return (this.bottom || Short2IntRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2IntRBTreeMap.this.compare(k, this.f2964to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.shorts.Short2IntMap, p014it.unimi.dsi.fastutil.shorts.Short2IntSortedMap
        public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2IntMap.Entry>() { // from class: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Short) && e.getValue() != null && (e.getValue() instanceof Integer) && (f = Short2IntRBTreeMap.this.findKey(((Short) e.getKey()).shortValue())) != null && Submap.this.m455in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Short2IntRBTreeMap.this.findKey(((Short) e.getKey()).shortValue());
                        if (f != null && Submap.this.m455in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractShort2IntSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public IntCollection values() {
            if (this.values == null) {
                this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.ints.AbstractIntCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.ints.IntCollection, p014it.unimi.dsi.fastutil.ints.IntIterable
                    public IntIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShort2IntMap, p014it.unimi.dsi.fastutil.shorts.Short2IntFunction, p014it.unimi.dsi.fastutil.shorts.Short2IntMap
        public boolean containsKey(short k) {
            return m455in(k) && Short2IntRBTreeMap.this.containsKey(k);
        }
        ...
        public int get(short k) {
            Entry e;
            return (!m455in(k) || (e = Short2IntRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public int put(short k, int v) {
            ...
            return Short2IntRBTreeMap.this.modified ? this.defRetValue : Short2IntRBTreeMap.this.put(k, v);
        }
        ...
        public int remove(short k) {
            ...
            return Short2IntRBTreeMap.this.modified ? Short2IntRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2IntSortedMap
        public Short2IntSortedMap headMap(short to) {
            if (!this.top && Short2IntRBTreeMap.this.compare(to, this.f2964to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2IntSortedMap
        public Short2IntSortedMap tailMap(short from) {
            if (!this.bottom && Short2IntRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
        ...
        public Short2IntSortedMap subMap(short from, short to) {
            ...
            if (!this.top) {
                to = Short2IntRBTreeMap.this.compare(to, this.f2964to) < 0 ? to : this.f2964to;
            }
            if (!this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Short2IntRBTreeMap.this.compare(e.key, this.f2964to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Short2IntRBTreeMap.this.locateKey(this.f2964to);
                if (Short2IntRBTreeMap.this.compare(e.key, this.f2964to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Short2IntRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, short k) {
                ...
                if (submap.bottom || Short2IntRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Short2IntRBTreeMap short2IntRBTreeMap = Short2IntRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (short2IntRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Short2IntRBTreeMap.this.compare(this.next.key, Submap.this.f2964to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Short2IntRBTreeMap clone() {
        try {
            Short2IntRBTreeMap c = (Short2IntRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
