...
public class Short2ShortOpenCustomHashMap extends AbstractShort2ShortMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f3004n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f3005f;
    ...
    public Short2ShortOpenCustomHashMap(int expected, float f, ShortHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f3004n = arraySize;
            this.minN = arraySize;
            this.mask = this.f3004n - 1;
            this.maxFill = HashCommon.maxFill(this.f3004n, f);
            this.key = new short[this.f3004n + 1];
            this.value = new short[this.f3004n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f3005f);
        if (needed > this.f3004n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f3005f)))));
        if (needed > this.f3004n) {
            rehash(needed);
        }
    }
    ...
    public short removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f3004n > this.minN && this.size < this.maxFill / 4 && this.f3004n > 16) {
            rehash(this.f3004n / 2);
        }
        return oldValue;
    }
    ...
    public short removeNullEntry() {
        ...
        short oldValue = this.value[this.f3004n];
        this.size--;
        if (this.f3004n > this.minN && this.size < this.maxFill / 4 && this.f3004n > 16) {
            rehash(this.f3004n / 2);
        }
    ...
    private int find(short k) {
        ...
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.f3004n : -(this.f3004n + 1);
        }
        short[] key = this.key;
    ...
    private void insert(int pos, short k, short v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f3005f));
        }
    }
    ...
    public short addTo(short k, short incr) {
        ...
        if (!this.strategy.equals(k, 0)) {
            ...
            return addToValue(this.f3004n, incr);
        } else {
            pos = this.f3004n;
            this.containsNullKey = true;
        }
    ...
    public short get(short k) {
        short curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f3004n] : this.defRetValue;
        }
        short[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(short v) {
        ...
        short[] key = this.key;
        if (this.containsNullKey && value[this.f3004n] == v) {
            return true;
        }
        int i = this.f3004n;
        while (true) {
    ...
    public short getOrDefault(short k, short defaultValue) {
        short curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f3004n] : defaultValue;
        }
        short[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(short k, short v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f3004n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Short2ShortOpenCustomHashMap.this.f3004n;
            this.last = -1;
            this.f3006c = Short2ShortOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Short2ShortOpenCustomHashMap.this.f3004n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Short2ShortOpenCustomHashMap.this.f3004n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Short2ShortOpenCustomHashMap.this.f3004n;
            this.f3007c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f3007c++;
                acceptOnIndex(action, Short2ShortOpenCustomHashMap.this.f3004n);
                return true;
            }
            short[] key = Short2ShortOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Short2ShortOpenCustomHashMap.this.size - this.f3007c);
            }
            return Math.min((long) (Short2ShortOpenCustomHashMap.this.size - this.f3007c), ((long) ((((double) Short2ShortOpenCustomHashMap.this.realSize()) / ((double) Short2ShortOpenCustomHashMap.this.f3004n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Short2ShortMap.Entry> implements Short2ShortMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Short2ShortOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Short2ShortOpenCustomHashMap.this.containsNullKey && Short2ShortOpenCustomHashMap.this.value[Short2ShortOpenCustomHashMap.this.f3004n] == v;
            }
            short[] key = Short2ShortOpenCustomHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Short2ShortOpenCustomHashMap.this.containsNullKey || Short2ShortOpenCustomHashMap.this.value[Short2ShortOpenCustomHashMap.this.f3004n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Short2ShortMap.Entry> consumer) {
            if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2ShortMap.BasicEntry(Short2ShortOpenCustomHashMap.this.key[Short2ShortOpenCustomHashMap.this.f3004n], Short2ShortOpenCustomHashMap.this.value[Short2ShortOpenCustomHashMap.this.f3004n]));
            }
            int pos = Short2ShortOpenCustomHashMap.this.f3004n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Short2ShortMap.Entry> consumer) {
            ...
            if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
                entry.key = Short2ShortOpenCustomHashMap.this.key[Short2ShortOpenCustomHashMap.this.f3004n];
                entry.value = Short2ShortOpenCustomHashMap.this.value[Short2ShortOpenCustomHashMap.this.f3004n];
    ...
    public final class KeySet extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Short2ShortOpenCustomHashMap.this.key[Short2ShortOpenCustomHashMap.this.f3004n]);
            }
            int pos = Short2ShortOpenCustomHashMap.this.f3004n;
            while (true) {
                pos--;
    ...
    public Collection<Short> values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.shorts.Short2ShortOpenCustomHashMap.1
                ...
                public void forEach(ShortConsumer consumer) {
                    if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Short2ShortOpenCustomHashMap.this.value[Short2ShortOpenCustomHashMap.this.f3004n]);
                    }
                    int pos = Short2ShortOpenCustomHashMap.this.f3004n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f3005f)));
        if (l >= this.f3004n || this.size > HashCommon.maxFill(l, this.f3005f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f3004n];
                this.f3004n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f3004n, this.f3005f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f3004n = HashCommon.arraySize(this.size, this.f3005f);
        this.maxFill = HashCommon.maxFill(this.f3004n, this.f3005f);
        this.mask = this.f3004n - 1;
        short[] key = new short[this.f3004n + 1];
        this.key = key;
        short[] value = new short[this.f3004n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
