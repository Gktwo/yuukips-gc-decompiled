...
public class Short2FloatRBTreeMap extends AbstractShort2FloatSortedMap implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractShort2FloatSortedMap implements Serializable {
        ...
        final boolean m457in(short k) {
            return (this.bottom || Short2FloatRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2FloatRBTreeMap.this.compare(k, this.f2952to) < 0);
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2FloatSortedMap
        public Short2FloatSortedMap headMap(short to) {
            if (!this.top && Short2FloatRBTreeMap.this.compare(to, this.f2952to) >= 0) {
                return this;
            }
        ...
        public Short2FloatSortedMap subMap(short from, short to) {
            ...
            if (!this.top) {
                to = Short2FloatRBTreeMap.this.compare(to, this.f2952to) < 0 ? to : this.f2952to;
            }
            if (!this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Short2FloatRBTreeMap.this.compare(e.key, this.f2952to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Short2FloatRBTreeMap.this.locateKey(this.f2952to);
                if (Short2FloatRBTreeMap.this.compare(e.key, this.f2952to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Short2FloatRBTreeMap.this.compare(this.next.key, Submap.this.f2952to) >= 0) {
                    this.next = null;
                }
            }
        }
