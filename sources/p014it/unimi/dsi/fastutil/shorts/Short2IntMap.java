...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntMap.class */
public interface Short2IntMap extends Short2IntFunction, Map<Short, Integer> {
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntMap$FastEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntMap$FastEntrySet.class */
    ...
    default void forEach(BiConsumer<? super Short, ? super Integer> consumer) {
        ObjectSet<Entry> entrySet = short2IntEntrySet();
        Consumer<Entry> wrappingConsumer = entry -> {
            consumer.accept(Short.valueOf(entry.getShortKey()), Integer.valueOf(entry.getIntValue()));
        };
    ...
    default int computeIfPresent(short key, BiFunction<? super Short, ? super Integer, ? extends Integer> remappingFunction) {
        ...
        Integer newValue = (Integer) remappingFunction.apply(Short.valueOf(key), Integer.valueOf(oldValue));
        if (newValue == null) {
            remove(key);
            return drv;
        }
    ...
    default int compute(short key, BiFunction<? super Short, ? super Integer, ? extends Integer> remappingFunction) {
        ...
        Integer newValue = (Integer) remappingFunction.apply(Short.valueOf(key), contained ? Integer.valueOf(oldValue) : null);
        if (newValue == null) {
            if (contained) {
                remove(key);
            }
    ...
    default int mergeInt(short key, int value, p014it.unimi.dsi.fastutil.ints.IntBinaryOperator remappingFunction) {
        return mergeInt(key, value, (IntBinaryOperator) remappingFunction);
    }

    @Deprecated
    default Integer putIfAbsent(Short key, Integer value) {
        return putIfAbsent((Short2IntMap) key, (Short) value);
    }
    ...
    default boolean replace(Short key, Integer oldValue, Integer newValue) {
        return replace((Short2IntMap) key, oldValue, newValue);
    }

    @Deprecated
    default Integer replace(Short key, Integer value) {
        return replace((Short2IntMap) key, (Short) value);
    }

    @Deprecated
    default Integer computeIfAbsent(Short key, Function<? super Short, ? extends Integer> mappingFunction) {
        return computeIfAbsent((Short2IntMap) key, (Function<? super Short2IntMap, ? extends Integer>) mappingFunction);
    }

    @Deprecated
    default Integer computeIfPresent(Short key, BiFunction<? super Short, ? super Integer, ? extends Integer> remappingFunction) {
        return computeIfPresent((Short2IntMap) key, (BiFunction<? super Short2IntMap, ? super Integer, ? extends Integer>) remappingFunction);
    }

    @Deprecated
    default Integer compute(Short key, BiFunction<? super Short, ? super Integer, ? extends Integer> remappingFunction) {
        return compute((Short2IntMap) key, (BiFunction<? super Short2IntMap, ? super Integer, ? extends Integer>) remappingFunction);
    }

    @Deprecated
    default Integer merge(Short key, Integer value, BiFunction<? super Integer, ? super Integer, ? extends Integer> remappingFunction) {
        return merge((Short2IntMap) key, (Short) value, (BiFunction<? super Short, ? super Short, ? extends Short>) remappingFunction);
    }

    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntMap$Entry.class */
