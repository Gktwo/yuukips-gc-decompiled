...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap.class */
public class Short2DoubleOpenCustomHashMap extends AbstractShort2DoubleMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f2932n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f2933f;
    protected transient Short2DoubleMap.FastEntrySet entries;
    protected transient ShortSet keys;
    protected transient DoubleCollection values;

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap.computeIfPresent(short, java.util.function.BiFunction<? super java.lang.Short, ? super java.lang.Double, ? extends java.lang.Double>):double, file: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap.class
    ...
    public double computeIfPresent(short r1, java.util.function.BiFunction<? super java.lang.Short, ? super java.lang.Double, ? extends java.lang.Double> r2) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap.computeIfPresent(short, java.util.function.BiFunction):double");
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap.compute(short, java.util.function.BiFunction<? super java.lang.Short, ? super java.lang.Double, ? extends java.lang.Double>):double, file: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap.class
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:204)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:309)
        	at jadx.core.ProcessClass.process(ProcessClass.java:53)
        	at jadx.core.ProcessClass.generateCode(ProcessClass.java:87)
    ...
    public double compute(short r1, java.util.function.BiFunction<? super java.lang.Short, ? super java.lang.Double, ? extends java.lang.Double> r2) {
        ...
        // Can't load method instructions: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap.compute(short, java.util.function.BiFunction<? super java.lang.Short, ? super java.lang.Double, ? extends java.lang.Double>):double, file: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap.class
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap.compute(short, java.util.function.BiFunction):double");
    }

    /*  JADX ERROR: Method load error
        jadx.core.utils.exceptions.DecodeException: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap.merge(short, double, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Double, ? extends java.lang.Double>):double, file: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap.class
        	at jadx.core.dex.nodes.MethodNode.load(MethodNode.java:204)
        	at jadx.core.dex.nodes.ClassNode.load(ClassNode.java:309)
        	at jadx.core.ProcessClass.process(ProcessClass.java:53)
        	at jadx.core.ProcessClass.generateCode(ProcessClass.java:87)
    ...
    public double merge(short r1, double r2, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Double, ? extends java.lang.Double> r4) {
        ...
        // Can't load method instructions: Load method exception: JavaClassParseException: Unknown opcode: 0x5e in method: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap.merge(short, double, java.util.function.BiFunction<? super java.lang.Double, ? super java.lang.Double, ? extends java.lang.Double>):double, file: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap.class
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap.merge(short, double, java.util.function.BiFunction):double");
    }
    ...
    public Short2DoubleOpenCustomHashMap(int expected, float f, ShortHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f2932n = arraySize;
            this.minN = arraySize;
            this.mask = this.f2932n - 1;
            this.maxFill = HashCommon.maxFill(this.f2932n, f);
            this.key = new short[this.f2932n + 1];
            this.value = new double[this.f2932n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f2933f);
        if (needed > this.f2932n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f2933f)))));
        if (needed > this.f2932n) {
            rehash(needed);
        }
    }
    ...
    public double removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f2932n > this.minN && this.size < this.maxFill / 4 && this.f2932n > 16) {
            rehash(this.f2932n / 2);
        }
        return oldValue;
    }
    ...
    public double removeNullEntry() {
        ...
        double oldValue = this.value[this.f2932n];
        this.size--;
        if (this.f2932n > this.minN && this.size < this.maxFill / 4 && this.f2932n > 16) {
            rehash(this.f2932n / 2);
        }
    ...
    private int find(short k) {
        ...
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.f2932n : -(this.f2932n + 1);
        }
        short[] key = this.key;
    ...
    private void insert(int pos, short k, double v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f2933f));
        }
    }
    ...
    public double addTo(short k, double incr) {
        ...
        if (!this.strategy.equals(k, 0)) {
            ...
            return addToValue(this.f2932n, incr);
        } else {
            pos = this.f2932n;
            this.containsNullKey = true;
        }
    ...
    public double get(short k) {
        short curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2932n] : this.defRetValue;
        }
        short[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(double v) {
        ...
        short[] key = this.key;
        if (this.containsNullKey && Double.doubleToLongBits(value[this.f2932n]) == Double.doubleToLongBits(v)) {
            return true;
        }
        int i = this.f2932n;
        while (true) {
    ...
    public double getOrDefault(short k, double defaultValue) {
        short curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2932n] : defaultValue;
        }
        short[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(short k, double v) {
        ...
        } else if (!this.containsNullKey || Double.doubleToLongBits(v) != Double.doubleToLongBits(this.value[this.f2932n])) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Short2DoubleMap.Entry, Map.Entry<Short, Double>, ShortDoublePair {
        ...
        public boolean equals(Object o) {
            ...
            return Short2DoubleOpenCustomHashMap.this.strategy.equals(Short2DoubleOpenCustomHashMap.this.key[this.index], e.getKey().shortValue()) && Double.doubleToLongBits(Short2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits(e.getValue().doubleValue());
        }
        ...
        public String toString() {
            return ((int) Short2DoubleOpenCustomHashMap.this.key[this.index]) + "=>" + Short2DoubleOpenCustomHashMap.this.value[this.index];
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Short2DoubleOpenCustomHashMap.this.f2932n;
            this.last = -1;
            this.f2934c = Short2DoubleOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Short2DoubleOpenCustomHashMap.this.f2932n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Short2DoubleOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Short2DoubleOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Short2DoubleOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Short2DoubleOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Short2DoubleOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Short2DoubleOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Short2DoubleOpenCustomHashMap.this.value[pos] = Short2DoubleOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Short2DoubleOpenCustomHashMap.this.f2932n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Short2DoubleMap.Entry>> implements ObjectIterator<Short2DoubleMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Short2DoubleOpenCustomHashMap.this.f2932n;
            this.f2935c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2935c++;
                acceptOnIndex(action, Short2DoubleOpenCustomHashMap.this.f2932n);
                return true;
            }
            short[] key = Short2DoubleOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Short2DoubleOpenCustomHashMap.this.size - this.f2935c);
            }
            return Math.min((long) (Short2DoubleOpenCustomHashMap.this.size - this.f2935c), ((long) ((((double) Short2DoubleOpenCustomHashMap.this.realSize()) / ((double) Short2DoubleOpenCustomHashMap.this.f2932n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap.this
                short[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Short2DoubleMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Short2DoubleMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Short2DoubleMap.Entry> implements Short2DoubleMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Short2DoubleOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Short2DoubleOpenCustomHashMap.this.containsNullKey && Double.doubleToLongBits(Short2DoubleOpenCustomHashMap.this.value[Short2DoubleOpenCustomHashMap.this.f2932n]) == Double.doubleToLongBits(v);
            }
            short[] key = Short2DoubleOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Short2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Short2DoubleOpenCustomHashMap.this.mask;
            int pos = mix;
            short curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            }
            if (Short2DoubleOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Double.doubleToLongBits(Short2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v);
            }
            do {
                int i = (pos + 1) & Short2DoubleOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (!Short2DoubleOpenCustomHashMap.this.strategy.equals(k, 0)) {
                ...
                if (!Short2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Short2DoubleOpenCustomHashMap.this.strategy.equals(curr2, k) && Double.doubleToLongBits(Short2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
                            Short2DoubleOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Double.doubleToLongBits(Short2DoubleOpenCustomHashMap.this.value[pos]) != Double.doubleToLongBits(v)) {
                    return false;
                } else {
                    Short2DoubleOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Short2DoubleOpenCustomHashMap.this.containsNullKey || Double.doubleToLongBits(Short2DoubleOpenCustomHashMap.this.value[Short2DoubleOpenCustomHashMap.this.f2932n]) != Double.doubleToLongBits(v)) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Short2DoubleMap.Entry> consumer) {
            if (Short2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2DoubleMap.BasicEntry(Short2DoubleOpenCustomHashMap.this.key[Short2DoubleOpenCustomHashMap.this.f2932n], Short2DoubleOpenCustomHashMap.this.value[Short2DoubleOpenCustomHashMap.this.f2932n]));
            }
            int pos = Short2DoubleOpenCustomHashMap.this.f2932n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Short2DoubleMap.Entry> consumer) {
            ...
            if (Short2DoubleOpenCustomHashMap.this.containsNullKey) {
                entry.key = Short2DoubleOpenCustomHashMap.this.key[Short2DoubleOpenCustomHashMap.this.f2932n];
                entry.value = Short2DoubleOpenCustomHashMap.this.value[Short2DoubleOpenCustomHashMap.this.f2932n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            if (Short2DoubleOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Short2DoubleOpenCustomHashMap.this.key[Short2DoubleOpenCustomHashMap.this.f2932n]);
            }
            int pos = Short2DoubleOpenCustomHashMap.this.f2932n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Double> values() {
        if (this.values == null) {
            this.values = new AbstractDoubleCollection() { // from class: it.unimi.dsi.fastutil.shorts.Short2DoubleOpenCustomHashMap.1
                ...
                public void forEach(DoubleConsumer consumer) {
                    if (Short2DoubleOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Short2DoubleOpenCustomHashMap.this.value[Short2DoubleOpenCustomHashMap.this.f2932n]);
                    }
                    int pos = Short2DoubleOpenCustomHashMap.this.f2932n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f2933f)));
        if (l >= this.f2932n || this.size > HashCommon.maxFill(l, this.f2933f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2932n];
                this.f2932n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f2932n, this.f2933f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Short2DoubleOpenCustomHashMap clone() {
        try {
            Short2DoubleOpenCustomHashMap c = (Short2DoubleOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.double2int(this.value[this.f2932n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f2932n = HashCommon.arraySize(this.size, this.f2933f);
        this.maxFill = HashCommon.maxFill(this.f2932n, this.f2933f);
        this.mask = this.f2932n - 1;
        short[] key = new short[this.f2932n + 1];
        this.key = key;
        double[] value = new double[this.f2932n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
