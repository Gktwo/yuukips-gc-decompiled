...
public class Short2IntOpenCustomHashMap extends AbstractShort2IntMap implements Serializable, Cloneable, Hash {
    ...
    public Short2IntOpenCustomHashMap(int expected, float f, ShortHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new int[this.f2956n + 1];
        }
    }
    ...
    public int removeNullEntry() {
        ...
        int oldValue = this.value[this.f2956n];
        this.size--;
        if (this.f2956n > this.minN && this.size < this.maxFill / 4 && this.f2956n > 16) {
            rehash(this.f2956n / 2);
        }
    ...
    public int addTo(short k, int incr) {
        ...
        if (!this.strategy.equals(k, 0)) {
            ...
            return addToValue(this.f2956n, incr);
        } else {
            pos = this.f2956n;
            this.containsNullKey = true;
        }
    ...
    public int get(short k) {
        short curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2956n] : this.defRetValue;
        }
        short[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Short2IntOpenCustomHashMap.this.f2956n;
            this.last = -1;
            this.f2958c = Short2IntOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Short2IntOpenCustomHashMap.this.f2956n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Short2IntOpenCustomHashMap.this.f2956n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Short2IntOpenCustomHashMap.this.f2956n;
            this.f2959c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2959c++;
                acceptOnIndex(action, Short2IntOpenCustomHashMap.this.f2956n);
                return true;
            }
            short[] key = Short2IntOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Short2IntOpenCustomHashMap.this.size - this.f2959c);
            }
            return Math.min((long) (Short2IntOpenCustomHashMap.this.size - this.f2959c), ((long) ((((double) Short2IntOpenCustomHashMap.this.realSize()) / ((double) Short2IntOpenCustomHashMap.this.f2956n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Short2IntMap.Entry> implements Short2IntMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Short2IntOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Short2IntOpenCustomHashMap.this.containsNullKey && Short2IntOpenCustomHashMap.this.value[Short2IntOpenCustomHashMap.this.f2956n] == v;
            }
            short[] key = Short2IntOpenCustomHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Short2IntOpenCustomHashMap.this.containsNullKey || Short2IntOpenCustomHashMap.this.value[Short2IntOpenCustomHashMap.this.f2956n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Short2IntMap.Entry> consumer) {
            if (Short2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2IntMap.BasicEntry(Short2IntOpenCustomHashMap.this.key[Short2IntOpenCustomHashMap.this.f2956n], Short2IntOpenCustomHashMap.this.value[Short2IntOpenCustomHashMap.this.f2956n]));
            }
            int pos = Short2IntOpenCustomHashMap.this.f2956n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Short2IntMap.Entry> consumer) {
            ...
            if (Short2IntOpenCustomHashMap.this.containsNullKey) {
                entry.key = Short2IntOpenCustomHashMap.this.key[Short2IntOpenCustomHashMap.this.f2956n];
                entry.value = Short2IntOpenCustomHashMap.this.value[Short2IntOpenCustomHashMap.this.f2956n];
    ...
    public final class KeySet extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            if (Short2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Short2IntOpenCustomHashMap.this.key[Short2IntOpenCustomHashMap.this.f2956n]);
            }
            int pos = Short2IntOpenCustomHashMap.this.f2956n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap.1
                ...
                public void forEach(IntConsumer consumer) {
                    if (Short2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Short2IntOpenCustomHashMap.this.value[Short2IntOpenCustomHashMap.this.f2956n]);
                    }
                    int pos = Short2IntOpenCustomHashMap.this.f2956n;
                    while (true) {
                        pos--;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        int[] value = new int[this.f2956n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
