...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntOpenCustomHashMap.class */
public class Short2IntOpenCustomHashMap extends AbstractShort2IntMap implements Serializable, Cloneable, Hash {
    ...
    public Short2IntOpenCustomHashMap(int expected, float f, ShortHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new int[this.f2920n + 1];
        }
    }
    ...
    public int removeNullEntry() {
        ...
        int oldValue = this.value[this.f2920n];
        this.size--;
        if (this.f2920n > this.minN && this.size < this.maxFill / 4 && this.f2920n > 16) {
            rehash(this.f2920n / 2);
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Short2IntMap.Entry, Map.Entry<Short, Integer>, ShortIntPair {
        ...
        public boolean equals(Object o) {
            ...
            return Short2IntOpenCustomHashMap.this.strategy.equals(Short2IntOpenCustomHashMap.this.key[this.index], e.getKey().shortValue()) && Short2IntOpenCustomHashMap.this.value[this.index] == e.getValue().intValue();
        }
        ...
        public String toString() {
            return ((int) Short2IntOpenCustomHashMap.this.key[this.index]) + "=>" + Short2IntOpenCustomHashMap.this.value[this.index];
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Short2IntOpenCustomHashMap.this.f2920n;
            this.last = -1;
            this.f2922c = Short2IntOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Short2IntOpenCustomHashMap.this.f2920n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Short2IntOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Short2IntOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Short2IntOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Short2IntOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Short2IntOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Short2IntOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Short2IntOpenCustomHashMap.this.value[pos] = Short2IntOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Short2IntOpenCustomHashMap.this.f2920n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Short2IntMap.Entry>> implements ObjectIterator<Short2IntMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Short2IntOpenCustomHashMap.this.f2920n;
            this.f2923c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2923c++;
                acceptOnIndex(action, Short2IntOpenCustomHashMap.this.f2920n);
                return true;
            }
            short[] key = Short2IntOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Short2IntOpenCustomHashMap.this.size - this.f2923c);
            }
            return Math.min((long) (Short2IntOpenCustomHashMap.this.size - this.f2923c), ((long) ((((double) Short2IntOpenCustomHashMap.this.realSize()) / ((double) Short2IntOpenCustomHashMap.this.f2920n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap.this
                short[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Short2IntMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Short2IntMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Short2IntMap.Entry> implements Short2IntMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Short2IntOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Short2IntOpenCustomHashMap.this.containsNullKey && Short2IntOpenCustomHashMap.this.value[Short2IntOpenCustomHashMap.this.f2920n] == v;
            }
            short[] key = Short2IntOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Short2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Short2IntOpenCustomHashMap.this.mask;
            int pos = mix;
            short curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            }
            if (Short2IntOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Short2IntOpenCustomHashMap.this.value[pos] == v;
            }
            do {
                int i = (pos + 1) & Short2IntOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (!Short2IntOpenCustomHashMap.this.strategy.equals(k, 0)) {
                ...
                if (!Short2IntOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Short2IntOpenCustomHashMap.this.strategy.equals(curr2, k) && Short2IntOpenCustomHashMap.this.value[pos] == v) {
                            Short2IntOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Short2IntOpenCustomHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Short2IntOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Short2IntOpenCustomHashMap.this.containsNullKey || Short2IntOpenCustomHashMap.this.value[Short2IntOpenCustomHashMap.this.f2920n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Short2IntMap.Entry> consumer) {
            if (Short2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2IntMap.BasicEntry(Short2IntOpenCustomHashMap.this.key[Short2IntOpenCustomHashMap.this.f2920n], Short2IntOpenCustomHashMap.this.value[Short2IntOpenCustomHashMap.this.f2920n]));
            }
            int pos = Short2IntOpenCustomHashMap.this.f2920n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Short2IntMap.Entry> consumer) {
            ...
            if (Short2IntOpenCustomHashMap.this.containsNullKey) {
                entry.key = Short2IntOpenCustomHashMap.this.key[Short2IntOpenCustomHashMap.this.f2920n];
                entry.value = Short2IntOpenCustomHashMap.this.value[Short2IntOpenCustomHashMap.this.f2920n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            if (Short2IntOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Short2IntOpenCustomHashMap.this.key[Short2IntOpenCustomHashMap.this.f2920n]);
            }
            int pos = Short2IntOpenCustomHashMap.this.f2920n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Integer> values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.shorts.Short2IntOpenCustomHashMap.1
                ...
                public void forEach(IntConsumer consumer) {
                    if (Short2IntOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Short2IntOpenCustomHashMap.this.value[Short2IntOpenCustomHashMap.this.f2920n]);
                    }
                    int pos = Short2IntOpenCustomHashMap.this.f2920n;
                    while (true) {
                        pos--;
    ...
    public Short2IntOpenCustomHashMap clone() {
        try {
            Short2IntOpenCustomHashMap c = (Short2IntOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        int[] value = new int[this.f2920n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
