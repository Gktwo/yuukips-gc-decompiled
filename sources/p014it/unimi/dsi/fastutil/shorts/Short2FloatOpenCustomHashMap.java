...
public class Short2FloatOpenCustomHashMap extends AbstractShort2FloatMap implements Serializable, Cloneable, Hash {
    ...
    public Short2FloatOpenCustomHashMap(int expected, float f, ShortHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new float[this.f2944n + 1];
        }
    }
    ...
    public float removeNullEntry() {
        ...
        float oldValue = this.value[this.f2944n];
        this.size--;
        if (this.f2944n > this.minN && this.size < this.maxFill / 4 && this.f2944n > 16) {
            rehash(this.f2944n / 2);
        }
    ...
    public float addTo(short k, float incr) {
        ...
        if (!this.strategy.equals(k, 0)) {
            ...
            return addToValue(this.f2944n, incr);
        } else {
            pos = this.f2944n;
            this.containsNullKey = true;
        }
    ...
    public float get(short k) {
        short curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2944n] : this.defRetValue;
        }
        short[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(float v) {
        ...
        short[] key = this.key;
        if (this.containsNullKey && Float.floatToIntBits(value[this.f2944n]) == Float.floatToIntBits(v)) {
            return true;
        }
        int i = this.f2944n;
        while (true) {
    ...
    public boolean remove(short k, float v) {
        ...
        } else if (!this.containsNullKey || Float.floatToIntBits(v) != Float.floatToIntBits(this.value[this.f2944n])) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Short2FloatOpenCustomHashMap.this.f2944n;
            this.last = -1;
            this.f2946c = Short2FloatOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Short2FloatOpenCustomHashMap.this.f2944n;
                this.last = i;
                return i;
            }
        ...
        public void remove() {
            ...
            if (this.last == Short2FloatOpenCustomHashMap.this.f2944n) {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Short2FloatOpenCustomHashMap.this.f2944n;
            this.f2947c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2947c++;
                acceptOnIndex(action, Short2FloatOpenCustomHashMap.this.f2944n);
                return true;
            }
            short[] key = Short2FloatOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Short2FloatOpenCustomHashMap.this.size - this.f2947c);
            }
            return Math.min((long) (Short2FloatOpenCustomHashMap.this.size - this.f2947c), ((long) ((((double) Short2FloatOpenCustomHashMap.this.realSize()) / ((double) Short2FloatOpenCustomHashMap.this.f2944n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
    ...
    public final class MapEntrySet extends AbstractObjectSet<Short2FloatMap.Entry> implements Short2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Short2FloatOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Short2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Short2FloatOpenCustomHashMap.this.value[Short2FloatOpenCustomHashMap.this.f2944n]) == Float.floatToIntBits(v);
            }
            short[] key = Short2FloatOpenCustomHashMap.this.key;
        ...
        public boolean remove(Object o) {
            ...
            } else if (!Short2FloatOpenCustomHashMap.this.containsNullKey || Float.floatToIntBits(Short2FloatOpenCustomHashMap.this.value[Short2FloatOpenCustomHashMap.this.f2944n]) != Float.floatToIntBits(v)) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Short2FloatMap.Entry> consumer) {
            if (Short2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2FloatMap.BasicEntry(Short2FloatOpenCustomHashMap.this.key[Short2FloatOpenCustomHashMap.this.f2944n], Short2FloatOpenCustomHashMap.this.value[Short2FloatOpenCustomHashMap.this.f2944n]));
            }
            int pos = Short2FloatOpenCustomHashMap.this.f2944n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Short2FloatMap.Entry> consumer) {
            ...
            if (Short2FloatOpenCustomHashMap.this.containsNullKey) {
                entry.key = Short2FloatOpenCustomHashMap.this.key[Short2FloatOpenCustomHashMap.this.f2944n];
                entry.value = Short2FloatOpenCustomHashMap.this.value[Short2FloatOpenCustomHashMap.this.f2944n];
    ...
    public final class KeySet extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            if (Short2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Short2FloatOpenCustomHashMap.this.key[Short2FloatOpenCustomHashMap.this.f2944n]);
            }
            int pos = Short2FloatOpenCustomHashMap.this.f2944n;
            while (true) {
                pos--;
        ...
        if (this.values == null) {
            this.values = new AbstractFloatCollection() { // from class: it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap.1
                ...
                public void forEach(FloatConsumer consumer) {
                    if (Short2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Short2FloatOpenCustomHashMap.this.value[Short2FloatOpenCustomHashMap.this.f2944n]);
                    }
                    int pos = Short2FloatOpenCustomHashMap.this.f2944n;
                    while (true) {
                        pos--;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.float2int(this.value[this.f2944n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        float[] value = new float[this.f2944n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
