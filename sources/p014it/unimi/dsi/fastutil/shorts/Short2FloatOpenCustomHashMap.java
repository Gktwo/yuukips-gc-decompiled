...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatOpenCustomHashMap.class */
public class Short2FloatOpenCustomHashMap extends AbstractShort2FloatMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f2908n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f2909f;
    ...
    public Short2FloatOpenCustomHashMap(int expected, float f, ShortHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f2908n = arraySize;
            this.minN = arraySize;
            this.mask = this.f2908n - 1;
            this.maxFill = HashCommon.maxFill(this.f2908n, f);
            this.key = new short[this.f2908n + 1];
            this.value = new float[this.f2908n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f2909f);
        if (needed > this.f2908n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f2909f)))));
        if (needed > this.f2908n) {
            rehash(needed);
        }
    }
    ...
    public float removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f2908n > this.minN && this.size < this.maxFill / 4 && this.f2908n > 16) {
            rehash(this.f2908n / 2);
        }
        return oldValue;
    }
    ...
    public float removeNullEntry() {
        ...
        float oldValue = this.value[this.f2908n];
        this.size--;
        if (this.f2908n > this.minN && this.size < this.maxFill / 4 && this.f2908n > 16) {
            rehash(this.f2908n / 2);
        }
    ...
    private int find(short k) {
        ...
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.f2908n : -(this.f2908n + 1);
        }
        short[] key = this.key;
    ...
    private void insert(int pos, short k, float v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f2909f));
        }
    }
    ...
    public float addTo(short k, float incr) {
        ...
        if (!this.strategy.equals(k, 0)) {
            ...
            return addToValue(this.f2908n, incr);
        } else {
            pos = this.f2908n;
            this.containsNullKey = true;
        }
    ...
    public float get(short k) {
        short curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2908n] : this.defRetValue;
        }
        short[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(float v) {
        ...
        short[] key = this.key;
        if (this.containsNullKey && Float.floatToIntBits(value[this.f2908n]) == Float.floatToIntBits(v)) {
            return true;
        }
        int i = this.f2908n;
        while (true) {
    ...
    public float getOrDefault(short k, float defaultValue) {
        short curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2908n] : defaultValue;
        }
        short[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(short k, float v) {
        ...
        } else if (!this.containsNullKey || Float.floatToIntBits(v) != Float.floatToIntBits(this.value[this.f2908n])) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Short2FloatMap.Entry, Map.Entry<Short, Float>, ShortFloatPair {
        ...
        public boolean equals(Object o) {
            ...
            return Short2FloatOpenCustomHashMap.this.strategy.equals(Short2FloatOpenCustomHashMap.this.key[this.index], e.getKey().shortValue()) && Float.floatToIntBits(Short2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue().floatValue());
        }
        ...
        public String toString() {
            return ((int) Short2FloatOpenCustomHashMap.this.key[this.index]) + "=>" + Short2FloatOpenCustomHashMap.this.value[this.index];
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Short2FloatOpenCustomHashMap.this.f2908n;
            this.last = -1;
            this.f2910c = Short2FloatOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Short2FloatOpenCustomHashMap.this.f2908n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Short2FloatOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Short2FloatOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Short2FloatOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Short2FloatOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Short2FloatOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Short2FloatOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Short2FloatOpenCustomHashMap.this.value[pos] = Short2FloatOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Short2FloatOpenCustomHashMap.this.f2908n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Short2FloatMap.Entry>> implements ObjectIterator<Short2FloatMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Short2FloatOpenCustomHashMap.this.f2908n;
            this.f2911c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2911c++;
                acceptOnIndex(action, Short2FloatOpenCustomHashMap.this.f2908n);
                return true;
            }
            short[] key = Short2FloatOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Short2FloatOpenCustomHashMap.this.size - this.f2911c);
            }
            return Math.min((long) (Short2FloatOpenCustomHashMap.this.size - this.f2911c), ((long) ((((double) Short2FloatOpenCustomHashMap.this.realSize()) / ((double) Short2FloatOpenCustomHashMap.this.f2908n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap.this
                short[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Short2FloatMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Short2FloatMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Short2FloatMap.Entry> implements Short2FloatMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Short2FloatOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Short2FloatOpenCustomHashMap.this.containsNullKey && Float.floatToIntBits(Short2FloatOpenCustomHashMap.this.value[Short2FloatOpenCustomHashMap.this.f2908n]) == Float.floatToIntBits(v);
            }
            short[] key = Short2FloatOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Short2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Short2FloatOpenCustomHashMap.this.mask;
            int pos = mix;
            short curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            }
            if (Short2FloatOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Float.floatToIntBits(Short2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v);
            }
            do {
                int i = (pos + 1) & Short2FloatOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (!Short2FloatOpenCustomHashMap.this.strategy.equals(k, 0)) {
                ...
                if (!Short2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Short2FloatOpenCustomHashMap.this.strategy.equals(curr2, k) && Float.floatToIntBits(Short2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
                            Short2FloatOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Float.floatToIntBits(Short2FloatOpenCustomHashMap.this.value[pos]) != Float.floatToIntBits(v)) {
                    return false;
                } else {
                    Short2FloatOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Short2FloatOpenCustomHashMap.this.containsNullKey || Float.floatToIntBits(Short2FloatOpenCustomHashMap.this.value[Short2FloatOpenCustomHashMap.this.f2908n]) != Float.floatToIntBits(v)) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Short2FloatMap.Entry> consumer) {
            if (Short2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2FloatMap.BasicEntry(Short2FloatOpenCustomHashMap.this.key[Short2FloatOpenCustomHashMap.this.f2908n], Short2FloatOpenCustomHashMap.this.value[Short2FloatOpenCustomHashMap.this.f2908n]));
            }
            int pos = Short2FloatOpenCustomHashMap.this.f2908n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Short2FloatMap.Entry> consumer) {
            ...
            if (Short2FloatOpenCustomHashMap.this.containsNullKey) {
                entry.key = Short2FloatOpenCustomHashMap.this.key[Short2FloatOpenCustomHashMap.this.f2908n];
                entry.value = Short2FloatOpenCustomHashMap.this.value[Short2FloatOpenCustomHashMap.this.f2908n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            if (Short2FloatOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Short2FloatOpenCustomHashMap.this.key[Short2FloatOpenCustomHashMap.this.f2908n]);
            }
            int pos = Short2FloatOpenCustomHashMap.this.f2908n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Float> values() {
        if (this.values == null) {
            this.values = new AbstractFloatCollection() { // from class: it.unimi.dsi.fastutil.shorts.Short2FloatOpenCustomHashMap.1
                ...
                public void forEach(FloatConsumer consumer) {
                    if (Short2FloatOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Short2FloatOpenCustomHashMap.this.value[Short2FloatOpenCustomHashMap.this.f2908n]);
                    }
                    int pos = Short2FloatOpenCustomHashMap.this.f2908n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f2909f)));
        if (l >= this.f2908n || this.size > HashCommon.maxFill(l, this.f2909f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2908n];
                this.f2908n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f2908n, this.f2909f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Short2FloatOpenCustomHashMap clone() {
        try {
            Short2FloatOpenCustomHashMap c = (Short2FloatOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    public int hashCode() {
        ...
        if (this.containsNullKey) {
            h += HashCommon.float2int(this.value[this.f2908n]);
        }
        return h;
    }
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f2908n = HashCommon.arraySize(this.size, this.f2909f);
        this.maxFill = HashCommon.maxFill(this.f2908n, this.f2909f);
        this.mask = this.f2908n - 1;
        short[] key = new short[this.f2908n + 1];
        this.key = key;
        float[] value = new float[this.f2908n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
