...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceRBTreeMap.class */
public class Short2ReferenceRBTreeMap<V> extends AbstractShort2ReferenceSortedMap<V> implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap.Entry<V> add(short r9) {
        /*
        // Method dump skipped, instructions count: 935
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap.add(short):it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap$Entry");
    }
    ...
    public V remove(short r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap.remove(short):java.lang.Object");
    }

    @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShort2ReferenceMap, java.util.Map
    public boolean containsValue(Object v) {
        Short2ReferenceRBTreeMap<V>.ValueIterator i = new ValueIterator();
        int j = this.count;
        do {
            j--;
            if (j == 0) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(short k) {
            Entry<V> locateKey = Short2ReferenceRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceRBTreeMap$EntryIterator.class */
    public class EntryIterator extends Short2ReferenceRBTreeMap<V>.TreeIterator implements ObjectListIterator<Short2ReferenceMap.Entry<V>> {
        EntryIterator() {
            super();
        }
    ...
    public ObjectSortedSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap.1
                final Comparator<? super Short2ReferenceMap.Entry<V>> comparator;

                {
                    this.comparator = Short2ReferenceRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Short)) {
                        return e.equals(Short2ReferenceRBTreeMap.this.findKey(((Short) e.getKey()).shortValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Short) || (f = Short2ReferenceRBTreeMap.this.findKey(((Short) e.getKey()).shortValue())) == null || f.getValue() != e.getValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceRBTreeMap$KeyIterator.class */
    public final class KeyIterator extends Short2ReferenceRBTreeMap<V>.TreeIterator implements ShortListIterator {
        public KeyIterator() {
            super();
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceRBTreeMap$ValueIterator.class */
    public final class ValueIterator extends Short2ReferenceRBTreeMap<V>.TreeIterator implements ObjectListIterator<V> {
    ...
    public ReferenceCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceRBTreeMap$Submap.class */
    public final class Submap extends AbstractShort2ReferenceSortedMap<V> implements Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.Function, p014it.unimi.dsi.fastutil.bytes.Byte2BooleanMap, java.util.Map
        public void clear() {
            Short2ReferenceRBTreeMap<V>.Submap.SubmapIterator i = new SubmapIterator();
            while (i.hasNext()) {
                i.nextEntry();
                i.remove();
            }
        ...
        /* renamed from: in */
        final boolean m449in(short k) {
            return (this.bottom || Short2ReferenceRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2ReferenceRBTreeMap.this.compare(k, this.f3000to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.shorts.Short2ReferenceMap, p014it.unimi.dsi.fastutil.shorts.Short2ReferenceSortedMap
        public ObjectSortedSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.ObjectSortedSet
                    public /* bridge */ /* synthetic */ ObjectBidirectionalIterator iterator(Object obj) {
                        return iterator((Short2ReferenceMap.Entry) ((Short2ReferenceMap.Entry) obj));
                    }
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Short) && (f = Short2ReferenceRBTreeMap.this.findKey(((Short) e.getKey()).shortValue())) != null && Submap.this.m449in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry<V> f = Short2ReferenceRBTreeMap.this.findKey(((Short) e.getKey()).shortValue());
                        if (f != null && Submap.this.m449in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractShort2ReferenceSortedMap<V>.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ReferenceCollection<V> values() {
            if (this.values == null) {
                this.values = new AbstractReferenceCollection<V>() { // from class: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractReferenceCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ReferenceCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection
                    public ObjectIterator<V> iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShort2ReferenceMap, p014it.unimi.dsi.fastutil.shorts.Short2ReferenceFunction, p014it.unimi.dsi.fastutil.shorts.Short2ReferenceMap
        public boolean containsKey(short k) {
            return m449in(k) && Short2ReferenceRBTreeMap.this.containsKey(k);
        }
        ...
        public V get(short k) {
            Entry<V> e;
            return (!m449in(k) || (e = Short2ReferenceRBTreeMap.this.findKey(k)) == null) ? (V) this.defRetValue : (V) e.value;
        }
        ...
        public V put(short k, V v) {
            ...
            if (!m449in(k)) {
                throw new IllegalArgumentException("Key (" + ((int) k) + ") out of range [" + (this.bottom ? "-" : String.valueOf((int) this.from)) + ", " + (this.top ? "-" : String.valueOf((int) this.f3000to)) + ")");
            }
            return Short2ReferenceRBTreeMap.this.modified ? (V) this.defRetValue : (V) Short2ReferenceRBTreeMap.this.put(k, (short) v);
        }
        ...
        public V remove(short k) {
            ...
            return Short2ReferenceRBTreeMap.this.modified ? (V) Short2ReferenceRBTreeMap.this.remove(k) : (V) this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2ReferenceSortedMap
        public Short2ReferenceSortedMap<V> headMap(short to) {
            if (!this.top && Short2ReferenceRBTreeMap.this.compare(to, this.f3000to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2ReferenceSortedMap
        public Short2ReferenceSortedMap<V> tailMap(short from) {
            if (!this.bottom && Short2ReferenceRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f3000to, this.top);
        }
        ...
        public Short2ReferenceSortedMap<V> subMap(short from, short to) {
            ...
            if (!this.top) {
                to = Short2ReferenceRBTreeMap.this.compare(to, this.f3000to) < 0 ? to : this.f3000to;
            }
            if (!this.bottom) {
                from = Short2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f3000to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.top || Short2ReferenceRBTreeMap.this.compare(e.key, this.f3000to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                ...
                e = Short2ReferenceRBTreeMap.this.locateKey(this.f3000to);
                if (Short2ReferenceRBTreeMap.this.compare(e.key, this.f3000to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Short2ReferenceRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends Short2ReferenceRBTreeMap<V>.TreeIterator {
            SubmapIterator() {
                super();
            ...
            SubmapIterator(Submap submap, short k) {
                ...
                if (submap.bottom || Short2ReferenceRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Short2ReferenceRBTreeMap short2ReferenceRBTreeMap = Short2ReferenceRBTreeMap.this;
                        Entry<V> lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (short2ReferenceRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Short2ReferenceRBTreeMap.this.compare(this.next.key, Submap.this.f3000to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceRBTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends Short2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Short2ReferenceMap.Entry<V>> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceRBTreeMap$Submap$SubmapKeyIterator.class */
        public final class SubmapKeyIterator extends Short2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ShortListIterator {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceRBTreeMap$Submap$SubmapValueIterator.class */
        public final class SubmapValueIterator extends Short2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<V> {
    ...
    public Short2ReferenceRBTreeMap<V> clone() {
        try {
            Short2ReferenceRBTreeMap<V> c = (Short2ReferenceRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        int n = this.count;
        Short2ReferenceRBTreeMap<V>.EntryIterator i = new EntryIterator();
