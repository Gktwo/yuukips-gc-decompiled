...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharOpenCustomHashMap.class */
public class Short2CharOpenCustomHashMap extends AbstractShort2CharMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f2920n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f2921f;
    ...
    public Short2CharOpenCustomHashMap(int expected, float f, ShortHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f2920n = arraySize;
            this.minN = arraySize;
            this.mask = this.f2920n - 1;
            this.maxFill = HashCommon.maxFill(this.f2920n, f);
            this.key = new short[this.f2920n + 1];
            this.value = new char[this.f2920n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f2921f);
        if (needed > this.f2920n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f2921f)))));
        if (needed > this.f2920n) {
            rehash(needed);
        }
    }
    ...
    public char removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f2920n > this.minN && this.size < this.maxFill / 4 && this.f2920n > 16) {
            rehash(this.f2920n / 2);
        }
        return oldValue;
    }
    ...
    public char removeNullEntry() {
        ...
        char oldValue = this.value[this.f2920n];
        this.size--;
        if (this.f2920n > this.minN && this.size < this.maxFill / 4 && this.f2920n > 16) {
            rehash(this.f2920n / 2);
        }
    ...
    private int find(short k) {
        ...
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.f2920n : -(this.f2920n + 1);
        }
        short[] key = this.key;
    ...
    private void insert(int pos, short k, char v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f2921f));
        }
    }
    ...
    public char addTo(short k, char incr) {
        ...
        if (!this.strategy.equals(k, 0)) {
            ...
            return addToValue(this.f2920n, incr);
        } else {
            pos = this.f2920n;
            this.containsNullKey = true;
        }
    ...
    public char get(short k) {
        short curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2920n] : this.defRetValue;
        }
        short[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(char v) {
        ...
        short[] key = this.key;
        if (this.containsNullKey && value[this.f2920n] == v) {
            return true;
        }
        int i = this.f2920n;
        while (true) {
    ...
    public char getOrDefault(short k, char defaultValue) {
        short curr;
        if (this.strategy.equals(k, 0)) {
            return this.containsNullKey ? this.value[this.f2920n] : defaultValue;
        }
        short[] key = this.key;
        int mix = HashCommon.mix(this.strategy.hashCode(k)) & this.mask;
        int pos = mix;
    ...
    public boolean remove(short k, char v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f2920n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Short2CharMap.Entry, Map.Entry<Short, Character>, ShortCharPair {
        ...
        public boolean equals(Object o) {
            ...
            return Short2CharOpenCustomHashMap.this.strategy.equals(Short2CharOpenCustomHashMap.this.key[this.index], e.getKey().shortValue()) && Short2CharOpenCustomHashMap.this.value[this.index] == e.getValue().charValue();
        }
        ...
        public String toString() {
            return ((int) Short2CharOpenCustomHashMap.this.key[this.index]) + "=>" + Short2CharOpenCustomHashMap.this.value[this.index];
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Short2CharOpenCustomHashMap.this.f2920n;
            this.last = -1;
            this.f2922c = Short2CharOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Short2CharOpenCustomHashMap.this.f2920n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Short2CharOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Short2CharOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Short2CharOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Short2CharOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Short2CharOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Short2CharOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Short2CharOpenCustomHashMap.this.value[pos] = Short2CharOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Short2CharOpenCustomHashMap.this.f2920n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Short2CharMap.Entry>> implements ObjectIterator<Short2CharMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Short2CharOpenCustomHashMap.this.f2920n;
            this.f2923c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2923c++;
                acceptOnIndex(action, Short2CharOpenCustomHashMap.this.f2920n);
                return true;
            }
            short[] key = Short2CharOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Short2CharOpenCustomHashMap.this.size - this.f2923c);
            }
            return Math.min((long) (Short2CharOpenCustomHashMap.this.size - this.f2923c), ((long) ((((double) Short2CharOpenCustomHashMap.this.realSize()) / ((double) Short2CharOpenCustomHashMap.this.f2920n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap.this
                short[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Short2CharMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Short2CharMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Short2CharMap.Entry> implements Short2CharMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Short2CharOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Short2CharOpenCustomHashMap.this.containsNullKey && Short2CharOpenCustomHashMap.this.value[Short2CharOpenCustomHashMap.this.f2920n] == v;
            }
            short[] key = Short2CharOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Short2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Short2CharOpenCustomHashMap.this.mask;
            int pos = mix;
            short curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            }
            if (Short2CharOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Short2CharOpenCustomHashMap.this.value[pos] == v;
            }
            do {
                int i = (pos + 1) & Short2CharOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (!Short2CharOpenCustomHashMap.this.strategy.equals(k, 0)) {
                ...
                if (!Short2CharOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Short2CharOpenCustomHashMap.this.strategy.equals(curr2, k) && Short2CharOpenCustomHashMap.this.value[pos] == v) {
                            Short2CharOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Short2CharOpenCustomHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Short2CharOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Short2CharOpenCustomHashMap.this.containsNullKey || Short2CharOpenCustomHashMap.this.value[Short2CharOpenCustomHashMap.this.f2920n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Short2CharMap.Entry> consumer) {
            if (Short2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2CharMap.BasicEntry(Short2CharOpenCustomHashMap.this.key[Short2CharOpenCustomHashMap.this.f2920n], Short2CharOpenCustomHashMap.this.value[Short2CharOpenCustomHashMap.this.f2920n]));
            }
            int pos = Short2CharOpenCustomHashMap.this.f2920n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Short2CharMap.Entry> consumer) {
            ...
            if (Short2CharOpenCustomHashMap.this.containsNullKey) {
                entry.key = Short2CharOpenCustomHashMap.this.key[Short2CharOpenCustomHashMap.this.f2920n];
                entry.value = Short2CharOpenCustomHashMap.this.value[Short2CharOpenCustomHashMap.this.f2920n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            if (Short2CharOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Short2CharOpenCustomHashMap.this.key[Short2CharOpenCustomHashMap.this.f2920n]);
            }
            int pos = Short2CharOpenCustomHashMap.this.f2920n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Character> values() {
        if (this.values == null) {
            this.values = new AbstractCharCollection() { // from class: it.unimi.dsi.fastutil.shorts.Short2CharOpenCustomHashMap.1
                ...
                public void forEach(CharConsumer consumer) {
                    if (Short2CharOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Short2CharOpenCustomHashMap.this.value[Short2CharOpenCustomHashMap.this.f2920n]);
                    }
                    int pos = Short2CharOpenCustomHashMap.this.f2920n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f2921f)));
        if (l >= this.f2920n || this.size > HashCommon.maxFill(l, this.f2921f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f2920n];
                this.f2920n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f2920n, this.f2921f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Short2CharOpenCustomHashMap clone() {
        try {
            Short2CharOpenCustomHashMap c = (Short2CharOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f2920n = HashCommon.arraySize(this.size, this.f2921f);
        this.maxFill = HashCommon.maxFill(this.f2920n, this.f2921f);
        this.mask = this.f2920n - 1;
        short[] key = new short[this.f2920n + 1];
        this.key = key;
        char[] value = new char[this.f2920n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
