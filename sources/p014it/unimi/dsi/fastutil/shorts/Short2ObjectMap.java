...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectMap.class */
public interface Short2ObjectMap<V> extends Short2ObjectFunction<V>, Map<Short, V> {
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectMap$FastEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectMap$FastEntrySet.class */
    ...
    default void forEach(BiConsumer<? super Short, ? super V> consumer) {
        ObjectSet<Entry<V>> entrySet = short2ObjectEntrySet();
    ...
    default V computeIfAbsentPartial(short key, Short2ObjectFunction<? extends V> mappingFunction) {
        return computeIfAbsent(key, (Short2ObjectFunction) mappingFunction);
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectMap$Entry.class */
