...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleFunctions.class */
public final class Short2DoubleFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractShort2DoubleFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2DoubleFunction, p014it.unimi.dsi.fastutil.shorts.Short2DoubleMap
        public boolean containsKey(short k) {
            return false;
        }

        @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShort2DoubleFunction, p014it.unimi.dsi.fastutil.shorts.Short2DoubleFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Short2DoubleFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Short2DoubleFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Short2DoubleFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2DoubleFunction, java.util.function.IntToDoubleFunction
        @Deprecated
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractShort2DoubleFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Short2DoubleFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Short2DoubleFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2DoubleFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2DoubleFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Short2DoubleFunction {
        ...
        public double get(short key) {
            Double v = (Double) this.function.apply(Short.valueOf(key));
        ...
        public Double get(Object key) {
            ...
            return (Double) this.function.apply((Short) key);
        }
        ...
        public Double getOrDefault(Object key, Double defaultValue) {
            Double v;
            if (!(key == null || (v = (Double) this.function.apply((Short) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
