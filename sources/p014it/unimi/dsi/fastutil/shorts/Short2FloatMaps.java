...
import p014it.unimi.dsi.fastutil.shorts.Short2FloatFunctions;
import p014it.unimi.dsi.fastutil.shorts.Short2FloatMap;

/* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatMaps */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatMaps.class */
public final class Short2FloatMaps {
    ...
    public static ObjectIterable<Short2FloatMap.Entry> fastIterable(Short2FloatMap map) {
        ...
        return entries instanceof Short2FloatMap.FastEntrySet ? new ObjectIterable<Short2FloatMap.Entry>() { // from class: it.unimi.dsi.fastutil.shorts.Short2FloatMaps.1
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatMaps$EmptyMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatMaps$EmptyMap.class */
    public static class EmptyMap extends Short2FloatFunctions.EmptyFunction implements Short2FloatMap, Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2FloatFunctions.EmptyFunction, p014it.unimi.dsi.fastutil.shorts.Short2FloatFunction
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2FloatFunctions.EmptyFunction, java.lang.Object
        public Object clone() {
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatMaps$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatMaps$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatMaps$SynchronizedMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatMaps$SynchronizedMap.class */
    public static class SynchronizedMap extends Short2FloatFunctions.SynchronizedFunction implements Short2FloatMap, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedMap(Short2FloatMap m, Object sync) {
            super(m, sync);
            this.map = m;
        }

        /* access modifiers changed from: protected */
        public SynchronizedMap(Short2FloatMap m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2FloatMap, p014it.unimi.dsi.fastutil.shorts.Short2FloatSortedMap
        public ObjectSet<Short2FloatMap.Entry> short2FloatEntrySet() {
            ObjectSet<Short2FloatMap.Entry> objectSet;
            synchronized (this.sync) {
                if (this.entries == null) {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2FloatFunctions.SynchronizedFunction, java.lang.Object
        public int hashCode() {
            int hashCode;
            synchronized (this.sync) {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2FloatFunctions.SynchronizedFunction, p014it.unimi.dsi.fastutil.shorts.Short2FloatFunction
        public float getOrDefault(short key, float defaultValue) {
            float orDefault;
            synchronized (this.sync) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2FloatMaps$UnmodifiableMap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2FloatMaps$UnmodifiableMap.class */
    public static class UnmodifiableMap extends Short2FloatFunctions.UnmodifiableFunction implements Short2FloatMap, Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableMap(Short2FloatMap m) {
            super(m);
            this.map = m;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2FloatFunctions.UnmodifiableFunction, java.lang.Object
        public int hashCode() {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2FloatFunctions.UnmodifiableFunction, p014it.unimi.dsi.fastutil.shorts.Short2FloatFunction
        public float getOrDefault(short key, float defaultValue) {
