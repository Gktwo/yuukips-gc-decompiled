...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceFunctions.class */
public final class Short2ReferenceFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceFunctions$EmptyFunction.class */
    public static class EmptyFunction<V> extends AbstractShort2ReferenceFunction<V> implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShort2ReferenceFunction, p014it.unimi.dsi.fastutil.shorts.Short2ReferenceFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction<V> implements Short2ReferenceFunction<V>, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Short2ReferenceFunction<V> f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Short2ReferenceFunction<V> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2ReferenceFunction, java.util.function.IntFunction
        @Deprecated
        ...
        public V apply(Short key) {
            V apply;
            synchronized (this.sync) {
                apply = this.function.apply((Short2ReferenceFunction<V>) key);
            }
            return apply;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction<V> extends AbstractShort2ReferenceFunction<V> implements Serializable {
        ...
        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Short2ReferenceFunction<? extends V> f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceFunctions$PrimitiveFunction.class */
