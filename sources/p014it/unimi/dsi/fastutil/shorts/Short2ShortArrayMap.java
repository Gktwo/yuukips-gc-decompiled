...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortArrayMap.class */
public class Short2ShortArrayMap extends AbstractShort2ShortMap implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Short2ShortArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Short2ShortArrayMap(Short2ShortMap m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Short2ShortMap.Entry> it = m.short2ShortEntrySet().iterator();
        while (it.hasNext()) {
            Short2ShortMap.Entry e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Short2ShortMap.Entry> implements Short2ShortMap.FastEntrySet {
        private EntrySet() {
        }

        @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
        public ObjectIterator<Short2ShortMap.Entry> iterator() {
            return new ObjectIterator<Short2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.shorts.Short2ShortArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Short2ShortMap.Entry next() {
                    ...
                    short[] sArr = Short2ShortArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    short s = sArr[i];
                    short[] sArr2 = Short2ShortArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractShort2ShortMap.BasicEntry(s, sArr2[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Short2ShortArrayMap.access$010(Short2ShortArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Short2ShortMap.Entry> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractShort2ShortMap.BasicEntry(s, sArr2[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Short2ShortMap.Entry> fastIterator() {
            return new ObjectIterator<Short2ShortMap.Entry>() { // from class: it.unimi.dsi.fastutil.shorts.Short2ShortArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Short2ShortMap.Entry next() {
                    ...
                    AbstractShort2ShortMap.BasicEntry basicEntry = this.entry;
                    short[] sArr = Short2ShortArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    basicEntry.key = sArr[i];
                    AbstractShort2ShortMap.BasicEntry basicEntry2 = this.entry;
                    short[] sArr2 = Short2ShortArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
                    basicEntry2.value = sArr2[i2];
                    return this.entry;
                }
        ...
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Short2ShortMap.Entry> implements ObjectSpliterator<Short2ShortMap.Entry> {
            ...
            public final Short2ShortMap.Entry get(int location) {
        ...
        public boolean remove(Object o) {
            ...
            Short2ShortArrayMap.access$010(Short2ShortArrayMap.this);
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortArrayMap$KeySet.class */
    public final class KeySet extends AbstractShortSet {
        ...
        public ShortIterator iterator() {
            return new ShortIterator() { // from class: it.unimi.dsi.fastutil.shorts.Short2ShortArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortArrayMap$KeySet$KeySetSpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractShortCollection {
        ...
        public ShortIterator iterator() {
            return new ShortIterator() { // from class: it.unimi.dsi.fastutil.shorts.Short2ShortArrayMap.ValuesCollection.1
                int pos = 0;
                ...
                public short nextShort() {
                    ...
                    short[] sArr = Short2ShortArrayMap.this.value;
                    int i = this.pos;
                    this.pos = i + 1;
                    return sArr[i];
                }
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortArrayMap$ValuesCollection$ValuesSpliterator.class */
    ...
    public Short2ShortArrayMap clone() {
        try {
            Short2ShortArrayMap c = (Short2ShortArrayMap) clone();
