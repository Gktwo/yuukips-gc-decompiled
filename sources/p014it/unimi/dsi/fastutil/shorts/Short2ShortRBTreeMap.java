...
public class Short2ShortRBTreeMap extends AbstractShort2ShortSortedMap implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractShort2ShortSortedMap implements Serializable {
        ...
        final boolean m447in(short k) {
            return (this.bottom || Short2ShortRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2ShortRBTreeMap.this.compare(k, this.f3012to) < 0);
        }
        ...
        public short put(short k, short v) {
            ...
            if (!m447in(k)) {
                throw new IllegalArgumentException("Key (" + ((int) k) + ") out of range [" + (this.bottom ? "-" : String.valueOf((int) this.from)) + ", " + (this.top ? "-" : String.valueOf((int) this.f3012to)) + ")");
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2ShortSortedMap
        public Short2ShortSortedMap headMap(short to) {
            if (!this.top && Short2ShortRBTreeMap.this.compare(to, this.f3012to) >= 0) {
                return this;
            }
        ...
        public Short2ShortSortedMap tailMap(short from) {
            ...
            return new Submap(from, false, this.f3012to, this.top);
        }
        ...
        public Short2ShortSortedMap subMap(short from, short to) {
            ...
            if (!this.top) {
                to = Short2ShortRBTreeMap.this.compare(to, this.f3012to) < 0 ? to : this.f3012to;
            }
            if (!this.bottom) {
                from = Short2ShortRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f3012to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Short2ShortRBTreeMap.this.compare(e.key, this.f3012to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Short2ShortRBTreeMap.this.locateKey(this.f3012to);
                if (Short2ShortRBTreeMap.this.compare(e.key, this.f3012to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Short2ShortRBTreeMap.this.compare(this.next.key, Submap.this.f3012to) >= 0) {
                    this.next = null;
                }
            }
        }
