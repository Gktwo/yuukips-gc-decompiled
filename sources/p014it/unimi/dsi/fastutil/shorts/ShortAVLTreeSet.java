...
/* renamed from: it.unimi.dsi.fastutil.shorts.ShortAVLTreeSet */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/ShortAVLTreeSet.class */
public class ShortAVLTreeSet extends AbstractShortSortedSet implements Serializable, Cloneable, ShortSortedSet {
    ...
    static {
        $assertionsDisabled = !ShortAVLTreeSet.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:54:0x01a6, code lost:
        if (p014it.unimi.dsi.fastutil.shorts.ShortAVLTreeSet.$assertionsDisabled != false) goto L_0x01ba;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:82:0x02a9, code lost:
        if (p014it.unimi.dsi.fastutil.shorts.ShortAVLTreeSet.$assertionsDisabled != false) goto L_0x02bd;
     */
    ...
    public boolean add(short r8) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.ShortAVLTreeSet.add(short):boolean");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.ShortAVLTreeSet$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/ShortAVLTreeSet$Entry.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.ShortAVLTreeSet$SetIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/ShortAVLTreeSet$SetIterator.class */
    public class SetIterator implements ShortListIterator {
        ...
        SetIterator(short k) {
            Entry locateKey = ShortAVLTreeSet.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.ShortAVLTreeSet$Subset */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/ShortAVLTreeSet$Subset.class */
    private final class Subset extends AbstractShortSortedSet implements Serializable, ShortSortedSet {
        ...
        /* renamed from: in */
        final boolean m446in(short k) {
            return (this.bottom || ShortAVLTreeSet.this.compare(k, this.from) >= 0) && (this.top || ShortAVLTreeSet.this.compare(k, this.f3013to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShortCollection, p014it.unimi.dsi.fastutil.shorts.ShortCollection
        public boolean contains(short k) {
            return m446in(k) && ShortAVLTreeSet.this.contains(k);
        }
        ...
        public boolean add(short k) {
            ...
            throw new IllegalArgumentException("Element (" + ((int) k) + ") out of range [" + (this.bottom ? "-" : String.valueOf((int) this.from)) + ", " + (this.top ? "-" : String.valueOf((int) this.f3013to)) + ")");
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.ShortSortedSet
        public ShortSortedSet headSet(short to) {
            if (!this.top && ShortAVLTreeSet.this.compare(to, this.f3013to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.ShortSortedSet
        public ShortSortedSet tailSet(short from) {
            if (!this.bottom && ShortAVLTreeSet.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Subset(from, false, this.f3013to, this.top);
        }
        ...
        public ShortSortedSet subSet(short from, short to) {
            ...
            if (!this.top) {
                to = ShortAVLTreeSet.this.compare(to, this.f3013to) < 0 ? to : this.f3013to;
            }
            if (!this.bottom) {
                from = ShortAVLTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f3013to) ? new Subset(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || ShortAVLTreeSet.this.compare(e.key, this.f3013to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = ShortAVLTreeSet.this.locateKey(this.f3013to);
                if (ShortAVLTreeSet.this.compare(e.key, this.f3013to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || ShortAVLTreeSet.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.ShortAVLTreeSet$Subset$SubsetIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/ShortAVLTreeSet$Subset$SubsetIterator.class */
        public final class SubsetIterator extends SetIterator {
            ...
            SubsetIterator(Subset subset, short k) {
                ...
                if (subset.bottom || ShortAVLTreeSet.this.compare(k, this.next.key) >= 0) {
                    if (!subset.top) {
                        ShortAVLTreeSet shortAVLTreeSet = ShortAVLTreeSet.this;
                        Entry lastEntry = subset.lastEntry();
                        this.prev = lastEntry;
                        if (shortAVLTreeSet.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.shorts.ShortAVLTreeSet.SetIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Subset.this.top && this.next != null && ShortAVLTreeSet.this.compare(this.next.key, Subset.this.f3013to) >= 0) {
                    this.next = null;
                }
            }
        }
    ...
    public Object clone() {
        try {
            ShortAVLTreeSet c = (ShortAVLTreeSet) clone();
            c.allocatePaths();
            if (this.count == 0) {
                return c;
            }
