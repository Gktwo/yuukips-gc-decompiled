...
public class Short2LongRBTreeMap extends AbstractShort2LongSortedMap implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractShort2LongSortedMap implements Serializable {
        ...
        final boolean m453in(short k) {
            return (this.bottom || Short2LongRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2LongRBTreeMap.this.compare(k, this.f2940to) < 0);
        }
        ...
        public long put(short k, long v) {
            ...
            if (!m453in(k)) {
                throw new IllegalArgumentException("Key (" + ((int) k) + ") out of range [" + (this.bottom ? "-" : String.valueOf((int) this.from)) + ", " + (this.top ? "-" : String.valueOf((int) this.f2940to)) + ")");
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2LongSortedMap
        public Short2LongSortedMap headMap(short to) {
            if (!this.top && Short2LongRBTreeMap.this.compare(to, this.f2940to) >= 0) {
                return this;
            }
        ...
        public Short2LongSortedMap tailMap(short from) {
            ...
            return new Submap(from, false, this.f2940to, this.top);
        }
        ...
        public Short2LongSortedMap subMap(short from, short to) {
            ...
            if (!this.top) {
                to = Short2LongRBTreeMap.this.compare(to, this.f2940to) < 0 ? to : this.f2940to;
            }
            if (!this.bottom) {
                from = Short2LongRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f2940to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Short2LongRBTreeMap.this.compare(e.key, this.f2940to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Short2LongRBTreeMap.this.locateKey(this.f2940to);
                if (Short2LongRBTreeMap.this.compare(e.key, this.f2940to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Short2LongRBTreeMap.this.compare(this.next.key, Submap.this.f2940to) >= 0) {
                    this.next = null;
                }
            }
        }
