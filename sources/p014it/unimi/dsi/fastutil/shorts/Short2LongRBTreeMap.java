...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2LongRBTreeMap.class */
public class Short2LongRBTreeMap extends AbstractShort2LongSortedMap implements Serializable, Cloneable {
    ...
    private p014it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap.Entry add(short r10) {
        /*
        // Method dump skipped, instructions count: 935
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap.add(short):it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.shorts.Short2LongFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public long remove(short r7) {
        /*
        // Method dump skipped, instructions count: 1895
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap.remove(short):long");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2LongRBTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2LongRBTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(short k) {
            Entry locateKey = Short2LongRBTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2LongRBTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2LongMap.Entry>() { // from class: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap.1
                final Comparator<? super Short2LongMap.Entry> comparator;

                {
                    this.comparator = Short2LongRBTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Short) && e.getValue() != null && (e.getValue() instanceof Long)) {
                        return e.equals(Short2LongRBTreeMap.this.findKey(((Short) e.getKey()).shortValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || !(e.getKey() instanceof Short) || e.getValue() == null || !(e.getValue() instanceof Long) || (f = Short2LongRBTreeMap.this.findKey(((Short) e.getKey()).shortValue())) == null || f.getLongValue() != ((Long) e.getValue()).longValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2LongRBTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2LongRBTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2LongRBTreeMap$ValueIterator.class */
    ...
    public LongCollection values() {
        if (this.values == null) {
            this.values = new AbstractLongCollection() { // from class: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2LongRBTreeMap$Submap.class */
    public final class Submap extends AbstractShort2LongSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m453in(short k) {
            return (this.bottom || Short2LongRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2LongRBTreeMap.this.compare(k, this.f2976to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.shorts.Short2LongMap, p014it.unimi.dsi.fastutil.shorts.Short2LongSortedMap
        public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2LongMap.Entry>() { // from class: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Short) && e.getValue() != null && (e.getValue() instanceof Long) && (f = Short2LongRBTreeMap.this.findKey(((Short) e.getKey()).shortValue())) != null && Submap.this.m453in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Short2LongRBTreeMap.this.findKey(((Short) e.getKey()).shortValue());
                        if (f != null && Submap.this.m453in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2LongRBTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractShort2LongSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public LongCollection values() {
            if (this.values == null) {
                this.values = new AbstractLongCollection() { // from class: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.longs.AbstractLongCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.longs.LongCollection, p014it.unimi.dsi.fastutil.longs.LongIterable
                    public LongIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShort2LongMap, p014it.unimi.dsi.fastutil.shorts.Short2LongFunction, p014it.unimi.dsi.fastutil.shorts.Short2LongMap
        public boolean containsKey(short k) {
            return m453in(k) && Short2LongRBTreeMap.this.containsKey(k);
        }
        ...
        public long get(short k) {
            Entry e;
            return (!m453in(k) || (e = Short2LongRBTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public long put(short k, long v) {
            ...
            return Short2LongRBTreeMap.this.modified ? this.defRetValue : Short2LongRBTreeMap.this.put(k, v);
        }
        ...
        public long remove(short k) {
            ...
            return Short2LongRBTreeMap.this.modified ? Short2LongRBTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2LongSortedMap
        public Short2LongSortedMap headMap(short to) {
            if (!this.top && Short2LongRBTreeMap.this.compare(to, this.f2976to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2LongSortedMap
        public Short2LongSortedMap tailMap(short from) {
            if (!this.bottom && Short2LongRBTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
        ...
        public Short2LongSortedMap subMap(short from, short to) {
            ...
            if (!this.top) {
                to = Short2LongRBTreeMap.this.compare(to, this.f2976to) < 0 ? to : this.f2976to;
            }
            if (!this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Short2LongRBTreeMap.this.compare(e.key, this.f2976to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Short2LongRBTreeMap.this.locateKey(this.f2976to);
                if (Short2LongRBTreeMap.this.compare(e.key, this.f2976to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Short2LongRBTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2LongRBTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, short k) {
                ...
                if (submap.bottom || Short2LongRBTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Short2LongRBTreeMap short2LongRBTreeMap = Short2LongRBTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (short2LongRBTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Short2LongRBTreeMap.this.compare(this.next.key, Submap.this.f2976to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2LongRBTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2LongRBTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2LongRBTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2LongRBTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Short2LongRBTreeMap clone() {
        try {
            Short2LongRBTreeMap c = (Short2LongRBTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
