...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceArrayMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceArrayMap.class */
public class Short2ReferenceArrayMap<V> extends AbstractShort2ReferenceMap<V> implements Serializable, Cloneable {
    ...
    static /* synthetic */ int access$010(Short2ReferenceArrayMap x0) {
        int i = x0.size;
        x0.size = i - 1;
        return i;
    }
    ...
    public Short2ReferenceArrayMap(Short2ReferenceMap<V> m) {
        this(m.size());
        int i = 0;
        ObjectIterator<Short2ReferenceMap.Entry<V>> it = m.short2ReferenceEntrySet().iterator();
        while (it.hasNext()) {
            Short2ReferenceMap.Entry<V> e = it.next();
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceArrayMap$EntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceArrayMap$EntrySet.class */
    public final class EntrySet extends AbstractObjectSet<Short2ReferenceMap.Entry<V>> implements Short2ReferenceMap.FastEntrySet<V> {
        ...
        public ObjectIterator<Short2ReferenceMap.Entry<V>> iterator() {
            return new ObjectIterator<Short2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.shorts.Short2ReferenceArrayMap.EntrySet.1
                int curr = -1;
                int next = 0;
                ...
                public Short2ReferenceMap.Entry<V> next() {
                    ...
                    short[] sArr = Short2ReferenceArrayMap.this.key;
                    int i = this.next;
                    this.curr = i;
                    short s = sArr[i];
                    ...
                    int i2 = this.next;
                    this.next = i2 + 1;
                    return new AbstractShort2ReferenceMap.BasicEntry(s, objArr[i2]);
                }
                ...
                public void remove() {
                    ...
                    this.curr = -1;
                    int access$010 = Short2ReferenceArrayMap.access$010(Short2ReferenceArrayMap.this);
                    int i = this.next;
                    this.next = i - 1;
                ...
                public void forEachRemaining(Consumer<? super Short2ReferenceMap.Entry<V>> action) {
                    ...
                    while (this.next < max) {
                        ...
                        int i2 = this.next;
                        this.next = i2 + 1;
                        action.accept(new AbstractShort2ReferenceMap.BasicEntry(s, objArr[i2]));
                    }
                }
            };
        }
        ...
        public ObjectIterator<Short2ReferenceMap.Entry<V>> fastIterator() {
            return new ObjectIterator<Short2ReferenceMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.shorts.Short2ReferenceArrayMap.EntrySet.2
                int next = 0;
                int curr = -1;
                ...
                public Short2ReferenceMap.Entry<V> next() {
                    ...
                    AbstractShort2ReferenceMap.BasicEntry<V> basicEntry2 = this.entry;
                    Object[] objArr = Short2ReferenceArrayMap.this.value;
                    int i2 = this.next;
                    this.next = i2 + 1;
        ...
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceArrayMap$EntrySet$EntrySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceArrayMap$EntrySet$EntrySetSpliterator.class */
        public final class EntrySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<Short2ReferenceMap.Entry<V>> implements ObjectSpliterator<Short2ReferenceMap.Entry<V>> {
            ...
            public final Short2ReferenceMap.Entry<V> get(int location) {
                return new AbstractShort2ReferenceMap.BasicEntry(Short2ReferenceArrayMap.this.key[location], Short2ReferenceArrayMap.this.value[location]);
            }

            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Short2ReferenceArrayMap<V>.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
        ...
        public void forEach(Consumer<? super Short2ReferenceMap.Entry<V>> action) {
            int max = Short2ReferenceArrayMap.this.size;
            for (int i = 0; i < max; i++) {
                action.accept(new AbstractShort2ReferenceMap.BasicEntry(Short2ReferenceArrayMap.this.key[i], Short2ReferenceArrayMap.this.value[i]));
            }
        }
        ...
        public boolean remove(Object o) {
            ...
            if (oldPos == -1 || value != Short2ReferenceArrayMap.this.value[oldPos]) {
                return false;
            }
            ...
            Short2ReferenceArrayMap.access$010(Short2ReferenceArrayMap.this);
            Short2ReferenceArrayMap.this.value[Short2ReferenceArrayMap.this.size] = null;
            return true;
        }
    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceArrayMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceArrayMap$KeySet.class */
    public final class KeySet extends AbstractShortSet {
        ...
        public ShortIterator iterator() {
            return new ShortIterator() { // from class: it.unimi.dsi.fastutil.shorts.Short2ReferenceArrayMap.KeySet.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceArrayMap$KeySet$KeySetSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceArrayMap$KeySet$KeySetSpliterator.class */
        public final class KeySetSpliterator extends ShortSpliterators.EarlyBindingSizeIndexBasedSpliterator implements ShortSpliterator {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.shorts.ShortSpliterators.AbstractIndexBasedSpliterator
            public final Short2ReferenceArrayMap<V>.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceArrayMap$ValuesCollection */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceArrayMap$ValuesCollection.class */
    public final class ValuesCollection extends AbstractReferenceCollection<V> {
        ...
        public ObjectIterator<V> iterator() {
            return new ObjectIterator<V>() { // from class: it.unimi.dsi.fastutil.shorts.Short2ReferenceArrayMap.ValuesCollection.1
                int pos = 0;
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ReferenceArrayMap$ValuesCollection$ValuesSpliterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ReferenceArrayMap$ValuesCollection$ValuesSpliterator.class */
        public final class ValuesSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<V> implements ObjectSpliterator<V> {
            ...
            /* access modifiers changed from: protected */
            @Override // p014it.unimi.dsi.fastutil.objects.ObjectSpliterators.AbstractIndexBasedSpliterator
            public final Short2ReferenceArrayMap<V>.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
    ...
    public Short2ReferenceArrayMap<V> clone() {
        try {
            Short2ReferenceArrayMap<V> c = (Short2ReferenceArrayMap) clone();
