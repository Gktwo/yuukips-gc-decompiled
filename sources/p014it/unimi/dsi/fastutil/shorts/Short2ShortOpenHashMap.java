...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortOpenHashMap.class */
public class Short2ShortOpenHashMap extends AbstractShort2ShortMap implements Serializable, Cloneable, Hash {
    ...
    /* renamed from: n */
    protected transient int f3008n;
    protected transient int maxFill;
    protected final transient int minN;
    protected int size;

    /* renamed from: f */
    protected final float f3009f;
    ...
    public Short2ShortOpenHashMap(int expected, float f) {
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.f3008n = arraySize;
            this.minN = arraySize;
            this.mask = this.f3008n - 1;
            this.maxFill = HashCommon.maxFill(this.f3008n, f);
            this.key = new short[this.f3008n + 1];
            this.value = new short[this.f3008n + 1];
        }
    }
    ...
    private void ensureCapacity(int capacity) {
        int needed = HashCommon.arraySize(capacity, this.f3009f);
        if (needed > this.f3008n) {
            rehash(needed);
        }
    }

    private void tryCapacity(long capacity) {
        int needed = (int) Math.min((long) FileSize.GB_COEFFICIENT, Math.max(2L, HashCommon.nextPowerOfTwo((long) Math.ceil((double) (((float) capacity) / this.f3009f)))));
        if (needed > this.f3008n) {
            rehash(needed);
        }
    }
    ...
    public short removeEntry(int pos) {
        ...
        this.size--;
        shiftKeys(pos);
        if (this.f3008n > this.minN && this.size < this.maxFill / 4 && this.f3008n > 16) {
            rehash(this.f3008n / 2);
        }
        return oldValue;
    }
    ...
    public short removeNullEntry() {
        ...
        short oldValue = this.value[this.f3008n];
        this.size--;
        if (this.f3008n > this.minN && this.size < this.maxFill / 4 && this.f3008n > 16) {
            rehash(this.f3008n / 2);
        }
    ...
    private int find(short k) {
        short curr;
        if (k == 0) {
            return this.containsNullKey ? this.f3008n : -(this.f3008n + 1);
        }
        short[] key = this.key;
    ...
    private void insert(int pos, short k, short v) {
        ...
        this.size = i + 1;
        if (i >= this.maxFill) {
            rehash(HashCommon.arraySize(this.size + 1, this.f3009f));
        }
    }
    ...
    public short addTo(short k, short incr) {
        ...
        if (k != 0) {
            ...
            return addToValue(this.f3008n, incr);
        } else {
            pos = this.f3008n;
            this.containsNullKey = true;
        }
    ...
    public short get(short k) {
        short curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f3008n] : this.defRetValue;
        }
        short[] key = this.key;
        int mix = HashCommon.mix((int) k) & this.mask;
        int pos = mix;
    ...
    public boolean containsValue(short v) {
        ...
        short[] key = this.key;
        if (this.containsNullKey && value[this.f3008n] == v) {
            return true;
        }
        int i = this.f3008n;
        while (true) {
    ...
    public short getOrDefault(short k, short defaultValue) {
        short curr;
        if (k == 0) {
            return this.containsNullKey ? this.value[this.f3008n] : defaultValue;
        }
        short[] key = this.key;
        int mix = HashCommon.mix((int) k) & this.mask;
        int pos = mix;
    ...
    public boolean remove(short k, short v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f3008n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortOpenHashMap$MapEntry.class */
    public final class MapEntry implements Short2ShortMap.Entry, Map.Entry<Short, Short>, ShortShortPair {
        ...
        public boolean equals(Object o) {
            ...
            return Short2ShortOpenHashMap.this.key[this.index] == e.getKey().shortValue() && Short2ShortOpenHashMap.this.value[this.index] == e.getValue().shortValue();
        }
        ...
        public String toString() {
            return ((int) Short2ShortOpenHashMap.this.key[this.index]) + "=>" + ((int) Short2ShortOpenHashMap.this.value[this.index]);
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortOpenHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Short2ShortOpenHashMap.this.f3008n;
            this.last = -1;
            this.f3010c = Short2ShortOpenHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Short2ShortOpenHashMap.this.f3008n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int i3 = Short2ShortOpenHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (k == key[p]) {
                            return p;
                        ...
                        mix = p + 1;
                        i3 = Short2ShortOpenHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Short2ShortOpenHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Short2ShortOpenHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Short2ShortOpenHashMap.this.value[pos] = Short2ShortOpenHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Short2ShortOpenHashMap.this.f3008n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortOpenHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Short2ShortMap.Entry>> implements ObjectIterator<Short2ShortMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortOpenHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortOpenHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Short2ShortOpenHashMap.this.f3008n;
            this.f3011c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f3011c++;
                acceptOnIndex(action, Short2ShortOpenHashMap.this.f3008n);
                return true;
            }
            short[] key = Short2ShortOpenHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Short2ShortOpenHashMap.this.size - this.f3011c);
            }
            return Math.min((long) (Short2ShortOpenHashMap.this.size - this.f3011c), ((long) ((((double) Short2ShortOpenHashMap.this.realSize()) / ((double) Short2ShortOpenHashMap.this.f3008n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap r0 = p014it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap.this
                short[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortOpenHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Short2ShortMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Short2ShortMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortOpenHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Short2ShortMap.Entry> implements Short2ShortMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (k == 0) {
                return Short2ShortOpenHashMap.this.containsNullKey && Short2ShortOpenHashMap.this.value[Short2ShortOpenHashMap.this.f3008n] == v;
            }
            short[] key = Short2ShortOpenHashMap.this.key;
            int mix = HashCommon.mix((int) k) & Short2ShortOpenHashMap.this.mask;
            int pos = mix;
            short curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            ...
            do {
                int i = (pos + 1) & Short2ShortOpenHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (k != 0) {
                ...
                if (curr != k) {
                    while (true) {
                        ...
                        if (curr2 == k && Short2ShortOpenHashMap.this.value[pos] == v) {
                            Short2ShortOpenHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Short2ShortOpenHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Short2ShortOpenHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Short2ShortOpenHashMap.this.containsNullKey || Short2ShortOpenHashMap.this.value[Short2ShortOpenHashMap.this.f3008n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Short2ShortMap.Entry> consumer) {
            if (Short2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2ShortMap.BasicEntry(Short2ShortOpenHashMap.this.key[Short2ShortOpenHashMap.this.f3008n], Short2ShortOpenHashMap.this.value[Short2ShortOpenHashMap.this.f3008n]));
            }
            int pos = Short2ShortOpenHashMap.this.f3008n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Short2ShortMap.Entry> consumer) {
            ...
            if (Short2ShortOpenHashMap.this.containsNullKey) {
                entry.key = Short2ShortOpenHashMap.this.key[Short2ShortOpenHashMap.this.f3008n];
                entry.value = Short2ShortOpenHashMap.this.value[Short2ShortOpenHashMap.this.f3008n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortOpenHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortOpenHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortOpenHashMap$KeySet.class */
    public final class KeySet extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            if (Short2ShortOpenHashMap.this.containsNullKey) {
                consumer.accept(Short2ShortOpenHashMap.this.key[Short2ShortOpenHashMap.this.f3008n]);
            }
            int pos = Short2ShortOpenHashMap.this.f3008n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortOpenHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ShortOpenHashMap$ValueSpliterator.class */
    ...
    public Collection<Short> values() {
        if (this.values == null) {
            this.values = new AbstractShortCollection() { // from class: it.unimi.dsi.fastutil.shorts.Short2ShortOpenHashMap.1
                ...
                public void forEach(ShortConsumer consumer) {
                    if (Short2ShortOpenHashMap.this.containsNullKey) {
                        consumer.accept(Short2ShortOpenHashMap.this.value[Short2ShortOpenHashMap.this.f3008n]);
                    }
                    int pos = Short2ShortOpenHashMap.this.f3008n;
                    while (true) {
                        pos--;
    ...
    public boolean trim(int n) {
        int l = HashCommon.nextPowerOfTwo((int) Math.ceil((double) (((float) n) / this.f3009f)));
        if (l >= this.f3008n || this.size > HashCommon.maxFill(l, this.f3009f)) {
            return true;
        }
        try {
            rehash(l);
    ...
    protected void rehash(int newN) {
        ...
        while (true) {
            ...
            if (j != 0) {
                ...
                newValue[newN] = value[this.f3008n];
                this.f3008n = newN;
                this.mask = mask;
                this.maxFill = HashCommon.maxFill(this.f3008n, this.f3009f);
                this.key = newKey;
                this.value = newValue;
                return;
            }
    ...
    public Short2ShortOpenHashMap clone() {
        try {
            Short2ShortOpenHashMap c = (Short2ShortOpenHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        int pos;
        s.defaultReadObject();
        this.f3008n = HashCommon.arraySize(this.size, this.f3009f);
        this.maxFill = HashCommon.maxFill(this.f3008n, this.f3009f);
        this.mask = this.f3008n - 1;
        short[] key = new short[this.f3008n + 1];
        this.key = key;
        short[] value = new short[this.f3008n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
