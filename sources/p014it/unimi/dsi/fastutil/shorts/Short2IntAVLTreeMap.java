...
import p014it.unimi.dsi.fastutil.shorts.AbstractShort2IntSortedMap;
import p014it.unimi.dsi.fastutil.shorts.Short2IntMap;

/* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntAVLTreeMap.class */
public class Short2IntAVLTreeMap extends AbstractShort2IntSortedMap implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Short2IntAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap.Entry add(short r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap.add(short):it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap$Entry");
    }
    ...
    @Override // p014it.unimi.dsi.fastutil.shorts.Short2IntFunction
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public int remove(short r5) {
        /*
        // Method dump skipped, instructions count: 1494
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap.remove(short):int");
    }
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntAVLTreeMap$Entry.class */
    public static final class Entry extends AbstractShort2IntMap.BasicEntry implements Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShort2IntMap.BasicEntry, p014it.unimi.dsi.fastutil.shorts.Short2IntMap.Entry
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShort2IntMap.BasicEntry, java.util.Map.Entry, java.lang.Object
        public boolean equals(Object o) {
            if (!(o instanceof Map.Entry)) {
                return false;
            }
            Map.Entry<Short, Integer> e = (Map.Entry) o;
            return this.key == e.getKey().shortValue() && this.value == e.getValue().intValue();
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShort2IntMap.BasicEntry, java.lang.Object
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(short k) {
            Entry locateKey = Short2IntAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntAVLTreeMap$EntryIterator.class */
    ...
    public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2IntMap.Entry>() { // from class: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap.1
                final Comparator<? super Short2IntMap.Entry> comparator;

                {
                    this.comparator = Short2IntAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Short) && e.getValue() != null && (e.getValue() instanceof Integer)) {
                        return e.equals(Short2IntAVLTreeMap.this.findKey(((Short) e.getKey()).shortValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Short) || !(e.getValue() instanceof Integer) || (f = Short2IntAVLTreeMap.this.findKey(((Short) e.getKey()).shortValue())) == null || f.getIntValue() != ((Integer) e.getValue()).intValue()) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntAVLTreeMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntAVLTreeMap$KeySet.class */
    public class KeySet extends AbstractShort2IntSortedMap.KeySet {
        private KeySet() {
            super();
        }

        @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShort2IntSortedMap.KeySet, p014it.unimi.dsi.fastutil.shorts.AbstractShortSortedSet, p014it.unimi.dsi.fastutil.shorts.AbstractShortSet, p014it.unimi.dsi.fastutil.shorts.AbstractShortCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.shorts.ShortCollection, p014it.unimi.dsi.fastutil.shorts.ShortIterable
        public ShortBidirectionalIterator iterator() {
            return new KeyIterator();
        }

        @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShort2IntSortedMap.KeySet, p014it.unimi.dsi.fastutil.shorts.ShortSortedSet
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntAVLTreeMap$ValueIterator.class */
    ...
    public IntCollection values() {
        if (this.values == null) {
            this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntAVLTreeMap$Submap.class */
    public final class Submap extends AbstractShort2IntSortedMap implements Serializable {
        ...
        /* renamed from: in */
        final boolean m456in(short k) {
            return (this.bottom || Short2IntAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2IntAVLTreeMap.this.compare(k, this.f2953to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.shorts.Short2IntMap, p014it.unimi.dsi.fastutil.shorts.Short2IntSortedMap
        public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2IntMap.Entry>() { // from class: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectSortedSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectSet, p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator() {
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Short) && e.getValue() != null && (e.getValue() instanceof Integer) && (f = Short2IntAVLTreeMap.this.findKey(((Short) e.getKey()).shortValue())) != null && Submap.this.m456in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry f = Short2IntAVLTreeMap.this.findKey(((Short) e.getKey()).shortValue());
                        if (f != null && Submap.this.m456in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractShort2IntSortedMap.KeySet {
            private KeySet() {
                super();
            }
        ...
        public IntCollection values() {
            if (this.values == null) {
                this.values = new AbstractIntCollection() { // from class: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.ints.AbstractIntCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.ints.IntCollection, p014it.unimi.dsi.fastutil.ints.IntIterable
                    public IntIterator iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShort2IntMap, p014it.unimi.dsi.fastutil.shorts.Short2IntFunction, p014it.unimi.dsi.fastutil.shorts.Short2IntMap
        public boolean containsKey(short k) {
            return m456in(k) && Short2IntAVLTreeMap.this.containsKey(k);
        }
        ...
        public int get(short k) {
            Entry e;
            return (!m456in(k) || (e = Short2IntAVLTreeMap.this.findKey(k)) == null) ? this.defRetValue : e.value;
        }
        ...
        public int put(short k, int v) {
            ...
            if (!m456in(k)) {
                throw new IllegalArgumentException("Key (" + ((int) k) + ") out of range [" + (this.bottom ? "-" : String.valueOf((int) this.from)) + ", " + (this.top ? "-" : String.valueOf((int) this.f2953to)) + ")");
            }
            return Short2IntAVLTreeMap.this.modified ? this.defRetValue : Short2IntAVLTreeMap.this.put(k, v);
        }
        ...
        public int remove(short k) {
            ...
            return Short2IntAVLTreeMap.this.modified ? Short2IntAVLTreeMap.this.remove(k) : this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2IntSortedMap
        public Short2IntSortedMap headMap(short to) {
            if (!this.top && Short2IntAVLTreeMap.this.compare(to, this.f2953to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2IntSortedMap
        public Short2IntSortedMap tailMap(short from) {
            if (!this.bottom && Short2IntAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f2953to, this.top);
        }
        ...
        public Short2IntSortedMap subMap(short from, short to) {
            ...
            if (!this.top) {
                to = Short2IntAVLTreeMap.this.compare(to, this.f2953to) < 0 ? to : this.f2953to;
            }
            if (!this.bottom) {
                from = Short2IntAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f2953to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Short2IntAVLTreeMap.this.compare(e.key, this.f2953to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Short2IntAVLTreeMap.this.locateKey(this.f2953to);
                if (Short2IntAVLTreeMap.this.compare(e.key, this.f2953to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Short2IntAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends TreeIterator {
            ...
            SubmapIterator(Submap submap, short k) {
                ...
                if (submap.bottom || Short2IntAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Short2IntAVLTreeMap short2IntAVLTreeMap = Short2IntAVLTreeMap.this;
                        Entry lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (short2IntAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Short2IntAVLTreeMap.this.compare(this.next.key, Submap.this.f2953to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntAVLTreeMap$Submap$SubmapEntryIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntAVLTreeMap$Submap$SubmapKeyIterator.class */
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2IntAVLTreeMap$Submap$SubmapValueIterator.class */
    ...
    public Short2IntAVLTreeMap clone() {
        try {
            Short2IntAVLTreeMap c = (Short2IntAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private Entry readTree(ObjectInputStream s, int n, Entry pred, Entry succ) throws IOException, ClassNotFoundException {
        if (n == 1) {
            ...
            Entry top2 = new Entry(s.readShort(), s.readInt());
            top2.right(new Entry(s.readShort(), s.readInt()));
