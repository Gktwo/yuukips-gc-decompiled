...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectAVLTreeMap.class */
public class Short2ObjectAVLTreeMap<V> extends AbstractShort2ObjectSortedMap<V> implements Serializable, Cloneable {
    ...
    static {
        $assertionsDisabled = !Short2ObjectAVLTreeMap.class.desiredAssertionStatus();
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x01c0, code lost:
        if (p014it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap.$assertionsDisabled != false) goto L_0x01d4;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:83:0x02c3, code lost:
        if (p014it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap.$assertionsDisabled != false) goto L_0x02d7;
     */
    ...
    private p014it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap.Entry<V> add(short r9) {
        /*
        // Method dump skipped, instructions count: 923
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap.add(short):it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap$Entry");
    }
    ...
    public V remove(short r5) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap.remove(short):java.lang.Object");
    }

    @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShort2ObjectMap, java.util.Map
    public boolean containsValue(Object v) {
        Short2ObjectAVLTreeMap<V>.ValueIterator i = new ValueIterator();
        int j = this.count;
        do {
            j--;
            if (j == 0) {
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap$Entry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectAVLTreeMap$Entry.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap$TreeIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectAVLTreeMap$TreeIterator.class */
    private class TreeIterator {
        ...
        TreeIterator(short k) {
            Entry<V> locateKey = Short2ObjectAVLTreeMap.this.locateKey(k);
            this.next = locateKey;
            if (locateKey == null) {
                return;
            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectAVLTreeMap$EntryIterator.class */
    public class EntryIterator extends Short2ObjectAVLTreeMap<V>.TreeIterator implements ObjectListIterator<Short2ObjectMap.Entry<V>> {
    ...
    public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
        if (this.entries == null) {
            this.entries = new AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap.1
                final Comparator<? super Short2ObjectMap.Entry<V>> comparator;

                {
                    this.comparator = Short2ObjectAVLTreeMap.this.actualComparator == null ? x, y -> {
                ...
                public boolean contains(Object o) {
                    ...
                    if (e.getKey() != null && (e.getKey() instanceof Short)) {
                        return e.equals(Short2ObjectAVLTreeMap.this.findKey(((Short) e.getKey()).shortValue()));
                    }
                    return false;
                }
                ...
                public boolean remove(Object o) {
                    ...
                    Map.Entry<?, ?> e = (Map.Entry) o;
                    if (e.getKey() == null || e.getKey() == null || !(e.getKey() instanceof Short) || (f = Short2ObjectAVLTreeMap.this.findKey(((Short) e.getKey()).shortValue())) == null || !Objects.equals(f.getValue(), e.getValue())) {
                        return false;
                    }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectAVLTreeMap$KeyIterator.class */
    public final class KeyIterator extends Short2ObjectAVLTreeMap<V>.TreeIterator implements ShortListIterator {
        public KeyIterator() {
            super();
        }
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectAVLTreeMap$KeySet.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectAVLTreeMap$ValueIterator.class */
    public final class ValueIterator extends Short2ObjectAVLTreeMap<V>.TreeIterator implements ObjectListIterator<V> {
    ...
    public ObjectCollection<V> values() {
        if (this.values == null) {
            this.values = new AbstractObjectCollection<V>() { // from class: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap.2
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap$Submap */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectAVLTreeMap$Submap.class */
    public final class Submap extends AbstractShort2ObjectSortedMap<V> implements Serializable {
        ...
        @Override // p014it.unimi.dsi.fastutil.Function, p014it.unimi.dsi.fastutil.bytes.Byte2BooleanMap, java.util.Map
        public void clear() {
            Short2ObjectAVLTreeMap<V>.Submap.SubmapIterator i = new SubmapIterator();
            while (i.hasNext()) {
                i.nextEntry();
                i.remove();
            }
        ...
        /* renamed from: in */
        final boolean m452in(short k) {
            return (this.bottom || Short2ObjectAVLTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2ObjectAVLTreeMap.this.compare(k, this.f2977to) < 0);
        }

        @Override // p014it.unimi.dsi.fastutil.shorts.Short2ObjectMap, p014it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap
        public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
            if (this.entries == null) {
                this.entries = new AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>() { // from class: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap.Submap.1
                    @Override // p014it.unimi.dsi.fastutil.objects.ObjectSortedSet
                    public /* bridge */ /* synthetic */ ObjectBidirectionalIterator iterator(Object obj) {
                        return iterator((Short2ObjectMap.Entry) ((Short2ObjectMap.Entry) obj));
                    }
                    ...
                    public boolean contains(Object o) {
                        ...
                        Map.Entry<?, ?> e = (Map.Entry) o;
                        return e.getKey() != null && (e.getKey() instanceof Short) && (f = Short2ObjectAVLTreeMap.this.findKey(((Short) e.getKey()).shortValue())) != null && Submap.this.m452in(f.key) && e.equals(f);
                    }
                    ...
                    public boolean remove(Object o) {
                        ...
                        Entry<V> f = Short2ObjectAVLTreeMap.this.findKey(((Short) e.getKey()).shortValue());
                        if (f != null && Submap.this.m452in(f.key)) {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap$Submap$KeySet */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectAVLTreeMap$Submap$KeySet.class */
        public class KeySet extends AbstractShort2ObjectSortedMap<V>.KeySet {
            private KeySet() {
                super();
            }
        ...
        public ObjectCollection<V> values() {
            if (this.values == null) {
                this.values = new AbstractObjectCollection<V>() { // from class: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap.Submap.2
                    @Override // p014it.unimi.dsi.fastutil.objects.AbstractObjectCollection, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, p014it.unimi.dsi.fastutil.objects.ObjectCollection, p014it.unimi.dsi.fastutil.objects.ObjectIterable
                    public ObjectIterator<V> iterator() {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShort2ObjectMap, p014it.unimi.dsi.fastutil.shorts.Short2ObjectFunction, p014it.unimi.dsi.fastutil.shorts.Short2ObjectMap
        public boolean containsKey(short k) {
            return m452in(k) && Short2ObjectAVLTreeMap.this.containsKey(k);
        }
        ...
        public V get(short k) {
            Entry<V> e;
            return (!m452in(k) || (e = Short2ObjectAVLTreeMap.this.findKey(k)) == null) ? (V) this.defRetValue : (V) e.value;
        }
        ...
        public V put(short k, V v) {
            ...
            if (!m452in(k)) {
                throw new IllegalArgumentException("Key (" + ((int) k) + ") out of range [" + (this.bottom ? "-" : String.valueOf((int) this.from)) + ", " + (this.top ? "-" : String.valueOf((int) this.f2977to)) + ")");
            }
            return Short2ObjectAVLTreeMap.this.modified ? (V) this.defRetValue : (V) Short2ObjectAVLTreeMap.this.put(k, (short) v);
        }
        ...
        public V remove(short k) {
            ...
            return Short2ObjectAVLTreeMap.this.modified ? (V) Short2ObjectAVLTreeMap.this.remove(k) : (V) this.defRetValue;
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap
        public Short2ObjectSortedMap<V> headMap(short to) {
            if (!this.top && Short2ObjectAVLTreeMap.this.compare(to, this.f2977to) >= 0) {
                return this;
            }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2ObjectSortedMap
        public Short2ObjectSortedMap<V> tailMap(short from) {
            if (!this.bottom && Short2ObjectAVLTreeMap.this.compare(from, this.from) <= 0) {
                return this;
            }
            return new Submap(from, false, this.f2977to, this.top);
        }
        ...
        public Short2ObjectSortedMap<V> subMap(short from, short to) {
            ...
            if (!this.top) {
                to = Short2ObjectAVLTreeMap.this.compare(to, this.f2977to) < 0 ? to : this.f2977to;
            }
            if (!this.bottom) {
                from = Short2ObjectAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
            }
            return (this.top || this.bottom || from != this.from || to != this.f2977to) ? new Submap(from, false, to, false) : this;
        }
        ...
        public Entry<V> firstEntry() {
            ...
            if (this.top || Short2ObjectAVLTreeMap.this.compare(e.key, this.f2977to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry<V> lastEntry() {
            ...
            if (this.top) {
                ...
                e = Short2ObjectAVLTreeMap.this.locateKey(this.f2977to);
                if (Short2ObjectAVLTreeMap.this.compare(e.key, this.f2977to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
            ...
            if (this.bottom || Short2ObjectAVLTreeMap.this.compare(e.key, this.from) >= 0) {
                return e;
            }
            return null;
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap$Submap$SubmapIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectAVLTreeMap$Submap$SubmapIterator.class */
        public class SubmapIterator extends Short2ObjectAVLTreeMap<V>.TreeIterator {
            SubmapIterator() {
                super();
            ...
            SubmapIterator(Submap submap, short k) {
                ...
                if (submap.bottom || Short2ObjectAVLTreeMap.this.compare(k, this.next.key) >= 0) {
                    if (!submap.top) {
                        Short2ObjectAVLTreeMap short2ObjectAVLTreeMap = Short2ObjectAVLTreeMap.this;
                        Entry<V> lastEntry = submap.lastEntry();
                        this.prev = lastEntry;
                        if (short2ObjectAVLTreeMap.compare(k, lastEntry.key) >= 0) {
                            this.next = null;
                            return;
                        }
                    }
            ...
            @Override // p014it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap.TreeIterator
            void updatePrevious() {
                this.prev = this.prev.prev();
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Short2ObjectAVLTreeMap.this.compare(this.next.key, Submap.this.f2977to) >= 0) {
                    this.next = null;
                }
            }
        }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap$Submap$SubmapEntryIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectAVLTreeMap$Submap$SubmapEntryIterator.class */
        public class SubmapEntryIterator extends Short2ObjectAVLTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Short2ObjectMap.Entry<V>> {
            SubmapEntryIterator() {
                super();
            }
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap$Submap$SubmapKeyIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectAVLTreeMap$Submap$SubmapKeyIterator.class */
        public final class SubmapKeyIterator extends Short2ObjectAVLTreeMap<V>.Submap.SubmapIterator implements ShortListIterator {
        ...
        /* access modifiers changed from: private */
        /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ObjectAVLTreeMap$Submap$SubmapValueIterator */
        /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ObjectAVLTreeMap$Submap$SubmapValueIterator.class */
        public final class SubmapValueIterator extends Short2ObjectAVLTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<V> {
    ...
    public Short2ObjectAVLTreeMap<V> clone() {
        try {
            Short2ObjectAVLTreeMap<V> c = (Short2ObjectAVLTreeMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
            c.allocatePaths();
    ...
    private void writeObject(ObjectOutputStream s) throws IOException {
        int n = this.count;
        Short2ObjectAVLTreeMap<V>.EntryIterator i = new EntryIterator();
