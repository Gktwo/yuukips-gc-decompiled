...
public class Short2DoubleRBTreeMap extends AbstractShort2DoubleSortedMap implements Serializable, Cloneable {
    ...
    public final class Submap extends AbstractShort2DoubleSortedMap implements Serializable {
        ...
        final boolean m459in(short k) {
            return (this.bottom || Short2DoubleRBTreeMap.this.compare(k, this.from) >= 0) && (this.top || Short2DoubleRBTreeMap.this.compare(k, this.f2940to) < 0);
        }
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2DoubleSortedMap
        public Short2DoubleSortedMap headMap(short to) {
            if (!this.top && Short2DoubleRBTreeMap.this.compare(to, this.f2940to) >= 0) {
                return this;
            }
        ...
        public Short2DoubleSortedMap subMap(short from, short to) {
            ...
            if (!this.top) {
                to = Short2DoubleRBTreeMap.this.compare(to, this.f2940to) < 0 ? to : this.f2940to;
            }
            if (!this.bottom) {
        ...
        public Entry firstEntry() {
            ...
            if (this.top || Short2DoubleRBTreeMap.this.compare(e.key, this.f2940to) < 0) {
                return e;
            }
            return null;
        }
        ...
        public Entry lastEntry() {
            ...
            if (this.top) {
                ...
                e = Short2DoubleRBTreeMap.this.locateKey(this.f2940to);
                if (Short2DoubleRBTreeMap.this.compare(e.key, this.f2940to) >= 0) {
                    e = e.prev();
                }
            }
            if (e == null) {
        ...
        public class SubmapIterator extends TreeIterator {
            ...
            void updateNext() {
                this.next = this.next.next();
                if (!Submap.this.top && this.next != null && Short2DoubleRBTreeMap.this.compare(this.next.key, Submap.this.f2940to) >= 0) {
                    this.next = null;
                }
            }
        }
