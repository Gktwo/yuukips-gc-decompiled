...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ByteOpenCustomHashMap.class */
public class Short2ByteOpenCustomHashMap extends AbstractShort2ByteMap implements Serializable, Cloneable, Hash {
    ...
    public Short2ByteOpenCustomHashMap(int expected, float f, ShortHash.Strategy strategy) {
        ...
        if (f <= 0.0f || f >= 1.0f) {
            ...
            this.value = new byte[this.f2908n + 1];
        }
    }
    ...
    public byte removeNullEntry() {
        ...
        byte oldValue = this.value[this.f2908n];
        this.size--;
        if (this.f2908n > this.minN && this.size < this.maxFill / 4 && this.f2908n > 16) {
            rehash(this.f2908n / 2);
        }
    ...
    public boolean containsValue(byte v) {
        ...
        short[] key = this.key;
        if (this.containsNullKey && value[this.f2908n] == v) {
            return true;
        }
        int i = this.f2908n;
        while (true) {
    ...
    public boolean remove(short k, byte v) {
        ...
        } else if (!this.containsNullKey || v != this.value[this.f2908n]) {
            return false;
        } else {
            removeNullEntry();
            return true;
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap$MapEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ByteOpenCustomHashMap$MapEntry.class */
    public final class MapEntry implements Short2ByteMap.Entry, Map.Entry<Short, Byte>, ShortBytePair {
        ...
        public boolean equals(Object o) {
            ...
            return Short2ByteOpenCustomHashMap.this.strategy.equals(Short2ByteOpenCustomHashMap.this.key[this.index], e.getKey().shortValue()) && Short2ByteOpenCustomHashMap.this.value[this.index] == e.getValue().byteValue();
        }
        ...
        public String toString() {
            return ((int) Short2ByteOpenCustomHashMap.this.key[this.index]) + "=>" + ((int) Short2ByteOpenCustomHashMap.this.value[this.index]);
        }
    }

    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap$MapIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ByteOpenCustomHashMap$MapIterator.class */
    private abstract class MapIterator<ConsumerType> {
        ...
        private MapIterator() {
            this.pos = Short2ByteOpenCustomHashMap.this.f2908n;
            this.last = -1;
            this.f2910c = Short2ByteOpenCustomHashMap.this.size;
        ...
        public int nextEntry() {
            ...
            if (this.mustReturnNullKey) {
                ...
                int i = Short2ByteOpenCustomHashMap.this.f2908n;
                this.last = i;
                return i;
            }
            ...
            do {
                ...
                if (i2 < 0) {
                    ...
                    int mix = HashCommon.mix(Short2ByteOpenCustomHashMap.this.strategy.hashCode(k));
                    int i3 = Short2ByteOpenCustomHashMap.this.mask;
                    while (true) {
                        int p = mix & i3;
                        if (Short2ByteOpenCustomHashMap.this.strategy.equals(k, key[p])) {
                            return p;
                        }
                        mix = p + 1;
                        i3 = Short2ByteOpenCustomHashMap.this.mask;
                    }
                }
        ...
        private void shiftKeys(int pos) {
            ...
            while (true) {
                int i = pos + 1;
                int i2 = Short2ByteOpenCustomHashMap.this.mask;
                while (true) {
                    pos = i & i2;
                    curr = key[pos];
                    if (curr == 0) {
                    ...
                    if (pos <= pos) {
                        ...
                        i = pos + 1;
                        i2 = Short2ByteOpenCustomHashMap.this.mask;
                    } else {
                        if (pos >= slot && slot > pos) {
                            break;
                        }
                ...
                key[pos] = curr;
                Short2ByteOpenCustomHashMap.this.value[pos] = Short2ByteOpenCustomHashMap.this.value[pos];
            }
        }
        ...
        public void remove() {
            ...
            if (this.last == Short2ByteOpenCustomHashMap.this.f2908n) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap$EntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ByteOpenCustomHashMap$EntryIterator.class */
    public final class EntryIterator extends MapIterator<Consumer<? super Short2ByteMap.Entry>> implements ObjectIterator<Short2ByteMap.Entry> {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap.MapIterator, java.util.Iterator
        public void remove() {
            remove();
            this.entry.index = -1;
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap$FastEntryIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ByteOpenCustomHashMap$FastEntryIterator.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap$MapSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ByteOpenCustomHashMap$MapSpliterator.class */
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        MapSpliterator() {
            this.pos = 0;
            this.max = Short2ByteOpenCustomHashMap.this.f2908n;
            this.f2911c = 0;
        ...
        public boolean tryAdvance(ConsumerType action) {
            if (this.mustReturnNull) {
                ...
                this.f2911c++;
                acceptOnIndex(action, Short2ByteOpenCustomHashMap.this.f2908n);
                return true;
            }
            short[] key = Short2ByteOpenCustomHashMap.this.key;
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return (long) (Short2ByteOpenCustomHashMap.this.size - this.f2911c);
            }
            return Math.min((long) (Short2ByteOpenCustomHashMap.this.size - this.f2911c), ((long) ((((double) Short2ByteOpenCustomHashMap.this.realSize()) / ((double) Short2ByteOpenCustomHashMap.this.f2908n)) * ((double) (this.max - this.pos)))) + ((long) (this.mustReturnNull ? 1 : 0)));
        }
        ...
        public long skip(long r7) {
            ...
            L_0x003f:
                r0 = r6
                it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap r0 = p014it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap.this
                short[] r0 = r0.key
                r11 = r0
            L_0x0048:
                r0 = r6
            ...
            L_0x0075:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: p014it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap.MapSpliterator.skip(long):long");
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap$EntrySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ByteOpenCustomHashMap$EntrySpliterator.class */
    public final class EntrySpliterator extends MapSpliterator<Consumer<? super Short2ByteMap.Entry>, EntrySpliterator> implements ObjectSpliterator<Short2ByteMap.Entry> {
        ...
        /* access modifiers changed from: package-private */
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap.MapSpliterator
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap$MapEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ByteOpenCustomHashMap$MapEntrySet.class */
    public final class MapEntrySet extends AbstractObjectSet<Short2ByteMap.Entry> implements Short2ByteMap.FastEntrySet {
        ...
        public boolean contains(Object o) {
            ...
            if (Short2ByteOpenCustomHashMap.this.strategy.equals(k, 0)) {
                return Short2ByteOpenCustomHashMap.this.containsNullKey && Short2ByteOpenCustomHashMap.this.value[Short2ByteOpenCustomHashMap.this.f2908n] == v;
            }
            short[] key = Short2ByteOpenCustomHashMap.this.key;
            int mix = HashCommon.mix(Short2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ByteOpenCustomHashMap.this.mask;
            int pos = mix;
            short curr2 = key[mix];
            if (curr2 == 0) {
                return false;
            }
            if (Short2ByteOpenCustomHashMap.this.strategy.equals(k, curr2)) {
                return Short2ByteOpenCustomHashMap.this.value[pos] == v;
            }
            do {
                int i = (pos + 1) & Short2ByteOpenCustomHashMap.this.mask;
                pos = i;
                curr = key[i];
                if (curr == 0) {
                    return false;
            ...
            if (!Short2ByteOpenCustomHashMap.this.strategy.equals(k, 0)) {
                ...
                if (!Short2ByteOpenCustomHashMap.this.strategy.equals(curr, k)) {
                    while (true) {
                        ...
                        if (Short2ByteOpenCustomHashMap.this.strategy.equals(curr2, k) && Short2ByteOpenCustomHashMap.this.value[pos] == v) {
                            Short2ByteOpenCustomHashMap.this.removeEntry(pos);
                            return true;
                        }
                    }
                } else if (Short2ByteOpenCustomHashMap.this.value[pos] != v) {
                    return false;
                } else {
                    Short2ByteOpenCustomHashMap.this.removeEntry(pos);
                    return true;
                }
            } else if (!Short2ByteOpenCustomHashMap.this.containsNullKey || Short2ByteOpenCustomHashMap.this.value[Short2ByteOpenCustomHashMap.this.f2908n] != v) {
                return false;
            } else {
        ...
        public void forEach(Consumer<? super Short2ByteMap.Entry> consumer) {
            if (Short2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(new AbstractShort2ByteMap.BasicEntry(Short2ByteOpenCustomHashMap.this.key[Short2ByteOpenCustomHashMap.this.f2908n], Short2ByteOpenCustomHashMap.this.value[Short2ByteOpenCustomHashMap.this.f2908n]));
            }
            int pos = Short2ByteOpenCustomHashMap.this.f2908n;
            while (true) {
                pos--;
                if (pos == 0) {
                    return;
        ...
        public void fastForEach(Consumer<? super Short2ByteMap.Entry> consumer) {
            ...
            if (Short2ByteOpenCustomHashMap.this.containsNullKey) {
                entry.key = Short2ByteOpenCustomHashMap.this.key[Short2ByteOpenCustomHashMap.this.f2908n];
                entry.value = Short2ByteOpenCustomHashMap.this.value[Short2ByteOpenCustomHashMap.this.f2908n];
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap$KeyIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ByteOpenCustomHashMap$KeyIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap$KeySpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ByteOpenCustomHashMap$KeySpliterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap$KeySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ByteOpenCustomHashMap$KeySet.class */
    public final class KeySet extends AbstractShortSet {
        ...
        public void forEach(ShortConsumer consumer) {
            if (Short2ByteOpenCustomHashMap.this.containsNullKey) {
                consumer.accept(Short2ByteOpenCustomHashMap.this.key[Short2ByteOpenCustomHashMap.this.f2908n]);
            }
            int pos = Short2ByteOpenCustomHashMap.this.f2908n;
            while (true) {
                pos--;
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap$ValueIterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ByteOpenCustomHashMap$ValueIterator.class */
    ...
    /* access modifiers changed from: private */
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap$ValueSpliterator */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2ByteOpenCustomHashMap$ValueSpliterator.class */
    ...
    public Collection<Byte> values() {
        if (this.values == null) {
            this.values = new AbstractByteCollection() { // from class: it.unimi.dsi.fastutil.shorts.Short2ByteOpenCustomHashMap.1
                ...
                public void forEach(ByteConsumer consumer) {
                    if (Short2ByteOpenCustomHashMap.this.containsNullKey) {
                        consumer.accept(Short2ByteOpenCustomHashMap.this.value[Short2ByteOpenCustomHashMap.this.f2908n]);
                    }
                    int pos = Short2ByteOpenCustomHashMap.this.f2908n;
                    while (true) {
                        pos--;
    ...
    public Short2ByteOpenCustomHashMap clone() {
        try {
            Short2ByteOpenCustomHashMap c = (Short2ByteOpenCustomHashMap) clone();
            c.keys = null;
            c.values = null;
            c.entries = null;
    ...
    private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
        ...
        this.key = key;
        byte[] value = new byte[this.f2908n + 1];
        this.value = value;
        int i = this.size;
        while (true) {
            i--;
