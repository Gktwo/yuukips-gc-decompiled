...
/* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharFunctions */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharFunctions.class */
public final class Short2CharFunctions {
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharFunctions$EmptyFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharFunctions$EmptyFunction.class */
    public static class EmptyFunction extends AbstractShort2CharFunction implements Serializable, Cloneable {
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.AbstractShort2CharFunction, p014it.unimi.dsi.fastutil.shorts.Short2CharFunction
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharFunctions$Singleton */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharFunctions$Singleton.class */
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharFunctions$SynchronizedFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharFunctions$SynchronizedFunction.class */
    public static class SynchronizedFunction implements Short2CharFunction, Serializable {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Short2CharFunction f, Object sync) {
            if (f == null) {
        ...
        /* access modifiers changed from: protected */
        public SynchronizedFunction(Short2CharFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
        ...
        @Override // p014it.unimi.dsi.fastutil.shorts.Short2CharFunction, java.util.function.IntUnaryOperator
        @Deprecated
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharFunctions$UnmodifiableFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharFunctions$UnmodifiableFunction.class */
    public static class UnmodifiableFunction extends AbstractShort2CharFunction implements Serializable {
        private static final long serialVersionUID = -7046029254386353129L;
        protected final Short2CharFunction function;

        /* access modifiers changed from: protected */
        public UnmodifiableFunction(Short2CharFunction f) {
            if (f == null) {
                throw new NullPointerException();
            }
            this.function = f;
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.Short2CharFunctions$PrimitiveFunction */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/Short2CharFunctions$PrimitiveFunction.class */
    public static class PrimitiveFunction implements Short2CharFunction {
        ...
        public char get(short key) {
            Character v = (Character) this.function.apply(Short.valueOf(key));
        ...
        public Character get(Object key) {
            ...
            return (Character) this.function.apply((Short) key);
        }
        ...
        public Character getOrDefault(Object key, Character defaultValue) {
            Character v;
            if (!(key == null || (v = (Character) this.function.apply((Short) key)) == null)) {
                return v;
            }
            return defaultValue;
        }
    ...
    public static Short2CharFunction primitive(java.util.function.Function<? super Short, ? extends Character> f) {
        ...
        return f instanceof Short2CharFunction ? (Short2CharFunction) f : f instanceof IntUnaryOperator ? key -> {
