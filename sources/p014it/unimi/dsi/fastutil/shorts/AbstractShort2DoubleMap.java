...
/* renamed from: it.unimi.dsi.fastutil.shorts.AbstractShort2DoubleMap */
/* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/AbstractShort2DoubleMap.class */
public abstract class AbstractShort2DoubleMap extends AbstractShort2DoubleFunction implements Short2DoubleMap, Serializable {
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.AbstractShort2DoubleMap$BasicEntry */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/AbstractShort2DoubleMap$BasicEntry.class */
    public static class BasicEntry implements Short2DoubleMap.Entry {
        ...
        public boolean equals(Object o) {
            ...
            return key != null && (key instanceof Short) && (value = e2.getValue()) != null && (value instanceof Double) && this.key == ((Short) key).shortValue() && Double.doubleToLongBits(this.value) == Double.doubleToLongBits(((Double) value).doubleValue());
        }
    ...
    /* renamed from: it.unimi.dsi.fastutil.shorts.AbstractShort2DoubleMap$BasicEntrySet */
    /* loaded from: grasscutter.jar:it/unimi/dsi/fastutil/shorts/AbstractShort2DoubleMap$BasicEntrySet.class */
    ...
    public Set<Short> keySet() {
        return new AbstractShortSet() { // from class: it.unimi.dsi.fastutil.shorts.AbstractShort2DoubleMap.1
            ...
            public ShortSpliterator spliterator() {
                return ShortSpliterators.asSpliterator(iterator(), Size64.sizeOf(AbstractShort2DoubleMap.this), 321);
            }
        };
    }
    ...
    public Collection<Double> values() {
        return new AbstractDoubleCollection() { // from class: it.unimi.dsi.fastutil.shorts.AbstractShort2DoubleMap.2
            ...
            public DoubleSpliterator spliterator() {
                return DoubleSpliterators.asSpliterator(iterator(), Size64.sizeOf(AbstractShort2DoubleMap.this), 320);
            }
        };
    }
    ...
    public void putAll(Map<? extends Short, ? extends Double> m) {
        ...
        int n = m.size();
        Iterator<? extends Map.Entry<? extends Short, ? extends Double>> i2 = m.entrySet().iterator();
        while (true) {
            n--;
            if (n != 0) {
                Map.Entry<? extends Short, ? extends Double> e2 = i2.next();
                put((Short) e2.getKey(), (Double) e2.getValue());
            } else {
                return;
            }
        }
