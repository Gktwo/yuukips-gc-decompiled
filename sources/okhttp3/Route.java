...
public final class Route {
    ...
    public int hashCode() {
        return (31 * ((31 * ((31 * 17) + this.address.hashCode())) + this.proxy.hashCode())) + this.socketAddress.hashCode();
    }
