...
@Metadata(m371mv = {1, 6, 0}, m372k = 1, m369xi = 48, m374d1 = {"��\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n��\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n��\n\u0002\u0018\u0002\n��\u0018��2\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0010\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n��¨\u0006\t"}, m373d2 = {"Lokhttp3/internal/http/CallServerInterceptor;", "Lokhttp3/Interceptor;", "forWebSocket", "", "(Z)V", "intercept", "Lokhttp3/Response;", "chain", "Lokhttp3/Interceptor$Chain;", "okhttp"})
/* loaded from: grasscutter.jar:okhttp3/internal/http/CallServerInterceptor.class */
    ...
    public Response intercept(@NotNull Interceptor.Chain chain) throws IOException {
        ...
        if (code == 204 || code == 205) {
            ...
            if ((body == null ? -1 : body.contentLength()) > 0) {
                ...
                throw new ProtocolException(append.append(body2 == null ? null : Long.valueOf(body2.contentLength())).toString());
            }
        }
        return response;
    }
