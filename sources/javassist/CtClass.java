...
/* loaded from: grasscutter.jar:javassist/CtClass.class */
public abstract class CtClass {
    ...
    public void writeFile() throws NotFoundException, IOException, CannotCompileException {
        writeFile(Mapper.IGNORED_FIELDNAME);
    }
    ...
    protected DataOutputStream makeFileOutput(String directoryName) {
        ...
        if (pos > 0) {
            ...
            if (!dir.equals(Mapper.IGNORED_FIELDNAME)) {
                new File(dir).mkdirs();
            }
        }
    ...
    public void debugWriteFile() {
        debugWriteFile(Mapper.IGNORED_FIELDNAME);
    }
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:javassist/CtClass$DelayedFileOutputStream.class */
