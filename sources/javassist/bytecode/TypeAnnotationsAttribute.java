...
/* loaded from: grasscutter.jar:javassist/bytecode/TypeAnnotationsAttribute.class */
public class TypeAnnotationsAttribute extends AttributeInfo {
    ...
    /* loaded from: grasscutter.jar:javassist/bytecode/TypeAnnotationsAttribute$TAWalker.class */
    ...
    /* loaded from: grasscutter.jar:javassist/bytecode/TypeAnnotationsAttribute$SubWalker.class */
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:javassist/bytecode/TypeAnnotationsAttribute$Renamer.class */
    ...
    /* loaded from: grasscutter.jar:javassist/bytecode/TypeAnnotationsAttribute$Copier.class */
    ...
    /* loaded from: grasscutter.jar:javassist/bytecode/TypeAnnotationsAttribute$SubCopier.class */
    static class SubCopier extends SubWalker {
        ...
        int localvarTarget(int pos, int targetType, int tableLength) throws Exception {
            ...
            return localvarTarget(pos, targetType, tableLength);
        }
        ...
        int typePath(int pos, int pathLength) throws Exception {
            ...
            return typePath(pos, pathLength);
        }
