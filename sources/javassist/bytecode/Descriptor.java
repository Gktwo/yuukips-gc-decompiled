...
/* loaded from: grasscutter.jar:javassist/bytecode/Descriptor.class */
public class Descriptor {
    ...
    /* renamed from: of */
    public static String m380of(String classname) {
    ...
    /* renamed from: of */
    public static String m379of(CtClass type) {
    ...
    public static String insertParameter(CtClass type, String descriptor) {
        ...
        return "(" + m379of(type) + descriptor.substring(1);
    }
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:javassist/bytecode/Descriptor$PrettyPrinter.class */
    ...
    /* loaded from: grasscutter.jar:javassist/bytecode/Descriptor$Iterator.class */
