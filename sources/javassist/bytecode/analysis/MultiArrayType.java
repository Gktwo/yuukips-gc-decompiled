...
/* loaded from: grasscutter.jar:javassist/bytecode/analysis/MultiArrayType.class */
public class MultiArrayType extends Type {
    ...
    public boolean isAssignableTo(Type type) {
        if (m378eq(type.getCtClass(), Type.OBJECT.getCtClass()) || m378eq(type.getCtClass(), Type.CLONEABLE.getCtClass()) || m378eq(type.getCtClass(), Type.SERIALIZABLE.getCtClass())) {
            return true;
        }
        if (!type.isArray()) {
            return false;
        ...
        if (!m378eq(typeRoot.getCtClass(), Type.OBJECT.getCtClass()) && !m378eq(typeRoot.getCtClass(), Type.CLONEABLE.getCtClass()) && !m378eq(typeRoot.getCtClass(), Type.SERIALIZABLE.getCtClass())) {
            return false;
        }
        return true;
    }
