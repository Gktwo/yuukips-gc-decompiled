...
/* loaded from: grasscutter.jar:javassist/bytecode/annotation/Annotation.class */
public class Annotation {
    ...
    /* loaded from: grasscutter.jar:javassist/bytecode/annotation/Annotation$Pair.class */
    ...
    public Annotation(String typeName, ConstPool cp) {
        this(cp.addUtf8Info(Descriptor.m380of(typeName)), cp);
    }

    public Annotation(ConstPool cp, CtClass clazz) throws NotFoundException {
        this(cp.addUtf8Info(Descriptor.m380of(clazz.getName())), cp);
