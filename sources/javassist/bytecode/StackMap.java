...
/* loaded from: grasscutter.jar:javassist/bytecode/StackMap.class */
public class StackMap extends AttributeInfo {
    ...
    /* loaded from: grasscutter.jar:javassist/bytecode/StackMap$Walker.class */
    ...
    /* loaded from: grasscutter.jar:javassist/bytecode/StackMap$Copier.class */
    static class Copier extends Walker {
        ...
        public int locals(int pos, int offset, int num) {
            ...
            return locals(pos, offset, num);
        }

        @Override // javassist.bytecode.StackMap.Walker
        public int typeInfoArray(int pos, int offset, int num, boolean isLocals) {
            ByteArray.write16bit(num, this.dest, pos - 2);
            return typeInfoArray(pos, offset, num, isLocals);
        }
    ...
    /* loaded from: grasscutter.jar:javassist/bytecode/StackMap$SimpleCopy.class */
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:javassist/bytecode/StackMap$InsertLocal.class */
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:javassist/bytecode/StackMap$Shifter.class */
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:javassist/bytecode/StackMap$SwitchShifter.class */
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:javassist/bytecode/StackMap$NewRemover.class */
    ...
    /* loaded from: grasscutter.jar:javassist/bytecode/StackMap$Printer.class */
    ...
    /* loaded from: grasscutter.jar:javassist/bytecode/StackMap$Writer.class */
