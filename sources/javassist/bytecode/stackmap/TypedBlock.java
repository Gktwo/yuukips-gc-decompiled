...
/* loaded from: grasscutter.jar:javassist/bytecode/stackmap/TypedBlock.class */
public class TypedBlock extends BasicBlock {
    ...
    public static TypedBlock[] makeBlocks(MethodInfo minfo, CodeAttribute ca, boolean optimize) throws BadBytecode {
        ...
        blocks[0].initFirstBlock(ca.getMaxStack(), ca.getMaxLocals(), minfo.getConstPool().getClassName(), minfo.getDescriptor(), (minfo.getAccessFlags() & 8) != 0, minfo.isConstructor());
        return blocks;
    }
    ...
    /* loaded from: grasscutter.jar:javassist/bytecode/stackmap/TypedBlock$Maker.class */
