...
/* loaded from: grasscutter.jar:javassist/bytecode/stackmap/Tracer.class */
    ...
    private int doOpcode0_53(int pos, byte[] code, int op) throws BadBytecode {
        ...
        switch (op) {
            ...
            case 45:
                ...
                this.stackTop = i15 + 1;
                stackTypes[i15] = this.localsTypes[op - 42];
                return 1;
            case 46:
            ...
            case 50:
                ...
                this.stackTop = i18;
                int s = i18 - 1;
                stackTypes[s] = TypeData.ArrayElement.make(stackTypes[s]);
                return 1;
            case 51:
            case 52:
            case 53:
