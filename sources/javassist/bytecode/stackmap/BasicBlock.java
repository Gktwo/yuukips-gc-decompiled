...
/* loaded from: grasscutter.jar:javassist/bytecode/stackmap/BasicBlock.class */
public class BasicBlock {
    ...
    /* loaded from: grasscutter.jar:javassist/bytecode/stackmap/BasicBlock$JsrBytecode.class */
    ...
    /* loaded from: grasscutter.jar:javassist/bytecode/stackmap/BasicBlock$Catch.class */
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:javassist/bytecode/stackmap/BasicBlock$Mark.class */
    ...
    /* loaded from: grasscutter.jar:javassist/bytecode/stackmap/BasicBlock$Maker.class */
        ...
        private Map<Integer, Mark> makeMarks(CodeIterator ci, int begin, int end, ExceptionTable et) throws BadBytecode {
            ...
            while (ci.hasNext() && (index = ci.next()) < end) {
                ...
                if ((153 <= op && op <= 166) || op == 198 || op == 199) {
                    makeMark(marks, index, makeArray(makeMark(marks, index + ci.s16bitAt(index + 1)).block, makeMark(marks, index + 3).block), 3, false);
                    ...
                    switch (op) {
                        ...
                        case 171:
                            ...
                            to2[0] = makeMark(marks, index + ci.s32bitAt(pos2)).block;
                            int p2 = pos2 + 8 + 4;
                            int n2 = (p2 + (ncases2 * 8)) - 4;
                            int k2 = 1;
                            while (p2 < n2) {
                                k2++;
                                to2[k2] = makeMark(marks, index + ci.s32bitAt(p2)).block;
                                p2 += 8;
                            }
