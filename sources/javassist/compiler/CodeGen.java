...
/* loaded from: grasscutter.jar:javassist/compiler/CodeGen.class */
public abstract class CodeGen extends Visitor implements Opcode, TokenId {
    ...
    /* loaded from: grasscutter.jar:javassist/compiler/CodeGen$ReturnHook.class */
    ...
    private void atSwitchStmnt(Stmnt st) throws CompileError {
        ...
        for (ASTList list2 = body; list2 != null; list2 = list2.tail()) {
            ...
            if (op == 310) {
                ...
                ipairs++;
                pairs[ipairs] = (caseLabel << 32) + (((long) (curPos - opcodePc)) & -1);
            }
            this.hasReturned = false;
