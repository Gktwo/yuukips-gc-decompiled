...
/* loaded from: grasscutter.jar:javassist/compiler/MemberCodeGen.class */
public class MemberCodeGen extends CodeGen {
    ...
    /* loaded from: grasscutter.jar:javassist/compiler/MemberCodeGen$JsrHook.class */
    ...
    /* loaded from: grasscutter.jar:javassist/compiler/MemberCodeGen$JsrHook2.class */
            ...
            if (expr instanceof Expr) {
                ...
                if (op == 35) {
                    ...
                    try {
                        ...
                        CtField f4 = this.resolver.lookupFieldByJvmName2(nfe.getField(), (Symbol) e2.oprand2(), expr);
                        this.resultStatic = true;
                        return f4;
                    }
                } else {
