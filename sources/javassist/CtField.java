...
public class CtField extends CtMember {
    ...
    public String toString() {
        return getDeclaringClass().getName() + Mapper.IGNORED_FIELDNAME + getName() + EmitterKt.COMMENT_PREFIX + this.fieldInfo.getDescriptor();
    }
    ...
    public void setModifiers(int mod) {
        this.declaringClass.checkModify();
        this.fieldInfo.setAccessFlags(AccessFlag.m381of(mod));
    }
    ...
    public void setType(CtClass clazz) {
        this.declaringClass.checkModify();
        this.fieldInfo.setDescriptor(Descriptor.m379of(clazz));
    }
    ...
    /* loaded from: grasscutter.jar:javassist/CtField$Initializer.class */
    ...
    /* loaded from: grasscutter.jar:javassist/CtField$CodeInitializer0.class */
    static abstract class CodeInitializer0 extends Initializer {
        ...
        int compile(CtClass type, String name, Bytecode code, CtClass[] parameters, Javac drv) throws CannotCompileException {
            try {
                code.addAload(0);
                compileExpr(drv);
                code.addPutfield(Bytecode.THIS, name, Descriptor.m379of(type));
        ...
        int compileIfStatic(CtClass type, String name, Bytecode code, Javac drv) throws CannotCompileException {
            try {
                compileExpr(drv);
                code.addPutstatic(Bytecode.THIS, name, Descriptor.m379of(type));
                return code.getMaxStack();
            } catch (CompileError e) {
                throw new CannotCompileException(e);
            }
    ...
    /* loaded from: grasscutter.jar:javassist/CtField$CodeInitializer.class */
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:javassist/CtField$PtreeInitializer.class */
    ...
    /* loaded from: grasscutter.jar:javassist/CtField$ParamInitializer.class */
    ...
    /* loaded from: grasscutter.jar:javassist/CtField$NewInitializer.class */
    ...
    /* loaded from: grasscutter.jar:javassist/CtField$MethodInitializer.class */
    static class MethodInitializer extends NewInitializer {
        ...
        int compile(CtClass type, String name, Bytecode code, CtClass[] parameters, Javac drv) throws CannotCompileException {
            ...
            String typeDesc = Descriptor.m379of(type);
    ...
    /* loaded from: grasscutter.jar:javassist/CtField$IntInitializer.class */
    ...
    /* loaded from: grasscutter.jar:javassist/CtField$LongInitializer.class */
    ...
    /* loaded from: grasscutter.jar:javassist/CtField$FloatInitializer.class */
    ...
    /* loaded from: grasscutter.jar:javassist/CtField$DoubleInitializer.class */
    ...
    /* loaded from: grasscutter.jar:javassist/CtField$StringInitializer.class */
    ...
    /* loaded from: grasscutter.jar:javassist/CtField$ArrayInitializer.class */
    ...
    /* loaded from: grasscutter.jar:javassist/CtField$MultiArrayInitializer.class */
