...
/* loaded from: grasscutter.jar:javassist/CtClassType.class */
public class CtClassType extends CtClass {
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:75:0x008d */
    ...
    public void replaceClassName(String oldname, String newname) throws RuntimeException {
        ...
        replaceClassName(oldname, newname);
    ...
    public void setModifiers(int mod) {
        ...
        getClassFile2().setAccessFlags(AccessFlag.m381of(mod & -9));
    }
    ...
    private static void updateInnerEntry(int newMod, String name, CtClass clazz, boolean outer) {
        ...
        if (ica != null) {
            ...
            if (i >= 0 && ((isStatic = ica.accessFlags(i) & 8) != 0 || !Modifier.isStatic(newMod))) {
                clazz.checkModify();
                ica.setAccessFlags(i, AccessFlag.m381of(mod) | isStatic);
