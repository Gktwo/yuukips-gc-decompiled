...
/* loaded from: grasscutter.jar:javassist/tools/web/Viewer.class */
public class Viewer extends ClassLoader {
    ...
    protected byte[] fetchClass(String classname) throws Exception {
        byte[] b;
        URLConnection con = new URL(URIUtil.HTTP, this.server, this.port, "/" + classname.replace('.', '/') + ".class").openConnection();
        con.connect();
