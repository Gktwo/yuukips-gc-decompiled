...
/* loaded from: grasscutter.jar:javassist/util/proxy/RuntimeSupport.class */
public class RuntimeSupport {
    public static MethodHandler default_interceptor = new DefaultMethodHandler();

    /* loaded from: grasscutter.jar:javassist/util/proxy/RuntimeSupport$DefaultMethodHandler.class */
    ...
    private static void error(Class<?> clazz, String name, String desc) {
        throw new RuntimeException("not found " + name + EmitterKt.COMMENT_PREFIX + desc + " in " + clazz.getName());
    }
