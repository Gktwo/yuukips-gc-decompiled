...
/* loaded from: grasscutter.jar:org/slf4j/event/EventRecodingLogger.class */
public class EventRecodingLogger implements Logger {
    ...
    private void recordEventArgArray(Level level, Marker marker, String msg, Object[] args) {
        ...
        if (throwableCandidate != null) {
            recordEvent(level, marker, msg, MessageFormatter.trimmedCopy(args), throwableCandidate);
        } else {
