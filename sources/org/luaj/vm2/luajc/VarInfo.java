...
public class VarInfo {
    ...
    private static final class NilVarInfo extends VarInfo {
        ...
        NilVarInfo(int i, int i2, C58811 r7) {
            this(i, i2);
        }
    }
    ...
    public static final class ParamVarInfo extends VarInfo {
        ...
        ParamVarInfo(int i, int i2, C58811 r7) {
            this(i, i2);
        }
    }
    ...
    private static final class PhiVarInfo extends VarInfo {
        ...
        /* renamed from: pi */
        private final ProtoInfo f3353pi;
        VarInfo[] values;

        private PhiVarInfo(ProtoInfo protoInfo, int i, int i2) {
            super(i, i2);
            this.f3353pi = protoInfo;
        }
        ...
        protected void collectUniqueValues(Set set, Set set2) {
            BasicBlock basicBlock = this.f3353pi.blocks[this.f3352pc];
            if (this.f3352pc == 0) {
                set2.add(this.f3353pi.params[this.slot]);
            }
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (!set.contains(basicBlock2)) {
                    set.add(basicBlock2);
                    VarInfo varInfo = this.f3353pi.vars[this.slot][basicBlock2.pc1];
                    if (varInfo != null) {
        ...
        PhiVarInfo(ProtoInfo protoInfo, int i, int i2, C58811 r9) {
            this(protoInfo, i, i2);
        }
    }
    ...
    public String toString() {
        return this.slot < 0 ? "x.x" : new StringBuffer().append(this.slot).append(Mapper.IGNORED_FIELDNAME).append(this.f3352pc).toString();
    }
