...
/* loaded from: grasscutter.jar:org/luaj/vm2/ast/Visitor.class */
public abstract class Visitor {
    ...
    public void visit(Stat.IfThenElse ifThenElse) {
        ...
        if (ifThenElse.elseifblocks != null) {
            ...
            for (int i = 0; i < size; i++) {
                ((Exp) ifThenElse.elseifexps.get(i)).accept(this);
                ((Block) ifThenElse.elseifblocks.get(i)).accept(this);
            }
        }
    ...
    public void visit(TableConstructor tableConstructor) {
        if (tableConstructor.fields != null) {
            ...
            for (int i = 0; i < size; i++) {
                ((TableField) tableConstructor.fields.get(i)).accept(this);
            }
        }
    }
    ...
    public void visitVars(List list) {
        if (list != null) {
            int size = list.size();
            for (int i = 0; i < size; i++) {
                ((Exp.VarExp) list.get(i)).accept(this);
            }
        }
    }
