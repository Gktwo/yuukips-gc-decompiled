...
public class LexState extends Constants {
    ...
    /* renamed from: t */
    final Token f3317t = new Token(null);
    ...
    public static class Token {
        ...
        public void set(Token token) {
            ...
            this.seminfo.f3328r = token.seminfo.f3328r;
            this.seminfo.f3329ts = token.seminfo.f3329ts;
        }
    ...
    public static class expdesc {
        ...
        /* renamed from: u */
        final C5867U f3331u = new C5867U();

        /* renamed from: t */
        final IntPtr f3332t = new IntPtr();

        /* renamed from: f */
        final IntPtr f3333f = new IntPtr();
        ...
        public static class C5867U {
            ...
            static LuaValue access$202(C5867U u, LuaValue luaValue) {
                u._nval = luaValue;
                return luaValue;
            }

            static LuaValue access$200(C5867U u) {
                return u._nval;
            }
        }
        ...
        public void init(int i, int i2) {
            this.f3333f.f3315i = -1;
            this.f3332t.f3315i = -1;
            this.f3330k = i;
            this.f3331u.info = i2;
        }
        ...
        public boolean hasjumps() {
            return this.f3332t.f3315i != this.f3333f.f3315i;
        }

        /* access modifiers changed from: package-private */
        public boolean isnumeral() {
            return this.f3330k == 5 && this.f3332t.f3315i == -1 && this.f3333f.f3315i == -1;
        }

        public void setvalue(expdesc expdesc) {
            this.f3333f.f3315i = expdesc.f3333f.f3315i;
            this.f3330k = expdesc.f3330k;
            this.f3332t.f3315i = expdesc.f3332t.f3315i;
            C5867U.access$202(this.f3331u, C5867U.access$200(expdesc.f3331u));
            this.f3331u.ind_idx = expdesc.f3331u.ind_idx;
            this.f3331u.ind_t = expdesc.f3331u.ind_t;
            this.f3331u.ind_vt = expdesc.f3331u.ind_vt;
            this.f3331u.info = expdesc.f3331u.info;
        }
    }
    ...
    public LexState(LuaC.CompileState compileState, InputStream inputStream) {
        this.f3320z = inputStream;
        this.f3319L = compileState;
    }

    void nextChar() {
        try {
            this.current = this.f3320z.read();
        } catch (IOException e) {
            e.printStackTrace();
            this.current = -1;
        }
    ...
    String token2str(int i) {
        return i < 257 ? iscntrl(i) ? this.f3319L.pushfstring(new StringBuffer().append("char(").append(i).append(")").toString()) : this.f3319L.pushfstring(String.valueOf((char) i)) : luaX_tokens[i - PacketOpcodes.SceneAvatarStaminaStepReq];
    }
    ...
    public void lexerror(String str, int i) {
        ...
        this.f3319L.pushfstring(new StringBuffer().append(chunkid).append(EmitterKt.COMMENT_PREFIX).append(this.linenumber).append(": ").append(str).toString());
        if (i != 0) {
            this.f3319L.pushfstring(new StringBuffer().append("syntax error: ").append(str).append(" near ").append(txtToken(i)).toString());
        }
    ...
    public void syntaxerror(String str) {
        lexerror(str, this.f3317t.token);
    }

    LuaString newstring(String str) {
        return this.f3319L.newTString(str);
    }

    LuaString newstring(char[] cArr, int i, int i2) {
        return this.f3319L.newTString(new String(cArr, i, i2));
    }
    ...
    boolean str2d(String str, SemInfo semInfo) {
        if (str.indexOf(110) >= 0 || str.indexOf(78) >= 0) {
            semInfo.f3328r = LuaValue.ZERO;
            return true;
        } else if (str.indexOf(120) >= 0 || str.indexOf(88) >= 0) {
            semInfo.f3328r = strx2number(str, semInfo);
            return true;
        } else {
            semInfo.f3328r = LuaValue.valueOf(Double.parseDouble(str.trim()));
            return true;
        }
    }
    ...
    void read_long_string(SemInfo semInfo, int i) {
        ...
        if (semInfo != null) {
            semInfo.f3329ts = this.f3319L.newTString(LuaString.valueOf(this.buff, 2 + i, this.nbuff - (2 * (2 + i))));
        }
    }
    ...
    void next() {
        ...
        if (this.lookahead.token != 286) {
            this.f3317t.set(this.lookahead);
            this.lookahead.token = 286;
            return;
        }
        this.f3317t.token = llex(this.f3317t.seminfo);
    }
    ...
    void anchor_token() {
        _assert(this.f3318fs != null || this.f3317t.token == 286);
        if (this.f3317t.token == 288 || this.f3317t.token == 289) {
            LuaString luaString = this.f3317t.seminfo.f3329ts;
            this.f3319L.cachedLuaString(this.f3317t.seminfo.f3329ts);
        }
    }
    ...
    void error_expected(int i) {
        syntaxerror(this.f3319L.pushfstring(new StringBuffer().append(LUA_QS(token2str(i))).append(" expected").toString()));
    }

    boolean testnext(int i) {
        if (this.f3317t.token != i) {
            return false;
        }
        next();
        return true;
    ...
    void check_match(int i, int i2, int i3) {
        ...
        if (i3 == this.linenumber) {
            ...
            syntaxerror(this.f3319L.pushfstring(new StringBuffer().append(LUA_QS(token2str(i))).append(" expected ").append("(to close ").append(LUA_QS(token2str(i2))).append(" at line ").append(i3).append(")").toString()));
        }
    }
    ...
    void codestring(expdesc expdesc2, LuaString luaString) {
        expdesc2.init(4, this.f3318fs.stringK(luaString));
    }
    ...
    int registerlocalvar(LuaString luaString) {
        FuncState funcState = this.f3318fs;
        Prototype prototype = funcState.f3307f;
    ...
    void new_localvar(LuaString luaString) {
        ...
        this.f3318fs.checklimit(this.dyd.n_actvar + 1, 200, "local variables");
    ...
    void adjustlocalvars(int i) {
        ...
        while (i > 0) {
            funcState.getlocvar(funcState.nactvar - i).startpc = funcState.f3312pc;
            i--;
        }
    }
    ...
    void removevars(int i) {
        ...
        while (funcState.nactvar > i) {
            ...
            funcState.nactvar = s;
            funcState.getlocvar(s).endpc = funcState.f3312pc;
        }
    }
    ...
    void singlevar(expdesc expdesc2) {
        ...
        if (FuncState.singlevaraux(funcState, str_checkname, expdesc2, 1) == 0) {
            ...
            _assert(expdesc2.f3330k == 7 || expdesc2.f3330k == 8);
    ...
    void enterlevel() {
        LuaC.CompileState compileState = this.f3319L;
    ...
    void closegoto(int i, Labeldesc labeldesc) {
        FuncState funcState = this.f3318fs;
        Labeldesc[] labeldescArr = this.dyd.f3325gt;
        Labeldesc labeldesc2 = labeldescArr[i];
        _assert(labeldesc2.name.eq_b(labeldesc.name));
        if (labeldesc2.nactvar < labeldesc.nactvar) {
            semerror(this.f3319L.pushfstring(new StringBuffer().append("<goto ").append(labeldesc2.name).append("> at line ").append(labeldesc2.line).append(" jumps into the scope of local '").append(funcState.getlocvar(labeldesc2.nactvar).varname.tojstring()).append("'").toString()));
        }
        funcState.patchlist(labeldesc2.f3327pc, labeldesc.f3327pc);
    ...
    public boolean findlabel(int i) {
        FuncState.BlockCnt blockCnt = this.f3318fs.f3311bl;
        Dyndata dyndata = this.dyd;
        Labeldesc labeldesc = dyndata.f3325gt[i];
        for (int i2 = blockCnt.firstlabel; i2 < dyndata.n_label; i2++) {
            ...
            if (labeldesc2.name.eq_b(labeldesc.name)) {
                if (labeldesc.nactvar > labeldesc2.nactvar && (blockCnt.upval || dyndata.n_label > blockCnt.firstlabel)) {
                    this.f3318fs.patchclose(labeldesc.f3327pc, labeldesc2.nactvar);
                }
    ...
    int newlabelentry(Labeldesc[] labeldescArr, int i, LuaString luaString, int i2, int i3) {
        labeldescArr[i] = new Labeldesc(luaString, i3, i2, this.f3318fs.nactvar);
        return i;
    }

    void findgotos(Labeldesc labeldesc) {
        Labeldesc[] labeldescArr = this.dyd.f3325gt;
        int i = this.f3318fs.f3311bl.firstgoto;
    ...
    public void breaklabel() {
        ...
        findgotos(this.dyd.label[newlabelentry(grow, i, valueOf, 0, this.f3318fs.f3312pc)]);
    }

    /* access modifiers changed from: package-private */
    public void undefgoto(Labeldesc labeldesc) {
        semerror(this.f3319L.pushfstring(isReservedKeyword(labeldesc.name.tojstring()) ? new StringBuffer().append("<").append(labeldesc.name).append("> at line ").append(labeldesc.line).append(" not inside a loop").toString() : new StringBuffer().append("no visible label '").append(labeldesc.name).append("' for <goto> at line ").append(labeldesc.line).toString()));
    }

    Prototype addprototype() {
        Prototype prototype = this.f3318fs.f3307f;
        if (prototype.f3296p == null || this.f3318fs.f3314np >= prototype.f3296p.length) {
            prototype.f3296p = realloc(prototype.f3296p, Math.max(1, this.f3318fs.f3314np * 2));
        }
        Prototype[] prototypeArr = prototype.f3296p;
        FuncState funcState = this.f3318fs;
        int i = funcState.f3314np;
        funcState.f3314np = i + 1;
    ...
    void codeclosure(expdesc expdesc2) {
        FuncState funcState = this.f3318fs.prev;
        expdesc2.init(11, funcState.codeABx(37, 0, funcState.f3314np - 1));
        funcState.exp2nextreg(expdesc2);
    }

    void open_func(FuncState funcState, FuncState.BlockCnt blockCnt) {
        funcState.prev = this.f3318fs;
        funcState.f3309ls = this;
        this.f3318fs = funcState;
        funcState.f3312pc = 0;
        ...
        funcState.f3311bl = null;
        funcState.f3307f.source = this.source;
        funcState.f3307f.maxstacksize = 2;
    ...
    void close_func() {
        ...
        prototype.code = realloc(prototype.code, funcState.f3312pc);
        prototype.lineinfo = realloc(prototype.lineinfo, funcState.f3312pc);
        prototype.f3295k = realloc(prototype.f3295k, funcState.f3313nk);
        prototype.f3296p = realloc(prototype.f3296p, funcState.f3314np);
        ...
        _assert(funcState.f3311bl == null);
        this.f3318fs = funcState.prev;
    }
    ...
    void yindex(expdesc expdesc2) {
        next();
        expr(expdesc2);
        this.f3318fs.exp2val(expdesc2);
        checknext(93);
    }

    void recfield(ConsControl consControl) {
        FuncState funcState = this.f3318fs;
        short s = this.f3318fs.freereg;
        expdesc expdesc2 = new expdesc();
        expdesc expdesc3 = new expdesc();
        if (this.f3317t.token == 288) {
            funcState.checklimit(consControl.f3323nh, MAX_INT, "items in a constructor");
            checkname(expdesc2);
        } else {
            yindex(expdesc2);
        }
        ...
        expr(expdesc3);
        funcState.codeABC(10, consControl.f3322t.f3331u.info, exp2RK, funcState.exp2RK(expdesc3));
        funcState.freereg = (short) s;
    }

    void listfield(ConsControl consControl) {
        expr(consControl.f3321v);
        this.f3318fs.checklimit(consControl.f3324na, MAX_INT, "items in a constructor");
        consControl.f3324na++;
        consControl.tostore++;
    }
    ...
    void constructor(expdesc expdesc2) {
        ...
        consControl.f3323nh = 0;
        consControl.f3324na = 0;
        consControl.f3322t = expdesc2;
        expdesc2.init(11, codeABC);
        consControl.f3321v.init(0, 0);
        funcState.exp2nextreg(expdesc2);
        checknext(123);
        while (true) {
            _assert(consControl.f3321v.f3330k == 0 || consControl.tostore > 0);
            if (this.f3317t.token != 125) {
                funcState.closelistfield(consControl);
                switch (this.f3317t.token) {
                    case 91:
        ...
        InstructionPtr instructionPtr = new InstructionPtr(funcState.f3307f.code, codeABC);
        SETARG_B(instructionPtr, luaO_int2fb(consControl.f3324na));
        SETARG_C(instructionPtr, luaO_int2fb(consControl.f3323nh));
    }
    ...
    void body(expdesc expdesc2, boolean z, int i) {
        ...
        funcState.f3307f = addprototype();
        funcState.f3307f.linedefined = i;
        ...
        checknext(41);
        statlist();
        funcState.f3307f.lastlinedefined = this.linenumber;
    ...
    int explist(expdesc expdesc2) {
        ...
        expr(expdesc2);
        while (testnext(44)) {
            this.f3318fs.exp2nextreg(expdesc2);
            expr(expdesc2);
            i++;
        }
        return i;
    ...
    void funcargs(expdesc expdesc2, int i) {
        ...
        switch (this.f3317t.token) {
            ...
            case 123:
                ...
                break;
            case 289:
                codestring(expdesc3, this.f3317t.seminfo.f3329ts);
                next();
                break;
            default:
        ...
        _assert(expdesc2.f3330k == 6);
        int i3 = expdesc2.f3331u.info;
        if (hasmultret(expdesc3.f3330k)) {
            i2 = -1;
        } else {
            if (expdesc3.f3330k != 0) {
    ...
    void primaryexp(expdesc expdesc2) {
        switch (this.f3317t.token) {
            case 40:
                ...
                expr(expdesc2);
                check_match(41, 40, i);
                this.f3318fs.dischargevars(expdesc2);
                return;
            case 288:
                singlevar(expdesc2);
                return;
            default:
                syntaxerror(new StringBuffer().append("unexpected symbol ").append(this.f3317t.token).append(" (").append((char) this.f3317t.token).append(")").toString());
                return;
        }
    }
        ...
        while (true) {
            switch (this.f3317t.token) {
                ...
                case 58:
                    ...
                    next();
                    checkname(expdesc3);
                    this.f3318fs.self(expdesc2, expdesc3);
                    funcargs(expdesc2, i);
                    break;
                case 91:
                    expdesc expdesc4 = new expdesc();
                    this.f3318fs.exp2anyregup(expdesc2);
                    yindex(expdesc4);
                    this.f3318fs.indexed(expdesc2, expdesc4);
                    break;
                default:
                    return;
            }
    ...
    void simpleexp(expdesc expdesc2) {
        switch (this.f3317t.token) {
            ...
            case 280:
                FuncState funcState = this.f3318fs;
                check_condition(funcState.f3307f.is_vararg != 0, new StringBuffer().append("cannot use ").append(LUA_QL("...")).append(" outside a vararg function").toString());
                expdesc2.init(13, funcState.codeABC(38, 0, 1, 0));
                break;
            case 287:
                expdesc2.init(5, 0);
                expdesc2.f3331u.setNval(this.f3317t.seminfo.f3328r);
                break;
            case 289:
                codestring(expdesc2, this.f3317t.seminfo.f3329ts);
                break;
            default:
    ...
    int subexpr(expdesc expdesc2, int i) {
        enterlevel();
        int i2 = getunopr(this.f3317t.token);
        if (i2 != 3) {
            int i3 = this.linenumber;
            next();
            subexpr(expdesc2, 8);
            this.f3318fs.prefix(i2, expdesc2, i3);
        } else {
            simpleexp(expdesc2);
        }
        int i4 = getbinopr(this.f3317t.token);
        while (i4 != 15 && priority[i4].left > i) {
            expdesc expdesc3 = new expdesc();
            int i5 = this.linenumber;
            next();
            this.f3318fs.infix(i4, expdesc2);
            i4 = subexpr(expdesc3, priority[i4].right);
            this.f3318fs.posfix(i4, expdesc2, expdesc3, i5);
        }
        leavelevel();
        return i4;
    }
    ...
    void check_conflict(LHS_assign lHS_assign, expdesc expdesc2) {
        ...
        while (lHS_assign != null) {
            if (lHS_assign.f3326v.f3330k == 9) {
                if (lHS_assign.f3326v.f3331u.ind_vt == expdesc2.f3330k && lHS_assign.f3326v.f3331u.ind_t == expdesc2.f3331u.info) {
                    z = true;
                    lHS_assign.f3326v.f3331u.ind_vt = 7;
                    lHS_assign.f3326v.f3331u.ind_t = s;
                }
                if (expdesc2.f3330k == 7 && lHS_assign.f3326v.f3331u.ind_idx == expdesc2.f3331u.info) {
                    z = true;
                    lHS_assign.f3326v.f3331u.ind_idx = s;
                }
            }
            lHS_assign = lHS_assign.prev;
        }
        if (z) {
            funcState.codeABC(expdesc2.f3330k == 7 ? 0 : 5, s, expdesc2.f3331u.info, 0);
    ...
    void assignment(LHS_assign lHS_assign, int i) {
        expdesc expdesc2 = new expdesc();
        check_condition(7 <= lHS_assign.f3326v.f3330k && lHS_assign.f3326v.f3330k <= 9, "syntax error");
        if (testnext(44)) {
            LHS_assign lHS_assign2 = new LHS_assign();
            lHS_assign2.prev = lHS_assign;
            suffixedexp(lHS_assign2.f3326v);
            if (lHS_assign2.f3326v.f3330k != 9) {
                check_conflict(lHS_assign, lHS_assign2.f3326v);
            }
            ...
            if (explist != i) {
                ...
                this.f3318fs.setoneret(expdesc2);
                this.f3318fs.storevar(lHS_assign.f3326v, expdesc2);
                return;
            }
        }
        expdesc2.init(6, this.f3318fs.freereg - 1);
        this.f3318fs.storevar(lHS_assign.f3326v, expdesc2);
    }
    ...
    int cond() {
        expdesc expdesc2 = new expdesc();
        expr(expdesc2);
        if (expdesc2.f3330k == 1) {
            expdesc2.f3330k = 3;
        }
        this.f3318fs.goiftrue(expdesc2);
        return expdesc2.f3333f.f3315i;
    }
    ...
    void gotostat(int i) {
        ...
        Dyndata dyndata = this.dyd;
        Labeldesc[] grow = grow(this.dyd.f3325gt, this.dyd.n_gt + 1);
        dyndata.f3325gt = grow;
        Dyndata dyndata2 = this.dyd;
    ...
    void skipnoopstat() {
        while (true) {
            if (this.f3317t.token == 59 || this.f3317t.token == 285) {
                statement();
            } else {
                return;
            }
    ...
    void labelstat(LuaString luaString, int i) {
        this.f3318fs.checkrepeated(this.dyd.label, this.dyd.n_label, luaString);
        checknext(285);
        Dyndata dyndata = this.dyd;
        Labeldesc[] grow = grow(this.dyd.label, this.dyd.n_label + 1);
        dyndata.label = grow;
        ...
        int newlabelentry = newlabelentry(grow, i2, luaString, i, this.f3318fs.f3312pc);
        skipnoopstat();
        if (block_follow(false)) {
            this.dyd.label[newlabelentry].nactvar = this.f3318fs.f3311bl.nactvar;
        }
    ...
    void test_then_block(IntPtr intPtr) {
        ...
        expr(expdesc2);
        checknext(275);
        if (this.f3317t.token == 266 || this.f3317t.token == 258) {
            this.f3318fs.goiffalse(expdesc2);
            this.f3318fs.enterblock(blockCnt, false);
            gotostat(expdesc2.f3332t.f3315i);
            skipnoopstat();
            if (block_follow(false)) {
                this.f3318fs.leaveblock();
                return;
            }
            i = this.f3318fs.jump();
        } else {
            this.f3318fs.goiftrue(expdesc2);
            this.f3318fs.enterblock(blockCnt, false);
            i = expdesc2.f3333f.f3315i;
        }
        statlist();
        this.f3318fs.leaveblock();
        if (this.f3317t.token == 260 || this.f3317t.token == 261) {
            this.f3318fs.concat(intPtr, this.f3318fs.jump());
        }
        this.f3318fs.patchtohere(i);
    }

    void ifstat(int i) {
        IntPtr intPtr = new IntPtr(-1);
        test_then_block(intPtr);
        while (this.f3317t.token == 261) {
            test_then_block(intPtr);
        }
        if (testnext(260)) {
            block();
        ...
        this.f3318fs.patchtohere(intPtr.f3315i);
    }
    ...
    void localfunc() {
        ...
        adjustlocalvars(1);
        body(expdesc2, false, this.linenumber);
        funcState.getlocvar(funcState.nactvar - 1).startpc = funcState.f3312pc;
    }
    ...
    boolean funcname(expdesc expdesc2) {
        boolean z = false;
        singlevar(expdesc2);
        while (this.f3317t.token == 46) {
            fieldsel(expdesc2);
        }
        if (this.f3317t.token == 58) {
            z = true;
            fieldsel(expdesc2);
        }
        return z;
    ...
    void funcstat(int i) {
        ...
        this.f3318fs.storevar(expdesc2, expdesc3);
        this.f3318fs.fixline(i);
    }

    void exprstat() {
        FuncState funcState = this.f3318fs;
        LHS_assign lHS_assign = new LHS_assign();
        suffixedexp(lHS_assign.f3326v);
        if (this.f3317t.token == 61 || this.f3317t.token == 44) {
            lHS_assign.prev = null;
            assignment(lHS_assign, 1);
            return;
        }
        check_condition(lHS_assign.f3326v.f3330k == 12, "syntax error");
        SETARG_C(funcState.getcodePtr(lHS_assign.f3326v), 1);
    }
    ...
    void retstat() {
        ...
        FuncState funcState = this.f3318fs;
        expdesc expdesc2 = new expdesc();
        if (block_follow(true) || this.f3317t.token == 59) {
            i = 0;
            i2 = 0;
        } else {
            i = explist(expdesc2);
    ...
    void statement() {
        ...
        _assert(this.f3318fs.f3307f.maxstacksize >= this.f3318fs.freereg && this.f3318fs.freereg >= this.f3318fs.nactvar);
        this.f3318fs.freereg = this.f3318fs.nactvar;
        leavelevel();
    }

    void statlist() {
        while (!block_follow(true)) {
            if (this.f3317t.token == 274) {
                statement();
                return;
            }
            statement();
    ...
    public void mainfunc(FuncState funcState) {
        ...
        this.f3318fs.f3307f.is_vararg = 1;
        expdesc expdesc2 = new expdesc();
        expdesc2.init(7, 0);
        this.f3318fs.newupvalue(this.envn, expdesc2);
        next();
        statlist();
        check(286);
        close_func();
    ...
    static {
        ...
        for (int i2 = 0; i2 < 22; i2++) {
            RESERVED.put(LuaValue.valueOf(luaX_tokens[i2]), new Integer(PacketOpcodes.SceneAvatarStaminaStepReq + i2));
        }
