...
public class LuaInteger extends LuaNumber {
    ...
    @Override // org.luaj.vm2.LuaValue
    public byte tobyte() {
        return (byte) this.f3253v;
    }

    @Override // org.luaj.vm2.LuaValue
    public char tochar() {
        return (char) this.f3253v;
    }

    @Override // org.luaj.vm2.LuaValue
    public double todouble() {
        return (double) this.f3253v;
    }

    @Override // org.luaj.vm2.LuaValue
    public float tofloat() {
        return (float) this.f3253v;
    }
    ...
    @Override // org.luaj.vm2.LuaValue
    public long tolong() {
        return (long) this.f3253v;
    }

    @Override // org.luaj.vm2.LuaValue
    public short toshort() {
        return (short) this.f3253v;
    }
    ...
    public String tojstring() {
        return Integer.toString(this.f3253v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaString strvalue() {
        return LuaString.valueOf(Integer.toString(this.f3253v));
    }
    ...
    @Override // org.luaj.vm2.LuaValue
    public LuaValue neg() {
        return valueOf(-((long) this.f3253v));
    }

    @Override // org.luaj.vm2.LuaValue
    public boolean equals(Object obj) {
        return (obj instanceof LuaInteger) && ((LuaInteger) obj).f3253v == this.f3253v;
    }

    @Override // org.luaj.vm2.LuaValue
    /* renamed from: eq */
    public LuaValue mo24eq(LuaValue luaValue) {
        return luaValue.raweq(this.f3253v) ? TRUE : FALSE;
    }

    @Override // org.luaj.vm2.LuaValue
    public boolean eq_b(LuaValue luaValue) {
        return luaValue.raweq(this.f3253v);
    }
    ...
    public boolean raweq(double d) {
        return ((double) this.f3253v) == d;
    }

    @Override // org.luaj.vm2.LuaValue
    public boolean raweq(int i) {
        return this.f3253v == i;
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue add(LuaValue luaValue) {
        return luaValue.add(this.f3253v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue add(double d) {
        return LuaDouble.valueOf(d + ((double) this.f3253v));
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue add(int i) {
        return valueOf(((long) i) + ((long) this.f3253v));
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue sub(LuaValue luaValue) {
        return luaValue.subFrom(this.f3253v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue sub(double d) {
        return LuaDouble.valueOf(((double) this.f3253v) - d);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue sub(int i) {
        return LuaDouble.valueOf(this.f3253v - i);
    }
    ...
    public LuaValue mul(LuaValue luaValue) {
        return luaValue.mul(this.f3253v);
    }
    ...
    public LuaValue pow(LuaValue luaValue) {
        return luaValue.powWith(this.f3253v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue pow(double d) {
        return MathLib.dpow((double) this.f3253v, d);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue pow(int i) {
        return MathLib.dpow((double) this.f3253v, (double) i);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue powWith(double d) {
        return MathLib.dpow(d, (double) this.f3253v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue powWith(int i) {
        return MathLib.dpow((double) i, (double) this.f3253v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue div(LuaValue luaValue) {
        return luaValue.divInto((double) this.f3253v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue div(double d) {
        return LuaDouble.ddiv((double) this.f3253v, d);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue div(int i) {
        return LuaDouble.ddiv((double) this.f3253v, (double) i);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue divInto(double d) {
        return LuaDouble.ddiv(d, (double) this.f3253v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue mod(LuaValue luaValue) {
        return luaValue.modFrom((double) this.f3253v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue mod(double d) {
        return LuaDouble.dmod((double) this.f3253v, d);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue mod(int i) {
        return LuaDouble.dmod((double) this.f3253v, (double) i);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue modFrom(double d) {
        return LuaDouble.dmod(d, (double) this.f3253v);
    }

    @Override // org.luaj.vm2.LuaValue
    /* renamed from: lt */
    public LuaValue mo18lt(LuaValue luaValue) {
        return luaValue.gt_b(this.f3253v) ? TRUE : FALSE;
    }

    @Override // org.luaj.vm2.LuaValue
    /* renamed from: lt */
    public LuaValue mo20lt(double d) {
        return ((double) this.f3253v) < d ? TRUE : FALSE;
    }

    @Override // org.luaj.vm2.LuaValue
    /* renamed from: lt */
    public LuaValue mo19lt(int i) {
        return this.f3253v < i ? TRUE : FALSE;
    }

    @Override // org.luaj.vm2.LuaValue
    public boolean lt_b(LuaValue luaValue) {
        return luaValue.gt_b(this.f3253v);
    }
    ...
    public LuaValue lteq(LuaValue luaValue) {
        return luaValue.gteq_b(this.f3253v) ? TRUE : FALSE;
    }
    ...
    public boolean lteq_b(LuaValue luaValue) {
        return luaValue.gteq_b(this.f3253v);
    }
    ...
    public LuaValue mo21gt(LuaValue luaValue) {
        return luaValue.lt_b(this.f3253v) ? TRUE : FALSE;
    }
    ...
    public boolean gt_b(LuaValue luaValue) {
        return luaValue.lt_b(this.f3253v);
    }
    ...
    public LuaValue gteq(LuaValue luaValue) {
        return luaValue.lteq_b(this.f3253v) ? TRUE : FALSE;
    }
    ...
    public boolean gteq_b(LuaValue luaValue) {
        return luaValue.lteq_b(this.f3253v);
    }
    ...
    public String checkjstring() {
        return String.valueOf(this.f3253v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaString checkstring() {
        return valueOf(String.valueOf(this.f3253v));
    }
