...
public class LuaDouble extends LuaNumber {
    ...
    public int hashCode() {
        long doubleToLongBits = Double.doubleToLongBits(this.f3252v + 1.0d);
        return ((int) (doubleToLongBits >> 32)) + ((int) doubleToLongBits);
    }

    @Override // org.luaj.vm2.LuaValue
    public boolean islong() {
        return this.f3252v == ((double) ((long) this.f3252v));
    }

    @Override // org.luaj.vm2.LuaValue
    public byte tobyte() {
        return (byte) ((int) ((long) this.f3252v));
    }

    @Override // org.luaj.vm2.LuaValue
    public char tochar() {
        return (char) ((int) ((long) this.f3252v));
    }
    ...
    public float tofloat() {
        return (float) this.f3252v;
    }

    @Override // org.luaj.vm2.LuaValue
    public int toint() {
        return (int) ((long) this.f3252v);
    }

    @Override // org.luaj.vm2.LuaValue
    public long tolong() {
        return (long) this.f3252v;
    }

    @Override // org.luaj.vm2.LuaValue
    public short toshort() {
        return (short) ((int) ((long) this.f3252v));
    }
    ...
    public LuaInteger optinteger(LuaInteger luaInteger) {
        return LuaInteger.valueOf((int) ((long) this.f3252v));
    }
    ...
    @Override // org.luaj.vm2.LuaValue
    public LuaValue neg() {
        return valueOf(-this.f3252v);
    }

    @Override // org.luaj.vm2.LuaValue
    public boolean equals(Object obj) {
        return (obj instanceof LuaDouble) && ((LuaDouble) obj).f3252v == this.f3252v;
    }

    @Override // org.luaj.vm2.LuaValue
    /* renamed from: eq */
    public LuaValue mo24eq(LuaValue luaValue) {
        return luaValue.raweq(this.f3252v) ? TRUE : FALSE;
    }

    @Override // org.luaj.vm2.LuaValue
    public boolean eq_b(LuaValue luaValue) {
        return luaValue.raweq(this.f3252v);
    }
    ...
    public boolean raweq(double d) {
        return this.f3252v == d;
    }

    @Override // org.luaj.vm2.LuaValue
    public boolean raweq(int i) {
        return this.f3252v == ((double) i);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue add(LuaValue luaValue) {
        return luaValue.add(this.f3252v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue add(double d) {
        return valueOf(d + this.f3252v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue sub(LuaValue luaValue) {
        return luaValue.subFrom(this.f3252v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue sub(double d) {
        return valueOf(this.f3252v - d);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue sub(int i) {
        return valueOf(this.f3252v - ((double) i));
    }
    ...
    public LuaValue mul(LuaValue luaValue) {
        return luaValue.mul(this.f3252v);
    }
    ...
    public LuaValue mul(int i) {
        return valueOf(((double) i) * this.f3252v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue pow(LuaValue luaValue) {
        return luaValue.powWith(this.f3252v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue pow(double d) {
        return MathLib.dpow(this.f3252v, d);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue pow(int i) {
        return MathLib.dpow(this.f3252v, (double) i);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue powWith(double d) {
        return MathLib.dpow(d, this.f3252v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue powWith(int i) {
        return MathLib.dpow((double) i, this.f3252v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue div(LuaValue luaValue) {
        return luaValue.divInto(this.f3252v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue div(double d) {
        return ddiv(this.f3252v, d);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue div(int i) {
        return ddiv(this.f3252v, (double) i);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue divInto(double d) {
        return ddiv(d, this.f3252v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue mod(LuaValue luaValue) {
        return luaValue.modFrom(this.f3252v);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue mod(double d) {
        return dmod(this.f3252v, d);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue mod(int i) {
        return dmod(this.f3252v, (double) i);
    }

    @Override // org.luaj.vm2.LuaValue
    public LuaValue modFrom(double d) {
        return dmod(d, this.f3252v);
    }
    ...
    public LuaValue mo18lt(LuaValue luaValue) {
        return luaValue.gt_b(this.f3252v) ? LuaValue.TRUE : FALSE;
    }

    @Override // org.luaj.vm2.LuaValue
    /* renamed from: lt */
    public LuaValue mo20lt(double d) {
        return this.f3252v < d ? TRUE : FALSE;
    }

    @Override // org.luaj.vm2.LuaValue
    /* renamed from: lt */
    public LuaValue mo19lt(int i) {
        return this.f3252v < ((double) i) ? TRUE : FALSE;
    }

    @Override // org.luaj.vm2.LuaValue
    public boolean lt_b(LuaValue luaValue) {
        return luaValue.gt_b(this.f3252v);
    }
    ...
    public LuaValue lteq(LuaValue luaValue) {
        return luaValue.gteq_b(this.f3252v) ? LuaValue.TRUE : FALSE;
    }
    ...
    public boolean lteq_b(LuaValue luaValue) {
        return luaValue.gteq_b(this.f3252v);
    }
    ...
    public LuaValue mo21gt(LuaValue luaValue) {
        return luaValue.lt_b(this.f3252v) ? LuaValue.TRUE : FALSE;
    }
    ...
    public boolean gt_b(LuaValue luaValue) {
        return luaValue.lt_b(this.f3252v);
    }
    ...
    public LuaValue gteq(LuaValue luaValue) {
        return luaValue.lteq_b(this.f3252v) ? LuaValue.TRUE : FALSE;
    }
    ...
    public boolean gteq_b(LuaValue luaValue) {
        return luaValue.lteq_b(this.f3252v);
    }
    ...
    public String tojstring() {
        long j = (long) this.f3252v;
        return ((double) j) == this.f3252v ? Long.toString(j) : Double.isNaN(this.f3252v) ? JSTR_NAN : Double.isInfinite(this.f3252v) ? this.f3252v < 0.0d ? JSTR_NEGINF : JSTR_POSINF : Float.toString((float) this.f3252v);
    }
    ...
    public boolean isvalidkey() {
        return !Double.isNaN(this.f3252v);
    }
}
