 ...
 */
    ...
    public static final class Capability extends Enum<Capability> {
        ...
        public static final Capability key_f22 = new Capability("key_f22", PacketOpcodes.PlatformStartRouteNotify);
        public static final Capability key_f23 = new Capability("key_f23", PacketOpcodes.PlatformStopRouteNotify);
        public static final Capability key_f24 = new Capability("key_f24", PacketOpcodes.SceneForceUnlockNotify);
        public static final Capability key_f25 = new Capability("key_f25", PacketOpcodes.ExitSceneWeatherAreaNotify);
        public static final Capability key_f26 = new Capability("key_f26", PacketOpcodes.SceneKickPlayerReq);
        public static final Capability key_f27 = new Capability("key_f27", PacketOpcodes.AddSeenMonsterNotify);
        public static final Capability key_f28 = new Capability("key_f28", PacketOpcodes.SetSceneWeatherAreaReq);
        public static final Capability key_f29 = new Capability("key_f29", 215);
        public static final Capability key_f3 = new Capability("key_f3", 216);
        public static final Capability key_f30 = new Capability("key_f30", PacketOpcodes.SceneEntityDrownReq);
        public static final Capability key_f31 = new Capability("key_f31", PacketOpcodes.BackMyWorldRsp);
        public static final Capability key_f32 = new Capability("key_f32", PacketOpcodes.SceneInitFinishReq);
        public static final Capability key_f33 = new Capability("key_f33", 220);
        public static final Capability key_f34 = new Capability("key_f34", PacketOpcodes.ClientTransmitReq);
        public static final Capability key_f35 = new Capability("key_f35", PacketOpcodes.ClientTransmitRsp);
        public static final Capability key_f36 = new Capability("key_f36", PacketOpcodes.LevelupCityReq);
        public static final Capability key_f37 = new Capability("key_f37", PacketOpcodes.WorldPlayerLocationNotify);
        public static final Capability key_f38 = new Capability("key_f38", PacketOpcodes.GetScenePointRsp);
        public static final Capability key_f39 = new Capability("key_f39", PacketOpcodes.SealBattleBeginNotify);
        public static final Capability key_f4 = new Capability("key_f4", PacketOpcodes.SceneAvatarStaminaStepRsp);
        public static final Capability key_f40 = new Capability("key_f40", PacketOpcodes.AllSeenMonsterNotify);
        public static final Capability key_f41 = new Capability("key_f41", PacketOpcodes.WorldPlayerReviveReq);
        public static final Capability key_f42 = new Capability("key_f42", PacketOpcodes.LeaveSceneReq);
        public static final Capability key_f43 = new Capability("key_f43", PacketOpcodes.SceneKickPlayerRsp);
        public static final Capability key_f44 = new Capability("key_f44", PacketOpcodes.EnterSceneDoneReq);
        public static final Capability key_f45 = new Capability("key_f45", 233);
        public static final Capability key_f46 = new Capability("key_f46", PacketOpcodes.EntityForceSyncReq);
        public static final Capability key_f47 = new Capability("key_f47", PacketOpcodes.ExecuteGadgetLuaReq);
        public static final Capability key_f48 = new Capability("key_f48", PacketOpcodes.ClientPauseNotify);
        public static final Capability key_f49 = new Capability("key_f49", 237);
        public static final Capability key_f5 = new Capability("key_f5", PacketOpcodes.HitClientTrivialNotify);
        public static final Capability key_f50 = new Capability("key_f50", PacketOpcodes.SceneEntityMoveNotify);
        public static final Capability key_f51 = new Capability("key_f51", PacketOpcodes.ExecuteGadgetLuaRsp);
        public static final Capability key_f52 = new Capability("key_f52", PacketOpcodes.PlayerEnterSceneInfoNotify);
        public static final Capability key_f53 = new Capability("key_f53", 242);
        public static final Capability key_f54 = new Capability("key_f54", PacketOpcodes.SceneEntityAppearNotify);
        public static final Capability key_f55 = new Capability("key_f55", PacketOpcodes.GetSceneAreaRsp);
        public static final Capability key_f56 = new Capability("key_f56", 245);
        public static final Capability key_f57 = new Capability("key_f57", PacketOpcodes.EnterWorldAreaReq);
        public static final Capability key_f58 = new Capability("key_f58", 247);
        public static final Capability key_f59 = new Capability("key_f59", PacketOpcodes.ScenePlayerLocationNotify);
        public static final Capability key_f6 = new Capability("key_f6", PacketOpcodes.BeginCameraSceneLookNotify);
        public static final Capability key_f60 = new Capability("key_f60", 250);
        public static final Capability key_f61 = new Capability("key_f61", PacketOpcodes.EnterSceneReadyRsp);
        public static final Capability key_f62 = new Capability("key_f62", PacketOpcodes.PersonalSceneJumpReq);
        public static final Capability key_f63 = new Capability("key_f63", PacketOpcodes.ScenePlayerInfoNotify);
        public static final Capability key_f7 = new Capability("key_f7", 254);
        ...
        public static final Capability key_find = new Capability("key_find", PacketOpcodes.SceneAvatarStaminaStepReq);
        public static final Capability key_help = new Capability("key_help", PacketOpcodes.JoinPlayerFailNotify);
        public static final Capability key_home = new Capability("key_home", PacketOpcodes.WorldPlayerDieNotify);
        public static final Capability key_ic = new Capability("key_ic", PacketOpcodes.ClientScriptEventNotify);
        public static final Capability key_il = new Capability("key_il", PacketOpcodes.SceneEntityDisappearNotify);
        public static final Capability key_left = new Capability("key_left", PacketOpcodes.EnterSceneReadyReq);
        public static final Capability key_ll = new Capability("key_ll", PacketOpcodes.ExecuteGroupTriggerReq);
        public static final Capability key_mark = new Capability("key_mark", 264);
        public static final Capability key_message = new Capability("key_message", PacketOpcodes.SealBattleProgressNotify);
        public static final Capability key_move = new Capability("key_move", PacketOpcodes.ScenePlayerSoundNotify);
        public static final Capability key_next = new Capability("key_next", PacketOpcodes.GetAreaExplorePointReq);
        public static final Capability key_npage = new Capability("key_npage", PacketOpcodes.EnterSceneDoneRsp);
        public static final Capability key_open = new Capability("key_open", PacketOpcodes.BackMyWorldReq);
        public static final Capability key_options = new Capability("key_options", PacketOpcodes.SetSceneWeatherAreaRsp);
        public static final Capability key_ppage = new Capability("key_ppage", PacketOpcodes.EnterScenePeerNotify);
        public static final Capability key_previous = new Capability("key_previous", PacketOpcodes.SceneCreateEntityRsp);
        public static final Capability key_print = new Capability("key_print", PacketOpcodes.SceneTransToPointRsp);
        public static final Capability key_redo = new Capability("key_redo", PacketOpcodes.PersonalSceneJumpRsp);
        public static final Capability key_reference = new Capability("key_reference", 275);
        public static final Capability key_refresh = new Capability("key_refresh", PacketOpcodes.ScenePointUnlockNotify);
        public static final Capability key_replace = new Capability("key_replace", PacketOpcodes.SealBattleEndNotify);
        public static final Capability key_restart = new Capability("key_restart", PacketOpcodes.SceneEntityMoveRsp);
        public static final Capability key_resume = new Capability("key_resume", PacketOpcodes.PlayerEnterSceneNotify);
        public static final Capability key_right = new Capability("key_right", PacketOpcodes.SceneForceLockNotify);
        public static final Capability key_save = new Capability("key_save", PacketOpcodes.CutSceneEndNotify);
        public static final Capability key_sbeg = new Capability("key_sbeg", PacketOpcodes.EnterSceneWeatherAreaNotify);
        public static final Capability key_scancel = new Capability("key_scancel", PacketOpcodes.CutSceneBeginNotify);
        public static final Capability key_scommand = new Capability("key_scommand", PacketOpcodes.CutSceneFinishNotify);
        public static final Capability key_scopy = new Capability("key_scopy", 285);
        public static final Capability key_screate = new Capability("key_screate", PacketOpcodes.WorldPlayerReviveRsp);
        public static final Capability key_sdc = new Capability("key_sdc", 287);
        public static final Capability key_sdl = new Capability("key_sdl", PacketOpcodes.PlatformChangeRouteNotify);
        public static final Capability key_select = new Capability("key_select", PacketOpcodes.GetSceneAreaReq);
        public static final Capability key_send = new Capability("key_send", PacketOpcodes.ExitTransPointRegionNotify);
        public static final Capability key_seol = new Capability("key_seol", 291);
        public static final Capability key_sexit = new Capability("key_sexit", 292);
        public static final Capability key_sf = new Capability("key_sf", PacketOpcodes.MarkEntityInMinMapNotify);
        public static final Capability key_sfind = new Capability("key_sfind", PacketOpcodes.SceneCreateEntityReq);
        public static final Capability key_shelp = new Capability("key_shelp", 295);
        public static final Capability key_shome = new Capability("key_shome", PacketOpcodes.SceneTimeNotify);
        public static final Capability key_sic = new Capability("key_sic", PacketOpcodes.JoinPlayerSceneReq);
        public static final Capability key_sleft = new Capability("key_sleft", 298);
        public static final Capability key_smessage = new Capability("key_smessage", PacketOpcodes.GetScenePointReq);
        ...
        public static final Capability key_sundo = new Capability("key_sundo", TokenId.ELSE);
        ...
        public static final Capability keypad_xmit = new Capability("keypad_xmit", TokenId.FOR);
        public static final Capability lab_f0 = new Capability("lab_f0", 319);
        ...
        public static final Capability lab_f8 = new Capability("lab_f8", TokenId.NEW);
        public static final Capability lab_f9 = new Capability("lab_f9", TokenId.PACKAGE);
        ...
        public static final Capability meta_off = new Capability("meta_off", 333);
        public static final Capability meta_on = new Capability("meta_on", 334);
        public static final Capability micro_column_address = new Capability("micro_column_address", TokenId.STATIC);
        public static final Capability micro_down = new Capability("micro_down", TokenId.SUPER);
        public static final Capability micro_left = new Capability("micro_left", TokenId.SWITCH);
        public static final Capability micro_right = new Capability("micro_right", TokenId.SYNCHRONIZED);
        public static final Capability micro_row_address = new Capability("micro_row_address", 339);
        ...
        public static final Capability order_of_pins = new Capability("order_of_pins", TokenId.TRANSIENT);
        public static final Capability orig_colors = new Capability("orig_colors", 343);
        public static final Capability orig_pair = new Capability("orig_pair", 344);
        public static final Capability pad_char = new Capability("pad_char", TokenId.VOLATILE);
        ...
        public static final Capability parm_down_cursor = new Capability("parm_down_cursor", PacketOpcodes.EvtBulletHitNotify);
        public static final Capability parm_down_micro = new Capability("parm_down_micro", PacketOpcodes.MassiveEntityStateChangedNotify);
        public static final Capability parm_ich = new Capability("parm_ich", 350);
        public static final Capability parm_index = new Capability("parm_index", TokenId.MOD_E);
        public static final Capability parm_insert_line = new Capability("parm_insert_line", 352);
        ...
        public static final Capability parm_right_cursor = new Capability("parm_right_cursor", TokenId.MINUS_E);
        public static final Capability parm_right_micro = new Capability("parm_right_micro", 356);
        public static final Capability parm_rindex = new Capability("parm_rindex", 357);
        public static final Capability parm_up_cursor = new Capability("parm_up_cursor", TokenId.f3079EQ);
        public static final Capability parm_up_micro = new Capability("parm_up_micro", TokenId.f3080GE);
        public static final Capability pkey_key = new Capability("pkey_key", 360);
        public static final Capability pkey_local = new Capability("pkey_local", 361);
        public static final Capability pkey_xmit = new Capability("pkey_xmit", TokenId.PLUSPLUS);
        ...
        public static final Capability prtr_off = new Capability("prtr_off", 366);
        public static final Capability prtr_on = new Capability("prtr_on", TokenId.RSHIFT_E);
        ...
        public static final Capability req_for_input = new Capability("req_for_input", PacketOpcodes.AvatarBuffDelNotify);
        public static final Capability reset_1string = new Capability("reset_1string", 373);
        public static final Capability reset_2string = new Capability("reset_2string", 374);
        public static final Capability reset_3string = new Capability("reset_3string", PacketOpcodes.EvtEntityRenderersChangedNotify);
        ...
        public static final Capability save_cursor = new Capability("save_cursor", PacketOpcodes.EvtBeingHitNotify);
        public static final Capability scroll_forward = new Capability("scroll_forward", PacketOpcodes.AvatarEnterElementViewNotify);
        public static final Capability scroll_reverse = new Capability("scroll_reverse", 381);
        public static final Capability select_char_set = new Capability("select_char_set", PacketOpcodes.EvtAvatarStandUpNotify);
        public static final Capability set_attributes = new Capability("set_attributes", 383);
        public static final Capability set_background = new Capability("set_background", Function.USE_VARARGS);
        public static final Capability set_bottom_margin = new Capability("set_bottom_margin", PacketOpcodes.EntityAiKillSelfNotify);
        public static final Capability set_bottom_margin_parm = new Capability("set_bottom_margin_parm", 386);
        public static final Capability set_clock = new Capability("set_clock", PacketOpcodes.EvtDestroyServerGadgetNotify);
        public static final Capability set_color_pair = new Capability("set_color_pair", PacketOpcodes.ReportFightAntiCheatNotify);
        public static final Capability set_foreground = new Capability("set_foreground", PacketOpcodes.EvtBulletMoveNotify);
        public static final Capability set_left_margin = new Capability("set_left_margin", 390);
        public static final Capability set_left_margin_parm = new Capability("set_left_margin_parm", PacketOpcodes.SyncTeamEntityNotify);
        public static final Capability set_right_margin = new Capability("set_right_margin", 392);
        public static final Capability set_right_margin_parm = new Capability("set_right_margin_parm", PacketOpcodes.DelTeamEntityNotify);
        public static final Capability set_tab = new Capability("set_tab", PacketOpcodes.AvatarBuffAddNotify);
        public static final Capability set_top_margin = new Capability("set_top_margin", PacketOpcodes.EvtAiSyncSkillCdNotify);
        public static final Capability set_top_margin_parm = new Capability("set_top_margin_parm", 396);
        public static final Capability set_window = new Capability("set_window", 397);
        public static final Capability start_bit_image = new Capability("start_bit_image", PacketOpcodes.ServerBuffChangeNotify);
        public static final Capability start_char_set_def = new Capability("start_char_set_def", PacketOpcodes.EvtBulletDeactiveNotify);
        ...
        public static final Capability user8 = new Capability("user8", HttpStatus.IM_A_TEAPOT_418);
        public static final Capability user9 = new Capability("user9", PacketOpcodes.FinishedParentQuestNotify);
        ...
        public static final Capability bit_image_carriage_return = new Capability("bit_image_carriage_return", 425);
        public static final Capability bit_image_newline = new Capability("bit_image_newline", HttpStatus.UPGRADE_REQUIRED_426);
        public static final Capability bit_image_repeat = new Capability("bit_image_repeat", PacketOpcodes.QuestCreateEntityRsp);
        public static final Capability char_set_names = new Capability("char_set_names", HttpStatus.PRECONDITION_REQUIRED_428);
        public static final Capability code_set_init = new Capability("code_set_init", HttpStatus.TOO_MANY_REQUESTS_429);
        public static final Capability color_names = new Capability("color_names", PacketOpcodes.QuestListUpdateNotify);
        ...
        public static final Capability device_type = new Capability("device_type", ActivityInfoOuterClass.ActivityInfo.MIST_TRIAL_ACTIVITY_INFO_FIELD_NUMBER);
        public static final Capability display_pc_char = new Capability("display_pc_char", PacketOpcodes.GetAllActivatedBargainDataRsp);
        public static final Capability end_bit_image_region = new Capability("end_bit_image_region", 434);
        public static final Capability enter_pc_charset_mode = new Capability("enter_pc_charset_mode", 435);
        public static final Capability enter_scancode_mode = new Capability("enter_scancode_mode", 436);
        public static final Capability exit_pc_charset_mode = new Capability("exit_pc_charset_mode", PacketOpcodes.QuestDestroyNpcReq);
        public static final Capability exit_scancode_mode = new Capability("exit_scancode_mode", 438);
        public static final Capability get_mouse = new Capability("get_mouse", PacketOpcodes.QuestDestroyEntityReq);
        ...
        public static final Capability pc_term_options = new Capability("pc_term_options", PacketOpcodes.ChapterStateNotify);
        public static final Capability pkey_plab = new Capability("pkey_plab", PacketOpcodes.AddQuestContentProgressReq);
        public static final Capability req_mouse_pos = new Capability("req_mouse_pos", 444);
        public static final Capability scancode_escape = new Capability("scancode_escape", 445);
        public static final Capability set0_des_seq = new Capability("set0_des_seq", 446);
        public static final Capability set1_des_seq = new Capability("set1_des_seq", PacketOpcodes.GetQuestTalkHistoryReq);
        public static final Capability set2_des_seq = new Capability("set2_des_seq", PacketOpcodes.QuestDestroyEntityRsp);
        public static final Capability set3_des_seq = new Capability("set3_des_seq", PacketOpcodes.GetParentQuestVideoKeyReq);
        public static final Capability set_a_background = new Capability("set_a_background", PacketOpcodes.NpcTalkStateNotify);
        public static final Capability set_a_foreground = new Capability("set_a_foreground", HttpStatus.UNAVAILABLE_FOR_LEGAL_REASONS_451);
        public static final Capability set_color_band = new Capability("set_color_band", 452);
        public static final Capability set_lr_margin = new Capability("set_lr_margin", PacketOpcodes.GetQuestLackingResourceReq);
        public static final Capability set_page_length = new Capability("set_page_length", 454);
        public static final Capability set_tb_margin = new Capability("set_tb_margin", 455);
        public static final Capability enter_horizontal_hl_mode = new Capability("enter_horizontal_hl_mode", PacketOpcodes.QuestDelNotify);
        public static final Capability enter_left_hl_mode = new Capability("enter_left_hl_mode", PacketOpcodes.QuestCreateEntityReq);
        ...
        public static final Capability enter_vertical_hl_mode = new Capability("enter_vertical_hl_mode", PacketOpcodes.AddQuestContentProgressRsp);
        public static final Capability set_a_attributes = new Capability("set_a_attributes", 462);
        public static final Capability set_pglen_inch = new Capability("set_pglen_inch", PacketOpcodes.AssociateInferenceWordRsp);
        ...
        static {
            Capability[] capabilityArr = new Capability[PacketOpcodes.RedeemLegendaryKeyReq];
