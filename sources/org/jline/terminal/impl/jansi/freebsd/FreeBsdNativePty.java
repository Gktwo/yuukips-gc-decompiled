...
/* loaded from: grasscutter.jar:org/jline/terminal/impl/jansi/freebsd/FreeBsdNativePty.class */
public class FreeBsdNativePty extends JansiNativePty {
    ...
    static CLibrary.Termios termios(Attributes t) {
        ...
        tio.c_oflag = setFlag(t.getOutputFlag(Attributes.OutputFlag.TABDLY), 4, tio.c_oflag);
        ...
        tio.c_lflag = setFlag(t.getLocalFlag(Attributes.LocalFlag.PENDIN), 33554432, tio.c_lflag);
        tio.c_lflag = setFlag(t.getLocalFlag(Attributes.LocalFlag.NOFLSH), 134217728, tio.c_lflag);
