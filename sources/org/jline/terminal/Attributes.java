 ...
 */
/* loaded from: grasscutter.jar:org/jline/terminal/Attributes.class */
 ...
 */
    /* loaded from: grasscutter.jar:org/jline/terminal/Attributes$ControlChar.class */
 ...
 */
    /* loaded from: grasscutter.jar:org/jline/terminal/Attributes$ControlFlag.class */
 ...
 */
    /* loaded from: grasscutter.jar:org/jline/terminal/Attributes$InputFlag.class */
 ...
 */
    /* loaded from: grasscutter.jar:org/jline/terminal/Attributes$LocalFlag.class */
 ...
 */
    /* loaded from: grasscutter.jar:org/jline/terminal/Attributes$OutputFlag.class */
    ...
    public void setControlChar(ControlChar c, int value) {
        this.cchars.put((EnumMap<ControlChar, Integer>) c, (ControlChar) Integer.valueOf(value));
    }
    ...
    public String toString() {
        return "Attributes[lflags: " + append(this.lflag) + ", iflags: " + append(this.iflag) + ", oflags: " + append(this.oflag) + ", cflags: " + append(this.cflag) + ", cchars: " + append(EnumSet.allOf(ControlChar.class), this::display) + "]";
    }
    ...
    private String display(ControlChar c) {
        ...
        if (c == ControlChar.VMIN || c == ControlChar.VTIME) {
            ...
            value = String.format("\\u%04x", Integer.valueOf(ch));
        } else {
