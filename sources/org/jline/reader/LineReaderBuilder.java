...
/* loaded from: grasscutter.jar:org/jline/reader/LineReaderBuilder.class */
public final class LineReaderBuilder {
    ...
    public LineReader build() {
        ...
        for (Map.Entry<LineReader.Option, Boolean> e2 : this.options.entrySet()) {
            reader.option(e2.getKey(), e2.getValue().booleanValue());
        }
        return reader;
    }
}
