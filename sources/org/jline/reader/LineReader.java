...
/* loaded from: grasscutter.jar:org/jline/reader/LineReader.class */
public interface LineReader {
    ...
    /* loaded from: grasscutter.jar:org/jline/reader/LineReader$RegionType.class */
    ...
    /* loaded from: grasscutter.jar:org/jline/reader/LineReader$SuggestionType.class */
    ...
    String readLine(Character ch) throws UserInterruptException, EndOfFileException;

    String readLine(String str) throws UserInterruptException, EndOfFileException;

    String readLine(String str, Character ch) throws UserInterruptException, EndOfFileException;

    String readLine(String str, Character ch, String str2) throws UserInterruptException, EndOfFileException;

    String readLine(String str, String str2, Character ch, String str3) throws UserInterruptException, EndOfFileException;

    String readLine(String str, String str2, MaskingCallback maskingCallback, String str3) throws UserInterruptException, EndOfFileException;

    void printAbove(String str);

    void printAbove(AttributedString attributedString);

    boolean isReading();

    LineReader variable(String str, Object obj);

    LineReader option(Option option, boolean z);

    void callWidget(String str);
    ...
    void addCommandsInBuffer(Collection<String> collection);
    ...
    void setTailTip(String str);

    void setAutosuggestion(SuggestionType suggestionType);

    SuggestionType getAutosuggestion();

    /* loaded from: grasscutter.jar:org/jline/reader/LineReader$Option.class */
    public enum Option {
        COMPLETE_IN_WORD,
