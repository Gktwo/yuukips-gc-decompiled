...
/* loaded from: grasscutter.jar:org/quartz/core/jmx/CronTriggerSupport.class */
public class CronTriggerSupport {
    ...
    private static final String[] ITEM_NAMES = {"expression", "timeZone"};
    private static final String[] ITEM_DESCRIPTIONS = {"expression", "timeZone"};
