...
/* loaded from: grasscutter.jar:org/bson/BSONCallbackAdapter.class */
public class BSONCallbackAdapter extends AbstractBsonWriter {
    private BSONCallback bsonCallback;

    /* access modifiers changed from: protected */
    public BSONCallbackAdapter(BsonWriterSettings settings, BSONCallback bsonCallback) {
        super(settings);
    ...
    public void doWriteStartDocument() {
        ...
        if (getState() == AbstractBsonWriter.State.SCOPE_DOCUMENT) {
            contextType = BsonContextType.SCOPE_DOCUMENT;
        } else {
            contextType = BsonContextType.DOCUMENT;
        }
    ...
    /* loaded from: grasscutter.jar:org/bson/BSONCallbackAdapter$Context.class */
