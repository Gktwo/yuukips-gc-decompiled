...
/* loaded from: grasscutter.jar:org/bson/codecs/pojo/PojoCodecProvider.class */
public final class PojoCodecProvider implements CodecProvider {
    ...
    private <T> PojoCodec<T> getPojoCodec(Class<T> clazz, CodecRegistry registry) {
        ...
        try {
            ClassModel<T> classModel2 = createClassModel(clazz, this.conventions);
            if (!clazz.isInterface() && classModel2.getPropertyModels().isEmpty()) {
                return null;
            }
            this.discriminatorLookup.addClassModel(classModel2);
            return new AutomaticPojoCodec(new PojoCodecImpl(classModel2, registry, this.propertyCodecProviders, this.discriminatorLookup));
        } catch (Exception e) {
    ...
    /* loaded from: grasscutter.jar:org/bson/codecs/pojo/PojoCodecProvider$Builder.class */
    public static final class Builder {
        ...
        public PojoCodecProvider build() {
            List<Convention> immutableConventions;
            if (this.conventions != null) {
                immutableConventions = Collections.unmodifiableList(new ArrayList(this.conventions));
            } else {
                immutableConventions = null;
            }
