...
/* loaded from: grasscutter.jar:org/bson/codecs/pojo/PropertyModelBuilder.class */
public final class PropertyModelBuilder<T> {
    ...
    public PropertyModelBuilder<T> propertyName(String propertyName) {
    ...
    /* access modifiers changed from: package-private */
    public PropertyModelBuilder<T> setError(String error) {
        this.error = error;
        return this;
    }
}
