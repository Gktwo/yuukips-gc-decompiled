...
/* loaded from: grasscutter.jar:org/bson/codecs/pojo/ClassModelBuilder.class */
public class ClassModelBuilder<T> {
    ...
    public ClassModelBuilder(Class<T> type) {
    ...
    public ClassModel<T> build() {
        ...
        return new ClassModel<>(this.type, this.propertyNameToTypeParameterMap, this.instanceCreatorFactory, Boolean.valueOf(this.discriminatorEnabled), this.discriminatorKey, this.discriminator, IdPropertyModelHolder.create(this.type, idPropertyModel, this.idGenerator), Collections.unmodifiableList(propertyModels));
    }
    ...
    /* access modifiers changed from: package-private */
    public ClassModelBuilder<T> propertyNameToTypeParameterMap(Map<String, TypeParameterMap> propertyNameToTypeParameterMap) {
