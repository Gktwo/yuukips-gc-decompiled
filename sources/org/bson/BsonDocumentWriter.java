...
/* loaded from: grasscutter.jar:org/bson/BsonDocumentWriter.class */
public class BsonDocumentWriter extends AbstractBsonWriter {
    ...
    protected void doWriteEndDocument() {
        ...
        if (getContext().getContextType() == BsonContextType.JAVASCRIPT_WITH_SCOPE) {
            setContext(getContext().getParentContext());
            write(new BsonJavaScriptWithScope(((BsonString) getContext().container).getValue(), (BsonDocument) value));
    ...
    /* loaded from: grasscutter.jar:org/bson/BsonDocumentWriter$Context.class */
