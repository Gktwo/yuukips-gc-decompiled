...
/* loaded from: grasscutter.jar:org/bson/RawBsonDocument.class */
public final class RawBsonDocument extends BsonDocument {
    ...
    public <T> T decode(Decoder<T> decoder) {
        ...
        try {
            T decode = decoder.decode(reader, DecoderContext.builder().build());
            reader.close();
            return decode;
        } catch (Throwable th) {
            reader.close();
    ...
    /* loaded from: grasscutter.jar:org/bson/RawBsonDocument$SerializationProxy.class */
