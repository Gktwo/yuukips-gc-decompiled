...
/* loaded from: grasscutter.jar:org/bson/BsonDocumentWrapper.class */
public final class BsonDocumentWrapper<T> extends BsonDocument {
    ...
    private BsonDocument getUnwrapped() {
        ...
        if (this.unwrapped == null) {
            ...
            this.encoder.encode(new BsonDocumentWriter(unwrapped), this.wrappedDocument, EncoderContext.builder().build());
