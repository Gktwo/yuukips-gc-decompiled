...
/* loaded from: grasscutter.jar:org/eclipse/jetty/util/ajax/JSONPojoConvertor.class */
public class JSONPojoConvertor implements JSON.Convertor {
    ...
    /* loaded from: grasscutter.jar:org/eclipse/jetty/util/ajax/JSONPojoConvertor$NumberType.class */
                ...
                switch (m.getParameterCount()) {
                    case 0:
                        if (m.getReturnType() != null) {
                            if (name2.startsWith(BeanUtil.PREFIX_GETTER_IS) && name2.length() > 2) {
                                name = name2.substring(2, 3).toLowerCase(Locale.ENGLISH) + name2.substring(3);
                            } else if (name2.startsWith(BeanUtil.PREFIX_GETTER_GET) && name2.length() > 3) {
    ...
    public Object fromJSON(Map object) {
        try {
            Object obj = this._pojoClass.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
            setProps(obj, object);
            return obj;
        } catch (Exception e) {
        ...
        for (Map.Entry<?, ?> entry : props.entrySet()) {
            ...
            if (setter != null) {
                try {
                    ...
                    LOG.warn(this._pojoClass.getName() + LineReaderImpl.DEFAULT_COMMENT_BEGIN + setter.getPropertyName() + " not set from " + entry.getValue().getClass().getName() + "=" + entry.getValue().toString(), new Object[0]);
                    log(e);
                }
            }
        }
    ...
    /* loaded from: grasscutter.jar:org/eclipse/jetty/util/ajax/JSONPojoConvertor$Setter.class */
