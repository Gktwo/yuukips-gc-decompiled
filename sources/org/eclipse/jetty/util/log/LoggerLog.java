...
/* loaded from: grasscutter.jar:org/eclipse/jetty/util/log/LoggerLog.class */
public class LoggerLog extends AbstractLogger {
    ...
    public LoggerLog(Object logger) {
        try {
            ...
            this._debug = ((Boolean) isDebugEnabled.invoke(this._logger, new Object[0])).booleanValue();
        } catch (Exception x) {
    ...
    protected Logger newLogger(String fullname) {
        try {
            return new LoggerLog(this._getLoggerN.invoke(this._logger, fullname));
        } catch (Exception e) {
            e.printStackTrace();
            return this;
        }
