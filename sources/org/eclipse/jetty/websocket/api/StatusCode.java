...
/* loaded from: grasscutter.jar:org/eclipse/jetty/websocket/api/StatusCode.class */
public final class StatusCode {
    ...
    public static boolean isFatal(int statusCode) {
        return statusCode == 1006 || statusCode == 1002 || statusCode == 1009 || statusCode == 1003 || statusCode == 1007 || statusCode == 1008 || statusCode == 1010 || statusCode == 1011 || statusCode == 1012;
    }

    public static boolean isTransmittable(int statusCode) {
        return statusCode == 1000 || statusCode == 1001 || statusCode == 1002 || statusCode == 1003 || statusCode == 1007 || statusCode == 1008 || statusCode == 1009 || statusCode == 1010 || statusCode == 1011 || statusCode == 1012 || statusCode == 1013 || statusCode == 1014 || (statusCode >= 3000 && statusCode <= 4999);
    }
}
