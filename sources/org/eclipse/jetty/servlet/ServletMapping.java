...
/* loaded from: grasscutter.jar:org/eclipse/jetty/servlet/ServletMapping.class */
public class ServletMapping {
    ...
    public String toString() {
        return (this._pathSpecs == null ? HttpUrl.PATH_SEGMENT_ENCODE_SET_URI : Arrays.asList(this._pathSpecs).toString()) + "=>" + this._servletName;
    }
