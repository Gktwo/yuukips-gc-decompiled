...
/* loaded from: grasscutter.jar:org/checkerframework/checker/formatter/FormatUtil.class */
public class FormatUtil {
    private static final String formatSpecifier = "%(\\d+\\$)?([-#+ 0,(\\<]*)?(\\d+)?(\\.\\d+)?([tT])?([a-zA-Z%])";
    private static Pattern fsPattern = Pattern.compile(formatSpecifier);

    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:org/checkerframework/checker/formatter/FormatUtil$Conversion.class */
    ...
    /* loaded from: grasscutter.jar:org/checkerframework/checker/formatter/FormatUtil$ExcessiveOrMissingFormatArgumentException.class */
    ...
    /* loaded from: grasscutter.jar:org/checkerframework/checker/formatter/FormatUtil$IllegalFormatConversionCategoryException.class */
