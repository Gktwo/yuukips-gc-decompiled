...
/* loaded from: grasscutter.jar:net/bytebuddy/matcher/LatentMatcher.class */
public interface LatentMatcher<T> {
    ElementMatcher<? super T> resolve(TypeDescription typeDescription);

    /* loaded from: grasscutter.jar:net/bytebuddy/matcher/LatentMatcher$ForSelfDeclaredMethod.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/matcher/LatentMatcher$Resolved.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/matcher/LatentMatcher$ForFieldToken.class */
    public static class ForFieldToken implements LatentMatcher<FieldDescription> {
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/matcher/LatentMatcher$ForFieldToken$ResolvedMatcher.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/matcher/LatentMatcher$ForMethodToken.class */
    public static class ForMethodToken implements LatentMatcher<MethodDescription> {
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/matcher/LatentMatcher$ForMethodToken$ResolvedMatcher.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/matcher/LatentMatcher$ForRecordComponentToken.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/matcher/LatentMatcher$Conjunction.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/matcher/LatentMatcher$Disjunction.class */
    public static class Disjunction<S> implements LatentMatcher<S> {
        ...
        public ElementMatcher<? super S> resolve(TypeDescription typeDescription) {
            ...
            for (LatentMatcher<? super S> latentMatcher : this.matchers) {
                matcher = matcher.mo105or(latentMatcher.resolve(typeDescription));
            }
            return matcher;
        }
    }
