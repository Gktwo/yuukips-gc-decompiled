...
/* loaded from: grasscutter.jar:net/bytebuddy/matcher/MethodOverrideMatcher.class */
public class MethodOverrideMatcher<T extends MethodDescription> extends ElementMatcher.Junction.AbstractBase<T> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: net.bytebuddy.matcher.MethodOverrideMatcher<T extends net.bytebuddy.description.method.MethodDescription> */
