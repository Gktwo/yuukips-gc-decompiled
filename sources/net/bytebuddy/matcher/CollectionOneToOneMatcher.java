...
/* loaded from: grasscutter.jar:net/bytebuddy/matcher/CollectionOneToOneMatcher.class */
public class CollectionOneToOneMatcher<T> extends ElementMatcher.Junction.AbstractBase<Iterable<? extends T>> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v17, resolved type: net.bytebuddy.matcher.ElementMatcher */
