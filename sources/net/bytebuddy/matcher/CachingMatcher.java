...
/* loaded from: grasscutter.jar:net/bytebuddy/matcher/CachingMatcher.class */
public class CachingMatcher<T> extends ElementMatcher.Junction.AbstractBase<T> {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/matcher/CachingMatcher$WithInlineEviction.class */
