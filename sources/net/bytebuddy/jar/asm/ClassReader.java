...
public class ClassReader {
    ...
    public void accept(ClassVisitor classVisitor, Attribute[] attributePrototypes, int parsingOptions) {
        ...
        if (enclosingMethodOffset != 0) {
            ...
            classVisitor.visitOuterClass(className, methodIndex == 0 ? null : readUTF8(this.cpInfoOffsets[methodIndex], charBuffer), methodIndex == 0 ? null : readUTF8(this.cpInfoOffsets[methodIndex] + 2, charBuffer));
        }
        if (runtimeVisibleAnnotationsOffset != 0) {
            ...
            while (true) {
                ...
                currentAnnotationOffset = readElementValues(classVisitor.visitAnnotation(readUTF8(currentAnnotationOffset, charBuffer), true), currentAnnotationOffset + 2, true, charBuffer);
            }
        }
        if (runtimeInvisibleAnnotationsOffset != 0) {
            int numAnnotations2 = readUnsignedShort(runtimeInvisibleAnnotationsOffset);
            int currentAnnotationOffset2 = runtimeInvisibleAnnotationsOffset + 2;
            while (true) {
                numAnnotations2--;
                if (numAnnotations2 <= 0) {
                    break;
                }
                currentAnnotationOffset2 = readElementValues(classVisitor.visitAnnotation(readUTF8(currentAnnotationOffset2, charBuffer), false), currentAnnotationOffset2 + 2, true, charBuffer);
            }
        }
        if (runtimeVisibleTypeAnnotationsOffset != 0) {
            int numAnnotations3 = readUnsignedShort(runtimeVisibleTypeAnnotationsOffset);
            int currentAnnotationOffset3 = runtimeVisibleTypeAnnotationsOffset + 2;
            while (true) {
                numAnnotations3--;
                if (numAnnotations3 <= 0) {
                    break;
                }
                int currentAnnotationOffset4 = readTypeAnnotationTarget(context, currentAnnotationOffset3);
                currentAnnotationOffset3 = readElementValues(classVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, readUTF8(currentAnnotationOffset4, charBuffer), true), currentAnnotationOffset4 + 2, true, charBuffer);
            }
        }
        if (runtimeInvisibleTypeAnnotationsOffset != 0) {
            int numAnnotations4 = readUnsignedShort(runtimeInvisibleTypeAnnotationsOffset);
            int currentAnnotationOffset5 = runtimeInvisibleTypeAnnotationsOffset + 2;
            while (true) {
                numAnnotations4--;
                if (numAnnotations4 <= 0) {
                    break;
                }
                int currentAnnotationOffset6 = readTypeAnnotationTarget(context, currentAnnotationOffset5);
                currentAnnotationOffset5 = readElementValues(classVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, readUTF8(currentAnnotationOffset6, charBuffer), false), currentAnnotationOffset6 + 2, true, charBuffer);
            }
        }
    ...
    private void readModuleAttributes(ClassVisitor classVisitor, Context context, int moduleOffset, int modulePackagesOffset, String moduleMainClass) {
        ...
        ModuleVisitor moduleVisitor = classVisitor.visitModule(readModule(moduleOffset, buffer), readUnsignedShort(moduleOffset + 2), readUTF8(moduleOffset + 4, buffer));
        if (moduleVisitor != null) {
            ...
            while (true) {
                ...
                currentOffset2 += 6;
                moduleVisitor.visitRequire(readModule(currentOffset2, buffer), readUnsignedShort(currentOffset2 + 2), readUTF8(currentOffset2 + 4, buffer));
            }
            ...
            while (true) {
                ...
                if (exportsToCount != 0) {
                    ...
                    for (int i = 0; i < exportsToCount; i++) {
                        exportsTo[i] = readModule(currentOffset3, buffer);
                        currentOffset3 += 2;
                    }
                }
            ...
            while (true) {
                ...
                if (opensToCount != 0) {
                    ...
                    for (int i2 = 0; i2 < opensToCount; i2++) {
                        opensTo[i2] = readModule(currentOffset4, buffer);
                        currentOffset4 += 2;
                    }
                }
            ...
            while (true) {
                ...
                if (providesCount > 0) {
                    ...
                    for (int i3 = 0; i3 < providesWithCount; i3++) {
                        providesWith[i3] = readClass(currentOffset5, buffer);
                        currentOffset5 += 2;
                    }
    ...
    private int readRecordComponent(ClassVisitor classVisitor, Context context, int recordComponentOffset) {
        ...
        while (true) {
            ...
            if (SignatureAttribute.tag.equals(attributeName)) {
        ...
        if (runtimeVisibleAnnotationsOffset != 0) {
            ...
            while (true) {
                ...
                currentAnnotationOffset = readElementValues(recordComponentVisitor.visitAnnotation(readUTF8(currentAnnotationOffset, charBuffer), true), currentAnnotationOffset + 2, true, charBuffer);
            }
        }
        if (runtimeInvisibleAnnotationsOffset != 0) {
            int numAnnotations2 = readUnsignedShort(runtimeInvisibleAnnotationsOffset);
            ...
            while (true) {
                ...
                currentAnnotationOffset2 = readElementValues(recordComponentVisitor.visitAnnotation(readUTF8(currentAnnotationOffset2, charBuffer), false), currentAnnotationOffset2 + 2, true, charBuffer);
            }
        }
        if (runtimeVisibleTypeAnnotationsOffset != 0) {
            int numAnnotations3 = readUnsignedShort(runtimeVisibleTypeAnnotationsOffset);
            ...
            while (true) {
                ...
                int currentAnnotationOffset4 = readTypeAnnotationTarget(context, currentAnnotationOffset3);
                currentAnnotationOffset3 = readElementValues(recordComponentVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, readUTF8(currentAnnotationOffset4, charBuffer), true), currentAnnotationOffset4 + 2, true, charBuffer);
            }
        }
        if (runtimeInvisibleTypeAnnotationsOffset != 0) {
            int numAnnotations4 = readUnsignedShort(runtimeInvisibleTypeAnnotationsOffset);
            ...
            while (true) {
                ...
                int currentAnnotationOffset6 = readTypeAnnotationTarget(context, currentAnnotationOffset5);
                currentAnnotationOffset5 = readElementValues(recordComponentVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, readUTF8(currentAnnotationOffset6, charBuffer), false), currentAnnotationOffset6 + 2, true, charBuffer);
            }
        }
        while (attributes != null) {
            Attribute nextAttribute = attributes.nextAttribute;
    ...
    private int readField(ClassVisitor classVisitor, Context context, int fieldInfoOffset) {
        ...
        if (runtimeVisibleAnnotationsOffset != 0) {
            ...
            while (true) {
                ...
                currentAnnotationOffset = readElementValues(fieldVisitor.visitAnnotation(readUTF8(currentAnnotationOffset, charBuffer), true), currentAnnotationOffset + 2, true, charBuffer);
            }
        }
        if (runtimeInvisibleAnnotationsOffset != 0) {
            int numAnnotations2 = readUnsignedShort(runtimeInvisibleAnnotationsOffset);
            ...
            while (true) {
                ...
                currentAnnotationOffset2 = readElementValues(fieldVisitor.visitAnnotation(readUTF8(currentAnnotationOffset2, charBuffer), false), currentAnnotationOffset2 + 2, true, charBuffer);
            }
        }
        if (runtimeVisibleTypeAnnotationsOffset != 0) {
            int numAnnotations3 = readUnsignedShort(runtimeVisibleTypeAnnotationsOffset);
            ...
            while (true) {
                ...
                int currentAnnotationOffset4 = readTypeAnnotationTarget(context, currentAnnotationOffset3);
                currentAnnotationOffset3 = readElementValues(fieldVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, readUTF8(currentAnnotationOffset4, charBuffer), true), currentAnnotationOffset4 + 2, true, charBuffer);
            }
        }
        if (runtimeInvisibleTypeAnnotationsOffset != 0) {
            int numAnnotations4 = readUnsignedShort(runtimeInvisibleTypeAnnotationsOffset);
            ...
            while (true) {
                ...
                int currentAnnotationOffset6 = readTypeAnnotationTarget(context, currentAnnotationOffset5);
                currentAnnotationOffset5 = readElementValues(fieldVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, readUTF8(currentAnnotationOffset6, charBuffer), false), currentAnnotationOffset6 + 2, true, charBuffer);
            }
        }
        while (attributes != null) {
            Attribute nextAttribute = attributes.nextAttribute;
    ...
    private int readMethod(ClassVisitor classVisitor, Context context, int methodInfoOffset) {
        ...
        while (true) {
            ...
            int attributeLength = readInt(currentOffset2 + 2);
            int currentOffset3 = currentOffset2 + 6;
            if (CodeAttribute.tag.equals(attributeName)) {
        ...
        if (runtimeVisibleAnnotationsOffset != 0) {
            ...
            while (true) {
                ...
                currentAnnotationOffset = readElementValues(methodVisitor.visitAnnotation(readUTF8(currentAnnotationOffset, charBuffer), true), currentAnnotationOffset + 2, true, charBuffer);
            }
        }
        if (runtimeInvisibleAnnotationsOffset != 0) {
            int numAnnotations2 = readUnsignedShort(runtimeInvisibleAnnotationsOffset);
            ...
            while (true) {
                ...
                currentAnnotationOffset2 = readElementValues(methodVisitor.visitAnnotation(readUTF8(currentAnnotationOffset2, charBuffer), false), currentAnnotationOffset2 + 2, true, charBuffer);
            }
        }
        if (runtimeVisibleTypeAnnotationsOffset != 0) {
            int numAnnotations3 = readUnsignedShort(runtimeVisibleTypeAnnotationsOffset);
            ...
            while (true) {
                ...
                int currentAnnotationOffset4 = readTypeAnnotationTarget(context, currentAnnotationOffset3);
                currentAnnotationOffset3 = readElementValues(methodVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, readUTF8(currentAnnotationOffset4, charBuffer), true), currentAnnotationOffset4 + 2, true, charBuffer);
            }
        }
        if (runtimeInvisibleTypeAnnotationsOffset != 0) {
            int numAnnotations4 = readUnsignedShort(runtimeInvisibleTypeAnnotationsOffset);
            ...
            while (true) {
                ...
                int currentAnnotationOffset6 = readTypeAnnotationTarget(context, currentAnnotationOffset5);
                currentAnnotationOffset5 = readElementValues(methodVisitor.visitTypeAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, readUTF8(currentAnnotationOffset6, charBuffer), false), currentAnnotationOffset6 + 2, true, charBuffer);
            }
        }
    ...
    private void readCode(MethodVisitor methodVisitor, Context context, int codeOffset) {
        ...
        while (true) {
            ...
            if (exceptionTableLength > 0) {
                currentOffset3 += 8;
                methodVisitor.visitTryCatchBlock(createLabel(readUnsignedShort(currentOffset3), labels), createLabel(readUnsignedShort(currentOffset3 + 2), labels), createLabel(readUnsignedShort(currentOffset3 + 4), labels), readUTF8(this.cpInfoOffsets[readUnsignedShort(currentOffset3 + 6)], charBuffer));
            } else {
                ...
                while (true) {
                    ...
                    if (attributesCount > 0) {
                            ...
                            if ((context.parsingOptions & 2) == 0) {
                                ...
                                while (true) {
                                    ...
                                    if (localVariableTableLength > 0) {
                                        ...
                                        createDebugLabel(startPc + readUnsignedShort(currentLocalVariableTableOffset + 2), labels);
                        ...
                        while (currentOffset6 < bytecodeEndOffset) {
                            ...
                            int opcode2 = classBuffer[currentOffset6] & 255;
                            switch (opcode2) {
                                case 0:
                                case 1:
                                case 2:
                                ...
                                case 16:
                                case 188:
                                    methodVisitor.visitIntInsn(opcode2, classBuffer[currentOffset6 + 1]);
                                    currentOffset6 += 2;
                                    break;
                                case 17:
                                    methodVisitor.visitIntInsn(opcode2, readShort(currentOffset6 + 1));
                                    currentOffset6 += 3;
                                    break;
                                case 18:
                                ...
                                case 58:
                                case 169:
                                    methodVisitor.visitVarInsn(opcode2, classBuffer[currentOffset6 + 1] & 255);
                                    currentOffset6 += 2;
                                    break;
                                case 26:
                                case 27:
                                ...
                                case 44:
                                case 45:
                                    int opcode3 = opcode2 - 26;
                                    methodVisitor.visitVarInsn(21 + (opcode3 >> 2), opcode3 & 3);
                                    currentOffset6++;
                                    break;
                                case 59:
                                case 60:
                                ...
                                case 77:
                                case 78:
                                    int opcode4 = opcode2 - 59;
                                    methodVisitor.visitVarInsn(54 + (opcode4 >> 2), opcode4 & 3);
                                    currentOffset6++;
                                    break;
                                case 132:
                                ...
                                case 198:
                                case 199:
                                    methodVisitor.visitJumpInsn(opcode2, labels[currentBytecodeOffset + readShort(currentOffset6 + 1)]);
                                    currentOffset6 += 3;
                                    break;
                                case 170:
                                    ...
                                    for (int i = 0; i < table.length; i++) {
                                        table[i] = labels[currentBytecodeOffset + readInt(currentOffset6)];
                                        currentOffset6 += 4;
                                    }
                                ...
                                case 171:
                                    ...
                                    for (int i2 = 0; i2 < numPairs; i2++) {
                                        keys[i2] = readInt(currentOffset6);
                                        values[i2] = labels[currentBytecodeOffset + readInt(currentOffset6 + 4)];
                                        currentOffset6 += 8;
                                    }
                                ...
                                case 185:
                                    ...
                                    if (opcode2 < 182) {
                                        ...
                                        methodVisitor.visitMethodInsn(opcode2, owner, name, descriptor, classBuffer[cpInfoOffset - 1] == 11);
                                    }
                                    if (opcode2 == 185) {
                                        currentOffset6 += 5;
                                        break;
                                ...
                                case 186:
                                    ...
                                    for (int i3 = 0; i3 < bootstrapMethodArguments.length; i3++) {
                                        bootstrapMethodArguments[i3] = readConst(readUnsignedShort(bootstrapMethodOffset2), charBuffer);
                                ...
                                case 192:
                                case 193:
                                    methodVisitor.visitTypeInsn(opcode2, readClass(currentOffset6 + 1, charBuffer));
                                    currentOffset6 += 3;
                                    break;
                                case 196:
                                    int opcode5 = classBuffer[currentOffset6 + 1] & 255;
                                    if (opcode5 == 132) {
                                        methodVisitor.visitIincInsn(readUnsignedShort(currentOffset6 + 2), readShort(currentOffset6 + 4));
                                        currentOffset6 += 6;
                                        break;
                                    } else {
                                        methodVisitor.visitVarInsn(opcode5, readUnsignedShort(currentOffset6 + 2));
                                        currentOffset6 += 4;
                                        break;
                                    }
                                case 197:
                                ...
                                case 200:
                                case 201:
                                    methodVisitor.visitJumpInsn(opcode2 - wideJumpOpcodeDelta, labels[currentBytecodeOffset + readInt(currentOffset6 + 1)]);
                                    currentOffset6 += 5;
                                    break;
                                case 202:
                                case 203:
                                ...
                                case PacketOpcodes.SceneInitFinishReq:
                                    ...
                                    if (opcode == 167 || opcode == 168) {
                                        ...
                                        methodVisitor.visitJumpInsn(opcode < 167 ? ((opcode + 1) ^ 1) - 1 : opcode ^ 1, createLabel(currentBytecodeOffset + 3, labels));
                            ...
                            while (visibleTypeAnnotationOffsets != null && currentVisibleTypeAnnotationIndex < visibleTypeAnnotationOffsets.length && currentVisibleTypeAnnotationBytecodeOffset <= currentBytecodeOffset) {
                                if (currentVisibleTypeAnnotationBytecodeOffset == currentBytecodeOffset) {
                                    ...
                                    readElementValues(methodVisitor.visitInsnAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, readUTF8(currentAnnotationOffset, charBuffer), true), currentAnnotationOffset + 2, true, charBuffer);
                                }
                            ...
                            while (invisibleTypeAnnotationOffsets != null && currentInvisibleTypeAnnotationIndex < invisibleTypeAnnotationOffsets.length && currentInvisibleTypeAnnotationBytecodeOffset <= currentBytecodeOffset) {
                                if (currentInvisibleTypeAnnotationBytecodeOffset == currentBytecodeOffset) {
                                    ...
                                    readElementValues(methodVisitor.visitInsnAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, readUTF8(currentAnnotationOffset2, charBuffer), false), currentAnnotationOffset2 + 2, true, charBuffer);
                                }
                        ...
                        if (localVariableTableOffset != 0 && (context.parsingOptions & 2) == 0) {
                            ...
                            while (true) {
                                ...
                                if (localVariableTableLength2 > 0) {
                                    int startPc3 = readUnsignedShort(currentOffset10);
                                    int length = readUnsignedShort(currentOffset10 + 2);
                                    ...
                                    if (typeTable != null) {
                                        int i4 = 0;
                                        while (true) {
                                            if (i4 >= typeTable.length) {
                                                break;
                                            } else if (typeTable[i4] == startPc3 && typeTable[i4 + 1] == index) {
                                                signature = readUTF8(typeTable[i4 + 2], charBuffer);
                                            } else {
                                                i4 += 3;
                                            }
                                        }
                                    }
                                    methodVisitor.visitLocalVariable(name3, descriptor3, signature, labels[startPc3], labels[startPc3 + length], index);
                                }
                            }
                        }
                        ...
                        if (invisibleTypeAnnotationOffsets != null) {
                            for (int typeAnnotationOffset2 : invisibleTypeAnnotationOffsets) {
                                ...
                                if (targetType2 == 64 || targetType2 == 65) {
                                    ...
                                    readElementValues(methodVisitor.visitLocalVariableAnnotation(context.currentTypeAnnotationTarget, context.currentTypeAnnotationTargetPath, context.currentLocalVariableAnnotationRangeStarts, context.currentLocalVariableAnnotationRangeEnds, context.currentLocalVariableAnnotationRangeIndices, readUTF8(currentOffset12, charBuffer), false), currentOffset12 + 2, true, charBuffer);
                                }
                            }
                        }
                        while (attributes != null) {
    ...
    private int[] readTypeAnnotations(MethodVisitor methodVisitor, Context context, int runtimeTypeAnnotationsOffset, boolean visible) {
        ...
        for (int i = 0; i < typeAnnotationsOffsets.length; i++) {
            ...
            if ((targetType >>> 24) == 66) {
                ...
                currentOffset2 = readElementValues(methodVisitor.visitTryCatchAnnotation(targetType & -256, path, readUTF8(currentOffset3, charBuffer), visible), currentOffset3 + 2, true, charBuffer);
            } else {
                currentOffset2 = readElementValues(null, currentOffset + 3 + (2 * pathLength), true, charBuffer);
            }
        }
    ...
    private void readParameterAnnotations(MethodVisitor methodVisitor, Context context, int runtimeParameterAnnotationsOffset, boolean visible) {
        ...
        for (int i = 0; i < numParameters; i++) {
            ...
            while (true) {
                numAnnotations--;
                if (numAnnotations > 0) {
                    currentOffset = readElementValues(methodVisitor.visitParameterAnnotation(i, readUTF8(currentOffset, charBuffer), visible), currentOffset + 2, true, charBuffer);
                }
            }
        }
    }
    ...
    private int readElementValues(AnnotationVisitor annotationVisitor, int annotationOffset, boolean named, char[] charBuffer) {
        ...
        if (!named) {
            ...
            while (true) {
                ...
                currentOffset = readElementValue(annotationVisitor, currentOffset + 2, readUTF8(currentOffset, charBuffer), charBuffer);
            }
        }
        if (annotationVisitor != null) {
            annotationVisitor.visitEnd();
        ...
        while (true) {
            ...
            switch (methodDescriptor.charAt(currentMethodDescritorOffset)) {
                ...
                case 'L':
                    ...
                    numLocal++;
                    int i = currentMethodDescritorOffset + 1;
                    currentMethodDescritorOffset++;
                    locals[numLocal] = methodDescriptor.substring(i, currentMethodDescritorOffset);
                    break;
                case '[':
                    while (methodDescriptor.charAt(currentMethodDescritorOffset) == '[') {
                        currentMethodDescritorOffset++;
                    ...
                    numLocal++;
                    currentMethodDescritorOffset++;
                    locals[numLocal] = methodDescriptor.substring(currentMethodDescritorOffset, currentMethodDescritorOffset);
                    break;
            }
        }
    }
    ...
    private int readVerificationTypeInfo(int verificationTypeInfoOffset, Object[] frame, int index, char[] charBuffer, Label[] labels) {
        ...
        switch (this.classFileBuffer[verificationTypeInfoOffset] & 255) {
            case 0:
    ...
    public long readLong(int offset) {
        long l1 = (long) readInt(offset);
        return (l1 << 32) | (((long) readInt(offset + 4)) & 4294967295L);
    }
    ...
    private String readUtf(int utfOffset, int utfLength, char[] charBuffer) {
        ...
        while (currentOffset < endOffset) {
            currentOffset++;
            byte b = classBuffer[currentOffset];
            if ((b & 128) == 0) {
                strLength++;
                charBuffer[strLength] = (char) (b & Byte.MAX_VALUE);
            } else if ((b & 224) == 192) {
                strLength++;
                currentOffset++;
                charBuffer[strLength] = (char) (((b & 31) << 6) + (classBuffer[currentOffset] & 63));
            } else {
                strLength++;
                int currentOffset2 = currentOffset + 1;
                currentOffset = currentOffset2 + 1;
                charBuffer[strLength] = (char) (((b & 15) << 12) + ((classBuffer[currentOffset] & 63) << 6) + (classBuffer[currentOffset2] & 63));
            }
        }
    ...
    public Object readConst(int constantPoolEntryIndex, char[] charBuffer) {
        ...
        switch (this.classFileBuffer[cpInfoOffset - 1]) {
            ...
            case 15:
                ...
                return new Handle(referenceKind, readClass(referenceCpInfoOffset, charBuffer), readUTF8(nameAndTypeCpInfoOffset, charBuffer), readUTF8(nameAndTypeCpInfoOffset + 2, charBuffer), this.classFileBuffer[referenceCpInfoOffset - 1] == 11);
            case 16:
