...
/* loaded from: grasscutter.jar:net/bytebuddy/jar/asm/Type.class */
public final class Type {
    ...
    public static Type[] getArgumentTypes(String methodDescriptor) {
        ...
        while (methodDescriptor.charAt(currentOffset) != ')') {
            ...
            if (methodDescriptor.charAt(currentOffset) == 'L') {
                currentOffset = Math.max(currentOffset, methodDescriptor.indexOf(59, currentOffset) + 1);
            }
            numArgumentTypes++;
        }
        ...
        while (methodDescriptor.charAt(currentOffset2) != ')') {
            ...
            currentOffset2++;
            if (methodDescriptor.charAt(currentOffset2) == 'L') {
                currentOffset2 = Math.max(currentOffset2, methodDescriptor.indexOf(59, currentOffset2) + 1);
            }
            currentArgumentTypeIndex++;
            argumentTypes[currentArgumentTypeIndex] = getTypeInternal(methodDescriptor, currentOffset2, currentOffset2);
        }
    ...
    public static int getArgumentsAndReturnSizes(String methodDescriptor) {
        int argumentsSize = 1;
        int currentOffset = 1;
        int currentChar = methodDescriptor.charAt(1);
        ...
        return (argumentsSize << 2) | ((currentChar2 == 74 || currentChar2 == 68) ? 2 : 1);
    }
