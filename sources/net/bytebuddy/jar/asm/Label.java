...
/* loaded from: grasscutter.jar:net/bytebuddy/jar/asm/Label.class */
public class Label {
    ...
    public final void markSubroutine(short subroutineId) {
        ...
        while (listOfBlocksToProcess != EMPTY_LIST) {
            ...
            if (listOfBlocksToProcess.subroutineId == 0) {
                listOfBlocksToProcess.subroutineId = subroutineId;
    ...
    public final void addSubroutineRetSuccessors(Label subroutineCaller) {
        ...
        listOfBlocksToProcess.nextListElement = EMPTY_LIST;
        while (listOfBlocksToProcess != EMPTY_LIST) {
            Label listOfBlocksToProcess2 = listOfBlocksToProcess.nextListElement;
            ...
            listOfBlocksToProcess = listOfBlocksToProcess.pushSuccessors(listOfBlocksToProcess2);
        }
    ...
    private Label pushSuccessors(Label listOfLabelsToProcess) {
        ...
        while (outgoingEdge != null) {
            if (!((this.flags & 16) != 0 && outgoingEdge == this.outgoingEdges.nextEdge) && outgoingEdge.successor.nextListElement == null) {
