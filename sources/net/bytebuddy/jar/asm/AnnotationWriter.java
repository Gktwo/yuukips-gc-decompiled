...
/* loaded from: grasscutter.jar:net/bytebuddy/jar/asm/AnnotationWriter.class */
public final class AnnotationWriter extends AnnotationVisitor {
    ...
    public void visit(String name, Object value) {
        ...
        if (value instanceof String) {
            ...
            this.annotation.put12(90, this.symbolTable.addConstantInteger(((Boolean) value).booleanValue() ? 1 : 0).index);
    ...
    public static int computeAnnotationsSize(AnnotationWriter lastRuntimeVisibleAnnotation, AnnotationWriter lastRuntimeInvisibleAnnotation, AnnotationWriter lastRuntimeVisibleTypeAnnotation, AnnotationWriter lastRuntimeInvisibleTypeAnnotation) {
        ...
        if (lastRuntimeVisibleAnnotation != null) {
            size = 0 + lastRuntimeVisibleAnnotation.computeAnnotationsSize(AnnotationsAttribute.visibleTag);
        }
        if (lastRuntimeInvisibleAnnotation != null) {
            size += lastRuntimeInvisibleAnnotation.computeAnnotationsSize(AnnotationsAttribute.invisibleTag);
        }
    ...
    public void putAnnotations(int attributeNameIndex, ByteVector output) {
        ...
        for (AnnotationWriter annotationWriter2 = firstAnnotation; annotationWriter2 != null; annotationWriter2 = annotationWriter2.nextAnnotation) {
            output.putByteArray(annotationWriter2.annotation.data, 0, annotationWriter2.annotation.length);
        }
    }
    ...
    public static void putAnnotations(SymbolTable symbolTable, AnnotationWriter lastRuntimeVisibleAnnotation, AnnotationWriter lastRuntimeInvisibleAnnotation, AnnotationWriter lastRuntimeVisibleTypeAnnotation, AnnotationWriter lastRuntimeInvisibleTypeAnnotation, ByteVector output) {
        if (lastRuntimeVisibleAnnotation != null) {
            lastRuntimeVisibleAnnotation.putAnnotations(symbolTable.addConstantUtf8(AnnotationsAttribute.visibleTag), output);
        }
        if (lastRuntimeInvisibleAnnotation != null) {
            lastRuntimeInvisibleAnnotation.putAnnotations(symbolTable.addConstantUtf8(AnnotationsAttribute.invisibleTag), output);
        }
        if (lastRuntimeVisibleTypeAnnotation != null) {
    ...
    public static void putParameterAnnotations(int attributeNameIndex, AnnotationWriter[] annotationWriters, int annotableParameterCount, ByteVector output) {
        ...
        for (int i2 = 0; i2 < annotableParameterCount; i2++) {
            ...
            output.putShort(numAnnotations);
            for (AnnotationWriter annotationWriter3 = firstAnnotation; annotationWriter3 != null; annotationWriter3 = annotationWriter3.nextAnnotation) {
