...
/* loaded from: grasscutter.jar:net/bytebuddy/jar/asm/ByteVector.class */
public class ByteVector {
    ...
    public ByteVector putUTF8(String stringValue) {
        ...
        for (int i = 0; i < charLength; i++) {
            ...
            currentLength3++;
            currentData[currentLength3] = (byte) charValue;
        }
        this.length = currentLength3;
        return this;
    }
