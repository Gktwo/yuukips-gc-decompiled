...
/* loaded from: grasscutter.jar:net/bytebuddy/dynamic/Transformer.class */
public interface Transformer<T> {
    T transform(TypeDescription typeDescription, T t);

    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/Transformer$NoOp.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/Transformer$ForField.class */
    public static class ForField implements Transformer<FieldDescription> {
        ...
        public static Transformer<FieldDescription> withModifiers(List<? extends ModifierContributor.ForField> modifierContributors) {
            return new ForField(new FieldModifierTransformer(ModifierContributor.Resolver.m255of(modifierContributors)));
        }
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/Transformer$ForField$FieldModifierTransformer.class */
        ...
        /* access modifiers changed from: protected */
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/Transformer$ForField$TransformedField.class */
        public static class TransformedField extends FieldDescription.AbstractBase {
            ...
            public TypeDescription.Generic getType() {
                return (TypeDescription.Generic) this.token.getType().accept(TypeDescription.Generic.Visitor.Substitutor.ForAttachment.m237of(this.instrumentedType));
            }
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/Transformer$ForMethod.class */
    public static class ForMethod implements Transformer<MethodDescription> {
        ...
        public static Transformer<MethodDescription> withModifiers(List<? extends ModifierContributor.ForMethod> modifierContributors) {
            return new ForMethod(new MethodModifierTransformer(ModifierContributor.Resolver.m255of(modifierContributors)));
        }
        ...
        /* access modifiers changed from: protected */
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/Transformer$ForMethod$MethodModifierTransformer.class */
        ...
        /* access modifiers changed from: protected */
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/Transformer$ForMethod$TransformedMethod.class */
        public static class TransformedMethod extends MethodDescription.AbstractBase {
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/Transformer$ForMethod$TransformedMethod$TransformedParameterList.class */
            ...
            /* access modifiers changed from: protected */
            /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/Transformer$ForMethod$TransformedMethod$TransformedParameter.class */
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/Transformer$ForMethod$TransformedMethod$AttachmentVisitor.class */
            public class AttachmentVisitor extends TypeDescription.Generic.Visitor.Substitutor.WithoutTypeSubstitution {
                ...
                public TypeDescription.Generic onTypeVariable(TypeDescription.Generic typeVariable) {
                    ...
                    if (candidates.isEmpty()) {
                        attached = TransformedMethod.this.instrumentedType.findVariable(typeVariable.getSymbol());
                    } else {
                        attached = candidates.getOnly();
                    }
                    if (attached != null) {
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/Transformer$Compound.class */
