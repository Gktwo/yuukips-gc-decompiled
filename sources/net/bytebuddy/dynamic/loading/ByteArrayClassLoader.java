...
/* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader.class */
public class ByteArrayClassLoader extends InjectionClassLoader {
    ...
    public ByteArrayClassLoader(ClassLoader parent, Map<String, byte[]> typeDefinitions, ProtectionDomain protectionDomain, PersistenceHandler persistenceHandler, PackageDefinitionStrategy packageDefinitionStrategy, ClassFilePostProcessor classFilePostProcessor) {
        this(parent, true, typeDefinitions, protectionDomain, persistenceHandler, packageDefinitionStrategy, classFilePostProcessor);
    }

    public ByteArrayClassLoader(ClassLoader parent, boolean sealed, Map<String, byte[]> typeDefinitions, ProtectionDomain protectionDomain, PersistenceHandler persistenceHandler, PackageDefinitionStrategy packageDefinitionStrategy, ClassFilePostProcessor classFilePostProcessor) {
        super(parent, sealed);
    ...
    public static Map<TypeDescription, Class<?>> load(ClassLoader classLoader, Map<TypeDescription, byte[]> types, ProtectionDomain protectionDomain, PersistenceHandler persistenceHandler, PackageDefinitionStrategy packageDefinitionStrategy, boolean forbidExisting, boolean sealed) {
        ...
        ClassLoader classLoader2 = new ByteArrayClassLoader(classLoader, sealed, typesByName, protectionDomain, persistenceHandler, packageDefinitionStrategy, ClassFilePostProcessor.NoOp.INSTANCE);
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v20, resolved type: java.util.concurrent.ConcurrentMap<java.lang.String, byte[]> */
    /* JADX DEBUG: Multi-variable search result rejected for r0v43, resolved type: java.util.concurrent.ConcurrentMap<java.lang.String, byte[]> */
    ...
    protected Class<?> findClass(String name) throws ClassNotFoundException {
        ...
        if (binaryRepresentation != null) {
            return (Class) AccessController.doPrivileged(new ClassDefinitionAction(name, this.classFilePostProcessor.transform(this, name, this.protectionDomain, binaryRepresentation)), this.accessControlContext);
        }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$SynchronizationStrategy.class */
    protected interface SynchronizationStrategy {

        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$SynchronizationStrategy$Initializable.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$SynchronizationStrategy$CreationAction.class */
            ...
            public Initializable run() {
                try {
                    try {
                        ...
                        return (!ClassFileVersion.ofThisVm(ClassFileVersion.JAVA_V5).isAtLeast(ClassFileVersion.JAVA_V9) || ByteArrayClassLoader.class.getClassLoader() != null) ? new ForJava7CapableVm(ClassLoader.class.getDeclaredMethod("getClassLoadingLock", String.class)) : ForLegacyVm.INSTANCE;
                    }
                } catch (Exception e2) {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$SynchronizationStrategy$ForLegacyVm.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$SynchronizationStrategy$ForJava7CapableVm.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$SynchronizationStrategy$ForJava8CapableVm.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$ClassDefinitionAction.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$PackageLookupStrategy.class */
    public interface PackageLookupStrategy {
        Package apply(ByteArrayClassLoader byteArrayClassLoader, String str);

        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$PackageLookupStrategy$CreationAction.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$PackageLookupStrategy$ForLegacyVm.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$PackageLookupStrategy$ForJava9CapableVm.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$PersistenceHandler.class */
    public enum PersistenceHandler {
        MANIFEST(true) {
            ...
            protected URL url(String resourceName, ConcurrentMap<String, byte[]> typeDefinitions) {
                ...
                byte[] binaryRepresentation = typeDefinitions.get(resourceName.replace('/', '.').substring(0, resourceName.length() - ".class".length()));
                if (binaryRepresentation == null) {
                    return ByteArrayClassLoader.NO_URL;
                }
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$PersistenceHandler$UrlDefinitionAction.class */
        protected static class UrlDefinitionAction implements PrivilegedAction<URL> {
            ...
            /* access modifiers changed from: protected */
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$PersistenceHandler$UrlDefinitionAction$ByteArrayUrlStreamHandler.class */
            public static class ByteArrayUrlStreamHandler extends URLStreamHandler {
                ...
                /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$PersistenceHandler$UrlDefinitionAction$ByteArrayUrlStreamHandler$ByteArrayUrlConnection.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$ChildFirst.class */
    public static class ChildFirst extends ByteArrayClassLoader {
        ...
        public ChildFirst(ClassLoader parent, Map<String, byte[]> typeDefinitions, ProtectionDomain protectionDomain, PersistenceHandler persistenceHandler, PackageDefinitionStrategy packageDefinitionStrategy, ClassFilePostProcessor classFilePostProcessor) {
            super(parent, typeDefinitions, protectionDomain, persistenceHandler, packageDefinitionStrategy, classFilePostProcessor);
        }

        public ChildFirst(ClassLoader parent, boolean sealed, Map<String, byte[]> typeDefinitions, ProtectionDomain protectionDomain, PersistenceHandler persistenceHandler, PackageDefinitionStrategy packageDefinitionStrategy, ClassFilePostProcessor classFilePostProcessor) {
        ...
        public static Map<TypeDescription, Class<?>> load(ClassLoader classLoader, Map<TypeDescription, byte[]> types, ProtectionDomain protectionDomain, PersistenceHandler persistenceHandler, PackageDefinitionStrategy packageDefinitionStrategy, boolean forbidExisting, boolean sealed) {
            ...
            ClassLoader classLoader2 = new ChildFirst(classLoader, sealed, typesByName, protectionDomain, persistenceHandler, packageDefinitionStrategy, ClassFilePostProcessor.NoOp.INSTANCE);
            Map<TypeDescription, Class<?>> result = new LinkedHashMap<>();
            for (TypeDescription typeDescription : types.keySet()) {
                try {
                    Class<?> type = Class.forName(typeDescription.getName(), false, classLoader2);
        ...
        public URL getResource(String name) {
            URL url = this.persistenceHandler.url(name, this.typeDefinitions);
            return (url != null || isShadowed(name)) ? url : getResource(name);
        }
        ...
        public Enumeration<URL> getResources(String name) throws IOException {
            ...
            return new PrependingEnumeration(url, getResources(name));
        }
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$ChildFirst$PrependingEnumeration.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$EmptyEnumeration.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/ByteArrayClassLoader$SingletonEnumeration.class */
