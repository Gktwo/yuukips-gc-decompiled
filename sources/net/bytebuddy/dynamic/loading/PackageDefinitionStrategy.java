...
/* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/PackageDefinitionStrategy.class */
public interface PackageDefinitionStrategy {
    Definition define(ClassLoader classLoader, String str, String str2);

    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/PackageDefinitionStrategy$NoOp.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/PackageDefinitionStrategy$Trivial.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/PackageDefinitionStrategy$Definition.class */
    public interface Definition {
        ...
        boolean isCompatibleTo(Package v);

        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/PackageDefinitionStrategy$Definition$Undefined.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/PackageDefinitionStrategy$Definition$Trivial.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/PackageDefinitionStrategy$Definition$Simple.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/PackageDefinitionStrategy$ManifestReading.class */
    public static class ManifestReading implements PackageDefinitionStrategy {
        ...
        public Definition define(ClassLoader classLoader, String packageName, String typeName) {
            ...
            if (mainAttributes != null) {
                Attributes.Name[] nameArr = ATTRIBUTE_NAMES;
                for (Attributes.Name attributeName : nameArr) {
            ...
            if (attributes != null) {
                Attributes.Name[] nameArr2 = ATTRIBUTE_NAMES;
                for (Attributes.Name attributeName2 : nameArr2) {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/PackageDefinitionStrategy$ManifestReading$SealBaseLocator.class */
        public interface SealBaseLocator {
            URL findSealBase(ClassLoader classLoader, String str);

            /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/PackageDefinitionStrategy$ManifestReading$SealBaseLocator$NonSealing.class */
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/PackageDefinitionStrategy$ManifestReading$SealBaseLocator$ForFixedValue.class */
            public static class ForFixedValue implements SealBaseLocator {
                ...
                public boolean equals(Object other) {
                    ...
                    return this.sealBase.equals(((ForFixedValue) other).sealBase);
                }
            }

            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/loading/PackageDefinitionStrategy$ManifestReading$SealBaseLocator$ForTypeResourceUrl.class */
