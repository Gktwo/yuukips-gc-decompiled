...
/* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/inline/MethodRebaseResolver.class */
public interface MethodRebaseResolver {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/inline/MethodRebaseResolver$Disabled.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/inline/MethodRebaseResolver$Resolution.class */
    public interface Resolution {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/inline/MethodRebaseResolver$Resolution$Preserved.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/inline/MethodRebaseResolver$Resolution$ForRebasedMethod.class */
        public static class ForRebasedMethod implements Resolution {
            ...
            /* renamed from: of */
            public static Resolution m199of(TypeDescription instrumentedType, MethodDescription.InDefinedShape methodDescription, MethodNameTransformer methodNameTransformer) {
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/inline/MethodRebaseResolver$Resolution$ForRebasedMethod$RebasedMethod.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/inline/MethodRebaseResolver$Resolution$ForRebasedConstructor.class */
        public static class ForRebasedConstructor implements Resolution {
            ...
            /* renamed from: of */
            public static Resolution m200of(MethodDescription.InDefinedShape methodDescription, TypeDescription placeholderType) {
            ...
            /* access modifiers changed from: protected */
            /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/inline/MethodRebaseResolver$Resolution$ForRebasedConstructor$RebasedConstructor.class */
            public static class RebasedConstructor extends MethodDescription.InDefinedShape.AbstractBase {
                ...
                @Override // net.bytebuddy.description.method.MethodDescription, net.bytebuddy.description.method.MethodDescription.InDefinedShape
                public ParameterList<ParameterDescription.InDefinedShape> getParameters() {
                    return new ParameterList.Explicit.ForTypes(this, CompoundList.m81of(this.methodDescription.getParameters().asTypeList().asErasures(), this.placeholderType));
                }
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/inline/MethodRebaseResolver$Default.class */
            ...
            for (MethodDescription.InDefinedShape instrumentedMethod : instrumentedType.getDeclaredMethods()) {
                if (rebaseables.contains(instrumentedMethod.asSignatureToken())) {
                    if (instrumentedMethod.isConstructor()) {
                        ...
                        resolution = Resolution.ForRebasedConstructor.m200of(instrumentedMethod, placeholderType.getTypeDescription());
                    } else {
                        resolution = Resolution.ForRebasedMethod.m199of(instrumentedType, instrumentedMethod, methodNameTransformer);
                    }
