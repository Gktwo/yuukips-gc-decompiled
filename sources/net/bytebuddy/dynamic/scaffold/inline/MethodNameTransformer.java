...
/* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/inline/MethodNameTransformer.class */
public interface MethodNameTransformer {
    String transform(MethodDescription methodDescription);

    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/inline/MethodNameTransformer$Suffixing.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/inline/MethodNameTransformer$Prefixing.class */
