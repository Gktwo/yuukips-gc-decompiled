...
/* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldRegistry.class */
public interface FieldRegistry {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldRegistry$Compiled.class */
    public interface Compiled extends TypeWriter.FieldPool {

        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldRegistry$Compiled$NoOp.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldRegistry$Default.class */
    public static class Default implements FieldRegistry {
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldRegistry$Default$Entry.class */
        protected static class Entry implements LatentMatcher<FieldDescription> {
            ...
            /* JADX DEBUG: Type inference failed for r0v2. Raw type applied. Possible types: net.bytebuddy.matcher.ElementMatcher<? super ? super net.bytebuddy.description.field.FieldDescription>, net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.field.FieldDescription> */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldRegistry$Default$Compiled.class */
        protected static class Compiled implements Compiled {
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldRegistry$Default$Compiled$Entry.class */
