...
/* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/subclass/SubclassImplementationTarget.class */
public class SubclassImplementationTarget extends Implementation.Target.AbstractBase {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/subclass/SubclassImplementationTarget$OriginTypeResolver.class */
    ...
    @Override // net.bytebuddy.implementation.Implementation.Target.AbstractBase
    public int hashCode() {
        return (hashCode() * 31) + this.originTypeResolver.hashCode();
    }
    ...
    private Implementation.SpecialMethodInvocation invokeConstructor(MethodDescription.SignatureToken token) {
        ...
        return candidates.size() == 1 ? Implementation.SpecialMethodInvocation.Simple.m184of((MethodDescription) candidates.getOnly(), this.instrumentedType.getSuperClass().asErasure()) : Implementation.SpecialMethodInvocation.Illegal.INSTANCE;
    }
    ...
    private Implementation.SpecialMethodInvocation invokeMethod(MethodDescription.SignatureToken token) {
        ...
        return methodNode.getSort().isUnique() ? Implementation.SpecialMethodInvocation.Simple.m184of(methodNode.getRepresentative(), this.instrumentedType.getSuperClass().asErasure()) : Implementation.SpecialMethodInvocation.Illegal.INSTANCE;
    }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/subclass/SubclassImplementationTarget$Factory.class */
    public enum Factory implements Implementation.Target.Factory {
        ...
        public Implementation.Target make(TypeDescription instrumentedType, MethodGraph.Linked methodGraph, ClassFileVersion classFileVersion) {
            return new SubclassImplementationTarget(instrumentedType, methodGraph, Implementation.Target.AbstractBase.DefaultMethodInvocation.m183of(classFileVersion), this.originTypeResolver);
        }
    }
}
