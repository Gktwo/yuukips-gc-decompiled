...
/* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldLocator.class */
public interface FieldLocator {

    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldLocator$Factory.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldLocator$Resolution.class */
    public interface Resolution {
        boolean isResolved();

        FieldDescription getField();

        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldLocator$Resolution$Illegal.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldLocator$Resolution$Simple.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldLocator$NoOp.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldLocator$AbstractBase.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldLocator$ForExactType.class */
    public static class ForExactType extends AbstractBase {
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldLocator$ForExactType$Factory.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldLocator$ForClassHierarchy.class */
    public static class ForClassHierarchy extends AbstractBase {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldLocator$ForClassHierarchy$Factory.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldLocator$ForTopLevelType.class */
    public static class ForTopLevelType extends AbstractBase {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/FieldLocator$ForTopLevelType$Factory.class */
        public enum Factory implements Factory {
            INSTANCE;
