...
/* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/RecordComponentRegistry.class */
public interface RecordComponentRegistry {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/RecordComponentRegistry$Compiled.class */
    public interface Compiled extends TypeWriter.RecordComponentPool {

        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/RecordComponentRegistry$Compiled$NoOp.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/RecordComponentRegistry$Default.class */
    public static class Default implements RecordComponentRegistry {
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/RecordComponentRegistry$Default$Entry.class */
        protected static class Entry implements LatentMatcher<RecordComponentDescription> {
            ...
            /* JADX DEBUG: Type inference failed for r0v2. Raw type applied. Possible types: net.bytebuddy.matcher.ElementMatcher<? super ? super net.bytebuddy.description.type.RecordComponentDescription>, net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.type.RecordComponentDescription> */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/RecordComponentRegistry$Default$Compiled.class */
        protected static class Compiled implements Compiled {
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/RecordComponentRegistry$Default$Compiled$Entry.class */
