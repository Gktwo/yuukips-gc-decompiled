...
/* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/TypeInitializer.class */
public interface TypeInitializer extends ByteCodeAppender {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/TypeInitializer$Drain.class */
    public interface Drain {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/TypeInitializer$Drain$Default.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/TypeInitializer$None.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/dynamic/scaffold/TypeInitializer$Simple.class */
