...
/* loaded from: grasscutter.jar:net/bytebuddy/NamingStrategy.class */
public interface NamingStrategy {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/NamingStrategy$AbstractBase.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/NamingStrategy$SuffixingRandom.class */
    public static class SuffixingRandom extends AbstractBase {
        ...
        protected String name(TypeDescription superClass) {
            ...
            if (baseName.startsWith(JAVA_PACKAGE) && !this.javaLangPackagePrefix.equals("")) {
                baseName = this.javaLangPackagePrefix + Mapper.IGNORED_FIELDNAME + baseName;
            }
            return baseName + "$" + this.suffix + "$" + this.randomString.nextString();
        }

        /* loaded from: grasscutter.jar:net/bytebuddy/NamingStrategy$SuffixingRandom$BaseNameResolver.class */
        public interface BaseNameResolver {
            String resolve(TypeDescription typeDescription);

            /* loaded from: grasscutter.jar:net/bytebuddy/NamingStrategy$SuffixingRandom$BaseNameResolver$ForUnnamedType.class */
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/NamingStrategy$SuffixingRandom$BaseNameResolver$ForGivenType.class */
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/NamingStrategy$SuffixingRandom$BaseNameResolver$ForFixedValue.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/NamingStrategy$PrefixingRandom.class */
    public static class PrefixingRandom extends AbstractBase {
        ...
        @Override // net.bytebuddy.NamingStrategy.AbstractBase
        protected String name(TypeDescription superClass) {
            return this.prefix + Mapper.IGNORED_FIELDNAME + superClass.getName() + "$" + this.randomString.nextString();
        }
    }
}
