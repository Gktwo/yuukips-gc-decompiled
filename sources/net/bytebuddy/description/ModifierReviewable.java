...
/* loaded from: grasscutter.jar:net/bytebuddy/description/ModifierReviewable.class */
public interface ModifierReviewable {
    public static final int EMPTY_MASK = 0;

    /* loaded from: grasscutter.jar:net/bytebuddy/description/ModifierReviewable$ForFieldDescription.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/ModifierReviewable$ForMethodDescription.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/ModifierReviewable$ForParameterDescription.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/ModifierReviewable$ForTypeDefinition.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/ModifierReviewable$OfAbstraction.class */
    public interface OfAbstraction extends OfByteCodeElement {
        boolean isAbstract();
    }

    /* loaded from: grasscutter.jar:net/bytebuddy/description/ModifierReviewable$OfByteCodeElement.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/ModifierReviewable$OfEnumeration.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/ModifierReviewable$AbstractBase.class */
    public static abstract class AbstractBase implements ForTypeDefinition, ForFieldDescription, ForMethodDescription, ForParameterDescription {
        ...
        public TypeManifestation getTypeManifestation() {
            int modifiers = getModifiers();
            switch (modifiers & RetcodeOuterClass.Retcode.RET_HOME_FIND_ONLINE_HOME_FAIL_VALUE) {
                case 0:
