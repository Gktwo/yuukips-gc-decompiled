...
/* loaded from: grasscutter.jar:net/bytebuddy/description/enumeration/EnumerationDescription.class */
public interface EnumerationDescription extends NamedElement {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/enumeration/EnumerationDescription$AbstractBase.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/enumeration/EnumerationDescription$ForLoadedEnumeration.class */
    public static class ForLoadedEnumeration extends AbstractBase {
        ...
        public TypeDescription getEnumerationType() {
            return TypeDescription.ForLoadedType.m247of(this.value.getDeclaringClass());
        }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/enumeration/EnumerationDescription$Latent.class */
