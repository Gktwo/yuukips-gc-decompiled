...
/* loaded from: grasscutter.jar:net/bytebuddy/description/type/RecordComponentList.class */
public interface RecordComponentList<T extends RecordComponentDescription> extends FilterableList<T, RecordComponentList<T>> {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/type/RecordComponentList$AbstractBase.class */
    public static abstract class AbstractBase<S extends RecordComponentDescription> extends FilterableList.AbstractBase<S, RecordComponentList<S>> implements RecordComponentList<S> {
        ...
        public ByteCodeElement.Token.TokenList<RecordComponentDescription.Token> asTokenList(ElementMatcher<? super TypeDescription> matcher) {
            ...
            while (it.hasNext()) {
                tokens.add(((RecordComponentDescription) it.next()).asToken(matcher));
            }
        ...
        public TypeList.Generic asTypeList() {
            ...
            Iterator it = iterator();
            while (it.hasNext()) {
                typeDescriptions.add(((RecordComponentDescription) it.next()).getType());
            }
        ...
        public RecordComponentList<RecordComponentDescription.InDefinedShape> asDefined() {
            ...
            Iterator it = iterator();
            while (it.hasNext()) {
                recordComponents.add(((RecordComponentDescription) it.next()).asDefined());
            }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/type/RecordComponentList$ForLoadedRecordComponents.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/type/RecordComponentList$Explicit.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/type/RecordComponentList$ForTokens.class */
    public static class ForTokens extends AbstractBase<RecordComponentDescription.InDefinedShape> {
        ...
        @Override // java.util.AbstractList, java.util.List
        public RecordComponentDescription.InDefinedShape get(int index) {
            return new RecordComponentDescription.Latent(this.typeDescription, (RecordComponentDescription.Token) this.tokens.get(index));
        }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/type/RecordComponentList$TypeSubstituting.class */
    public static class TypeSubstituting extends AbstractBase<RecordComponentDescription.InGenericShape> {
        ...
        public RecordComponentDescription.InGenericShape get(int index) {
            return new RecordComponentDescription.TypeSubstituting(this.declaringType, (RecordComponentDescription) this.recordComponentDescriptions.get(index), this.visitor);
        }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/type/RecordComponentList$Empty.class */
