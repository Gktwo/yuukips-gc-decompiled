...
/* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList.class */
public interface TypeList extends FilterableList<TypeDescription, TypeList> {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$AbstractBase.class */
    public static abstract class AbstractBase extends FilterableList.AbstractBase<TypeDescription, TypeList> implements TypeList {
        ...
        public String[] toInternalNames() {
            ...
            while (it.hasNext()) {
                i++;
                internalNames[i] = ((TypeDescription) it.next()).getInternalName();
            }
            return internalNames.length == 0 ? NO_INTERFACES : internalNames;
        }
    }

    /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$ForLoadedTypes.class */
    public static class ForLoadedTypes extends AbstractBase {
        ...
        public TypeDescription get(int index) {
            return TypeDescription.ForLoadedType.m247of((Class) this.types.get(index));
        }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Explicit.class */
    public static class Explicit extends AbstractBase {
        ...
        /* renamed from: of */
        public static TypeList m235of(List<? extends JavaConstant> constants) {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Empty.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic.class */
    public interface Generic extends FilterableList<TypeDescription.Generic, Generic> {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic$AbstractBase.class */
        public static abstract class AbstractBase extends FilterableList.AbstractBase<TypeDescription.Generic, Generic> implements Generic {
            ...
            public ByteCodeElement.Token.TokenList<TypeVariableToken> asTokenList(ElementMatcher<? super TypeDescription> matcher) {
                ...
                Iterator it = iterator();
                while (it.hasNext()) {
                    tokens.add(TypeVariableToken.m233of((TypeDescription.Generic) it.next(), matcher));
                }
            ...
            public int getStackSize() {
                ...
                Iterator it = iterator();
                while (it.hasNext()) {
                    stackSize += ((TypeDescription.Generic) it.next()).getStackSize().getSize();
                }
                return stackSize;
            }
            ...
            public TypeList asErasures() {
                ...
                Iterator it = iterator();
                while (it.hasNext()) {
                    typeDescriptions.add(((TypeDescription.Generic) it.next()).asErasure());
                }
                return new Explicit(typeDescriptions);
            }
            ...
            public Generic asRawTypes() {
                ...
                Iterator it = iterator();
                while (it.hasNext()) {
                    typeDescriptions.add(((TypeDescription.Generic) it.next()).asRawType());
                }
                return new Explicit(typeDescriptions);
            }
        }

        /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic$Explicit.class */
        public static class Explicit extends AbstractBase {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic$ForLoadedTypes.class */
        public static class ForLoadedTypes extends AbstractBase {
            ...
            @Override // java.util.AbstractList, java.util.List
            public TypeDescription.Generic get(int index) {
                return TypeDefinition.Sort.describe((java.lang.reflect.Type) this.types.get(index));
            }
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic$ForLoadedTypes$OfTypeVariables.class */
            public static class OfTypeVariables extends AbstractBase {
                ...
                /* renamed from: of */
                public static Generic m234of(GenericDeclaration genericDeclaration) {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic$ForDetachedTypes.class */
        public static class ForDetachedTypes extends AbstractBase {
            ...
            public static Generic attachVariables(TypeDescription typeDescription, List<? extends TypeVariableToken> detachedTypeVariables) {
                return new OfTypeVariables(typeDescription, detachedTypeVariables, TypeDescription.Generic.Visitor.Substitutor.ForAttachment.m237of(typeDescription));
            }

            public static Generic attach(FieldDescription fieldDescription, List<? extends TypeDescription.Generic> detachedTypes) {
                return new ForDetachedTypes(detachedTypes, TypeDescription.Generic.Visitor.Substitutor.ForAttachment.m241of(fieldDescription));
            }

            public static Generic attach(MethodDescription methodDescription, List<? extends TypeDescription.Generic> detachedTypes) {
                return new ForDetachedTypes(detachedTypes, TypeDescription.Generic.Visitor.Substitutor.ForAttachment.m240of(methodDescription));
            }
            ...
            public static Generic attachVariables(MethodDescription methodDescription, List<? extends TypeVariableToken> detachedTypeVariables) {
                return new OfTypeVariables(methodDescription, detachedTypeVariables, TypeDescription.Generic.Visitor.Substitutor.ForAttachment.m240of(methodDescription));
            }
            ...
            public static Generic attach(ParameterDescription parameterDescription, List<? extends TypeDescription.Generic> detachedTypes) {
                return new ForDetachedTypes(detachedTypes, TypeDescription.Generic.Visitor.Substitutor.ForAttachment.m239of(parameterDescription));
            }
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic$ForDetachedTypes$WithResolvedErasure.class */
            public static class WithResolvedErasure extends AbstractBase {
                ...
                @Override // java.util.AbstractList, java.util.List
                public TypeDescription.Generic get(int index) {
                    return new TypeDescription.Generic.LazyProjection.WithResolvedErasure((TypeDescription.Generic) this.detachedTypes.get(index), this.visitor);
                }
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic$ForDetachedTypes$OfTypeVariables.class */
            public static class OfTypeVariables extends AbstractBase {
                ...
                /* access modifiers changed from: protected */
                /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic$ForDetachedTypes$OfTypeVariables$AttachedTypeVariable.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic$OfLoadedInterfaceTypes.class */
        public static class OfLoadedInterfaceTypes extends AbstractBase {
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic$OfLoadedInterfaceTypes$TypeProjection.class */
            public static class TypeProjection extends TypeDescription.Generic.LazyProjection.WithLazyNavigation.OfAnnotatedElement {
                ...
                public TypeDescription asErasure() {
                    return TypeDescription.ForLoadedType.m247of(this.erasure[this.index]);
                }
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic$OfConstructorExceptionTypes.class */
        public static class OfConstructorExceptionTypes extends AbstractBase {
            ...
            /* access modifiers changed from: private */
            /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic$OfConstructorExceptionTypes$TypeProjection.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic$OfMethodExceptionTypes.class */
        public static class OfMethodExceptionTypes extends AbstractBase {
            ...
            /* access modifiers changed from: private */
            /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic$OfMethodExceptionTypes$TypeProjection.class */
            public static class TypeProjection extends TypeDescription.Generic.LazyProjection.WithEagerNavigation.OfAnnotatedElement {
                private final Method method;
                private final int index;
                private final Class<?>[] erasure;
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/description/type/TypeList$Generic$Empty.class */
