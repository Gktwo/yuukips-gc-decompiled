...
/* loaded from: grasscutter.jar:net/bytebuddy/description/annotation/AnnotationList.class */
public interface AnnotationList extends FilterableList<AnnotationDescription, AnnotationList> {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/annotation/AnnotationList$AbstractBase.class */
    public static abstract class AbstractBase extends FilterableList.AbstractBase<AnnotationDescription, AnnotationList> implements AnnotationList {
        ...
        public boolean isAnnotationPresent(Class<? extends Annotation> annotationType) {
            ...
            while (it.hasNext()) {
                if (((AnnotationDescription) it.next()).getAnnotationType().represents(annotationType)) {
                    return true;
                }
            }
            return false;
        ...
        public boolean isAnnotationPresent(TypeDescription annotationType) {
            Iterator it = iterator();
            while (it.hasNext()) {
                if (((AnnotationDescription) it.next()).getAnnotationType().equals(annotationType)) {
                    return true;
                }
            }
            return false;
        ...
        public TypeList asTypeList() {
            ...
            Iterator it = iterator();
            while (it.hasNext()) {
                annotationTypes.add(((AnnotationDescription) it.next()).getAnnotationType());
            }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/annotation/AnnotationList$ForLoadedAnnotations.class */
    public static class ForLoadedAnnotations extends AbstractBase {
        ...
        public AnnotationDescription get(int index) {
            return AnnotationDescription.ForLoadedAnnotation.m286of((Annotation) this.annotations.get(index));
        }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/annotation/AnnotationList$Explicit.class */
    public static class Explicit extends AbstractBase {
        ...
        @Override // java.util.AbstractList, java.util.List
        public AnnotationDescription get(int index) {
            return (AnnotationDescription) this.annotationDescriptions.get(index);
        }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/annotation/AnnotationList$Empty.class */
