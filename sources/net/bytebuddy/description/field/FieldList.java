...
/* loaded from: grasscutter.jar:net/bytebuddy/description/field/FieldList.class */
public interface FieldList<T extends FieldDescription> extends FilterableList<T, FieldList<T>> {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/field/FieldList$AbstractBase.class */
    public static abstract class AbstractBase<S extends FieldDescription> extends FilterableList.AbstractBase<S, FieldList<S>> implements FieldList<S> {
        ...
        public ByteCodeElement.Token.TokenList<FieldDescription.Token> asTokenList(ElementMatcher<? super TypeDescription> matcher) {
            ...
            while (it.hasNext()) {
                tokens.add(((FieldDescription) it.next()).asToken(matcher));
            }
        ...
        public FieldList<FieldDescription.InDefinedShape> asDefined() {
            ...
            Iterator it = iterator();
            while (it.hasNext()) {
                declaredForms.add(((FieldDescription) it.next()).asDefined());
            }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/field/FieldList$ForLoadedFields.class */
    public static class ForLoadedFields extends AbstractBase<FieldDescription.InDefinedShape> {
        ...
        public FieldDescription.InDefinedShape get(int index) {
            return new FieldDescription.ForLoadedField((Field) this.fields.get(index));
        }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/field/FieldList$Explicit.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/field/FieldList$ForTokens.class */
    public static class ForTokens extends AbstractBase<FieldDescription.InDefinedShape> {
        ...
        @Override // java.util.AbstractList, java.util.List
        public FieldDescription.InDefinedShape get(int index) {
            return new FieldDescription.Latent(this.declaringType, (FieldDescription.Token) this.tokens.get(index));
        }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/field/FieldList$TypeSubstituting.class */
    public static class TypeSubstituting extends AbstractBase<FieldDescription.InGenericShape> {
        ...
        public FieldDescription.InGenericShape get(int index) {
            return new FieldDescription.TypeSubstituting(this.declaringType, (FieldDescription) this.fieldDescriptions.get(index), this.visitor);
        }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/description/field/FieldList$Empty.class */
