...
/* loaded from: grasscutter.jar:net/bytebuddy/agent/builder/LambdaFactory.class */
public class LambdaFactory {
    ...
    public static boolean register(ClassFileTransformer classFileTransformer, Object classFileFactory) {
        boolean isEmpty;
        try {
            TypeDescription typeDescription = TypeDescription.ForLoadedType.m247of(LambdaFactory.class);
