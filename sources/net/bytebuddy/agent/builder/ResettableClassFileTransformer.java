...
/* loaded from: grasscutter.jar:net/bytebuddy/agent/builder/ResettableClassFileTransformer.class */
public interface ResettableClassFileTransformer extends ClassFileTransformer {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/agent/builder/ResettableClassFileTransformer$AbstractBase.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/agent/builder/ResettableClassFileTransformer$WithDelegation.class */
