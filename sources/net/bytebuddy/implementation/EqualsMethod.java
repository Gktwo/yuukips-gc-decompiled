...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/EqualsMethod.class */
public class EqualsMethod implements Implementation {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/EqualsMethod$SuperClassCheck.class */
    ...
    /* access modifiers changed from: protected */
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/EqualsMethod$TypeCompatibilityCheck.class */
    public enum TypeCompatibilityCheck {
        ...
        SUBCLASS {
            @Override // net.bytebuddy.implementation.EqualsMethod.TypeCompatibilityCheck
            protected StackManipulation resolve(TypeDescription instrumentedType) {
                return new StackManipulation.Compound(MethodVariableAccess.REFERENCE.loadFrom(1), InstanceCheck.m117of(instrumentedType), ConditionalReturn.onZeroInteger());
            }
        };
        
        protected static final MethodDescription.InDefinedShape GET_CLASS = (MethodDescription.InDefinedShape) TypeDescription.ForLoadedType.m247of(Object.class).getDeclaredMethods().filter(ElementMatchers.named("getClass")).getOnly();
    ...
    public EqualsMethod withIgnoredFields(ElementMatcher<? super FieldDescription.InDefinedShape> ignored) {
        return new EqualsMethod(this.superClassCheck, this.typeCompatibilityCheck, this.ignored.mo105or(ignored), this.nonNullable, this.comparator);
    }

    public EqualsMethod withNonNullableFields(ElementMatcher<? super FieldDescription.InDefinedShape> nonNullable) {
        return new EqualsMethod(this.superClassCheck, this.typeCompatibilityCheck, this.ignored, this.nonNullable.mo105or(nonNullable), this.comparator);
    }
    ...
    public ByteCodeAppender appender(Implementation.Target implementationTarget) {
        ...
        List<FieldDescription.InDefinedShape> fields = new ArrayList<>(implementationTarget.getInstrumentedType().getDeclaredFields().filter(ElementMatchers.not(ElementMatchers.isStatic().mo105or(this.ignored))));
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/EqualsMethod$NullValueGuard.class */
    protected interface NullValueGuard {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/EqualsMethod$NullValueGuard$NoOp.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/EqualsMethod$NullValueGuard$UsingJump.class */
        public static class UsingJump implements NullValueGuard {
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/EqualsMethod$NullValueGuard$UsingJump$BeforeInstruction.class */
            ...
            @HashCodeAndEqualsPlugin.Enhance(includeSyntheticFields = true)
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/EqualsMethod$NullValueGuard$UsingJump$AfterInstruction.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/EqualsMethod$ValueComparator.class */
    protected enum ValueComparator implements StackManipulation {
        ...
        /* renamed from: of */
        public static StackManipulation m196of(TypeDefinition typeDefinition) {
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/EqualsMethod$Appender.class */
    protected static class Appender implements ByteCodeAppender {
        ...
        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext, MethodDescription instrumentedMethod) {
            if (instrumentedMethod.isStatic()) {
            ...
            } else if (instrumentedMethod.getParameters().size() != 1 || ((ParameterDescription) instrumentedMethod.getParameters().getOnly()).getType().isPrimitive()) {
                throw new IllegalStateException();
            } else if (!instrumentedMethod.getReturnType().represents(Boolean.TYPE)) {
                ...
                for (FieldDescription.InDefinedShape fieldDescription : this.fieldDescriptions) {
                    ...
                    stackManipulations.add(TypeCasting.m116to(this.instrumentedType));
                    stackManipulations.add(FieldAccess.forField(fieldDescription).read());
                    ...
                    stackManipulations.add(ValueComparator.m196of(fieldDescription.getType()));
    ...
    /* access modifiers changed from: protected */
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/EqualsMethod$ConditionalReturn.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/EqualsMethod$NaturalOrderComparator.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/EqualsMethod$TypePropertyComparator.class */
    protected enum TypePropertyComparator implements Comparator<FieldDescription.InDefinedShape> {
        FOR_PRIMITIVE_TYPES {
            ...
            public /* bridge */ /* synthetic */ int compare(FieldDescription.InDefinedShape inDefinedShape, FieldDescription.InDefinedShape inDefinedShape2) {
                return compare(inDefinedShape, inDefinedShape2);
            }
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/EqualsMethod$CompoundComparator.class */
