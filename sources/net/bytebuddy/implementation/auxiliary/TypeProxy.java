...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/TypeProxy.class */
public class TypeProxy implements AuxiliaryType {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/TypeProxy$InvocationFactory.class */
    public interface InvocationFactory {

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/TypeProxy$InvocationFactory$Default.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/TypeProxy$AbstractMethodErrorThrow.class */
    protected enum AbstractMethodErrorThrow implements StackManipulation {
        ...
        AbstractMethodErrorThrow() {
            TypeDescription abstractMethodError = TypeDescription.ForLoadedType.m247of(AbstractMethodError.class);
            this.implementation = new StackManipulation.Compound(TypeCreation.m119of(abstractMethodError), Duplication.SINGLE, MethodInvocation.invoke((MethodDescription) abstractMethodError.getDeclaredMethods().filter(ElementMatchers.isConstructor().and(ElementMatchers.takesArguments(0))).getOnly()), Throw.INSTANCE);
        }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/TypeProxy$SilentConstruction.class */
    protected enum SilentConstruction implements Implementation {
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/TypeProxy$SilentConstruction$Appender.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/TypeProxy$ForSuperMethodByConstructor.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/TypeProxy$ForDefaultMethod.class */
    public static class ForDefaultMethod implements StackManipulation {
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext) {
            ...
            return new StackManipulation.Compound(TypeCreation.m119of(proxyType), Duplication.SINGLE, MethodInvocation.invoke((MethodDescription.InDefinedShape) proxyType.getDeclaredMethods().filter(ElementMatchers.isConstructor()).getOnly()), Duplication.SINGLE, MethodVariableAccess.loadThis(), FieldAccess.forField((FieldDescription.InDefinedShape) proxyType.getDeclaredFields().filter(ElementMatchers.named(TypeProxy.INSTANCE_FIELD)).getOnly()).write()).apply(methodVisitor, implementationContext);
        }
    }

    /* access modifiers changed from: protected */
    @HashCodeAndEqualsPlugin.Enhance(includeSyntheticFields = true)
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/TypeProxy$MethodCall.class */
    public class MethodCall implements Implementation {
        ...
        @HashCodeAndEqualsPlugin.Enhance(includeSyntheticFields = true)
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/TypeProxy$MethodCall$Appender.class */
        protected class Appender implements ByteCodeAppender {
            ...
            public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext, MethodDescription instrumentedMethod) {
                ...
                return new ByteCodeAppender.Size((specialMethodInvocation.isValid() ? new AccessorMethodInvocation(instrumentedMethod, specialMethodInvocation) : AbstractMethodErrorThrow.INSTANCE).apply(methodVisitor, implementationContext).getMaximalSize(), instrumentedMethod.getStackSize());
            }

            @HashCodeAndEqualsPlugin.Enhance(includeSyntheticFields = true)
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/TypeProxy$MethodCall$Appender$AccessorMethodInvocation.class */
