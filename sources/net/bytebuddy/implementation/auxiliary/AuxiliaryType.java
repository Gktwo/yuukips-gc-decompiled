...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/AuxiliaryType.class */
public interface AuxiliaryType {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/AuxiliaryType$SignatureRelevant.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/AuxiliaryType$NamingStrategy.class */
    public interface NamingStrategy {
        String name(TypeDescription typeDescription);

        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/AuxiliaryType$NamingStrategy$SuffixingRandom.class */
