...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/auxiliary/PrivilegedMemberLookupAction.class */
public enum PrivilegedMemberLookupAction implements AuxiliaryType {
    FOR_PUBLIC_METHOD("getMethod", "name", String.class, NativeJob.PROP_PARAMETERS, Class[].class),
    FOR_DECLARED_METHOD("getDeclaredMethod", "name", String.class, NativeJob.PROP_PARAMETERS, Class[].class),
    FOR_PUBLIC_CONSTRUCTOR("getConstructor", NativeJob.PROP_PARAMETERS, Class[].class),
    FOR_DECLARED_CONSTRUCTOR(TypeProxy.SilentConstruction.Appender.GET_DECLARED_CONSTRUCTOR_METHOD_NAME, NativeJob.PROP_PARAMETERS, Class[].class);
    ...
    /* renamed from: of */
    public static AuxiliaryType m133of(MethodDescription methodDescription) {
