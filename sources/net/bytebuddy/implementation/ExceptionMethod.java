...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/ExceptionMethod.class */
public class ExceptionMethod implements Implementation, ByteCodeAppender {
    ...
    public static Implementation throwing(Class<? extends Throwable> throwableType) {
        return throwing(TypeDescription.ForLoadedType.m247of(throwableType));
    }
    ...
    public static Implementation throwing(Class<? extends Throwable> throwableType, String message) {
        return throwing(TypeDescription.ForLoadedType.m247of(throwableType), message);
    }
    ...
    public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext, MethodDescription instrumentedMethod) {
        return new ByteCodeAppender.Size(new StackManipulation.Compound(this.constructionDelegate.make(), Throw.INSTANCE).apply(methodVisitor, implementationContext).getMaximalSize(), instrumentedMethod.getStackSize());
    }

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/ExceptionMethod$ConstructionDelegate.class */
    public interface ConstructionDelegate {
        StackManipulation make();

        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/ExceptionMethod$ConstructionDelegate$ForDefaultConstructor.class */
        public static class ForDefaultConstructor implements ConstructionDelegate {
            ...
            public StackManipulation make() {
                return new StackManipulation.Compound(TypeCreation.m119of(this.throwableType), Duplication.SINGLE, MethodInvocation.invoke(this.targetConstructor));
            }
        }

        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/ExceptionMethod$ConstructionDelegate$ForStringConstructor.class */
        public static class ForStringConstructor implements ConstructionDelegate {
            ...
            @Override // net.bytebuddy.implementation.ExceptionMethod.ConstructionDelegate
            public StackManipulation make() {
                return new StackManipulation.Compound(TypeCreation.m119of(this.throwableType), Duplication.SINGLE, new TextConstant(this.message), MethodInvocation.invoke(this.targetConstructor));
            }
        }
    }
}
