...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/DefaultCall.class */
public @interface DefaultCall {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/DefaultCall$Binder.class */
    public enum Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<DefaultCall> {
        ...
        static {
            MethodList<MethodDescription.InDefinedShape> annotationProperties = TypeDescription.ForLoadedType.m247of(DefaultCall.class).getDeclaredMethods();
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/DefaultCall$Binder$DefaultMethodLocator.class */
        protected interface DefaultMethodLocator {
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/DefaultCall$Binder$DefaultMethodLocator$Implicit.class */
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/DefaultCall$Binder$DefaultMethodLocator$Explicit.class */
