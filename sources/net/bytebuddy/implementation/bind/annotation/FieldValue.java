...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldValue.class */
public @interface FieldValue {
    String value() default "";

    Class<?> declaringType() default void.class;

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldValue$Binder.class */
    public enum Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<FieldValue> {
        ...
        static {
            MethodList<MethodDescription.InDefinedShape> methodList = TypeDescription.ForLoadedType.m247of(FieldValue.class).getDeclaredMethods();
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldValue$Binder$Delegate.class */
