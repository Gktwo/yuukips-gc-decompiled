...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/BindingPriority.class */
public @interface BindingPriority {
    public static final int DEFAULT = 1;

    int value();

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/BindingPriority$Resolver.class */
