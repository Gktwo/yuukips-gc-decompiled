...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Morph.class */
public @interface Morph {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Morph$Binder.class */
    public static class Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Morph> {
        ...
        static {
            MethodList<MethodDescription.InDefinedShape> methodList = TypeDescription.ForLoadedType.m247of(Morph.class).getDeclaredMethods();
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Morph$Binder$DefaultMethodLocator.class */
        protected interface DefaultMethodLocator {
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Morph$Binder$DefaultMethodLocator$Implicit.class */
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Morph$Binder$DefaultMethodLocator$Explicit.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Morph$Binder$RedirectionProxy.class */
        protected static class RedirectionProxy implements AuxiliaryType, StackManipulation {
            ...
            public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext) {
                ...
                stackManipulationArr[0] = TypeCreation.m119of(forwardingType);
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Morph$Binder$RedirectionProxy$StaticFieldConstructor.class */
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Morph$Binder$RedirectionProxy$InstanceFieldConstructor.class */
            protected static class InstanceFieldConstructor implements Implementation {
                ...
                @HashCodeAndEqualsPlugin.Enhance
                /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Morph$Binder$RedirectionProxy$InstanceFieldConstructor$Appender.class */
                protected static class Appender implements ByteCodeAppender {
                    ...
                    public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext, MethodDescription instrumentedMethod) {
                        return new ByteCodeAppender.Size(new StackManipulation.Compound(MethodVariableAccess.loadThis(), MethodInvocation.invoke(StaticFieldConstructor.INSTANCE.objectTypeDefaultConstructor), MethodVariableAccess.allArgumentsOf(instrumentedMethod).prependThisReference(), FieldAccess.forField(this.fieldDescription).write(), MethodReturn.VOID).apply(methodVisitor, implementationContext).getMaximalSize(), instrumentedMethod.getStackSize());
                    }
                }
            }

            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Morph$Binder$RedirectionProxy$MethodCall.class */
            protected static class MethodCall implements Implementation {
                ...
                /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Morph$Binder$RedirectionProxy$MethodCall$Appender.class */
                protected class Appender implements ByteCodeAppender {
                    ...
                    public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext, MethodDescription instrumentedMethod) {
                        ...
                        while (it.hasNext()) {
                            parameterLoading[index] = new StackManipulation.Compound(arrayReference, IntegerConstant.forValue(index), ArrayAccess.REFERENCE.load(), MethodCall.this.assigner.assign(TypeDescription.Generic.OBJECT, (TypeDescription.Generic) it.next(), Assigner.Typing.DYNAMIC));
                            index++;
                        }
