...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Argument.class */
public @interface Argument {

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Argument$BindingMechanic.class */
    public enum BindingMechanic {
        UNIQUE {
            ...
            protected MethodDelegationBinder.ParameterBinding<?> makeBinding(TypeDescription.Generic source, TypeDescription.Generic target, int sourceParameterIndex, Assigner assigner, Assigner.Typing typing, int parameterOffset) {
                return MethodDelegationBinder.ParameterBinding.Unique.m132of(new StackManipulation.Compound(MethodVariableAccess.m107of(source).loadFrom(parameterOffset), assigner.assign(source, target, typing)), new ArgumentTypeResolver.ParameterIndexToken(sourceParameterIndex));
            }
        },
        ANONYMOUS {
            @Override // net.bytebuddy.implementation.bind.annotation.Argument.BindingMechanic
            protected MethodDelegationBinder.ParameterBinding<?> makeBinding(TypeDescription.Generic source, TypeDescription.Generic target, int sourceParameterIndex, Assigner assigner, Assigner.Typing typing, int parameterOffset) {
                return new MethodDelegationBinder.ParameterBinding.Anonymous(new StackManipulation.Compound(MethodVariableAccess.m107of(source).loadFrom(parameterOffset), assigner.assign(source, target, typing)));
            }
        };
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Argument$Binder.class */
