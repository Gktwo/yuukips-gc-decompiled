...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Super.class */
public @interface Super {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Super$Instantiation.class */
    public enum Instantiation {
        ...
        static {
            MethodList<MethodDescription.InDefinedShape> annotationProperties = TypeDescription.ForLoadedType.m247of(Super.class).getDeclaredMethods();
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Super$Binder.class */
    public enum Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Super> {
        ...
        public MethodDelegationBinder.ParameterBinding<?> bind(AnnotationDescription.Loadable<Super> annotation, MethodDescription source, ParameterDescription target, Implementation.Target implementationTarget, Assigner assigner, Assigner.Typing typing) {
            ...
            TypeDescription proxyType = TypeLocator.ForType.m130of((TypeDescription) annotation.getValue(PROXY_TYPE).resolve(TypeDescription.class)).resolve(implementationTarget.getInstrumentedType(), target.getType());
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Super$Binder$TypeLocator.class */
        protected interface TypeLocator {
            TypeDescription resolve(TypeDescription typeDescription, TypeDescription.Generic generic);

            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Super$Binder$TypeLocator$ForInstrumentedType.class */
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Super$Binder$TypeLocator$ForParameterType.class */
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Super$Binder$TypeLocator$ForType.class */
            public static class ForType implements TypeLocator {
                ...
                /* renamed from: of */
                protected static TypeLocator m130of(TypeDescription typeDescription) {
