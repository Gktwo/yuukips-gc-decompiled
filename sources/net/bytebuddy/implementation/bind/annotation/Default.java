...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Default.class */
public @interface Default {
    boolean serializableProxy() default false;

    Class<?> proxyType() default void.class;

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Default$Binder.class */
    public enum Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Default> {
        ...
        static {
            MethodList<MethodDescription.InDefinedShape> annotationProperties = TypeDescription.ForLoadedType.m247of(Default.class).getDeclaredMethods();
        ...
        public MethodDelegationBinder.ParameterBinding<?> bind(AnnotationDescription.Loadable<Default> annotation, MethodDescription source, ParameterDescription target, Implementation.Target implementationTarget, Assigner assigner, Assigner.Typing typing) {
            TypeDescription proxyType = TypeLocator.ForType.m131of((TypeDescription) annotation.getValue(PROXY_TYPE).resolve(TypeDescription.class)).resolve(target.getType());
            if (!proxyType.isInterface()) {
                throw new IllegalStateException(target + " uses the @Default annotation on an invalid type");
            } else if (source.isStatic() || !implementationTarget.getInstrumentedType().getInterfaces().asErasures().contains(proxyType)) {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Default$Binder$TypeLocator.class */
        protected interface TypeLocator {
            TypeDescription resolve(TypeDescription.Generic generic);

            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Default$Binder$TypeLocator$ForParameterType.class */
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Default$Binder$TypeLocator$ForType.class */
            public static class ForType implements TypeLocator {
                ...
                /* renamed from: of */
                protected static TypeLocator m131of(TypeDescription typeDescription) {
