...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/AllArguments.class */
public @interface AllArguments {
    Assignment value() default Assignment.STRICT;

    boolean includeSelf() default false;

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/AllArguments$Assignment.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/AllArguments$Binder.class */
    public enum Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<AllArguments> {
        ...
        public MethodDelegationBinder.ParameterBinding<?> bind(AnnotationDescription.Loadable<AllArguments> annotation, MethodDescription source, ParameterDescription target, Implementation.Target implementationTarget, Assigner assigner, Assigner.Typing typing) {
            ...
            if (includeThis) {
                list = CompoundList.m82of(implementationTarget.getInstrumentedType().asGenericType(), source.getParameters().asTypeList());
            } else {
                list = source.getParameters().asTypeList();
            }
            for (TypeDescription.Generic sourceParameter : list) {
                StackManipulation stackManipulation = new StackManipulation.Compound(MethodVariableAccess.m107of(sourceParameter).loadFrom(offset), assigner.assign(sourceParameter, componentType, typing));
