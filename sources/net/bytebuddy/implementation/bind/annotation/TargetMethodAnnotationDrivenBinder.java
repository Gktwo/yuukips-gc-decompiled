...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/TargetMethodAnnotationDrivenBinder.class */
public class TargetMethodAnnotationDrivenBinder implements MethodDelegationBinder {
    ...
    /* renamed from: of */
    public static MethodDelegationBinder m129of(List<? extends ParameterBinder<?>> parameterBinders) {
        return new TargetMethodAnnotationDrivenBinder(DelegationProcessor.m128of(parameterBinders));
    }
    ...
    public MethodDelegationBinder.Record compile(MethodDescription candidate) {
        ...
        while (it.hasNext()) {
            handlers.add(this.delegationProcessor.prepare((ParameterDescription) it.next()));
        }
        return new Record(candidate, handlers, RuntimeType.Verifier.check(candidate));
    }

    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/TargetMethodAnnotationDrivenBinder$Record.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/TargetMethodAnnotationDrivenBinder$ParameterBinder.class */
    public interface ParameterBinder<T extends Annotation> {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/TargetMethodAnnotationDrivenBinder$ParameterBinder$ForFixedValue.class */
        public static abstract class ForFixedValue<S extends Annotation> implements ParameterBinder<S> {
            ...
            public MethodDelegationBinder.ParameterBinding<?> bind(AnnotationDescription.Loadable<S> annotation, MethodDescription source, ParameterDescription target, Implementation.Target implementationTarget, Assigner assigner, Assigner.Typing typing) {
                ...
                if (value == null) {
                    return new MethodDelegationBinder.ParameterBinding.Anonymous(DefaultValue.m113of(target.getType()));
                }
                if (value instanceof Boolean) {
                    stackManipulation = IntegerConstant.forValue(((Boolean) value).booleanValue());
                    suppliedType = TypeDescription.ForLoadedType.m247of(Boolean.TYPE);
                } else if (value instanceof Byte) {
                    stackManipulation = IntegerConstant.forValue(((Byte) value).byteValue());
                    suppliedType = TypeDescription.ForLoadedType.m247of(Byte.TYPE);
                } else if (value instanceof Short) {
                    stackManipulation = IntegerConstant.forValue(((Short) value).shortValue());
                    suppliedType = TypeDescription.ForLoadedType.m247of(Short.TYPE);
                } else if (value instanceof Character) {
                    stackManipulation = IntegerConstant.forValue(((Character) value).charValue());
                    suppliedType = TypeDescription.ForLoadedType.m247of(Character.TYPE);
                } else if (value instanceof Integer) {
                    stackManipulation = IntegerConstant.forValue(((Integer) value).intValue());
                    suppliedType = TypeDescription.ForLoadedType.m247of(Integer.TYPE);
                } else if (value instanceof Long) {
                    stackManipulation = LongConstant.forValue(((Long) value).longValue());
                    suppliedType = TypeDescription.ForLoadedType.m247of(Long.TYPE);
                } else if (value instanceof Float) {
                    stackManipulation = FloatConstant.forValue(((Float) value).floatValue());
                    suppliedType = TypeDescription.ForLoadedType.m247of(Float.TYPE);
                } else if (value instanceof Double) {
                    stackManipulation = DoubleConstant.forValue(((Double) value).doubleValue());
                    suppliedType = TypeDescription.ForLoadedType.m247of(Double.TYPE);
                    ...
                    suppliedType = TypeDescription.ForLoadedType.m247of(((Enum) value).getDeclaringClass());
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/TargetMethodAnnotationDrivenBinder$ParameterBinder$ForFixedValue$OfConstant.class */
            public static class OfConstant<U extends Annotation> extends ForFixedValue<U> {
                ...
                /* renamed from: of */
                public static <V extends Annotation> ParameterBinder<V> m126of(Class<V> type, Object value) {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/TargetMethodAnnotationDrivenBinder$ParameterBinder$ForFieldBinding.class */
        public static abstract class ForFieldBinding<S extends Annotation> implements ParameterBinder<S> {
            ...
            public MethodDelegationBinder.ParameterBinding<?> bind(AnnotationDescription.Loadable<S> annotation, MethodDescription source, ParameterDescription target, Implementation.Target implementationTarget, Assigner assigner, Assigner.Typing typing) {
                ...
                if (declaringType(annotation).represents(Void.TYPE)) {
                    fieldLocator = new FieldLocator.ForClassHierarchy(implementationTarget.getInstrumentedType());
                } else {
                    fieldLocator = new FieldLocator.ForExactType(declaringType(annotation), implementationTarget.getInstrumentedType());
                }
                if (fieldName(annotation).equals("")) {
                    resolution = resolveAccessor(fieldLocator, source);
                } else {
                    resolution = fieldLocator.locate(fieldName(annotation));
                }
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/TargetMethodAnnotationDrivenBinder$DelegationProcessor.class */
    protected static class DelegationProcessor {
        ...
        /* renamed from: of */
        protected static DelegationProcessor m128of(List<? extends ParameterBinder<?>> parameterBinders) {
            Map<TypeDescription, ParameterBinder<?>> parameterBinderMap = new HashMap<>();
            for (ParameterBinder<?> parameterBinder : parameterBinders) {
                if (parameterBinderMap.put(TypeDescription.ForLoadedType.m247of(parameterBinder.getHandledType()), parameterBinder) != null) {
        ...
        protected Handler prepare(ParameterDescription target) {
            ...
            for (AnnotationDescription annotation : target.getDeclaredAnnotations()) {
                ParameterBinder<?> parameterBinder = (ParameterBinder) this.parameterBinders.get(annotation.getAnnotationType());
                if (parameterBinder != null && handler.isBound()) {
                    throw new IllegalStateException("Ambiguous binding for parameter annotated with two handled annotation types");
                } else if (parameterBinder != null) {
                    handler = Handler.Bound.m127of(target, parameterBinder, annotation, typing);
                }
            }
            return handler;
        }
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/TargetMethodAnnotationDrivenBinder$DelegationProcessor$Handler.class */
        public interface Handler {
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/TargetMethodAnnotationDrivenBinder$DelegationProcessor$Handler$Unbound.class */
            public static class Unbound implements Handler {
                ...
                public MethodDelegationBinder.ParameterBinding<?> bind(MethodDescription source, Implementation.Target implementationTarget, Assigner assigner) {
                    return Argument.Binder.INSTANCE.bind(AnnotationDescription.ForLoadedAnnotation.m286of(new DefaultArgument(this.target.getIndex())), source, this.target, implementationTarget, assigner, this.typing);
                }

                /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/TargetMethodAnnotationDrivenBinder$DelegationProcessor$Handler$Unbound$DefaultArgument.class */
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/TargetMethodAnnotationDrivenBinder$DelegationProcessor$Handler$Bound.class */
            public static class Bound<T extends Annotation> implements Handler {
                ...
                /* renamed from: of */
                protected static Handler m127of(ParameterDescription target, ParameterBinder<?> parameterBinder, AnnotationDescription annotation, Assigner.Typing typing) {
