...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Pipe.class */
public @interface Pipe {
    boolean serializableProxy() default false;

    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Pipe$Binder.class */
    public static class Binder implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Pipe> {
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Pipe$Binder$Redirection.class */
        protected static class Redirection implements AuxiliaryType, StackManipulation {
            ...
            protected enum ConstructorCall implements Implementation {
                ...
                @HashCodeAndEqualsPlugin.Enhance
                /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Pipe$Binder$Redirection$ConstructorCall$Appender.class */
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Pipe$Binder$Redirection$MethodCall.class */
            protected static class MethodCall implements Implementation {
                ...
                /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/Pipe$Binder$Redirection$MethodCall$Appender.class */
                private class Appender implements ByteCodeAppender {
                    ...
                    public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext, MethodDescription instrumentedMethod) {
                        ...
                        while (it.hasNext()) {
                            index++;
                            fieldLoading[index] = new StackManipulation.Compound(MethodVariableAccess.loadThis(), FieldAccess.forField((FieldDescription) it.next()).read());
                        }
                        return new ByteCodeAppender.Size(new StackManipulation.Compound(MethodVariableAccess.REFERENCE.loadFrom(1), MethodCall.this.assigner.assign(TypeDescription.Generic.OBJECT, MethodCall.this.redirectedMethod.getDeclaringType().asGenericType(), Assigner.Typing.DYNAMIC), new StackManipulation.Compound(fieldLoading), MethodInvocation.invoke(MethodCall.this.redirectedMethod), MethodCall.this.assigner.assign(MethodCall.this.redirectedMethod.getReturnType(), instrumentedMethod.getReturnType(), Assigner.Typing.DYNAMIC), MethodReturn.REFERENCE).apply(methodVisitor, implementationContext).getMaximalSize(), instrumentedMethod.getStackSize());
                    }
                }
            }
        }
