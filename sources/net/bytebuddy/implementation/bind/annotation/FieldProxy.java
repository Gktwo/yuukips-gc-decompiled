...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy.class */
public @interface FieldProxy {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder.class */
    public static class Binder extends TargetMethodAnnotationDrivenBinder.ParameterBinder.ForFieldBinding<FieldProxy> {
        ...
        static {
            MethodList<MethodDescription.InDefinedShape> methodList = TypeDescription.ForLoadedType.m247of(FieldProxy.class).getDeclaredMethods();
        ...
        public static TargetMethodAnnotationDrivenBinder.ParameterBinder<FieldProxy> install(Class<?> type) {
            return install(TypeDescription.ForLoadedType.m247of(type));
        }
        ...
        public static TargetMethodAnnotationDrivenBinder.ParameterBinder<FieldProxy> install(Class<?> getterType, Class<?> setterType) {
            return install(TypeDescription.ForLoadedType.m247of(getterType), TypeDescription.ForLoadedType.m247of(setterType));
        }
        ...
        public static TargetMethodAnnotationDrivenBinder.ParameterBinder<FieldProxy> install(TypeDescription getterType, TypeDescription setterType) {
            ...
            if (!getterMethod.getReturnType().asErasure().represents(Object.class)) {
                ...
                } else if (setterMethod.getParameters().size() == 1 && ((ParameterDescription.InDefinedShape) setterMethod.getParameters().get(0)).getType().asErasure().represents(Object.class)) {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$FieldResolver.class */
        protected interface FieldResolver {
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$FieldResolver$Factory.class */
            public interface Factory {
                FieldResolver resolve(TypeDescription typeDescription, FieldDescription fieldDescription);

                @HashCodeAndEqualsPlugin.Enhance
                /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$FieldResolver$Factory$Duplex.class */
                ...
                @HashCodeAndEqualsPlugin.Enhance
                /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$FieldResolver$Factory$Simplex.class */
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$FieldResolver$Unresolved.class */
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$FieldResolver$ForGetter.class */
            public static class ForGetter implements FieldResolver {
                ...
                @Override // net.bytebuddy.implementation.bind.annotation.FieldProxy.Binder.FieldResolver
                public DynamicType.Builder<?> apply(DynamicType.Builder<?> builder, FieldDescription fieldDescription, Assigner assigner, MethodAccessorFactory methodAccessorFactory) {
                    return builder.method(ElementMatchers.definedMethod(ElementMatchers.m97is(this.getterMethod))).intercept(new FieldGetter(fieldDescription, assigner, methodAccessorFactory));
                }
            }

            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$FieldResolver$ForSetter.class */
            public static class ForSetter implements FieldResolver {
                ...
                @Override // net.bytebuddy.implementation.bind.annotation.FieldProxy.Binder.FieldResolver
                public DynamicType.Builder<?> apply(DynamicType.Builder<?> builder, FieldDescription fieldDescription, Assigner assigner, MethodAccessorFactory methodAccessorFactory) {
                    return builder.method(ElementMatchers.m97is(this.setterMethod)).intercept(new FieldSetter(fieldDescription, assigner, methodAccessorFactory));
                }
            }

            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$FieldResolver$ForGetterSetterPair.class */
            public static class ForGetterSetterPair implements FieldResolver {
                ...
                @Override // net.bytebuddy.implementation.bind.annotation.FieldProxy.Binder.FieldResolver
                public DynamicType.Builder<?> apply(DynamicType.Builder<?> builder, FieldDescription fieldDescription, Assigner assigner, MethodAccessorFactory methodAccessorFactory) {
                    return builder.method(ElementMatchers.m97is(this.getterMethod)).intercept(new FieldGetter(fieldDescription, assigner, methodAccessorFactory)).method(ElementMatchers.m97is(this.setterMethod)).intercept(fieldDescription.isFinal() ? ExceptionMethod.throwing(UnsupportedOperationException.class, "Cannot set final field " + fieldDescription) : new FieldSetter(fieldDescription, assigner, methodAccessorFactory));
                }
            }
        }

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$StaticFieldConstructor.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$InstanceFieldConstructor.class */
        protected static class InstanceFieldConstructor implements Implementation {
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$InstanceFieldConstructor$Appender.class */
            protected static class Appender implements ByteCodeAppender {
                ...
                public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext, MethodDescription instrumentedMethod) {
                    return new ByteCodeAppender.Size(new StackManipulation.Compound(MethodVariableAccess.loadThis(), MethodInvocation.invoke(StaticFieldConstructor.INSTANCE.objectTypeDefaultConstructor), MethodVariableAccess.allArgumentsOf(instrumentedMethod.asDefined()).prependThisReference(), FieldAccess.forField(this.fieldDescription).write(), MethodReturn.VOID).apply(methodVisitor, implementationContext).getMaximalSize(), instrumentedMethod.getStackSize());
                }
            }
        }

        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$FieldGetter.class */
        protected static class FieldGetter implements Implementation {
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$FieldGetter$Appender.class */
            protected class Appender implements ByteCodeAppender {
                ...
                public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext, MethodDescription instrumentedMethod) {
                    ...
                    stackManipulationArr[3] = MethodReturn.m108of(instrumentedMethod.getReturnType().asErasure());
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$FieldSetter.class */
        protected static class FieldSetter implements Implementation {
            ...
            @HashCodeAndEqualsPlugin.Enhance(includeSyntheticFields = true)
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$FieldSetter$Appender.class */
            protected class Appender implements ByteCodeAppender {
                private final TypeDescription typeDescription;
                ...
                public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext, MethodDescription instrumentedMethod) {
                    ...
                    stackManipulationArr[1] = MethodVariableAccess.m107of(parameterType).loadFrom(1);
        ...
        @HashCodeAndEqualsPlugin.Enhance(includeSyntheticFields = true)
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/annotation/FieldProxy$Binder$AccessorProxy.class */
        protected class AccessorProxy implements AuxiliaryType, StackManipulation {
            ...
            public DynamicType make(String auxiliaryTypeName, ClassFileVersion classFileVersion, MethodAccessorFactory methodAccessorFactory) {
                ...
                return fieldResolver.apply(defineConstructor.withParameters((Collection<? extends TypeDefinition>) list).intercept(this.fieldDescription.isStatic() ? StaticFieldConstructor.INSTANCE : new InstanceFieldConstructor(this.instrumentedType)), this.fieldDescription, this.assigner, methodAccessorFactory).make();
            }
            ...
            public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext) {
                ...
                StackManipulation[] stackManipulationArr = new StackManipulation[4];
                stackManipulationArr[0] = TypeCreation.m119of(auxiliaryType);
