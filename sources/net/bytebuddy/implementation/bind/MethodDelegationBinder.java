...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder.class */
public interface MethodDelegationBinder {

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$TerminationHandler.class */
    public interface TerminationHandler {

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$TerminationHandler$Default.class */
        public enum Default implements TerminationHandler {
            RETURNING {
                ...
                public StackManipulation resolve(Assigner assigner, Assigner.Typing typing, MethodDescription source, MethodDescription target) {
                    ...
                    if (target.isConstructor()) {
                        generic = target.getDeclaringType().asGenericType();
                    } else {
                        generic = target.getReturnType();
                    }
                    stackManipulationArr[0] = assigner.assign(generic, source.getReturnType(), typing);
                    stackManipulationArr[1] = MethodReturn.m108of(source.getReturnType());
            ...
            DROPPING {
                ...
                public StackManipulation resolve(Assigner assigner, Assigner.Typing typing, MethodDescription source, MethodDescription target) {
                    ...
                    if (target.isConstructor()) {
                        typeDefinition = target.getDeclaringType();
                    } else {
                        typeDefinition = target.getReturnType();
                    }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$Record.class */
    public interface Record {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$Record$Illegal.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$MethodInvoker.class */
    public interface MethodInvoker {
        StackManipulation invoke(MethodDescription methodDescription);

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$MethodInvoker$Simple.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$MethodInvoker$Virtual.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$ParameterBinding.class */
    public interface ParameterBinding<T> extends StackManipulation {
        T getIdentificationToken();

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$ParameterBinding$Illegal.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$ParameterBinding$Anonymous.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$ParameterBinding$Unique.class */
        public static class Unique<T> implements ParameterBinding<T> {
            ...
            /* renamed from: of */
            public static <S> Unique<S> m132of(StackManipulation delegate, S identificationToken) {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$MethodBinding.class */
    public interface MethodBinding extends StackManipulation {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$MethodBinding$Illegal.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$MethodBinding$Builder.class */
        public static class Builder {
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$MethodBinding$Builder$Build.class */
            protected static class Build implements MethodBinding {
                ...
                @Override // net.bytebuddy.implementation.bytecode.StackManipulation
                public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext) {
                    return new StackManipulation.Compound(CompoundList.m80of((List) this.parameterStackManipulations, Arrays.asList(this.methodInvocation, this.terminatingStackManipulation))).apply(methodVisitor, implementationContext);
                }
            }
        }
    }

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$BindingResolver.class */
    public interface BindingResolver {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$BindingResolver$Default.class */
        public enum Default implements BindingResolver {
            ...
            private MethodBinding doResolve(AmbiguityResolver ambiguityResolver, MethodDescription source, List<MethodBinding> targets) {
                ...
                switch (targets.size()) {
                    ...
                    default:
                        switch (ambiguityResolver.resolve(source, targets.get(0), targets.get(1))) {
                            case LEFT:
                                targets.remove(1);
                            ...
                            case UNKNOWN:
                                targets.remove(1);
                                targets.remove(0);
                                switch (ambiguityResolver.resolve(source, left, subResult).merge(ambiguityResolver.resolve(source, right, doResolve(ambiguityResolver, source, targets)))) {
                                    case LEFT:
                                    case AMBIGUOUS:
                                    case UNKNOWN:
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$BindingResolver$Unique.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$BindingResolver$StreamWriting.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$AmbiguityResolver.class */
    public interface AmbiguityResolver {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$AmbiguityResolver$Resolution.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$AmbiguityResolver$NoOp.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$AmbiguityResolver$Directional.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$AmbiguityResolver$Compound.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bind/MethodDelegationBinder$Processor.class */
