...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor.class */
public abstract class FieldAccessor implements Implementation {
    protected final FieldLocation fieldLocation;
    protected final Assigner assigner;
    protected final Assigner.Typing typing;

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$AssignerConfigurable.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$OwnerTypeLocatable.class */
    public interface OwnerTypeLocatable extends AssignerConfigurable {
        /* renamed from: in */
        AssignerConfigurable mo192in(Class<?> cls);

        /* renamed from: in */
        AssignerConfigurable mo191in(TypeDescription typeDescription);

        /* renamed from: in */
        AssignerConfigurable mo190in(FieldLocator.Factory factory);
    }

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$PropertyConfigurable.class */
    ...
    public static OwnerTypeLocatable ofField(String name) {
        return m193of(new FieldNameExtractor.ForFixedValue(name));
    }

    public static OwnerTypeLocatable ofBeanProperty() {
        return m193of(FieldNameExtractor.ForBeanProperty.INSTANCE);
    }

    /* renamed from: of */
    public static OwnerTypeLocatable m193of(FieldNameExtractor fieldNameExtractor) {
        return new ForImplicitProperty(new FieldLocation.Relative(fieldNameExtractor));
    }

    /* renamed from: of */
    public static AssignerConfigurable m195of(Field field) {
        return m194of(new FieldDescription.ForLoadedField(field));
    }

    /* renamed from: of */
    public static AssignerConfigurable m194of(FieldDescription fieldDescription) {
        return new ForImplicitProperty(new FieldLocation.Absolute(fieldDescription));
    }

    /* access modifiers changed from: protected */
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$FieldLocation.class */
    public interface FieldLocation {

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$FieldLocation$Prepared.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$FieldLocation$Absolute.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$FieldLocation$Relative.class */
        public static class Relative implements FieldLocation {
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$FieldLocation$Relative$Prepared.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$FieldNameExtractor.class */
    public interface FieldNameExtractor {
        String resolve(MethodDescription methodDescription);

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$FieldNameExtractor$ForBeanProperty.class */
        public enum ForBeanProperty implements FieldNameExtractor {
            ...
            public String resolve(MethodDescription methodDescription) {
                ...
                if (name.startsWith(BeanUtil.PREFIX_GETTER_GET) || name.startsWith("set")) {
                    crop = 3;
                ...
                String name2 = name.substring(crop);
                if (name2.length() != 0) {
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$FieldNameExtractor$ForFixedValue.class */
    ...
    /* access modifiers changed from: protected */
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$ForImplicitProperty.class */
    public static class ForImplicitProperty extends FieldAccessor implements OwnerTypeLocatable {
        ...
        public Implementation.Composable setsValue(Object value) {
            ...
            if (type == Class.class) {
                return setsValue(ClassConstant.m114of(TypeDescription.ForLoadedType.m247of((Class) value)), Class.class);
            }
        ...
        public Implementation.Composable setsValue(TypeDescription typeDescription) {
            return setsValue(ClassConstant.m114of(typeDescription), Class.class);
        }
        ...
        public Implementation.Composable setsReference(Object value) {
            return setsReference(value, "fixedFieldValue$" + RandomString.hashOf(value.getClass().hashCode() ^ value.hashCode()));
        }
        ...
        /* renamed from: in */
        public AssignerConfigurable mo192in(Class<?> type) {
            return mo191in(TypeDescription.ForLoadedType.m247of(type));
        }

        @Override // net.bytebuddy.implementation.FieldAccessor.OwnerTypeLocatable
        /* renamed from: in */
        public AssignerConfigurable mo191in(TypeDescription typeDescription) {
            return mo190in(new FieldLocator.ForExactType.Factory(typeDescription));
        }

        @Override // net.bytebuddy.implementation.FieldAccessor.OwnerTypeLocatable
        /* renamed from: in */
        public AssignerConfigurable mo190in(FieldLocator.Factory fieldLocatorFactory) {
            return new ForImplicitProperty(this.fieldLocation.with(fieldLocatorFactory), this.assigner, this.typing);
        }

        @HashCodeAndEqualsPlugin.Enhance(includeSyntheticFields = true)
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$ForImplicitProperty$Appender.class */
            ...
            public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext, MethodDescription instrumentedMethod) {
                ...
                if (fieldDescription.isStatic() || !instrumentedMethod.isStatic()) {
                    ...
                    if (!instrumentedMethod.getReturnType().represents(Void.TYPE)) {
                        implementation = new StackManipulation.Compound(initialization, FieldAccess.forField(fieldDescription).read(), ForImplicitProperty.this.assigner.assign(fieldDescription.getType(), instrumentedMethod.getReturnType(), ForImplicitProperty.this.typing), MethodReturn.m108of(instrumentedMethod.getReturnType()));
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$ForSetter.class */
    protected static abstract class ForSetter<T> extends FieldAccessor implements Implementation.Composable {
        private final TerminationHandler terminationHandler;

        /* access modifiers changed from: protected */
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$ForSetter$TerminationHandler.class */
        ...
        @Override // net.bytebuddy.implementation.FieldAccessor
        public int hashCode() {
            return (hashCode() * 31) + this.terminationHandler.hashCode();
        }
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$ForSetter$OfParameterValue.class */
        ...
        /* access modifiers changed from: protected */
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$ForSetter$OfDefaultValue.class */
        public static class OfDefaultValue extends ForSetter<Void> {
            ...
            public StackManipulation resolve(Void initialized, FieldDescription fieldDescription, TypeDescription instrumentedType, MethodDescription instrumentedMethod) {
                return DefaultValue.m113of(fieldDescription.getType());
            }
        ...
        /* access modifiers changed from: protected */
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$ForSetter$OfConstantValue.class */
        public static class OfConstantValue extends ForSetter<Void> {
            ...
            @Override // net.bytebuddy.implementation.FieldAccessor.ForSetter, net.bytebuddy.implementation.FieldAccessor
            public int hashCode() {
                return (((hashCode() * 31) + this.typeDescription.hashCode()) * 31) + this.stackManipulation.hashCode();
            }
        ...
        /* access modifiers changed from: protected */
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$ForSetter$OfReferenceValue.class */
        public static class OfReferenceValue extends ForSetter<FieldDescription.InDefinedShape> {
            ...
            @Override // net.bytebuddy.implementation.FieldAccessor.ForSetter, net.bytebuddy.implementation.FieldAccessor
            public int hashCode() {
                return (((hashCode() * 31) + this.value.hashCode()) * 31) + this.name.hashCode();
            }
            ...
            @Override // net.bytebuddy.dynamic.scaffold.InstrumentedType.Prepareable
            public InstrumentedType prepare(InstrumentedType instrumentedType) {
                if (instrumentedType.getDeclaredFields().filter(ElementMatchers.named(this.name).and(ElementMatchers.fieldType(this.value.getClass()))).isEmpty()) {
                    return instrumentedType.withField(new FieldDescription.Token(this.name, 4105, TypeDescription.ForLoadedType.m247of(this.value.getClass()).asGenericType())).withInitializer(new LoadedTypeInitializer.ForStaticField(this.name, this.value));
                }
                throw new IllegalStateException("Field with name " + this.name + " and type " + this.value.getClass() + " already declared by " + instrumentedType);
            }
            ...
            public StackManipulation resolve(FieldDescription.InDefinedShape target, FieldDescription fieldDescription, TypeDescription instrumentedType, MethodDescription instrumentedMethod) {
                if (!fieldDescription.isFinal() || !instrumentedMethod.isMethod()) {
                    return new StackManipulation.Compound(FieldAccess.forField(target).read(), this.assigner.assign(TypeDescription.ForLoadedType.m247of(this.value.getClass()).asGenericType(), fieldDescription.getType(), this.typing));
                }
        ...
        /* access modifiers changed from: protected */
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$ForSetter$OfFieldValue.class */
        public static class OfFieldValue extends ForSetter<FieldLocation.Prepared> {
            ...
            @Override // net.bytebuddy.implementation.FieldAccessor.ForSetter, net.bytebuddy.implementation.FieldAccessor
            public int hashCode() {
                return (hashCode() * 31) + this.target.hashCode();
            }
        ...
        @HashCodeAndEqualsPlugin.Enhance(includeSyntheticFields = true)
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FieldAccessor$ForSetter$Appender.class */
        protected class Appender implements ByteCodeAppender {
