...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/collection/ArrayFactory.class */
public class ArrayFactory implements CollectionFactory {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/collection/ArrayFactory$ArrayCreator.class */
    public interface ArrayCreator extends StackManipulation {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/collection/ArrayFactory$ArrayCreator$ForPrimitiveType.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/collection/ArrayFactory$ArrayCreator$ForReferenceType.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/collection/ArrayFactory$ArrayStackManipulation.class */
    public class ArrayStackManipulation implements StackManipulation {
        ...
        @Override // net.bytebuddy.implementation.bytecode.StackManipulation
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext) {
            StackManipulation.Size size = IntegerConstant.forValue(this.stackManipulations.size()).apply(methodVisitor, implementationContext).aggregate(ArrayFactory.this.arrayCreator.apply(methodVisitor, implementationContext));
            int index = 0;
            for (StackManipulation stackManipulation : this.stackManipulations) {
                methodVisitor.visitInsn(89);
                index++;
                StackManipulation.Size size2 = size.aggregate(StackSize.SINGLE.toIncreasingSize()).aggregate(IntegerConstant.forValue(index).apply(methodVisitor, implementationContext)).aggregate(stackManipulation.apply(methodVisitor, implementationContext));
                methodVisitor.visitInsn(ArrayFactory.this.arrayCreator.getStorageOpcode());
                size = size2.aggregate(ArrayFactory.this.sizeDecrease);
            }
            return size;
        }
    }
