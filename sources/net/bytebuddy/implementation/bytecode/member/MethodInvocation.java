...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodInvocation.class */
public enum MethodInvocation {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodInvocation$WithImplicitInvocationTargetType.class */
    ...
    public static WithImplicitInvocationTargetType invoke(MethodDescription methodDescription) {
        ...
        return OfGenericMethod.m109of(methodDescription, invoke(declaredMethod));
    }

    /* access modifiers changed from: protected */
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodInvocation$IllegalInvocation.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodInvocation$OfGenericMethod.class */
    public static class OfGenericMethod implements WithImplicitInvocationTargetType {
        ...
        /* renamed from: of */
        protected static WithImplicitInvocationTargetType m109of(MethodDescription methodDescription, WithImplicitInvocationTargetType invocation) {
            return new OfGenericMethod(methodDescription.getReturnType().asErasure(), invocation);
        }

        @Override // net.bytebuddy.implementation.bytecode.member.MethodInvocation.WithImplicitInvocationTargetType
        public StackManipulation virtual(TypeDescription invocationTarget) {
            return new StackManipulation.Compound(this.invocation.virtual(invocationTarget), TypeCasting.m116to(this.targetType));
        }

        @Override // net.bytebuddy.implementation.bytecode.member.MethodInvocation.WithImplicitInvocationTargetType
        public StackManipulation special(TypeDescription invocationTarget) {
            return new StackManipulation.Compound(this.invocation.special(invocationTarget), TypeCasting.m116to(this.targetType));
        }
        ...
        @Override // net.bytebuddy.implementation.bytecode.member.MethodInvocation.WithImplicitInvocationTargetType
        public StackManipulation onHandle(HandleType type) {
            return new StackManipulation.Compound(this.invocation.onHandle(type), TypeCasting.m116to(this.targetType));
        }
        ...
        @Override // net.bytebuddy.implementation.bytecode.StackManipulation
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext) {
            return new StackManipulation.Compound(this.invocation, TypeCasting.m116to(this.targetType)).apply(methodVisitor, implementationContext);
        }
    }

    /* access modifiers changed from: protected */
    @HashCodeAndEqualsPlugin.Enhance(includeSyntheticFields = true)
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodInvocation$Invocation.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance(includeSyntheticFields = true)
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodInvocation$DynamicInvocation.class */
    protected class DynamicInvocation implements StackManipulation {
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext) {
            ...
            int index = 0;
            for (JavaConstant argument : this.arguments) {
                index++;
            ...
            int stackSize = this.returnType.getStackSize().getSize() - StackSize.m121of(this.parameterTypes);
            return new StackManipulation.Size(stackSize, Math.max(stackSize, 0));
        }
    }

    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodInvocation$HandleInvocation.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodInvocation$HandleType.class */
