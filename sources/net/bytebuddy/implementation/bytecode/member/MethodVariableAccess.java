...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodVariableAccess.class */
public enum MethodVariableAccess {
    ...
    private static transient /* synthetic */ StackManipulation loadThis;
    ...
    /* renamed from: of */
    public static MethodVariableAccess m107of(TypeDefinition typeDefinition) {
    ...
    public static StackManipulation load(ParameterDescription parameterDescription) {
        return m107of(parameterDescription.getType()).loadFrom(parameterDescription.getOffset());
    }

    public static StackManipulation store(ParameterDescription parameterDescription) {
        return m107of(parameterDescription.getType()).storeAt(parameterDescription.getOffset());
    }

    public static StackManipulation increment(ParameterDescription parameterDescription, int value) {
        return m107of(parameterDescription.getType()).increment(parameterDescription.getOffset(), value);
    }

    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodVariableAccess$MethodLoading.class */
    public static class MethodLoading implements StackManipulation {
        ...
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext) {
            ...
            while (it.hasNext()) {
                ...
                stackManipulations.add(MethodVariableAccess.m107of(parameterType).loadFrom(parameterDescription.getOffset()));
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodVariableAccess$MethodLoading$TypeCastingHandler.class */
        public interface TypeCastingHandler {
            StackManipulation ofIndex(TypeDescription typeDescription, int i);

            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodVariableAccess$MethodLoading$TypeCastingHandler$NoOp.class */
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodVariableAccess$MethodLoading$TypeCastingHandler$ForBridgeTarget.class */
            public static class ForBridgeTarget implements TypeCastingHandler {
                ...
                public StackManipulation ofIndex(TypeDescription parameterType, int index) {
                    ...
                    return parameterType.equals(targetType) ? StackManipulation.Trivial.INSTANCE : TypeCasting.m116to(targetType);
                }
            }
        }
    }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodVariableAccess$OffsetLoading.class */
    ...
    /* access modifiers changed from: protected */
    @HashCodeAndEqualsPlugin.Enhance(includeSyntheticFields = true)
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodVariableAccess$OffsetWriting.class */
    ...
    /* access modifiers changed from: protected */
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/MethodVariableAccess$OffsetIncrementing.class */
