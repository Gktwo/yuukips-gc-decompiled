...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/FieldAccess.class */
public enum FieldAccess {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/FieldAccess$Defined.class */
    ...
    public static Defined forField(FieldDescription fieldDescription) {
        ...
        return OfGenericField.m110of(fieldDescription, forField(declaredField));
    }

    /* access modifiers changed from: protected */
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/FieldAccess$OfGenericField.class */
    public static class OfGenericField implements Defined {
        ...
        /* renamed from: of */
        protected static Defined m110of(FieldDescription fieldDescription, Defined fieldAccess) {
        ...
        public StackManipulation read() {
            return new StackManipulation.Compound(this.defined.read(), TypeCasting.m116to(this.targetType));
        }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/FieldAccess$AccessDispatcher.class */
    public class AccessDispatcher implements Defined {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/FieldAccess$AccessDispatcher$AbstractFieldInstruction.class */
        ...
        /* access modifiers changed from: protected */
        @HashCodeAndEqualsPlugin.Enhance(includeSyntheticFields = true)
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/FieldAccess$AccessDispatcher$FieldGetInstruction.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance(includeSyntheticFields = true)
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/member/FieldAccess$AccessDispatcher$FieldPutInstruction.class */
