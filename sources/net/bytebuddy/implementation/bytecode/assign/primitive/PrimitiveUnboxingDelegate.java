...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/assign/primitive/PrimitiveUnboxingDelegate.class */
public enum PrimitiveUnboxingDelegate implements StackManipulation {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/assign/primitive/PrimitiveUnboxingDelegate$UnboxingResponsible.class */
    ...
    PrimitiveUnboxingDelegate(Class cls, Class cls2, StackSize sizeDifference, String unboxingMethodName, String unboxingMethodDescriptor) {
        ...
        this.primitiveType = TypeDescription.ForLoadedType.m247of(cls2);
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/assign/primitive/PrimitiveUnboxingDelegate$ExplicitlyTypedUnboxingResponsible.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/assign/primitive/PrimitiveUnboxingDelegate$ImplicitlyTypedUnboxingResponsible.class */
