...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/assign/primitive/PrimitiveBoxingDelegate.class */
public enum PrimitiveBoxingDelegate {
    BOOLEAN(Boolean.class, StackSize.ZERO, CoreConstants.VALUE_OF, "(Z)Ljava/lang/Boolean;"),
    BYTE(Byte.class, StackSize.ZERO, CoreConstants.VALUE_OF, "(B)Ljava/lang/Byte;"),
    SHORT(Short.class, StackSize.ZERO, CoreConstants.VALUE_OF, "(S)Ljava/lang/Short;"),
    CHARACTER(Character.class, StackSize.ZERO, CoreConstants.VALUE_OF, "(C)Ljava/lang/Character;"),
    INTEGER(Integer.class, StackSize.ZERO, CoreConstants.VALUE_OF, "(I)Ljava/lang/Integer;"),
    LONG(Long.class, StackSize.SINGLE, CoreConstants.VALUE_OF, "(J)Ljava/lang/Long;"),
    FLOAT(Float.class, StackSize.ZERO, CoreConstants.VALUE_OF, "(F)Ljava/lang/Float;"),
    DOUBLE(Double.class, StackSize.SINGLE, CoreConstants.VALUE_OF, "(D)Ljava/lang/Double;");
    ...
    PrimitiveBoxingDelegate(Class cls, StackSize sizeDifference, String boxingMethodName, String boxingMethodDescriptor) {
        this.wrapperType = TypeDescription.ForLoadedType.m247of(cls);
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/assign/primitive/PrimitiveBoxingDelegate$BoxingStackManipulation.class */
