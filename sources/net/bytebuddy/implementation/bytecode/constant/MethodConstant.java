...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/constant/MethodConstant.class */
public abstract class MethodConstant implements StackManipulation {
    protected final MethodDescription.InDefinedShape methodDescription;

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/constant/MethodConstant$CanCache.class */
    ...
    /* renamed from: of */
    public static CanCache m112of(MethodDescription.InDefinedShape methodDescription) {
    ...
    protected static List<StackManipulation> typeConstantsFor(List<TypeDescription> parameterTypes) {
        ...
        for (TypeDescription parameterType : parameterTypes) {
            typeConstants.add(ClassConstant.m114of(parameterType));
        }
    ...
    public boolean equals(Object other) {
        ...
        return this.methodDescription.equals(((MethodConstant) other).methodDescription);
    }

    /* access modifiers changed from: protected */
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/constant/MethodConstant$CanCacheIllegal.class */
    ...
    /* access modifiers changed from: protected */
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/constant/MethodConstant$ForMethod.class */
    ...
    /* access modifiers changed from: protected */
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/constant/MethodConstant$ForConstructor.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/constant/MethodConstant$PrivilegedLookup.class */
    protected static class PrivilegedLookup implements StackManipulation, CanCache {
        ...
        @Override // net.bytebuddy.implementation.bytecode.StackManipulation
        public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext) {
            TypeDescription auxiliaryType = implementationContext.register(PrivilegedMemberLookupAction.m133of(this.methodDescription));
            ...
            stackManipulationArr[2] = ClassConstant.m114of(this.methodDescription.getDeclaringType());
            ...
            stackManipulationArr[7] = TypeCasting.m116to(TypeDescription.ForLoadedType.m247of(this.methodDescription.isConstructor() ? Constructor.class : Method.class));
        ...
        public boolean equals(Object other) {
            ...
            return this.methodDescription.equals(((PrivilegedLookup) other).methodDescription);
        }
    }

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/constant/MethodConstant$CachedMethod.class */
    protected static class CachedMethod implements StackManipulation {
        private static final TypeDescription METHOD_TYPE = TypeDescription.ForLoadedType.m247of(Method.class);
        ...
        public boolean equals(Object other) {
            ...
            return this.methodConstant.equals(((CachedMethod) other).methodConstant);
        }
    }

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/constant/MethodConstant$CachedConstructor.class */
    protected static class CachedConstructor implements StackManipulation {
        private static final TypeDescription CONSTRUCTOR_TYPE = TypeDescription.ForLoadedType.m247of(Constructor.class);
        ...
        public boolean equals(Object other) {
            ...
            return this.constructorConstant.equals(((CachedConstructor) other).constructorConstant);
        }
    }
}
