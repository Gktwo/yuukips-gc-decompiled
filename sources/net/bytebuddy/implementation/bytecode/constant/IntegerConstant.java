...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/constant/IntegerConstant.class */
public enum IntegerConstant implements StackManipulation {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/constant/IntegerConstant$SingleBytePush.class */
    ...
    /* access modifiers changed from: protected */
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/constant/IntegerConstant$TwoBytePush.class */
    ...
    /* access modifiers changed from: protected */
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/bytecode/constant/IntegerConstant$ConstantPool.class */
