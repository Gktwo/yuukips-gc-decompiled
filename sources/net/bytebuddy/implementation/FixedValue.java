...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/FixedValue.class */
public abstract class FixedValue implements Implementation {
    protected final Assigner assigner;
    protected final Assigner.Typing typing;

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FixedValue$AssignerConfigurable.class */
    ...
    public static AssignerConfigurable value(Object fixedValue) {
        ...
        if (type == Class.class) {
            return new ForPoolValue(ClassConstant.m114of(TypeDescription.ForLoadedType.m247of((Class) fixedValue)), TypeDescription.CLASS);
        }
    ...
    public static AssignerConfigurable value(TypeDescription fixedValue) {
        return new ForPoolValue(ClassConstant.m114of(fixedValue), TypeDescription.CLASS);
    }
    ...
    protected ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext, MethodDescription instrumentedMethod, TypeDescription.Generic fixedValueType, StackManipulation valueLoadingInstruction) {
        ...
        if (assignment.isValid()) {
            return new ByteCodeAppender.Size(new StackManipulation.Compound(valueLoadingInstruction, assignment, MethodReturn.m108of(instrumentedMethod.getReturnType())).apply(methodVisitor, implementationContext).getMaximalSize(), instrumentedMethod.getStackSize());
        }
        throw new IllegalArgumentException("Cannot return value of type " + fixedValueType + " for " + instrumentedMethod);
    }

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FixedValue$ForNullValue.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FixedValue$ForOriginType.class */
    protected static class ForOriginType extends FixedValue implements AssignerConfigurable {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FixedValue$ForOriginType$Appender.class */
        protected class Appender implements ByteCodeAppender {
            ...
            @Override // net.bytebuddy.implementation.bytecode.ByteCodeAppender
            public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext, MethodDescription instrumentedMethod) {
                return ForOriginType.this.apply(methodVisitor, implementationContext, instrumentedMethod, TypeDescription.CLASS.asGenericType(), ClassConstant.m114of(this.originType));
            }
        }
    }

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FixedValue$ForThisValue.class */
    protected static class ForThisValue extends FixedValue implements AssignerConfigurable {
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FixedValue$ForThisValue$Appender.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FixedValue$ForArgument.class */
    public static class ForArgument extends FixedValue implements AssignerConfigurable, ByteCodeAppender {
        ...
        public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext, MethodDescription instrumentedMethod) {
            ...
            StackManipulation stackManipulation = new StackManipulation.Compound(MethodVariableAccess.load(parameterDescription), this.assigner.assign(parameterDescription.getType(), instrumentedMethod.getReturnType(), this.typing), MethodReturn.m108of(instrumentedMethod.getReturnType()));
    ...
    /* access modifiers changed from: protected */
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FixedValue$ForPoolValue.class */
    public static class ForPoolValue extends FixedValue implements AssignerConfigurable, ByteCodeAppender {
        ...
        @Override // net.bytebuddy.implementation.FixedValue
        public int hashCode() {
            return (((hashCode() * 31) + this.valueLoadInstruction.hashCode()) * 31) + this.loadedType.hashCode();
        }

        protected ForPoolValue(StackManipulation valueLoadInstruction, Class<?> loadedType) {
            this(valueLoadInstruction, TypeDescription.ForLoadedType.m247of(loadedType));
        }
    ...
    /* access modifiers changed from: protected */
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FixedValue$ForValue.class */
    public static class ForValue extends FixedValue implements AssignerConfigurable {
        ...
        @Override // net.bytebuddy.implementation.FixedValue
        public int hashCode() {
            return (((hashCode() * 31) + this.fieldName.hashCode()) * 31) + this.value.hashCode();
        }

        protected ForValue(Object value) {
            this("value$" + RandomString.hashOf(value.getClass().hashCode() ^ value.hashCode()), value);
        }
        ...
        private ForValue(Assigner assigner, Assigner.Typing typing, String fieldName, Object value) {
            ...
            this.value = value;
            this.fieldType = TypeDescription.Generic.OfNonGenericType.ForLoadedType.m244of(value.getClass());
        }
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/FixedValue$ForValue$StaticFieldByteCodeAppender.class */
