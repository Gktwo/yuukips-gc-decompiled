...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall.class */
public class MethodCall implements Implementation.Composable {
    ...
    public static Implementation.Composable call(Callable<?> callable) {
        try {
            return invoke(Callable.class.getMethod("call", new Class[0])).m174on((WithoutSpecifiedTarget) callable, (Class<? super WithoutSpecifiedTarget>) Callable.class).withAssigner(Assigner.DEFAULT, Assigner.Typing.DYNAMIC);
    ...
    public static Implementation.Composable run(Runnable runnable) {
        try {
            return invoke(Runnable.class.getMethod("run", new Class[0])).m174on((WithoutSpecifiedTarget) runnable, (Class<? super WithoutSpecifiedTarget>) Runnable.class).withAssigner(Assigner.DEFAULT, Assigner.Typing.DYNAMIC);
        } catch (NoSuchMethodException exception) {
    ...
    public MethodCall with(Object... argument) {
        ...
        for (Object anArgument : argument) {
            argumentLoaders.add(ArgumentLoader.ForStackManipulation.m176of(anArgument));
        }
    ...
    public MethodCall with(TypeDescription... typeDescription) {
        ...
        for (TypeDescription aTypeDescription : typeDescription) {
            argumentLoaders.add(new ArgumentLoader.ForStackManipulation(ClassConstant.m114of(aTypeDescription), Class.class));
        }
        return with(argumentLoaders);
    }
    ...
    public MethodCall with(List<? extends ArgumentLoader.Factory> argumentLoaders) {
        return new MethodCall(this.methodLocator, this.targetHandler, CompoundList.m80of((List) this.argumentLoaders, (List) argumentLoaders), this.methodInvoker, this.terminationHandler, this.assigner, this.typing);
    }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodLocator.class */
    public interface MethodLocator {

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodLocator$Factory.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodLocator$ForInstrumentedMethod.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodLocator$ForExplicitMethod.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodLocator$ForElementMatcher.class */
        public static class ForElementMatcher implements MethodLocator {
            ...
            /* JADX DEBUG: Type inference failed for r3v4. Raw type applied. Possible types: net.bytebuddy.matcher.ElementMatcher<? super net.bytebuddy.description.method.MethodDescription>, net.bytebuddy.matcher.ElementMatcher<? super T> */
            @Override // net.bytebuddy.implementation.MethodCall.MethodLocator
            public MethodDescription resolve(TypeDescription targetType, MethodDescription instrumentedMethod) {
                List<MethodDescription> candidates = CompoundList.m79of(this.instrumentedType.getSuperClass().getDeclaredMethods().filter(ElementMatchers.isConstructor().and(this.matcher)), this.instrumentedType.getDeclaredMethods().filter(ElementMatchers.not(ElementMatchers.isVirtual()).and(this.matcher)), this.methodGraphCompiler.compile(targetType, this.instrumentedType).listNodes().asMethodList().filter(this.matcher));
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodLocator$ForElementMatcher$Factory.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader.class */
    public interface ArgumentLoader {

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ArgumentProvider.class */
        public interface ArgumentProvider {
            List<ArgumentLoader> resolve(MethodDescription methodDescription, MethodDescription methodDescription2);
        }

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$Factory.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForNullConstant.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForThisReference.class */
        public static class ForThisReference implements ArgumentLoader, ArgumentProvider {
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForThisReference$Factory.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForInstrumentedType.class */
        public static class ForInstrumentedType implements ArgumentLoader, ArgumentProvider {
            ...
            @Override // net.bytebuddy.implementation.MethodCall.ArgumentLoader
            public StackManipulation toStackManipulation(ParameterDescription target, Assigner assigner, Assigner.Typing typing) {
                StackManipulation stackManipulation = new StackManipulation.Compound(ClassConstant.m114of(this.instrumentedType), assigner.assign(TypeDescription.Generic.OfNonGenericType.ForLoadedType.CLASS, target.getType(), typing));
                if (stackManipulation.isValid()) {
                    return stackManipulation;
                }
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForInstrumentedType$Factory.class */
            public enum Factory implements Factory {
                INSTANCE;
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForMethodParameter.class */
        public static class ForMethodParameter implements ArgumentLoader {
            ...
            public enum OfInstrumentedMethod implements Factory, ArgumentProvider {
                ...
                public List<ArgumentLoader> resolve(MethodDescription instrumentedMethod, MethodDescription invokedMethod) {
                    ...
                    while (it.hasNext()) {
                        argumentLoaders.add(new ForMethodParameter(((ParameterDescription) it.next()).getIndex(), instrumentedMethod));
                    }
            ...
            /* access modifiers changed from: protected */
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForMethodParameter$Factory.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForMethodParameterArray.class */
        public static class ForMethodParameterArray implements ArgumentLoader {
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForMethodParameterArray$ForInstrumentedMethod.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForMethodParameterArrayElement.class */
        public static class ForMethodParameterArrayElement implements ArgumentLoader {
            ...
            @Override // net.bytebuddy.implementation.MethodCall.ArgumentLoader
            public StackManipulation toStackManipulation(ParameterDescription target, Assigner assigner, Assigner.Typing typing) {
                StackManipulation stackManipulation = new StackManipulation.Compound(MethodVariableAccess.load(this.parameterDescription), IntegerConstant.forValue(this.index), ArrayAccess.m115of(this.parameterDescription.getType().getComponentType()).load(), assigner.assign(this.parameterDescription.getType().getComponentType(), target.getType(), typing));
                if (stackManipulation.isValid()) {
                    return stackManipulation;
                }
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForMethodParameterArrayElement$OfParameter.class */
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForMethodParameterArrayElement$OfInvokedMethod.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForInstance.class */
        public static class ForInstance implements ArgumentLoader, ArgumentProvider {
            ...
            /* access modifiers changed from: protected */
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForInstance$Factory.class */
            public static class Factory implements Factory {
                ...
                @Override // net.bytebuddy.dynamic.scaffold.InstrumentedType.Prepareable
                public InstrumentedType prepare(InstrumentedType instrumentedType) {
                    return instrumentedType.withField(new FieldDescription.Token(this.name, 4105, TypeDescription.Generic.OfNonGenericType.ForLoadedType.m244of(this.value.getClass()))).withInitializer(new LoadedTypeInitializer.ForStaticField(this.name, this.value));
                }
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForField.class */
        public static class ForField implements ArgumentLoader {
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForField$ArgumentProvider.class */
            ...
            /* access modifiers changed from: protected */
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForField$Factory.class */
            public static class Factory implements Factory {
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForMethodCall.class */
        public static class ForMethodCall implements ArgumentLoader {
            ...
            public StackManipulation toStackManipulation(ParameterDescription target, Assigner assigner, Assigner.Typing typing) {
                ...
                stackManipulationArr[1] = assigner.assign(generic, target.getType(), typing);
                StackManipulation stackManipulation = new StackManipulation.Compound(stackManipulationArr);
                if (stackManipulation.isValid()) {
                    return stackManipulation;
                }
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForMethodCall$ArgumentProvider.class */
            protected static class ArgumentProvider implements ArgumentProvider {
                private final Appender appender;
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForMethodCall$Factory.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$ArgumentLoader$ForStackManipulation.class */
        public static class ForStackManipulation implements ArgumentLoader, ArgumentProvider, Factory {
            ...
            /* renamed from: of */
            public static Factory m176of(Object value) {
                if (value == null) {
                ...
                if (value instanceof Class) {
                    return new ForStackManipulation(ClassConstant.m114of(TypeDescription.ForLoadedType.m247of((Class) value)), Class.class);
                }
                if (value instanceof TypeDescription) {
                    return new ForStackManipulation(ClassConstant.m114of((TypeDescription) value), Class.class);
                }
    ...
    /* access modifiers changed from: protected */
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler.class */
    public interface TargetHandler {

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$Factory.class */
        public interface Factory extends InstrumentedType.Prepareable {
            TargetHandler make(Implementation.Target target);
        }

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$Resolved.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$Simple.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForSelfOrStaticInvocation.class */
        public static class ForSelfOrStaticInvocation implements TargetHandler {
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForSelfOrStaticInvocation$Resolved.class */
            protected static class Resolved implements Resolved {
                ...
                public StackManipulation toStackManipulation(MethodDescription invokedMethod, Assigner assigner, Assigner.Typing typing) {
                    ...
                    } else if (!invokedMethod.isConstructor() || (this.instrumentedMethod.isConstructor() && (this.instrumentedType.equals(invokedMethod.getDeclaringType().asErasure()) || this.instrumentedType.getSuperClass().asErasure().equals(invokedMethod.getDeclaringType().asErasure())))) {
                        StackManipulation[] stackManipulationArr = new StackManipulation[2];
            ...
            /* access modifiers changed from: protected */
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForSelfOrStaticInvocation$Factory.class */
            public enum Factory implements Factory {
                INSTANCE;
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForConstructingInvocation.class */
        public static class ForConstructingInvocation implements TargetHandler, Resolved {
            ...
            @Override // net.bytebuddy.implementation.MethodCall.TargetHandler.Resolved
            public StackManipulation toStackManipulation(MethodDescription invokedMethod, Assigner assigner, Assigner.Typing typing) {
                return new StackManipulation.Compound(TypeCreation.m119of(invokedMethod.getDeclaringType().asErasure()), Duplication.SINGLE);
            }

            /* access modifiers changed from: package-private */
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForConstructingInvocation$Factory.class */
            public enum Factory implements Factory {
                INSTANCE;
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForValue.class */
        public static class ForValue implements TargetHandler, Resolved {
            ...
            /* access modifiers changed from: protected */
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForValue$Factory.class */
            public static class Factory implements Factory {
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForField.class */
        public static class ForField implements TargetHandler, Resolved {
            ...
            /* access modifiers changed from: protected */
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForField$Location.class */
            public interface Location {
                FieldDescription resolve(TypeDescription typeDescription);

                @HashCodeAndEqualsPlugin.Enhance
                /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForField$Location$ForImplicitField.class */
                ...
                @HashCodeAndEqualsPlugin.Enhance
                /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForField$Location$ForExplicitField.class */
            ...
            /* access modifiers changed from: protected */
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForField$Factory.class */
            public static class Factory implements Factory {
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForMethodParameter.class */
        public static class ForMethodParameter implements TargetHandler, Factory {
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForMethodParameter$Resolved.class */
            protected static class Resolved implements Resolved {
                private final ParameterDescription parameterDescription;
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForMethodCall.class */
        public static class ForMethodCall implements TargetHandler {
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForMethodCall$Resolved.class */
            protected static class Resolved implements Resolved {
                private final Appender appender;
                private final MethodDescription methodDescription;
                private final MethodDescription instrumentedMethod;
                ...
                public StackManipulation toStackManipulation(MethodDescription invokedMethod, Assigner assigner, Assigner.Typing typing) {
                    ...
                    StackManipulation stackManipulation = assigner.assign(generic, invokedMethod.getDeclaringType().asGenericType(), typing);
                    if (stackManipulation.isValid()) {
                    ...
                    StringBuilder append = new StringBuilder().append("Cannot invoke ").append(invokedMethod).append(" on ");
                    if (this.methodDescription.isConstructor()) {
                        typeDefinition = this.methodDescription.getDeclaringType();
                    } else {
                        typeDefinition = this.methodDescription.getReturnType();
                    }
                    throw new IllegalStateException(append.append(typeDefinition).toString());
                }
            }

            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TargetHandler$ForMethodCall$Factory.class */
            protected static class Factory implements Factory {
                private final MethodCall methodCall;
    ...
    /* access modifiers changed from: protected */
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodInvoker.class */
    public interface MethodInvoker {

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodInvoker$Factory.class */
        public interface Factory {
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodInvoker$ForContextualInvocation.class */
        public static class ForContextualInvocation implements MethodInvoker {
            ...
            public StackManipulation toStackManipulation(MethodDescription invokedMethod, Implementation.Target implementationTarget) {
                ...
                } else if (invokedMethod.isVirtual()) {
            ...
            /* access modifiers changed from: package-private */
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodInvoker$ForContextualInvocation$Factory.class */
            public enum Factory implements Factory {
                INSTANCE;
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodInvoker$ForVirtualInvocation.class */
        public static class ForVirtualInvocation implements MethodInvoker {
            ...
            /* access modifiers changed from: protected */
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodInvoker$ForVirtualInvocation$WithImplicitType.class */
            ...
            /* access modifiers changed from: protected */
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodInvoker$ForVirtualInvocation$Factory.class */
            public static class Factory implements Factory {
                private final TypeDescription typeDescription;
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodInvoker$ForSuperMethodInvocation.class */
        public static class ForSuperMethodInvocation implements MethodInvoker {
            ...
            /* access modifiers changed from: package-private */
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodInvoker$ForSuperMethodInvocation$Factory.class */
            public enum Factory implements Factory {
                INSTANCE;
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodInvoker$ForDefaultMethodInvocation.class */
        public static class ForDefaultMethodInvocation implements MethodInvoker {
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$MethodInvoker$ForDefaultMethodInvocation$Factory.class */
    ...
    /* access modifiers changed from: protected */
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TerminationHandler.class */
    public interface TerminationHandler {

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TerminationHandler$Factory.class */
        public interface Factory {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TerminationHandler$Simple.class */
        public enum Simple implements TerminationHandler, Factory {
            RETURNING {
                ...
                public StackManipulation toStackManipulation(MethodDescription invokedMethod, MethodDescription instrumentedMethod, Assigner assigner, Assigner.Typing typing) {
                    ...
                    if (invokedMethod.isConstructor()) {
                        generic = invokedMethod.getDeclaringType().asGenericType();
                    } else {
                        generic = invokedMethod.getReturnType();
                    }
                    StackManipulation stackManipulation = assigner.assign(generic, instrumentedMethod.getReturnType(), typing);
                    if (stackManipulation.isValid()) {
                        return new StackManipulation.Compound(stackManipulation, MethodReturn.m108of(instrumentedMethod.getReturnType()));
                    }
            ...
            DROPPING {
                ...
                public StackManipulation toStackManipulation(MethodDescription invokedMethod, MethodDescription instrumentedMethod, Assigner assigner, Assigner.Typing typing) {
                    TypeDefinition typeDefinition;
                    if (invokedMethod.isConstructor()) {
                        typeDefinition = invokedMethod.getDeclaringType();
                    } else {
                        typeDefinition = invokedMethod.getReturnType();
                    }
                    return Removal.m124of(typeDefinition);
                }
            },
            IGNORING {
                @Override // net.bytebuddy.implementation.MethodCall.TerminationHandler
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TerminationHandler$FieldSetting.class */
        public static class FieldSetting implements TerminationHandler {
            ...
            public StackManipulation toStackManipulation(MethodDescription invokedMethod, MethodDescription instrumentedMethod, Assigner assigner, Assigner.Typing typing) {
                ...
                StackManipulation stackManipulation = assigner.assign(generic, this.fieldDescription.getType(), typing);
                if (stackManipulation.isValid()) {
            ...
            /* access modifiers changed from: protected */
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TerminationHandler$FieldSetting$Explicit.class */
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$TerminationHandler$FieldSetting$Implicit.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$WithoutSpecifiedTarget.class */
    public static class WithoutSpecifiedTarget extends MethodCall {
        ...
        /* renamed from: on */
        public MethodCall m175on(Object target) {
            return m174on((WithoutSpecifiedTarget) target, (Class<? super WithoutSpecifiedTarget>) target.getClass());
        }

        /* renamed from: on */
        public <T> MethodCall m174on(T target, Class<? super T> type) {
            return new MethodCall(this.methodLocator, new TargetHandler.ForValue.Factory(target, TypeDescription.Generic.OfNonGenericType.ForLoadedType.m244of(type)), this.argumentLoaders, new MethodInvoker.ForVirtualInvocation.Factory(TypeDescription.ForLoadedType.m247of(type)), this.terminationHandler, this.assigner, this.typing);
        }

        /* renamed from: on */
        public MethodCall m173on(StackManipulation stackManipulation, Class<?> type) {
            return m172on(stackManipulation, TypeDescription.ForLoadedType.m247of(type));
        }

        /* renamed from: on */
        public MethodCall m172on(StackManipulation stackManipulation, TypeDescription typeDescription) {
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$FieldSetting.class */
    public static class FieldSetting implements Implementation.Composable {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$FieldSetting$Appender.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/MethodCall$Appender.class */
