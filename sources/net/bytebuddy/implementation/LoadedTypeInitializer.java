...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/LoadedTypeInitializer.class */
public interface LoadedTypeInitializer {
    void onLoad(Class<?> cls);

    boolean isAlive();

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/LoadedTypeInitializer$NoOp.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/LoadedTypeInitializer$ForStaticField.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/LoadedTypeInitializer$Compound.class */
