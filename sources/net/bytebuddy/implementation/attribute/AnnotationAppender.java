...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/attribute/AnnotationAppender.class */
public interface AnnotationAppender {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/attribute/AnnotationAppender$Target.class */
    public interface Target {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/attribute/AnnotationAppender$Target$OnType.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/attribute/AnnotationAppender$Target$OnField.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/attribute/AnnotationAppender$Target$OnMethod.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/attribute/AnnotationAppender$Target$OnMethodParameter.class */
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/attribute/AnnotationAppender$Target$OnRecordComponent.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/attribute/AnnotationAppender$Default.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/attribute/AnnotationAppender$ForTypeAnnotations.class */
    public static class ForTypeAnnotations implements TypeDescription.Generic.Visitor<AnnotationAppender> {
        ...
        public static AnnotationAppender ofTypeVariable(AnnotationAppender annotationAppender, AnnotationValueFilter annotationValueFilter, boolean variableOnType, int subListIndex, List<? extends TypeDescription.Generic> typeVariables) {
            ...
            for (TypeDescription.Generic typeVariable : typeVariables.subList(subListIndex, typeVariables.size())) {
                ...
                for (TypeDescription.Generic typeBound : typeVariable.getUpperBounds()) {
                    boundIndex++;
                    annotationAppender = (AnnotationAppender) typeBound.accept(new ForTypeAnnotations(annotationAppender, annotationValueFilter, TypeReference.newTypeParameterBoundReference(variableBoundBaseBase, typeVariableIndex, boundIndex)));
                }
                typeVariableIndex++;
            }
        ...
        public AnnotationAppender onWildcard(TypeDescription.Generic wildcard) {
            ...
            if (lowerBounds.isEmpty()) {
                generic = wildcard.getUpperBounds().getOnly();
            } else {
                generic = lowerBounds.getOnly();
            }
            return (AnnotationAppender) generic.accept(new ForTypeAnnotations(apply(wildcard, this.typePath), this.annotationValueFilter, this.typeReference, this.typePath + '*'));
        }
        ...
        public AnnotationAppender onParameterizedType(TypeDescription.Generic parameterizedType) {
            ...
            for (TypeDescription.Generic typeArgument : parameterizedType.getTypeArguments()) {
                index2++;
                annotationAppender = (AnnotationAppender) typeArgument.accept(new ForTypeAnnotations(annotationAppender, this.annotationValueFilter, this.typeReference, typePath.toString() + index2 + ';'));
            }
            return annotationAppender;
        }
