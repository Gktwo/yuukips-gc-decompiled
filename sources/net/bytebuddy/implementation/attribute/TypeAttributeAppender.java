...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/attribute/TypeAttributeAppender.class */
public interface TypeAttributeAppender {
    void apply(ClassVisitor classVisitor, TypeDescription typeDescription, AnnotationValueFilter annotationValueFilter);

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/attribute/TypeAttributeAppender$NoOp.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/attribute/TypeAttributeAppender$ForInstrumentedType.class */
    public enum ForInstrumentedType implements TypeAttributeAppender {
        ...
        public void apply(ClassVisitor classVisitor, TypeDescription instrumentedType, AnnotationValueFilter annotationValueFilter) {
            ...
            for (TypeDescription.Generic interfaceType : instrumentedType.getInterfaces()) {
                interfaceIndex++;
                annotationAppender = (AnnotationAppender) interfaceType.accept(AnnotationAppender.ForTypeAnnotations.ofInterfaceType(annotationAppender, annotationValueFilter, interfaceIndex));
            }
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/attribute/TypeAttributeAppender$ForInstrumentedType$Differentiating.class */
        public static class Differentiating implements TypeAttributeAppender {
            ...
            public void apply(ClassVisitor classVisitor, TypeDescription instrumentedType, AnnotationValueFilter annotationValueFilter) {
                ...
                for (TypeDescription.Generic interfaceType : interfaceTypes.subList(this.interfaceTypeIndex, interfaceTypes.size())) {
                    interfaceTypeIndex++;
                    annotationAppender = (AnnotationAppender) interfaceType.accept(AnnotationAppender.ForTypeAnnotations.ofInterfaceType(annotationAppender, annotationValueFilter, interfaceTypeIndex));
                }
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/attribute/TypeAttributeAppender$Explicit.class */
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/attribute/TypeAttributeAppender$Compound.class */
