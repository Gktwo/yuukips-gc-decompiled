...
/* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation.class */
public interface Implementation extends InstrumentedType.Prepareable {

    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Composable.class */
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$SpecialMethodInvocation.class */
    public interface SpecialMethodInvocation extends StackManipulation {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$SpecialMethodInvocation$Illegal.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$SpecialMethodInvocation$AbstractBase.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$SpecialMethodInvocation$Simple.class */
        public static class Simple extends AbstractBase {
            ...
            /* renamed from: of */
            public static SpecialMethodInvocation m184of(MethodDescription methodDescription, TypeDescription typeDescription) {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Target.class */
    public interface Target {

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Target$Factory.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Target$AbstractBase.class */
        public static abstract class AbstractBase implements Target {
            ...
            /* access modifiers changed from: protected */
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Target$AbstractBase$DefaultMethodInvocation.class */
            public enum DefaultMethodInvocation {
                ENABLED {
                    ...
                    protected SpecialMethodInvocation apply(MethodGraph.Node node, TypeDescription targetType) {
                        return node.getSort().isUnique() ? SpecialMethodInvocation.Simple.m184of(node.getRepresentative(), targetType) : SpecialMethodInvocation.Illegal.INSTANCE;
                    }
                },
                DISABLED {
                    @Override // net.bytebuddy.implementation.Implementation.Target.AbstractBase.DefaultMethodInvocation
                ...
                /* renamed from: of */
                public static DefaultMethodInvocation m183of(ClassFileVersion classFileVersion) {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context.class */
    public interface Context extends MethodAccessorFactory {

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$Factory.class */
        public interface Factory {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$ExtractableView.class */
        public interface ExtractableView extends Context {
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$ExtractableView$AbstractBase.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$Disabled.class */
        public static class Disabled extends ExtractableView.AbstractBase {
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$Disabled$Factory.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$Default.class */
        public static class Default extends ExtractableView.AbstractBase {
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$Default$CacheValueField.class */
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$Default$FieldCacheEntry.class */
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$Default$AbstractPropertyAccessorMethod.class */
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$Default$AccessorMethod.class */
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$Default$FieldGetter.class */
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$Default$FieldSetter.class */
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$Default$DelegationRecord.class */
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$Default$AccessorMethodDelegation.class */
            protected static class AccessorMethodDelegation extends DelegationRecord {
                ...
                @Override // net.bytebuddy.implementation.Implementation.Context.Default.DelegationRecord
                public int hashCode() {
                    return (hashCode() * 31) + this.accessorMethodInvocation.hashCode();
                }
                ...
                public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Context implementationContext, MethodDescription instrumentedMethod) {
                    return new ByteCodeAppender.Size(new StackManipulation.Compound(MethodVariableAccess.allArgumentsOf(instrumentedMethod).prependThisReference(), this.accessorMethodInvocation, MethodReturn.m108of(instrumentedMethod.getReturnType())).apply(methodVisitor, implementationContext).getMaximalSize(), instrumentedMethod.getStackSize());
                }
            }

            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$Default$FieldGetterDelegation.class */
            protected static class FieldGetterDelegation extends DelegationRecord {
                ...
                public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Context implementationContext, MethodDescription instrumentedMethod) {
                    ...
                    stackManipulationArr[2] = MethodReturn.m108of(this.fieldDescription.getType());
            ...
            @HashCodeAndEqualsPlugin.Enhance
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$Default$FieldSetterDelegation.class */
            protected static class FieldSetterDelegation extends DelegationRecord {
                ...
                @Override // net.bytebuddy.implementation.bytecode.ByteCodeAppender
                public ByteCodeAppender.Size apply(MethodVisitor methodVisitor, Context implementationContext, MethodDescription instrumentedMethod) {
                    return new ByteCodeAppender.Size(new StackManipulation.Compound(MethodVariableAccess.allArgumentsOf(instrumentedMethod).prependThisReference(), FieldAccess.forField(this.fieldDescription).write(), MethodReturn.VOID).apply(methodVisitor, implementationContext).getMaximalSize(), instrumentedMethod.getStackSize());
                }
            }

            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Context$Default$Factory.class */
            public enum Factory implements Factory {
                INSTANCE;
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Compound.class */
    public static class Compound implements Implementation {
        ...
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Compound$Composable.class */
        public static class Composable implements Composable {
            ...
            public Implementation andThen(Implementation implementation) {
                return new Compound(CompoundList.m81of(this.implementations, this.composable.andThen(implementation)));
            }
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Simple.class */
    public static class Simple implements Implementation {
        private static final int NO_ADDITIONAL_VARIABLES = 0;
        private final ByteCodeAppender byteCodeAppender;

        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Simple$Dispatcher.class */
        ...
        /* renamed from: of */
        public static Implementation m188of(Dispatcher dispatcher) {
            return m187of(dispatcher, 0);
        }

        /* renamed from: of */
        public static Implementation m187of(Dispatcher dispatcher, int additionalVariableLength) {
            return m185of(dispatcher, InstrumentedType.Prepareable.NoOp.INSTANCE, additionalVariableLength);
        }

        /* renamed from: of */
        public static Implementation m186of(Dispatcher dispatcher, InstrumentedType.Prepareable prepareable) {
            return m185of(dispatcher, prepareable, 0);
        }

        /* renamed from: of */
        public static Implementation m185of(Dispatcher dispatcher, InstrumentedType.Prepareable prepareable, int additionalVariableLength) {
        ...
        /* access modifiers changed from: protected */
        @HashCodeAndEqualsPlugin.Enhance
        /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Simple$ForDispatcher.class */
        public static class ForDispatcher implements Implementation {
            ...
            /* loaded from: grasscutter.jar:net/bytebuddy/implementation/Implementation$Simple$ForDispatcher$Appender.class */
