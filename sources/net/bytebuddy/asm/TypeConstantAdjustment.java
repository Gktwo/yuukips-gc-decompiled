...
/* loaded from: grasscutter.jar:net/bytebuddy/asm/TypeConstantAdjustment.class */
public enum TypeConstantAdjustment implements AsmVisitorWrapper {
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/asm/TypeConstantAdjustment$TypeConstantDissolvingClassVisitor.class */
    protected static class TypeConstantDissolvingClassVisitor extends ClassVisitor {
        ...
        public void visit(int version, int modifiers, String name, String signature, String superClassName, String[] interfaceName) {
            ...
            visit(version, modifiers, name, signature, superClassName, interfaceName);
        }

        @Override // net.bytebuddy.jar.asm.ClassVisitor
        public MethodVisitor visitMethod(int modifiers, String name, String descriptor, String signature, String[] exception) {
            MethodVisitor methodVisitor = visitMethod(modifiers, name, descriptor, signature, exception);
            return (this.supportsTypeConstants || methodVisitor == null) ? methodVisitor : new TypeConstantDissolvingMethodVisitor(methodVisitor);
        }

        /* loaded from: grasscutter.jar:net/bytebuddy/asm/TypeConstantAdjustment$TypeConstantDissolvingClassVisitor$TypeConstantDissolvingMethodVisitor.class */
            ...
            public void visitLdcInsn(Object value) {
                if (value instanceof Type) {
                    ...
                    switch (type.getSort()) {
                        case 9:
                        case 10:
                            visitLdcInsn(type.getInternalName().replace('/', '.'));
                            visitMethodInsn(184, "java/lang/Class", FOR_NAME, DESCRIPTOR, false);
                            return;
                    }
                }
                visitLdcInsn(value);
