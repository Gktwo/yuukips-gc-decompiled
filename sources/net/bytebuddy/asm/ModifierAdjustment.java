...
/* loaded from: grasscutter.jar:net/bytebuddy/asm/ModifierAdjustment.class */
public class ModifierAdjustment extends AsmVisitorWrapper.AbstractBase {
    ...
    public ModifierAdjustment withTypeModifiers(ElementMatcher<? super TypeDescription> matcher, List<? extends ModifierContributor.ForType> modifierContributors) {
        return new ModifierAdjustment(CompoundList.m82of(new Adjustment(matcher, ModifierContributor.Resolver.m255of(modifierContributors)), this.typeAdjustments), this.fieldAdjustments, this.methodAdjustments);
    }
    ...
    public ModifierAdjustment withFieldModifiers(ElementMatcher<? super FieldDescription.InDefinedShape> matcher, List<? extends ModifierContributor.ForField> modifierContributors) {
        return new ModifierAdjustment(this.typeAdjustments, CompoundList.m82of(new Adjustment(matcher, ModifierContributor.Resolver.m255of(modifierContributors)), this.fieldAdjustments), this.methodAdjustments);
    }
    ...
    public ModifierAdjustment withInvokableModifiers(ElementMatcher<? super MethodDescription> matcher, List<? extends ModifierContributor.ForMethod> modifierContributors) {
        return new ModifierAdjustment(this.typeAdjustments, this.fieldAdjustments, CompoundList.m82of(new Adjustment(matcher, ModifierContributor.Resolver.m255of(modifierContributors)), this.methodAdjustments));
    }
    ...
    @HashCodeAndEqualsPlugin.Enhance
    /* loaded from: grasscutter.jar:net/bytebuddy/asm/ModifierAdjustment$Adjustment.class */
    ...
    /* access modifiers changed from: protected */
    /* loaded from: grasscutter.jar:net/bytebuddy/asm/ModifierAdjustment$ModifierAdjustingClassVisitor.class */
    public static class ModifierAdjustingClassVisitor extends ClassVisitor {
        ...
        public void visit(int version, int modifiers, String internalName, String signature, String superClassName, String[] interfaceName) {
            ...
            visit(version, modifiers, internalName, signature, superClassName, interfaceName);
        }
        ...
        public FieldVisitor visitField(int modifiers, String internalName, String descriptor, String signature, Object value) {
            ...
            return visitField(modifiers, internalName, descriptor, signature, value);
        }
