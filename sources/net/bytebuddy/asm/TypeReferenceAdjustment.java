...
/* loaded from: grasscutter.jar:net/bytebuddy/asm/TypeReferenceAdjustment.class */
public class TypeReferenceAdjustment extends AsmVisitorWrapper.AbstractBase {
    ...
    public TypeReferenceAdjustment filter(ElementMatcher<? super TypeDescription> filter) {
        return new TypeReferenceAdjustment(this.strict, this.filter.mo105or(filter));
    }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/asm/TypeReferenceAdjustment$TypeReferenceClassVisitor.class */
    protected static class TypeReferenceClassVisitor extends ClassVisitor {
        ...
        public void visit(int version, int modifiers, String internalName, String genericSignature, String superClassInternalName, String[] interfaceInternalName) {
            ...
            visit(version, modifiers, internalName, genericSignature, superClassInternalName, interfaceInternalName);
        }
        ...
        public void visitOuterClass(String ownerTypeInternalName, String methodName, String methodDescriptor) {
            ...
            visitOuterClass(ownerTypeInternalName, methodName, methodDescriptor);
        }
        ...
        public void visitInnerClass(String internalName, String outerName, String innerName, int modifiers) {
            ...
            visitInnerClass(internalName, outerName, innerName, modifiers);
        }
        ...
        public AnnotationVisitor visitAnnotation(String descriptor, boolean visible) {
            this.observedTypes.add(Type.getType(descriptor).getInternalName());
            AnnotationVisitor annotationVisitor = visitAnnotation(descriptor, visible);
        ...
        public AnnotationVisitor visitTypeAnnotation(int typeReference, TypePath typePath, String descriptor, boolean visible) {
            this.observedTypes.add(Type.getType(descriptor).getInternalName());
            AnnotationVisitor annotationVisitor = visitTypeAnnotation(typeReference, typePath, descriptor, visible);
            if (annotationVisitor != null) {
                return new TypeReferenceAnnotationVisitor(annotationVisitor);
            }
            return IGNORE_ANNOTATION;
        ...
        public MethodVisitor visitMethod(int modifiers, String internalName, String descriptor, String signature, String[] exceptionInternalName) {
            MethodVisitor methodVisitor = visitMethod(modifiers, internalName, descriptor, signature, exceptionInternalName);
                    ...
                    if (resolution.isResolved()) {
                        ...
                        if (!this.filter.matches(typeDescription)) {
                            while (typeDescription != null && typeDescription.isNestedClass()) {
                                visitInnerClass(typeDescription.getInternalName(), typeDescription.isMemberType() ? typeDescription.getDeclaringType().getInternalName() : null, typeDescription.isAnonymousType() ? null : typeDescription.getSimpleName(), typeDescription.getModifiers());
                                do {
                                    try {
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/asm/TypeReferenceAdjustment$TypeReferenceClassVisitor$TypeReferenceAnnotationVisitor.class */
        protected class TypeReferenceAnnotationVisitor extends AnnotationVisitor {
            ...
            public void visitEnum(String name, String descriptor, String value) {
                ...
                visitEnum(name, descriptor, value);
            }

            @Override // net.bytebuddy.jar.asm.AnnotationVisitor
            public AnnotationVisitor visitAnnotation(String name, String descriptor) {
                TypeReferenceClassVisitor.this.observedTypes.add(Type.getType(descriptor).getInternalName());
                AnnotationVisitor annotationVisitor = visitAnnotation(name, descriptor);
                if (annotationVisitor != null) {
                    return new TypeReferenceAnnotationVisitor(annotationVisitor);
                }
            ...
            public AnnotationVisitor visitArray(String name) {
                AnnotationVisitor annotationVisitor = visitArray(name);
                if (annotationVisitor != null) {
                    return new TypeReferenceAnnotationVisitor(annotationVisitor);
                }
                return TypeReferenceClassVisitor.IGNORE_ANNOTATION;
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/asm/TypeReferenceAdjustment$TypeReferenceClassVisitor$TypeReferenceFieldVisitor.class */
        ...
        /* loaded from: grasscutter.jar:net/bytebuddy/asm/TypeReferenceAdjustment$TypeReferenceClassVisitor$TypeReferenceMethodVisitor.class */
        protected class TypeReferenceMethodVisitor extends MethodVisitor {
            ...
            public AnnotationVisitor visitParameterAnnotation(int index, String descriptor, boolean visible) {
                TypeReferenceClassVisitor.this.observedTypes.add(Type.getType(descriptor).getInternalName());
                AnnotationVisitor annotationVisitor = visitParameterAnnotation(index, descriptor, visible);
                if (annotationVisitor != null) {
                    return new TypeReferenceAnnotationVisitor(annotationVisitor);
                }
                return TypeReferenceClassVisitor.IGNORE_ANNOTATION;
            ...
            public AnnotationVisitor visitInsnAnnotation(int typeReference, TypePath typePath, String descriptor, boolean visible) {
                TypeReferenceClassVisitor.this.observedTypes.add(Type.getType(descriptor).getInternalName());
                AnnotationVisitor annotationVisitor = visitInsnAnnotation(typeReference, typePath, descriptor, visible);
                if (annotationVisitor != null) {
                    return new TypeReferenceAnnotationVisitor(annotationVisitor);
                }
                return TypeReferenceClassVisitor.IGNORE_ANNOTATION;
            ...
            public AnnotationVisitor visitTryCatchAnnotation(int typeReference, TypePath typePath, String descriptor, boolean visible) {
                TypeReferenceClassVisitor.this.observedTypes.add(Type.getType(descriptor).getInternalName());
                AnnotationVisitor annotationVisitor = visitTryCatchAnnotation(typeReference, typePath, descriptor, visible);
                if (annotationVisitor != null) {
                    return new TypeReferenceAnnotationVisitor(annotationVisitor);
                }
                return TypeReferenceClassVisitor.IGNORE_ANNOTATION;
            ...
            public AnnotationVisitor visitLocalVariableAnnotation(int typeReference, TypePath typePath, Label[] start, Label[] end, int[] index, String descriptor, boolean visible) {
                TypeReferenceClassVisitor.this.observedTypes.add(Type.getType(descriptor).getInternalName());
                AnnotationVisitor annotationVisitor = visitLocalVariableAnnotation(typeReference, typePath, start, end, index, descriptor, visible);
                if (annotationVisitor != null) {
                    return new TypeReferenceAnnotationVisitor(annotationVisitor);
                }
                return TypeReferenceClassVisitor.IGNORE_ANNOTATION;
            ...
            public void visitTypeInsn(int opcode, String internalName) {
                ...
                visitTypeInsn(opcode, internalName);
            }
            ...
            public void visitFieldInsn(int opcode, String ownerInternalName, String name, String descriptor) {
                ...
                visitFieldInsn(opcode, ownerInternalName, name, descriptor);
            }
            ...
            public void visitMethodInsn(int opcode, String ownerInternalName, String name, String descriptor, boolean isInterface) {
                TypeReferenceClassVisitor.this.resolveInternalName(ownerInternalName);
                TypeReferenceClassVisitor.this.resolve(Type.getType(descriptor));
                visitMethodInsn(opcode, ownerInternalName, name, descriptor, isInterface);
            }
            ...
            public void visitMultiANewArrayInsn(String descriptor, int dimension) {
                TypeReferenceClassVisitor.this.resolve(Type.getType(descriptor));
                visitMultiANewArrayInsn(descriptor, dimension);
            }
            ...
            public void visitTryCatchBlock(Label start, Label end, Label handler, String typeInternalName) {
                ...
                visitTryCatchBlock(start, end, handler, typeInternalName);
            }
        }
    }
}
