...
/* loaded from: grasscutter.jar:net/bytebuddy/asm/MemberRemoval.class */
public class MemberRemoval extends AsmVisitorWrapper.AbstractBase {
    ...
    public MemberRemoval stripFields(ElementMatcher<? super FieldDescription.InDefinedShape> matcher) {
        return new MemberRemoval(this.fieldMatcher.mo105or(matcher), this.methodMatcher);
    }
    ...
    public MemberRemoval stripInvokables(ElementMatcher<? super MethodDescription> matcher) {
        return new MemberRemoval(this.fieldMatcher, this.methodMatcher.mo105or(matcher));
    }
    ...
    /* loaded from: grasscutter.jar:net/bytebuddy/asm/MemberRemoval$MemberRemovingClassVisitor.class */
    protected static class MemberRemovingClassVisitor extends ClassVisitor {
        ...
        public FieldVisitor visitField(int modifiers, String internalName, String descriptor, String signature, Object value) {
            ...
            return (fieldDescription == null || !this.fieldMatcher.matches(fieldDescription)) ? visitField(modifiers, internalName, descriptor, signature, value) : REMOVE_FIELD;
        }

        @Override // net.bytebuddy.jar.asm.ClassVisitor
        public MethodVisitor visitMethod(int modifiers, String internalName, String descriptor, String signature, String[] exception) {
            MethodDescription methodDescription = this.methods.get(internalName + descriptor);
            return (methodDescription == null || !this.methodMatcher.matches(methodDescription)) ? visitMethod(modifiers, internalName, descriptor, signature, exception) : REMOVE_METHOD;
        }
    }
}
