...
/* loaded from: grasscutter.jar:dev/morphia/aggregation/experimental/expressions/impls/ArrayFilterExpression.class */
public class ArrayFilterExpression extends Expression {
    private final Expression array;
    private final Expression conditional;

    /* renamed from: as */
    private String f463as;
    ...
    /* renamed from: as */
    public ArrayFilterExpression m1257as(String as) {
        this.f463as = as;
        return this;
    }
    ...
    public void encode(Mapper mapper, BsonWriter writer, EncoderContext encoderContext) {
        ...
        /*  JADX ERROR: Method code generation error
            jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x000a: INVOKE  
              ...
              (r6v0 'this' dev.morphia.aggregation.experimental.expressions.impls.ArrayFilterExpression A[D('this' dev.morphia.aggregation.experimental.expressions.impls.ArrayFilterExpression), DONT_INLINE, IMMUTABLE_TYPE, THIS])
             ...
             call insn: ?: INVOKE  
              (r1 I:dev.morphia.aggregation.experimental.expressions.impls.ArrayFilterExpression)
              (r2 I:org.bson.BsonWriter)
              (r3 I:dev.morphia.mapping.Mapper)
              (r4 I:org.bson.codecs.EncoderContext)
             type: DIRECT call: dev.morphia.aggregation.experimental.expressions.impls.ArrayFilterExpression.lambda$encode$1(org.bson.BsonWriter, dev.morphia.mapping.Mapper, org.bson.codecs.EncoderContext):void)
             type: STATIC call: dev.morphia.aggregation.experimental.codecs.ExpressionHelper.document(org.bson.BsonWriter, java.lang.Runnable):void in method: dev.morphia.aggregation.experimental.expressions.impls.ArrayFilterExpression.encode(dev.morphia.mapping.Mapper, org.bson.BsonWriter, org.bson.codecs.EncoderContext):void, file: grasscutter.jar:dev/morphia/aggregation/experimental/expressions/impls/ArrayFilterExpression.class
        ...
        /*
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: dev.morphia.aggregation.experimental.expressions.impls.ArrayFilterExpression.encode(dev.morphia.mapping.Mapper, org.bson.BsonWriter, org.bson.codecs.EncoderContext):void");
    }
}
