...
/* loaded from: grasscutter.jar:dev/morphia/mapping/codec/pojo/PropertyModelBuilder.class */
public final class PropertyModelBuilder {
    ...
    /*  JADX ERROR: Dependency scan failed at insn: 0x003D: INVOKE_CUSTOM r-7
        java.lang.IndexOutOfBoundsException: Index 4 out of bounds for length 4
        	...
        	at jadx.core.dex.nodes.RootNode.runPreDecompileStage(RootNode.java:267)
        */
    /*  JADX ERROR: Failed to decode insn: 0x000B: INVOKE_CUSTOM r3, method: dev.morphia.mapping.codec.pojo.PropertyModelBuilder.toString():java.lang.String
        ...
        Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Failed to process invoke-custom instruction: CallSite{[{ENCODED_METHOD_HANDLE: INVOKE_STATIC: Ljava/lang/invoke/StringConcatFactory;->makeConcatWithConstants(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/invoke/CallSite;}, makeConcatWithConstants, {ENCODED_METHOD_TYPE: (Ljava/lang/String;)Ljava/lang/String;}, []}
        	...
        	... 11 more
        */
    /*  JADX ERROR: Failed to decode insn: 0x0019: INVOKE_CUSTOM r1, method: dev.morphia.mapping.codec.pojo.PropertyModelBuilder.toString():java.lang.String
        ...
        Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Failed to process invoke-custom instruction: CallSite{[{ENCODED_METHOD_HANDLE: INVOKE_STATIC: Ljava/lang/invoke/StringConcatFactory;->makeConcatWithConstants(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/invoke/CallSite;}, makeConcatWithConstants, {ENCODED_METHOD_TYPE: (Ljava/lang/String;)Ljava/lang/String;}, name='']}
        	...
        	... 11 more
        */
    /*  JADX ERROR: Failed to decode insn: 0x0025: INVOKE_CUSTOM r1, method: dev.morphia.mapping.codec.pojo.PropertyModelBuilder.toString():java.lang.String
        ...
        Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Failed to process invoke-custom instruction: CallSite{[{ENCODED_METHOD_HANDLE: INVOKE_STATIC: Ljava/lang/invoke/StringConcatFactory;->makeConcatWithConstants(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/invoke/CallSite;}, makeConcatWithConstants, {ENCODED_METHOD_TYPE: (Ljava/lang/String;)Ljava/lang/String;}, mappedName='']}
        	...
        	... 11 more
        */
    /*  JADX ERROR: Failed to decode insn: 0x0031: INVOKE_CUSTOM r1, method: dev.morphia.mapping.codec.pojo.PropertyModelBuilder.toString():java.lang.String
        ...
        Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Failed to process invoke-custom instruction: CallSite{[{ENCODED_METHOD_HANDLE: INVOKE_STATIC: Ljava/lang/invoke/StringConcatFactory;->makeConcatWithConstants(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/invoke/CallSite;}, makeConcatWithConstants, {ENCODED_METHOD_TYPE: (Ldev/morphia/mapping/codec/pojo/TypeData;)Ljava/lang/String;}, typeData=]}
        	...
        	... 11 more
        */
    /*  JADX ERROR: Failed to decode insn: 0x003D: INVOKE_CUSTOM r1, method: dev.morphia.mapping.codec.pojo.PropertyModelBuilder.toString():java.lang.String
        jadx.core.utils.exceptions.JadxRuntimeException: 'invoke-custom' instruction processing error: Failed to process invoke-custom instruction: CallSite{[{ENCODED_METHOD_HANDLE: INVOKE_STATIC: Ljava/lang/invoke/StringConcatFactory;->makeConcatWithConstants(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/MethodType;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/invoke/CallSite;}, makeConcatWithConstants, {ENCODED_METHOD_TYPE: (Ljava/util/List;)Ljava/lang/String;}, annotations=]}
        	at jadx.core.dex.instructions.InvokeCustomBuilder.build(InvokeCustomBuilder.java:55)
        	at jadx.core.dex.instructions.InsnDecoder.invoke(InsnDecoder.java:568)
        	at jadx.core.dex.instructions.InsnDecoder.decode(InsnDecoder.java:438)
        	at jadx.core.dex.instructions.InsnDecoder.lambda$process$0(InsnDecoder.java:48)
    ...
    public java.lang.String toString() {
        /*
            ...
            r1 = r0
            java.lang.String r2 = ", "
            java.lang.Class<dev.morphia.mapping.codec.pojo.PropertyModelBuilder> r3 = dev.morphia.mapping.codec.pojo.PropertyModelBuilder.class
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: dev.morphia.mapping.codec.pojo.PropertyModelBuilder.toString():java.lang.String");
    }

    /* access modifiers changed from: package-private */
    public PropertyModelBuilder(Datastore datastore) {
    ...
    public PropertyModelBuilder discoverMappedName(MapperOptions options) {
        ...
        if (hasAnnotation(AbstractC1283Id.class)) {
    ...
    public PropertyModelBuilder annotations(List<Annotation> annotations) {
        this.annotations = Collections.unmodifiableList((List) Assertions.notNull("annotations", annotations));
        return this;
    }
    ...
    public PropertyModelBuilder serialization(MorphiaPropertySerialization propertySerialization) {
        this.serialization = (MorphiaPropertySerialization) Assertions.notNull("propertySerialization", propertySerialization);
        return this;
    }
