...
/* renamed from: io.netty.util.internal.ObjectCleaner */
/* loaded from: grasscutter.jar:io/netty/util/internal/ObjectCleaner.class */
public final class ObjectCleaner {
        ...
        public void run() {
            ...
            while (true) {
                if (!ObjectCleaner.LIVE_SET.isEmpty()) {
                    try {
                        AutomaticCleanerReference reference = (AutomaticCleanerReference) ObjectCleaner.REFERENCE_QUEUE.remove((long) ObjectCleaner.REFERENCE_QUEUE_POLL_TIMEOUT_MS);
                        if (reference != null) {
                            try {
                                reference.cleanup();
                            } catch (Throwable th) {
    ...
    /* renamed from: io.netty.util.internal.ObjectCleaner$AutomaticCleanerReference */
    /* loaded from: grasscutter.jar:io/netty/util/internal/ObjectCleaner$AutomaticCleanerReference.class */
