...
/* renamed from: io.netty.handler.ssl.util.LazyX509Certificate */
/* loaded from: grasscutter.jar:io/netty/handler/ssl/util/LazyX509Certificate.class */
public final class LazyX509Certificate extends X509Certificate {
    ...
    private X509Certificate unwrap() {
        ...
        if (wrapped == null) {
            try {
                X509Certificate x509Certificate = (X509Certificate) X509_CERT_FACTORY.generateCertificate(new ByteArrayInputStream(this.bytes));
