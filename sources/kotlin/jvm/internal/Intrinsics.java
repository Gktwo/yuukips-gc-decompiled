...
/* loaded from: grasscutter.jar:kotlin/jvm/internal/Intrinsics.class */
public class Intrinsics {
    ...
    public static void checkReturnedValueIsNotNull(Object value, String className, String methodName) {
        if (value == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Method specified as non-null returned null: " + className + Mapper.IGNORED_FIELDNAME + methodName)));
        }
    }
    ...
    public static void checkFieldIsNotNull(Object value, String className, String fieldName) {
        if (value == null) {
            throw ((IllegalStateException) sanitizeStackTrace(new IllegalStateException("Field specified as non-null is null: " + className + Mapper.IGNORED_FIELDNAME + fieldName)));
        }
    }
    ...
    private static String createParameterIsNullExceptionMessage(String paramName) {
        ...
        return "Parameter specified as non-null is null: method " + className + Mapper.IGNORED_FIELDNAME + caller.getMethodName() + ", parameter " + paramName;
    }
    ...
    @SinceKotlin(version = "1.4")
    /* loaded from: grasscutter.jar:kotlin/jvm/internal/Intrinsics$Kotlin.class */
