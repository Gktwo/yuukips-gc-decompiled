...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    /* compiled from: ClassReference.kt */
    @Metadata(m371mv = {1, 6, 0}, m372k = 1, m369xi = 48, m374d1 = {"��6\n\u0002\u0018\u0002\n\u0002\u0010��\n\u0002\b\u0002\n\u0002\u0010$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n��\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\u000b\n\u0002\b\u0002\b\u0003\u0018��2\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0014\u0010\u000f\u001a\u0004\u0018\u00010\n2\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u0005J\u0014\u0010\u0011\u001a\u0004\u0018\u00010\n2\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u0005J\u001c\u0010\u0012\u001a\u00020\u00132\b\u0010\u0014\u001a\u0004\u0018\u00010\u00012\n\u0010\u0010\u001a\u0006\u0012\u0002\b\u00030\u0005R&\u0010\u0003\u001a\u001a\u0012\u0010\u0012\u000e\u0012\n\b\u0001\u0012\u0006\u0012\u0002\b\u00030\u00060\u0005\u0012\u0004\u0012\u00020\u00070\u0004X\u0004¢\u0006\u0002\n��R*\u0010\b\u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\tj\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n`\u000bX\u0004¢\u0006\u0002\n��R*\u0010\f\u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\tj\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n`\u000bX\u0004¢\u0006\u0002\n��R*\u0010\r\u001a\u001e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\tj\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n`\u000bX\u0004¢\u0006\u0002\n��R\u001a\u0010\u000e\u001a\u000e\u0012\u0004\u0012\u00020\n\u0012\u0004\u0012\u00020\n0\u0004X\u0004¢\u0006\u0002\n��¨\u0006\u0015"}, m373d2 = {"Lkotlin/jvm/internal/ClassReference$Companion;", "", "()V", "FUNCTION_CLASSES", "", "Ljava/lang/Class;", "Lkotlin/Function;", "", "classFqNames", "Ljava/util/HashMap;", "", "Lkotlin/collections/HashMap;", "primitiveFqNames", "primitiveWrapperFqNames", "simpleNames", "getClassQualifiedName", "jClass", "getClassSimpleName", "isInstance", "", "value", "kotlin-stdlib"})
    /* loaded from: grasscutter.jar:kotlin/jvm/internal/ClassReference$Companion.class */
    public static final class Companion {
        ...
        public final String getClassSimpleName(@NotNull Class<?> cls) {
            ...
            if (cls.isLocalClass()) {
                ...
                if (componentType.isPrimitive()) {
                    String str2 = (String) ClassReference.simpleNames.get(componentType.getName());
                    str = str2 != null ? str2 + "Array" : null;
                } else {
                    str = null;
                }
                if (str == null) {
        ...
        public final boolean isInstance(@Nullable Object value, @NotNull Class<?> cls) {
            Intrinsics.checkNotNullParameter(cls, "jClass");
            Integer num = (Integer) ClassReference.FUNCTION_CLASSES.get(cls);
            if (num != null) {
                return TypeIntrinsics.isFunctionOfArity(value, num.intValue());
            }
            return (cls.isPrimitive() ? JvmClassMapping.getJavaObjectType(JvmClassMapping.getKotlinClass(cls)) : cls).isInstance(value);
        }
    }
    ...
    static {
        ...
        for (Object item$iv$iv : $this$mapIndexed$iv) {
            ...
            destination$iv$iv.add(Tuples.m366to((Class) item$iv$iv, Integer.valueOf(index$iv$iv)));
        }
        ...
        Iterable $this$associateTo$iv = primitiveFqNames.values();
        ...
        for (Object element$iv : $this$associateTo$iv) {
            ...
            Pair pair = Tuples.m366to(append.append(StringsKt.substringAfterLast$default(kotlinName, '.', (String) null, 2, (Object) null)).append("CompanionObject").toString(), kotlinName + ".Companion");
