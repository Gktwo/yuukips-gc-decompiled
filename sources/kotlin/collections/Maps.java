...
class Maps extends MapsJVM {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: java.util.Map<K, ? extends V> */
    ...
    /* JADX DEBUG: Type inference failed for r0v3. Raw type applied. Possible types: java.util.Iterator<java.util.Map$Entry<? extends K, ? extends V>>, java.util.Iterator<java.util.Map$Entry<K, V>> */
    @InlineOnly
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r6v0, resolved type: M extends java.util.Map<? super K, ? super R> */
    /* JADX WARN: Multi-variable type inference failed */
    @NotNull
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: M extends java.util.Map<? super R, ? super V> */
    /* JADX WARN: Multi-variable type inference failed */
    @NotNull
    ...
    public static final <K, V> Map<K, V> toMap(@NotNull Iterable<? extends Pair<? extends K, ? extends V>> iterable) {
        ...
        switch (((Collection) iterable).size()) {
            case 0:
                return MapsKt.emptyMap();
            case 1:
                return MapsKt.mapOf(iterable instanceof List ? (Pair) ((List) iterable).get(0) : (Pair) iterable.iterator().next());
            default:
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: java.util.Map<K, ? extends V> */
    /* JADX WARN: Multi-variable type inference failed */
    @InlineOnly
