...
public class Collections extends CollectionsJVM {
    ...
    public static final <T, K extends Comparable<? super K>> int binarySearchBy(@NotNull List<? extends T> list, @Nullable K k, int fromIndex, int toIndex, @NotNull Function1<? super T, ? extends K> function1) {
        Intrinsics.checkNotNullParameter(list, "<this>");
    ...
    public static final <T> int binarySearch(@NotNull List<? extends T> list, int fromIndex, int toIndex, @NotNull Function1<? super T, Integer> function1) {
        Intrinsics.checkNotNullParameter(list, "<this>");
