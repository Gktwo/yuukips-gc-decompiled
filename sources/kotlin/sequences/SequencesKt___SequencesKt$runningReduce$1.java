...
@DebugMetadata(m364f = "_Sequences.kt", m362l = {PacketOpcodes.BlessingRedeemRewardReq, 2176}, m363i = {0, 0, 0, 1, 1, 1}, m359s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$2"}, m360n = {"$this$sequence", "iterator", "accumulator", "$this$sequence", "iterator", "accumulator"}, m361m = "invokeSuspend", m365c = "kotlin.sequences.SequencesKt___SequencesKt$runningReduce$1")
