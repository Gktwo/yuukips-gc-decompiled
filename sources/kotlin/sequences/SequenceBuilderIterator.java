...
final class SequenceBuilderIterator<T> extends SequenceScope<T> implements Iterator<T>, Continuation<Unit>, KMappedMarker {
    ...
    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: kotlin.coroutines.Continuation<? super kotlin.Unit>, kotlin.coroutines.Continuation<kotlin.Unit> */
    @Nullable
    ...
    public boolean hasNext() {
        while (true) {
            ...
            step.resumeWith(Result.m7062constructorimpl(Unit.INSTANCE));
        }
    }
