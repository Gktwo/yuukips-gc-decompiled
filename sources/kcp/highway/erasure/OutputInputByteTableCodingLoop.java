...
/* loaded from: grasscutter.jar:kcp/highway/erasure/OutputInputByteTableCodingLoop.class */
        ...
        for (int iOutput = 0; iOutput < outputCount; iOutput++) {
            ...
            for (int iInput = 1; iInput < inputCount; iInput++) {
                ...
                for (int iByte2 = offset; iByte2 < offset + byteCount; iByte2++) {
                    outputShard[iByte2] = (byte) (outputShard[iByte2] ^ multTableRow2[inputShard2[iByte2] & 255]);
                }
            }
        }
    }
