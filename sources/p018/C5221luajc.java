...
public class C5221luajc {
    ...
    public class InputFile {
        ...
        private final C5221luajc this$0;

        public InputFile(C5221luajc luajc, File file, File file2, String str) {
            this.this$0 = luajc;
            this.infile = file2;
            String replace = str != null ? str.replace('.', '/') : null;
            String stringBuffer = replace != null ? new StringBuffer().append(C5221luajc.access$000(luajc)).append("/").append(replace).toString() : C5221luajc.access$000(luajc);
    ...
    public static final class LocalClassLoader extends ClassLoader {
        ...
        /* renamed from: t */
        private final Hashtable f3061t;

        private LocalClassLoader(Hashtable hashtable) {
            this.f3061t = hashtable;
        }

        @Override // java.lang.ClassLoader
        public Class findClass(String str) throws ClassNotFoundException {
            byte[] bArr = (byte[]) this.f3061t.get(str);
            return bArr != null ? defineClass(str, bArr, 0, bArr.length) : findClass(str);
        }

        LocalClassLoader(Hashtable hashtable, C52221 r5) {
            this(hashtable);
        }
    }
    ...
    public static void main(String[] strArr) throws IOException {
        new C5221luajc(strArr);
    }

    private C5221luajc(String[] strArr) throws IOException {
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
        ...
        */
    private void processFile(p018.C5221luajc.InputFile r8) {
        /*
        // Method dump skipped, instructions count: 619
        */
        throw new UnsupportedOperationException("Method not decompiled: p018.C5221luajc.processFile(luajc$InputFile):void");
    }

    static String access$000(C5221luajc luajc) {
