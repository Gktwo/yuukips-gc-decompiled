...
/* loaded from: grasscutter.jar:com/mongodb/BulkUpdateRequestBuilder.class */
public class BulkUpdateRequestBuilder {
    ...
    public BulkUpdateRequestBuilder(BulkWriteOperation bulkWriteOperation, DBObject query, boolean upsert, Encoder<DBObject> queryCodec, Encoder<DBObject> replacementCodec, @Nullable Collation collation, @Nullable List<? extends DBObject> arrayFilters) {
