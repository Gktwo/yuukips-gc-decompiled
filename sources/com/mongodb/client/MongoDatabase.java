...
@ThreadSafe
/* loaded from: grasscutter.jar:com/mongodb/client/MongoDatabase.class */
public interface MongoDatabase {
    ...
    AggregateIterable<Document> aggregate(List<? extends Bson> list);

    <TResult> AggregateIterable<TResult> aggregate(List<? extends Bson> list, Class<TResult> cls);

    AggregateIterable<Document> aggregate(ClientSession clientSession, List<? extends Bson> list);
