...
/* loaded from: grasscutter.jar:com/mongodb/client/MongoClients.class */
public final class MongoClients {
    ...
    public static MongoClient create(MongoClientSettings settings, @Nullable MongoDriverInformation mongoDriverInformation) {
        return new MongoClientImpl(settings, (mongoDriverInformation == null ? MongoDriverInformation.builder() : MongoDriverInformation.builder(mongoDriverInformation)).driverName("sync").build());
    }
