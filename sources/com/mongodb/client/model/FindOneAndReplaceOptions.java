...
/* loaded from: grasscutter.jar:com/mongodb/client/model/FindOneAndReplaceOptions.class */
public class FindOneAndReplaceOptions {
    ...
    public String toString() {
        return "FindOneAndReplaceOptions{projection=" + this.projection + ", sort=" + this.sort + ", upsert=" + this.upsert + ", returnDocument=" + this.returnDocument + ", maxTimeMS=" + this.maxTimeMS + ", bypassDocumentValidation=" + this.bypassDocumentValidation + ", collation=" + this.collation + ", hint=" + this.hint + ", hintString" + this.hintString + '}';
    }
}
