...
@ThreadSafe
/* loaded from: grasscutter.jar:com/mongodb/client/MongoCollection.class */
public interface MongoCollection<TDocument> {
    ...
    InsertOneResult insertOne(TDocument tdocument);

    InsertOneResult insertOne(TDocument tdocument, InsertOneOptions insertOneOptions);

    InsertOneResult insertOne(ClientSession clientSession, TDocument tdocument);

    InsertOneResult insertOne(ClientSession clientSession, TDocument tdocument, InsertOneOptions insertOneOptions);

    InsertManyResult insertMany(List<? extends TDocument> list);

    InsertManyResult insertMany(List<? extends TDocument> list, InsertManyOptions insertManyOptions);

    InsertManyResult insertMany(ClientSession clientSession, List<? extends TDocument> list);

    InsertManyResult insertMany(ClientSession clientSession, List<? extends TDocument> list, InsertManyOptions insertManyOptions);
    ...
    UpdateResult updateOne(Bson bson, List<? extends Bson> list);

    UpdateResult updateOne(Bson bson, List<? extends Bson> list, UpdateOptions updateOptions);

    UpdateResult updateOne(ClientSession clientSession, Bson bson, List<? extends Bson> list);

    UpdateResult updateOne(ClientSession clientSession, Bson bson, List<? extends Bson> list, UpdateOptions updateOptions);
    ...
    UpdateResult updateMany(Bson bson, List<? extends Bson> list);

    UpdateResult updateMany(Bson bson, List<? extends Bson> list, UpdateOptions updateOptions);

    UpdateResult updateMany(ClientSession clientSession, Bson bson, List<? extends Bson> list);

    UpdateResult updateMany(ClientSession clientSession, Bson bson, List<? extends Bson> list, UpdateOptions updateOptions);
    ...
    @Nullable
    TDocument findOneAndUpdate(Bson bson, List<? extends Bson> list);

    @Nullable
    TDocument findOneAndUpdate(Bson bson, List<? extends Bson> list, FindOneAndUpdateOptions findOneAndUpdateOptions);

    @Nullable
    TDocument findOneAndUpdate(ClientSession clientSession, Bson bson, List<? extends Bson> list);

    @Nullable
    TDocument findOneAndUpdate(ClientSession clientSession, Bson bson, List<? extends Bson> list, FindOneAndUpdateOptions findOneAndUpdateOptions);
