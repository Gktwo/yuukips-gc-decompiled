...
/* loaded from: grasscutter.jar:com/mongodb/BulkWriteRequestBuilder.class */
public class BulkWriteRequestBuilder {
    ...
    public BulkWriteRequestBuilder(BulkWriteOperation bulkWriteOperation, DBObject query, Encoder<DBObject> queryCodec, Encoder<DBObject> replacementCodec) {
