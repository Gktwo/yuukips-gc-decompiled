...
/* loaded from: grasscutter.jar:com/mongodb/connection/netty/NettyByteBuf.class */
final class NettyByteBuf implements ByteBuf {
    private p013io.netty.buffer.ByteBuf proxied;
    private boolean isWriting;

    /* access modifiers changed from: package-private */
    public NettyByteBuf(p013io.netty.buffer.ByteBuf proxied) {
        this.isWriting = true;
        this.proxied = proxied.order(ByteOrder.LITTLE_ENDIAN);
    }

    NettyByteBuf(p013io.netty.buffer.ByteBuf proxied, boolean isWriting) {
        this(proxied);
        this.isWriting = isWriting;
    }

    /* access modifiers changed from: package-private */
    public p013io.netty.buffer.ByteBuf asByteBuf() {
        return this.proxied;
    }
