...
@Immutable
/* loaded from: grasscutter.jar:com/mongodb/connection/ServerSettings.class */
public class ServerSettings {
    ...
    @NotThreadSafe
    /* loaded from: grasscutter.jar:com/mongodb/connection/ServerSettings$Builder.class */
    public static final class Builder {
        ...
        private Builder() {
            ...
            this.minHeartbeatFrequencyMS = 500;
        ...
        public Builder applyConnectionString(ConnectionString connectionString) {
            ...
            if (heartbeatFrequency != null) {
                this.heartbeatFrequencyMS = (long) heartbeatFrequency.intValue();
            }
            return this;
        }
