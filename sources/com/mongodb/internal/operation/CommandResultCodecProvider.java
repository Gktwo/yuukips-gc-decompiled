...
/* loaded from: grasscutter.jar:com/mongodb/internal/operation/CommandResultCodecProvider.class */
public class CommandResultCodecProvider<P> implements CodecProvider {
    ...
    /* access modifiers changed from: package-private */
    public CommandResultCodecProvider(Decoder<P> payloadDecoder, List<String> fieldContainingPayload) {
