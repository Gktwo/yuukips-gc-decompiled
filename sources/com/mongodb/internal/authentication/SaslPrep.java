...
/* loaded from: grasscutter.jar:com/mongodb/internal/authentication/SaslPrep.class */
public final class SaslPrep {
    ...
    private static String saslPrep(String str, boolean allowUnassigned) {
        ...
        int i3 = 0;
        while (i3 < normalized.length()) {
            int codepoint = normalized.codePointAt(i3);
            if (prohibited(codepoint)) {
                throw new IllegalArgumentException("Prohibited character at position " + i3);
            }
