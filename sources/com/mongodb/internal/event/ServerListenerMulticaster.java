...
/* loaded from: grasscutter.jar:com/mongodb/internal/event/ServerListenerMulticaster.class */
public final class ServerListenerMulticaster implements ServerListener {
    private static final Logger LOGGER = Loggers.getLogger("cluster.event");
    private final List<ServerListener> serverListeners;

    /* access modifiers changed from: package-private */
    public ServerListenerMulticaster(List<ServerListener> serverListeners) {
