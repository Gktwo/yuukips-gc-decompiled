...
/* loaded from: grasscutter.jar:com/mongodb/internal/event/ClusterListenerMulticaster.class */
public final class ClusterListenerMulticaster implements ClusterListener {
    private static final Logger LOGGER = Loggers.getLogger("cluster.event");
    private final List<ClusterListener> clusterListeners;

    /* access modifiers changed from: package-private */
    public ClusterListenerMulticaster(List<ClusterListener> clusterListeners) {
