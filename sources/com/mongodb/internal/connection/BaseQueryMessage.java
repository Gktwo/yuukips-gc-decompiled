...
/* loaded from: grasscutter.jar:com/mongodb/internal/connection/BaseQueryMessage.class */
abstract class BaseQueryMessage extends LegacyMessage {
    ...
    public BaseQueryMessage(String collectionName, int skip, int numberToReturn, MessageSettings settings) {
