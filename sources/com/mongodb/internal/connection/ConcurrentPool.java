...
/* loaded from: grasscutter.jar:com/mongodb/internal/connection/ConcurrentPool.class */
public class ConcurrentPool<T> implements Pool<T> {
    ...
    /* loaded from: grasscutter.jar:com/mongodb/internal/connection/ConcurrentPool$ItemFactory.class */
    ...
    /* loaded from: grasscutter.jar:com/mongodb/internal/connection/ConcurrentPool$Prune.class */
    public enum Prune {
        YES,
        NO,
        STOP
    ...
    public T get(long timeout, TimeUnit timeUnit) {
        ...
        } else if (!acquirePermit(timeout, timeUnit)) {
    ...
    public void prune() {
        ...
        while (iter.hasNext() && (shouldPrune = this.itemFactory.shouldPrune((cur = iter.next()))) != Prune.STOP) {
            if (shouldPrune == Prune.YES && iter.reportingRemove()) {
                close(cur);
            }
        }
    }
    ...
    public void ensureMinSize(int minSize, boolean initialize) {
        while (getCount() < minSize && acquirePermit(10, TimeUnit.MILLISECONDS)) {
