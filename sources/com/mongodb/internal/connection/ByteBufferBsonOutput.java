...
/* loaded from: grasscutter.jar:com/mongodb/internal/connection/ByteBufferBsonOutput.class */
public class ByteBufferBsonOutput extends OutputBuffer {
    ...
    private ByteBuf getByteBufferAtIndex(int index) {
        ...
        if (this.bufferList.size() < index + 1) {
            ...
            if (index >= 21) {
                ...
                i = Math.min(1024 << index, 16777216);
            }
            list.add(bufferProvider.getBuffer(i));
        }
    ...
    @Override // org.bson.p022io.OutputBuffer
    protected void write(int absolutePosition, int value) {
        ...
        if (absolutePosition < 0) {
            ...
            getByteBufferAtIndex(bufferPositionPair.bufferIndex).put(BufferPositionPair.access$108(bufferPositionPair), (byte) value);
        }
    }
    ...
    @Override // org.bson.p022io.OutputBuffer, org.bson.p022io.BsonOutput
    ...
    @Override // org.bson.p022io.OutputBuffer, java.io.OutputStream, java.io.Closeable, java.lang.AutoCloseable, org.bson.p022io.BsonOutput
    public void close() {
        for (ByteBuf cur : this.bufferList) {
            cur.release();
        }
    ...
    /* loaded from: grasscutter.jar:com/mongodb/internal/connection/ByteBufferBsonOutput$BufferPositionPair.class */
