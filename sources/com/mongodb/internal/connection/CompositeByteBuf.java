...
/* loaded from: grasscutter.jar:com/mongodb/internal/connection/CompositeByteBuf.class */
class CompositeByteBuf implements ByteBuf {
    ...
    public CompositeByteBuf(List<ByteBuf> buffers) {
    ...
    private int findComponentIndex(int index) {
        for (int i = this.components.size() - 1; i >= 0; i--) {
            if (index >= this.components.get(i).offset) {
                return i;
            }
        }
    ...
    /* loaded from: grasscutter.jar:com/mongodb/internal/connection/CompositeByteBuf$Component.class */
