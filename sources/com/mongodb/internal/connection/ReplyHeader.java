...
/* loaded from: grasscutter.jar:com/mongodb/internal/connection/ReplyHeader.class */
public final class ReplyHeader {
    ...
    public ReplyHeader(ByteBuf header, MessageHeader messageHeader) {
        this(messageHeader.getMessageLength(), messageHeader.getOpCode(), messageHeader, header);
    }

    /* access modifiers changed from: package-private */
    public ReplyHeader(ByteBuf header, CompressedHeader compressedHeader) {
