...
/* loaded from: grasscutter.jar:com/mongodb/internal/connection/ClientMetadataHelper.class */
public final class ClientMetadataHelper {
    ...
    private static BsonDocument addDriverInformation(MongoDriverInformation mongoDriverInformation, BsonDocument document) {
        ...
        document.append("driver", new BsonDocument("name", listToBsonString(driverInformation.getDriverNames())).append("version", listToBsonString(driverInformation.getDriverVersions())));
