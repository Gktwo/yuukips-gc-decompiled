...
/* loaded from: grasscutter.jar:com/mongodb/internal/connection/GSSAPIAuthenticator.class */
public class GSSAPIAuthenticator extends SaslAuthenticator {
    ...
    /* access modifiers changed from: package-private */
    public GSSAPIAuthenticator(MongoCredentialWithCache credential) {
        super(credential);
    ...
    private GSSCredential getGSSCredential(String userName) throws GSSException {
        ...
        return manager.createCredential(manager.createName(userName, GSSName.NT_USER_NAME), Integer.MAX_VALUE, krb5Mechanism, 1);
    }
