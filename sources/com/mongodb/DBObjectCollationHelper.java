...
/* loaded from: grasscutter.jar:com/mongodb/DBObjectCollationHelper.class */
public final class DBObjectCollationHelper {
    /* access modifiers changed from: package-private */
    @Nullable
    public static Collation createCollationFromOptions(DBObject options) {
        ...
        if (collation.get("strength") != null) {
            ...
            builder.collationStrength(CollationStrength.fromInt(((Integer) strength).intValue()));
        }
