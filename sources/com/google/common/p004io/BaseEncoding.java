...
/* loaded from: grasscutter.jar:com/google/common/io/BaseEncoding.class */
public abstract class BaseEncoding {
    ...
    /* loaded from: grasscutter.jar:com/google/common/io/BaseEncoding$DecodingException.class */
    ...
    /* loaded from: grasscutter.jar:com/google/common/io/BaseEncoding$Alphabet.class */
    ...
    /* loaded from: grasscutter.jar:com/google/common/io/BaseEncoding$StandardBaseEncoding.class */
        ...
        public InputStream decodingStream(final Reader reader) {
            ...
            return new InputStream() { // from class: com.google.common.io.BaseEncoding.StandardBaseEncoding.2
                ...
                /* JADX WARNING: Code restructure failed: missing block: B:22:0x00a9, code lost:
                    throw new com.google.common.p004io.BaseEncoding.DecodingException("Padding cannot start at index " + r5.readChars);
                 */
                ...
                public int read() throws java.io.IOException {
                    ...
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.google.common.p004io.BaseEncoding.StandardBaseEncoding.C04812.read():int");
                }
    ...
    /* loaded from: grasscutter.jar:com/google/common/io/BaseEncoding$Base16Encoding.class */
    static final class Base16Encoding extends StandardBaseEncoding {
        ...
        @Override // com.google.common.p004io.BaseEncoding.StandardBaseEncoding, com.google.common.p004io.BaseEncoding
        void encodeTo(Appendable target, byte[] bytes, int off, int len) throws IOException {
            Preconditions.checkNotNull(target);
            Preconditions.checkPositionIndexes(off, off + len, bytes.length);
            for (int i = 0; i < len; i++) {
        ...
        @Override // com.google.common.p004io.BaseEncoding.StandardBaseEncoding
        BaseEncoding newInstance(Alphabet alphabet, Character paddingChar) {
    ...
    /* loaded from: grasscutter.jar:com/google/common/io/BaseEncoding$Base64Encoding.class */
    ...
    /* loaded from: grasscutter.jar:com/google/common/io/BaseEncoding$SeparatedBaseEncoding.class */
