...
/* loaded from: grasscutter.jar:com/google/common/collect/ImmutableMap.class */
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1419of() {
        return (ImmutableMap<K, V>) RegularImmutableMap.EMPTY;
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1418of(K k1, V v1) {
        return ImmutableBiMap.m1445of((Object) k1, (Object) v1);
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1417of(K k1, V v1, K k2, V v2) {
        return RegularImmutableMap.fromEntries(entryOf(k1, v1), entryOf(k2, v2));
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1416of(K k1, V v1, K k2, V v2, K k3, V v3) {
        return RegularImmutableMap.fromEntries(entryOf(k1, v1), entryOf(k2, v2), entryOf(k3, v3));
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1415of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4) {
        return RegularImmutableMap.fromEntries(entryOf(k1, v1), entryOf(k2, v2), entryOf(k3, v3), entryOf(k4, v4));
    }

    /* renamed from: of */
    public static <K, V> ImmutableMap<K, V> m1414of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
    ...
    /* loaded from: grasscutter.jar:com/google/common/collect/ImmutableMap$Builder.class */
    public static class Builder<K, V> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: com.google.common.collect.ImmutableMap$Builder<K, V> */
        ...
        public ImmutableMap<K, V> build() {
            ...
            switch (this.size) {
                ...
                case 1:
                    return ImmutableMap.m1418of((Object) this.entries[0].getKey(), (Object) this.entries[0].getValue());
                default:
    ...
    public static <K, V> ImmutableMap<K, V> copyOf(Iterable<? extends Map.Entry<? extends K, ? extends V>> entries) {
        ...
        switch (entryArray.length) {
            ...
            case 1:
                ...
                return m1418of((Object) onlyEntry.getKey(), (Object) onlyEntry.getValue());
            default:
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:com/google/common/collect/ImmutableMap$IteratorBasedImmutableMap.class */
    ...
    public ImmutableSetMultimap<K, V> asMultimap() {
        if (isEmpty()) {
            return ImmutableSetMultimap.m1389of();
        }
    ...
    /* loaded from: grasscutter.jar:com/google/common/collect/ImmutableMap$MapViewOfValuesAsSingletonSets.class */
    private final class MapViewOfValuesAsSingletonSets extends IteratorBasedImmutableMap<K, ImmutableSet<V>> {
        ...
        public ImmutableSet<V> get(Object key) {
            ...
            return ImmutableSet.m1395of(obj);
        }
                ...
                public Map.Entry<K, ImmutableSet<V>> next() {
                    ...
                    return new AbstractMapEntry<K, ImmutableSet<V>>() { // from class: com.google.common.collect.ImmutableMap.MapViewOfValuesAsSingletonSets.1.1
                        ...
                        public ImmutableSet<V> getValue() {
                            return ImmutableSet.m1395of(backingEntry.getValue());
                        }
                    };
                }
            };
    ...
    /* loaded from: grasscutter.jar:com/google/common/collect/ImmutableMap$SerializedForm.class */
