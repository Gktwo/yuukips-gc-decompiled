...
/* loaded from: grasscutter.jar:com/google/common/collect/FluentIterable.class */
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo1456or((Optional<Iterable<E>>) this);
    }
    ...
    @Beta
    /* renamed from: of */
    public static <E> FluentIterable<E> m1448of() {
        return from(ImmutableList.m1438of());
    }

    @Beta
    /* renamed from: of */
    public static <E> FluentIterable<E> m1447of(E element, E... elements) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: com.google.common.base.Function<? super E, ? extends java.lang.Iterable<? extends T>> */
    ...
    public final Optional<E> first() {
        ...
        return iterator.hasNext() ? Optional.m1463of(iterator.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (iterable instanceof List) {
            ...
            return Optional.m1463of(list.get(list.size() - 1));
        }
        ...
        if (iterable instanceof SortedSet) {
            return Optional.m1463of(((SortedSet) iterable).last());
        }
        do {
            current = iterator.next();
        } while (iterator.hasNext());
        return Optional.m1463of(current);
    }
    ...
    /* loaded from: grasscutter.jar:com/google/common/collect/FluentIterable$FromIterableFunction.class */
