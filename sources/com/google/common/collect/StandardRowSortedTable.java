...
@GwtCompatible
/* loaded from: grasscutter.jar:com/google/common/collect/StandardRowSortedTable.class */
class StandardRowSortedTable<R, C, V> extends StandardTable<R, C, V> implements RowSortedTable<R, C, V> {
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/common/collect/StandardRowSortedTable$RowSortedMap.class */
