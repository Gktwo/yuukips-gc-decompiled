...
@GwtCompatible
/* loaded from: grasscutter.jar:com/google/common/collect/StandardTable.class */
public class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public boolean contains(Object rowKey, Object columnKey) {
        return (rowKey == null || columnKey == null || !contains(rowKey, columnKey)) ? false : true;
    }
    ...
    /* loaded from: grasscutter.jar:com/google/common/collect/StandardTable$TableSet.class */
    ...
    /* loaded from: grasscutter.jar:com/google/common/collect/StandardTable$CellIterator.class */
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:com/google/common/collect/StandardTable$Row.class */
    public class Row extends Maps.IteratorBasedAbstractMap<C, V> {
        ...
        Map.Entry<C, V> wrapEntry(final Map.Entry<C, V> entry) {
            return new ForwardingMapEntry<C, V>() { // from class: com.google.common.collect.StandardTable.Row.2
                ...
                /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: com.google.common.collect.StandardTable$Row$2 */
                /* JADX WARN: Multi-variable type inference failed */
                @Override // com.google.common.collect.ForwardingMapEntry, java.util.Map.Entry
                public V setValue(V value) {
                    return (V) setValue(Preconditions.checkNotNull(value));
                }
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/common/collect/StandardTable$Column.class */
    public class Column extends Maps.ViewCachingAbstractMap<R, V> {
        ...
        /* loaded from: grasscutter.jar:com/google/common/collect/StandardTable$Column$EntrySet.class */
        private class EntrySet extends Sets.ImprovedAbstractSet<Map.Entry<R, V>> {
            ...
            public boolean retainAll(Collection<?> c) {
                return Column.this.removeFromColumnIf(Predicates.not(Predicates.m1462in(c)));
            }
        }

        /* loaded from: grasscutter.jar:com/google/common/collect/StandardTable$Column$EntrySetIterator.class */
                ...
                while (this.iterator.hasNext()) {
                    ...
                    if (entry.getValue().containsKey(Column.this.columnKey)) {
                        return new AbstractMapEntry<R, V>() { // from class: com.google.common.collect.StandardTable.Column.EntrySetIterator.1EntryImpl
                            ...
                            /* JADX DEBUG: Multi-variable search result rejected for r0v3, resolved type: java.util.Map */
                            /* JADX WARN: Multi-variable type inference failed */
                            @Override // com.google.common.collect.AbstractMapEntry, java.util.Map.Entry
                            public V setValue(V value) {
        ...
        /* loaded from: grasscutter.jar:com/google/common/collect/StandardTable$Column$KeySet.class */
        private class KeySet extends Maps.KeySet<R, V> {
            ...
            @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
            public boolean retainAll(Collection<?> c) {
                return Column.this.removeFromColumnIf(Maps.keyPredicateOnEntries(Predicates.not(Predicates.m1462in(c))));
            }
        }
        ...
        /* loaded from: grasscutter.jar:com/google/common/collect/StandardTable$Column$Values.class */
        private class Values extends Maps.Values<R, V> {
            ...
            public boolean removeAll(Collection<?> c) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.m1462in(c)));
            }

            @Override // com.google.common.collect.Maps.Values, java.util.AbstractCollection, java.util.Collection
            public boolean retainAll(Collection<?> c) {
                return Column.this.removeFromColumnIf(Maps.valuePredicateOnEntries(Predicates.not(Predicates.m1462in(c))));
            }
        }
    }
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/common/collect/StandardTable$ColumnKeySet.class */
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/common/collect/StandardTable$ColumnKeyIterator.class */
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:com/google/common/collect/StandardTable$RowMap.class */
    public class RowMap extends Maps.ViewCachingAbstractMap<R, Map<C, V>> {
        ...
        /* access modifiers changed from: package-private */
        /* loaded from: grasscutter.jar:com/google/common/collect/StandardTable$RowMap$EntrySet.class */
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/common/collect/StandardTable$ColumnMap.class */
    public class ColumnMap extends Maps.ViewCachingAbstractMap<C, Map<R, V>> {
        ...
        /* access modifiers changed from: package-private */
        /* loaded from: grasscutter.jar:com/google/common/collect/StandardTable$ColumnMap$ColumnMapEntrySet.class */
        public class ColumnMapEntrySet extends StandardTable<R, C, V>.TableSet {
            ...
            /* JADX DEBUG: Multi-variable search result rejected for r2v2, resolved type: com.google.common.collect.StandardTable */
            /* JADX WARN: Multi-variable type inference failed */
            @Override // com.google.common.collect.Sets.ImprovedAbstractSet, java.util.AbstractCollection, java.util.Collection, java.util.Set
            public boolean retainAll(Collection<?> c) {
                Preconditions.checkNotNull(c);
        ...
        /* loaded from: grasscutter.jar:com/google/common/collect/StandardTable$ColumnMap$ColumnMapValues.class */
        private class ColumnMapValues extends Maps.Values<C, Map<R, V>> {
            ...
            /* JADX DEBUG: Multi-variable search result rejected for r1v2, resolved type: com.google.common.collect.StandardTable */
            /* JADX WARN: Multi-variable type inference failed */
            @Override // com.google.common.collect.Maps.Values, java.util.AbstractCollection, java.util.Collection
            public boolean removeAll(Collection<?> c) {
                Preconditions.checkNotNull(c);
