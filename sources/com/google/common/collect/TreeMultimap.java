...
/* loaded from: grasscutter.jar:com/google/common/collect/TreeMultimap.class */
public class TreeMultimap<K, V> extends AbstractSortedKeySortedSetMultimap<K, V> {
    ...
    public /* bridge */ /* synthetic */ SortedSet replaceValues(Object obj, Iterable iterable) {
        return replaceValues((TreeMultimap<K, V>) obj, iterable);
    }
    ...
    public NavigableSet<V> get(K key) {
        return (NavigableSet) get((TreeMultimap<K, V>) key);
    }
