...
@GwtIncompatible
/* loaded from: grasscutter.jar:com/google/common/collect/AbstractNavigableMap.class */
public abstract class AbstractNavigableMap<K, V> extends Maps.IteratorBasedAbstractMap<K, V> implements NavigableMap<K, V> {
    ...
    /* loaded from: grasscutter.jar:com/google/common/collect/AbstractNavigableMap$DescendingMap.class */
