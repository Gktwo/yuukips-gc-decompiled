...
@GwtCompatible
/* loaded from: grasscutter.jar:com/google/common/collect/TopKSelector.class */
public final class TopKSelector<T> {

    /* renamed from: k */
    private final int f288k;
    ...
    /* JADX DEBUG: Type inference failed for r2v13. Raw type applied. Possible types: T, ? super T */
    public void offer(T elem) {
        if (this.f288k != 0) {
            if (this.bufferSize == 0) {
                ...
                this.threshold = elem;
                this.bufferSize = 1;
            } else if (this.bufferSize < this.f288k) {
                T[] tArr = this.buffer;
                ...
                tArr2[i2] = elem;
                if (this.bufferSize == 2 * this.f288k) {
                    trim();
                }
            }
        }
    ...
    private void trim() {
        ...
        this.bufferSize = this.f288k;
        this.threshold = this.buffer[minThresholdPosition];
        for (int i = minThresholdPosition + 1; i < this.f288k; i++) {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: com.google.common.collect.TopKSelector<T> */
    ...
    public List<T> topK() {
        ...
        if (this.bufferSize > this.f288k) {
            Arrays.fill(this.buffer, this.f288k, this.buffer.length, (Object) null);
            this.bufferSize = this.f288k;
            this.threshold = this.buffer[this.f288k - 1];
        }
