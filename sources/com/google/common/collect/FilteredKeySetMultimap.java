...
@GwtCompatible
/* loaded from: grasscutter.jar:com/google/common/collect/FilteredKeySetMultimap.class */
public final class FilteredKeySetMultimap<K, V> extends FilteredKeyMultimap<K, V> implements FilteredSetMultimap<K, V> {
    ...
    public Set<V> get(K key) {
        return (Set) get((FilteredKeySetMultimap<K, V>) key);
    }
    ...
    public Set<V> replaceValues(K key, Iterable<? extends V> values) {
        return (Set) replaceValues((FilteredKeySetMultimap<K, V>) key, (Iterable) values);
    }
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:com/google/common/collect/FilteredKeySetMultimap$EntrySet.class */
