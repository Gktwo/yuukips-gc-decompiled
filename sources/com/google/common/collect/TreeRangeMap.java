...
@Beta
@GwtIncompatible
/* loaded from: grasscutter.jar:com/google/common/collect/TreeRangeMap.class */
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V> {
    ...
    /* loaded from: grasscutter.jar:com/google/common/collect/TreeRangeMap$RangeMapEntry.class */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: com.google.common.collect.TreeRangeMap<K extends java.lang.Comparable, V> */
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/common/collect/TreeRangeMap$AsMapOfRanges.class */
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/common/collect/TreeRangeMap$SubRangeMap.class */
    public class SubRangeMap implements RangeMap<K, V> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r0v1, resolved type: com.google.common.collect.TreeRangeMap */
        /* JADX WARN: Multi-variable type inference failed */
        @Override // com.google.common.collect.RangeMap
        public void clear() {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: com.google.common.collect.Range<K extends java.lang.Comparable> */
        /* JADX WARN: Multi-variable type inference failed */
        @Override // com.google.common.collect.RangeMap
        ...
        /* loaded from: grasscutter.jar:com/google/common/collect/TreeRangeMap$SubRangeMap$SubRangeMapAsMap.class */
        public class SubRangeMapAsMap extends AbstractMap<Range<K>, V> {
            ...
            public Set<Range<K>> keySet() {
                return new Maps.KeySet<Range<K>, V>(this) { // from class: com.google.common.collect.TreeRangeMap.SubRangeMap.SubRangeMapAsMap.1
                    ...
                    public boolean retainAll(Collection<?> c) {
                        return SubRangeMapAsMap.this.removeEntryIf(Predicates.compose(Predicates.not(Predicates.m1462in(c)), Maps.keyFunction()));
                    }
                };
            }
            ...
            public Set<Map.Entry<Range<K>, V>> entrySet() {
                return new Maps.EntrySet<Range<K>, V>() { // from class: com.google.common.collect.TreeRangeMap.SubRangeMap.SubRangeMapAsMap.2
                    ...
                    public boolean retainAll(Collection<?> c) {
                        return SubRangeMapAsMap.this.removeEntryIf(Predicates.not(Predicates.m1462in(c)));
                    }
            ...
            public Collection<V> values() {
                return new Maps.Values<Range<K>, V>(this) { // from class: com.google.common.collect.TreeRangeMap.SubRangeMap.SubRangeMapAsMap.4
                    ...
                    public boolean removeAll(Collection<?> c) {
                        return SubRangeMapAsMap.this.removeEntryIf(Predicates.compose(Predicates.m1462in(c), Maps.valueFunction()));
                    }

                    @Override // com.google.common.collect.Maps.Values, java.util.AbstractCollection, java.util.Collection
                    public boolean retainAll(Collection<?> c) {
                        return SubRangeMapAsMap.this.removeEntryIf(Predicates.compose(Predicates.not(Predicates.m1462in(c)), Maps.valueFunction()));
                    }
                };
            }
        }
