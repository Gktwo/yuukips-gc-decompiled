...
@GwtCompatible
/* loaded from: grasscutter.jar:com/google/common/collect/AbstractSortedSetMultimap.class */
abstract class AbstractSortedSetMultimap<K, V> extends AbstractSetMultimap<K, V> implements SortedSetMultimap<K, V> {
    ...
    public SortedSet<V> get(K key) {
        return (SortedSet) get((AbstractSortedSetMultimap<K, V>) key);
    }

    @Override // com.google.common.collect.AbstractSetMultimap, com.google.common.collect.AbstractMapBasedMultimap, com.google.common.collect.Multimap, com.google.common.collect.ListMultimap
    @CanIgnoreReturnValue
    public SortedSet<V> removeAll(Object key) {
        return (SortedSet) removeAll(key);
    }
    ...
    public SortedSet<V> replaceValues(K key, Iterable<? extends V> values) {
        return (SortedSet) replaceValues((AbstractSortedSetMultimap<K, V>) key, (Iterable) values);
    }
