...
@Beta
@GwtCompatible
/* loaded from: grasscutter.jar:com/google/common/primitives/ImmutableIntArray.class */
public final class ImmutableIntArray implements Serializable {
    ...
    /* renamed from: of */
    public static ImmutableIntArray m1318of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static ImmutableIntArray m1317of(int e0) {
        return new ImmutableIntArray(new int[]{e0});
    }

    /* renamed from: of */
    public static ImmutableIntArray m1316of(int e0, int e1) {
        return new ImmutableIntArray(new int[]{e0, e1});
    }

    /* renamed from: of */
    public static ImmutableIntArray m1315of(int e0, int e1, int e2) {
        return new ImmutableIntArray(new int[]{e0, e1, e2});
    }

    /* renamed from: of */
    public static ImmutableIntArray m1314of(int e0, int e1, int e2, int e3) {
        return new ImmutableIntArray(new int[]{e0, e1, e2, e3});
    }

    /* renamed from: of */
    public static ImmutableIntArray m1313of(int e0, int e1, int e2, int e3, int e4) {
        return new ImmutableIntArray(new int[]{e0, e1, e2, e3, e4});
    }

    /* renamed from: of */
    public static ImmutableIntArray m1312of(int e0, int e1, int e2, int e3, int e4, int e5) {
        return new ImmutableIntArray(new int[]{e0, e1, e2, e3, e4, e5});
    }

    /* renamed from: of */
    public static ImmutableIntArray m1311of(int first, int... rest) {
    ...
    /* loaded from: grasscutter.jar:com/google/common/primitives/ImmutableIntArray$Builder.class */
    ...
    /* loaded from: grasscutter.jar:com/google/common/primitives/ImmutableIntArray$AsList.class */
