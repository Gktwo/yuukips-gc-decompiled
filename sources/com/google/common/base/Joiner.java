...
@GwtCompatible
/* loaded from: grasscutter.jar:com/google/common/base/Joiner.class */
public class Joiner {
    private final String separator;

    /* renamed from: on */
    public static Joiner m1464on(String separator) {
        return new Joiner(separator);
    }

    /* renamed from: on */
    public static Joiner m1465on(char separator) {
    ...
    /* loaded from: grasscutter.jar:com/google/common/base/Joiner$MapJoiner.class */
