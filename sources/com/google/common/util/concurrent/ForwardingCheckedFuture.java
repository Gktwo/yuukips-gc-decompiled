...
@GwtIncompatible
@Deprecated
/* loaded from: grasscutter.jar:com/google/common/util/concurrent/ForwardingCheckedFuture.class */
public abstract class ForwardingCheckedFuture<V, X extends Exception> extends ForwardingListenableFuture<V> implements CheckedFuture<V, X> {
    ...
    @Beta
    @Deprecated
    /* loaded from: grasscutter.jar:com/google/common/util/concurrent/ForwardingCheckedFuture$SimpleForwardingCheckedFuture.class */
