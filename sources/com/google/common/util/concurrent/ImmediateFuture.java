...
/* loaded from: grasscutter.jar:com/google/common/util/concurrent/ImmediateFuture.class */
abstract class ImmediateFuture<V> implements ListenableFuture<V> {
    ...
    /* loaded from: grasscutter.jar:com/google/common/util/concurrent/ImmediateFuture$ImmediateSuccessfulFuture.class */
    public static class ImmediateSuccessfulFuture<V> extends ImmediateFuture<V> {
        ...
        public String toString() {
            return toString() + "[status=SUCCESS, result=[" + this.value + "]]";
        }
    }

    @GwtIncompatible
    /* loaded from: grasscutter.jar:com/google/common/util/concurrent/ImmediateFuture$ImmediateSuccessfulCheckedFuture.class */
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:com/google/common/util/concurrent/ImmediateFuture$ImmediateFailedFuture.class */
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:com/google/common/util/concurrent/ImmediateFuture$ImmediateCancelledFuture.class */
    ...
    @GwtIncompatible
    /* loaded from: grasscutter.jar:com/google/common/util/concurrent/ImmediateFuture$ImmediateFailedCheckedFuture.class */
    static class ImmediateFailedCheckedFuture<V, X extends Exception> extends ImmediateFuture<V> implements CheckedFuture<V, X> {
        ...
        @Override // java.lang.Object
        public String toString() {
            return toString() + "[status=FAILURE, cause=[" + this.thrown + "]]";
        }
    }
}
