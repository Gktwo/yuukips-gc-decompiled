...
@Beta
@GwtIncompatible
/* loaded from: grasscutter.jar:com/google/common/util/concurrent/ServiceManager.class */
public final class ServiceManager {
    ...
    @Beta
    /* loaded from: grasscutter.jar:com/google/common/util/concurrent/ServiceManager$Listener.class */
    ...
    public ServiceManager(Iterable<? extends Service> services) {
        ...
        if (copy.isEmpty()) {
            ...
            copy = ImmutableList.m1437of(new NoOpService());
        }
    ...
    /* loaded from: grasscutter.jar:com/google/common/util/concurrent/ServiceManager$ServiceManagerState.class */
    private static final class ServiceManagerState {
        ...
        /* loaded from: grasscutter.jar:com/google/common/util/concurrent/ServiceManager$ServiceManagerState$AwaitHealthGuard.class */
        ...
        /* loaded from: grasscutter.jar:com/google/common/util/concurrent/ServiceManager$ServiceManagerState$StoppedGuard.class */
        ...
        void awaitHealthy(long timeout, TimeUnit unit) throws TimeoutException {
            ...
            try {
                if (!this.monitor.waitForUninterruptibly(this.awaitHealthGuard, timeout, unit)) {
                    throw new TimeoutException("Timeout waiting for the services to become healthy. The following services have not started: " + Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.m1462in(ImmutableSet.m1394of(Service.State.NEW, Service.State.STARTING))));
                }
                checkHealthy();
                this.monitor.leave();
            } catch (Throwable th) {
        ...
        void awaitStopped(long timeout, TimeUnit unit) throws TimeoutException {
            ...
            try {
                if (!this.monitor.waitForUninterruptibly(this.stoppedGuard, timeout, unit)) {
                    throw new TimeoutException("Timeout waiting for the services to stop. The following services have not stopped: " + Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.not(Predicates.m1462in(EnumSet.of(Service.State.TERMINATED, Service.State.FAILED)))));
                }
            } finally {
                this.monitor.leave();
            }
    ...
    /* loaded from: grasscutter.jar:com/google/common/util/concurrent/ServiceManager$ServiceListener.class */
    ...
    /* loaded from: grasscutter.jar:com/google/common/util/concurrent/ServiceManager$NoOpService.class */
    ...
    /* loaded from: grasscutter.jar:com/google/common/util/concurrent/ServiceManager$EmptyServiceManagerWarning.class */
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/common/util/concurrent/ServiceManager$FailedService.class */
