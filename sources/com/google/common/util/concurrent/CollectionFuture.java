...
/* loaded from: grasscutter.jar:com/google/common/util/concurrent/CollectionFuture.class */
abstract class CollectionFuture<V, C> extends AggregateFuture<V, C> {
    CollectionFuture() {
    }

    /* loaded from: grasscutter.jar:com/google/common/util/concurrent/CollectionFuture$CollectionFutureRunningState.class */
    abstract class CollectionFutureRunningState extends AggregateFuture<V, C>.RunningState {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r0v7, resolved type: com.google.common.util.concurrent.CollectionFuture */
    ...
    /* loaded from: grasscutter.jar:com/google/common/util/concurrent/CollectionFuture$ListFuture.class */
    static final class ListFuture<V> extends CollectionFuture<V, List<V>> {
        ...
        /* loaded from: grasscutter.jar:com/google/common/util/concurrent/CollectionFuture$ListFuture$ListFutureRunningState.class */
