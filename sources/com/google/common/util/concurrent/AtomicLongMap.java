...
@GwtCompatible
/* loaded from: grasscutter.jar:com/google/common/util/concurrent/AtomicLongMap.class */
public final class AtomicLongMap<K> implements Serializable {
    ...
    public long updateAndGet(K key, LongUnaryOperator updaterFunction) {
        ...
        return this.map.compute(key, k, value -> {
            return Long.valueOf(updaterFunction.applyAsLong(value == null ? 0 : value.longValue()));
        }).longValue();
    }
    ...
    public long getAndUpdate(K key, LongUnaryOperator updaterFunction) {
        ...
        this.map.compute(key, k, value -> {
            long oldValue = value == null ? 0 : value.longValue();
            holder.set(oldValue);
