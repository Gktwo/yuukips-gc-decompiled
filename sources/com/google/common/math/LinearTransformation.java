...
@Beta
@GwtIncompatible
/* loaded from: grasscutter.jar:com/google/common/math/LinearTransformation.class */
public abstract class LinearTransformation {
    ...
    /* loaded from: grasscutter.jar:com/google/common/math/LinearTransformation$LinearTransformationBuilder.class */
    public static final class LinearTransformationBuilder {

        /* renamed from: x1 */
        private final double f327x1;

        /* renamed from: y1 */
        private final double f328y1;
        ...
        public LinearTransformation and(double x2, double y2) {
            ...
            if (x2 != this.f327x1) {
                return withSlope((y2 - this.f328y1) / (x2 - this.f327x1));
            }
            Preconditions.checkArgument(y2 != this.f328y1);
            return new VerticalLinearTransformation(this.f327x1);
        }
        ...
        public LinearTransformation withSlope(double slope) {
            ...
            if (DoubleUtils.isFinite(slope)) {
                return new RegularLinearTransformation(slope, this.f328y1 - (this.f327x1 * slope));
            }
            return new VerticalLinearTransformation(this.f327x1);
        }
    }
    ...
    /* loaded from: grasscutter.jar:com/google/common/math/LinearTransformation$RegularLinearTransformation.class */
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/common/math/LinearTransformation$VerticalLinearTransformation.class */
    public static final class VerticalLinearTransformation extends LinearTransformation {
        ...
        public String toString() {
            return String.format("x = %g", Double.valueOf(this.f329x));
        }

        private LinearTransformation createInverse() {
            return new RegularLinearTransformation(0.0d, this.f329x, this);
        }
    }

    /* loaded from: grasscutter.jar:com/google/common/math/LinearTransformation$NaNLinearTransformation.class */
