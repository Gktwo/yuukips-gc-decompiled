...
/* loaded from: grasscutter.jar:com/google/common/math/IntMath.class */
public final class IntMath {
    ...
    /* loaded from: grasscutter.jar:com/google/common/math/IntMath$1.class */
    ...
    public static int log2(int x, RoundingMode mode) {
        MathPreconditions.checkPositive("x", x);
        switch (C05001.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
            case 1:
            ...
            case 8:
                ...
                return (31 - leadingZeros) + lessThanBranchFree(MAX_POWER_OF_SQRT2_UNSIGNED >>> leadingZeros, x);
            default:
