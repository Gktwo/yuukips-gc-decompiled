...
@Beta
/* loaded from: grasscutter.jar:com/google/common/graph/AbstractNetwork.class */
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
        ...
        return new AbstractGraph<N>() { // from class: com.google.common.graph.AbstractNetwork.1
            ...
            public Set<EndpointPair<N>> edges() {
                ...
                return new AbstractSet<EndpointPair<N>>() { // from class: com.google.common.graph.AbstractNetwork.1.1
                    ...
                    /* JADX DEBUG: Multi-variable search result rejected for r0v13, resolved type: com.google.common.graph.AbstractNetwork$1 */
                    ...
                    public boolean contains(Object obj) {
                        ...
                        return C04271.this.isOrderingCompatible(endpointPair) && C04271.this.nodes().contains(endpointPair.nodeU()) && C04271.this.successors((C04271) endpointPair.nodeU()).contains(endpointPair.nodeV());
                    }
                };
            }
    ...
    public Set<E> adjacentEdges(E edge) {
        ...
        return Sets.difference(Sets.union(incidentEdges(endpointPair.nodeU()), incidentEdges(endpointPair.nodeV())), ImmutableSet.m1395of((Object) edge));
    }
