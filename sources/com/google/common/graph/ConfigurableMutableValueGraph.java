...
/* loaded from: grasscutter.jar:com/google/common/graph/ConfigurableMutableValueGraph.class */
public final class ConfigurableMutableValueGraph<N, V> extends ConfigurableValueGraph<N, V> implements MutableValueGraph<N, V> {
    ...
    private GraphConnections<N, V> newConnections() {
        if (isDirected()) {
            return DirectedGraphConnections.m1342of();
        }
        return UndirectedGraphConnections.m1336of();
    }
}
