...
@GwtIncompatible
/* loaded from: grasscutter.jar:com/google/common/cache/AbstractLoadingCache.class */
public abstract class AbstractLoadingCache<K, V> extends AbstractCache<K, V> implements LoadingCache<K, V> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: com.google.common.cache.AbstractLoadingCache<K, V> */
