...
@Beta
@GwtIncompatible
/* loaded from: grasscutter.jar:com/google/common/net/InetAddresses.class */
public final class InetAddresses {
    private static final int IPV4_PART_COUNT = 4;
    private static final int IPV6_PART_COUNT = 8;
    private static final Splitter IPV4_SPLITTER = Splitter.m1455on('.').limit(4);
    private static final Splitter IPV6_SPLITTER = Splitter.m1455on(':').limit(10);
    ...
    private static String convertDottedQuadToHex(String ipString) {
        ...
        return initialPart + penultimate + EmitterKt.COMMENT_PREFIX + Integer.toHexString(((quad[2] & 255) << 8) | (quad[3] & 255));
    }
    ...
    @Beta
    /* loaded from: grasscutter.jar:com/google/common/net/InetAddresses$TeredoInfo.class */
