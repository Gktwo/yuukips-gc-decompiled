...
@Beta
/* loaded from: grasscutter.jar:com/google/common/reflect/TypeResolver.class */
public final class TypeResolver {
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/common/reflect/TypeResolver$TypeTable.class */
    public static class TypeTable {
        private final ImmutableMap<TypeVariableKey, Type> map;

        TypeTable() {
            this.map = ImmutableMap.m1419of();
        }
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/common/reflect/TypeResolver$TypeMappingIntrospector.class */
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/common/reflect/TypeResolver$WildcardCapturer.class */
    public static class WildcardCapturer {
        static final WildcardCapturer INSTANCE = new WildcardCapturer();

        /* renamed from: id */
        private final AtomicInteger f331id;
        ...
        TypeVariable<?> captureAsTypeVariable(Type[] upperBounds) {
            return Types.newArtificialTypeVariable(WildcardCapturer.class, "capture#" + this.f331id.incrementAndGet() + "-of ? extends " + Joiner.m1465on('&').join(upperBounds), upperBounds);
        }

        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeParam) {
            return new WildcardCapturer(this.f331id) { // from class: com.google.common.reflect.TypeResolver.WildcardCapturer.1
                ...
                TypeVariable<?> captureAsTypeVariable(Type[] upperBounds) {
                    ...
                    return captureAsTypeVariable((Type[]) combined.toArray(new Type[0]));
                }
            };
        }

        private WildcardCapturer notForTypeVariable() {
            return new WildcardCapturer(this.f331id);
        }
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:com/google/common/reflect/TypeResolver$TypeVariableKey.class */
