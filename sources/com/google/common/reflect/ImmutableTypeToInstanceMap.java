...
@Beta
/* loaded from: grasscutter.jar:com/google/common/reflect/ImmutableTypeToInstanceMap.class */
public final class ImmutableTypeToInstanceMap<B> extends ForwardingMap<TypeToken<? extends B>, B> implements TypeToInstanceMap<B> {
    ...
    /* renamed from: of */
    public static <B> ImmutableTypeToInstanceMap<B> m1301of() {
        return new ImmutableTypeToInstanceMap<>(ImmutableMap.m1419of());
    }
    ...
    @Beta
    /* loaded from: grasscutter.jar:com/google/common/reflect/ImmutableTypeToInstanceMap$Builder.class */
    public static final class Builder<B> {
        ...
        public <T extends B> Builder<B> put(Class<T> key, T value) {
            this.mapBuilder.put(TypeToken.m1299of((Class) key), value);
            return this;
        }
