...
/* loaded from: grasscutter.jar:com/google/protobuf/Type.class */
public final class Type extends GeneratedMessageV3 implements TypeOrBuilder {
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:81:0x0157 */
    /* JADX DEBUG: Multi-variable search result rejected for r0v56, resolved type: java.util.List<com.google.protobuf.Option> */
    /* JADX DEBUG: Multi-variable search result rejected for r0v74, resolved type: java.util.List<com.google.protobuf.Field> */
    ...
    public int hashCode() {
        ...
        if (getFieldsCount() > 0) {
            hash = (53 * ((37 * hash) + 2)) + getFieldsList().hashCode();
        }
        if (getOneofsCount() > 0) {
            hash = (53 * ((37 * hash) + 3)) + getOneofsList().hashCode();
        }
        if (getOptionsCount() > 0) {
            hash = (53 * ((37 * hash) + 4)) + getOptionsList().hashCode();
        }
        if (hasSourceContext()) {
            hash = (53 * ((37 * hash) + 5)) + getSourceContext().hashCode();
        }
        int hash2 = (29 * ((53 * ((37 * hash) + 6)) + this.syntax_)) + this.unknownFields.hashCode();
    ...
    /* loaded from: grasscutter.jar:com/google/protobuf/Type$Builder.class */
