...
/* loaded from: grasscutter.jar:com/google/protobuf/UInt32Value.class */
public final class UInt32Value extends GeneratedMessageV3 implements UInt32ValueOrBuilder {
    ...
    public int hashCode() {
        ...
        int hash = (29 * ((53 * ((37 * ((19 * 41) + getDescriptor().hashCode())) + 1)) + getValue())) + this.unknownFields.hashCode();
    ...
    /* loaded from: grasscutter.jar:com/google/protobuf/UInt32Value$Builder.class */
    ...
    /* renamed from: of */
    public static UInt32Value m1287of(int value) {
