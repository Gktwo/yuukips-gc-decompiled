...
/* loaded from: grasscutter.jar:com/google/protobuf/Internal.class */
public final class Internal {
    ...
    /* loaded from: grasscutter.jar:com/google/protobuf/Internal$BooleanList.class */
    ...
    /* loaded from: grasscutter.jar:com/google/protobuf/Internal$DoubleList.class */
    ...
    /* loaded from: grasscutter.jar:com/google/protobuf/Internal$EnumLite.class */
    public interface EnumLite {
        int getNumber();
    }

    /* loaded from: grasscutter.jar:com/google/protobuf/Internal$EnumLiteMap.class */
    public interface EnumLiteMap<T extends EnumLite> {
        T findValueByNumber(int i);
    }

    /* loaded from: grasscutter.jar:com/google/protobuf/Internal$EnumVerifier.class */
    public interface EnumVerifier {
        boolean isInRange(int i);
    }

    /* loaded from: grasscutter.jar:com/google/protobuf/Internal$FloatList.class */
    ...
    /* loaded from: grasscutter.jar:com/google/protobuf/Internal$IntList.class */
    ...
    /* loaded from: grasscutter.jar:com/google/protobuf/Internal$LongList.class */
    ...
    /* loaded from: grasscutter.jar:com/google/protobuf/Internal$ProtobufList.class */
    ...
    public static int hashBoolean(boolean b) {
        return b ? RetcodeOuterClass.Retcode.RET_MP_OTHER_DATA_VERSION_NOT_LATEST_VALUE : RetcodeOuterClass.Retcode.RET_MP_MATCH_FULL_VALUE;
    }
    ...
    /* loaded from: grasscutter.jar:com/google/protobuf/Internal$ListAdapter.class */
    public static class ListAdapter<F, T> extends AbstractList<T> {
        private final List<F> fromList;
        private final Converter<F, T> converter;

        /* loaded from: grasscutter.jar:com/google/protobuf/Internal$ListAdapter$Converter.class */
    ...
    /* loaded from: grasscutter.jar:com/google/protobuf/Internal$MapAdapter.class */
    public static class MapAdapter<K, V, RealValue> extends AbstractMap<K, V> {
        private final Map<K, RealValue> realMap;
        private final Converter<RealValue, V> valueConverter;

        /* loaded from: grasscutter.jar:com/google/protobuf/Internal$MapAdapter$Converter.class */
        ...
        public static <T extends EnumLite> Converter<Integer, T> newEnumConverter(final EnumLiteMap<T> enumMap, final T unrecognizedValue) {
            return new Converter<Integer, T>() { // from class: com.google.protobuf.Internal.MapAdapter.1
                ...
                public EnumLite doForward(Integer value) {
                    EnumLite findValueByNumber = enumMap.findValueByNumber(value.intValue());
        ...
        /* loaded from: grasscutter.jar:com/google/protobuf/Internal$MapAdapter$SetAdapter.class */
        ...
        /* loaded from: grasscutter.jar:com/google/protobuf/Internal$MapAdapter$IteratorAdapter.class */
        ...
        /* loaded from: grasscutter.jar:com/google/protobuf/Internal$MapAdapter$EntryAdapter.class */
        public class EntryAdapter implements Map.Entry<K, V> {
            ...
            /* JADX DEBUG: Multi-variable search result rejected for r0v1, resolved type: java.util.Map$Entry<K, RealValue> */
