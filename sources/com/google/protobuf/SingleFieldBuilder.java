...
/* loaded from: grasscutter.jar:com/google/protobuf/SingleFieldBuilder.class */
public class SingleFieldBuilder<MType extends GeneratedMessage, BType extends GeneratedMessage.Builder, IType extends MessageOrBuilder> implements GeneratedMessage.BuilderParent {
    ...
    public SingleFieldBuilder(MType message, GeneratedMessage.BuilderParent parent, boolean isClean) {
        this.message = (MType) ((GeneratedMessage) Internal.checkNotNull(message));
        this.parent = parent;
    ...
    public SingleFieldBuilder<MType, BType, IType> clear() {
        ...
        this.message = (MType) ((GeneratedMessage) messageLite);
        if (this.builder != null) {
            this.builder.dispose();
            this.builder = null;
        }
