...
/* loaded from: grasscutter.jar:com/google/protobuf/UnsafeUtil.class */
public final class UnsafeUtil {
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/protobuf/UnsafeUtil$MemoryAccessor.class */
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/protobuf/UnsafeUtil$JvmMemoryAccessor.class */
    public static final class JvmMemoryAccessor extends MemoryAccessor {
        ...
        @Override // com.google.protobuf.UnsafeUtil.MemoryAccessor
        public boolean supportsUnsafeByteBufferOperations() {
            if (!supportsUnsafeByteBufferOperations()) {
                return false;
            }
            try {
                Class<?> clazz = this.unsafe.getClass();
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/protobuf/UnsafeUtil$Android64MemoryAccessor.class */
    ...
    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/google/protobuf/UnsafeUtil$Android32MemoryAccessor.class */
    ...
    public static void putByteBigEndian(Object target, long offset, byte value) {
        ...
        putInt(target, offset & -4, (getInt(target, offset & -4) & ((255 << shift) ^ -1)) | ((255 & value) << shift));
    }
