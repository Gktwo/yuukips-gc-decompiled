...
public final class SchemaUtil {
    ...
    public static int computeSizeStringList(int fieldNumber, List<?> list) {
        ...
        if (list instanceof LazyStringList) {
            ...
            for (int i5 = 0; i5 < length; i5++) {
                Object value = lazyList.getRaw(i5);
                if (value instanceof ByteString) {
                    i4 = size;
                    i3 = CodedOutputStream.computeBytesSizeNoTag((ByteString) value);
                } else {
                    i4 = size;
                    i3 = CodedOutputStream.computeStringSizeNoTag((String) value);
                }
                size = i4 + i3;
            }
        } else {
            for (int i6 = 0; i6 < length; i6++) {
                Object value2 = list.get(i6);
    ...
    public static boolean shouldUseTableSwitch(int lo, int hi, int numFields) {
        ...
        return ((((long) hi) - ((long) lo)) + 1) + (3 * 3) <= (3 + (2 * ((long) numFields))) + (3 * (3 + ((long) numFields)));
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r0v32, resolved type: java.lang.Object */
