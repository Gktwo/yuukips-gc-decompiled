...
/* loaded from: grasscutter.jar:com/google/protobuf/ExtensionRegistryLite.class */
public class ExtensionRegistryLite {
    ...
    /* loaded from: grasscutter.jar:com/google/protobuf/ExtensionRegistryLite$ExtensionClassHolder.class */
    ...
    public final void add(ExtensionLite<?, ?> extension) {
        ...
        if (doFullRuntimeInheritanceCheck && ExtensionRegistryFactory.isFullRegistry(this)) {
            try {
                getClass().getMethod(BeanUtil.PREFIX_ADDER, ExtensionClassHolder.INSTANCE).invoke(this, extension);
            } catch (Exception e) {
    ...
    /* loaded from: grasscutter.jar:com/google/protobuf/ExtensionRegistryLite$ObjectIntPair.class */
