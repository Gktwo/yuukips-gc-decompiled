...
/* loaded from: grasscutter.jar:com/google/gson/internal/reflect/ReflectionHelper.class */
public class ReflectionHelper {
    ...
    public static void makeAccessible(Field field) throws JsonIOException {
        try {
            ...
            throw new JsonIOException("Failed making field '" + field.getDeclaringClass().getName() + LineReaderImpl.DEFAULT_COMMENT_BEGIN + field.getName() + "' accessible; either change its visibility or write a custom TypeAdapter for its declaring type", exception);
        }
    }
