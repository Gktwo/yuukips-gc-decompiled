...
/* renamed from: com.mchange.v2.c3p0.PoolConfig */
/* loaded from: grasscutter.jar:com/mchange/v2/c3p0/PoolConfig.class */
public final class PoolConfig {
    ...
    static {
        Properties sysProps;
        PoolConfig rsrcDefaults = extractConfig(C3P0ConfigUtils.findResourceProperties(), null);
        try {
