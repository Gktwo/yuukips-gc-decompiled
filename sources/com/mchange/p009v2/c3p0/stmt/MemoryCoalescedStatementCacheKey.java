...
/* renamed from: com.mchange.v2.c3p0.stmt.MemoryCoalescedStatementCacheKey */
/* loaded from: grasscutter.jar:com/mchange/v2/c3p0/stmt/MemoryCoalescedStatementCacheKey.class */
public final class MemoryCoalescedStatementCacheKey extends StatementCacheKey {
    static final Coalescer keyCoalescer = CoalescerFactory.createCoalescer(true, false);

    /* access modifiers changed from: package-private */
    public static StatementCacheKey _find(Connection pcon, Method stmtProducingMethod, Object[] args) {
        ...
        return (StatementCacheKey) keyCoalescer.coalesce(new MemoryCoalescedStatementCacheKey(pcon, stmtText, is_callable, result_set_type, result_set_concurrency, columnIndexes, columnNames, autogeneratedKeys, resultSetHoldability));
    }
