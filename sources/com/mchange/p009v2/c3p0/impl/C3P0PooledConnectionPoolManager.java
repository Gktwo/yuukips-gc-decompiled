...
import com.mchange.p009v2.resourcepool.BasicResourcePoolFactory;
...
/* renamed from: com.mchange.v2.c3p0.impl.C3P0PooledConnectionPoolManager */
/* loaded from: grasscutter.jar:com/mchange/v2/c3p0/impl/C3P0PooledConnectionPoolManager.class */
public final class C3P0PooledConnectionPoolManager {
    ...
    public int getStatementDestroyerNumThreads() {
        if (this.deferredStatementDestroyer != null) {
            return this.deferredStatementDestroyer.getThreadCount();
        }
        return -1;
    }
    ...
    public int getStatementDestroyerNumActiveThreads() {
        if (this.deferredStatementDestroyer != null) {
            return this.deferredStatementDestroyer.getActiveCount();
        }
        return -1;
    }
    ...
    public int getStatementDestroyerNumIdleThreads() {
        if (this.deferredStatementDestroyer != null) {
            return this.deferredStatementDestroyer.getIdleCount();
        }
        return -1;
    }
    ...
    public int getStatementDestroyerNumTasksPending() {
        if (this.deferredStatementDestroyer != null) {
            return this.deferredStatementDestroyer.getPendingTaskCount();
        }
        return -1;
    }
    ...
    public String getStatementDestroyerStackTraces() {
        if (this.deferredStatementDestroyer != null) {
            return this.deferredStatementDestroyer.getStackTraces();
        }
        return null;
    }
    ...
    public void maybePrivilegedPoolsInit(boolean privilege_spawned_threads) {
    ...
    private void poolsInit() {
        ...
        try {
            if ("library".equalsIgnoreCase(contextClassLoaderSource)) {
                Thread t = new Thread(getClass().getClassLoader(), privilege_spawned_threads) { // from class: com.mchange.v2.c3p0.impl.C3P0PooledConnectionPoolManager.1ContextClassLoaderPoolsInitThread
                    final /* synthetic */ boolean val$privilege_spawned_threads;

                    /* JADX WARN: Incorrect args count in method signature: (Ljava/lang/ClassLoader;)V */
                    {
                        this.val$privilege_spawned_threads = r6;
                ...
                Thread t2 = new Thread(null, privilege_spawned_threads) { // from class: com.mchange.v2.c3p0.impl.C3P0PooledConnectionPoolManager.1ContextClassLoaderPoolsInitThread
                    final /* synthetic */ boolean val$privilege_spawned_threads;
    ...
    private synchronized void poolsDestroy(boolean close_outstanding_connections) {
        for (C3P0PooledConnectionPool c3P0PooledConnectionPool : this.authsToPools.values()) {
            try {
                c3P0PooledConnectionPool.close(close_outstanding_connections);
            } catch (Exception e) {
    ...
    public C3P0PooledConnectionPoolManager(ConnectionPoolDataSource cpds, Map flatPropertyOverrides, Map forceUserOverrides, int num_task_threads, String parentDataSourceIdentityToken, String parentDataSourceName) throws SQLException {
        ...
        try {
            ...
            this.defaultAuth = auth == null ? C3P0ImplUtils.findAuth(cpds) : auth;
            Map tmp = new HashMap();
            PropertyDescriptor[] pds = Introspector.getBeanInfo(cpds.getClass()).getPropertyDescriptors();
            ...
            if (forceUserOverrides == null) {
                ...
                if (uom != null) {
                    this.userOverrides = C3P0ImplUtils.parseUserOverridesAsString((String) uom.invoke(cpds, null));
                } else {
    ...
    public synchronized C3P0PooledConnectionPool getPool(String username, String password, boolean create) throws SQLException {
        ...
        C3P0PooledConnectionPool out = (C3P0PooledConnectionPool) this.authsToPools.get(new DbAuth(username, password));
        if (out != null) {
            return out;
        }
    ...
    public synchronized int getNumIdleConnectionsAllAuths() throws SQLException {
        int out = 0;
        for (C3P0PooledConnectionPool c3P0PooledConnectionPool : this.authsToPools.values()) {
            out += c3P0PooledConnectionPool.getNumIdleConnections();
        }
        return out;
    }
    ...
    public synchronized int getNumBusyConnectionsAllAuths() throws SQLException {
        int out = 0;
        for (C3P0PooledConnectionPool c3P0PooledConnectionPool : this.authsToPools.values()) {
            out += c3P0PooledConnectionPool.getNumBusyConnections();
        }
        return out;
    }
    ...
    public synchronized int getNumConnectionsAllAuths() throws SQLException {
        int out = 0;
        for (C3P0PooledConnectionPool c3P0PooledConnectionPool : this.authsToPools.values()) {
            out += c3P0PooledConnectionPool.getNumConnections();
        }
        return out;
    }
    ...
    public synchronized int getNumUnclosedOrphanedConnectionsAllAuths() throws SQLException {
        int out = 0;
        for (C3P0PooledConnectionPool c3P0PooledConnectionPool : this.authsToPools.values()) {
            out += c3P0PooledConnectionPool.getNumUnclosedOrphanedConnections();
        }
        return out;
    }
    ...
    public synchronized int getStatementCacheNumStatementsAllUsers() throws SQLException {
        int out = 0;
        for (C3P0PooledConnectionPool c3P0PooledConnectionPool : this.authsToPools.values()) {
            out += c3P0PooledConnectionPool.getStatementCacheNumStatements();
        }
        return out;
    }
    ...
    public synchronized int getStatementCacheNumCheckedOutStatementsAllUsers() throws SQLException {
        int out = 0;
        for (C3P0PooledConnectionPool c3P0PooledConnectionPool : this.authsToPools.values()) {
            out += c3P0PooledConnectionPool.getStatementCacheNumCheckedOut();
        }
        return out;
    }
    ...
    public synchronized int getStatementCacheNumConnectionsWithCachedStatementsAllUsers() throws SQLException {
        int out = 0;
        for (C3P0PooledConnectionPool c3P0PooledConnectionPool : this.authsToPools.values()) {
            out += c3P0PooledConnectionPool.getStatementCacheNumConnectionsWithCachedStatements();
        }
        return out;
    }
    ...
    public synchronized int getStatementDestroyerNumConnectionsInUseAllUsers() throws SQLException {
        ...
        int out = 0;
        for (C3P0PooledConnectionPool c3P0PooledConnectionPool : this.authsToPools.values()) {
            out += c3P0PooledConnectionPool.getStatementDestroyerNumConnectionsInUse();
        }
        return out;
    }

    /* renamed from: getStatementDestroyerNumConnectionsWithDeferredDestroyStatementsAllUsers */
    public synchronized int m1283x7f0e7943() throws SQLException {
        if (this.deferredStatementDestroyer == null) {
            return -1;
        }
        int out = 0;
        for (C3P0PooledConnectionPool c3P0PooledConnectionPool : this.authsToPools.values()) {
            out += c3P0PooledConnectionPool.getStatementDestroyerNumConnectionsWithDeferredDestroyStatements();
        }
        return out;
    }
    ...
    public synchronized int getStatementDestroyerNumDeferredDestroyStatementsAllUsers() throws SQLException {
        ...
        int out = 0;
        for (C3P0PooledConnectionPool c3P0PooledConnectionPool : this.authsToPools.values()) {
            out += c3P0PooledConnectionPool.getStatementDestroyerNumDeferredDestroyStatements();
        }
        return out;
    }
    ...
    public synchronized void softResetAllAuths() throws SQLException {
        for (C3P0PooledConnectionPool c3P0PooledConnectionPool : this.authsToPools.values()) {
            c3P0PooledConnectionPool.reset();
        }
    }
    ...
    private Object getObject(String propName, String userName) {
        ...
        if (out == null) {
            try {
                ...
                if (!(m == null || (readProp = m.invoke(this.cpds, null)) == null)) {
    ...
    private int getMaxIdleTime(String userName) {
        try {
            return getInt(C3p0PoolingConnectionProvider.DB_DISCARD_IDLE_CONNECTIONS_SECONDS, userName);
        } catch (Exception e) {
            if (logger.isLoggable(MLevel.FINE)) {
                logger.log(MLevel.FINE, "Could not fetch int property", (Throwable) e);
            }
    ...
    private C3P0PooledConnectionPool createPooledConnectionPool(DbAuth auth) throws SQLException {
        ...
        return new C3P0PooledConnectionPool(this.cpds, auth, getMinPoolSize(userName), getMaxPoolSize(userName), getInitialPoolSize(userName), getAcquireIncrement(userName), getAcquireRetryAttempts(userName), getAcquireRetryDelay(userName), getBreakAfterAcquireFailure(userName), getCheckoutTimeout(userName), getIdleConnectionTestPeriod(userName), getMaxIdleTime(userName), getMaxIdleTimeExcessConnections(userName), getMaxConnectionAge(userName), getPropertyCycle(userName), getUnreturnedConnectionTimeout(userName), getDebugUnreturnedConnectionStackTraces(userName), getForceSynchronousCheckins(userName), getTestConnectionOnCheckout(userName), getTestConnectionOnCheckin(userName), getMaxStatements(userName), getMaxStatementsPerConnection(userName), getConnectionTester(userName), getConnectionCustomizer(userName), realTestQuery, this.rpfact, this.taskRunner, this.deferredStatementDestroyer, this.parentDataSourceIdentityToken);
    }

    /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
        jadx.core.utils.exceptions.JadxRuntimeException: Unreachable block: B:15:0x011e
        	at jadx.core.dex.visitors.blocks.BlockProcessor.checkForUnreachableBlocks(BlockProcessor.java:86)
        	at jadx.core.dex.visitors.blocks.BlockProcessor.processBlocksTree(BlockProcessor.java:52)
        	at jadx.core.dex.visitors.blocks.BlockProcessor.visit(BlockProcessor.java:44)
        */
    private java.lang.String initializeAutomaticTestTable(java.lang.String r10, com.mchange.p009v2.c3p0.impl.DbAuth r11) throws java.sql.SQLException {
        /*
        // Method dump skipped, instructions count: 473
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mchange.p009v2.c3p0.impl.C3P0PooledConnectionPoolManager.initializeAutomaticTestTable(java.lang.String, com.mchange.v2.c3p0.impl.DbAuth):java.lang.String");
    }

    private void ensureFirstConnectionAcquisition(DbAuth auth) throws SQLException {
        PooledConnection throwawayPooledConnection;
        if (auth.equals(this.defaultAuth)) {
            throwawayPooledConnection = this.cpds.getPooledConnection();
        } else {
            throwawayPooledConnection = this.cpds.getPooledConnection(auth.getUser(), auth.getPassword());
        }
        Connection c = null;
        try {
