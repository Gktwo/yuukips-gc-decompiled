...
/* renamed from: com.mchange.v2.c3p0.impl.WrapperConnectionPoolDataSourceBase */
/* loaded from: grasscutter.jar:com/mchange/v2/c3p0/impl/WrapperConnectionPoolDataSourceBase.class */
public abstract class WrapperConnectionPoolDataSourceBase extends IdentityTokenResolvable implements Referenceable, Serializable {
    ...
    private int maxIdleTime = C3P0Config.initializeIntPropertyVar(C3p0PoolingConnectionProvider.DB_DISCARD_IDLE_CONNECTIONS_SECONDS, C3P0Defaults.maxIdleTime());
    ...
    private void writeObject(ObjectOutputStream oos) throws IOException {
        ...
        try {
            ...
            try {
                oos.writeObject(new ReferenceIndirector().indirectForm(this.nestedDataSource));
