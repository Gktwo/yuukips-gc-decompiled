package com.mchange.p009v2.c3p0.jboss;

import java.beans.PropertyVetoException;
import java.sql.SQLException;
import javax.naming.NamingException;

/* renamed from: com.mchange.v2.c3p0.jboss.C3P0PooledDataSourceMBean */
/* loaded from: grasscutter.jar:com/mchange/v2/c3p0/jboss/C3P0PooledDataSourceMBean.class */
public interface C3P0PooledDataSourceMBean {
    ...
    void setUnreturnedConnectionTimeout(int i) throws NamingException;

    boolean isDebugUnreturnedConnectionStackTraces();

    void setDebugUnreturnedConnectionStackTraces(boolean z) throws NamingException;

    boolean isForceSynchronousCheckins();

    void setForceSynchronousCheckins(boolean z) throws NamingException;

    String getConnectionCustomizerClassName();

    void setConnectionCustomizerClassName(String str) throws NamingException;

    int getMaxConnectionAge();

    void setMaxConnectionAge(int i) throws NamingException;

    int getMaxIdleTimeExcessConnections();

    void setMaxIdleTimeExcessConnections(int i) throws NamingException;

    int getMaxAdministrativeTaskTime();

    void setMaxAdministrativeTaskTime(int i) throws NamingException;
