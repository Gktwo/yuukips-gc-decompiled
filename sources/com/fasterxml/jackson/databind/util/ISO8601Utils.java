...
@Deprecated
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/util/ISO8601Utils.class */
public class ISO8601Utils {
    ...
    public static String format(Date date, boolean millis, TimeZone tz, Locale loc) {
        ...
        if (offset != 0) {
            int hours = Math.abs((offset / Kcp.IKCP_RTO_MAX) / 60);
            int minutes = Math.abs((offset / Kcp.IKCP_RTO_MAX) % 60);
            ...
            if (hasT || date.length() > offset5) {
                ...
                if (timezoneIndicator == 'Z') {
                    ...
                    if ("+0000".equals(timezoneOffset) || "+00:00".equals(timezoneOffset)) {
                        ...
                        if (!act.equals(timezoneId) && !act.replace(EmitterKt.COMMENT_PREFIX, "").equals(timezoneId)) {
