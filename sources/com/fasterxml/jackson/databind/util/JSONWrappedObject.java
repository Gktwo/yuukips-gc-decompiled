...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/util/JSONWrappedObject.class */
public class JSONWrappedObject implements JsonSerializable {
    ...
    public void serialize(JsonGenerator jgen, SerializerProvider provider) throws IOException {
        ...
        if (this._value == null) {
            ...
            provider.findTypedValueSerializer(this._value.getClass(), true, (BeanProperty) null).serialize(this._value, jgen, provider);
        }
