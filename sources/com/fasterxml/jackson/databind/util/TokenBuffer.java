...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/util/TokenBuffer.class */
public class TokenBuffer extends JsonGenerator {
    ...
    public JsonGenerator overrideStdFeatures(int values, int mask) {
        this._generatorFeatures = (getFeatureMask() & (mask ^ -1)) | (values & mask);
        return this;
    }
        ...
        switch (t) {
            ...
            case VALUE_NUMBER_FLOAT:
                if (this._forceBigDecimal) {
                    ...
                    _appendValue(JsonToken.VALUE_NUMBER_FLOAT, p.getNumberValueExact());
                    return;
                }
            case VALUE_TRUE:
                writeBoolean(true);
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/util/TokenBuffer$Parser.class */
    public static final class Parser extends ParserMinimalBase {
        ...
        public JsonLocation getCurrentLocation() {
            return this._location == null ? JsonLocation.f215NA : this._location;
        }
    ...
    /* access modifiers changed from: protected */
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/util/TokenBuffer$Segment.class */
    public static final class Segment {
        ...
        public JsonToken type(int index) {
            int i = this._tokenTypes;
            if (index > 0) {
                i >>= index << 2;
            }
            return TOKEN_TYPES_BY_INDEX[((int) i) & 15];
        }
