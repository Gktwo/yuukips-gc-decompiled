...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/util/ClassUtil.class */
public final class ClassUtil {
    ...
    public static String getClassDescription(Object classOrInstance) {
        ...
        return nameOf(classOrInstance instanceof Class ? (Class) classOrInstance : classOrInstance.getClass());
    }
    ...
    public static String classNameOf(Object inst) {
        ...
        return nameOf(inst instanceof Class ? (Class) inst : inst.getClass());
    }
    ...
    public static void checkAndFixAccess(Member member, boolean evenIfAlreadyPublic) {
        ...
        try {
            ...
            if (!(Modifier.isPublic(member.getModifiers()) && Modifier.isPublic(declaringClass.getModifiers())) || (evenIfAlreadyPublic && !isJDKClass(declaringClass))) {
                ao.setAccessible(true);
            }
        } catch (SecurityException se) {
            if (!ao.isAccessible()) {
                throw new IllegalArgumentException("Cannot access " + member + " (from class " + member.getDeclaringClass().getName() + "; failed to set access: " + se.getMessage());
            }
    ...
    /* JADX DEBUG: Type inference failed for r0v1. Raw type applied. Possible types: java.lang.Class<?>, java.lang.Class<? extends java.lang.Enum<?>> */
    public static Class<? extends Enum<?>> findEnumType(Enum<?> en) {
        return en.getDeclaringClass();
    }

    /* JADX DEBUG: Multi-variable search result rejected for r3v1, resolved type: java.lang.Class<? extends java.lang.Enum<?>> */
    /* JADX DEBUG: Multi-variable search result rejected for r3v2, resolved type: java.lang.Class<? extends java.lang.Enum<?>> */
    /* JADX DEBUG: Multi-variable search result rejected for r3v3, resolved type: java.lang.Class<? extends java.lang.Enum<?>> */
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/util/ClassUtil$EnumTypeLocator.class */
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/util/ClassUtil$Ctor.class */
