...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/cfg/BaseSettings.class */
public final class BaseSettings implements Serializable {
    ...
    public BaseSettings with(TimeZone tz) {
        ...
        return new BaseSettings(this._classIntrospector, this._annotationIntrospector, this._propertyNamingStrategy, this._typeFactory, this._typeResolverBuilder, _force(this._dateFormat, tz == null ? DEFAULT_TIMEZONE : tz), this._handlerInstantiator, this._locale, tz, this._defaultBase64, this._typeValidator, this._accessorNaming);
    }
