...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/ObjectReader.class */
public class ObjectReader extends ObjectCodec implements Versioned, Serializable {
    ...
    public JsonParser treeAsTokens(TreeNode n) {
        _assertNotNull("n", n);
        return new TreeTraversingParser((JsonNode) n, withValueToUpdate(null));
    }
    ...
    protected JsonDeserializer<Object> _prefetchRootDeserializer(JavaType valueType) {
        ...
        if (deser == null) {
            try {
                deser = createDummyDeserializationContext().findRootValueDeserializer(valueType);
                if (deser != null) {
