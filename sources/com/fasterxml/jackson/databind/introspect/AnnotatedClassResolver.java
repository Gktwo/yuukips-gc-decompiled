...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/introspect/AnnotatedClassResolver.class */
public class AnnotatedClassResolver {
    ...
    private AnnotationCollector _addFromBundleIfNotPresent(AnnotationCollector c, Annotation bundle) {
        Annotation[] findClassAnnotations = ClassUtil.findClassAnnotations(bundle.annotationType());
        for (Annotation ann : findClassAnnotations) {
