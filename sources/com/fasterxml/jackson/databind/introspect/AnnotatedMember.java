...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/introspect/AnnotatedMember.class */
public abstract class AnnotatedMember extends Annotated implements Serializable {
    ...
    public String getFullName() {
        return getDeclaringClass().getName() + LineReaderImpl.DEFAULT_COMMENT_BEGIN + getName();
    }
