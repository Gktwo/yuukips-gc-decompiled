...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/introspect/AnnotatedMethod.class */
public final class AnnotatedMethod extends AnnotatedWithParams implements Serializable {
    ...
    public String getFullName() {
        ...
        switch (getParameterCount()) {
            ...
            default:
                return String.format("%s(%d params)", getFullName(), Integer.valueOf(getParameterCount()));
        }
    }
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/introspect/AnnotatedMethod$Serialization.class */
