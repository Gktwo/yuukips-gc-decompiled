...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/node/TextNode.class */
public class TextNode extends ValueNode {
    ...
    public byte[] getBinaryValue(Base64Variant b64variant) throws IOException {
        ...
        ByteArrayBuilder builder = new ByteArrayBuilder(Math.max(16, Math.min(65536, 4 + ((str.length() >> 2) * 3))));
        try {
    ...
    public boolean asBoolean(boolean defaultValue) {
        if (this._value != null) {
            ...
            if (C3P0Substitutions.DEBUG.equals(v)) {
                return true;
            }
            if ("false".equals(v)) {
                return false;
