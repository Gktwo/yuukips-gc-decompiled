...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/DataFormatReaders.class */
public class DataFormatReaders {
    ...
    private Match _findFormat(AccessorForReader acc) throws IOException {
        ...
        for (ObjectReader f : objectReaderArr) {
            acc.reset();
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/DataFormatReaders$AccessorForReader.class */
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/DataFormatReaders$Match.class */
