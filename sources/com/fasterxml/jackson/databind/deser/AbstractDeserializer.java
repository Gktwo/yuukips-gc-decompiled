...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/AbstractDeserializer.class */
public class AbstractDeserializer extends JsonDeserializer<Object> implements ContextualDeserializer, Serializable {
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property) throws JsonMappingException {
        ...
        if (property != null && intr != null && (accessor = property.getMember()) != null && (objectIdInfo = intr.findObjectIdInfo(accessor)) != null) {
            ...
            return new AbstractDeserializer(this, ObjectIdReader.construct(idType, objectIdInfo2.getPropertyName(), idGen, ctxt.findRootValueDeserializer(idType), idProp, resolver), (Map<String, SettableBeanProperty>) null);
    ...
    public Object deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        return ctxt.handleMissingInstantiator(this._baseType.getRawClass(), new ValueInstantiator.Base(this._baseType), p, "abstract types either need to be mapped to concrete types, have custom deserializer, or contain additional type information", new Object[0]);
    }
