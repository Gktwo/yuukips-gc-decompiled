...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/impl/JavaUtilCollectionsDeserializers.class */
public abstract class JavaUtilCollectionsDeserializers {
    ...
    public static JsonDeserializer<?> findForCollection(DeserializationContext ctxt, JavaType type) throws JsonMappingException {
        ...
        if (localName2 == null) {
            ...
            return null;
        } else if (localName2.contains("List")) {
            return new StdDelegatingDeserializer(converter(5, type, List.class));
        } else {
            return null;
        }
    }
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/impl/JavaUtilCollectionsDeserializers$JavaUtilCollectionsConverter.class */
