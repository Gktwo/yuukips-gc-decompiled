...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/impl/CreatorCollector.class */
public class CreatorCollector {
    ...
    protected static final String[] TYPE_DESCS = {"default", "from-String", "from-int", "from-long", "from-big-integer", "from-double", "from-big-decimal", "from-boolean", MethodDelegation.ImplementationDelegate.FIELD_NAME_PREFIX, "property-based", "array-delegate"};
    ...
    private JavaType _computeDelegateType(DeserializationContext ctxt, AnnotatedWithParams creator, SettableBeanProperty[] delegateArgs) throws JsonMappingException {
        ...
        if (intr != null) {
            ...
            if (deserDef != null) {
                baseType = baseType.withValueHandler(ctxt.deserializerInstance(delegate, deserDef));
            } else {
