...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/impl/PropertyBasedCreator.class */
public final class PropertyBasedCreator {
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/impl/PropertyBasedCreator$CaseInsensitiveMap.class */
    static class CaseInsensitiveMap extends HashMap<String, SettableBeanProperty> {
        ...
        public SettableBeanProperty get(Object key0) {
            return get((Object) ((String) key0).toLowerCase(this._locale));
        }

        public SettableBeanProperty put(String key, SettableBeanProperty value) {
            return put((CaseInsensitiveMap) key.toLowerCase(this._locale), (String) value);
        }
    }
}
