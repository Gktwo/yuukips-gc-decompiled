...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/impl/ObjectIdReferenceProperty.class */
public class ObjectIdReferenceProperty extends SettableBeanProperty {
    ...
    public SettableBeanProperty withValueDeserializer(JsonDeserializer<?> deser) {
        ...
        return new ObjectIdReferenceProperty(this, deser, this._valueDeserializer == this._nullProvider ? deser : this._nullProvider);
    }
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/impl/ObjectIdReferenceProperty$PropertyReferring.class */
