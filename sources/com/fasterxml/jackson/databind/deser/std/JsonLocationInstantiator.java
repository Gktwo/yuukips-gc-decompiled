...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/std/JsonLocationInstantiator.class */
public class JsonLocationInstantiator extends ValueInstantiator.Base {
    ...
    public Object createFromObjectWith(DeserializationContext ctxt, Object[] args) {
        return new JsonLocation(ContentReference.rawReference(args[0]), _long(args[1]), _long(args[2]), _int(args[3]), _int(args[4]));
    }
