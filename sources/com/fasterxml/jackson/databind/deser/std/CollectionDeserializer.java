...
@JacksonStdImpl
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/std/CollectionDeserializer.class */
public class CollectionDeserializer extends ContainerDeserializerBase<Collection<Object>> implements ContextualDeserializer {
    ...
    protected Collection<Object> _deserializeFromString(JsonParser p, DeserializationContext ctxt, String value) throws IOException {
        ...
        if (value.isEmpty()) {
            CoercionAction act = _checkCoercionFail(ctxt, ctxt.findCoercionAction(logicalType(), rawTargetType, CoercionInputShape.EmptyString), rawTargetType, value, "empty String (\"\")");
            if (act != null) {
                return (Collection) _deserializeFromEmptyString(p, ctxt, act, rawTargetType, "empty String (\"\")");
            }
        } else if (_isBlank(value)) {
            return (Collection) _deserializeFromEmptyString(p, ctxt, ctxt.findCoercionFromBlankString(logicalType(), rawTargetType, CoercionAction.Fail), rawTargetType, "blank String (all whitespace)");
        }
        return handleNonArray(p, ctxt, createDefaultInstance(ctxt));
    }
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/std/CollectionDeserializer$CollectionReferringAccumulator.class */
    public static class CollectionReferringAccumulator {
        ...
        public void add(Object value) {
            if (this._accumulator.isEmpty()) {
                ...
                this._accumulator.get(this._accumulator.size() - 1).next.add(value);
            }
        }
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/std/CollectionDeserializer$CollectionReferring.class */
