...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/std/ReferenceTypeDeserializer.class */
public abstract class ReferenceTypeDeserializer<T> extends StdDeserializer<T> implements ContextualDeserializer {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: com.fasterxml.jackson.databind.deser.std.ReferenceTypeDeserializer<T> */
    ...
    public T deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        if (this._valueTypeDeserializer == null) {
            contents = this._valueDeserializer.deserialize(p, ctxt);
        } else {
            contents = this._valueDeserializer.deserializeWithType(p, ctxt, this._valueTypeDeserializer);
        }
    ...
    public T deserialize(JsonParser p, DeserializationContext ctxt, T reference) throws IOException {
        ...
        if (!this._valueDeserializer.supportsUpdate(ctxt.getConfig()).equals(Boolean.FALSE) && this._valueTypeDeserializer == null) {
            Object contents3 = getReferenced(reference);
            if (contents3 == null) {
                if (this._valueTypeDeserializer == null) {
                    contents2 = this._valueDeserializer.deserialize(p, ctxt);
                } else {
                    contents2 = this._valueDeserializer.deserializeWithType(p, ctxt, this._valueTypeDeserializer);
                }
                return referenceValue(contents2);
            }
            contents = this._valueDeserializer.deserialize(p, ctxt, contents3);
