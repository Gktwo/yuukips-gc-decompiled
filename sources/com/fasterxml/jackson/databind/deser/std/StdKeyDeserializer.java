...
@JacksonStdImpl
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/std/StdKeyDeserializer.class */
public class StdKeyDeserializer extends KeyDeserializer implements Serializable {
    ...
    protected Object _parse(String key, DeserializationContext ctxt) throws Exception {
        switch (this._kind) {
            case 1:
                if (C3P0Substitutions.DEBUG.equals(key)) {
                    return Boolean.TRUE;
                }
                if ("false".equals(key)) {
    ...
    @JacksonStdImpl
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/std/StdKeyDeserializer$StringKD.class */
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/std/StdKeyDeserializer$DelegatingKD.class */
    ...
    /* access modifiers changed from: package-private */
    @JacksonStdImpl
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/std/StdKeyDeserializer$EnumKD.class */
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/std/StdKeyDeserializer$StringCtorKeyDeserializer.class */
    ...
    /* access modifiers changed from: package-private */
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/deser/std/StdKeyDeserializer$StringFactoryKeyDeserializer.class */
