...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/exc/IgnoredPropertyException.class */
public class IgnoredPropertyException extends PropertyBindingException {
    ...
    public static IgnoredPropertyException from(JsonParser p, Object fromObjectOrClass, String propertyName, Collection<Object> propertyIds) {
        ...
        IgnoredPropertyException e = new IgnoredPropertyException(p, String.format("Ignored field \"%s\" (class %s) encountered; mapper configured not to allow this", propertyName, ref.getName()), p.getCurrentLocation(), ref, propertyName, propertyIds);
