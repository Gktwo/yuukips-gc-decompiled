...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/type/MapLikeType.class */
public class MapLikeType extends TypeBase {
    ...
    public JavaType withHandlersFrom(JavaType src) {
        JavaType ct;
        JavaType ct2;
        JavaType type = withHandlersFrom(src);
    ...
    public boolean hasHandlers() {
        return hasHandlers() || this._valueType.hasHandlers() || this._keyType.hasHandlers();
    }
