...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/type/SimpleType.class */
    ...
    protected JavaType _narrow(Class<?> subclass) {
        ...
        for (Class<?> iface : nextI) {
            ...
            if (this._class.isAssignableFrom(iface)) {
                return new SimpleType(subclass, this._bindings, null, new JavaType[]{_narrow(iface)}, this._valueHandler, this._typeHandler, this._asStatic);
            }
        }
