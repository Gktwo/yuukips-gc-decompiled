...
@JacksonStdImpl
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/ser/BeanPropertyWriter.class */
public class BeanPropertyWriter extends PropertyWriter implements Serializable {
    ...
    protected JsonSerializer<Object> _findAndAddDynamic(PropertySerializerMap map, Class<?> type, SerializerProvider provider) throws JsonMappingException {
        ...
        if (this._nonTrivialBaseType != null) {
            result = map.findAndAddPrimarySerializer(provider.constructSpecializedType(this._nonTrivialBaseType, type), provider, this);
        } else {
    ...
    public String toString() {
        ...
        if (this._accessorMethod != null) {
            sb.append("via method ").append(this._accessorMethod.getDeclaringClass().getName()).append(LineReaderImpl.DEFAULT_COMMENT_BEGIN).append(this._accessorMethod.getName());
        } else if (this._field != null) {
            sb.append("field \"").append(this._field.getDeclaringClass().getName()).append(LineReaderImpl.DEFAULT_COMMENT_BEGIN).append(this._field.getName());
        } else {
            sb.append("virtual");
        }
        if (this._serializer == null) {
