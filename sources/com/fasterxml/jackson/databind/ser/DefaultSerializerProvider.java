...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/ser/DefaultSerializerProvider.class */
public abstract class DefaultSerializerProvider extends SerializerProvider implements Serializable {
    ...
    public boolean includeFilterSuppressNulls(Object filter) throws JsonMappingException {
        ...
        try {
            ...
            reportBadDefinition(filter.getClass(), String.format("Problem determining whether filter of type '%s' should filter out `null` values: (%s) %s", filter.getClass().getName(), t.getClass().getName(), ClassUtil.exceptionMessage(t)), t);
            return false;
        }
    }
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/ser/DefaultSerializerProvider$Impl.class */
