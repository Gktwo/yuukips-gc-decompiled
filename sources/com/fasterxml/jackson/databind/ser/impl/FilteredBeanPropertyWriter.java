...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/ser/impl/FilteredBeanPropertyWriter.class */
public abstract class FilteredBeanPropertyWriter {
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/ser/impl/FilteredBeanPropertyWriter$SingleView.class */
    public static final class SingleView extends BeanPropertyWriter implements Serializable {
        ...
        public void depositSchemaProperty(JsonObjectFormatVisitor v, SerializerProvider provider) throws JsonMappingException {
            ...
            if (activeView == null || this._view.isAssignableFrom(activeView)) {
                depositSchemaProperty(v, provider);
            }
        }
    }

    /* access modifiers changed from: private */
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/ser/impl/FilteredBeanPropertyWriter$MultiView.class */
