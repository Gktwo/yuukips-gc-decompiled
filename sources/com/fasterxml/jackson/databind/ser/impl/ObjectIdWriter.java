...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/ser/impl/ObjectIdWriter.class */
public final class ObjectIdWriter {
    ...
    public static ObjectIdWriter construct(JavaType idType, PropertyName propName, ObjectIdGenerator<?> generator, boolean alwaysAsId) {
        ...
        return new ObjectIdWriter(idType, simpleName == null ? null : new SerializedString(simpleName), generator, null, alwaysAsId);
    }
