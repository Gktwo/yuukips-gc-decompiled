...
@JacksonStdImpl
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/ser/std/JsonValueSerializer.class */
public class JsonValueSerializer extends StdSerializer<Object> implements ContextualSerializer, JsonFormatVisitable, SchemaAware {
    ...
    public JsonSerializer<?> createContextual(SerializerProvider ctxt, BeanProperty property) throws JsonMappingException {
        ...
        if (ctxt.isEnabled(MapperFeature.USE_STATIC_TYPING) || this._valueType.isFinal()) {
            ...
            return withResolved(property, typeSer, ser2, isNaturalTypeWithStdHandling(this._valueType.getRawClass(), ser2));
        } else if (property != this._property) {
    ...
    public void serializeWithType(Object bean, JsonGenerator gen, SerializerProvider ctxt, TypeSerializer typeSer0) throws IOException {
        ...
        ser.serializeWithType(value, gen, ctxt, new TypeSerializerRerouter(typeSer0, bean));
    }
    ...
    protected JsonSerializer<Object> _findDynamicSerializer(SerializerProvider ctxt, Class<?> valueClass) throws JsonMappingException {
        ...
        if (serializer == null) {
            if (this._valueType.hasGenericTypes()) {
                ...
                this._dynamicSerializers = this._dynamicSerializers.addSerializer(fullType, serializer).map;
            } else {
                serializer = ctxt.findPrimaryPropertySerializer(valueClass, this._property);
                this._dynamicSerializers = this._dynamicSerializers.addSerializer(valueClass, serializer).map;
            }
        }
        return serializer;
    }
    ...
    public String toString() {
        return "(@JsonValue serializer for method " + this._accessor.getDeclaringClass() + LineReaderImpl.DEFAULT_COMMENT_BEGIN + this._accessor.getName() + ")";
    }

    /* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/ser/std/JsonValueSerializer$TypeSerializerRerouter.class */
