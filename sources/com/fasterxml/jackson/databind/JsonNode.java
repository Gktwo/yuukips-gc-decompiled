...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/databind/JsonNode.class */
public abstract class JsonNode extends JsonSerializable.Base implements TreeNode, Iterable<JsonNode> {
    ...
    @Override // com.fasterxml.jackson.core.TreeNode
    /* renamed from: at */
    public final JsonNode mo1479at(JsonPointer ptr) {
        if (ptr.matches()) {
            return this;
        }
        JsonNode n = _at(ptr);
        ...
        return n.mo1479at(ptr.tail());
    }

    @Override // com.fasterxml.jackson.core.TreeNode
    /* renamed from: at */
    public final JsonNode mo1478at(String jsonPtrExpr) {
        return mo1479at(JsonPointer.compile(jsonPtrExpr));
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: com.fasterxml.jackson.databind.JsonNode */
