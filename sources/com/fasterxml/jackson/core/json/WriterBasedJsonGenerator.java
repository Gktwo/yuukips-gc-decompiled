...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/core/json/WriterBasedJsonGenerator.class */
public class WriterBasedJsonGenerator extends JsonGeneratorImpl {
    ...
    public void writeString(Reader reader, int len) throws IOException {
        ...
        while (toRead > 0 && (numRead = reader.read(buf, 0, Math.min(toRead, buf.length))) > 0) {
    ...
    private void _writeString(char[] text, int offset, int len) throws IOException {
        if (this._characterEscapes != null) {
            ...
            while (offset < len2) {
                ...
                int newAmount = offset - offset;
                if (newAmount < 32) {
                    if (this._outputTail + newAmount > this._outputEnd) {
                        _flushBuffer();
                    }
                    if (newAmount > 0) {
                        System.arraycopy(text, offset, this._outputBuffer, this._outputTail, newAmount);
                        this._outputTail += newAmount;
                    }
                } else {
                    _flushBuffer();
                    this._writer.write(text, offset, newAmount);
                }
                if (offset < len2) {
                    offset++;
                    char c2 = text[offset];
    ...
    /* JADX WARNING: Removed duplicated region for block: B:20:0x0098 A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:26:0x0055 A[EDGE_INSN: B:26:0x0055->B:14:0x0055 ?: BREAK  , SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:32:0x0054 A[EDGE_INSN: B:32:0x0054->B:15:0x0054 ?: BREAK  , SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:32:0x0083 A[EDGE_INSN: B:32:0x0083->B:21:0x0083 ?: BREAK  , SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:38:0x0083 A[EDGE_INSN: B:38:0x0083->B:22:0x0083 ?: BREAK  , SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    protected final void _writeBinary(Base64Variant b64variant, byte[] input, int inputPtr, int inputEnd) throws IOException, JsonGenerationException {
        ...
        while (inputPtr <= safeInputEnd) {
            ...
            this._outputTail = b64variant.encodeBase64Chunk((((input[inputPtr] << 8) | (input[inputPtr2] & 255)) << 8) | (input[inputPtr3] & 255), this._outputBuffer, this._outputTail);
            chunksBeforeLF--;
            if (chunksBeforeLF <= 0) {
                char[] cArr = this._outputBuffer;
                int i = this._outputTail;
