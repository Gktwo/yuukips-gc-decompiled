...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/core/json/ByteSourceJsonBootstrapper.class */
public final class ByteSourceJsonBootstrapper {
    ...
    public JsonParser constructParser(int parserFeatures, ObjectCodec codec, ByteQuadsCanonicalizer rootByteSymbols, CharsToNameCanonicalizer rootCharSymbols, int factoryFeatures) throws IOException {
        ...
        return new UTF8StreamJsonParser(this._context, parserFeatures, this._in, codec, rootByteSymbols.makeChild(factoryFeatures), this._inputBuffer, this._inputPtr, this._inputEnd, bytesProcessed, this._bufferRecyclable);
    }
    ...
    private boolean handleBOM(int quad) throws IOException {
        switch (quad) {
            ...
            case 65279:
                ...
                this._bytesPerChar = 4;
                return true;
            case ArrayTernaryTrie.MAX_CAPACITY /* 65534 */:
