...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/core/json/UTF8JsonGenerator.class */
public class UTF8JsonGenerator extends JsonGeneratorImpl {
    ...
    public void writeRaw(String text, int offset, int len) throws IOException {
        ...
        while (len > 0) {
            ...
            if (len2 > 1 && (ch = buf[len2 - 1]) >= 55296 && ch <= 56319) {
                len2--;
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x005e, code lost:
        if ((r6._outputTail + 3) < r6._outputEnd) goto L_0x0065;
     */
    ...
    private final int _outputMultiByteChar(int ch, int outputPtr) throws IOException {
        ...
        if (ch < 55296 || ch > 57343) {
            ...
            bbuf[outputPtr3] = (byte) (128 | ((ch >> 6) & 63));
            outputPtr2 = outputPtr4 + 1;
            bbuf[outputPtr4] = (byte) (128 | (ch & 63));
        } else {
