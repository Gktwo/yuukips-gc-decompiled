...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/core/json/async/NonBlockingJsonParserBase.class */
public abstract class NonBlockingJsonParserBase extends ParserBase {
    ...
    public JsonLocation getCurrentLocation() {
        ...
        return new JsonLocation(_contentReference(), this._currInputProcessed + ((long) (this._inputPtr - this._currBufferStart)), -1L, Math.max(this._currInputRow, this._currInputRowAlt), col);
    }
