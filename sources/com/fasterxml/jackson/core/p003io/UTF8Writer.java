...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/core/io/UTF8Writer.class */
        ...
        if (len >= 2) {
            ...
            while (off < len2) {
                ...
                if (c < 2048) {
                    ...
                    off++;
                    int c2 = convertSurrogate(cbuf[off]);
                    if (c2 > 1114111) {
                        this._outPtr = outPtr;
                        illegalSurrogate(c2);
                    }
                    int outPtr5 = outPtr + 1;
                    outBuf[outPtr] = (byte) (240 | (c2 >> 18));
        ...
        if (len >= 2) {
            ...
            while (off < len2) {
                ...
                if (c < 2048) {
                    ...
                    off++;
                    int c2 = convertSurrogate(str.charAt(off));
                    if (c2 > 1114111) {
                        this._outPtr = outPtr;
                        illegalSurrogate(c2);
                    }
