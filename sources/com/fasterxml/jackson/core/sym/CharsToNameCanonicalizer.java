...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/core/sym/CharsToNameCanonicalizer.class */
public final class CharsToNameCanonicalizer {
    ...
    protected void verifyInternalConsistency() {
        ...
        int bucketSize = size >> 1;
        for (int i2 = 0; i2 < bucketSize; i2++) {
            for (Bucket b = this._buckets[i2]; b != null; b = b.next) {
                count++;
            }
        }
        if (count != this._size) {
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/core/sym/CharsToNameCanonicalizer$Bucket.class */
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/core/sym/CharsToNameCanonicalizer$TableInfo.class */
