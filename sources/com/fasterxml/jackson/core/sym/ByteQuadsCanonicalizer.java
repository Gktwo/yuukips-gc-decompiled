...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/core/sym/ByteQuadsCanonicalizer.class */
public final class ByteQuadsCanonicalizer {
    ...
    public String toString() {
        ...
        return String.format("[%s: size=%d, hashSize=%d, %d/%d/%d/%d pri/sec/ter/spill (=%s), total:%d]", getClass().getName(), Integer.valueOf(this._count), Integer.valueOf(this._hashSize), Integer.valueOf(pri), Integer.valueOf(sec), Integer.valueOf(tert), Integer.valueOf(spill), Integer.valueOf(pri + sec + tert + spill), Integer.valueOf(totalCount()));
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:11:0x0058 A[RETURN] */
    ...
    private boolean _checkNeedForRehash() {
        ...
        if (((this._spilloverEnd - _spilloverStart()) >> 2) > ((1 + this._count) >> 7) || ((double) this._count) > ((double) this._hashSize) * 0.8d) {
            return true;
        }
        return false;
    }
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/core/sym/ByteQuadsCanonicalizer$TableInfo.class */
