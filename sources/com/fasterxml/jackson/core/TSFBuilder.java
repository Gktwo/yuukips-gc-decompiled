...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/core/TSFBuilder.class */
public abstract class TSFBuilder<F extends JsonFactory, B extends TSFBuilder<F, B>> {
    ...
    private B _failNonJSON(Object feature) {
        throw new IllegalArgumentException("Feature " + feature.getClass().getName() + LineReaderImpl.DEFAULT_COMMENT_BEGIN + feature.toString() + " not supported for non-JSON backend");
    }
