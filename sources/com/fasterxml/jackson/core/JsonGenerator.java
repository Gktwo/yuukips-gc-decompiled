...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/core/JsonGenerator.class */
public abstract class JsonGenerator implements Closeable, Flushable, Versioned {
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/core/JsonGenerator$Feature.class */
    public enum Feature {
    ...
    public JsonGenerator overrideStdFeatures(int values, int mask) {
        return setFeatureMask((getFeatureMask() & (mask ^ -1)) | (values & mask));
    }
    ...
    public void copyCurrentStructure(JsonParser p) throws IOException {
        JsonToken t = p.currentToken();
        int id = t == null ? -1 : t.m1480id();
        if (id == 5) {
            writeFieldName(p.getCurrentName());
            JsonToken t2 = p.nextToken();
            id = t2 == null ? -1 : t2.m1480id();
        }
        switch (id) {
            case 1:
                writeStartObject();
