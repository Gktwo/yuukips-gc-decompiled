...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/annotation/JsonInclude.class */
public @interface JsonInclude {

    /* loaded from: grasscutter.jar:com/fasterxml/jackson/annotation/JsonInclude$Include.class */
    public enum Include {
        ALWAYS,
        NON_NULL,
        NON_ABSENT,
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/annotation/JsonInclude$Value.class */
