...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/annotation/JacksonInject.class */
public @interface JacksonInject {
    String value() default "";

    OptBoolean useInput() default OptBoolean.DEFAULT;

    /* loaded from: grasscutter.jar:com/fasterxml/jackson/annotation/JacksonInject$Value.class */
