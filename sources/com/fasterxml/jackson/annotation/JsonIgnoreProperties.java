...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/annotation/JsonIgnoreProperties.class */
public @interface JsonIgnoreProperties {
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/annotation/JsonIgnoreProperties$Value.class */
    public static class Value implements JacksonAnnotationValue<JsonIgnoreProperties>, Serializable {
        ...
        public Value withOverrides(Value overrides) {
            ...
            return construct(_merge(this._ignored, overrides._ignored), this._ignoreUnknown || overrides._ignoreUnknown, this._allowGetters || overrides._allowGetters, this._allowSetters || overrides._allowSetters, true);
        }
