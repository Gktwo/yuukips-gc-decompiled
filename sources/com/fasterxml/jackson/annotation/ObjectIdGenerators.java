...
/* loaded from: grasscutter.jar:com/fasterxml/jackson/annotation/ObjectIdGenerators.class */
public class ObjectIdGenerators {

    /* loaded from: grasscutter.jar:com/fasterxml/jackson/annotation/ObjectIdGenerators$None.class */
    public static abstract class None extends ObjectIdGenerator<Object> {
    }

    /* loaded from: grasscutter.jar:com/fasterxml/jackson/annotation/ObjectIdGenerators$Base.class */
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/annotation/ObjectIdGenerators$PropertyGenerator.class */
    public static abstract class PropertyGenerator extends Base<Object> {
        ...
        public /* bridge */ /* synthetic */ boolean canUseFor(ObjectIdGenerator objectIdGenerator) {
            return canUseFor(objectIdGenerator);
        }
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/annotation/ObjectIdGenerators$IntSequenceGenerator.class */
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/annotation/ObjectIdGenerators$UUIDGenerator.class */
    ...
    /* loaded from: grasscutter.jar:com/fasterxml/jackson/annotation/ObjectIdGenerators$StringIdGenerator.class */
