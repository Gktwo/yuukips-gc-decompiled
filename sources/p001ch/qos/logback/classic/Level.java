...
/* loaded from: grasscutter.jar:ch/qos/logback/classic/Level.class */
public final class Level implements Serializable {
    ...
    public static final Level ERROR = new Level(ERROR_INT, Constants.STATE_ERROR);
    ...
    public static Level toLevel(String sArg, Level defaultLevel) {
        ...
        if (sArg.equalsIgnoreCase(Constants.STATE_ERROR)) {
            return ERROR;
        }
