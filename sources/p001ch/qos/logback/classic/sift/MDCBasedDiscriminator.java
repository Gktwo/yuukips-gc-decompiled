...
/* loaded from: grasscutter.jar:ch/qos/logback/classic/sift/MDCBasedDiscriminator.class */
public class MDCBasedDiscriminator extends AbstractDiscriminator<ILoggingEvent> {
    ...
    @Override // p001ch.qos.logback.core.sift.AbstractDiscriminator, p001ch.qos.logback.core.spi.LifeCycle
    public void start() {
        int errors = 0;
