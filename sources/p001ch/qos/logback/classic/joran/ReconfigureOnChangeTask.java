...
/* renamed from: ch.qos.logback.classic.joran.ReconfigureOnChangeTask */
/* loaded from: grasscutter.jar:ch/qos/logback/classic/joran/ReconfigureOnChangeTask.class */
public class ReconfigureOnChangeTask extends ContextAwareBase implements Runnable {
    ...
    private List<SaxEvent> removeIncludeEvents(List<SaxEvent> unsanitizedEventList) {
        ...
        for (SaxEvent e : unsanitizedEventList) {
            if (!Printer.INCLUDE.equalsIgnoreCase(e.getLocalName())) {
    ...
    private void fallbackConfiguration(LoggerContext lc, List<SaxEvent> eventList, URL mainURL) {
        ...
        ConfigurationWatchList newCWL = ConfigurationWatchListUtil.getConfigurationWatchList(this.context).buildClone();
