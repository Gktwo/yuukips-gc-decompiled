...
/* loaded from: grasscutter.jar:ch/qos/logback/classic/pattern/ThrowableProxyConverter.class */
    ...
    public void start() {
        ...
        if (optionList != null && optionList.size() > 1) {
            ...
            for (int i = 1; i < optionListSize; i++) {
                ...
                EventEvaluator<?> eventEvaluator = ((Map) getContext().getObject(CoreConstants.EVALUATOR_MAP)).get(evaluatorOrIgnoredStackTraceLine);
