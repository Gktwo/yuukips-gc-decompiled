...
/* loaded from: grasscutter.jar:ch/qos/logback/classic/spi/ThrowableProxyUtil.class */
public class ThrowableProxyUtil {
    ...
    public static int findNumberOfCommonFrames(StackTraceElement[] steArray, StackTraceElementProxy[] parentSTEPArray) {
        ...
        int count = 0;
        while (steIndex >= 0 && parentIndex >= 0 && steArray[steIndex].equals(parentSTEPArray[parentIndex].ste)) {
            count++;
            steIndex--;
            parentIndex--;
        }
