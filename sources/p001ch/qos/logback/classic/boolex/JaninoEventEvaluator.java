...
import p001ch.qos.logback.core.boolex.JaninoEventEvaluatorBase;
import p001ch.qos.logback.core.boolex.Matcher;

/* renamed from: ch.qos.logback.classic.boolex.JaninoEventEvaluator */
/* loaded from: grasscutter.jar:ch/qos/logback/classic/boolex/JaninoEventEvaluator.class */
public class JaninoEventEvaluator extends JaninoEventEvaluatorBase<ILoggingEvent> {
    ...
    static {
        ...
        DEFAULT_PARAM_NAME_LIST.add(Constants.STATE_ERROR);
        DEFAULT_PARAM_NAME_LIST.add("event");
        DEFAULT_PARAM_NAME_LIST.add(SendMailJob.PROP_MESSAGE);
    ...
    @Override // p001ch.qos.logback.core.boolex.JaninoEventEvaluatorBase
    ...
    protected String[] getParameterNames() {
        ...
        for (int i = 0; i < this.matcherList.size(); i++) {
            fullNameList.add(((Matcher) this.matcherList.get(i)).getName());
        }
