...
/* renamed from: ch.qos.logback.classic.servlet.LogbackServletContainerInitializer */
/* loaded from: grasscutter.jar:ch/qos/logback/classic/servlet/LogbackServletContainerInitializer.class */
public class LogbackServletContainerInitializer implements ServletContainerInitializer {
    ...
    public void onStartup(Set<Class<?>> c, ServletContext ctx) throws ServletException {
        ...
        ctx.addListener((ServletContext) new LogbackServletContextListener());
    }
    ...
    boolean isDisabledByConfiguration(ServletContext ctx) {
        ...
        return disableAttributeStr.equalsIgnoreCase(C3P0Substitutions.DEBUG);
    }
}
