...
/* loaded from: grasscutter.jar:ch/qos/logback/classic/net/SimpleSocketServer.class */
public class SimpleSocketServer extends Thread {
    private final int port;

    /* renamed from: lc */
    private final LoggerContext f5lc;
        ...
        try {
            ...
            try {
                ...
                while (!this.closed) {
                    ...
                    SocketNode newSocketNode = new SocketNode(this, socket, this.f5lc);
                    synchronized (this.socketNodeList) {
                        this.socketNodeList.add(newSocketNode);
                    }
                    new Thread(newSocketNode, getClientThreadName(socket)).start();
                }
