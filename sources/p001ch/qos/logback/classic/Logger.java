...
/* loaded from: grasscutter.jar:ch/qos/logback/classic/Logger.class */
public final class Logger implements org.slf4j.Logger, LocationAwareLogger, AppenderAttachable<ILoggingEvent>, Serializable {
    ...
    public Logger getChildByName(String childName) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (childName.equals(childLogger_i.getName())) {
    ...
    private synchronized void handleParentLevelChange(int newParentLevelInt) {
        if (this.level == null) {
            ...
            if (this.childrenList != null) {
                int len = this.childrenList.size();
                for (int i = 0; i < len; i++) {
                    this.childrenList.get(i).handleParentLevelChange(newParentLevelInt);
                }
            }
        }
    }
    ...
    Logger createChildByLastNamePart(String lastPart) {
        Logger childLogger;
        if (LoggerNameUtil.getFirstSeparatorIndexOf(lastPart) != -1) {
    ...
    public Logger createChildByName(String childName) {
        if (LoggerNameUtil.getSeparatorIndexOf(childName, this.name.length() + 1) != -1) {
    ...
    public void log(Marker marker, String fqcn, int levelInt, String message, Object[] argArray, Throwable t) {
        filterAndLog_0_Or3Plus(fqcn, marker, Level.fromLocationAwareLoggerInteger(levelInt), message, argArray, t);
    }

    public void log(org.slf4j.event.LoggingEvent slf4jEvent) {
        filterAndLog_0_Or3Plus(FQCN, slf4jEvent.getMarker(), Level.fromLocationAwareLoggerInteger(slf4jEvent.getLevel().toInt()), slf4jEvent.getMessage(), slf4jEvent.getArgumentArray(), slf4jEvent.getThrowable());
    }
