...
/* loaded from: grasscutter.jar:ch/qos/logback/core/joran/spi/SimpleRuleStore.class */
public class SimpleRuleStore extends ContextAwareBase implements RuleStore {
    ...
    @Override // p001ch.qos.logback.core.joran.spi.RuleStore
    ...
    List<Action> prefixMatch(ElementPath elementPath) {
        ...
        ElementSelector longestMatchingElementSelector = null;
        for (ElementSelector selector : this.rules.keySet()) {
            if (isKleeneStar(selector.peekLast()) && (r = selector.getPrefixMatchLength(elementPath)) == selector.size() - 1 && r > max) {
                max = r;
                longestMatchingElementSelector = selector;
            }
        }
