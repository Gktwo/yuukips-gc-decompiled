...
/* renamed from: ch.qos.logback.core.status.ViewStatusMessagesServletBase */
/* loaded from: grasscutter.jar:ch/qos/logback/core/status/ViewStatusMessagesServletBase.class */
public abstract class ViewStatusMessagesServletBase extends HttpServlet {
    ...
    private void printStatus(StringBuilder buf, Status s) {
        ...
        buf.append("    <td class=\"date\">").append(SDF.format(s.getDate().longValue())).append("</td>\r\n");
