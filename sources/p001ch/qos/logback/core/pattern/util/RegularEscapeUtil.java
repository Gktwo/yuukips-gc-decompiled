...
/* loaded from: grasscutter.jar:ch/qos/logback/core/pattern/util/RegularEscapeUtil.class */
    ...
    public void escape(String escapeChars, StringBuffer buf, char next, int pointer) {
        ...
        switch (next) {
            ...
            case 't':
                ...
                return;
            default:
                throw new IllegalArgumentException("Illegal char '" + next + " at column " + pointer + ". Only \\\\, \\_" + formatEscapeCharsForListing(escapeChars) + ", \\t, \\n, \\r combinations are allowed as escape characters.");
        }
    }
