...
/* loaded from: grasscutter.jar:ch/qos/logback/core/net/SyslogOutputStream.class */
public class SyslogOutputStream extends OutputStream {
    ...
    /* renamed from: ds */
    private DatagramSocket f12ds = new DatagramSocket();
    ...
    public void flush() throws IOException {
        ...
        if (bytes.length != 0 && this.f12ds != null) {
            this.f12ds.send(packet);
        }
    }
    ...
    public int getSendBufferSize() throws SocketException {
        return this.f12ds.getSendBufferSize();
    }
}
