...
/* loaded from: grasscutter.jar:ch/qos/logback/core/rolling/helper/Compressor.class */
public class Compressor extends ContextAwareBase {
        ...
        if (!file2zip.exists()) {
            ...
            try {
                try {
                    ...
                    zos2.putNextEntry(computeZipEntry(innerEntryName));
    ...
    ZipEntry computeZipEntry(String filename) {
        return new ZipEntry(computeFileNameStrWithoutCompSuffix(filename, this.compressionMode));
    }
    ...
    public Future<?> asyncCompress(String nameOfFile2Compress, String nameOfCompressedFile, String innerEntryName) throws RolloverFailure {
        return this.context.getScheduledExecutorService().submit(new CompressionRunnable(nameOfFile2Compress, nameOfCompressedFile, innerEntryName));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: ch.qos.logback.core.rolling.helper.Compressor$CompressionRunnable */
    /* loaded from: grasscutter.jar:ch/qos/logback/core/rolling/helper/Compressor$CompressionRunnable.class */
